 ...
 *  SoAd_Rx_IsActive()
 *********************************************************************************************************************/
/*! \brief       Indicates if a reception is active or pending on a socket connection.
 *  \details     -
 *  \param[in]   SoConIdx             Socket connection index.
 *                                    [range: SoConIdx < SoAd_GetSizeOfSoCon()]
 *  \param[in]   PartitionIdx         Partition index.
 *                                    [range: PartitionIdx < size of SoAd_PCPartitionConfig]
 *  \return      TRUE                 Transmission is active or pending.
 *  \return      FALSE                No transmission is active or pending.
 *  \pre         -
 *  \context     TASK|ISR2
