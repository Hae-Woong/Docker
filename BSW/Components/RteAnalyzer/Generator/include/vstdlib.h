...
/* Copies nCnt bits of  data from one memory location to another memory location with endianess conversion. 
   As used only for the BSW gendata analysis the stub simulates a write to the entire memory region
*/
# define VStdLib_BitCpySawBigToLittleEndian_s(pDst, nDstSize, nDstBitOffsetSaw, pSrc, nSrcBitOffsetSaw, nCnt, errorCode) (memset((pDst), (0), (nDstSize)),0)
# define VStdLib_BitCpySawLittleToBigEndian_s(pDst, nDstSize, nDstBitOffsetSaw, pSrc, nSrcBitOffsetSaw, nCnt, errorCode) (memset((pDst), (0), (nDstSize)),0)
# define VStdLib_BitCpySawLittleToLittleEndian_s(pDst, nDstSize, nDstBitOffsetSaw, pSrc, nSrcBitOffsetSaw, nCnt, errorCode) (memset((pDst), (0), (nDstSize)),0)
# define VStdLib_BitCpySawBigToBigEndian_s(pDst, nDstSize, nDstBitOffsetSaw, pSrc, nSrcBitOffsetSaw, nCnt, errorCode) (memset((pDst), (0), (nDstSize)),0)

/* Compares two buffers for the specified number of bytes and returns whether they are equal or not. */
#define VStdLib_MemCmp(pBuf1, pBuf2, nCnt) 0
