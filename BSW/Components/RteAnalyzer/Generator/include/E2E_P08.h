...
typedef struct {
    E2E_P08CheckStatusType Status; /*!< Result of verification of the Data in this cycle */
 ...
 * \details         Protects the array/buffer to be transmitted using the E2E Profile 8. This includes checksum calculation,
...
# define E2E_P08ProtectInit(StatePtr) 0; (StatePtr)->Counter = 0
 ...
 * \details         Check initialization function of E2Elib Profile 8
 * \param[in,out]   StatePtr  Pointer to communication state
 * \return          E2E_E_INPUTERR_NULL: Pointer parameter is NULL
 * \return          E2E_E_OK: Initialization successful
 * \pre             -
 ...
 */
 /* Set any element of the struct to mark the struct initialized. */
# define E2E_P08CheckInit(StatePtr) 0; (StatePtr)->Counter = 0
 ...
 * \trace           CREQ-1175
 */
FUNC (E2E_PCheckStatusType, E2E_CODE) E2E_P08MapStatusToSM (VAR (Std_ReturnType, AUTOMATIC) CheckReturn,
                                                            VAR(E2E_P08CheckStatusType, AUTOMATIC) Status);
