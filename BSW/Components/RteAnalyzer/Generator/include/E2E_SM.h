...
typedef struct
{
    /* MICROSAR RTE is compatible with older MICROSAR stacks, this extension allows testing of both variants */
# if (defined(E2EXF_LEGACY_STATEMACHINE) && (E2EXF_LEGACY_STATEMACHINE == STD_OFF))
...
# define E2E_SMCheckInit(StatePtr, ConfigPtr) 0; (StatePtr)->SMState = E2E_SM_NODATA
