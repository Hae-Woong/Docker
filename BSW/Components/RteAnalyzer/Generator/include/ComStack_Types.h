...
# define COMMONASR__COMMON_IMPL_COMSTACKTYPES_VERSION 0x0500
...
# define COMSTACKTYPE_AR_RELEASE_MINOR_VERSION      (3u)
...
# define COMSTACKTYPE_SW_MAJOR_VERSION       (5u)
...
/* PduInfoType MetaData handling */

# ifndef RTEANALYER_DISABLE_METADATA
#  define PDUINFOTYPE_INIT {NULL_PTR, NULL_PTR, 0}
#  define PDUINFOTYPE_VERSION 43
# else
#  define PDUINFOTYPE_INIT {NULL_PTR, 0}
#  define PDUINFOTYPE_VERSION 42
#endif
...
typedef  P2VAR(uint8, TYPEDEF, AUTOSAR_COMSTACKDATA) MetaDataPtrType;
typedef struct
{
