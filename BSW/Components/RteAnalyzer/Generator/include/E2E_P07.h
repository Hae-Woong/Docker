 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *         \file  E2E_P07.h
 *        \brief  E2E header file for AUTOSAR E2E Library Profile 7
 *
...
typedef struct {
    ...
    uint32 MaxDeltaCounter; /*!< Maximum allowed difference between two counter values of consecutively received valid messages */
} E2E_P07ConfigType;
...
typedef struct {
    E2E_P07CheckStatusType Status; /*!< Result of verification of the Data in this cycle */
 ...
 *********************************************************************************************************************/
/*!
 * \brief           Protection function of E2Elib Profile 7
 * \details         Protects the array/buffer to be transmitted using the E2E Profile 7. This includes checksum calculation,
 ...
 *********************************************************************************************************************/
/*!
 * \brief           Protection initialization function of E2Elib Profile 7
...
# define E2E_P07ProtectInit(StatePtr) 0; (StatePtr)->Counter = 0
 ...
 *********************************************************************************************************************/
/*!
 * \brief           Check function of E2Elib Profile 7
 * \details         Checks the Data received using the E2E Profile 7. This includes CRC calculation, handling of
 ...
 *********************************************************************************************************************/
/*!
 * \brief           Check initialization function of E2Elib Profile 7
 * \details         Check initialization function of E2Elib Profile 7
 * \param[in,out]   StatePtr  Pointer to communication state
 * \return          E2E_E_INPUTERR_NULL: Pointer parameter is NULL
 * \return          E2E_E_OK: Initialization successful
 * \pre             -
 ...
 */
 /* Set any element of the struct to mark the struct initialized. */
# define E2E_P07CheckInit(StatePtr) 0; (StatePtr)->Counter = 0
 ...
 *********************************************************************************************************************/
/*!
 * \brief           State mapping function of E2Elib Profile 7
 * \details         Maps the check status of Profile 7 to a generic check status, which can be used by E2E state machine
 *                  check function. The E2E Profile 7 delivers a more fine-grained status, but this is not relevant for
 *                  the E2E state machine.
 * \param[in]       CheckReturn     Return value of E2E_P07Check
