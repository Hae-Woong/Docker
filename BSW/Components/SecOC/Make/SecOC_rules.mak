...
#------------------------------------------------------------------------------
# 1.00.00   2014-10-01  vishho  ESCAN00078700  CONC_607_SecOC
# 1.01.00   2019-02-06  vircbl  Added support of component-based SIP structure
# 1.01.01   2023-08-24  visms   ESCAN00115475  unresolved external symbol SecOC_Rte_Write_VerificationStatus_verificationStatus_<PartitionName> and SecOC_Rte_Call_VerificationStatusNotification_VerifyStatus_<PartitionName>
#------------------------------------------------------------------------------
...
LIBRARIES_TO_BUILD      += SecOC
SecOC_FILES             = SecOC$(BSW_SRC_DIR)\SecOC.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += SecOC$(BSW_SRC_DIR)\SecOC.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\SecOC_PBcfg.c $(GENDATA_DIR)\SecOC_Lcfg.c

include $(GENDATA_DIR)\Make\SecOC_rules_generated.mak
