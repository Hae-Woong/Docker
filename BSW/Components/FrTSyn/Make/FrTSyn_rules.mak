...
# ----------   -------  ---- -------------------------------------------------#
# 2014-12-05   1.00.00  ssf  Initial Version                                  #
# 2019-01-23   1.01.00  si   Support of new SIP structure                     #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 1.00.00                                                   #
###############################################################################
...
LIBRARIES_TO_BUILD      += FrTSyn
FrTSyn_FILES             = FrTSyn$(BSW_SRC_DIR)\FrTSyn.c

# e.g.: CC_FILES_TO_BUILD       += <MSN>\<MSN>.c <MSN>\<MSN>_Irq.c
CC_FILES_TO_BUILD       += FrTSyn$(BSW_SRC_DIR)\FrTSyn.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\FrTSyn_Cfg.c
