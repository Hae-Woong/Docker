 ...
 *  \synchronous TRUE
 *  \unit        Common
 *  \config      FRTSYN_SLAVECONFIG
 *********************************************************************************************************************/
FUNC(void, FRTSYN_CODE) FrTSyn_RxIndication(PduIdType RxPduId, P2CONST(PduInfoType, AUTOMATIC, FRTSYN_APPL_DATA) PduInfoPtr);
# else
#  define FrTSyn_RxIndication(RxPduId, PduInfoPtr) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
# endif
 ...
 *********************************************************************************************************************/
FUNC(Std_ReturnType, FRTSYN_CODE) FrTSyn_TriggerTransmit(PduIdType TxPduId, P2VAR(PduInfoType, AUTOMATIC, FRTSYN_APPL_VAR) PduInfoPtr);
# else
#  define FrTSyn_TriggerTransmit(TxPduId, PduInfoPtr) (E_NOT_OK) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
# endif
