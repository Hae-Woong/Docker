###################################################################################################
# File Name  : Mcal_Tc3xx_rules.mak																  #
...
# 2020-02-17   1.09.00  virnid  Integration of MC-ISAR_AS422_TC3xx_BASIC/CD_1.40.0-alpha1		  #
# 2020-06-16   1.10.00	virnid	Integration of MC-ISAR_AS422_TC3xx_BASIC/CD_1.40.0				  #
# 2020-01-12   1.11.00	virnid	Integration of MC-ISAR_AS440_TC3xx_BASIC/CD_2.0.0-rc			  #
#								and MC-ISAR_AS422_TC3xx_BASIC/CD_2.0.0-rc		  				  #
# 2021-04-16   1.12.00	virelt	Integration of MC-ISAR_AS440_TC3xx_BASIC/CD_2.0.0				  #
#								and MC-ISAR_AS422_TC3xx_BASIC/CD_2.0.0		  					  #
# 2023-08-05   1.13.00	virnid	Integration of MC-ISAR_AS440_TC3xx_BASIC/CD_2.25.0				  #
#								and MC-ISAR_AS422_TC3xx_BASIC/CD_2.25.0		  					  #
# 2024-06-24   1.14.00	virnid	Integration of MC-ISAR_AS440_TC3xx_BASIC/CD_2.30.0				  #
#								and MC-ISAR_AS422_TC3xx_BASIC/CD_2.30.0		  					  #
#-------------------------------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       					  #
# MAKEFILE        = 0.1                                                        					  #
###################################################################################################
...
ifeq ($(MCAL_EXCLUDE_MCALLIB),)
MCAL_EXCLUDE_MCALLIB = 0
endif
...
#Path to Mcal Base Package
MCAL_PATH_BASE = ..\ThirdParty\Mcal_Tc3xx\Supply\MC-ISAR_AS440_TC3xx_BASIC_2.30.0
#Path to Mcal CDD Package
MCAL_PATH_CD = ..\ThirdParty\Mcal_Tc3xx\Supply\MC-ISAR_AS440_TC3xx_BASIC_2.30.0

#MCAL AUTOSAR version
...
CC_FILES_TO_BUILD += $(MCAL_PATH_BASE)\DemoWorkspace\McalDemo\$(SEL_DERIV)\0_Src\BaseSw\Infra\Autosar_Srv\Mcal_SafetyError.c	\
						$(MCAL_PATH_BASE)\DemoWorkspace\McalDemo\$(SEL_DERIV)\0_Src\BaseSw\Infra\Autosar_Srv\Mcal_Wrapper.c
endif
#End of DEMO Sources

#MCALLIB
ifneq ($(MCAL_EXCLUDE_MCALLIB),1)
MCALLIB_BASE_PATH = $(MCAL_PATH_BASE)\McIsar\Src\Mcal\Tricore\McalLib\ssc

CC_FILES_TO_BUILD += $(MCALLIB_BASE_PATH)\src\McalLib.c

CC_INCLUDE_PATH += $(MCALLIB_BASE_PATH)\inc		\
					$(MCALLIB_BASE_PATH)\inc\$(MCAL_ASRVERSION)
endif
#End of MCALLIB
...
# e.g.:  ADDITIONAL_INCLUDES += $(GENDATA_DIR)\inc
