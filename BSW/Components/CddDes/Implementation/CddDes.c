...
#define CDDDES_DEM_NUM_STATUS_CHANGES       (9u)
 ...
 *********************************************************************************************************************/
                                                            ...
                                                            /* Helper Macros */
/* ------------------------------------------------------------------------- */
#define CddDes_SetHighNibble(Var, HighNibble) ( (Var) = (((Var) & CDDDES_LOW_NIBBLE)  | ((HighNibble) & CDDDES_HIGH_NIBBLE)) )  /*!< Clears and sets the high nibble of Var to the high nibble stored in HighNibble */   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_SetLowNibble(Var, LowNibble)   ( (Var) = (((Var) & CDDDES_HIGH_NIBBLE) | ((LowNibble) & CDDDES_LOW_NIBBLE)) )    /*!< Clears and sets the low nibble of Var to the low nibble stored in LowNibble */   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_GetHighNibble(Var)             ( (Var) & CDDDES_HIGH_NIBBLE ) /*!< Masks and returns the high nibble of Var */   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_GetLowNibble(Var)              ( (Var) & CDDDES_LOW_NIBBLE )  /*!< Masks and returns the low nibble of Var */   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Util_Make16Bit(hiByte, loByte) ((uint16)((((uint16)(hiByte))<<8) | ((uint16)(loByte)))) /*!< Compose a word from single bytes */ /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

                                                               /* Assertions */
/* ------------------------------------------------------------------------- */
#if (CDDDES_DEV_ERROR_REPORT == STD_ON)
/*! Wrapper to call Det_ReportError */
# define CddDes_Det_ReportError(ApiId, ErrorCode)   (void)Det_ReportError(CDDDES_MODULE_ID, CDDDES_INSTANCE_ID_DET, (ApiId), (ErrorCode));                  /* PRQA S 3412, 3453 */ /* MD_MSR_19.4, MD_MSR_FctLikeMacro */
#else
/*! Wrapper to call Det_ReportError */
...
# define CddDes_Det_ErrorRegisterDefine()           uint8 lErrorId;                                                                 /* PRQA S 3412, 3453 */ /* MD_MSR_19.4, MD_MSR_FctLikeMacro */
/*! Set error register with DET error code */
# define CddDes_Det_ErrorRegisterSet(value)         lErrorId = (value);                                                             /* PRQA S 3412, 3453 */ /* MD_MSR_19.4, MD_MSR_FctLikeMacro */
/*! Get error register with DET error code */
# define CddDes_Det_ErrorRegisterGet()              lErrorId                                                                        /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#else
/*! Define local variable for DET error code  */
# define CddDes_Det_ErrorRegisterDefine()                                                                                           /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Set error register with DET error code */
# define CddDes_Det_ErrorRegisterSet(value)                                                                                         /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Get error register with DET error code */
# define CddDes_Det_ErrorRegisterGet()                                                                                              /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#endif


                                                           /* PduR Interface */
/* ------------------------------------------------------------------------- */
#define CddDes_Pdur_SetConnectionState(Connection, Val)             CddDes_Pdur_ConnectionContext[(Connection)].State = (Val)  /*!< Set the State of the indicated connection to Val. */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Pdur_GetConnectionState(Connection)                  (CddDes_Pdur_ConnectionContext[(Connection)].State)        /*!< Get the current State of the indicated connection */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Pdur_SetConnectionBufferIndex(Connection, Val)       CddDes_Pdur_ConnectionContext[(Connection)].Index = (Val)  /*!< Set the read/write position index of the currently processed message on the indicated connection to Val. */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Pdur_GetConnectionBufferIndex(Connection)            (CddDes_Pdur_ConnectionContext[(Connection)].Index)        /*!< Get the read/write position index of the currently processed message on the indicated connection. */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Pdur_SetConnectionMessageLength(Connection, Val)     CddDes_Pdur_ConnectionContext[(Connection)].Length = (Val) /*!< Set the currently processed message length of the indicated connection to Val. */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Pdur_GetConnectionMessageLength(Connection)          (CddDes_Pdur_ConnectionContext[(Connection)].Length)       /*!< Get the length of the currently processed message. */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Pdur_SetConnectionTxBufferHandle(Connection, Val)    CddDes_Pdur_ConnectionContext[(Connection)].TxBufferHandle = (Val) /*!< Sets the Buffer Handle of Connection to either the 'internal' TP buffer or the 'status collection buffer' for Transmission. */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Pdur_GetConnectionTxBufferHandle(Connection)         (CddDes_Pdur_ConnectionContext[(Connection)].TxBufferHandle)       /*!< Gets the Buffer Handle of Connection used for transmission. */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Pdur_GetConnectionTpBufferPtr(Connection)            (CddDes_Pdur_ConnectionContext[(Connection)].BufferPtr)     /*!< Get the pointer to the TpBuffer of Connection */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */


                                                    /* Core Processing State */
/* ------------------------------------------------------------------------- */

#define CddDes_Core_GetMessageType(Connection)                      ((CddDes_Pdur_GetConnectionTpBufferPtr(Connection)[0]) & CDDDES_MESSAGE_TYPE_MASK)    /*!< Returns the first byte of the Pdur Tp Message Buffer of Connection. The first byte of each message is used to indicate the MessageType. The message type bitmask is applied to avoid that 0xFF ("no message") is ever read as message type. */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_SetMessageType(Connection, MessageType)         CddDes_Pdur_GetConnectionTpBufferPtr(Connection)[0] = (MessageType)  /*!< Sets the first byte of the Pdur Tp Message Buffer of Connection to MessageType. */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Core_GetMessagePayloadPtr(Connection)                (&CddDes_Pdur_GetConnectionTpBufferPtr(Connection)[CDDDES_CORE_MSG_HDR_LENGTH])  /*!< Get the pointer to the TpBuffer of Connection after the header */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetMessagePayloadLength(Connection)             (CddDes_Pdur_GetConnectionMessageLength(Connection) - CDDDES_CORE_MSG_HDR_LENGTH)    /*!< Get the length of the message, after subtracting the length of the message header */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Core_SetLastReceivedMessage(Connection, MessageType) (CddDes_Core_State.LastReceivedMessage[(Connection)] = (MessageType)) /*!< Remembers the MessageType when receiving a message. Used in the main function to check if a message was received */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetLastReceivedMessage(Connection)              (CddDes_Core_State.LastReceivedMessage[(Connection)])                 /*!< Returns the MessageType of the last received message. */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_ClearLastReceivedMessage(Connection)            CddDes_Core_SetLastReceivedMessage((Connection), CDDDES_MESSAGE_NONE) /*!< Clears the last received message. The last received message shall be cleared after the trigger was processed from the main function. */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Core_SetLastTxConfirmation(Connection, Result)       (CddDes_Core_State.LastTxConfirmation[(Connection)] = (Result))             /*!< Remembers the result of a TxConfirmation when transmitting a message. Used in the main function to check if a message was transmitted */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetLastTxConfirmation(Connection)               (CddDes_Core_State.LastTxConfirmation[(Connection)])                        /*!< Returns TxConfirmation result of the last transmitted message. */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_ClearLastTxConfirmation(Connection)             CddDes_Core_SetLastTxConfirmation((Connection), CDDDES_TXCONFIRMATION_NONE) /*!< Clears the last TxConfirmation. The last TxConfirmation shall be cleared before waiting for a new TxConfirmation. */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Core_SetTimeoutCounter(Timeout, Value)               (CddDes_Core_State.TimeoutCounter[(Timeout)] = (CddDes_TimeoutCounterType)(Value))  /*!< Sets the timeout counter Timeout to Value */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetTimeoutCounter(Timeout)                      (CddDes_Core_State.TimeoutCounter[(Timeout)])            /*!< Gets the counter value of timeout Timeout (used connection specific)*/  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetProtocolTimeoutCounter()                     (CddDes_Core_GetTimeoutCounter(CDDDES_PROTOCOL_TIMER))   /*!< Gets the counter value of protocol timeout (used for the periodic transmission) */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_DecrementTimeoutCounter(Timeout)                (CddDes_Core_State.TimeoutCounter[(Timeout)]--)          /*!< Decrements the timeout counter of timeout Timeout */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_IsTimeoutElapsed(Timeout)                       ((boolean)(CddDes_Core_GetTimeoutCounter(Timeout) == 0u)) /*!< Returns true if the counter value of timeout Timeout has reached zero */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Core_SetProtocolProcessingState(ProcessingState)     (CddDes_Core_State.TopLevelState = (ProcessingState))    /*!< Sets the Processing State of the Top Level State Machine */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetProtocolProcessingState()                    (CddDes_Core_State.TopLevelState)                        /*!< Gets the Processing State of the Top Level State Machine */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Core_SetEstablishConnectionState(ProcessingState)    (CddDes_Core_State.SubLevelState = (ProcessingState))    /*!< Sets the Processing State of the Sub-Level State machine when in State 'Establish Connection' */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetEstablishConnectionState()                   (CddDes_Core_State.SubLevelState)                        /*!< Gets the Processing State of the Sub-Level State machine when in State 'Establish Connection' */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Core_SetInitialSynchronizationState(ProcessingState) (CddDes_Core_State.SubLevelState = (ProcessingState))    /*!< Sets the Processing State of the Sub-Level State machine when in State 'Initial Synchronization' */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetInitialSynchronizationState()                (CddDes_Core_State.SubLevelState)                        /*!< Gets the Processing State of the Sub-Level State machine when in State 'Initial Synchronization' */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Core_SetConnectedState(ProcessingState)              (CddDes_Core_State.SubLevelState = (ProcessingState))    /*!< Sets the Processing State of the Sub-Level State machine when in State 'Connected'. Careful: The Sub-State 'Connected' has two state machines that use the higher respectively lower nibble of the state variable */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetConnectedState()                             (CddDes_Core_State.SubLevelState)                        /*!< Gets the Processing State of the Sub-Level State machine when in State 'Connected' */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Core_SetTxNackState(ProcessingState)                 (CddDes_Core_State.SubLevelState = (ProcessingState))    /*!< Sets the Processing State of the Sub-Level State machine when in State 'TX_NACK'. Careful: The Sub-State 'Connected' has two state machines that use the higher respectively lower nibble of the state variable */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetTxNackState()                                (CddDes_Core_State.SubLevelState)                        /*!< Gets the Processing State of the Sub-Level State machine when in State 'TX_NACK' */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Core_SetMasterTxNackState(ProcessingState)           (CddDes_SetHighNibble(CddDes_Core_State.SubLevelState, (ProcessingState)))  /*!< Sets the Processing State of the Master TxNack Sub-Level State machine */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetMasterTxNackState()                          (CddDes_GetHighNibble(CddDes_Core_State.SubLevelState))                     /*!< Gets the Processing State of the Master TxNack Sub-Level State machine */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Core_SetDependentTxNackState(ProcessingState)        (CddDes_SetLowNibble(CddDes_Core_State.SubLevelState, (ProcessingState)))   /*!< Sets the Processing State of the Dependent TxNack Sub-Level State machine */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetDependentTxNackState()                       (CddDes_GetLowNibble(CddDes_Core_State.SubLevelState))                      /*!< Gets the Processing State of the Dependent TxNack Sub-Level State machine */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Core_SetSyncTransmissionState(ProcessingState)       (CddDes_SetHighNibble(CddDes_Core_State.SubLevelState, (ProcessingState)))  /*!< Sets the Processing State of the Sync Message RX Sub-Level State machine */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetSyncTransmissionState()                      (CddDes_GetHighNibble(CddDes_Core_State.SubLevelState))                     /*!< Gets the Processing State of the Sync Message RX Sub-Level State machine */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Core_SetSyncReceptionState(ProcessingState)          (CddDes_SetLowNibble(CddDes_Core_State.SubLevelState, (ProcessingState)))   /*!< Sets the Processing State of the Sync Message TX Sub-Level State machine */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetSyncReceptionState()                         (CddDes_GetLowNibble(CddDes_Core_State.SubLevelState))                      /*!< Gets the Processing State of the Sync Message TX Sub-Level State machine */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Core_SetSyncMessageProcessingIndex(Index)            (CddDes_Core_State.SyncMessageProcessingIndex = (Index))                    /*!< Sets the Processing Index of for processing a received Sync Message */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetSyncMessageProcessingIndex()                 (CddDes_Core_State.SyncMessageProcessingIndex)                              /*!< Gets the Processing Index of for processing a received Sync Message */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetSyncMessageCurrentEventType()                (CddDes_Core_GetMessagePayloadPtr(CDDDES_CORE_SYNC_RECEPTION_CONNECTION)[CddDes_Core_GetSyncMessageProcessingIndex()])  /*!< Gets the byte at the current Processing Index of a received Sync Message */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetSyncMessageCurrentEventPayloadPtr()          (&(CddDes_Core_GetMessagePayloadPtr(CDDDES_CORE_SYNC_RECEPTION_CONNECTION)[CddDes_Core_GetSyncMessageProcessingIndex()+CDDDES_MESSAGELENGTH_SYNCHDR]))  /*!< Gets the byte at the current Processing Index of a received Sync Message */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetSyncMessageLength()                          (CddDes_Core_GetMessagePayloadLength(CDDDES_CORE_SYNC_RECEPTION_CONNECTION)) /*!< Returns the length of the received Sync Message */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_GetSyncMessageEndOfCurrentEvent(eventSize)      ((CddDes_BufferSizeType)(CddDes_Core_GetSyncMessageProcessingIndex() + CDDDES_MESSAGELENGTH_SYNCHDR + (eventSize)))  /*!< Returns the processing index pointing to the beginning of the next SyncEvent (current processing index + length of the given length */  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
...
#define CddDes_Core_Buffer_GetWriteIndex()                          (CddDes_CollectionBuffer.WriteIndex)                                                                                      /*!< Returns the WriteIndex */   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_Buffer_GetReadIndex()                           (CddDes_CollectionBuffer.ReadIndex)                                                                                       /*!< Returns the ReadIndex */   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_Buffer_SetWriteIndex(Index)                     (CddDes_CollectionBuffer.WriteIndex=(Index))                                                                              /*!< Sets the WriteIndex without considering the wrap arround! */   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_Buffer_SetReadIndex(Index)                      (CddDes_CollectionBuffer.ReadIndex=(Index))                                                                               /*!< Sets the ReadIndex without considering the wrap arround! */   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_Buffer_ReadByteAbs(Index)                       (CddDes_CollectionBuffer.Buffer[((Index)%(CDDDES_CFG_COLLECTION_BUFFER_SIZE))])                                           /*!< Reads a byte from the ringbuffer, using the absolute index, considering the wrap-arround */   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_Buffer_WriteByteAbs(Index, Value)               (CddDes_CollectionBuffer.Buffer[((Index)%(CDDDES_CFG_COLLECTION_BUFFER_SIZE))] = (Value))                                 /*!< Writes a byte to the ringbuffer, using the absolute index, considering the wrap-arround */   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_Buffer_ReadByteRelative(Offset)                 (CddDes_Core_Buffer_ReadByteAbs(CddDes_CollectionBuffer.ReadIndex+(Offset)))                                              /*!< Reads a byte from the ringbuffer, relative from the read index, considering the wrap-arround */   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Core_Buffer_WriteByteRelative(Offset, Value)         (CddDes_Core_Buffer_WriteByteAbs(CddDes_CollectionBuffer.WriteIndex+(Offset), (Value)))                                   /*!< Writes a byte to the ringbuffer, relative to the write index, considering the wrap-arround */   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#define CddDes_Core_GetSyncEventLength(Event)                       (CddDes_SyncEventLengthTable[(Event)])                                                                                    /*!< Returns the length of the sync event or VAR_LENGTH if length field follows after type */    /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */             

                                                     /* Configuration Access */
/* ------------------------------------------------------------------------- */
#define CddDes_Cfg_GetConnectionFromRxPdu(PduId)       CddDes_GetConnectionTableIdxOfRxPduMap(PduId)                                            /*!< Retrieve the connection to a given RxPduId */    /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Cfg_GetConnectionFromTxPdu(PduId)       CddDes_GetConnectionTableIdxOfTxPduMap(PduId)                                            /*!< Retrieve the connection to a given TxPduId */    /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Cfg_GetConnectionTpBufferSize(Connection) CddDes_GetTpBufferSizeOfConnectionTable(Connection)                                    /*! Retrieve the Tp buffer size for a given connection */   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define CddDes_Cfg_GetTxPduFromConnection(Connection)    CddDes_GetCddPduRUpperLayerTxPduSymNameOfConnectionTable(Connection)                   /*! Retrieve the TxPduId to a given connection */     /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
...
CDDDES_LOCAL CONST(CddDes_BufferSizeType, CDDDES_CONST) CddDes_SyncEventLengthTable[CDDDES_NUM_SYNCEVENTS] =
{
 /* CDDDES_SYNCEVENT_DTC_PASSED */ 3u,   /* one uint24 parameter */
 /* CDDDES_SYNCEVENT_DTC_FAILED */ 3u,   /* one uint24 parameter */
 /* CDDDES_SYNCEVENT_CLEAR_DTC  */ 3u    /* one uint24 parameter */
}; 
 ...
 *  \reentrant    FALSE
 *  \synchronous  TRUE
 *  \trace        DSGN-CddDes23143, DSGN-CddDes23131
 *********************************************************************************************************************/
  ...
  )
{
  ...
  CddDes_Core_SetInitialSynchronizationState(CDDDES_PROTOCOL_STATE_INVALID);  /* PRQA S 1840, 2982 */ /* MD_CddDes_MISRA2012-Rule2.2_SubStateInit */
  CddDes_Core_SetEstablishConnectionState(CDDDES_PROTOCOL_STATE_INVALID);     /* PRQA S 1840, 2982 */ /* MD_CddDes_MISRA2012-Rule2.2_SubStateInit */
  CddDes_Core_SetSyncTransmissionState(CDDDES_PROTOCOL_STATE_INVALID);        /* PRQA S 1840, 2982 */ /* MD_CddDes_MISRA2012-Rule2.2_SubStateInit */
  CddDes_Core_SetSyncReceptionState(CDDDES_PROTOCOL_STATE_INVALID);           /* PRQA S 1840, 2982 */ /* MD_CddDes_MISRA2012-Rule2.2_SubStateInit */
  CddDes_Core_SetTxNackState(CDDDES_PROTOCOL_STATE_INVALID);                  /* PRQA S 1840, 2982 */ /* MD_CddDes_MISRA2012-Rule2.2_SubStateInit */
  ...
  )
{
  ...
  {
    if (CddDes_Core_GetTimeoutCounter(timeoutIterator) > 0u)
    {
...
#if (CDDDES_CFG_SUPPORT_DEPENDENT == STD_ON)
  if (CddDes_Core_GetProtocolTimeoutCounter() == 0u) /* Protocol Timeout elapsed.. */
  {
    /* Transition to State "Establish Connection */
    CddDes_Core_SetNextProtocolProcessingState(CDDDES_PROTOCOL_STATE_ESTABLISH_CONNECTION);
  }
  ...
  )
{
  ...
  switch (CddDes_Core_GetMasterTxNackState())
  {
    case CDDDES_PROTOCOL_SUBSTATE_ENTRY:
    {
      ...
      {
        /* Transition to State "Transmit NACK" */
        CddDes_Core_SetMasterTxNackState(CDDDES_PROTOCOL_SUBSTATE_MASTER_TRANSMIT_NACK); /* PRQA S 2985 */ /* MD_CddDes_MISRA2012-Rule2.2_Protection */
      ...
      {
        CddDes_Core_SetMasterTxNackState(CDDDES_PROTOCOL_SUBSTATE_MASTER_EXIT); /* PRQA S 2985 */ /* MD_CddDes_MISRA2012-Rule2.2_Protection */
      }
      break;
    }
    case CDDDES_PROTOCOL_SUBSTATE_MASTER_TRANSMIT_NACK:
    {
      ...
      {
        if (CddDes_Core_IsTimeoutElapsed(CDDDES_CFG_CONNECTION_MASTER) == TRUE) /* PRQA S 4304 */ /* MD_MSR_AutosarBoolean */
        {
  ...
  )
{
  ...
  switch (CddDes_Core_GetDependentTxNackState())
  {
    case CDDDES_PROTOCOL_SUBSTATE_ENTRY:
    {
      ...
      {
        /* Transition to State "Transmit NACK" */
        CddDes_Core_SetDependentTxNackState(CDDDES_PROTOCOL_SUBSTATE_DEPENDENT_TRANSMIT_NACK); /* PRQA S 2985 */ /* MD_CddDes_MISRA2012-Rule2.2_Protection */
      ...
      {
        CddDes_Core_SetDependentTxNackState(CDDDES_PROTOCOL_SUBSTATE_DEPENDENT_EXIT); /* PRQA S 2985 */ /* MD_CddDes_MISRA2012-Rule2.2_Protection */
      }
      break;
    }
    case CDDDES_PROTOCOL_SUBSTATE_DEPENDENT_TRANSMIT_NACK:
    {
      ...
      {
        if (CddDes_Core_IsTimeoutElapsed(CDDDES_CFG_CONNECTION_DEPENDENT) == TRUE) /* PRQA S 4304 */ /* MD_MSR_AutosarBoolean */
        {
          /* We failed to transmit the NACK message in time! Release Connection. */
          CddDes_Pdur_ReleaseConnection(CDDDES_CFG_CONNECTION_DEPENDENT);
  ...
  )
{
  switch (CddDes_Core_GetEstablishConnectionState())
  {
    ...
    {
      /* Reset the Timer on entry.. */
      CddDes_Core_SetTimeoutCounter(CDDDES_CFG_CONNECTION_MASTER, (CDDDES_CFG_RETRIES_TRANSMISSION-1u)); /* As this state is "fall-through", the first trial happens in this task cycle */
      CddDes_Core_SetEstablishConnectionState(CDDDES_PROTOCOL_SUBSTATE_EST_CON_REQUEST_CONNECTION);
      /* Intentionally skipping break; */
    }
    /* fall through */
    case CDDDES_PROTOCOL_SUBSTATE_EST_CON_REQUEST_CONNECTION:  /* PRQA S 2003 */ /* MD_CddDes_MISRA2012-Rule16.3_NoBreak */
    {
      /* Possible Transitions out of this sub-state are:
  ...
  )
{
  switch (CddDes_Core_GetSyncReceptionState())
  {
    ...
    /* fall through */
    case CDDDES_PROTOCOL_SUBSTATE_RX_WAIT_SYNC_MSG:       /* PRQA S 2003 */ /* MD_CddDes_MISRA2012-Rule16.3_NoBreak */
    {
      /*
...
#endif
        {
          if (CddDes_Core_IsTimeoutElapsed(CDDDES_CORE_SYNC_RECEPTION_CONNECTION) == TRUE) /* PRQA S 4304 */ /* MD_MSR_AutosarBoolean */
          {
            CddDes_Core_SetSyncReceptionState(CDDDES_PROTOCOL_SUBSTATE_RX_EXIT_NOT_OK);
          }
        }
    ...
    {
      if(CddDes_Core_ProcessReceivedSyncMessage() == CDDDES_OPERATION_COMPLETED) /* PRQA S 2991, 2995 */ /*  MD_CddDes_MISRA2012-Rule14.3_MasterNoAsync */
      {
      ...
      /* else: Continue next task cycle */
      break;
    }
    case CDDDES_PROTOCOL_SUBSTATE_RX_TRANSMIT_RESPONSE:   /* PRQA S 2003 */ /* MD_CddDes_MISRA2012-Rule16.3_NoBreak */
    {
  ...
  )
{
  switch (CddDes_Core_GetSyncTransmissionState())
  {
    ...
    /* fall through */
    case CDDDES_PROTOCOL_SUBSTATE_TX_WAIT_STATUS_CHANGED:     /* PRQA S 2003 */ /* MD_CddDes_MISRA2012-Rule16.3_NoBreak */
    {
      ...
      */
#if (CDDDES_CFG_SUPPORT_MASTER == STD_ON)
      if(CddDes_Core_Buffer_GetReadAvailable() > 0u)
      {
      ...
      if ( (CddDes_Core_Buffer_GetReadAvailable() >= CDDDES_CFG_COLLECTION_BUFFER_TRANSMIT_THRESHOLD) 
        || (CddDes_Core_IsTimeoutElapsed(CDDDES_PROTOCOL_TIMER) == TRUE) ) /* PRQA S 4304 */ /* MD_MSR_AutosarBoolean */
      {
        transmitCondition = TRUE;
      }
#endif
    ...
    {
      if (CddDes_Core_IsTimeoutElapsed(CDDDES_CORE_SYNC_TRANSMISSION_CONNECTION) == TRUE) /* PRQA S 4304 */ /* MD_MSR_AutosarBoolean */
      {
  ...
  )
{
  ...
  if (considerWriteWrap == TRUE)
  {
    ...
    bytesAvailable = (CDDDES_CFG_COLLECTION_BUFFER_SIZE + CddDes_Core_Buffer_GetWriteIndex()) - CddDes_Core_Buffer_GetReadIndex();   /* PRQA S 0404 */ /* MD_CddDes_MISRA2012-Rule1.3_VolatileIndex */
  }
  else
  {
    bytesAvailable = CddDes_Core_Buffer_GetWriteIndex() - CddDes_Core_Buffer_GetReadIndex(); /* PRQA S 0404 */ /* MD_CddDes_MISRA2012-Rule1.3_VolatileIndex */
  }
  ...
  )
{
  ...
  if(CddDes_Core_Buffer_GetReadIndex() > CddDes_Core_Buffer_GetWriteIndex()) /* PRQA S 0404 */ /* MD_CddDes_MISRA2012-Rule1.3_VolatileIndex */
  {
  ...
  )
{
  ...
  if (CddDes_Core_Buffer_GetWriteIndex() < CddDes_Core_Buffer_GetReadIndex()) /* PRQA S 0404 */ /* MD_CddDes_MISRA2012-Rule1.3_VolatileIndex */
  {
    bytesAvailable = CddDes_Core_Buffer_GetReadIndex() - CddDes_Core_Buffer_GetWriteIndex(); /* PRQA S 0404 */ /* MD_CddDes_MISRA2012-Rule1.3_VolatileIndex */
  }
  else
  {
    /* We have to consider the wrap-arround here.. */
    bytesAvailable = (CDDDES_CFG_COLLECTION_BUFFER_SIZE + CddDes_Core_Buffer_GetReadIndex()) - CddDes_Core_Buffer_GetWriteIndex(); /* PRQA S 0404 */ /* MD_CddDes_MISRA2012-Rule1.3_VolatileIndex */
  }
  ...
  )
{
  ...
  if ( ((Offset + segmentOffset) >= CDDDES_MESSAGELENGTH_SYNCHDR) && (Length>segmentOffset) )
  {
    retVal = CddDes_Core_Buffer_ReadBytesRelative(
                   ...
                   (CddDes_BufferSizeType)((Offset + segmentOffset) - CDDDES_MESSAGELENGTH_SYNCHDR),
                   (CddDes_BufferSizeType)(Length - segmentOffset)
             );
  }
  ...
  )
{
  ...
  const CddDes_BufferSizeType messageLength = CDDDES_MESSAGELENGTH_SYNCHDR + CddDes_Core_GetSyncEventLength(EventType); /* Type + Parm */
  Std_ReturnType retVal = E_NOT_OK;
  ...
  {
    uint8_least bytePos;
    CddDes_Core_Buffer_WriteByteRelative(0u, EventType);
    ...
    {
      CddDes_Core_Buffer_WriteByteRelative((CDDDES_MESSAGELENGTH_SYNCHDR + bytePos), (uint8)paramValue);
      paramValue=paramValue>>8u; /* Shift to next byte.*/
    }
    ...
    */
...
#endif
    {
      ...
      if (CddDes_Core_GetSyncMessageEndOfCurrentEvent(eventSize) <= CddDes_Core_GetSyncMessageLength())
      {
        ...
        if (CddDes_Core_ProcessSyncEvent(eventType, DTC) == CDDDES_OPERATION_COMPLETED) /* PRQA S 2991, 2995 */ /*  MD_CddDes_MISRA2012-Rule14.3_MasterNoAsync */
        {
          CddDes_Core_SetSyncMessageProcessingIndex(CddDes_Core_GetSyncMessageEndOfCurrentEvent(eventSize));
        }
        else
        {
          retVal = CDDDES_OPERATION_PENDING; /* Continue in the next task cycle */
        }
      }
...
FUNC(void, CDDDES_CODE) CddDes_Init(
  P2CONST(CddDes_ConfigType, AUTOMATIC, CDDDES_PBCFG) ConfigPtr   /* PRQA S 3206, 3673 */ /* MD_CddDes_MISRA2012-Rule2.7_AutosarApi, MD_MSR_Rule8.13 */
  )
{
  /* ----- Local Variables ---------------------------------------------- */
...
/* Check initialization state of the component */
  ...
  CDDDES_DUMMY_STATEMENT(ConfigPtr);    /* PRQA S 1338 */ /* MD_MSR_DummyStmt */ /*lint -e{438} */
}
  ...
  )
{
  ...
  else if (CddDesTxPduId >= CddDes_GetSizeOfTxPduMap())
  {
...
#if (CDDDES_DEV_ERROR_DETECT == STD_ON)                                                                                                                
    if(lConnection >= CddDes_GetSizeOfConnectionTable())
    {
      CddDes_Det_ErrorRegisterSet(CDDDES_E_PARAM_CONFIG)
    }
    else if (CddDes_Pdur_GetConnectionState(lConnection) != CDDDES_PDUR_TX_COPY)
    {
...
FUNC(BufReq_ReturnType, CDDDES_CODE) CddDes_StartOfReception(
  ...
  P2VAR(PduInfoType, AUTOMATIC, CDDDES_APPL_DATA) PduInfoPtr,           /* PRQA S 3206, 3673 */ /* MD_CddDes_MISRA2012-Rule2.7_AutosarApi, MD_MSR_Rule8.13 */
  ...
  )
{
  ...
  else if (CddDesRxPduId >= CddDes_GetSizeOfRxPduMap())
  {
  ...
  CDDDES_DUMMY_STATEMENT(PduInfoPtr); /* PRQA S 1338 */ /* MD_MSR_DummyStmt */ /*lint -e{438} */
...
FUNC(BufReq_ReturnType, CDDDES_CODE) CddDes_CopyRxData(
  PduIdType CddDesRxPduId,
  P2VAR(PduInfoType, AUTOMATIC, CDDDES_APPL_DATA) PduInfoPtr,            /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
  P2VAR(PduLengthType, AUTOMATIC, CDDDES_APPL_DATA) BufferSizePtr
  )
{
  /* ----- Local Variables ---------------------------------------------- */
  CddDes_Det_ErrorRegisterDefine()
  BufReq_ReturnType lResult = BUFREQ_E_NOT_OK; /* PRQA S 2981 */ /* MD_MSR_RetVal */
...
#endif
  {
    ...
    else if (CddDes_Pdur_GetConnectionState(lConnection) != CDDDES_PDUR_RX_COPY)
    {
      CddDes_Det_ErrorRegisterSet(CDDDES_E_ILLEGAL_STATE)
    }
...
FUNC(BufReq_ReturnType, CDDDES_CODE) CddDes_CopyTxData(
  PduIdType CddDesTxPduId,
  P2VAR(PduInfoType, AUTOMATIC, CDDDES_APPL_DATA) PduInfoPtr,           /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
  P2VAR(RetryInfoType, AUTOMATIC, CDDDES_APPL_DATA) Retry,              /* PRQA S 3206, 3673 */ /* MD_CddDes_MISRA2012-Rule2.7_AutosarApi, MD_MSR_Rule8.13 */
  ...
  )
{
  ...
  CDDDES_DUMMY_STATEMENT(Retry);   /* PRQA S 1338, 3206 */ /* MD_MSR_DummyStmt */ /*lint -e{438} */
  ...
  )
{
  ...
  CDDDES_LOCAL CONST(CddDes_Dem_DtcStatusTriggerTableType, CDDDES_CONST) CddDes_Dem_DtcStatusTriggerTable[CDDDES_DEM_NUM_STATUS_CHANGES] =
  { 
...
FUNC(Std_ReturnType, CDDDES_CODE) CddDes_ClearDtcNotification(
  uint32 DTC,
  Dem_DTCFormatType DTCFormat, /* PRQA S 3206 */ /* MD_CddDes_MISRA2012-Rule2.7_AutosarApi */
...
# endif
  ...
  CDDDES_DUMMY_STATEMENT(DTCFormat);    /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
  ...
  )
{
  ...
  {
    retVal += ((uint32)Buffer[sourceBytePos]) << (8u * sourceBytePos);
  }
...
MD_CddDes_MISRA2012-Rule2.7_AutosarApi:
      Description: Rule 2.7 There should be no unused parameters in functions
      Reason:      API defined by Autosar, but not all parameters are required for CddDes.
      Risk:        None.
      Prevention:  None.

 MD_CddDes_MISRA2012-Rule14.3_MasterNoAsync
      Description: Rule 14.3 Controlling expressions shall not be invariant
      Reason:      CddDes supports different usecases. Currently in the "Master" usecase there are no asynchronous
                   operations so the result is never "pending". 
      Risk:        None.
      Prevention:  None.

 MD_CddDes_MISRA2012-Rule16.3_NoBreak:
 ...
 MD_CddDes_MISRA2012-Rule2.2_SubStateInit
      Description: Rule 2.2 There shall be no dead code
      Reason:      Substates are all mapped to the same variable but use separate access macros. All substatemachines 
                   are initialized resulting in the same statement after preprocessor processing.
      Risk:        None.
      Prevention:  None.

 MD_CddDes_MISRA2012-Rule2.2_Protection
      Description: Rule 2.2 There shall be no dead code
      Reason:      CddDes applies a bitmask when setting the low/high nibble, however, the macros used do not any
                   bits that are supposed to be masked out.
      Risk:        None.
      Prevention:  None.

 MD_CddDes_MISRA2012-Rule1.3_VolatileIndex
 Description: Rule 1.3 There shall be no occurrence of undefined or critical unspecified behavior
      Reason:      CddDes uses ReadIndex and WriteIndex of a ring buffer to compute the number of available bytes.
                   Both indexes might change. 
      Risk:        Data might change at undefined point in time.
      Prevention:  In case one of those changes might result in error, a critical section is used to protect against
                   changes. Clearly documented expected "worst case" error, code inspection.
*/
