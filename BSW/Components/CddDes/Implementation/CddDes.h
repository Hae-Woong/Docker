 ...
 *  02.00.00  2019-07-15  vissko   DIAG-311     The CddDes complies to MISRA 2012.
 *  02.00.01  2019-08-26  vissko   DIAG-495     The CddDes MemMap complies to MISRA 2012.
 *  02.00.02  2021-02-16  vissko   TAR-9        Trivial Change: Remove invalid keyword from comment.
 *  03.00.00  2021-10-22  vissko   DEM-5761     Remove DET check for 'PduInfoPtr' parameter in CddDes_StartOfReception
 *                                 DEM-6281     Justify QAC MISRA-2021 MD_CddDes_MISRA2012-Rule14.3_MasterNoAsync
 *  04.00.00  2022-09-21  vissko   DEM-7629     Change CddDes ClientID Ref to AUTOSAR (no change to embedded code).
 *********************************************************************************************************************/
...
# define CDDDES_SW_MAJOR_VERSION                                (4u)
 ...
 *********************************************************************************************************************/
# define CddDes_EnterExclusiveArea_CollectionBuffer() SchM_Enter_CddDes_CDDDES_EXCLUSIVE_AREA_0()    /* PRQA S 3453,3335 */ /* MD_MSR_FctLikeMacro */
# define CddDes_LeaveExclusiveArea_CollectionBuffer() SchM_Exit_CddDes_CDDDES_EXCLUSIVE_AREA_0()     /* PRQA S 3453,3335 */ /* MD_MSR_FctLikeMacro */
