...
# define CDDDES_HANDLE_TP_BUFFER                       (0u)      /*!< Buffer handle for TP buffer */
# define CDDDES_HANDLE_COLLECTION_BUFFER               (1u)      /*!< Buffer handle for collection buffer */
# define CDDDES_HANDLE_INVALID                         (2u)      /*!< Invalid buffer handle */
...
# define CDDDES_MESSAGE_NACK                                         (0x7Fu)    /*!< Negative Acknowledgment: The received message was not expected or could not be processed. */
...
# define CDDDES_TXCONFIRMATION_NONE                                  (0xABu)     /*!< No TxConfirmation received yet */
...
# define CDDDES_PROCESS_SYNC_MESSAGE_STATE_INVALID                   (CDDDES_PROTOCOL_STATE_INVALID)   /*!< Sub-Sub-State (used in CONNECTED, INITAL SYNC RX). */
# define CDDDES_PROCESS_SYNC_MESSAGE_STATE_ENTRY_POINT               (CDDDES_PROTOCOL_SUBSTATE_ENTRY)  /*!< Sub-Sub-State (used in CONNECTED, INITAL SYNC RX). */
# define CDDDES_PROCESS_SYNC_MESSAGE_STATE_READY                     (0x51u)                           /*!< Sub-Sub-State (used in CONNECTED, INITAL SYNC RX). */
# define CDDDES_PROCESS_SYNC_MESSAGE_STATE_READ_NEXT                 (0x52u)                           /*!< Sub-Sub-State (used in CONNECTED, INITAL SYNC RX). */
# define CDDDES_PROCESS_SYNC_MESSAGE_STATE_DISPATCH_DEM              (0x53u)                           /*!< Sub-Sub-State (used in CONNECTED, INITAL SYNC RX). */
# define CDDDES_PROCESS_SYNC_MESSAGE_STATE_WAIT_TASK_CYCLE           (0x54u)                           /*!< Sub-Sub-State (used in CONNECTED, INITAL SYNC RX). */
# define CDDDES_PROCESS_SYNC_MESSAGE_STATE_EXIT_POINT                (CDDDES_PROTOCOL_SUBSTATE_EXIT)   /*!< Sub-Sub-State (used in CONNECTED, INITAL SYNC RX). */
