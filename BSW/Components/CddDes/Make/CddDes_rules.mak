...
#------------------------------------------------------------------------------
# 1.00.00   2017-11-23  Ade     Initial Version
...
LIBRARIES_TO_BUILD      += CddDes
CddDes_FILES               = CddDes$(BSW_SRC_DIR)\CddDes.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += CddDes$(BSW_SRC_DIR)\CddDes.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\CddDes_Cfg.c
