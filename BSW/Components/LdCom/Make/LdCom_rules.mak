...
#------------------------------------------------------------------------------
# 1.00.00   2014-05-13  visswa  ESCAN00074218  AR4-665: Efficient COM
# 1.01.00   2019-02-06  vircbl  Added support of component-based SIP structure
# 2.00.00   2024-02-06  jdorst  COM-4911       Setup Test2020 test suite
#------------------------------------------------------------------------------
...
LIBRARIES_TO_BUILD      += LdCom
LdCom_FILES              = LdCom$(BSW_SRC_DIR)\LdCom.c
LdCom_FILES             += LdCom$(BSW_SRC_DIR)\LdCom_Reporting.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += LdCom$(BSW_SRC_DIR)\LdCom.c
CC_FILES_TO_BUILD       += LdCom$(BSW_SRC_DIR)\LdCom_Reporting.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\LdCom_PBcfg.c
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\LdCom_Lcfg.c 
