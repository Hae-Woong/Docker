...
VAR(uint8, NVM_PRIVATE_DATA) NvM_SecondaryRedundantBlockDataIntegrityRecord[NVM_MAX_NUM_BYTES_DATAINTEGRITYRECORD];
...
CONST(NvM_IntServiceDescrType, NVM_PRIVATE_CONST) NvM_IntServiceDescrTable_at[(uint32)NVM_INT_FID_NO_JOB_PENDING + 1u] =
{
    ...
    {
        NVM_ACT_ID_InitWriteBlock, NVM_STATE_WRITE_COPY_BUFFER_DATA, NVM_SERVICE_ID_WRITE_BLOCK
    },

    /* NVM_INT_FID_READ_BLOCK */
    {
        NVM_ACT_ID_ReadNvBlock, NVM_STATE_READ_READ_DATA, NVM_SERVICE_ID_READ_BLOCK
    },

    /* NVM_INT_FID_RESTORE_DEFAULTS */
    {
        NVM_ACT_ID_InitRestoreBlockDefaults, NVM_STATE_RESTORE_LOAD_ROM, NVM_SERVICE_ID_RESTORE_BLOCK_DEFAULTS
    },

#if (NVM_API_CONFIG_CLASS == NVM_API_CONFIG_CLASS_3)
    /* NVM_INT_FID_INVALIDATE_NV_BLOCK */
    {
        NVM_ACT_ID_InvalidateNvBlock, NVM_STATE_INVALIDATING_BLOCK, NVM_SERVICE_ID_INVALIDATE_NV_BLOCK
    },

    /* NVM_INT_FID_ERASE_BLOCK */
    {
        NVM_ACT_ID_EraseNvBlock, NVM_STATE_ERASE_ERASE_BLOCK, NVM_SERVICE_ID_ERASE_BLOCK
    },
#else
    /* NVM_INT_FID_INVALIDATE_NV_BLOCK */
    {
        NVM_ACT_ID_Nop, NVM_STATE_FSM_FINISHED, NVM_SERVICE_ID_INVALIDATE_NV_BLOCK
    },

    /* NVM_INT_FID_ERASE_BLOCK */
    {
        NVM_ACT_ID_Nop, NVM_STATE_FSM_FINISHED, NVM_SERVICE_ID_ERASE_BLOCK
    },
#endif
    /* NVM_INT_FID_WRITE_ALL */
    {
        NVM_ACT_ID_InitWriteAll, NVM_STATE_WRITEALL_PROC_BLOCK, NVM_SERVICE_ID_WRITE_ALL
    },

    /* NVM_INT_FID_READ_ALL */
    {
#if (NVM_DYNAMIC_CONFIGURATION == STD_ON)
        NVM_ACT_ID_InitReadAll, NVM_STATE_READALL_PROC_CONFIG_ID, NVM_SERVICE_ID_READ_ALL
#else
        NVM_ACT_ID_InitReadAll, NVM_STATE_READALL_PROC_RAM_BLOCK, NVM_SERVICE_ID_READ_ALL
#endif /* (NVM_DYNAMIC_CONFIGURATION == STD_ON) */
    },
#if(NVM_PRE_READALL_API == STD_ON)
    /* NVM_INT_FID_PRE_READ_ALL */
    {
        NVM_ACT_ID_InitPreReadAll, NVM_STATE_PREREADALL_PREP, NVM_SERVICE_ID_PRE_READ_ALL
    },
#else
    /* NVM_INT_FID_PRE_READ_ALL */
    {
        NVM_ACT_ID_Nop, NVM_STATE_FSM_FINISHED, NVM_SERVICE_ID_PRE_READ_ALL
    },
#endif
#if (NVM_REPAIR_REDUNDANT_BLOCKS_API == STD_ON)
    /* NVM_INT_FID_REPAIR_REDUNDANT_BLOCKS */
    {
        NVM_ACT_ID_RepairRedBlocksInit, NVM_STATE_REPAIRREDUNDANT_MAIN, NVM_SERVICE_ID_REPAIR_REDUNDANT_BLOCKS
    },
#else
    /* NVM_INT_FID_REPAIR_REDUNDANT_BLOCKS */
    {
        NVM_ACT_ID_Nop, NVM_STATE_FSM_FINISHED, NVM_SERVICE_ID_REPAIR_REDUNDANT_BLOCKS
    },
#endif
    /* NVM_INT_FID_NO_JOB_PENDING */
    {
        NVM_ACT_ID_Nop, NVM_STATE_FSM_FINISHED, NVM_SERVICE_ID_MAINFUNCTION
    }
};
    ...
    {
        {
            ...
            },
            {
                ...
                NVM_STATE_ELSEIF{NVM_QRY_ID_LAST_RESULT_OK, NVM_QRY_ID_IS_DATA_INTEGRITY_ALGORITHM_CONFIGURED},
                    NVM_STATE_THEN{NVM_ACT_ID_SetupDataIntegrityVerification_ReadBlock, NVM_ACT_ID_Nop},
                    NVM_NEXT_STATE(NVM_STATE_READ_VERIFY_DATA_INTEGRITY)
            },
            {
        ...
        {
            {
                ...
                NVM_STATE_IF{NVM_QRY_ID_SYNCDECRYPT, NVM_QRY_ID_POST_READ_TRANSFORM},
            ...
            },
            {
                ...
                NVM_STATE_ELSEIF{NVM_QRY_ID_CSM_RETRIES_NECESSARY, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_Wait, NVM_ACT_ID_Nop},
                    NVM_NEXT_STATE(NVM_STATE_READ_DATA_VALIDATION)
            },
            {
        ...
        {
            {
                ...
                NVM_STATE_IF{NVM_QRY_ID_IS_DATA_INTEGRITY_JOB_PENDING, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_ProcessDataIntegrityJob, NVM_ACT_ID_Wait},
                    NVM_NEXT_STATE(NVM_STATE_READ_VERIFY_DATA_INTEGRITY)
            },
            {
                /* successful verification && LossOfRedundancy check enabled -> go to redundancy check */
                NVM_STATE_ELSEIF{NVM_QRY_ID_IS_DATA_INTEGRITY_JOB_FINISHED_SUCCESSFUL, NVM_QRY_ID_BLOCK_CHECK_LOSS_OF_REDUNDANCY},
                    NVM_STATE_THEN{NVM_ACT_ID_ExportDataIntegrityInformation, NVM_ACT_ID_Nop},
                    NVM_NEXT_STATE(NVM_STATE_READ_PRE_CHECK_LOSS_OF_REDUNDANCY)
            },
            {
                /* successful verification && LossOfRedundancy check disabled -> go to data validation */
                NVM_STATE_ELSEIF{NVM_QRY_ID_IS_DATA_INTEGRITY_JOB_FINISHED_SUCCESSFUL, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_ExportDataIntegrityInformation, NVM_ACT_ID_Nop},
                    NVM_NEXT_STATE(NVM_STATE_READ_DATA_VALIDATION)
            }
        },
        {
            /* verification error -> try recovery */
    ...
    {
        {
            ...
            },
            {
                ...
                NVM_STATE_ELSEIF{NVM_QRY_ID_TRUE, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_SetupRedundant, NVM_ACT_ID_ReadNvBlockDataIntegrityRecordOnly},
 ...
 *  WriteBlock
 *********************************************************************************************************************/
    /* NVM_STATE_WRITE_COPY_BUFFER_DATA = initial state of Write Block */
    {
        {
            {   /* Loop: while data copy busy -> copy bytes
                   Note: Implicitly takes care of PreWriteTransform handling
                 */
                NVM_STATE_IF{NVM_QRY_ID_DATA_COPY_BUSY, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_CopyNvDataToBuf, NVM_ACT_ID_Wait},
                    NVM_NEXT_STATE(NVM_STATE_WRITE_COPY_BUFFER_DATA)
            },
#if (NVM_CSM_CIPHERING_ENABLED == STD_ON)
            {   /* Encryption configured */
                NVM_STATE_ELSEIF{NVM_QRY_ID_HAS_ENCRYPTION_JOB, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_ProcessEncryptionJob, NVM_ACT_ID_Nop},
                    NVM_NEXT_STATE(NVM_STATE_WRITE_ENCRYPT_DATA)
            },
#else
            {   /* In case CSM module is not used, this path always has to be false */
                NVM_STATE_ELSEIF{NVM_QRY_ID_FALSE, NVM_QRY_ID_FALSE},
                    NVM_STATE_THEN{NVM_ACT_ID_Nop, NVM_ACT_ID_Nop},
                    NVM_NEXT_STATE(NVM_STATE_FSM_FINISHED)
            },
#endif
            {   /* No encryption BUT DataIntegrity algorithm configured */
                NVM_STATE_ELSEIF{NVM_QRY_ID_IS_DATA_INTEGRITY_ALGORITHM_CONFIGURED, NVM_QRY_ID_TRUE },
                    NVM_STATE_THEN{NVM_ACT_ID_SetupDataIntegrityGeneration, NVM_ACT_ID_Nop},
                    NVM_NEXT_STATE(NVM_STATE_WRITE_GENERATE_DATA_INTEGRITY_INFORMATION)
            }
        },
        {   /* No encryption nor DataIntegrity algorithm configured -> go on with processing */
            NVM_STATE_ELSE{NVM_ACT_ID_Nop, NVM_ACT_ID_Nop},
            NVM_NEXT_STATE(NVM_STATE_WRITE_CHECK_DATAINTEGRITYRECORD_COMPMECHANISM_SKIP)
        }
    },
    ...
    {
        {
            {   /* Loop: CSM job failed but retry possible */
                NVM_STATE_ELSEIF{NVM_QRY_ID_CSM_JOB_ATTEMPT_FAILED, NVM_QRY_ID_CSM_RETRIES_NECESSARY},
                    NVM_STATE_THEN{NVM_ACT_ID_ProcessEncryptionJob, NVM_ACT_ID_Wait},
                    NVM_NEXT_STATE(NVM_STATE_WRITE_ENCRYPT_DATA)
            },
            {   /* CSM job failed, retry attempts exceeded maximum => Abort job with NOK */
                NVM_STATE_ELSEIF{NVM_QRY_ID_CSM_JOB_ATTEMPT_FAILED, NVM_QRY_ID_TRUE},
                    NVM_STATE_ELSE{NVM_ACT_ID_SetReqNotOk, NVM_ACT_ID_FinishWriteBlock},
                    NVM_NEXT_STATE(NVM_STATE_FSM_FINISHED)
            },
            {   /* CSM job succeeded && DataIntegrity algorithm configured */
                NVM_STATE_ELSEIF{NVM_QRY_ID_IS_DATA_INTEGRITY_ALGORITHM_CONFIGURED, NVM_QRY_ID_TRUE },
                    NVM_STATE_THEN{NVM_ACT_ID_SetupDataIntegrityGeneration, NVM_ACT_ID_Nop},
                    NVM_NEXT_STATE(NVM_STATE_WRITE_GENERATE_DATA_INTEGRITY_INFORMATION)
            }
        },
        {   /* CSM job succeeded, no DataIntegrity algorithm configured */
            NVM_STATE_ELSE{NVM_ACT_ID_Nop, NVM_ACT_ID_Nop},
            NVM_NEXT_STATE(NVM_STATE_WRITE_CHECK_DATAINTEGRITYRECORD_COMPMECHANISM_SKIP)
        }
    },
    ...
    {
        {
            {   /* Loop: job busy -> processing */
                NVM_STATE_ELSEIF{NVM_QRY_ID_IS_DATA_INTEGRITY_JOB_PENDING, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_ProcessDataIntegrityJob, NVM_ACT_ID_Wait},
                    NVM_NEXT_STATE(NVM_STATE_WRITE_GENERATE_DATA_INTEGRITY_INFORMATION)
            },
            {   /* Generation job ended successfully => go on processing */
                NVM_STATE_ELSEIF{NVM_QRY_ID_IS_DATA_INTEGRITY_JOB_FINISHED_SUCCESSFUL, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_ExportDataIntegrityInformation, NVM_ACT_ID_Nop},
                    NVM_NEXT_STATE(NVM_STATE_WRITE_CHECK_DATAINTEGRITYRECORD_COMPMECHANISM_SKIP)
            },
            {   /* Generation job failed => Abort job with NOK */
                NVM_STATE_ELSEIF{NVM_QRY_ID_TRUE, NVM_QRY_ID_TRUE},
                    NVM_STATE_ELSE{NVM_ACT_ID_SetReqNotOk, NVM_ACT_ID_FinishWriteBlock},
                    NVM_NEXT_STATE(NVM_STATE_FSM_FINISHED)
            }
    ...
    /* NVM_STATE_WRITE_CHECK_DATAINTEGRITYRECORD_COMPMECHANISM_SKIP */
    {
        {
            {   /* Redundant block => readability check primary block */
                NVM_STATE_ELSEIF{NVM_QRY_ID_PRIMARY_REDUNDANT_BLOCK, NVM_QRY_ID_TRUE},
                    ...
                    NVM_NEXT_STATE(NVM_STATE_WRITE_READABILITY_CHECK_PRIMARY_BLOCK)
            },
            {   /* Native or Dataset block, DataIntegrityRecordCompMechanism configured and matching
                   => skip unnecessary write */
                NVM_STATE_ELSEIF{NvM_QRY_ID_DATAINTEGRITYRECORD_COMP_MECHANISM_SKIPWRITE, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_FinishWriteBlock, NVM_ACT_ID_Nop},
                    NVM_NEXT_STATE(NVM_STATE_FSM_FINISHED)
            },
            {   /* Native or Dataset block, no DataIntegrityRecordCompMechanism configured or not matching */
                NVM_STATE_ELSEIF{NVM_QRY_ID_TRUE, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_WriteNvBlock, NVM_ACT_ID_Nop},
                    NVM_NEXT_STATE(NVM_STATE_WRITE_NV_WRITE_DATA)
            }
        },
        {   /* not used */
            NVM_STATE_ELSE{NVM_ACT_ID_Nop, NVM_ACT_ID_Nop},
    ...
    {
        {
            ...
            {   /* result of primary NvBlock OK -> test secondary NvBlock */
                NVM_STATE_IF{NVM_QRY_ID_PRIMARY_REDUNDANT_BLOCK, NVM_QRY_ID_LAST_RESULT_OK},
                    ...
                    NVM_NEXT_STATE(NVM_STATE_WRITE_READABILITY_CHECK_SECONDARY_BLOCK)
            },
            {   /* result of primary NvBlock not OK -> write primary NvBlock first */
                NVM_STATE_ELSEIF{NVM_QRY_ID_PRIMARY_REDUNDANT_BLOCK, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_WriteNvBlock, NVM_ACT_ID_Nop},
                    NVM_NEXT_STATE(NVM_STATE_WRITE_NV_WRITE_REDUNDANT_DATA)
            }
        },
        {   /* not used */
            NVM_STATE_ELSE{NVM_ACT_ID_Nop, NVM_ACT_ID_Nop},
    ...
    {
        {
            ...
            {   /* Both blocks readable, CRC matches -> no write, finalize job */
                NVM_STATE_ELSEIF{NVM_QRY_ID_LAST_RESULT_OK, NvM_QRY_ID_DATAINTEGRITYRECORD_COMP_MECHANISM_SKIPWRITE},
                   NVM_STATE_THEN{NVM_ACT_ID_FinishWriteBlock, NVM_ACT_ID_Nop},
                   NVM_NEXT_STATE(NVM_STATE_FSM_FINISHED)
            },
    ...
    /* NVM_STATE_WRITE_EXECUTE_NV_WRITE_DATA */
    {
        {
            {   /* nv write not finished -> wait */
                NVM_STATE_IF{NVM_QRY_ID_NV_BUSY, NVM_QRY_ID_TRUE},
 ...
 *********************************************************************************************************************/
    ...
    {
        {
            ...
            {   /* last block not finished, check valid/calcRamBlock
                ...
                NVM_STATE_ELSEIF{NVM_QRY_ID_CALC_RAM_BLOCK_CRC_ENABLED_AND_RAM_VALID, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_Nop, NVM_ACT_ID_Nop},
                    NVM_NEXT_STATE(NVM_STATE_READALL_PREPARE_DATAINTEGRITY_VERIFICATION)
            },
            {   /* not valid or no crc && KillReadAll */
                NVM_STATE_ELSEIF{NVM_QRY_ID_READALL_KILLED, NVM_QRY_ID_TRUE},
    ...
    {
        {
            {   /* Explicit sync configured but not executed yet => attempt to copy RAM data */
                NVM_STATE_IF{NVM_QRY_ID_HAS_EXPLICITSYNCHRONIZATION, NVM_QRY_ID_EXPLICITSYNC_ATTEMPT_NECESSARY},
                    NVM_STATE_THEN{NVM_ACT_ID_CopyRamDataToInternalBuffer, NVM_ACT_ID_Wait},
                    NVM_NEXT_STATE(NVM_STATE_READALL_PREPARE_DATAINTEGRITY_VERIFICATION)
            },
            {   /* Explicit sync failed => no DataIntegrityRecordCompMechanism check, go on FSM processing */
                NVM_STATE_ELSEIF{NVM_QRY_ID_HAS_EXPLICITSYNCHRONIZATION, NVM_QRY_ID_EXPLICITSYNC_ATTEMPT_FAILED},
                    NVM_STATE_THEN{NVM_ACT_ID_Nop, NVM_ACT_ID_Nop},
                    NVM_NEXT_STATE(NVM_STATE_READALL_CHK_SKIP)
            },
            {   /* Either explicit sync success OR no explicit sync => setup verification job  */
                NVM_STATE_ELSEIF{NVM_QRY_ID_TRUE, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_SetupDataIntegrityVerification_ReadAll, NVM_ACT_ID_Nop},
    ...
    {   /* At this point the underlying module is processing or processed the job. The job handling
           will be done by the sub FSM -> cancel the busy NV */
        {
            {   /* NV busy -> cancel and abort sub FSM */
                NVM_STATE_ELSEIF{NVM_QRY_ID_NV_BUSY, NVM_QRY_ID_READALL_KILLED},
 ...
 *  PreReadAll
 *********************************************************************************************************************/
    /* NVM_STATE_PREREADALL_PREP */
    {
        {
            {   /* last block checked -> finalize FSM (readall qry can be reused) */
                NVM_STATE_IF{NVM_QRY_ID_LAST_BLOCK_DONE_READALL, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_Nop, NVM_ACT_ID_Nop},
                    NVM_NEXT_STATE(NVM_STATE_FSM_FINISHED)
            },
            {   /* check if block is selected for preReadAll -> init block for readAll and init ReadBlockSubFsm
                                                                and go to exec state  */
                NVM_STATE_IF{NVM_QRY_ID_BLK_RELEVANT_FOR_PREREADALL, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_InitBlockExtended, NVM_ACT_ID_InitReadBlockSubFsm},
                    NVM_NEXT_STATE(NVM_STATE_PREREADALL_EXEC)
            },
            {   /* it was not last block and block was not selected for PreReadAll -> increment blockID and repeat */
                NVM_STATE_ELSEIF{NVM_QRY_ID_TRUE, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_IncrementBlockId, NVM_ACT_ID_Nop},
                    NVM_NEXT_STATE(NVM_STATE_PREREADALL_PREP)
            }
        },
        /* not used */
        {
    ...
    /* NVM_STATE_PREREADALL_EXEC */
    {
        {
            {   /* sub fsm still running (ReadBlock is ongoing) ->  wait */
                NVM_STATE_IF{NVM_QRY_ID_SUB_FSM_RUNNING, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_Wait, NVM_ACT_ID_Nop},
                    NVM_NEXT_STATE(NVM_STATE_PREREADALL_EXEC)
            },
            {   /* sub fsm finished (ReadBlock is finished) -> finish block, increment blockID and return to prep preReadAll state */
                NVM_STATE_IF{NVM_QRY_ID_TRUE, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_FinishBlock, NVM_ACT_ID_IncrementBlockId},
                    NVM_NEXT_STATE(NVM_STATE_PREREADALL_PREP)
            },
            {   /* not used */
                NVM_STATE_ELSEIF{NVM_QRY_ID_TRUE, NVM_QRY_ID_TRUE},
