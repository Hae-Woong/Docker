 ...
 *********************************************************************************************************************/
 /* Flag indicating if any MAC data integrity block is present. Used to disable unused code sections */
# if (NVM_NR_OF_CSM_MAC_JOBS > 0u)
#  define NVM_CSM_MAC_DATAINTEGRITY_ENABLED (STD_ON)
# else
#  define NVM_CSM_MAC_DATAINTEGRITY_ENABLED (STD_OFF)
# endif

/* Flag indicating if any ciphering data is present. Used to disable unused code sections
   set the flag before NvM_Act.h and NvM_Qry.h are included */
# if (NVM_NR_OF_CSM_CRYPTO_JOBS > 0u)
#  define NVM_CSM_CIPHERING_ENABLED (STD_ON)
# else
#  define NVM_CSM_CIPHERING_ENABLED (STD_OFF)
# endif
...
# define NVM_APIFLAG_PRE_READ_ALL_SET            (0x80u)
# define NVM_APIFLAG_PRE_READ_ALL_CL             (0x7Fu)
