...
/**********************************************************************************************************************
 * NVM_QryBlockRelevantForPreReadAll
 *********************************************************************************************************************/
/*! \brief Checks if the current block is selected to be processed in PreReadAll
 *  \details -
 *  \return TRUE Selected for PreReadAll
 *  \return FALSE otherwise
 *  \context TASK
 *  \reentrant FALSE
 *  \synchronous TRUE
 *  \pre -
 */
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NVM_QryBlockRelevantForPreReadAll(void);
#endif
...
/**********************************************************************************************************************
 *  NvM_QryIsDataIntegrityJobPending
 *********************************************************************************************************************/
/*!
 * \brief           Test if a DataIntegrity job is pending
 * \details         -
 * \return          TRUE if a job is running; FALSE otherwise
 * \pre             DataIntegrity job must be set up for currently processed block
 * \context         TASK
 * \reentrant       FALSE
 * \synchronous     TRUE
 */
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryIsDataIntegrityJobPending(void);

/**********************************************************************************************************************
 *  NvM_QryIsDataIntegrityJobFinishedSuccessful
 *********************************************************************************************************************/
/*!
 * \brief           Test if a DataIntegrity job has ended successfully
 * \details         -
 ...
 * \synchronous     TRUE
 */
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryIsDataIntegrityJobFinishedSuccessful(void);

/**********************************************************************************************************************
 *  NvM_QryIsDataIntegrityAlgorithmConfigured
 *********************************************************************************************************************/
/*!
 * \brief           Test if currently processed block has a DataIntegrity algorithm configured.
 * \details         -
 * \return          TRUE if any algorithm is configured; FALSE if none is configured.
 * \pre             -
 * \context         TASK
 * \reentrant       FALSE
 * \synchronous     TRUE
 */
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryIsDataIntegrityAlgorithmConfigured(void);
 ...
 *********************************************************************************************************************/
/*!
 * \brief           Simply returns FALSE
 * \details         Required for FSM handling
 * \return          FALSE
 * \pre             -
 * \context         TASK
 * \reentrant       TRUE
 * \synchronous     TRUE
 */
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryFalse(void);
#endif
 ...
 *          or multi block job ((Pre)ReadAll or WriteAll). It does not care about the high priority jobs - NvM handles this itself.
 * \return FALSE 
 * \return TRUE 
 * \context TASK
 * \reentrant FALSE
...
/**********************************************************************************************************************
 * NvM_QryDataIntegrityRecordCompareMechanismSkipWrite
 *********************************************************************************************************************/
/*!
 * \brief Checks whether the block writing shall be skipped because of DataIntegrityRecordCompareMechanism and clean block.
 * \details -
 ...
 * \pre -
 */
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryDataIntegrityRecordCompareMechanismSkipWrite(void);
...
/**********************************************************************************************************************
 *  NvM_QryCsmJobAttemptFailed
 *********************************************************************************************************************/
/*!
 * \brief           Test if the latest CSM job attempt failed.
 * \details         -
 * \return          TRUE if CSM job was failing, FALSE otherwise
 * \pre             -
 * \context         TASK
 * \reentrant       FALSE
 * \synchronous     TRUE
 */
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryCsmJobAttemptFailed(void);
#endif
...
#if (NVM_CSM_CIPHERING_ENABLED == STD_ON)
/**********************************************************************************************************************
 *  NvM_QryHasEncryptionJob
 *********************************************************************************************************************/
/*!
 * \brief           Test if currently processed block has an encryption job configured
 * \details         -
 * \return          TRUE if an encryption jobis configured; FALSE otherwise
 * \pre             -
 * \context         TASK
 * \reentrant       FALSE
 * \synchronous     TRUE
 */
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryHasEncryptionJob(void);
#endif

#if(NVM_SET_RAM_BLOCK_STATUS_API == STD_ON)
/**********************************************************************************************************************
 *  NvM_QryHasExplicitSynchronization
 *********************************************************************************************************************/
/*!
 * \brief           Test if currently processed block has explicit synchronization mechanism configured
 * \details         -
 * \return          return TRUE if mechanism is configured, FALSE otherwise
 * \pre             -
 * \config          -
 * \context         TASK
 * \reentrant       FALSE
 * \synchronous     TRUE
 */
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryHasExplicitSynchronization(void);

/**********************************************************************************************************************
 *  NvM_QryExplicitSyncAttemptNecessary
 *********************************************************************************************************************/
/*!
 * \brief           Test if recent explicit synchronization attempt was erroneous but retry is possible
 * \details         -
 * \return          return TRUE if attempt failed and retry maximum not exceeded; FALSE otherwise
 * \pre             -
 * \config          -
 * \context         TASK
 * \reentrant       FALSE
 * \synchronous     TRUE
 */
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryExplicitSyncAttemptNecessary(void);

/**********************************************************************************************************************
 *  NvM_QryExplicitSyncAttemptFailed
 *********************************************************************************************************************/
/*!
 * \brief           Test if recent explicit synchronization attempt failed
 * \details         -
 * \return          return TRUE if attempt failed; FALSE if succeeded
 * \pre             -
 * \config          -
 * \context         TASK
 * \reentrant       FALSE
 * \synchronous     TRUE
 */
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryExplicitSyncAttemptFailed(void);
#endif
...
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryBlockRelevantForWriteAll(void)
{
  ...
  if(NvM_CurrentJob_t.JobBlockId_t == 1u) /* Skip the config block */
  {
    retVal_isRelevantForWriteAll = FALSE;
  }
#endif
...
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NVM_QryBlockRelevantForPreReadAll(void)
{
  return (NvM_IsBooleanBitfieldTrue(NvM_BlockDescriptorTable_at[NvM_CurrentJob_t.JobBlockId_t].Flags.SelectBlockForPreReadAllEnabled) == TRUE);
}
#endif
...
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryIsDataIntegrityJobPending(void)
{
  return (NvM_DataIntegrity_GetStatus(&NvM_CurrentBlockInfo_t.DataIntegrityJob) == NVM_DATAINTEGRITYSTATUS_PENDING);    /* SBSW_NvM_FuncCall_PtrParam_CurrBlockInfo */
}
...
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryIsDataIntegrityJobFinishedSuccessful(void)
{
  return (NvM_DataIntegrity_GetStatus(&NvM_CurrentBlockInfo_t.DataIntegrityJob)                                         /* SBSW_NvM_FuncCall_PtrParam_CurrBlockInfo */
      == NVM_DATAINTEGRITYSTATUS_FINISHED_SUCCESSFUL);
}
...
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryIsDataIntegrityAlgorithmConfigured(void)
{
  /* Currently only CRC available */
  return (NvM_CurrentBlockInfo_t.Descriptor_pt->DataIntegritySettings != NVM_BLOCK_DATA_INTEGRITY_OFF);
}
...
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryLastBlockDone_ReadAll(void)
{
    return (boolean)(NvM_CurrentJob_t.JobBlockId_t >= NVM_TOTAL_NUM_OF_NVRAM_BLOCKS);
}
...
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryNvBusy(void)
{
    ...
    {
        if (MEMIF_BUSY == NvM_MemIfAbstraction_GetStatus(deviceId))
        {
            retVal = TRUE;
        }
        else
        {
            switch(NvM_MemIfAbstraction_GetJobResult(deviceId))
            {
                case MEMIF_JOB_OK:
...
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryMemHwaBusy(void)
{
  const MemIf_StatusType MemHwaStatus = NvM_MemIfAbstraction_GetStatus(MEMIF_BROADCAST_ID);
...
# if(NVM_PRE_READALL_API == STD_ON)
   || ((NvM_ApiFlags_u8 & NVM_APIFLAG_PRE_READ_ALL_SET) != 0u)
# endif
     );
}
...
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryRepairRedBlockDefect(void)
{
  ...
  if((firstBlockOk && secondBlockOk)
      && ((NvM_CurrentBlockInfo_t.Descriptor_pt->DataIntegritySettings > NVM_BLOCK_DATA_INTEGRITY_OFF)
...
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryDataIntegrityRecordCompareMechanismSkipWrite(void)
{
  ...
  if(NvM_CurrentBlockInfo_t.Descriptor_pt->DataIntegrityRecordCompMechanismBuffer != NULL_PTR)
  {
    skipWrite = NvM_DataIntegrity_Compare(                                                                              /* SBSW_NvM_FuncCall_PtrParam_CurrBlockInfo */
        &NvM_CurrentBlockInfo_t.DataIntegrityJob,
        NvM_CurrentBlockInfo_t.Descriptor_pt->DataIntegrityRecordCompMechanismBuffer);
  }
...
FUNC(boolean, NVM_PRIVATE_CODE) NvM_QrySyncDecrypt(void)
{
  /* #100 CSM enabled and the current block has a CSM job reference (must be decrypted). */
    ...
    if(NvM_QryIsCipherBlock(NvM_CurrentBlockInfo_t.Descriptor_pt) == TRUE) /* SBSW_NvM_FuncCall_PtrParam_CurrBlockInfo */
    {
      ...
      NvM_CurrentBlockInfo_t.CsmJobReturnValue_u8 = Csm_Decrypt(NvM_CsmCryptoJobs[NvM_CurrentBlockInfo_t.Descriptor_pt->NvCryptoReference].DecryptJobId, NVM_CSM_OP_MODE, /* SBSW_NvM_FuncCall_PtrParam_Csm */
...
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryCsmRetryNecessary(void)
{
  /* #10 CSM ciphering enabled and the current block has a CSM job reference */
#if (NVM_CSM_CIPHERING_ENABLED == STD_ON)
    /* the initial try is also counted as retry. Therefore the total number of
...
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryCsmJobAttemptFailed(void)
{
  return (NvM_CurrentBlockInfo_t.CsmJobAttemptSuccessful == FALSE);
}
#endif
...
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryRedundantCrcMatches(void)
{
   ...
   */
  return NvM_DataIntegrity_Compare(                                                                                     /* SBSW_NvM_FuncCall_PtrParam_CurrBlockInfo */
      &NvM_CurrentBlockInfo_t.DataIntegrityJob,
...
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryHasEncryptionJob(void)
{
  return NvM_QryIsCipherBlock(NvM_CurrentBlockInfo_t.Descriptor_pt); /* SBSW_NvM_FuncCall_PtrParam_CurrBlockInfo */
}
#endif
 ...
 *
 */
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryHasExplicitSynchronization(void)                                       /* COV_NVM_COVEREDINOTHERCFG */
{
  /* No need to check Get-function of mechanism, it is ensured that only both or none is configurable */
  return (NvM_CurrentBlockInfo_t.Descriptor_pt->CbkSetMirrorFunc_pt != NULL_PTR);
}
 ...
 *
 */
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryExplicitSyncAttemptNecessary(void)                                     /* COV_NVM_COVEREDINOTHERCFG */
{
  /* Note: Current handling does not really support retry handling but this code preserves an easy extension of NvM
   *       in future to possibly support it.
   *       Flags are prepared in NvM_ActInitNextBlockReadAll()
   */
  return ((NvM_CurrentBlockInfo_t.ExplSyncAttemptSuccessful == FALSE)
      && (NvM_CurrentBlockInfo_t.ExplSyncAttemptCounter < NVM_READALL_MAX_NUM_EXPLICITSYNC_RETRY_ATTEMPTS));            /* COV_NVM_READALL_EXPLICITSYNC_NO_RETRY */
}
 ...
 *
 */
NVM_LOCAL FUNC(boolean, NVM_PRIVATE_CODE) NvM_QryExplicitSyncAttemptFailed(void)                                        /* COV_NVM_COVEREDINOTHERCFG */
{
  return (NvM_CurrentBlockInfo_t.ExplSyncAttemptSuccessful == FALSE);
}
#endif
...
{
  return (BlockDescriptor->NvCryptoReference < NVM_NR_OF_CSM_CRYPTO_JOBS);
}
