...
typedef enum
{
    ...
    NVM_ACT_ID_ReadNvBlockDataIntegrityRecordOnly,
...
#endif
    NVM_ACT_ID_SetupDataIntegrityGeneration,
    NVM_ACT_ID_SetupDataIntegrityVerification_ReadBlock,
#if(NVM_SET_RAM_BLOCK_STATUS_API == STD_ON)
    NVM_ACT_ID_SetupDataIntegrityVerification_ReadAll,
#endif
    NVM_ACT_ID_ProcessDataIntegrityJob,
    NVM_ACT_ID_ExportDataIntegrityInformation,
#if(NVM_SET_RAM_BLOCK_STATUS_API == STD_ON)
    NVM_ACT_ID_CopyRamDataToInternalBuffer,
#endif
#if (NVM_CSM_CIPHERING_ENABLED == STD_ON)
    NVM_ACT_ID_ProcessEncryptionJob,
#endif
