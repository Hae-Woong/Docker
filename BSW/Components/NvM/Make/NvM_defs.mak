...
# REVISION HISTORY
#------------------------------------------------------------------------------
# Refer to the NvM_rules.mak file.
############################################################################### 
...
NVM_CORE_PATH       =   $(SSC_ROOT)\NvM


# e.g.: CAN_OUTPUT_PATH = $(GENDATA_DIR)


NVM_OUTPUT_PATH     =  $(GENDATA_DIR)
...
<ASR_MODULENAME>_DEPENDENT_PLUGINS =
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     +=  $(NVM_CORE_PATH)  $(NVM_OUTPUT_PATH)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
