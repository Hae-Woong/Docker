...
# 1.02.00   2021-02-05  virjwa  NvM tamper detection: Implement normalized 
#                               subcomponent to hide data integrity
# 1.03.00   2021-03-11  virsrl  NvM tamper detection: Add CSM MAC handling to 
#                               data integrity service
# 1.04.00   2022-06-14  virbka  MWDG-7056: NvM: Create MemIf abstraction with
#                               configurable usage scenario
#------------------------------------------------------------------------------
...
LIBRARIES_TO_BUILD      += NvM
NvM_FILES                = NvM$(BSW_SRC_DIR)\NvM.c \
                           NvM$(BSW_SRC_DIR)\NvM_Act.c \
                           NvM$(BSW_SRC_DIR)\NvM_Crc.c \
                           NvM$(BSW_SRC_DIR)\NvM_JobProc.c \
                           NvM$(BSW_SRC_DIR)\NvM_Qry.c \
                           NvM$(BSW_SRC_DIR)\NvM_Queue.c \
                           NvM$(BSW_SRC_DIR)\NvM_DataIntegrity.c \
                           NvM$(BSW_SRC_DIR)\NvM_Mac.c \
                           NvM$(BSW_SRC_DIR)\NvM_MemIfAbstraction.c \
                           NvM$(BSW_SRC_DIR)\NvM_MemIfMemoryCore.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += NvM$(BSW_SRC_DIR)\NvM.c \
                           NvM$(BSW_SRC_DIR)\NvM_Act.c \
                           NvM$(BSW_SRC_DIR)\NvM_Crc.c \
                           NvM$(BSW_SRC_DIR)\NvM_JobProc.c \
                           NvM$(BSW_SRC_DIR)\NvM_Qry.c \
...
GENERATED_SOURCE_FILES  +=  $(GENDATA_DIR)\NvM_Cfg.c
