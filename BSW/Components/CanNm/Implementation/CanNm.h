 ...
 * 11.00.00   2021-12-22  vispkn  NMM-1845      Support synchronized PNC shutdown
 *                                ESCAN00111344 Restructured PNC byte accesses
 *            2022-04-05  vispps  NMM-2075      Finite Execution Time Analysis
 * 11.00.01   2022-06-08  vispkn  ESCAN00112060 Synchronized Pnc Shutdown does not work as expected
 *                                ESCAN00112059 Compiler error C2166: l-value specifies const object
 *********************************************************************************************************************/
...
# define NM_ASR4NMCAN_VERSION                                 (0x1100u)
...
# define CANNM_SID_REQUESTSYNCHRONIZEDPNCSHUTDOWN             (0xF3u) /*!< Service ID: CanNm_RequestSynchronizationPncShutdown() */
...
# define CANNM_E_INVALID_PN_SYNC_SHUTDOWN_REQUEST             (0x34u) /*!< Error code: The Sync Shutdown Request was done on an actively coordinated channel. */
# define CANNM_E_TRANSMISSION_OF_PN_SHUTDOWN_MESSAGE_FAILED   (0x35u) /*!< Error code: Transmission of a Pn Shutdown Message failed. */
# define CANNM_E_REQUEST_PN_SHUTDOWN_MESSAGE_INVALID_STATE    (0x80u) /*!< Error code: The Request of a synchronized Pn Shutdown cannot be accepted due to an invalid state of the Nm state machine. */
...
/***********************************************************************************************************************
 *  CanNm_RequestSynchronizationPncShutdown
 **********************************************************************************************************************/
  ...
  *  \note        Called from NM Interface
  *  \config      CANNM_SYNCHRONIZEDPNCSHUTDOWNENABLEDOFCHANNELCONFIG == STD_ON
  *  \context     TASK|ISR1|ISR2
  *  \reentrant   TRUE for different channels
  *  \synchronous TRUE
  *  \trace       DSGN-CanNm23228
  **********************************************************************************************************************/
extern FUNC( Std_ReturnType, CANNM_CODE ) CanNm_RequestSynchronizedPncShutdown( CONST( NetworkHandleType, AUTOMATIC ) nmChannelHandle, CONST( PNCHandleType, AUTOMATIC ) pncId );
# endif
 ...
 * \length SHORT The length depends upon the PnInfo Length.
 * \usedin CanNm_MainFunction, CanNm_RxIndication
 * \exclude CanNm_MainFunction, CanNm_RxIndication
 * \protects CanNm_PnClusterReqExtNew, CanNm_PnClusterReqNew (read), CanNm_SyncPncShutdownReqExt
 * \endexclusivearea
 *
 ...
 * \endexclusivearea
 *
 * \exclusivearea CANNM_EXCLUSIVE_AREA_7
 * Ensures that the CanNm_SyncPncShutdownReqNew is not written while data is modified.
 * Note: This critical section can be left empty when ComM cannot interrupt the CanNm_MainFunction.
 * \length SHORT At max 128 bytes are copied within this exclusive area. But usually it is a lot less, due to the PN settings.
 * \usedin CanNm_MainFunction
 * \exclude CanNm_RequestSynchronizedPncShutdown
 * \protects CanNm_SyncPncShutdownReqNew
 * \endexclusivearea
 */
/**********************************************************************************************************************
 *  END OF FILE: CanNm.h
