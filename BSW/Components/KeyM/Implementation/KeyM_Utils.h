...
# define KEYM_SERVICECALLBACK_USED                                    ((KEYM_SERVICECERTIFICATECALLBACKNOTIFICATION == STD_ON) || \
                                                                      (KEYM_SERVICECERTIFICATERTECALLBACKNOTIFICATION440 == STD_ON) || \
                                                                      (KEYM_SERVICECERTIFICATERTECALLBACKNOTIFICATION2211 == STD_ON))

# define KEYM_VERIFYCALLBACK_USED                                     ((KEYM_CERTIFICATEVERIFYCALLBACKNOTIFICATIONWITHOUTID == STD_ON) || \
                                                                      (KEYM_CERTIFICATEVERIFYCALLBACKNOTIFICATIONWITHID == STD_ON))
...
FUNC(Std_ReturnType, KEYM_RTE_CODE) Vcastub_Appl_ServiceCertificateRteCallbackNotification440(KeyM_CertificateStatusType Result, uint16 ResultDataLength, P2CONST(uint8, AUTOMATIC, KEYM_APPL_DATA) ResultDataPtr);
FUNC(Std_ReturnType, KEYM_RTE_CODE) Vcastub_Appl_ServiceCertificateRteCallbackNotification2211(KeyM_CertificateStatusType Result, uint16 ResultDataLength, P2CONST(void, AUTOMATIC, KEYM_APPL_DATA) ResultDataPtr);
...
/*!
 * \internal
 * - Call VStdLib_MemCmp and check if result is 0.
 * \endinternal
 */
KEYM_UTILS_LOCAL_INLINE FUNC(boolean, KEYM_CODE) KeyM_Utils_MemCmp(
  P2CONST(uint8, AUTOMATIC, KEYM_APPL_DATA) buffer1,
...
/*!
 * \internal
 * - Check that buffer lengths are equal
 *  - Check that buffer contents are equal
 * - Return true if length and contents are equal, return false if they are not
 * \endinternal
 */
...
/*!
 * \internal
 * - Forward call to VStdLib_ConvertUint8ArrayToUint16BigEndian
 * - Return output from dst parameter as function result
 * \endinternal
 */
/* PRQA S 3219 1 */  /* MD_MSR_Unreachable */
KEYM_UTILS_LOCAL_INLINE FUNC(uint16, KEYM_CODE) KeyM_Utils_ConvertUint8ArrayToUint16BigEndian(
...
/*!
 * \internal
 * - # Forward call to VStdLib_ConvertUint16ToUint8ArrayBigEndian
 * \endinternal
 */
/* PRQA S 3219 1 */  /* MD_MSR_Unreachable */
KEYM_UTILS_LOCAL_INLINE FUNC(void, KEYM_CODE) KeyM_Utils_ConvertUint16ToUint8ArrayBigEndian(
...
/*!
 * \internal
 * - # Forward call to VStdLib_MemCpy
 * \endinternal
 */
/* PRQA S 3219 1 */  /* MD_MSR_Unreachable */
KEYM_UTILS_LOCAL_INLINE FUNC(Std_ReturnType, KEYM_CODE) KeyM_Utils_MemCpyWithSizeCheck(
