 ...
 *  04.11.00  2024-01-08  mapelt  ESCAN00115413 OCSP response verification fails due to incorrect validation of
 *                                              responder certificate
 *            2024-01-15  vismhh  ESCAN00116420 Generated CSR contains invalid ASN.1 encoding
 *            2024-03-05  mapelt  CRY-556       Make Eddsa usable for OCSP
 *            2024-03-06  lotto   CRY-488       Support for slot sharing of NvM and Csm certificates
 *  04.11.01  2024-03-06  vismhh  ESCAN00115952 Parsing of CRL fails for missing CertRevocationList element
 *            2024-03-26  visivg  ESCAN00117023 Certificate Signing Request generation fails for ECDSA or EdDSA 
 *                                              public key algorithm
 *            2024-03-27  visivg  ESCAN00117055 Out of bounds memory read in ASN1-Parser
 *            2024-03-27  visivg  ESCAN00116746 Compiler error: VCA compilation failed due to missing StbM.h
 **********************************************************************************************************************/
#if !defined KEYM_H
# define KEYM_H
...
# define KEYM_SW_MINOR_VERSION                                        (11u)
