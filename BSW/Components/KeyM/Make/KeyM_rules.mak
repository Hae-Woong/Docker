...
#------------------------------------------------------------------------------
# 1.00.00   2019-07-05  vismwe  Creation
# 1.03.00   2020-03-13  visivg  Minor fixes
#------------------------------------------------------------------------------
...
LIBRARIES_TO_BUILD      += KeyM
KeyM_FILES = KeyM$(BSW_SRC_DIR)\KeyM*.c 

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += KeyM$(BSW_SRC_DIR)\KeyM*.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\KeyM_Cfg.c
