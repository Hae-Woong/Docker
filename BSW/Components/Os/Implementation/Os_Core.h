...
OS_ALWAYS_INLINE, Os_CoreIsInterruptOnlyOs, (void))
{
...
{
  P2CONST(Os_CoreAsrConfigType, AUTOMATIC, OS_CONST) localCore = Os_ThreadGetCore(Os_CoreGetThread());                  /* PRQA S 2983 */ /* MD_Os_Rule2.2_2983_Config */ /* SBSW_OS_CORE_THREADGETCORE_001 */
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE                                                                            /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
P2VAR(Os_TraceCoreType, TYPEDEF, OS_VAR_NOINIT), OS_CODE, OS_ALWAYS_INLINE, Os_CoreGetTrace,
(
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE                                                                            /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_TESTSUITEOSC4998 */
...
{
  return ((P2VAR(Os_CoreAsrStatusType volatile, AUTOMATIC, OS_VAR_NOINIT))Core->Core.Status);                           /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */ /* COMP_WARN_OS_CAST_INCREASES_ALIGNMENT */
}
...
{
  return &(Os_CoreAsrGetDyn(Core)->IntApiState);                                                                        /* SBSW_OS_FC_PRECONDITION */
}
...
/***********************************************************************************************************************
 *  Os_CoreGetLastErrorParametersLocal()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(                                                                                           /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
OS_LOCAL_INLINE Os_ErrorParamsType, OS_CODE, OS_ALWAYS_INLINE, Os_CoreGetLastErrorParametersLocal,
(
  void
))
{
  return Os_CoreGetLastError(Os_ThreadGetCore(Os_CoreGetThread()))->Parameters;                                         /* SBSW_OS_CORE_COREGETLASTERROR_001 */ /* SBSW_OS_CORE_THREADGETCORE_001 */
}
...
))
{
  ...
  {
    Os_ErrKernelPanic(OS_STATUS_PANIC_INTERRUPTED_THREADS_OVERFLOW);
  }
...
))
{
  ...
  {
    Os_ErrKernelPanic(OS_STATUS_PANIC_INTERRUPTED_THREADS_UNDERFLOW);
  }
...
))
{
  ...
  else
  {
    ...
    while(iterator != iteratorEnd)                                                                                      /* COV_OS_HALPLATFORMTPUNSUPPORTED_XF */ /* FETA_OS_MAXINTERRUPTEDTHREADS */
    {
...
{
  P2CONST(Os_CoreAsrType, AUTOMATIC, OS_VAR_NOINIT) coreDyn;
...
))
{
  ...
  {
    Os_ErrKernelPanic(OS_STATUS_PANIC_INTERRUPTED_THREADS_INVALID_IDX);
  }
...
{
  if(Os_StackIsMonitoringEnabled() == 0u)                                                                               /* COV_OS_INVSTATE */ /* PRQA S 2991, 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
  {
...
))
{
  ...
  for(idx = 0; idx < (Os_ObjIdx_IteratorType) Core->IsrCount; idx++)                                                    /* FETA_OS_CONSTANTASFUNCTIONPARAMETER */
  {
