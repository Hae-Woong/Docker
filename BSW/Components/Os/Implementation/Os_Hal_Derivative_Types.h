...
# elif defined(OS_CFG_DERIVATIVEGROUP_TC49X_CSRM)                                                                       /* COV_OS_DERIVATIVEGROUP */
#  include "Os_Hal_Derivative_TC49x_CSRM_Types.h"
# elif defined(OS_CFG_DERIVATIVEGROUP_TC49XN)                                                                           /* COV_OS_DERIVATIVEGROUP */
#  include "Os_Hal_Derivative_TC49xN_Types.h"
# elif defined(OS_CFG_DERIVATIVEGROUP_TC49XN_CSRM)                                                                      /* COV_OS_DERIVATIVEGROUP */
#  include "Os_Hal_Derivative_TC49xN_CSRM_Types.h"
# elif defined(OS_CFG_DERIVATIVEGROUP_TC4DX)                                                                            /* COV_OS_DERIVATIVEGROUP */
#  include "Os_Hal_Derivative_TC4Dx_Types.h"
# elif defined(OS_CFG_DERIVATIVEGROUP_TC4DX_CSRM)                                                                       /* COV_OS_DERIVATIVEGROUP */
#  include "Os_Hal_Derivative_TC4Dx_CSRM_Types.h"
# else
