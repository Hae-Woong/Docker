 ...
 *  Os_IsrGetDyn()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE P2VAR(Os_IsrType, AUTOMATIC, OS_VAR_NOINIT), OS_CODE, OS_ALWAYS_INLINE,
Os_IsrGetDyn,
(
  P2CONST(Os_IsrConfigType, AUTOMATIC, OS_CONST) Isr
))
...
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_IsrKill,                               /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
(
  P2CONST(Os_IsrConfigType, AUTOMATIC, OS_CONST) Isr,
...
))
{
  ...
  Os_ThreadKill(Os_IsrGetThread(Isr), TerminationReason);                                                               /* SBSW_OS_ISR_THREADKILL_001 */ /* SBSW_OS_FC_PRECONDITION */
}
