...
typedef enum
{
  /*! The ExPo is part of a schedule table with no or implicit synchronization. */
  OS_SCHT_EXPO_KIND_EXECUTE             = 0,
  /*! The ExPo is part of an explicitly synchronized schedule table and at least length or shorten is unequal to zero.*/
  OS_SCHT_EXPO_KIND_EXECUTE_SYNC        = 1,
  /*! The ExPo is part of an explicitly synchronized schedule table and does not perform synchronization. */
