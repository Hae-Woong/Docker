...
/***********************************************************************************************************************
 *  Os_SpinlockLock2Spinlock()
 **********************************************************************************************************************/
/*! \brief        Returns the given lock as spinlock.
 *  \details      --no details--
 *
 *  \param[in]    Lock  The lock to query. Parameter must not be NULL.
 *
 *  \return       The given lock as spinlock.
 *
 *  \context      OS_INTERNAL
 *
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 *
 *  \pre          The given lock is a spinlock.
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE P2CONST(Os_SpinlockConfigType, AUTOMATIC, OS_CONST), OS_CODE,
OS_ALWAYS_INLINE, Os_SpinlockLock2Spinlock,
(
    ...
    case OS_SPINLOCKMETHOD_SCHEDULER:                                                                                   /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
    {
      ...
      if(Os_ThreadIsTask(currentThread) != 0u)                                                                          /* SBSW_OS_SL_THREADISTASK_001 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
      {
        ...
        if(Os_SchedulerPriorityIsLower(PreviousPriority, currentPriority) != 0u)
        {
          ...
          /* #55 Perform round robin scheduling if needed. */
          Os_SchedulerRobRound(scheduler);                                                                              /* SBSW_OS_SL_SCHEDULER_ROBROUND_001 */
...
{
  P2CONST(Os_SpinlockType, AUTOMATIC, OS_VAR_NOINIT) spinlockDyn;
  ...
  do                                                                                                                    /* FETA_OS_SPINLOCK */
  {
    ...
    while(Os_Hal_SpinIsLocked(&(spinlockDyn->Spinlock)) != 0u)                                                          /* PRQA S 2994, 2996 */ /* MD_Os_Rule14.3_2994, MD_Os_Rule2.2_2996 */ /* SBSW_OS_SL_HAL_SPINISLOCKED_001 */ /* FETA_OS_SPINLOCK */
    {
      Os_Hal_CoreNop();
    }
  ...
  } while(Os_SpinlockTraceOwnerTryGet(Spinlock) != OS_HAL_SPINLOCKSUCCEEDED);                                           /* PRQA S 2993, 2996 */ /* MD_Os_Rule14.3_2993, MD_Os_Rule2.2_2996 */ /* SBSW_OS_FC_PRECONDITION */ /* COV_OS_HALPLATFORMGETSPINLOCK */
}
...
))
{
  ...
  Os_SpinlockListPop();                                                                                                 /* PRQA S 2987 */ /* MD_Os_Rule2.2_2987_Global */

  /* #30 Clear the lock owner. */
  spinlockDyn->OwnerThread = NULL_PTR;                                                                                  /* SBSW_OS_SL_SPINLOCKGETDYN_001 */

  /* #40 Inform the trace module and release the lock.*/
  Os_SpinlockTraceAndHalUnlock(Spinlock);                                                                               /* SBSW_OS_FC_PRECONDITION */
...
{
  Os_StdReturnType result;
  P2CONST(Os_SpinlockListType, AUTOMATIC, OS_VAR_NOINIT) spinlockList;
 ...
 *  Os_SpinlockLock2Spinlock()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE P2CONST(Os_SpinlockConfigType, AUTOMATIC, OS_CONST), OS_CODE,
OS_ALWAYS_INLINE, Os_SpinlockLock2Spinlock,
(
  P2CONST(Os_LockConfigType, AUTOMATIC, OS_CONST) Lock
))
{
  return (P2CONST(Os_SpinlockConfigType, AUTOMATIC, OS_CONST))(Lock);                                                   /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
/***********************************************************************************************************************
 *  Os_SpinlockForciblyReleaseThreadLocksViaOwnerThread()
 **********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
/* PRQA S 6050 1 */ /* MD_MSR_STCAL */
FUNC(void, OS_CODE) Os_SpinlockForciblyReleaseThreadLocksViaOwnerThread
(
  P2CONST(Os_ThreadConfigType, AUTOMATIC, OS_CONST) Thread
)
{
  if(Os_SpinlockIsEnabled() != 0u)                                                                                      /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
    {
      SpinlockIdType idx;

      /* #10 Iterate over all spinlocks. */
      for(idx = (SpinlockIdType)0; idx < Os_SpinlockGetSpinlockIdCount(); ++idx)                                        /* PRQA S 4332, 4527 */ /* MD_Os_Rule10.5_4332, MD_Os_Rule10.1_4527 */ /* COMP_WARN_OS_CW_005 */ /* FETA_OS_CONSTDATA */
      {
        P2CONST(Os_SpinlockConfigType, AUTOMATIC, OS_CONST) spinlock;
        P2VAR(Os_SpinlockType, AUTOMATIC, OS_VAR_NOINIT) spinlockDyn;
 ...
 *
 */
FUNC(void, OS_CODE) Os_SpinlockForceReleaseLock                                                                         /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  P2CONST(Os_LockConfigType, AUTOMATIC, OS_CONST) Lock
)
{
  ...
  if(Os_SpinlockIsEnabled() != 0u)                                                                                      /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
    P2CONST(Os_SpinlockConfigType, AUTOMATIC, OS_VAR_NOINIT) spinlock = Os_SpinlockLock2Spinlock(Lock);                 /* SBSW_OS_FC_PRECONDITION */

    /* #20 Clear the lock owner. */
    Os_SpinlockGetDyn(spinlock)->OwnerThread = NULL_PTR;                                                                /* SBSW_OS_SL_SPINLOCKGETDYN_001 */ /* SBSW_OS_SL_SPINLOCKGETDYN_004 */

    /* #30 Inform the trace module and release the lock. */
    Os_SpinlockTraceAndHalUnlock(spinlock);                                                                             /* SBSW_OS_SL_SPINLOCKTRACEANDHALUNLOCK_001 */
...
)
{
  ...
  if(OS_UNLIKELY(Spinlock->Type == OS_SPINLOCKTYPE_STANDARD))
  {
    P2CONST(Os_ThreadConfigType, AUTOMATIC, OS_CONST) currentThread;
  ...
  if(OS_LIKELY(status == OS_STATUS_OK))
  {
    ...
    if(OS_UNLIKELY(Spinlock->Type == OS_SPINLOCKTYPE_STANDARD))                                                          /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
    {
...
)
{
  ...
  if(OS_UNLIKELY(Spinlock->Type == OS_SPINLOCKTYPE_STANDARD))
  {
    ...
    P2CONST(Os_LockListType, AUTOMATIC, OS_VAR_NOINIT) locks;
...
)
{
  ...
  if(OS_LIKELY(status == OS_STATUS_OK))
  {
    ...
    if(OS_LIKELY(result == OS_HAL_SPINLOCKSUCCEEDED))                                                                   /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
    {
...
)
{
  ...
  else
  {
    ...
    if(OS_LIKELY(spinlock->Mode == OS_SPINLOCKMODE_USER))                                                               /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
    {
      ...
      if(result == OS_HAL_SPINLOCKSUCCEEDED)                                                                            /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
      {
        *Success = TRYTOGETSPINLOCK_SUCCESS;                                                                            /* SBSW_OS_PWA_PRECONDITION */
      }
      else
...
\ID SBSW_OS_SL_SCHEDULER_ROBROUND_001
 \DESCRIPTION    Os_SchedulerRobRound is called with the return value of Os_CoreGetScheduler.
 \COUNTERMEASURE \M [CM_OS_COREGETSCHEDULER_M]
...
\ID SBSW_OS_SL_SPINLOCKGETDYN_004
 \DESCRIPTION    Os_SpinlockGetDyn is called with the return value of Os_SpinlockLock2Spinlock.
...
\ID SBSW_OS_SL_SPINLOCKTRACEANDHALUNLOCK_001
 \DESCRIPTION    Os_SpinlockTraceAndHalUnlock is called with the return value of Os_SpinlockLock2Spinlock.
 \COUNTERMEASURE \R [CM_LOCKLISTGETTOP_R]
