 ...
 *  02.49.00  2021-03-18  visdqk      ESCAN00108354 Removed obsolete HAL API.
 *  02.50.00  2021-05-05  visto       HALBE-4363    Support TC49x HSM usecase
 *  02.51.00  2021-08-17  visto       HALBE-5115    Runtime optimization: Remove the global lock when dis/enabling the IntLevels
 *  02.52.00  2021-09-23  visdqk      OSC-7919      MISRA migration to new QAC version.
 *  02.53.00  2021-11-12  visto       HALBE-5537    Fix MISRA warning
 *  02.54.00  2021-11-24  visrk       OSC-8178      Internal improvement.
 *            2021-12-06  visrk       OSC-6113      64 Bit support for VttOs.
 *  02.55.00  2021-12-16  virsmn      OSC-8186      Updates for new QAC version (MISRA).
 *  02.56.00  2022-02-08  visto       HALBE-6118    create special handling for user defined context management handling.
 *  02.57.00  2022-03-25  virbse      OSC-7628      Support ARTI.
 *            2022-03-30  visto       HALBE-2818    Support of TC49x
 *  02.58.00  2022-04-13  visto       HALBE-6648    ESCAN00111687 - STM interrupt source initialization does not work correctly
 *  02.59.00  2022-06-10  visto       HALBE-7150    ESCAN00112051 - Interrupt Mapping cannot be configured as expected
 *  02.60.00  2022-07-29  visto       HALBE-7490    ESCAN00112448 Compile error: the assembler issues errors
 *  02.61.00  2022-09-28  viswip      HALBE-7547    Interrupt Controller CS Bit handling on CS Core added.
 *  02.62.00  2022-10-27  virmid      HALBE-7206    Fixed CoreSTM bit mask and bit value.
 *            2022-11-09  visto       HALBE-8040    update of generator version check
 *  02.63.00  2023-01-25  visdri      HALBE-7675    Perform Tricore FETA analysis.
 *            2023-01-31  visto       HALBE-8580    Provide new Interface Os_Hal_TimerFrtGetCompareValue().
 *  02.64.00  2023-02-24  visto       HALBE-8854    Support new OS Counter Algorithm
 *                                    HALBE-8840    ESCAN00113725 - Timing problems with more than 32767 Alarms and Schedule Tables.
 *                                    HALBE-8838    ESCAN00113942 - IOC buffer generated too small
 *  02.65.00  2023-07-14  mwohnhaas   OSC-9684      BETA feature: Virtualization Support
 *  02.66.00  2023-08-04  visdri      HALBE-10156   Support TC4Dx SC1-SC4 with Tasking (Development)
 *            2023-08-11  virjas      HALBE-10106   Add coverage justification for beta feature virtualization support.
 *            2023-08-17  virjas      HALBE-10235   Adaption of Os_ErrKernelPanic interface.
 *  02.67.00  2023-09-05  virrlu      -             Update due to BSWMD change.
 *            2023-10-12  visdri      BASEENV-10718 Add support to TC4D CSRM core.
 *  02.68.00  2023-11-12  visdri      OSHAL-60      TC4x QM Release.
 *  02.69.00  2023-11-30  visdri      OSHAL-789     Minor improvements.
 *            2023-12-21  vistmo      OSHAL-746     Support new Compiler LlvmHighTec for TC4x.
 *            2024-01-03  visdri      OSHAL-832     Add OsIsrPeriod/OsTaskPeriod parameters to BSWMD, Update generator.
 *  02.70.00  2024-05-01  visdri      OSHAL-1289    MISRA fix using the Macro OS_STACK_GETLIMIT instead of OS_STACK_GETHIGHADDRESS.
 *  02.71.00  2024-05-31  vistmo      OSHAL-1523    Fix TC4D coverage tests.
 *            2024-06-03  visdri      OSHAL-1488    Add support for TC49x-N.
 *  02.72.00  2024-10-24  vistmo      OSHAL-2091    Added functions Os_Hal_LoadAcquire16 and Os_Hal_StoreRelease16.
 *                                    OSHAL-2177    Add new interfaces Os_Hal_MpuAppSwitchTo and Os_Hal_MpuThreadSwitchTo.
 **********************************************************************************************************************/
...
# define OS_HAL_SW_MINOR_VERSION                     (72u)
