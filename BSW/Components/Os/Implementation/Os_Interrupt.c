 ...
 *  Os_IntSetTaskLevel()
 **********************************************************************************************************************/
/*! \brief        Set the interrupt level to task level to enable interrupt handling.
 *  \details      -- no details --
 *
 *  \context      ANY
 *
 ...
 *  \pre          Supervisor mode.
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_IntSetTaskLevel, (void));
...
))
{
  return Os_ErrServiceProtectionCheck((Os_StdReturnType)((                                                              /* PRQA S 4304 */ /* MD_Os_C90BooleanCompatibility */
                                                  (Os_StdReturnType)(InterruptState->Os_IntLockingState.InDisableAll) | /* PRQA S 4304 */ /* MD_Os_C90BooleanCompatibility */
...
{
  if(Os_InterruptIsCriticalSectionTracingEnabled() != 0u)                                                               /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
    InterruptState->Os_IntLockingState.InDisableAll = TRUE;                                                             /* SBSW_OS_PWA_PRECONDITION */
  }
}
...
))
{
  if(Os_InterruptIsCriticalSectionTracingEnabled() != 0u)                                                               /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
    InterruptState->Os_IntLockingState.InDisableAll = FALSE;                                                            /* SBSW_OS_PWA_PRECONDITION */
  }
}
...
{
  return Os_ErrServiceProtectionCheck((Os_StdReturnType)(InterruptState->Os_IntLockingState.InDisableAll != FALSE));    /* PRQA S 4304 */ /* MD_Os_C90BooleanCompatibility */
}
 ...
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE,
Os_IntSetTaskLevel, (void))
{
  /* #10 If the HAL supports interrupt levels: */
  if (Os_Hal_IntIsLevelSupported() != 0u)                                                                               /* COV_OS_HALPLATFORMLEVELSUPPORT */ /* PRQA S 2991, 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
  {
    Os_Hal_IntLevelType level;

    /* #20 Get the interrupt lock level for tasks. */
    Os_Hal_IntGetTaskLevel(&level);                                                                                     /* SBSW_OS_FC_POINTER2LOCAL */

    /* #30 Set interrupt lock level to task level. */
...
)
{
  ...
  if(Os_InterruptIsCriticalSectionTracingEnabled() != 0u)                                                               /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
    ...
    IntApiState->Os_IntLockingState.InDisableAll = FALSE;                                                               /* SBSW_OS_PWA_PRECONDITION */
  }
 ...
 * */
    ...
    else
    {
      ...
      /* #50 We are in a DisableAllInterrupts() sequence so we need to be able to detect invalid service calls. */
  ...
  {
    /* #70 Otherwise, disable interrupts and save current interrupt state in the core's interrupt API state. */
    P2CONST(Os_CoreAsrConfigType, AUTOMATIC, OS_CONST) asrCore;

    asrCore = Os_Core2AsrCore(Os_CoreGetCurrentCore());                                                                 /* SBSW_OS_INT_CORE2ASRCORE_001 */
    Os_CoreGetInterruptApiState(asrCore)->SuspendAllPrevState.Global = Os_Hal_IntDisableAndReturnGlobalState();         /* SBSW_OS_INT_COREGETINTERRUPTAPISTATE_001 */ /* SBSW_OS_INT_COREGETINTERRUPTAPISTATE_002 */
  }
}
...
)
{
  ...
  {
    /* #70 Otherwise, restore global interrupt state saved in the core's interrupt API state. */
    P2CONST(Os_Hal_IntGlobalStateType, AUTOMATIC, OS_CONST) intState;
    P2CONST(Os_CoreAsrConfigType, AUTOMATIC, OS_CONST) asrCore;
    asrCore = Os_Core2AsrCore(Os_CoreGetCurrentCore());                                                                 /* SBSW_OS_INT_CORE2ASRCORE_001 */
    intState = &(Os_CoreGetInterruptApiState(asrCore)->SuspendAllPrevState.Global);                                     /* SBSW_OS_INT_COREGETINTERRUPTAPISTATE_001 */

    Os_Hal_IntSetGlobalState(intState);                                                                                 /* SBSW_OS_INT_INTSETGLOBALSTATE_001 */
  }
}
...
)
{
  ...
  if(OS_UNLIKELY(interruptApiState->Os_IntLockingState.SuspendAllCounter == 0u))                                        /* PRQA S 4304 */ /* MD_Os_C90BooleanCompatibility */
  {
    status = OS_STATUS_API_ERROR;
  }
  else
...
)
{
  ...
  if(OS_UNLIKELY(interruptApiState->Os_IntLockingState.SuspendOsCounter == 0u))                                         /* PRQA S 4304 */ /* MD_Os_C90BooleanCompatibility */
  {
    status = OS_STATUS_API_ERROR;
  }
  else
 ...
 *
 */
FUNC(void, OS_CODE) Os_Api_EnableInterruptsPreStart
(
  void
)
{
  /* #10 If not in InterruptOnly use case: */
  if (Os_CoreIsInterruptOnlyOs() == 0u)                                                                                 /* PRQA S 2991, 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
  {
    P2CONST(Os_CoreAsrConfigType, AUTOMATIC, OS_CONST) coreAsr;

    /* #20 Check if core has called StartOS(). */
    coreAsr = Os_Core2AsrCore(Os_CoreGetCurrentCore());                                                                 /* SBSW_OS_INT_CORE2ASRCORE_001 */
    if (OS_UNLIKELY(Os_CoreOsIsStarted(coreAsr) != 0u))                                                                 /* SBSW_OS_INT_COREOSISSTARTED_001 */
    {
      /* #30 If core is started, raise protection error. */
      Os_ErrReportEnableInterruptsPreStart(OS_STATUS_API_ERROR);
    }
  }

  /* #40 Set interrupt lock level to task level. */
  Os_IntSetTaskLevel();                                                                                                 /* PRQA S 2987 */ /* MD_Os_Rule2.2_2987 */

  /* #50 Update processor status word. */
  Os_IntEnableGlobal();
}
...
\ID SBSW_OS_INT_CORE2ASRCORE_001
...
\ID SBSW_OS_INT_COREGETINTERRUPTAPISTATE_001
 \DESCRIPTION    Os_CoreGetInterruptApiState is called with the return value of Os_Core2AsrCore.
 \COUNTERMEASURE \N [CM_OS_CORE2ASRCORE_N]

\ID SBSW_OS_INT_COREGETINTERRUPTAPISTATE_002
 \DESCRIPTION    Write access to a member variable derived from the return value of Os_CoreGetInterruptApiState
                 which in turn is derived from Os_CoreAsrGetDyn.
 \COUNTERMEASURE \M [CM_OS_COREASRGETDYN_M]

\ID SBSW_OS_INT_INTSETGLOBALSTATE_001
 \DESCRIPTION    Os_Hal_IntSetGlobalState is called with a pointer derived from the return value of
                 Os_CoreGetInterruptApiState which in turn is derived from Os_CoreAsrGetDyn.
 \COUNTERMEASURE \M [CM_OS_COREASRGETDYN_M]

\ID SBSW_OS_INT_COREOSISSTARTED_001
 \DESCRIPTION    Os_CoreOsIsStarted is called with the return value of Os_Core2AsrCore.
 \COUNTERMEASURE \N [CM_OS_CORE2ASRCORE_N]
...
\ID COV_OS_INTCOUNTEROVERFLOW
   \ACCEPT XF
   \REASON Counter overflow cannot be checked for type uint16 as the type is quite large.
           However, the code is unit tested and code inspected.
