...
#define OS_BITARRAY_LENGTH(BitSize)   ((BitSize) + 1u)


/*! \brief    Calculates the number of required bit fields.
 *  \details  --no details--
 *  \param[in]      BitSize   Number of bits which shall be reserved */
#define OS_BITARRAY_SIZE(BitSize)  ((OS_BITARRAY_LENGTH(BitSize)/OS_BITFIELD_BITWIDTH) + 1u)                            /* PRQA S 3410 */ /* MD_Os_Rule20.7_3410_Decl */
...
#define OS_BITARRAY_DECLARE(Name, BitSize, MemClass)  VAR(Os_BitFieldType, MemClass)  Name[OS_BITARRAY_SIZE(BitSize)]   /* PRQA S 0850, 3410 */ /* MD_MSR_MacroArgumentEmpty, MD_Os_Rule20.7_3410_Decl */
