...
{
   return (Os_StdReturnType)((uint32)OS_NONTRUSTEDFUNCTIONID_COUNT > 0u);                                               /* PRQA S 4304, 2995, 2996 */ /* MD_Os_C90BooleanCompatibility, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996*/
}
...
{
   return (Os_StdReturnType)((uint32)OS_TRUSTEDFUNCTIONID_COUNT > 0u);                                                  /* PRQA S 4304, 2995, 2996 */ /* MD_Os_C90BooleanCompatibility, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996*/
}
...
{
   return (Os_StdReturnType)((uint32)OS_FASTTRUSTEDFUNCTIONID_COUNT > 0u);                                              /* PRQA S 4304, 2995, 2996 */ /* MD_Os_C90BooleanCompatibility, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
}
...
))
{
  ...
  if((ntfEnabled | tfEnabled) != 0u)                                                                                    /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */ /* COMP_WARN_OS_CW_005 */
  {
    FUNC(void, OS_CODE) Os_ServiceInitInternal(P2CONST(Os_ServiceConfigType, AUTOMATIC, OS_CONST) Service);             /* PRQA S 3449, 3451 */ /* MD_Os_Rule8.5_3449, MD_Os_Rule8.5_3451 */
