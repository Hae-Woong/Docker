 ...
 *  \details        The value of the passed Error reference is changed to E_OS_SYS_DISABLED in case that forcible
 *                  termination is requested by the protection hook but forcible termination has not been configured.
 *
 *
 *  \param[in]      UserReaction  Protection reaction to verify.
 *  \param[in,out]  Error         Error state in which the protection reaction has been selected. Parameter must not be
 *                                NULL.
 *
...
(
  ...
  P2VAR(StatusType, AUTOMATIC, OS_VAR_NOINIT) Error
);
 ...
 *  \details      If the given exception occurred during OS code execution with privileged access, the OS could be in
...
)
{
  ...
  /* #50 If protection violation has occurred during user critical section, shutdown. */
  ...
  else if(OS_UNLIKELY((Os_CoreIsExceptionContextModificationSupported() == 0u) &&                                       /* PRQA S 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */ /* COV_OS_NOFUNCCALL */
                      (UserReaction == PRO_IGNORE_EXCEPTION)))
  {
    result = PRO_SHUTDOWN;
  }
  ...
  {
    /* #90 If killing is disabled, shutdown (Error is set to E_OS_SYS_DISABLED). */
    if(Os_ErrIsKillingEnabled() == 0u)                                                                                  /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
    {
      *Error = E_OS_SYS_DISABLED;                                                                                       /* SBSW_OS_PWA_PRECONDITION */
      result = PRO_SHUTDOWN;
    }
    else
    {
      ...
      responsibleThread = Os_CoreThreadGetByContext(Os_ThreadGetCore(currentThread), OS_CALLCONTEXT_PROTHOOK_RESPONSIBLE);/* SBSW_OS_ERROR_CORETHREADGETBYCONTEXT_001 */ /* SBSW_OS_ERROR_THREADGETCORE_001 */
      ...
      Os_ErrKernelPanic(OS_STATUS_PANIC_KILLING_NO_RESPONSIBLE_THREAD);
      }
      ...
      Os_ErrKernelPanic(OS_STATUS_PANIC_KILLING_NO_RESPONSIBLE_APPLICATION);
      }

      /* #100 If the current thread is a kernel thread, shutdown. */
      if(OS_UNLIKELY(Os_AppIsKernelApp(responsibleApplication) != 0u))                                                    /* SBSW_OS_ERROR_APPISKERNELAPP_001 */
      {
        result = PRO_SHUTDOWN;
      }

      /* #110 If the user reaction is PRO_TERMINATETASKISR and the responsible thread is neither a task
      *      nor an ISR, terminate the responsible application. */
      ...
      /* #120 If the user reaction is PRO_TERMINATEAPPL_RESTART and there is no restart task, shutdown */
  ...
  /* #130 Otherwise the user reaction is valid, return it. */
 ...
 * */
  ...
  switch(ProtectionReaction)
  {
    ...
    case PRO_IGNORE_EXCEPTION:                                                                                          /* COV_OS_HALPLATFORMSETEXCEPTIONCONTEXTAVAILABILITY */
      break;
    ...
    case PRO_TERMINATETASKISR:
      ...
      {
        Os_IsrKill(Os_IsrThread2Isr(responsibleThread), OS_FORCIBLE_TERMINATION);                                       /* SBSW_OS_ERROR_ISRKILL_001 */ /* SBSW_OS_ERROR_ISRTHREAD2ISR_001 */
      }
      else
      {
        Os_ErrKernelPanic(OS_STATUS_PANIC_KILLING_NO_TASK_OR_ISR);
      }

      /* #45 If the current thread is not the TP ISR, suicide. */
...
{
  return (Os_StdReturnType)(OS_CFG_INTERNAL_EXCEPTION_DETECTION == STD_ON);                                             /* PRQA S 4304, 2995, 2996 */ /* MD_Os_C90BooleanCompatibility, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
}
...
)
{
  ...
  else if(Os_ErrIsInternalExceptionDetectionSupported() != 0u)                                                          /* PRQA S 2991, 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */ /* COV_OS_ERRCODESECTIONCHECK */
  {
    Os_ObjIdx_IteratorType index;
    result = 0;

    /* #40 Check each OS code section: */
    for(index = 0; index < (Os_ObjIdx_IteratorType) OS_CFG_NUM_OSCODE_SECTIONS; index++)                                /* PRQA S 2994, 2996 */ /* MD_Os_Rule14.3_2994, MD_Os_Rule2.2_2996 */ /* COMP_WARN_OS_CW_005 */
    {
      /* #50 If the address is inside the OS code section: */
      if (Os_ErrIsAddressInsideSection(OsCfg_OsCode_Sections[index], ExceptionInstructionAddress) != 0u)                /* PRQA S 2880 */ /* MD_Os_Rule2.1_2880 */ /* SBSW_OS_ERROR_ISADDRESSINSIDESECTION_001 */
      {
...
)
{
  ...
  /* #20 Initialize exception instruction address. */
  Error->ExceptionInstructionAddress = (Os_AddressOfConstType) 0u;                                                      /* SBSW_OS_FC_PRECONDITION */
}
...
{
  Os_ErrorParamsType lastErrorParams;
  ...
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamAlarmType;                                                          /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(AlarmBaseRefType, OS_CODE) Os_ErrorGetParameter_AlarmBaseRefType(Os_ErrorParmIndexType ParamIndex)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamAlarmBaseRefType;                                                   /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamApplicationStateRefType;                                            /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(ApplicationType, OS_CODE) Os_ErrorGetParameter_ApplicationType(Os_ErrorParmIndexType ParamIndex)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamApplicationType;                                                    /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(boolean, OS_CODE) Os_ErrorGetParameter_boolean(Os_ErrorParmIndexType ParamIndex)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].Paramboolean;                                                            /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParambooleanRefType;                                                     /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(CoreIdType, OS_CODE) Os_ErrorGetParameter_CoreIdType(Os_ErrorParmIndexType ParamIndex)                             /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamCoreIdType;                                                         /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(Os_ExceptionContextRefType, OS_CODE) Os_ErrorGetParameter_ExceptionContextRefType(Os_ErrorParmIndexType ParamIndex)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamExceptionContextRefType;                                            /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(CounterType, OS_CODE) Os_ErrorGetParameter_CounterType(Os_ErrorParmIndexType ParamIndex)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamCounterType;                                                        /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(EventMaskType, OS_CODE) Os_ErrorGetParameter_EventMaskType(Os_ErrorParmIndexType ParamIndex)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamEventMaskType;                                                      /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(EventMaskType*, OS_CODE) Os_ErrorGetParameter_EventMaskRefType(Os_ErrorParmIndexType ParamIndex)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamEventMaskRefType;                                                   /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(IdleModeType, OS_CODE) Os_ErrorGetParameter_IdleModeType(Os_ErrorParmIndexType ParamIndex)                         /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamIdleModeType;                                                       /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(ISRType, OS_CODE) Os_ErrorGetParameter_ISRType(Os_ErrorParmIndexType ParamIndex)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamISRType;                                                            /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(ResourceType, OS_CODE) Os_ErrorGetParameter_ResourceType(Os_ErrorParmIndexType ParamIndex)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamResourceType;                                                       /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamInterruptSourceIdRefType;                                           /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamExceptionSourceIdRefType;                                           /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(RestartType, OS_CODE) Os_ErrorGetParameter_RestartType(Os_ErrorParmIndexType ParamIndex)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamRestartType;                                                        /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamScheduleTableStatusRefType;                                         /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(ScheduleTableType, OS_CODE) Os_ErrorGetParameter_ScheduleTableType(Os_ErrorParmIndexType ParamIndex)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamScheduleTableType;                                                  /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(SpinlockIdType, OS_CODE) Os_ErrorGetParameter_SpinlockIdType(Os_ErrorParmIndexType ParamIndex)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamSpinlockIdType;                                                     /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(TaskRefType, OS_CODE) Os_ErrorGetParameter_TaskRefType(Os_ErrorParmIndexType ParamIndex)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamTaskRefType;                                                        /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(TaskStateRefType, OS_CODE) Os_ErrorGetParameter_TaskStateRefType(Os_ErrorParmIndexType ParamIndex)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamTaskStateRefType;                                                   /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
 ...
 *
 */
FUNC(Os_BarrierIdType, OS_CODE) Os_ErrorGetParameter_BarrierIdType(Os_ErrorParmIndexType ParamIndex)                    /* COV_OS_TESTSUITEOSC4998 */
{
  Os_ErrorParamsType lastErrorParams;
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamBarrierIdType;                                                      /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(TaskType, OS_CODE) Os_ErrorGetParameter_TaskType(Os_ErrorParmIndexType ParamIndex)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamTaskType;                                                           /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(TickRefType, OS_CODE) Os_ErrorGetParameter_TickRefType(Os_ErrorParmIndexType ParamIndex)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamTickRefType;                                                        /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
FUNC(TickType, OS_CODE) Os_ErrorGetParameter_TickType(Os_ErrorParmIndexType ParamIndex)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamTickType;                                                           /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamTrustedFunctionIndexType;                                           /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamTrustedFunctionParameterRefType;                                    /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}


/***********************************************************************************************************************
 *  Os_ErrorGetParameter_FastTrustedFunctionIndexType()
 **********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
 *
 */
FUNC(Os_FastTrustedFunctionIndexType, OS_CODE) Os_ErrorGetParameter_FastTrustedFunctionIndexType                        /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
(
  Os_ErrorParmIndexType ParamIndex
)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamOs_FastTrustedFunctionIndexType;                                    /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}


/***********************************************************************************************************************
 *  Os_ErrorGetParameter_FastTrustedFunctionParameterRefType()
 **********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
 *
 */
FUNC(Os_FastTrustedFunctionParameterRefType, OS_CODE) Os_ErrorGetParameter_FastTrustedFunctionParameterRefType
(
  Os_ErrorParmIndexType ParamIndex
)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamOs_FastTrustedFunctionParameterRefType;                             /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamOs_NonTrustedFunctionIndexType;                                     /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamOs_NonTrustedFunctionParameterRefType;                              /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
(Os_ErrorParmIndexType ParamIndex)
{
  ...
  /* #10 Fetch requested error parameter from core and return it. */
  lastErrorParams = Os_TrapCoreGetLastErrorParametersLocal();
  return lastErrorParams.Parameter[ParamIndex].ParamTryToGetSpinlockConstRefType;                                       /* PRQA S 2842 */ /* MD_Os_Rule18.1_2842 */
}
...
{
  P2CONST(Os_ThreadConfigType, AUTOMATIC, OS_CONST) currentThread;
  Os_CallContextType currentContext;
  Os_CallContextType nonPropagatingContext;

  currentThread = Os_CoreGetThread();
  currentContext = Os_ThreadGetCurrentType(currentThread);                                                              /* SBSW_OS_ERROR_THREADGETCURRENTTYPE_001 */
  nonPropagatingContext = (Os_CallContextType) (OS_CALLCONTEXT_PRETASKHOOK | OS_CALLCONTEXT_POSTTASKHOOK);

  /* #5 If calling the error hook is allowed within the current call context: */
  if ((currentContext & nonPropagatingContext) == 0u)                                                                   /* PRQA S 4404 */ /* MD_Os_C90BooleanCompatibility */
  {
...
FUNC(void, OS_CODE) Os_ErrProtectionError(Os_StatusType Fatalerror)
{
  ...
  if (Os_HookIsProtectionHookEnabled() != 0u)                                                                           /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
    ...
    /* #15 Inform the trace module about protection hook entry. */
    Os_TraceProtHookEntry(status);
    ...
    protectionReaction = Os_ErrVerifyProtectionReaction(protectionReaction, &status);                                   /* SBSW_OS_FC_POINTER2LOCAL */

    /* #35 Inform the trace module about protection hook exit. */
    Os_TraceProtHookExit(protectionReaction);
...
)
{
  ...
  /* #05 Set the exception instruction address in the core local error data. */
  lastError->ExceptionInstructionAddress = ExceptionInstructionAddress;                                                 /* SBSW_OS_ERROR_COREGETLASTERROR_002 */

  /* #10 If the user critical section is active, call the panic hook. */
  if (Os_CoreCriticalUserSectionIsActive(localCore) != 0u)                                                              /* PRQA S 1881 */ /* MD_Os_C90BooleanCompatibility */ /* SBSW_OS_ERROR_CORECRITICALUSERSECTIONISACTIVE_001 */
  {
    Os_ErrKernelPanic(OS_STATUS_PANIC_EXC_ERR_CRITICAL_SECTION);
  }
  ...
  {
    Os_ErrKernelPanic(OS_STATUS_PANIC_EXC_ERR_INSIDE_OS);
  }
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(void, OS_CODE, OS_NORETURN, Os_ErrKernelPanic,
(
  Os_PanicStatusType Status
))
{
...
\ID SBSW_OS_ERROR_THREADGETCURRENTTYPE_001
 \DESCRIPTION    Os_ThreadGetCurrentType is called with the return value of Os_CoreGetThread.
 \COUNTERMEASURE \N [CM_OS_COREGETTHREAD_N]
...
\ID COV_OS_ASSERT
   \ACCEPT XF
   \REASON Assertions are a debug feature that the customer must not enable. Thus they are disabled in any productive
           platform. To test the assertions as well, the platform VTT enables assertions.
