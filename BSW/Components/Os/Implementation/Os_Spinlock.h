...
/***********************************************************************************************************************
 *  Os_SpinlockTraceAndHalUnlock()
 **********************************************************************************************************************/
/*! \brief          Inform the trace module about spinlock release and delegate unlocking to the HAL.
 *  \details        --no details--
 *
 ...
 *  \pre            No lock list contains the given spinlock.
 **********************************************************************************************************************/
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_Hal_SpinlockResultType, OS_CODE,                                        /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
...
))                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
  ...
  if(Os_ErrIsKillingEnabled() != 0u)                                                                                    /* COV_OS_HALPLATFORMTESTEDASMULTICORE */ /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
    ...
    /* #40 Inform the trace module and delegate to the HAL. */
  ...
  {
    /* #60 Else inform the trace module and delegate to the HAL. */
    Os_SpinlockTraceAndHalUnlock(Spinlock);                                                                             /* SBSW_OS_FC_PRECONDITION */
  }
}
...
))
{
  ...
  {
    /* #20 Empty thread's spinlock order list. */
    P2VAR(Os_SpinlockListType, AUTOMATIC, OS_VAR_NOINIT) spinlockList;

    spinlockList = Os_ThreadGetSpinlocks(Thread);                                                                       /* SBSW_OS_FC_PRECONDITION */
    *spinlockList = OS_SPINLOCK_LIST_END;                                                                               /* SBSW_OS_SL_THREADGETSPINLOCKS_002 */
  }
}
