 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE                                                                            /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_HALPLATFORMTPUNSUPPORTED_XX */
...
))                                                                                                                      /* COV_OS_HALPLATFORMTPUNSUPPORTED_XX */
{
  ...
  return (P2CONST(Os_TpOwnerThreadConfigType, AUTOMATIC, OS_CONST))(TpThread);                                          /* PRQA S 0310, 3305 */ /* MD_Os_Rule11.3_0310, MD_Os_Rule11.3_3305 */ /* COMP_WARN_OS_CAST_INCREASES_ALIGNMENT */
}
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_TickType, OS_CODE, OS_ALWAYS_INLINE,                                    /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_HALPLATFORMTPUNSUPPORTED_XX */
Os_TpSub,
(
  P2CONST(Os_TpConfigType, AUTOMATIC, OS_CONST) Config,
  Os_TickType Value,
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_InterArrivalTimeType, OS_CODE,                                          /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_HALPLATFORMTPUNSUPPORTED_XX */
...
{
  /* #10 If there has been no budget expiration until now: */
  if(Current->Dyn->Violation == OS_TPMONITORINGTYPE_NONE)
  {
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE uint32, OS_CODE, OS_ALWAYS_INLINE, Os_TpGetGlobalConfigValue, (void))
{
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_StdReturnType, OS_CODE, OS_ALWAYS_INLINE, Os_TpIsEnabledByCoreTpConfig,
(
  P2CONST(Os_TpConfigType, AUTOMATIC, OS_CONST) Config
))
{
  ...
  switch(Os_TpGetGlobalConfigValue())
  {
    ...
    case OS_CFG_TP_SOME_CORES:                                                                                          /* COV_OS_HALPLATFORMMULTICOREORTPUNSUPPORTED */
      retVal = (Config != NULL_PTR);                                                                                    /* PRQA S 4404 */ /* MD_Os_C90BooleanCompatibility */
      break;
