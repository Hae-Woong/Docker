 ...
 *  \pre          -
 **********************************************************************************************************************/
# define OS_STACK_GETHIGHADDRESS(StackLabel)  ((P2VAR(Os_Hal_StackType, TYPEDEF, OS_VAR_NOINIT))                        \
 ...
 *  OS_STACK_GETLIMIT()
 **********************************************************************************************************************/
/*! \brief        Get the address of the limit of a stack label.
 *  \details
 *  Platforms can use this macro to set context configuration data.
 *
 *  \param[in]    StackLabel  The stack label to query.
 *
 *  \context      ANY
 ...
 *  \pre          -
 **********************************************************************************************************************/
# define OS_STACK_GETLIMIT(StackLabel)  ((P2VAR(Os_Hal_StackType, TYPEDEF, OS_VAR_NOINIT))                              \
(&StackLabel[(OS_STACK_GETSIZE(StackLabel)/sizeof(Os_Hal_StackType))]))                                                 /* PRQA S 3410 */ /* MD_Os_Rule20.7_3410_Decl */
 ...
 *  \pre          -
 **********************************************************************************************************************/
# define OS_STACK_DECLARE(StackLabel, ByteSize)   VAR(Os_Hal_StackType, OS_VAR_NOINIT)                                  \
