...
{
  return (Os_StdReturnType)(OS_CFG_MEMORY_PROTECTION_FOR_APPLICATIONS == STD_ON);                                       /* PRQA S 4304, 2995, 2996 */ /* MD_Os_C90BooleanCompatibility, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
}
...
{
  return (Os_StdReturnType)(OS_CFG_MEMORY_PROTECTION_FOR_THREADS == STD_ON);                                            /* PRQA S 4304, 2995, 2996 */ /* MD_Os_C90BooleanCompatibility, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
}
...
))
{
  if(Os_MpIsEnabled() != 0u)                                                                                            /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
    if(Os_MpIsEnabledForApplications() != 0u)                                                                           /* PRQA S 2991, 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
    {
      ...
      if(Current->AppAccessRights != Next->AppAccessRights)
      {
        ...
        Os_Hal_MpAppSwitch(Current->AppAccessRights, Next->AppAccessRights);                                            /* SBSW_OS_MP_Hal_MPAPPSWITCH_001 */
      }
    }
    if(Os_MpIsEnabledForThreads() != 0u)                                                                                /* PRQA S 2991, 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
    {
      /* #30 Switch thread access rights. */
      Os_Hal_MpThreadSwitch(Current->ThreadAccessRights, Next->ThreadAccessRights);                                     /* SBSW_OS_MP_Hal_MPTHREADSWITCH_001 */
    }
  }
...
))
{
  if(Os_MpIsEnabled() != 0u)                                                                                            /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
    if(Os_MpIsEnabledForApplications() != 0u)                                                                           /* PRQA S 2991, 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
    {
      ...
      Os_Hal_MpAppSwitchTo(AccessRights->AppAccessRights);                                                              /* SBSW_OS_MP_Hal_MPAPPSWITCHTO_001 */
    }

    if(Os_MpIsEnabledForThreads() != 0u)                                                                                /* PRQA S 2991, 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
    {
      /* #20 Switch thread access rights. */
      Os_Hal_MpThreadSwitchTo(AccessRights->ThreadAccessRights);                                                        /* SBSW_OS_MP_Hal_MPTHREADSWITCHTO_001 */
    }
  }
}
