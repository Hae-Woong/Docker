...
{
  /* #10 Return !0 if the top element is a resource, otherwise return 0. */
  return (Os_StdReturnType)(Os_LockIsResource(*LockList) != 0u);                                                        /* PRQA S 4304 */ /* MD_Os_C90BooleanCompatibility */ /* SBSW_OS_LOCK_LOCKISRESOURCE_001 */
}
...
{
  /* #10 Return !0 if the top element is a spinlock, otherwise return 0. */
  return (Os_StdReturnType)(((*LockList)->Type == OS_LOCKTYPE_SPINLOCK));                                               /* PRQA S 4304 */ /* MD_Os_C90BooleanCompatibility */
}
