...
))
{
  ...
  thread = Os_CoreGetThread();                                                                                          /* PRQA S 2983 */ /* MD_Os_Rule2.2_2983_Config */
  peripheral = NULL_PTR;

  /* #10  Perform checks. */
  if(OS_UNLIKELY(Os_PeripheralCheckId(PeripheralID) == OS_CHECK_FAILED))                                                /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
  ...
  if(OS_UNLIKELY(status != OS_STATUS_OK))                                                                               /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
...
{
  return (Os_StdReturnType) (   (((const uint8*)Address) >=  ((const uint8*)Peripheral->AddressStart))                  /* PRQA S 0316, 2811, 4304 */ /* MD_Os_Rule11.5_0316, MD_Os_Dir4.1_2811_Peripheral, MD_Os_C90BooleanCompatibility */
                             && (((const uint8*)Address) <= (((const uint8*)Peripheral->AddressEnd) - (Size - 1u) )));  /* PRQA S 0488, 0316 */ /* MD_Os_Rule18.4_0488_PeripheralAddress, MD_Os_Rule11.5_0316 */
}
