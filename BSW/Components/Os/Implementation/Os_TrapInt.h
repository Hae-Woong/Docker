...
typedef enum
{
  ...
  OS_TRAPID_GETINITHOOKSTACKUSAGE,
  ...
  OS_TRAPID_COREGETLASTERRORPARAMETERSLOCAL,
...
{                                                                                                                       /* PRQA S 0750 */ /* MD_MSR_Union */
  ...
  P2CONST(Os_HookConfigType, TYPEDEF, OS_CONST)                 ParamHookConfigType;
...
{                                                                                                                       /* PRQA S 0750 */ /* MD_MSR_Union */
  ...
  Os_ErrorParamsType    ReturnOs_ErrorParamsType;
} Os_TrapReturnType;
 ...
 **********************************************************************************************************************/
/*! \brief        Returns the status passed as a parameter to the hook.
 *  \details      For further details see Os_HookGetStatus().
 *
 *  \param[in]    Hook        See Os_HookGetStatus().
 *
 *  \return       See Os_HookGetStatus().
 *
 *  \context      OS_INTERNAL
 *
 *  \reentrant    TRUE
 ...
 *  \details        For further details see Os_CoreGetLastErrorParametersLocal().
 *
 *  \return         See Os_CoreGetLastErrorParametersLocal().
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 *  \synchronous    TRUE
 *
 *  \pre            See Os_CoreGetLastErrorParametersLocal().
 **********************************************************************************************************************/
