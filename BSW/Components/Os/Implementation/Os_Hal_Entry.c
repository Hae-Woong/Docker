...
))
{
  ...
  else
  {
    ...
    /* #80 Save the raw PCXI of the upper context */
    context->RawPCXI = *(uint32*)(param + OS_HAL_CSA_PCXI_OFFSET);                                                      /* SBSW_OS_HAL_PWA_EXCEPTION_CONTEXT_SAVE */ /* PRQA S 0306, 2985 */ /* MD_Os_Hal_Rule11.4_0306, MD_Os_Hal_Rule2.2_2985 */
  }
}
...
{
  Os_ExceptionContextRefType context;                                                                                   /* PRQA S 3679 */ /* MD_Os_Hal_Rule8.13_3679 */
  uint32 param;
