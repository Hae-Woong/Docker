...
\ID SBSW_OS_JOB_COUNTERGETPHYSICALVALUE_001
 \DESCRIPTION    Os_CounterGetPhysicalValue is called with the Counter pointer derived from the caller argument Job.
                 Precondition ensures that the Job pointer is valid. The compliance of the precondition is check
                 during review.
 \COUNTERMEASURE \M [CM_OS_JOBGETCOUNTER_M]
...
\ID SBSW_OS_JOB_JOB_CALLBACK_001
 ...
 \COUNTERMEASURE  \M [CM_OS_JOB_CALLBACK_M]
