...
\ID SBSW_OS_TRACE_COREGETTRACE_001
 \DESCRIPTION    Write access to the return value of Os_CoreGetTrace.
 \COUNTERMEASURE \M [CM_OS_COREGETTRACE_M]

 \ID SBSW_OS_TRACE_COREGETTRACE_002
 \DESCRIPTION    Os_CoreGetTrace is called with the return value of Os_CoreGetCurrentCore.
 \COUNTERMEASURE \S [CM_OS_COREGETCURRENTCORE_S]
...
\CM CM_OS_TRACETHREAD_DYN_M
      Verify that the Dyn object of each thread trace object is a non NULL_PTR.
