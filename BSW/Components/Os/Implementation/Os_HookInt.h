 ...
 *  \param[in]      Hook  Hook to query. Parameter must not be NULL.
 *
 *  \return         The status parameter of the hook.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
...
/***********************************************************************************************************************
 *  Os_HookInitHookGetThread()
 **********************************************************************************************************************/
/*! \brief          Returns init hook's thread.
 *  \details        --no details--
 *
 *  \param[in]      Hook  Hook to query. Parameter must not be NULL.
 *
 *  \return         Init hook's thread.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE P2CONST(Os_ThreadConfigType, AUTOMATIC, OS_CONST), OS_CODE,
OS_ALWAYS_INLINE, Os_HookInitHookGetThread,
(
 ...
 *  \param[in]      TerminationReason The reason why the hook is killed.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_HookKill,
(
  P2CONST(Os_HookConfigType, AUTOMATIC, OS_CONST) Hook,
 ...
 *  \details      --no details--
 *
 *  \param[in]    Status  The status of the panic hook call.
 *
 *  \context      OS_INTERNAL
 *
 *  \reentrant    TRUE
