 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_SchedulerTaskRobRoundInternal,
(
  P2CONST(Os_SchedulerConfigType, AUTOMATIC, OS_CONST) Scheduler
));
...
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_SchedulerTaskRobRoundInternal,
(
  P2CONST(Os_SchedulerConfigType, AUTOMATIC, OS_CONST) Scheduler
))
{
  ...
  {
    P2CONST(Os_TaskConfigType, AUTOMATIC, OS_CONST) currentTask = Os_SchedulerGetCurrentTask(Scheduler);                /* SBSW_OS_FC_PRECONDITION */
...
)
{
  ...
  for(priority = 0; priority < Scheduler->NumberOfPriorities; priority++)                                               /* FETA_OS_CONSTANTASFUNCTIONPARAMETER */
  {
...
FUNC(void, OS_CODE) Os_SchedulerTaskRoundRobinEvent(void)
{
  ...
  if(Os_SchedulerIsRoundRobinEnabled() != 0u)                                                                           /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
    ...
    P2CONST(Os_CoreAsrConfigType, AUTOMATIC, OS_CONST) localCore = Os_ThreadGetCore(currentThread);                     /* SBSW_OS_SDR_THREADGETCORE_001 */
    P2CONST(Os_SchedulerConfigType, AUTOMATIC, OS_CONST) scheduler = Os_CoreGetScheduler(localCore);                    /* SBSW_OS_SDR_COREGETSCHEDULER_001 */
    P2CONST(Os_TaskConfigType, AUTOMATIC, OS_CONST) currentTask = Os_SchedulerGetCurrentTask(scheduler);                /* SBSW_OS_SDR_SCHEDULERGETCURRENTTASK_001 */
...
{
  P2CONST(Os_TaskConfigType, AUTOMATIC, OS_CONST) currentTask;
  P2CONST(Os_SchedulerType, TYPEDEF, OS_VAR_NOINIT) dyn;
