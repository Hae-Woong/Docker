 ...
 *  2.30.00   2019-02-21  visrk     ESCAN00100968 MICROSAR OS does support only 1023 different task priorities.
 *            2019-02-28  visaev    STORYC-7720   Internal improvement on compiler warning justification
 *  2.31.00   2019-03-13  virsmn    ESCAN00102127 Compiler Error: Unresolved Symbols.
 *            2019-03-15  visrk     STORYC-2545   Support for 64 Bit FRT timer.
 *            2019-03-29  visaev    STORYC-7156   Optimization for OS footprint.
 *  2.32.00   2019-04-12  visrk     STORYC-7966   Cleanup of vLinkGen section group OS_CODE
 *  2.33.00   2019-05-09  virsmn    STORYC-7025   Update for hierarchical interrupt controller support.
 *            2019-05-24  visaev    STORYC-8330   Optimized barrier footprint.
 *  2.34.00   2019-06-05  visdqk    -             Updated version number.
 *            2019-06-13  visdqk    FIX-6401      Moved core trace information from ASR Core to Core struct
 *            2019-06-19  visdqk    FIX-6174      Updates for generic stack gaps
 *  2.35.00   2019-07-04  visdqk    -             Updated version number.
 *            2019-07-09  visrk     OSC-3041      Internal improvements on trace link comments.
 *            2019-07-19  visdqk    STORYC-2218   Provide Os_BarrierSynchronize() as ASIL-D feature
 *            2019-07-24  visaev    STORYC-8754   Update for internal exception detection.
 *  2.36.00   2019-08-20  virsmn    OSC-4914      Compiler Warning: Volatile cast.
 *            2019-08-21  visdqk    STORYC-8771   New API to request the core status.
 *  2.37.00   2019-09-18  virsmn    OSC-3472      Support for 16 Bit FRT timer.
 *  2.38.00   2019-09-30  virsmn    -             Fix for Coverage.
 *            2019-10-08  visdqk    OSC-5189      Internal improvement (removal of compiler warning).
 *  2.39.00   2019-10-25  visdqk    OSC-5183      Release interrupt lock during timer ISR.
 *  2.40.00   2019-11-22  virsmn    OSC-5338      Optimization for feature Timing Hooks.
 *            2019-11-18  virleh    OSC-5342      Optimization for ORTI tracing.
 *  2.41.00   2019-12-20  visdqk    OSC-5248      Added feature Time Slice Scheduling.
 *            2020-01-09  visrk     ESCAN00104823 NULL pointer write with timing hooks and timing protection.
 *  2.42.00   2020-01-31  visror    ESCAN00105308 Wrong return value of OS API ReleaseResource in case of an
 *                                                erroneous call.
 *            2020-02-04  virsmn    ESCAN00104885 Undetected timing protection violation.
 *            2020-02-04  virsmn    ESCAN00105192 Time base corruption due to usage of GetCounterValue() API.
 *  2.43.00   2020-02-13  virsmn    OSC-5569      Update of SBSW justifications and countermeasures.
 *            2020-02-14  visdqk    OSC-5389      Internal improvements.
 *  2.44.00   2020-03-16  virsmn    OSC-5361      Increase number of configurable OS Applications.
 *            2020-03-17  visror    OSC-5836      Correction of API return values.
 *            2020-03-20  virleh    ESCAN00105636 Compiler error: Undefined symbol.
 *  2.45.00   2020-04-21  virsmn    ESCAN00105900 Wrong return value of GetApplicationID() and GetCurrentApplicationID()
 *                                                in Pre- or PostTaskHook.
 *            2020-04-28  virleh    OSC-5909      Internal improvements.
 *            2020-04-30  virleh    OSC-5934      More defensive counter behavior in Os_Resume(All|OS)Interrupts.
 *  2.46.00   2020-05-14  virsmn    OSC-5903      Introduced new OS API Os_GetExceptionAddress().
 *            2020-05-19  virsmn    OSC-5965      Update for Exception Context API.
 *  2.47.00   2020-06-17  virbse    -             Updated version number.
 *  2.48.00   2020-07-09  visror    OSC-5096      Qualify Feature "Fast Trusted Functions"
 *  2.49.00   2020-08-10  virleh    -             Updated version number.
 *  2.50.00   2020-09-03  virsmn    OSC-6450      Free timer usage for cores without Timing Protection.
 *  2.51.00   2020-10-06  virleh    OSC-6102      Justify all MISRA deviations after update to new QAC version.
 *            2020-10-14  virsmn    OSC-6462      Interrupt Post Action support.
 *            2020-10-14  visdqk    OSC-6655      Internal improvement.
 *  2.52.00   2020-10-28  virleh    OSC-6639      Internal improvement.
 *  2.53.00   2020-12-01  virleh    OSC-6937      Internal improvement.
 *  2.54.00   2020-12-23  virsmn    OSC-5882      ESCAN00088830, ESCAN00104942, ESCAN00089701.
 *  2.55.00   2021-01-25  virsmn    ESCAN00108054 Unpredictable behavior in case of erroneous calls of asynchronous
 *                                                X-Signal.
 *  2.56.00   2021-02-11  visdqk    OSC-161       Add StackUsage API for NonTrusted functions.
 *            2021-02-11  visdqk    OSC-6322      Replaced includes of MemMap.h by Os_MemMap.h.
 *            2021-02-23  virsmn    OSC-6295      Introduced OS Interrupt Only use case.
 *  2.56.01   2021-03-11  virbse    ESCAN00108814 Removed invalid MEMMAP_ERROR checks from MemMap header files.
 *  2.57.00   2021-03-18  visdqk    ESCAN00108354 Added an entry wrapper function for Pre-Start tasks.
 *            2021-03-19  virsmn    ESCAN00108881 OS service GetAlarm() returns invalid value.
 *            2021-03-26  virsmn    ESCAN00108060 Incorrect scheduling when terminating applications.
 *  2.58.00   2021-04-12  virsmn    ESCAN00109057 Usage of Interrupt Resources may lead to incorrect interrupt handling.
 *  2.59.00   2021-05-21  visdqk    -             Updated version number.
 *  2.60.00   2021-06-15  virbse    OSC-7107      Add support for TinyOS use case (generator only).
 *  2.61.00   2021-07-07  virbse    OSC-7565      Create OS SwAddrMethod mappings (generator only).
 *            2021-07-09  visdqk    ESCAN00109375 EnableAllInterrupt API does not work as expected in OS Interrupt Only
 *                                                use case.
 *  2.61.01   2021-08-17  virsmn    OSC-7773      Internal improvements.
 *  2.62.00   2021-09-23  visdqk    OSC-7919      MISRA migration to new QAC version.
 *            2021-10-12  virleh    ESCAN00108150 Cross Core API function call returns E_OS_SYS_OVERFLOW.
 *  2.63.00   2021-11-03  virleh    -             Update version number.
 *  2.64.00   2021-11-26  visdqk    OSC-8037      Internal improvement.
 *            2021-12-06  visrk     OSC-6113      64 Bit Support for VttOs.
 *  2.65.00   2021-12-16  virsmn    OSC-8186      Updates for new QAC version (MISRA).
 *  2.66.00   2022-02-25  virbse    OSC-8418      Update Generator to support VTT with GnuGcc (generator only).
 *  2.67.00   2022-03-09  virsmn    OSC-8417      Internal improvement.
 *            2022-03-24  virbse    OSC-7628      Support ARTI.
 *            2022-03-30  visrk     OSC-8555      Rework MPU initialization / Add traps for read (with HALBE-4893).
 *  2.68.00   2022-04-13  virleh    ESCAN00111717 Endless call of OS TimingProtection ISR.
 *            2022-04-14  virleh    ESCAN00111699 Incorrect OwnerThread for IOC Spinlocks.
 *            2022-04-25  virleh    OSC-8594      Internal improvement.
 *            2022-04-27  visrk     ESCAN00111775 Unpredictable behavior in case of implicitly synchronized Schedule
 *                                                Tables.
 *            2022-04-28  virleh    OSC-8586      Fixed compiler warning reported by MSVC.
 *  2.69.00   2022-05-23  virleh    OSC-8719      Internal improvement.
 *  2.70.00   2022-06-02  twurm     OSC-8506      Move Doxygen CDD to CAD.
 *  2.71.00   2022-07-01  virleh    -             Update version number.
 *  2.72.00   2022-08-16  virleh    -             Update version number.
 *  2.73.00   2022-09-23  twurm     OSC-6921      Update POSIX Guest OS to a newer Release.
 *  2.74.00   2022-10-31  virsmn    ESCAN00112961 OS API function GetAlarm returns wrong alarm time.
 *            2022-11-07  virleh    OSC-8223      Finish 64 bit support
 *  2.75.00   2022-12-05  twurm     OSC-9021      Perform FETA on Core and VTT.
 *            2022-12-08  sreif     OSC-8334      Provide Service to enable global interrupt handling.
 *            2022-12-15  sreif     OSC-9346      Unify MemMap handling for static analysis.
 *  2.76.00   2023-01-30  visdqk    OSC-9327      Verify that the FRT compare value is written to hardware.
 *            2023-01-30  sreif     OSC-9415      Justify compiler warnings in test implementation.
 *  2.77.00   2023-02-16  mwohnhaas OSC-2988      Add feature Counter Algorithm.
              2023-02-23  visdqk    OSC-9528      Fixed TP counter initialization.
              2023-02-23  mwohnhaas OSC-9523      Fixed ESCAN00113942: IOC buffer generated too small.
 *  2.78.00   2023-03-07  virleh    -             Updated version number.
 *            2023-03-23  visrk     OSC-9634      Replace bitfield in Os_IntLockingStateType by boolean.
 *            2023-03-29  mwohnhaas OSC-9446      Remove static variables with local scope.
 *  2.79.00   2023-04-13  sreif     OSC-9553      Optimize Os_SpinlockForciblyReleaseThreadLocks().
 *            2023-04-13  sreif     ESCAN00114338 Fixed unintended kernel panic call if Shutdown from a Cat2 Isr.
 *            2023-04-13  sreif     ESCAN00114355 Fixed unintended kernel panic call if Shutdown from a hook.
 *            2023-04-14  sreif     OSC-9673      Rename OS_CALLCONTEXT_TERMINATEABLE.
 *  2.80.00   2023-05-02  visdqk    -             Updated version number.
 *            2023-05-15  mwohnhaas OSC-9705      Fixed ESCAN00114342: Unintended Shutdown in a Protection Hook.
 *            2023-05-15  rleinauer OSC-9764      Allow protection hook without forcible termination.
 *  2.81.00   2023-06-16  visdqk    OSC-9774      Refactor forcible lock releasing.
 *  2.82.00   2023-07-14  mwohnhaas -             Updated version number.
 *            2023-07-17  sreif     OSC-9881      Fix ESCAN00114757 Cache Coherence Issue.
 *  2.83.00   2023-08-07  twurm     OSC-9569      Add support for Metaware Ccac Compiler.
 *            2023-08-09  virsmn    OSC-8717      Debug support for PanicHook calls.
 *  2.84.00   2023-08-21  hsimon    OSC-9161      Add API function GetInitHookStackUsage.
 *            2023-08-31  asaleh    OSC-6302      Add API functions ActivateTaskAsyn and SetEventAsyn.
 *            2023-09-19  visdqk    OSC-8213      Added hooks to the error code descriptions.
 *            2023-09-27  mwohnhaas ESCAN00115593 Initialize next run reason of threads for ARTI.
 *  2.85.00   2023-10-16  rleinauer ESCAN00115055 Initialize return value for stack measurement API.
 *            2023-10-23  sreif     OSC-10163     Reduce footprint of Os_IsrKill() and Os_HookKill().
 *            2023-10-24  visrk     OSC-10252     Small improvement to increase test coverage.
 *            2023-11-10  rleinauer OSC-9262      Fix for ESCAN00113015: Call ARTI hooks only with instance name 'Os'.
 *  2.86.00   2023-12-12  visrk     OSC-10454     Introduce panic reason: shutdown.
 *            2023-12-15  hsimon    OSC-10343     Justify coverage gaps on VTT.
 *  2.87.00   2024-01-15  asaleh    OSC-10461     Initialize errorParameters object to zero.
 *            2024-02-05  sreif     OSC-10630     Moved coverage justification from VTT to core.
 *            2024-02-26  mwohnhaas OSC-10671     Fix new MISRA violations after QAC update.
 *            2024-02-27  visrk     ESCAN00116698 Fixed: Trusted/non-trusted/fast-trusted function not performed.
 *  2.88.00   2024-03-05  asaleh    -             Updated version number.
 *            2024-03-18  mwohnhaas OSC-10853     Improvements to follow MISRA rules.
 *            2024-04-04  hsimon    ESCAN00116976 Unexpected call of ARTI trace hook with OsTask_Release.
 *            2024-04-05  hsimon    ESCAN00116830 ARTI current thread tracing via variables does not work if ORTI is not
 *                                                configured.
 *            2024-04-09  mwohnhaas -             Justify coverage gap on platforms without interrupt nesting.
 *            2024-04-12  rleinauer ESCAN00116465 Memory fault in getter APIs using ARTI hooks for service calls.
 *  2.89.00   2024-07-24  visdqk    OSC-11036     Added MMU Support.
 *            2024-08-16  sreif     ESCAN00117091 Sporadic issue in cross-core communication.
 *  2.89.01   2024-11-04  virsmn    TAR-66570     Trivial change.
 **********************************************************************************************************************/
...
# define OS_SW_MINOR_VERSION                     (89u)
...
/*!
 * Redefinition of SetEvent to Os_SetEvent in the OS Context.
 *
 ...
 *  \details      Gets the address of the instruction that raised the latest exception.
 *                The returned address is only valid if at least one exception has occured.
 *
 *  \return       Address of the instruction that raised the latest exception.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 *  \trace        CREQ-247263
 **********************************************************************************************************************/
FUNC(Os_AddressOfConstType, OS_CODE) Os_GetExceptionAddress
(
  void
);
 ...
 *  \details      The function performs all initialization steps which are needed to handle
 *                   - Category 1 Interrupts
 *                   - Exceptions
 *                   - Unhandled Interrupts
 *                   - Unhandled Exceptions
 *                After call of Os_InitInterruptOnly() the AUTOSAR API StartOS() must not be called.
 *                After call of Os_InitInterruptOnly() the following AUTOSAR interrupt APIs may be used:
 ...
 *  \pre          Pre-Condition: Concurrent access is prevented by caller.
 **********************************************************************************************************************/
FUNC(void, OS_CODE) Os_InitInterruptOnly
(
  void
);
 ...
 *                E_OS_CALLEVEL       (EXTENDED status:) Called from invalid context.
 *                E_OS_DISABLEDINT    (EXTENDED status:) Caller is in interrupt API sequence.
 *
 *  \context      TASK|ISR2
 *
 *  \reentrant    FALSE
 ...
 **********************************************************************************************************************/
/*! \brief        Get the current maximum stack usage of the given task.
 *  \details      In case of an error, the function simply returns 0. The following error information is only provided
 *                in the ErrorHook:
 *                E_OS_SYS_DISABLED Stack usage measurement is disabled in the configuration.
 *                E_OS_ID           (EXTENDED status:) Passed task ID is not a valid ID.
 *
 *  \param[in]    TaskID        The task which shall be queried.
 *
 *  \return       Current maximum stack usage of the given task in bytes or zero.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 *  Os_GetISRStackUsage()
 **********************************************************************************************************************/
/*! \brief        Get the current maximum stack usage of the given ISR.
 *  \details      In case of an error, the function simply returns 0. The following error information is only provided
 *                in the ErrorHook:
 *                E_OS_SYS_DISABLED Stack usage measurement is disabled in the configuration.
 *                E_OS_ID           (EXTENDED status:) Passed ISR ID is not a valid ID.
 *
 *  \param[in]    IsrID         The ISR which shall be queried.
 *
 *  \return       Current maximum stack usage of the given ISR in bytes or zero.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 **********************************************************************************************************************/
/*! \brief        Get the current maximum kernel stack usage on the given core.
 *  \details      In case of an error, the function simply returns 0. The following error information is only provided
 *                in the ErrorHook:
 *                E_OS_SYS_DISABLED Stack usage measurement is disabled in the configuration.
 ...
 *
 *  \return       Current maximum kernel stack usage on the given core in bytes or zero.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
...
/***********************************************************************************************************************
 *  Os_GetInitHookStackUsage()
 **********************************************************************************************************************/
/*! \brief        Get the current maximum init hook stack usage on the given core.
 *  \details      In case of an error, the function simply returns 0. The following error information is only provided
 *                in the ErrorHook:
 *                E_OS_SYS_DISABLED Stack usage measurement is disabled in the configuration.
 *                E_OS_ID           (EXTENDED status:) Passed Core ID is not a valid ID.
 ...
 *  \param[in]    CoreID         The core which shall be queried.
 *
 *  \return       Current maximum init hook stack usage on the given core in bytes or zero.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 *  \pre          Pre-Condition: None
 **********************************************************************************************************************/
FUNC(uint32, OS_CODE) Os_GetInitHookStackUsage
(
  CoreIdType CoreID
);
 ...
 **********************************************************************************************************************/
/*! \brief        Get the current maximum startup hook stack usage on the given core.
 *  \details      In case of an error, the function simply returns 0. The following error information is only provided
 *                in the ErrorHook:
 *                E_OS_SYS_DISABLED Stack usage measurement is disabled in the configuration.
 *                E_OS_ID           (EXTENDED status:) Passed Core ID is not a valid ID.
 ...
 *  \param[in]    CoreID         The core which shall be queried.
 *
 *  \return       Current maximum startup hook stack usage on the given core in bytes or zero.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 **********************************************************************************************************************/
/*! \brief        Get the current maximum error hook stack usage on the given core.
 *  \details      In case of an error, the function simply returns 0. The following error information is only provided
 *                in the ErrorHook:
 *                E_OS_SYS_DISABLED Stack usage measurement is disabled in the configuration.
 ...
 *  \param[in]    CoreID         The core which shall be queried.
 *
 *  \return       Current maximum error hook stack usage on the given core in bytes or zero.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 **********************************************************************************************************************/
/*! \brief        Get the current maximum shutdown hook stack usage on the given core.
 *  \details      In case of an error, the function simply returns 0. The following error information is only provided
 *                in the ErrorHook:
 *                E_OS_SYS_DISABLED Stack usage measurement is disabled in the configuration.
 *                E_OS_ID           (EXTENDED status:) Passed is not a valid ID.
 ...
 *  \param[in]    CoreID         The core which shall be queried.
 *
 *  \return       Current maximum shutdown hook stack usage on the given core in bytes or zero.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 **********************************************************************************************************************/
/*! \brief        Get the current maximum protection hook stack usage on the given core.
 *  \details      In case of an error, the function simply returns 0. The following error information is only provided
 *                in the ErrorHook:
 *                E_OS_SYS_DISABLED Stack usage measurement is disabled in the configuration.
 *                E_OS_ID           (EXTENDED status:) Passed is not a valid ID.
 ...
 *  \param[in]    CoreID         The core which shall be queried.
 *
 *  \return       Current maximum protection hook stack usage on the given core in bytes or zero.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 **********************************************************************************************************************/
/*! \brief        Get the current maximum stack usage of the given non-trusted function.
 *  \details      Returns the number of bytes used by the stack with the highest consumption in the function's
 *                stack pool. The API runtime depends on the number of configured stacks for the non-trusted function.
 *                In case of an error, the function simply returns 0. The following error information is only provided
 *                in the ErrorHook:
 *                E_OS_SYS_DISABLED Stack usage measurement is disabled in the configuration.
 *                E_OS_ID           (EXTENDED status:) Passed function index is not valid.
 *
 *  \param[in]    FunctionIndex        The function index which shall be queried.
 *
 *  \return       Current maximum stack usage of the given non-trusted function in bytes or zero.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 *  \pre          Pre-Condition: None
 **********************************************************************************************************************/
FUNC(uint32, OS_CODE) Os_GetNonTrustedFunctionStackUsage
(
 ...
 *  Os_EnableInterruptsPreStart()
 **********************************************************************************************************************/
/*! \brief        OS service Os_EnableInterruptsPreStart().
 *  \details      Enables the recognition status of all interrupts on the current core.
 *                This functions shall be used after Os_Init() or Os_InitInterruptOnly() but not after StartOS().
 *
 *  \context      INIT
 *
 *  \reentrant    FALSE
 *  \synchronous  TRUE
 *
 *  \pre          Pre-Condition: Os_Init() or Os_InitInterruptOnly() has been called on the current core.
 *  \pre          Pre-Condition: StartOS() has not been called on the current core.
 *
 *  \trace        CREQ-Os-EnablePreStart
 **********************************************************************************************************************/
FUNC(void, OS_CODE) Os_EnableInterruptsPreStart(void);
 ...
 *  \details      The calling Task will block here until the required number of participating tasks have also
 *                called Os_BarrierSynchronize(). The operating system checks that the Task is allowed to
 *                participate in the given barrier.
 *
 *  \param[in]    BarrierID         The barrier to which the task shall be synchronized.
 *
 *  \return       E_OK                               No error.
 ...
 *                                                                     the local core.
 *                                                  (EXTENDED status:) The Task is not configured to participate in
 *                                                                     the barrier.
 *
 *  \context      TASK
 *
 ...
 *  ActivateTaskAsyn()
 **********************************************************************************************************************/
/*! \brief        OS service ActivateTaskAsyn().
 *  \details      The task TaskID is transferred from the SUSPENDED state into the READY state.
 *                The operating system ensures that the task code is being executed from the first statement.
 *
 *  \param[in]    TaskID            The task which shall be activated.
 ...
 *                E_OS_DISABLEDINT  (EXTENDED status:) The service was called with disabled interrupts.
 *
 *  \context      TASK
 *
 *  \reentrant    TRUE
 ...
 *                E_OS_CALLEVEL       (EXTENDED status:) Called from invalid context.
 *                E_OS_DISABLEDINT    (EXTENDED status:) Caller is in interrupt API sequence.
 *                E_OS_SYS_DISABLED   (EXTENDED status:) Events are not enabled in the configuration.
 *
 *  \context      TASK|ISR2
 *
 *  \reentrant    TRUE
 ...
 *                                    - Spinlock and Resource API not used in LIFO order.
 *                E_OS_ACCESS       (Service Protection:) Caller's access rights are not sufficient.
 *                E_OS_DISABLEDINT  (EXTENDED status:) Caller is in interrupt API sequence.
 *
 *  \context      TASK|ISR2
 ...
 *                OS_MEM_ACCESS_TYPE_NON      No access, invalid TaskID or address range overflow.
 *
 *  \context      TASK|ISR2|ERRHOOK|PROTHOOK
 *
 *  \reentrant    TRUE
 ...
 **********************************************************************************************************************/
/*! \brief        This service returns the current start state of a given core.
 *  \details      This service supports AUTOSAR as well as non-AUTOSAR cores.
 *                This API is allowed to be used from AUTOSAR cores.
 *
 *  \param[in]    CoreID     The core which shall be queried.
 *  \param[out]   CoreState  Core state.
 *  \param[out]   Status     Status code.
 *
 *  \return       E_OK                No Error.
 *                E_OS_PARAM_POINTER  (EXTENDED status:) Given pointer is NULL.
 ...
 *  \trace        CREQ-213720
 **********************************************************************************************************************/
FUNC(void, OS_CODE) Os_GetCoreStartState(
  CoreIdType CoreID,
...
***********************************************************************************************************************/
/*! \brief        Returns parameter FunctionIndex of a faulty Os_CallFastTrustedFunction call.
 *  \details      --no details--
 *
 *  \return       Requested parameter value.
 *
 ...
 *  \trace        SPEC-67578, SPEC-63766
 **********************************************************************************************************************/
FUNC(Os_FastTrustedFunctionIndexType, OS_CODE) OSError_CallFastTrustedFunction_FunctionIndex(void);


/***********************************************************************************************************************
 *  OSError_CallFastTrustedFunction_FunctionParams()
 **********************************************************************************************************************/
/*! \brief        Returns parameter FunctionParams of a faulty Os_CallFastTrustedFunction call.
 *  \details      --no details--
 *
 *  \return       Requested parameter value.
 *
 ...
 *  \trace        SPEC-67578, SPEC-63766
 **********************************************************************************************************************/
FUNC(Os_FastTrustedFunctionParameterRefType, OS_CODE)
OSError_CallFastTrustedFunction_FunctionParams(void);                                                                    /* PRQA S 0777 */ /* MD_MSR_Rule5.1 */
...
***********************************************************************************************************************/
/*! \brief        Returns parameter FunctionIndex of a faulty Os_CallNonTrustedFunction call.
 *  \details      --no details--
 *
 *  \return       Requested parameter value.
 *
 ...
 **********************************************************************************************************************/
/*! \brief        Returns parameter FunctionParams of a faulty Os_CallNonTrustedFunction call.
 *  \details      --no details--
 *
 *  \return       Requested parameter value.
 *
...
/***********************************************************************************************************************
 *  OSError_ActivateTaskAsyn_TaskID()
 **********************************************************************************************************************/
/*! \brief        Returns parameter TaskID of a faulty ActivateTaskAsyn call.
 *  \details      --no details--
 *
 *  \return       Requested parameter value.
 *
 ...
 *  \trace        SPEC-63736
 **********************************************************************************************************************/
FUNC(TaskType, OS_CODE) OSError_ActivateTaskAsyn_TaskID(void);
...
/***********************************************************************************************************************
 *  OSError_SetEventAsyn_TaskID()
 **********************************************************************************************************************/
/*! \brief        Returns parameter TaskID of a faulty SetEventAsyn call.
 *  \details      --no details--
 *
 *  \return       Requested parameter value.
 *
 ...
 *  \trace        SPEC-63736
 **********************************************************************************************************************/
FUNC(TaskType, OS_CODE) OSError_SetEventAsyn_TaskID(void);


/***********************************************************************************************************************
 *  OSError_SetEventAsyn_Mask()
 **********************************************************************************************************************/
/*! \brief        Returns parameter Mask of a faulty SetEventAsyn call.
 *  \details      --no details--
 *
 *  \return       Requested parameter value.
 *
 ...
 *  \trace        SPEC-63736
 **********************************************************************************************************************/
FUNC(EventMaskType, OS_CODE) OSError_SetEventAsyn_Mask(void);
