...
{
  return (Os_StdReturnType)(OS_CFG_ALARM_SETEVENT_USED == STD_ON);                                                      /* PRQA S 2995, 4304 */ /* MD_Os_Rule2.2_2995, MD_Os_C90BooleanCompatibility */
}
...
{
  return (Os_StdReturnType)(OS_CFG_ALARM_ACTIVATETASK_USED == STD_ON);                                                  /* PRQA S 2995, 4304 */ /* MD_Os_Rule2.2_2995, MD_Os_C90BooleanCompatibility */
}
...
{
  return (Os_StdReturnType)(OS_CFG_ALARM_INCREMENTCOUNTER_USED == STD_ON);                                              /* PRQA S 2995, 4304 */ /* MD_Os_Rule2.2_2995, MD_Os_C90BooleanCompatibility */
}
...
{
  return (Os_StdReturnType)(OS_CFG_ALARM_CALLBACK_USED == STD_ON);                                                      /* PRQA S 2995, 2996, 4304 */ /* MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996, MD_Os_C90BooleanCompatibility */
}
...
{
  return (P2CONST(Os_AlarmActivateTaskConfigType, AUTOMATIC, OS_CONST))Job;                                             /* PRQA S 0310, 3305 */ /* MD_Os_Rule11.3_0310, MD_Os_Rule11.3_3305 */
}
...
{
  return (P2CONST(Os_AlarmIncrementCounterConfigType, AUTOMATIC, OS_CONST))Job;                                         /* PRQA S 0310, 3305 */ /* MD_Os_Rule11.3_0310, MD_Os_Rule11.3_3305 */
}
...
{
  return (P2CONST(Os_AlarmCallbackConfigType, AUTOMATIC, OS_CONST))Job;                                                 /* PRQA S 0310, 3305 */ /* MD_Os_Rule11.3_0310, MD_Os_Rule11.3_3305 */
}
...
)
{
  ...
  alarm = Os_AlarmJob2AlarmSetEvent(Job);                                                                               /* SBSW_OS_AL_ALARMJOB2ALARMSETEVENT_001 */
  ...
  Os_ErrReportAlarmActionSetEvent(status, Os_TaskGetId(alarm->Task), alarm->Mask);                                      /* SBSW_OS_AL_TASKGETID_002 */
}
...
)
{
  ...
  alarm = Os_AlarmJob2AlarmActivateTask(Job);                                                                           /* SBSW_OS_AL_ALARMJOB2ALARMACTIVATETASK_001 */
  ...
  /* #30 Report error if applicable. */
  Os_ErrReportAlarmActionActivateTask(status, Os_TaskGetId(alarm->Task));                                               /* SBSW_OS_AL_TASKGETID_001 */
}
...
)
{
  ...
  alarm = Os_AlarmJob2AlarmIncrementCounter(Job);                                                                       /* SBSW_OS_AL_ALARMJOB2ALARMINCREMENTCOUNTER_001 */
...
)
{
  ...
  if(Os_AlarmHasActionCallback() == 0u)                                                                                 /* COV_OS_INVSTATE */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
  {
    Os_ErrKernelPanic(OS_STATUS_PANIC_FUNCTIONALITY_NOT_AVAILABLE);                                                     /* PRQA S 2880 */ /* MD_Os_Rule2.1_2880 */
  }

  coreAsr = Os_JobGetCore(Job);                                                                                         /* SBSW_OS_FC_PRECONDITION */
  alarm = Os_AlarmJob2AlarmCallback(Job);                                                                               /* SBSW_OS_AL_ALARMJOB2ALARMCALLBACK_001 */
...
)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if(OS_LIKELY(Os_CoreAsrIsCoreLocal(targetCore) != 0u))                                                            /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* SBSW_OS_AL_COREASRISCORELOCAL_001 */ /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
      {
...
)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if(OS_LIKELY(Os_CoreAsrIsCoreLocal(targetCore) != 0u))                                                            /* SBSW_OS_AL_COREASRISCORELOCAL_001 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
      {
        Os_IntStateType intState;
...
\ID SBSW_OS_AL_ALARMJOB2ALARMSETEVENT_001
 \DESCRIPTION    Os_AlarmJob2AlarmSetEvent is called with an argument passed to the caller function.
                 As the type correctness of the argument is configuration dependent, it cannot be guaranteed by means
                 of implementation. Therefore, it is checked by MSSV.
 \COUNTERMEASURE \M [CM_OS_ALARMJOB2ALARMSETEVENT_M]

\ID SBSW_OS_AL_ALARMJOB2ALARMACTIVATETASK_001
 \DESCRIPTION    Os_AlarmJob2AlarmActivateTask is called with an argument passed to the caller function.
                 As the type correctness of the argument is configuration dependent, it cannot be guaranteed by means
                 of implementation. Therefore, it is checked by MSSV.
 \COUNTERMEASURE \M [CM_OS_ALARMJOB2ALARMACTIVATETASK_M]

\ID SBSW_OS_AL_ALARMJOB2ALARMINCREMENTCOUNTER_001
 \DESCRIPTION    Os_AlarmJob2AlarmIncrementCounter is called with an argument passed to the caller function.
                 As the type correctness of the argument is configuration dependent, it cannot be guaranteed by means
                 of implementation. Therefore, it is checked by MSSV.
 \COUNTERMEASURE \M [CM_OS_ALARMJOB2ALARMINCREMENTCOUNTER_M]

\ID SBSW_OS_AL_ALARMJOB2ALARMCALLBACK_001
 \DESCRIPTION    Os_AlarmJob2AlarmCallback is called with an argument passed to the caller function.
                 As the type correctness of the argument is configuration dependent, it cannot be guaranteed by means
                 of implementation. Therefore, it is checked by MSSV.
...
\ID SBSW_OS_AL_TASKGETID_001
 \DESCRIPTION    Os_TaskGetId is called with the return value of Os_AlarmJob2AlarmActivateTask.
 \COUNTERMEASURE \M [CM_OS_ALARM_TASK_M]
                 \M [CM_OS_ALARMJOB2ALARMACTIVATETASK_M]

\ID SBSW_OS_AL_TASKGETID_002
 \DESCRIPTION    Os_TaskGetId is called with the return value of Os_AlarmJob2AlarmSetEvent.
 \COUNTERMEASURE \M [CM_OS_ALARM_TASK_M]
                 \M [CM_OS_ALARMJOB2ALARMSETEVENT_M]
