...
/*! Defines the reason for a thread termination. */
typedef enum
{
  OS_VOLUNTARY_TERMINATION,  /*!< Thread terminates voluntarily. */
  OS_FORCIBLE_TERMINATION,   /*!< Thread is forcibly terminated. */
  OS_SHUTDOWN_TERMINATION    /*!< Thread is terminated due to shutdown. */
} Os_TerminationType;
