...
{
   return (Os_StdReturnType)((uint16)OS_SCHTID_COUNT > 0u);                                                             /* PRQA S 4304, 2995 */ /* MD_Os_C90BooleanCompatibility, MD_Os_Rule2.2_2995 */
}
...
))
{
  ...
  {
    P2CONST(Os_SchTType, AUTOMATIC, OS_VAR_NOINIT) dyn;
...
{
  return (P2CONST(Os_SchTConfigType, AUTOMATIC, OS_CONST))Job;                                                          /* PRQA S 0310, 3305 */ /* MD_Os_Rule11.3_0310, MD_Os_Rule11.3_3305 */
}
...
{
  return (P2VAR(Os_SchTType, AUTOMATIC, OS_VAR_NOINIT))Os_JobGetDyn(&(ScheduleTable->Job));                             /* PRQA S 0310, 3305 */ /* MD_Os_Rule11.3_0310, MD_Os_Rule11.3_3305 */ /* SBSW_OS_FC_PRECONDITION */
}
...
{
  P2CONST(Os_SchTSyncType, AUTOMATIC, OS_CONST) dynSync;
...
{
  P2CONST(Os_SchTType, AUTOMATIC, OS_CONST) dyn;
...
))
{
  ...
  if(ScheduleTable != dyn->Next)
  {
    ...
    {
      P2CONST(Os_SchTSyncConfigType, AUTOMATIC, OS_CONST) scheduleTableSync;
      P2CONST(Os_SchTSyncType, AUTOMATIC, OS_VAR_NOINIT) dynSync;
...
))
{
  ...
  /* #10 Activate all configured tasks. */
  {
    ...
    for(taskIdx = ((Os_SchTTaskIdxType)0); taskIdx < ExPo->TaskCount; ++taskIdx)                                        /* FETA_OS_CONSTANTASFUNCTIONPARAMETER */
    {
  ...
  /* #20 Set each configured event. */
  {
    ...
    for(eventIdx = 0; eventIdx < ExPo->EventCount; ++eventIdx)                                                          /* FETA_OS_CONSTANTASFUNCTIONPARAMETER */
    {
...
)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if(OS_LIKELY(Os_AppIsCoreLocal(scheduleTable->OwnerApplication) != 0u))                                           /* SBSW_OS_SCHT_APPISCORELOCAL_001 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
      {
...
)
{
  ...
  else
  {
    ...
    {
      if(OS_LIKELY(Os_AppIsCoreLocal(scheduleTable_From->OwnerApplication) != 0u))                                      /* SBSW_OS_SCHT_APPISCORELOCAL_001 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
      {
        Os_IntStateType interruptState;
...
)
{
  ...
  else
  {
    ...
    else if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(Os_AppGetCore(scheduleTable->OwnerApplication)) == OS_CHECK_FAILED)) /* SBSW_OS_SCHT_COREASRCHECKISCORELOCAL_001 */ /* SBSW_OS_SCHT_APPGETCORE_001 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
    {
  ...
  else
  {
    ...
    else
    {
      ...
      if(OS_LIKELY(Os_AppIsCoreLocal(scheduleTable->OwnerApplication) != 0u))                                           /* SBSW_OS_SCHT_APPISCORELOCAL_001 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
      {
        ...
        status = Os_SchTGetScheduleTableStatus(scheduleTable, ScheduleStatus);                                          /* SBSW_OS_SCHT_SCHTGETSCHEDULETABLESTATUS_001 */ /* COMP_WARN_OS_UNINITIALIZED_VAR */
...
)
{
  ...
  return Os_SchTGetScheduleTableStatus(ScheduleTable, ScheduleStatus);                                                  /* SBSW_OS_FC_PRECONDITION */ /* COMP_WARN_OS_UNINITIALIZED_VAR */
}
...
)
{
  ...
  do                                                                                                                    /* FETA_OS_EXTERNALTERMINATIONSCHT */
  {
