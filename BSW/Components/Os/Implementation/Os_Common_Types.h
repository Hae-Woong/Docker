...
/* module specific MISRA deviations:
  ...
  MD_Os_C90BooleanCompatibility:
      ...
      Risk:       Readability of the code may not be optimal. This is low risk as the developers are still familiar
                  with C90.
      Prevention: Code inspection by C90 experts.

  MD_Os_BoolOnlyInStaticAnalysis:
      Reason:     The MISRA checker detects that the condition is always TRUE or always FALSE. This is a false
                  positive, caused by the fact that we perform MISRA analysis with typedef _Bool Boolean while
                  a typedef unsigned int boolean would be typically used in C90 code. The check shall asure
                  that the value is really TRUE or FALSE (although a bigger value range is possible for unsigned
                  int).
      Risk:       None.
      Prevention: None.
  ...
  MD_Os_Dir4.1_2811_Peripheral:
      Reason:     The function Os_PeripheralIsInAddressRange() is called with a value returned by the function
                  Os_PeripheralCheck(). This function returns a variable that is initialized with a NULL_PTR.
                  If the checks in the function Os_PeripheralCheck() are not successful, the value of the variable
                  stays NULL_PTR. This is not problematic as in this case a non-returning ProtectionHook is called
                  before returning. Thus, the NULL_PTR is never passed to Os_PeripheralIsInAddressRange().
      Risk:       None, as no NULL_PTR is passed to Os_PeripheralIsInAddressRange().
      Prevention: None.
  ...
  MD_Os_Rule2.1_2880_NonReturning:
  ...
  MD_Os_Rule2.2_2981:
      Reason:     Whether a value is written to the variable, depends on a configuration or platform parameter.
                  Thus, unconditional initialization is required.
      Risk:       None, because in other configurations or on other platforms the initialization is required.
      Prevention: None.
  ...
  MD_Os_Rule2.2_2982_Config:
      Reason:     Whether the assigned value is used before being modified, depends on a configuration
                  or platform parameter.
      Risk:       None, because in other configurations or on other platforms the assignment is required.
      Prevention: None.

  MD_Os_Rule2.2_2982_ContextSwitch:
      Reason:     The assignment is done before a context switch and used after it (return to the interrupted context).
                  Due to the context switch, the dataflow analysis of the MISRA tool is incomplete leading to the
                  variable usage not being recognized.
      Risk:       None, because the assignment isn't redundant as the assigned value is used after the context switch.
      Prevention: None.
  ...
  MD_Os_Rule2.2_2983_Config:
      Reason:     Whether the assigned value is subsequently used, depends on a configuration or platform parameter.
      Risk:       None, because in other configurations or on other platforms the assignment is required.
      Prevention: None.

  MD_Os_Rule2.2_2986:
      Reason:     Whether the result of this operation is always that of the right-hand operand, depends on a
                  configuration or platform parameter.
      Risk:       None, because in other configurations or on other platforms the operation is not redundant.
      Prevention: None.

  MD_Os_Rule2.2_2987:
      Reason:     Whether this function has a side effect or is just implemented as a stub depends on the platform.
      Risk:       None, because on other platforms the function has a side effect.
      Prevention: None.

  MD_Os_Rule2.2_2987_Global:
      Reason:     The function does have a side effect as it modifies the value of a global variable directly
                  or indirectly via a pointer. Thus, the function is not redundant and can't be removed.
      Risk:       None, as the function has a side effect.
      Prevention: None.

  MD_Os_Rule2.2_2995:
      Reason:     The result of the logical operation depends on a configuration or platform parameter.
      Risk:       None, because in other configurations or on other platforms it may be false.
      Prevention: None.

  MD_Os_Rule2.2_2996:
      Reason:     The result of the logical operation depends on a configuration or platform parameter.
      Risk:       None, because in other configurations or on other platforms it may be true.
      Prevention: None.
  ...
  MD_Os_Rule8.5_3449_LinkerSymbol:
      Reason:     The linker symbol start/end addresses are declared in multiple files. As the consistency of
                  the multiple declarations is checked by the compiler, this is unproblematic.
      Risk:       None.
      Prevention: None.

  MD_Os_Rule8.5_3451:
      Reason:     See MD_Os_Rule8.5_3449.
      Risk:       None.
      Prevention: None.

  MD_Os_Rule8.5_3451_LinkerSymbol:
      Reason:     See MD_Os_Rule8.5_3449_LinkerSymbol.
      Risk:       None.
      Prevention: None.
  ...
  MD_Os_Rule9.1_2972:
      Reason:     The variable is not always initialized since this is only done when certain conditions are fulfilled.
                  However, the same conditions are also checked before the variable is accessed. Consider that checking
                  the conditions may already be done in the calling function.
      Risk:       Usage of an uninitialized variable when accessing it unconditionally.
  ...
  MD_Os_Rule10.1_4115:
      Reason:     An operator with a fixed boolean like value zero or non zero is used in this logical operation.
                  The code is developed according to C90 standard. So boolean values are represented by integral
                  types.
      Risk:       None.
      Prevention: None.

  MD_Os_Rule10.1_4116:
      Reason:     See MD_Os_Rule10.1_4115.
      Risk:       None.
      Prevention: None.
  ...
  MD_Os_Rule11.4_0306_ListEnd:
      ...
      Risk:       Data width of the pointer may differ from the data width of the integral type.
      Prevention: It is ensured by design, that the integral type has the correct data width.
  ...
  MD_Os_Rule11.5_0316:
      Reason:     Casting a void pointer to an integral type is done in the context of an address range check.
                  This is necessary here to calculate with byte granularity.
      Risk:       None.
      Prevention: None.
  ...
  MD_Os_Rule12.4_2910:
      Reason:     Overflow calculation for hardware timers with counter register bit width smaller then the OS TickType.
      Risk:       None, as the implementation ensures the correctness of the usage of calculation.
                  Furthermore the code shall be removed by compiler if the size difference condition is not fulfilled.
      Prevention: None.

  MD_Os_Rule13.3_3387:
      Reason:     The expression contains an increment/decrement operator and has potential
                  side effects (function call, pointer dereference).
      Risk:       The order of the expression evaluation may not be clear and can lead to unexpected results.
      Prevention: Implementation Review.
  ...
  MD_Os_Rule14.3_2991:
      Reason:     The controlling expression depends on a configuration or platform parameter.
      Risk:       None, because in other configurations or on other platforms it may be false.
      Prevention: None.
  ...
  MD_Os_Rule16.3_2024:
      Reason:     The last case of a switch statement is a default case that calls Os_ErrKernelPanic with status
                  OS_STATUS_PANIC_SWITCH_CASE_DEFAULT. The default case only exists for defensive programming reasons
                  and is not reachable by valid inputs.
      Risk:       None, because the kernel panic does not return.
      Prevention: None.
  ...
  MD_Os_Rule18.6_2916:
      Reason:     Pointer to a local variable is assigned to an output argument of a function.
      Risk:       The output argument is invalid when the function returns and may not be used.
      Prevention: The output pointer is set to an invalid value before the function returns in order to ensure, that an
                  invalid write access is detected during testing.

  MD_Os_Rule18.6_3225:
      Reason:     See MD_Os_Rule18.6_2916.
      Risk:       See MD_Os_Rule18.6_2916.
      Prevention: See MD_Os_Rule18.6_2916.
