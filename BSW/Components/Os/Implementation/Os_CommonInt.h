...
#  define OS_JUSTIFY_NOINIT(X)   X = { 0 }
# else
#  define OS_JUSTIFY_NOINIT(X)   X /* PRQA S 2972 */ /* MD_Os_Rule9.1_2972 */
# endif
...
{                                                                                                                       /* PRQA S 0750 */ /* MD_MSR_Union */
  ...
  Os_CoreStartStateType *                   ParamCoreStartStateRefType;
};
