 ...
 *  \param[in]      TerminationReason The reason why the task shall be reset.
 *
 *  \context        ANY
 *
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_TaskReset,
(
  P2CONST(Os_TaskConfigType, AUTOMATIC, OS_CONST) Task,
...
( void ))
{
  return (Os_StdReturnType)(OS_CFG_PRETASKHOOK == STD_ON);                                                              /* PRQA S 4304, 2995 */ /* MD_Os_C90BooleanCompatibility, MD_Os_Rule2.2_2995 */
}
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_TaskReset,
(
  P2CONST(Os_TaskConfigType, AUTOMATIC, OS_CONST) Task,
  Os_TerminationType TerminationReason
))
{
  ...
  Os_ThreadKill(Os_TaskGetThread(Task), TerminationReason);                                                             /* SBSW_OS_TASK_THREADKILL_001 */ /* SBSW_OS_FC_PRECONDITION */
}
...
)
{
  ...
  Os_Assert((Os_StdReturnType)(Os_TaskGetThread(Task) != NULL_PTR));                                                    /* PRQA S 2995, 4304 */ /* MD_Os_Rule2.2_2995, MD_Os_C90BooleanCompatibility */ /* SBSW_OS_FC_PRECONDITION */
...
)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if(OS_LIKELY(Os_CoreAsrIsCoreLocal(targetCore) != 0u))                                                            /* SBSW_OS_TASK_COREASRISCORELOCAL_001 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
      {
 ...
 */
/* PRQA S 6050, 6080 1 */ /* MD_MSR_STCAL, MD_MSR_STMIF */
FUNC(Os_StatusType, OS_CODE) Os_Api_ActivateTaskAsyn
(
  TaskType TaskID
)
{
  ...
  {
    status = Os_ErrSetOkInStdStatus(OS_STATUS_XSIGNAL_DISABLED_BY_CONFIG);                                              /* PRQA S 2880 */ /* MD_Os_Rule2.1_2880 */
  }
  else if(OS_UNLIKELY(Os_ThreadCheckCallContext(currentThread, OS_APICONTEXT_ACTIVATETASK) == OS_CHECK_FAILED))         /* SBSW_OS_TASK_THREADCHECKCALLCONTEXT_001 */
  {
    status = OS_STATUS_CALLEVEL;
  }
  else if(OS_UNLIKELY(Os_TaskCheckId(TaskID) == OS_CHECK_FAILED ))
  ...
  else
  {
    ...
    else
    {
      ...
      /* #20 Check if local task. */
      if(OS_UNLIKELY(Os_CoreAsrIsCoreLocal(targetCore) != 0u))                                                          /* SBSW_OS_TASK_COREASRISCORELOCAL_001 */ /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
      {
        status = OS_STATUS_ID_1;
      }
      /* #30 If No errors are detected and not a local task: */
      else
      {
        /* #40 Signal the responsible core to activate the task asynchronously. */
        status = Os_XSigSend_ActivateTaskAsync(targetCore, currentThread, TaskID);                                      /* SBSW_OS_TASK_XSIGSEND_001 */
      }
    }
  }
  return status;
...
)
{
  ...
  else if(OS_UNLIKELY(Os_TpCheckInterArrival(timingProtection, Os_ThreadGetTpConfig(taskThread)) == OS_CHECK_FAILED))   /* SBSW_OS_TASK_TPCHECKINTERARRIVAL_001 */ /* SBSW_OS_TASK_THREADGETTPCONFIG_001 */ /* COV_OS_HALPLATFORMTPUNSUPPORTED_XF */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
  {
    status = OS_STATUS_OK;
  }
  else
...
)
{
  ...
  if(OS_UNLIKELY(Os_TpCheckInterArrival(timingProtection, Os_ThreadGetTpConfig(taskThread)) == OS_CHECK_FAILED))        /* SBSW_OS_TASK_TPCHECKINTERARRIVAL_001 */ /* SBSW_OS_TASK_THREADGETTPCONFIG_001 */ /* COV_OS_HALPLATFORMTPUNSUPPORTED_XF */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
  {
    status = OS_STATUS_OK;
  }
  else
  {
    ...
    Os_TaskGetDyn(Task)->ActivationsAllowed--;                                                                          /* PRQA S 3387 */ /* MD_Os_Rule13.3_3387 */ /* SBSW_OS_FC_PRECONDITION */ /* SBSW_OS_TASK_TASKGETDYN_002 */
...
FUNC(Os_StatusType, OS_CODE) Os_Api_TerminateTask(void)
{
  ...
  status = OS_STATUS_OK;                                                                                                /* PRQA S 2982 */ /* MD_Os_Rule2.2_2982_Config */ /* COMP_WARN_OS_USELESS_ASSIGNMENT */
  ...
  else
  {
    ...
    Os_TaskGetDyn(currentTask)->ActivationsAllowed++;                                                                   /* PRQA S 3387 */ /* MD_Os_Rule13.3_3387 */ /* SBSW_OS_TASK_TASKGETDYN_003 */ /* SBSW_OS_TASK_TASKGETDYN_002 */
    Os_TaskReset(currentTask, OS_VOLUNTARY_TERMINATION);                                                                /* SBSW_OS_TASK_TASKRESET_001 */
  ...
  else
  {
    ...
    else
    {
      ...
      if(currentTask == targetTask)
      {
        ...
        if(OS_UNLIKELY(Os_TpCheckInterArrival(timingProtection, Os_ThreadGetTpConfig(currentThread)                     /* SBSW_OS_TASK_TPCHECKINTERARRIVAL_001 */ /* SBSW_OS_TASK_THREADGETTPCONFIG_001 */ /* COV_OS_HALPLATFORMTPUNSUPPORTED_XF */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
                                              ) == OS_CHECK_FAILED))
        {
      ...
      else
      {
        ...
        if(OS_LIKELY(Os_TaskIsCoreLocal(targetTask) != 0u))                                                             /* SBSW_OS_TASK_TASKISCORELOCAL_001 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
        {
      ...
      if(OS_LIKELY((status == OS_STATUS_OK) && (startNextTask == TRUE)))                                                /* PRQA S 2995 */ /* MD_Os_Rule2.2_2995 */
      {
...
FUNC(Os_StatusType, OS_CODE) Os_Api_Schedule(void)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_TaskCheckIsScheduleAllowed(currentTask) == OS_CHECK_FAILED))                                      /* SBSW_OS_TASK_TASKCHECKISSCHEDULEALLOWED_001 */ /* COV_OS_VTTSTACKSHARINGSUPPORT_XF */
    {
...
)
{
  ...
  Os_TaskReset(Task, TerminationReason);                                                                                /* SBSW_OS_FC_PRECONDITION */
...
FUNC(void, OS_CODE) Os_TaskKill(void)
{
  ...
  Os_TaskGetDyn(targetTask)->ActivationsAllowed++;                                                                      /* PRQA S 3387 */ /* MD_Os_Rule13.3_3387 */ /* SBSW_OS_TASK_TASKGETDYN_001 */ /* SBSW_OS_TASK_TASKGETDYN_002 */
  Os_TaskReset(targetTask, OS_FORCIBLE_TERMINATION);                                                                    /* SBSW_OS_TASK_TASKRESET_002 */
...
OS_FUNC_ATTRIBUTE_DEFINITION(void, OS_CODE, OS_NORETURN, Os_TaskMissingTerminateTask, (void))
{
...

  {
    ...
    Os_TaskGetDyn(currentTask)->ActivationsAllowed++;                                                                   /* PRQA S 3387 */ /* MD_Os_Rule13.3_3387 */ /* SBSW_OS_TASK_TASKGETDYN_001 */ /* SBSW_OS_TASK_TASKGETDYN_002 */
    Os_TaskReset(currentTask, OS_VOLUNTARY_TERMINATION);                                                                /* SBSW_OS_TASK_TASKRESET_001 */
  ...
  Os_ErrKernelPanic(OS_STATUS_PANIC_UNEXPECTED_CONTROL_FLOW);                                                           /* PRQA S 2880 */ /* MD_Os_Rule2.1_2880_NonReturning */ /* COMP_WARN_OS_UNREACHABLE_CODE */
}
...
\ID SBSW_OS_TASK_CORESETTHREAD_001
 \DESCRIPTION    Os_CoreSetThread is called with the return value of Os_CoreGetThread.
 \COUNTERMEASURE \N [CM_OS_COREGETTHREAD_N]

\ID SBSW_OS_TASK_CORESETTHREAD_002
