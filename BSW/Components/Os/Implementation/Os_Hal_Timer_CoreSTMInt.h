...
# define OS_HAL_TIMER_STM_ICR_USE_CMP1_VALUE          0x00000030uL
 ...
 **********************************************************************************************************************/
/*! \brief          Get the compare value of the given HRT.
 *  \details        This function shall get the compare value of the given timer.
 *
 *  \param[in]      TimerConfig     Timer hardware configuration. Parameter must not be NULL.
 *
 ...
 *  \trace          SPEC-63797
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_Hal_TimerFrtTickType, OS_CODE, OS_ALWAYS_INLINE,
Os_Hal_TimerFrtGetCompareValue,
(
  P2CONST(Os_Hal_TimerFrtConfigType, AUTOMATIC, OS_CONST) TimerConfig
));
