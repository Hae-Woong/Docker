...
))
{
  ...
  for( PCXIRaw = Os_Hal_Mfcr(OS_HAL_PCXI_OFFSET);                                                                       /* FETA_OS_HAL_STARTUP_CSA_CLEANUP */
...
))
{
  ...
  Context->Pprs = Config->ProtectionSet;                                                                                /* SBSW_OS_HAL_PWA_CALLER */
...
))
{
  ...
  *(uint32*)(PCXIAddr + OS_HAL_CSA_PSW_OFFSET) = CurrentConfig->ProgramStatus | OS_HAL_PSW_CDC_1;                       /* PRQA S 0306 */ /* MD_Os_Hal_Rule11.4_0306 */ /* SBSW_OS_HAL_PWA_PCXI */
  ...
  /* #25 Initialize the PPRS register */
  Os_Hal_ContextPreparePRS(PCXIAddr, CurrentConfig);                                                                    /* SBSW_OS_HAL_FC_CALLER */
  ...
  *(uint32*)(PCXIAddr + OS_HAL_CSA_RA_UPPER_OFFSET) = CurrentConfig->ReturnAddress;                                     /* PRQA S 0306 */ /* MD_Os_Hal_Rule11.4_0306 */ /* SBSW_OS_HAL_PWA_PCXI */
  ...
  Context->Pprs = CurrentConfig->ProtectionSet;                                                                         /* SBSW_OS_HAL_PWA_CALLER */
}
...
))
{
  ...
  Context->Pprs = Os_Hal_GetPPRS();                                                                                     /* SBSW_OS_HAL_PWA_CALLER */
