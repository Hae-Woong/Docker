 ...
 *  \pre            -
 **********************************************************************************************************************/
FUNC(void, OS_CODE) Os_ServiceInitInternal                                                                              /* PRQA S 3449, 3451 */ /* MD_Os_Rule8.5_3449, MD_Os_Rule8.5_3451 */
(
  P2CONST(Os_ServiceConfigType, AUTOMATIC, OS_CONST) Service
);
...
)
{
  ...
  /* #30 Set access counters to configured values. */
  {
    ...
    for(index = 0; index < (Os_ObjIdx_IteratorType) OS_APPID_COUNT; index++)
    {
...
)
{
  ...
  /* #10 Update the current call context. */
  currentThread = Os_CoreGetThread();
  prevCallContext = Os_ThreadSwitchType(currentThread, OS_CALLCONTEXT_FTF);                                             /* SBSW_OS_SF_THREADSWITCHTYPE_001 */

  /* #20 Call the trusted function directly. */
  FastTrustedFunction->Callback(FunctionIndex, FunctionParams);                                                         /* SBSW_OS_SF_CALLBACK_001 */

  /* #30 Restore the previous call context. */
  (void) Os_ThreadSwitchType(currentThread, prevCallContext);                                                           /* SBSW_OS_SF_THREADSWITCHTYPE_001 */
...
)
{
  ...
  if(Os_ServiceNtfIsEnabled() != 0u)                                                                                     /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
...
))
{
  ...
  if(Os_ServiceTfIsEnabled() == 0u)                                                                                     /* COV_OS_INVSTATE */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
  {
...
{
  /* #10 If module is not enabled, KernelPanic. */
  if(Os_ServiceNtfIsEnabled() == 0u)                                                                                    /* COV_OS_INVSTATE */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
  {
    Os_ErrKernelPanic(OS_STATUS_PANIC_FUNCTIONALITY_NOT_AVAILABLE);
  }
  /* #20 Otherwise: */
...
)
{
  ...
  if((ntfEnabled | tfEnabled) != 0u)                                                                                    /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
    ...
    while(serviceCall != OS_SERVICECALL_LIST_END)                                                                       /* FETA_OS_SERVICECALLLIST */
    {
...
)
{
  ...
  if(Os_ServiceTfIsEnabled() == 0u)                                                                                     /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
  {
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(ownerCore) == OS_CHECK_FAILED))                                           /* SBSW_OS_SF_COREASRCHECKISCORELOCAL_001 */ /* COV_OS_HALPLATFORMTESTEDASMULTICORE */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
    {
...
)
{
  ...
  /* #10 Perform error checks. */
  if(Os_ServiceNtfIsEnabled() == 0u)                                                                                    /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
  {
    status = Os_ErrSetOkInStdStatus(OS_STATUS_SERVICEID);
  }
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(ownerCore) == OS_CHECK_FAILED))                                           /* SBSW_OS_SF_COREASRCHECKISCORELOCAL_001 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
    {
      status = OS_STATUS_ACCESSRIGHTS_1;
    }
    else
...
)
{
  ...
  /* #10 Perform error checks. */
  if(Os_ServiceFtfIsEnabled() == 0u)                                                                                    /* PRQA S 2991, 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
  {
    status = Os_ErrSetOkInStdStatus(OS_STATUS_SERVICEID);
  }
  else if(OS_UNLIKELY(Os_ServiceCheckFtfId(FunctionIndex) == OS_CHECK_FAILED))
  {
    status = OS_STATUS_SERVICEID;
  }
  else
...
\ID SBSW_OS_SF_CALLBACK_001
 ...
 \COUNTERMEASURE \M [CM_OS_SF_TF_CALLBACKPOINTER_M]
                 \M [CM_OS_SF_FTF_CALLBACKPOINTER_M]
...
\ID SBSW_OS_SF_THREADSWITCHTYPE_001
