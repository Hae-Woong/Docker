 ...
 **********************************************************************************************************************/
FUNC(void, OS_CODE) Os_StackInitInternal                                                                                /* PRQA S 3449, 3451 */ /* MD_Os_Rule8.5_3449, MD_Os_Rule8.5_3451 */
(
...
))
{
  ...
  return (Os_StdReturnType)((CheckAddress >= Stack->LowAddress) && (CheckAddress <= Stack->HighAddress));               /* PRQA S 4304 */ /* MD_Os_C90BooleanCompatibility */ /* COV_OS_VTTSTACKHANDLING_TX_XF */
}
...
{
  if(Os_StackIsMeasurementEnabled() != 0u)                                                                              /* PRQA S 2991, 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
  {
    ...
    if(OS_LIKELY(Os_StackIsPartOfStack(Stack, topOfStack) == 0u))                                                       /* SBSW_OS_ST_STACKISPARTOFSTACK_001 */ /* COV_OS_VTTSTACKHANDLING_TX_XF */
    {
    ...
    while(iterator != iteratorEnd)                                                                                      /* FETA_OS_ITERATEOVERSTACK */
    {
...
)
{
  ...
  if(Os_StackIsMeasurementEnabled() == 0u)                                                                              /* COV_OS_INVSTATE */ /* PRQA S 2991, 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
  {
...
/***********************************************************************************************************************
 *  Os_StackGetInitHookStackUsageLocal()
 **********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 *
 */
FUNC(uint32, OS_CODE) Os_StackGetInitHookStackUsageLocal                                                                /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  P2CONST(Os_CoreAsrConfigType, AUTOMATIC, OS_CONST) Core
)
{
  ...
  /* #20 Get the stack. */
  stack = Os_ThreadGetStack(Os_HookInitHookGetThread(Os_CoreGetInitHook(Core)));                                        /* SBSW_OS_ST_THREADGETSTACK_007 */ /* SBSW_OS_ST_HOOKINITHOOKGETTHREAD_001 */ /* SBSW_OS_FC_PRECONDITION */
...
/***********************************************************************************************************************
 *  Os_StackGetNonTrustedFunctionStackUsageLocal()
 **********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 *
 */
FUNC(uint32, OS_CODE) Os_StackGetNonTrustedFunctionStackUsageLocal
(
...
)
{
  ...
  /* #20 Iterate over all stacks from the function's stack pool to retrieve maximum consumption. */
  result = 0;
  stackPool = NonTrustedFunction->StackPool;

  for(index = 0; index < stackPool->StackCount; index++)                                                                /* FETA_OS_CONSTANTASFUNCTIONPARAMETER */
  {
    stack = stackPool->Stacks[index].Stack;
    stackUsage = Os_StackGetUsageLocal(stack);                                                                          /* SBSW_OS_ST_STACKGETUSAGELOCAL_003 */

    if (OS_UNLIKELY(stackUsage > result))
    {
      result = stackUsage;
    }
  }
...
)
{
  ...
  else
  {
    ...
    if(OS_LIKELY(Os_CoreAsrIsCoreLocal(targetCore) != 0u))                                                              /* SBSW_OS_ST_COREASRISCORELOCAL_001 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
    {
      P2CONST(Os_StackConfigType, AUTOMATIC, OS_CONST) stack;
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreCheckIsAsrCore(core) == OS_CHECK_FAILED))                                                     /* SBSW_OS_ST_CORECHECKISASRCORE_001 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
    {
    ...
    else
    {
      ...
      /* #20 Get the stack object and determine the stack usage. */
      if(OS_LIKELY(Os_CoreAsrIsCoreLocal(targetCore) != 0u))                                                            /* SBSW_OS_ST_COREASRISCORELOCAL_002 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
      {
        P2CONST(Os_StackConfigType, AUTOMATIC, OS_CONST) stack;
...
)
{
  ...
  else
  {
    ...
    else
    {
      ...
      else if(OS_LIKELY(Os_CoreAsrIsCoreLocal(targetCore) != 0u))                                                       /* SBSW_OS_ST_COREASRISCORELOCAL_002 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
      {
        P2CONST(Os_StackConfigType, AUTOMATIC, OS_CONST) stack;
 ...
 */
/* PRQA S 6050, 6080 1 */ /* MD_MSR_STCAL, MD_MSR_STMIF */
FUNC(uint32, OS_CODE) Os_Api_GetInitHookStackUsage
(
  CoreIdType CoreID
)
{
  ...
  else
  {
    ...
    else
    {
      ...
      targetCore = Os_Core2AsrCore(core);                                                                               /* SBSW_OS_ST_CORE2ASRCORE_001 */
      hook = Os_CoreGetInitHook(targetCore);                                                                            /* SBSW_OS_ST_COREGETINITHOOK_001 */

      if(OS_LIKELY(Os_CoreAsrIsCoreLocal(targetCore) != 0u))                                                            /* SBSW_OS_ST_COREASRISCORELOCAL_002 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
      {
        P2CONST(Os_StackConfigType, AUTOMATIC, OS_CONST) stack;

        stack = Os_ThreadGetStack(Os_HookInitHookGetThread(hook));                                                      /* SBSW_OS_ST_THREADGETSTACK_007 */ /* SBSW_OS_ST_HOOKINITHOOKGETTHREAD_001 */
      ...
      {
        status = Os_XSigSend_GetInitHookStackUsage(targetCore, Os_CoreGetThread(), CoreID, &result);                    /* SBSW_OS_CORE_XSIGSEND_001 */
      }
    }
  }

  /* #30 Report error if applicable. */
  Os_ErrReportGetInitHookStackUsage(status, CoreID);
...
/***********************************************************************************************************************
 *  Os_Api_GetNonTrustedFunctionStackUsage()
 **********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
/* PRQA S 6050 1 */ /* MD_MSR_STCAL */
FUNC(uint32, OS_CODE) Os_Api_GetNonTrustedFunctionStackUsage
(
...
)
{
  ...
  else
  {
    ...
    /* #20 Get the non trusted function object and determine the overall stack usage. */
    nonTrustedFunction = Os_ServiceNtfId2Ntf(FunctionIndex);
    targetCore = Os_AppGetCore(nonTrustedFunction->Base.OwnerApplication);                                              /* SBSW_OS_ST_APPGETCORE_001 */

    if(OS_LIKELY(Os_CoreAsrIsCoreLocal(targetCore) != 0u))                                                              /* SBSW_OS_ST_COREASRISCORELOCAL_002 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
    {
      result = Os_StackGetNonTrustedFunctionStackUsageLocal(nonTrustedFunction);                                        /* SBSW_OS_ST_STACKGETNONTRUSTEDFUNCTIONSTACKUSAGELOCAL_001 */

      status = OS_STATUS_OK;
    }
    else
    {
      status = Os_XSigSend_GetNonTrustedFunctionStackUsage(targetCore, Os_CoreGetThread(), FunctionIndex, &result);     /* SBSW_OS_ST_XSIGSEND_002 */
    }
  }

  /* #30 Report error if applicable. */
  Os_ErrReportGetNonTrustedFunctionStackUsage(status, FunctionIndex);
...
\ID SBSW_OS_ST_THREADGETSTACK_007
 \DESCRIPTION    Os_ThreadGetStack is called with the return value of Os_HookInitHookGetThread.
...
\ID SBSW_OS_ST_STACKGETUSAGELOCAL_003
 \DESCRIPTION    Os_StackGetUsageLocal is called with a stack from the non trusted function StackPool.
                 StackPool is derived from an argument of the caller function. The correctness of the caller argument
...
\ID SBSW_OS_ST_HOOKINITHOOKGETTHREAD_001
 \DESCRIPTION    Os_HookInitHookGetThread is called with the return value of Os_CoreGetInitHook.
...
\ID SBSW_OS_ST_XSIGSEND_002
 \DESCRIPTION    A Os_XSigSend function is called with the return value of Os_AppGetCore and Os_CoreGetThread.
                 Precondition ensures that the pointer return by Os_CoreGetThread is valid. The compliance of the
                 precondition is check during review.
...
\ID SBSW_OS_ST_COREGETINITHOOK_001
...
\ID SBSW_OS_ST_ERRCHECKPOINTERISNOTNULL_005
 \DESCRIPTION    Os_ErrCheckPointerIsNotNull is called with the return value of Os_CoreGetInitHook.
 \COUNTERMEASURE \N [CM_OS_COREGETINITHOOK_N]
...
\ID SBSW_OS_ST_STACKGETNONTRUSTEDFUNCTIONSTACKUSAGELOCAL_001
 \DESCRIPTION    Os_StackGetNonTrustedFunctionStackUsageLocal is called with the return value of Os_ServiceNtfId2Ntf.
 \COUNTERMEASURE \M [CM_OS_SERVICENTFID2NTF_M]
