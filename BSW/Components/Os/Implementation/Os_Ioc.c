...
#define OS_IOC_INTERNAL_STATUS(Status)                                                                                  \
  ((uint32) (((uint32)(Status)) << (sizeof(Std_ReturnType)*8u)) | (uint32)0xFF)
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
FUNC(void, OS_CODE) Os_IocInitInternal                                                                                  /* PRQA S 3449, 3451 */ /* MD_Os_Rule8.5_3449, MD_Os_Rule8.5_3451 */
(
  P2CONST(Os_IocConfigType, AUTOMATIC, OS_CONST) Ioc
);
...
)
{
  ...
  if(Os_IocIsEnabled() == 0u)                                                                                           /* COV_OS_INVSTATE */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
  {
...
{
  /* #10 return whether or not the channel is currently enabled. */
...
))
{
  ...
  for(idx = 0; idx < (Os_ObjIdx_IteratorType) Ioc->Ioc.ReceiveChannelCount; idx++)                                      /* FETA_OS_CONSTANTASFUNCTIONPARAMETER */
  {
...
{
  return (P2VAR(Os_IocMultiReceiveType volatile, AUTOMATIC, OS_VAR_NOINIT))(Ioc->Base.Dyn);                             /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */ /* COMP_WARN_OS_CAST_INCREASES_ALIGNMENT */
}
...
))
{
  ...
  if (Os_IocHasCallbacks() != 0u)                                                                                       /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
    ...
    for(index = (Os_HookIdType)0; index < Callbacks->CallbackCount; index++)                                            /* FETA_OS_CONSTANTASFUNCTIONPARAMETER */
    {
  ...
  if(OS_LIKELY(callFailed == FALSE))                                                                                    /* COMP_WARN_OS_CW_005 */
  {
    result = IOC_E_OK;
  }
  else
...
))
{
  ...
  P2CONST(Os_IocSendType volatile, AUTOMATIC, TYPEDEF) senderDyn;
...
))
{
  ...
  dyn->LostCounter++;                                                                                                   /* PRQA S 3387 */ /* MD_Os_Rule13.3_3387 */ /* SBSW_OS_IOC_IOCSENDGETDYN_002 */
}
...
))                                                                                                                      /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
{
  ...
  for(idx = 0; idx < (Os_ObjIdx_IteratorType) Ioc->ReceiveChannelCount; idx++)                                          /* FETA_OS_CONSTANTASFUNCTIONPARAMETER */
  {
...
{
  Os_IocInternalReturnType status = OS_IOC_E_INTERNAL_CLOSE_CHANNEL;                                                    /* COMP_WARN_OS_USELESS_ASSIGNMENT */
  ...
  {
    switch(Os_Fifo08HasDataAvailable(&(Ioc->FifoRead)))                                                                 /* SBSW_OS_FC_PRECONDITION */
    {
      case OS_FIFO_INVALID_STATE:                                                                                       /* COV_OS_INVSTATE */
        status = OS_IOC_E_INTERNAL_CLOSE_CHANNEL;
        break;

      case OS_FIFO_UNAVAILABLE:
...
))
{
  ...
  {
    switch(Os_Fifo16HasDataAvailable(&(Ioc->FifoRead)))                                                                 /* SBSW_OS_FC_PRECONDITION */
    {
      case OS_FIFO_INVALID_STATE:                                                                                       /* COV_OS_INVSTATE */
        status = OS_IOC_E_INTERNAL_CLOSE_CHANNEL;
        break;
...
))
{
  ...
  {
    switch(Os_Fifo32HasDataAvailable(&(Ioc->FifoRead)))                                                                 /* SBSW_OS_FC_PRECONDITION */
    {
      case OS_FIFO_INVALID_STATE:                                                                                       /* COV_OS_INVSTATE */
        status = OS_IOC_E_INTERNAL_CLOSE_CHANNEL;
        break;
...
))
{
  ...
  {
    switch (Os_FifoRefHasDataAvailable(&(Ioc->FifoRead)))                                                               /* SBSW_OS_FC_PRECONDITION */
    {
      case OS_FIFO_INVALID_STATE:                                                                                       /* COV_OS_INVSTATE */
        status = OS_IOC_E_INTERNAL_CLOSE_CHANNEL;
        break;
...
)
{
...

  {
    ...
    {
      Os_IntStateType intState = {0, 0};
      Os_ObjIdx_IteratorType currentReceiveIdx;
      ...
      else
      {
        ...
        Os_ObjIdx_IteratorType receiveChannelCounter;

        dyn = Os_IocMultiReceiveGetDyn(&(Ioc->Ioc));                                                                    /* SBSW_OS_FC_PRECONDITION */
        currentReceiveIdx = (Os_ObjIdx_IteratorType) dyn->NextReceiveChannel;

        status = OS_IOC_E_INTERNAL_NO_DATA;

        /* #40 For each IOC channel, beginning from where last receive ended: */
        for(receiveChannelCounter = 0; receiveChannelCounter < (Os_ObjIdx_IteratorType) Ioc->Ioc.ReceiveChannelCount;   /* COV_OS_HALPLATFORMTESTEDASMULTICORE */ /* FETA_OS_CONSTANTASFUNCTIONPARAMETER */
            receiveChannelCounter++)
        {
          ...
          currentReceiveIdx++;
          if (currentReceiveIdx >= (Os_ObjIdx_IteratorType) Ioc->Ioc.ReceiveChannelCount)                               /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
          {
            currentReceiveIdx = 0;
          }
        }
        ...
        switch(status)
        {
          ...
          default:                                                                                                      /* COV_OS_INVSTATE */
            ...
            for(currentReceiveIdx = 0; currentReceiveIdx < (Os_ObjIdx_IteratorType) Ioc->Ioc.ReceiveChannelCount;       /* COV_OS_INVSTATE */ /* FETA_OS_CONSTANTASFUNCTIONPARAMETER */
                currentReceiveIdx++)
            {
        ...
        dyn->NextReceiveChannel++;                                                                                      /* PRQA S 3387 */ /* MD_Os_Rule13.3_3387 */ /* SBSW_OS_IOC_IOCMULTIRECEIVEGETDYN_001 */
...
)
{
...

  {
    ...
    {
      Os_IntStateType interruptState = {0, 0};
...
{
  Std_ReturnType status = IOC_E_NOK;                                                                                    /* COMP_WARN_OS_USELESS_ASSIGNMENT */
...

  {
    ...
    else
    {
      ...
      /* #30 Check that the channel is enabled. */
      if(OS_UNLIKELY(Os_IocChannelIsEnabled(&(Ioc->Ioc.Base)) == 0u))                                                   /* SBSW_OS_FC_PRECONDITION */ /* COV_OS_INVSTATE */
      {
        status = IOC_E_LIMIT;
      }
      ...
      {
        switch(Os_Fifo08HasFreeSpaceAvailable(&(Ioc->FifoWrite)))                                                       /* SBSW_OS_FC_PRECONDITION */
        {
          case OS_FIFO_INVALID_STATE:                                                                                   /* COV_OS_INVSTATE */
            /* #40 Close the channel if the indices are out of range. */
            Os_IocSendCloseChannel(&(Ioc->Ioc));                                                                        /* SBSW_OS_FC_PRECONDITION */
            status = IOC_E_LIMIT;
            break;

          case OS_FIFO_UNAVAILABLE:
            /* #50 Increment lost counter if the buffer is full. */
            Os_IocIncrementLostCounter(&(Ioc->Ioc));                                                                    /* SBSW_OS_FC_PRECONDITION */
            status = IOC_E_LIMIT;
            break;

          case OS_FIFO_AVAILABLE:
            /* #60 Write to the IOC buffer if it is not full. */
            Os_Fifo08Enqueue(&(Ioc->FifoWrite), Data);                                                                  /* SBSW_OS_FC_PRECONDITION */
            status = IOC_E_OK;
            break;
...
)
{
...

  {
    ...
    else
    {
      ...
      {
        switch(Os_Fifo16HasFreeSpaceAvailable(&(Ioc->FifoWrite)))                                                       /* SBSW_OS_FC_PRECONDITION */
        {
          case OS_FIFO_INVALID_STATE:                                                                                   /* COV_OS_INVSTATE */
            /* #40 Close the channel if the indices are out of range. */
            Os_IocSendCloseChannel(&(Ioc->Ioc));                                                                        /* SBSW_OS_FC_PRECONDITION */
          ...
          case OS_FIFO_AVAILABLE:
            /* #60 Write to the IOC buffer if it is not full. */
            Os_Fifo16Enqueue(&(Ioc->FifoWrite), Data);                                                                  /* SBSW_OS_FC_PRECONDITION */
            status = IOC_E_OK;
            break;
...
)
{
...

  {
    ...
    else
    {
      ...
      {
        switch(Os_Fifo32HasFreeSpaceAvailable(&(Ioc->FifoWrite)))                                                       /* SBSW_OS_FC_PRECONDITION */
        {
          case OS_FIFO_INVALID_STATE:                                                                                   /* COV_OS_INVSTATE */
            /* #40 Close the channel if the indices are out of range. */
            Os_IocSendCloseChannel(&(Ioc->Ioc));                                                                        /* SBSW_OS_FC_PRECONDITION */
          ...
          case OS_FIFO_AVAILABLE:
            /* #60 Write to the IOC buffer if it is not full. */
            Os_Fifo32Enqueue(&(Ioc->FifoWrite), Data);                                                                  /* SBSW_OS_FC_PRECONDITION */
            status = IOC_E_OK;
            break;
...
)
{
...

  {
    ...
    else
    {
      ...
      {
        switch(Os_FifoRefHasFreeSpaceAvailable(&(Ioc->FifoWrite)))                                                      /* SBSW_OS_FC_PRECONDITION */
        {
          case OS_FIFO_INVALID_STATE:                                                                                   /* COV_OS_INVSTATE */
            /* #40 Close the channel if the indices are out of range. */
            Os_IocSendCloseChannel(&(Ioc->Ioc));                                                                        /* SBSW_OS_FC_PRECONDITION */
          ...
          case OS_FIFO_AVAILABLE:
            /* #60 Write to the IOC buffer if it is not full. */
            Os_FifoRefEnqueue(&(Ioc->FifoWrite), Data);                                                                 /* SBSW_OS_FC_PRECONDITION */
            status = IOC_E_OK;
            break;
