 ...
 **********************************************************************************************************************/
/*! \brief          Set the currently occupied communication data element of the given thread.
 *  \details        --no details--
 *
 *  \param[in]      Thread        The thread to modify. Parameter must not be NULL.
 *  \param[in]      ComElement    The new communication data element. Parameter must not be NULL.
 *
 *  \context        OS_INTERNAL
 *
 ...
 **********************************************************************************************************************/
/*! \brief          Set that no communication data element is occupied by the given thread.
 *  \details        --no details--
 *
 *  \param[in]      Thread        The thread to modify. Parameter must not be NULL.
 *
 ...
 *  \param[in]      TerminationReason The reason why locks shall be released.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *  \param[in]      TerminationReason TRUE if this operation belongs to a forcible termination.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE for different threads.
