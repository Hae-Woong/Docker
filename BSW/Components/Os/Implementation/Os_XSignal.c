 ...
 *                               FunctionIdx must be < OS_XSIGFUNCTIONIDX_COUNT.
 *
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE OSServiceIdType, OS_CODE, OS_ALWAYS_INLINE, Os_XSigFunctionIdx2ServiceId,
(
  Os_XSigFunctionIdx FunctionIdx
));
 ...
 *  Os_XSigHandleResult()
 **********************************************************************************************************************/
/*! \brief        Handle a returned result.
 *  \details      --no details--
 *
 *  \param[in]    SendChannel    The send buffer that's results are handled. Parameter must not be NULL.
 *  \param[in]    ComData        The com object which contains the result. Parameter must not be NULL.
 *
 *  \context      OS_INTERNAL
 *
 *  \reentrant    TRUE
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_XSigHandleResult,
(
...
/***********************************************************************************************************************
 *  Os_XSigHandleAllResults
 **********************************************************************************************************************/
/*! \brief        Handles all returned results of asynchronous or preempted synchronous requests.
 *  \details      --no details--
 *
 *  \param[in]    SendChannel    The send buffer that's results are handled. Parameter must not be NULL.
 *
 ...
 *  \trace        SPEC-63727
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_XSigHandleAllResults,
(
  P2CONST(Os_XSigChannelSendConfigType, TYPEDEF, OS_CONST) SendChannel
));
 ...
 *  Os_XSigGetRecvIsrCount()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_ObjIdxType, OS_CODE, OS_ALWAYS_INLINE, Os_XSigGetRecvIsrCount,          /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  P2CONST(Os_XSigConfigType, AUTOMATIC, OS_CONST) XSignal
))                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
 ...
 *  Os_XSigGetRecvIsr()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE P2CONST(Os_XSigIsrConfigType, TYPEDEF, OS_CONST),                          /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
OS_CODE, OS_ALWAYS_INLINE, Os_XSigGetRecvIsr,
(
  P2CONST(Os_XSigConfigType, AUTOMATIC, OS_CONST) XSignal,
  Os_ObjIdxType IsrIdx
...
))                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
  ...
  if(OS_UNLIKELY(Os_ErrIsValueLo((uint32)FunctionIdx, (uint32)OS_XSIGFUNCTIONIDX_USEDCOUNT) != 0u))                     /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
  {
    result = (Os_StdReturnType)(XSigIsr->FunctionTable->FunctionDescription[FunctionIdx].FunctionRef != NULL_PTR);      /* PRQA S 2842, 4304 */ /* MD_Os_Rule18.1_2842_Check, MD_Os_C90BooleanCompatibility */
  }
 ...
 *
  ...
  Os_XSigBufferIdxType acknowledge = XSigRecvElement->SendData->Acknowledge;
  return (Os_StdReturnType) ( (acknowledge == OS_XSIGSTATE_ASYNC_NACK) ||                                               /* PRQA S 4304 */ /* MD_Os_C90BooleanCompatibility */
                              (acknowledge == OS_XSIGSTATE_SYNC_NACK ) );
}
...
))                                                                                                                      /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
{
...

  {
    ...
    Os_XSigHandleAllResults(&(SendPort->SendChannel));                                                                  /* SBSW_OS_FC_PRECONDITION */
    ...
    *ComData = Os_XSigChannelGetSendElement(&(SendPort->SendChannel));                                                  /* SBSW_OS_PWA_PRECONDITION */ /* SBSW_OS_FC_PRECONDITION */
    ...
    else
    {
      ...
      /* #50 If the request is a synchronous one: */
      if(Acknowledge == OS_XSIGSTATE_SYNC_NACK)
      {
        /* #60 Store the occupied communication data element in the thread. */
        Os_ThreadSetComElement(SendThread, *ComData);                                                                   /* SBSW_OS_XSIG_THREADSETCOMELEMENT_001 */
      }

      /* #70 Send the data element and trigger the receiver. */
 ...
 *  Os_XSigFunctionIdx2ServiceId()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE OSServiceIdType, OS_CODE, OS_ALWAYS_INLINE, Os_XSigFunctionIdx2ServiceId,  /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  Os_XSigFunctionIdx FunctionIdx
))                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
  Os_Assert(Os_ErrIsValueLo((uint32)FunctionIdx, (uint32)OS_XSIGFUNCTIONIDX_COUNT));
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_XSigHandleResult,                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  P2CONST(Os_XSigChannelSendConfigType, TYPEDEF, OS_CONST) SendChannel,
  P2CONST(Os_XSigComDataConfigType, AUTOMATIC, OS_CONST) ComData
))                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
  ...
  Os_XSigBufferIdxType acknowledge = ComData->SendData->Acknowledge;
  if(acknowledge == OS_XSIGSTATE_ASYNC_NACK)
  {
 ...
 * */
      ...
      serviceId = Os_XSigFunctionIdx2ServiceId(ComData->SendData->FunctionIdx);
 ...
 * */
    ...
    ComData->SendData->Acknowledge = OS_XSIGSTATE_ACK;                                                                  /* SBSW_OS_XSIG_XSIGCOMDATA_SENDDATA_001 */
  }

  /* #60 Otherwise if the result is a synchronous one: */
  else if(acknowledge == OS_XSIGSTATE_SYNC_NACK)
  {
    /* #70 Set the state to pending. It will be handled by the sender. */
    ComData->SendData->Acknowledge = OS_XSIGSTATE_SYNC_PENDING;                                                         /* SBSW_OS_XSIG_XSIGCOMDATA_SENDDATA_001 */
  }
  else /* The MISRA-else */
  {
     /* OS_XSIGSTATE_ACK doesn't require any action. */
     /* OS_XSIGSTATE_SYNC_PENDING will be handled by the sender thread, no action here. */
  }
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_XSigHandleAllResults,                  /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  P2CONST(Os_XSigChannelSendConfigType, TYPEDEF, OS_CONST) SendChannel
))                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
  Os_StdReturnType resultAvailable = !0u;                                                                               /* PRQA S 2880, 4404, 4558 */ /* MD_Os_Rule2.1_2880, MD_Os_C90BooleanCompatibility, MD_Os_Rule10.1_4558 */

  /* #10 While there are results in the buffer: */
  while(resultAvailable != 0u)                                                                                          /* FETA_OS_XSIGHANDLERESULTS */
  {
    P2CONST(Os_XSigComDataConfigType, AUTOMATIC, OS_CONST) comData = Os_XSigChannelTryGetResult(SendChannel);           /* SBSW_OS_FC_PRECONDITION */
    if(comData == NULL_PTR)
    {
      resultAvailable = 0u;
    }
    else
    {
      ...
      Os_XSigHandleResult(SendChannel, comData);                                                                        /* SBSW_OS_XSIG_HANDLERESULT_001 */
    }
  }
}
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_XSigSendPortInit,                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  P2CONST(Os_XSigSendPortConfigType, AUTOMATIC, OS_CONST) SendPort
))                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_XSigRecvPortInit,                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  P2CONST(Os_XSigRecvPortConfigType, AUTOMATIC, OS_CONST) RecvPort
))                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_XSigIsrInit,                           /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
    P2CONST(Os_XSigIsrConfigType, AUTOMATIC, OS_CONST) XSigIsr
))                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
  Os_ObjIdx_IteratorType it;
  ...
  for(it = 0; it < (Os_ObjIdx_IteratorType) XSigIsr->RecvPortCount; ++it)                                               /* FETA_OS_CONSTANTASFUNCTIONPARAMETER */
  {
 ...
 *  Os_XSigThread2XSigIsr()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE P2CONST(Os_XSigIsrConfigType, AUTOMATIC, OS_CONST), OS_CODE,               /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
OS_ALWAYS_INLINE, Os_XSigThread2XSigIsr,
(
  P2CONST(Os_ThreadConfigType, AUTOMATIC, OS_CONST) Thread
))                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
...
ISR(Os_XSigRecvIsrHandler)                                                                                              /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
  ...
  do                                                                                                                    /* FETA_OS_XSIGNALISR */
  {
    ...
    for(it = 0; it < (Os_ObjIdx_IteratorType) xSigIsr->RecvPortCount; ++it)                                             /* FETA_OS_CONSTDATA */
    {
      P2CONST(Os_XSigRecvPortConfigType, AUTOMATIC, OS_CONST) recvPort;
      P2CONST(Os_CoreAsrConfigType, AUTOMATIC, OS_CONST) sendCore;
      ...
      {
        /* #60 If the core has sent a request: */
        P2CONST(Os_XSigComDataConfigType, AUTOMATIC, OS_CONST) comData;
        ...
        if(comData != NULL_PTR)
        {
          ...
          if(Os_XSigRecvCheckIsReceiveElementValid(comData) != 0u)                                                      /* SBSW_OS_XSIGRECVCHECKISRECEIVEELEMENTVALID_001 */
          {
            ...
            if(Os_XSigRecvCheckIsFunctionAvailable(xSigIsr, sendData->FunctionIdx) == OS_CHECK_FAILED)                  /* SBSW_OS_XSIG_XSIGRECVCHECKISFUNCTIONAVAILABLE_001 */ /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
            {
            ...
            else
            {
              ...
              inParameter = ((P2CONST(Os_XSigParamsType, AUTOMATIC, OS_VAR_NOINIT))&(sendData->ParameterData));         /* PRQA S 0312 */ /* MD_Os_Rule11.8_0312_Volatile */ /* COMP_WARN_OS_VOLATILE_CAST */
              outParameter = ((P2VAR(Os_XSigOutputParamsType, AUTOMATIC, OS_VAR_NOINIT))                                /* PRQA S 0312 */ /* MD_Os_Rule11.8_0312_Volatile */ /* COMP_WARN_OS_VOLATILE_CAST */
...
)
{
  ...
  if(Os_XSigIsEnabled() != 0u)                                                                                          /* PRQA S 2991, 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
  {
    Os_CoreAsrCoreIdx itSendPort;
    Os_ObjIdxType recvIsrCount;
    Os_ObjIdx_IteratorType itReceivePort;

    recvIsrCount = Os_XSigGetRecvIsrCount(XSignal);                                                                     /* SBSW_OS_FC_PRECONDITION */

    /* #20 Initialize the send ports. */
    for(itSendPort = (Os_CoreAsrCoreIdx)0; itSendPort < OS_COREASRCOREIDX_COUNT; ++itSendPort)                          /* PRQA S 4332,  4527 */ /* MD_Os_Rule10.5_4332,  MD_Os_Rule10.1_4527 */ /* COMP_WARN_OS_CW_005 */
    {
    ...
    for(itReceivePort = 0; itReceivePort < (Os_ObjIdx_IteratorType) recvIsrCount; ++itReceivePort)                      /* FETA_OS_CONSTDATA */
    {
      Os_XSigIsrInit(Os_XSigGetRecvIsr(XSignal, (Os_ObjIdxType) itReceivePort));                                        /* SBSW_OS_XSIG_XSIGISRINIT_001 */ /* SBSW_OS_FC_PRECONDITION */
    }
  }
}
...
)
{
  ...
  if(Os_XSigIsEnabled() != 0u)                                                                                          /* PRQA S 2991, 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
  {
    P2CONST(Os_XSigSendPortConfigType, AUTOMATIC, OS_CONST) sendPort;
 ...
 * */
    ...
    else
    {
      ...
      if(status == OS_STATUS_OK)
      {
        ...
        while(Os_XSigChannelIsRequestHandled(&(sendPort->SendChannel), comData) == 0u)                                  /* SBSW_OS_XSIG_XSIGCHANNELISREQUESTHANDLED_001 */ /* FETA_OS_XSIGNALSYNC */
        {
          /*! Internal comment removed.
 *
 *
 * */
        ...
        /* #50 Suspend interrupts. */
        Os_IntSuspend(&interruptState);                                                                                 /* SBSW_OS_FC_POINTER2LOCAL */

        /* #60 Free the communication data element. */
        comData->SendData->Acknowledge = OS_XSIGSTATE_ACK;                                                              /* SBSW_OS_XSIG_SENDDATA_002 */
        Os_ThreadReleaseComElement(SendThread);                                                                         /* SBSW_OS_FC_PRECONDITION */
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(taskCore) == OS_CHECK_FAILED))                                            /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_001 */ /* COV_OS_XSIGDOUBLECHECK */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
    {
      status = OS_STATUS_CORE_CROSS_DATA;
    }
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(counterCore) == OS_CHECK_FAILED))                                         /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_002 */ /* COV_OS_XSIGDOUBLECHECK */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
    {
      status = OS_STATUS_CORE_CROSS_DATA;
    }
    else if( OS_UNLIKELY(Os_AppCheckAccess(SendApp, permittedApplications) == OS_CHECK_FAILED) )                        /* SBSW_OS_FC_PRECONDITION */ /* COV_OS_XSIGDOUBLECHECK */
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(alarmCore) == OS_CHECK_FAILED))                                           /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_003 */ /* COV_OS_XSIGDOUBLECHECK */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
    {
      status = OS_STATUS_CORE_CROSS_DATA;
    }
    else if( OS_UNLIKELY(Os_AppCheckAccess(SendApp, permittedApplications) == OS_CHECK_FAILED) )                        /* SBSW_OS_FC_PRECONDITION */ /* COV_OS_XSIGDOUBLECHECK */
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(schTCore) == OS_CHECK_FAILED))                                            /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_004 */ /* COV_OS_XSIGDOUBLECHECK */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
    {
      status = OS_STATUS_CORE_CROSS_DATA;
    }
    else if( OS_UNLIKELY(Os_AppCheckAccess(SendApp, permittedApplications) == OS_CHECK_FAILED) )                        /* SBSW_OS_FC_PRECONDITION */ /* COV_OS_XSIGDOUBLECHECK */
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(schTFromCore) == OS_CHECK_FAILED))                                        /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_004 */ /* COV_OS_XSIGDOUBLECHECK */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
    {
      status = OS_STATUS_CORE_CROSS_DATA;
    }
    else if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(schTToCore) == OS_CHECK_FAILED))                                     /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_004 */ /* COV_OS_XSIGDOUBLECHECK */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
    {
      status = OS_STATUS_CORE_CROSS_DATA;
    }
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(isrCore) == OS_CHECK_FAILED))                                             /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_005 */ /* COV_OS_XSIGDOUBLECHECK */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
    {
      status = OS_STATUS_CORE_CROSS_DATA;
    }
    else
...
)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(coreRef) == OS_CHECK_FAILED))                                           /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_006 */ /* COV_OS_XSIGDOUBLECHECK */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
      {
        status = OS_STATUS_CORE_CROSS_DATA;
      }
      else
 ...
 *
 */
FUNC(Os_StatusType, OS_CODE) Os_XSigRecv_GetInitHookStackUsage                                                          /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  P2CONST(Os_AppConfigType, AUTOMATIC, OS_VAR_NOINIT) SendApp,
  P2CONST(Os_XSigParamsType, AUTOMATIC, OS_VAR_NOINIT) InParameter,
  P2VAR(Os_XSigOutputParamsType, AUTOMATIC, OS_VAR_NOINIT) OutParameter
)
{
  ...
  else
  {
    ...
    {
      /* #20 Call the local API function. */
      OutParameter->ParameterData.Paramuint32 = Os_StackGetInitHookStackUsageLocal(coreRef);                            /* SBSW_OS_PWA_PRECONDITION */ /* SBSW_OS_XSIG_STACKGETUSAGE_001 */
      status = OS_STATUS_OK;
    }
  }
 ...
 *
 */
FUNC(Os_StatusType, OS_CODE) Os_XSigRecv_GetNonTrustedFunctionStackUsage                                                /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  P2CONST(Os_AppConfigType, AUTOMATIC, OS_VAR_NOINIT) SendApp,
  P2CONST(Os_XSigParamsType, AUTOMATIC, OS_VAR_NOINIT) InParameter,
  P2VAR(Os_XSigOutputParamsType, AUTOMATIC, OS_VAR_NOINIT) OutParameter
)
{
  ...
  functionIndex = InParameter->ParameterData[0].ParamOs_NonTrustedFunctionIndexType;

  /* #10 Perform checks. */
  if(OS_UNLIKELY(Os_ServiceCheckNtfId(functionIndex) == OS_CHECK_FAILED))                                               /* COV_OS_XSIGDOUBLECHECK */
  {
    status = OS_STATUS_CORE_CROSS_DATA;
  }
  else
  {
    ...
    coreRef = Os_AppGetCore(nonTrustedFunction->Base.OwnerApplication);                                                 /* SBSW_OS_XSIG_APPGETCORE_002 */
    ...
    {
      /* #20 Call the local API function. */
      OutParameter->ParameterData.Paramuint32 = Os_StackGetNonTrustedFunctionStackUsageLocal(nonTrustedFunction);       /* SBSW_OS_PWA_PRECONDITION */ /* SBSW_OS_XSIG_STACKGETUSAGE_001 */
      status = OS_STATUS_OK;
    }
  }
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(appCore) == OS_CHECK_FAILED))                                             /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_007 */ /* COV_OS_XSIGDOUBLECHECK */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
    {
      status = OS_STATUS_CORE_CROSS_DATA;
    }
    else
...
)
{
  ...
  return OS_STATUS_OK;                                                                                                  /* COMP_WARN_OS_INIT_RETURN_VALUE */
}
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreAsrCheckIsCoreLocal(callbackCore) == OS_CHECK_FAILED))                                        /* SBSW_OS_XSIG_COREASRCHECKISCORELOCAL_005 */ /* COV_OS_XSIGDOUBLECHECK */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
    {
      status = OS_STATUS_CORE_CROSS_DATA;
    }
...
\ID SBSW_OS_XSIG_XSIGCOMDATA_SENDDATA_001
 \DESCRIPTION    Write access to the SendData reference of a ComData object.
...
\ID SBSW_OS_XSIG_XSIGCHANNELISRECEIVEELEMENTAVAILABLE_001
 \DESCRIPTION    Os_XSigChannelIsReceiveElementAvailable is called with a receive channel and a pointer to a local
                 variable. The receive channel is passed to the calling function as a parameter.
...
\ID SBSW_OS_XSIG_XSIGCHANNELSENDDATA_001
 \DESCRIPTION    Write access to the SendData pointer which is derived from the XSigCom pointer. The XSigCom pointer
                 is passed as an argument to the function. Precondition ensures that the argument XSigCom pointer
                 is valid. The compliance of the precondition is checked during review.
 \COUNTERMEASURE \M [CM_OS_XSIGCOM_SENDDATA_M]
...
\ID SBSW_OS_XSIG_APPGETCORE_002
 \DESCRIPTION    Os_AppGetCore is called with a OwnerApplication which is derived from a NonTrustedFunction.
                 NonTrustedFunction is returned from Os_ServiceNtfId2Ntf. The correctness of the OwnerApplication is
                 ensured by preconditions. The compliance of the preconditions is check during review.
 \COUNTERMEASURE \M [CM_OS_SERVICENTFID2NTF_M] [CM_OS_SF_OWNERAPPLICATION_M]
...
\ID SBSW_OS_XSIG_STORERELEASE_001
 \DESCRIPTION    Os_Hal_StoreRelease16 is called with a pointer derived from the Dyn member of a XSigChannelSend object.
                 The channel is passed as argument to the caller. The correctness of the caller argument is ensured by
...
\ID SBSW_OS_XSIG_THREADSETCOMELEMENT_001
 \DESCRIPTION    Os_ThreadSetComElement is called with a thread pointer and a XSigCom pointer. The thread pointer is
                 passed as an argument to the function. Precondition ensures that the argument thread pointer is valid.
                 The XSigCom pointer is the return value of the function Os_XSigChannelGetSendElement.
 \COUNTERMEASURE \R [CM_OS_XSIGCHANNELGETSENDELEMENT_R]

\ID SBSW_OS_XSIG_XSIGCHANNELISRESULTAVAILABLE_001
  \DESCRIPTION    Os_XSigChannelIsResultAvailable is called with a channel object and a pointer to a local variable. The
                  Channel pointer is passed as an argument to the caller.
  \COUNTERMEASURE \N [CM_OS_PRECONDITION_N]

\ID SBSW_OS_XSIG_HANDLERESULT_001
  \DESCRIPTION    Os_XSigHandleResult is called with the return value of Os_XSigChannelTryGetResult and an
                  Os_XSigChannelSend object. The send object is passed as a reference to the calling function.
  \COUNTERMEASURE \R [CM_OS_XSIGCHANNELTRYGETRESULT_R]

\ID SBSW_OS_XSIG_LOADACQUIRE_001
  \DESCRIPTION    Os_Hal_LoadAcquire16 is called with a pointer derived from a channel object. The channel is passed as
                  an argument to the caller.
  \COUNTERMEASURE \M [CM_OS_XSIGCHANNELSEND_RECV_M]
                  \M [CM_OS_XSIGCHANNELRECV_SEND_M]

\ID SBSW_OS_XSIG_LOADACQUIRE_002
  \DESCRIPTION    Os_Hal_LaodAcquire16 is called with a pointer derived from a ComData object. The ComData is passed as
                  an argument to the caller.
  \COUNTERMEASURE \M [CM_OS_XSIGCOM_SENDDATA_M]
...
\CM CM_OS_XSIGCHANNELTRYGETRESULT_R
      Implementation ensures that the return value of Os_XSigChannelTryGetResult is not used if it is a NULL_PTR.
