...
/***********************************************************************************************************************
 *  Os_ErrGetExceptionInstructionAddress()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_AddressOfConstType, OS_CODE, OS_ALWAYS_INLINE,                          /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
Os_ErrGetExceptionInstructionAddress,
(
  P2CONST(Os_ErrorType, AUTOMATIC, OS_CONST) Error
))
{
  return Error->ExceptionInstructionAddress;
}
...
/***********************************************************************************************************************
 *  Os_ErrReportEnableInterruptsPreStart()
 **********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
...
))                                                                                                                      /* COV_OS_HALPLATFORMPITUNSUPPORTED_XX */
{
  ...
  if(OS_UNLIKELY(Os_ErrIsPropagationRequired(Status) != 0u))
  {
    ...
    Os_ErrorParamsType errorParameters = OS_ERR_PARAMS_ZERO_INITIALIZER;
...
/***********************************************************************************************************************
 *  Os_ErrReportFrtSetFutureCompareValue()
 **********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE,                                           /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_NOTTESTABLE_XX */
Os_ErrReportFrtSetFutureCompareValue,
(
  Os_StatusType Status
))                                                                                                                      /* COV_OS_NOTTESTABLE_XX */
{
  /* #10 If there was an error: */
  if(OS_UNLIKELY(Os_ErrIsPropagationRequired(Status) != 0u))
  {
    ...
    /* #30 Report the error and get the error return code. */
    Os_TrapErrApplicationError(OSServiceId_FrtSetFutureCompareValue, Status, &errorParameters);                         /* SBSW_OS_FC_POINTER2LOCAL */
  }
}


/***********************************************************************************************************************
 *  Os_ErrReportFrtSetCompareValue()
 **********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
...
))                                                                                                                      /* COV_OS_NOTTESTABLE_XX */
{
  ...
  if(OS_UNLIKELY(Os_ErrIsPropagationRequired(Status) != 0u))
  {
    ...
    /* #30 Report the error and get the error return code. */
    Os_TrapErrApplicationError(OSServiceId_FrtSetCompareValue, Status, &errorParameters);                               /* SBSW_OS_FC_POINTER2LOCAL */
  }
}
...
/***********************************************************************************************************************
 *  Os_ErrReportGetInitHookStackUsage()
 **********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
...
))
{
  ...
  if(OS_UNLIKELY(Os_ErrIsPropagationRequired(Status) != 0u))
  {
    ...
    /* #30 Report the error and get the error return code. */
    Os_TrapErrApplicationError(OSServiceId_GetInitHookStackUsage, Status, &errorParameters);                            /* SBSW_OS_FC_POINTER2LOCAL */
  }
}
...
/***********************************************************************************************************************
 *  Os_ErrReportGetNonTrustedFunctionStackUsage()
 **********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
...
))
{
  ...
  if(OS_UNLIKELY(Os_ErrIsPropagationRequired(Status) != 0u))
  {
    ...
    /* #30 Report the error and get the error return code. */
    Os_TrapErrApplicationError(OSServiceId_GetNonTrustedFunctionStackUsage, Status, &errorParameters);                  /* SBSW_OS_FC_POINTER2LOCAL */
  }
}
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE StatusType, OS_CODE, OS_ALWAYS_INLINE,                                     /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_TESTSUITEOSC4998 */
Os_ErrReportBarrierSynchronize,
(
  Os_StatusType Status,
...
{
  /* #10 If there was an error: */
  if(OS_UNLIKELY(Os_ErrIsPropagationRequired(Status) != 0u))                                                            /* COV_OS_TESTSUITEOSC4998 */
  {
    /* #20 Create error parameter object. */
    Os_ErrorParamsType errorParameters = OS_ERR_PARAMS_ZERO_INITIALIZER;
...
))
{
  ...
  if(OS_UNLIKELY(Os_ErrIsPropagationRequired(Status) != 0u))
  {
    ...
    /* #30 Report the error by means of error hook. */
    Os_TrapErrApplicationError(OSServiceId_ActivateTaskAsyn, Status, &errorParameters);                                 /* SBSW_OS_FC_POINTER2LOCAL */
  }
}
...
))
{
  ...
  if(OS_UNLIKELY(Os_ErrIsPropagationRequired(Status) != 0u))
  {
    ...
    /* #30 Report the error by means of error hook. */
    Os_TrapErrApplicationError(OSServiceId_SetEventAsyn, Status, &errorParameters);                                     /* SBSW_OS_FC_POINTER2LOCAL */
  }
}
...
))
{
  ...
  return ((!Os_ErrIsExtendedStatusEnabled()) || (Value));                                                               /* PRQA S 4115, 4116, 4404, 4558, 2996 */  /* MD_Os_Rule10.1_4115, MD_Os_Rule10.1_4116, MD_Os_C90BooleanCompatibility, MD_Os_Rule10.1_4558, MD_Os_Rule2.2_2996 */
}
...
))
{
  ...
  if(Os_ErrIsExtendedStatusEnabled() != 0u)                                                                             /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
    result = Value;
  }
  else
...
))
{
   ...
   * Otherwise Value indicates whether the check failed or not. */
  return ((!Os_ErrIsServiceProtectionEnabled()) || (Value));                                                            /* PRQA S 4115, 4116, 4404, 4558, 2996 */ /* MD_Os_Rule10.1_4115, MD_Os_Rule10.1_4116, MD_Os_C90BooleanCompatibility, MD_Os_Rule10.1_4558, MD_Os_Rule2.2_2996 */
}
...
{
  if(Os_ErrIsAssertEnabled() != 0u)                                                                                     /* COV_OS_INVSTATE */ /* PRQA S 2991, 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
  {
    if (OS_UNLIKELY(!(Condition)))                                                                                      /* COV_OS_ASSERT */ /* PRQA S 4116, 4558 */ /* MD_Os_Rule10.1_4116, MD_Os_Rule10.1_4558 */
    {
      Os_ErrKernelPanic(OS_STATUS_PANIC_ASSERTION);
    }
  }
}
...
{
  return Os_ErrExtendedCheck((Os_StdReturnType)((Value == TRUE) || (Value == FALSE)));                                  /* PRQA S 4304, 2995 */ /* MD_Os_C90BooleanCompatibility, MD_Os_BoolOnlyInStaticAnalysis */
}
...
))
{
  ...
  return (Os_StdReturnType)((Os_HookIsErrorHookEnabled()) && (OsStatus != OS_STATUS_OK));                               /* PRQA S 4115, 4304, 4558 */ /* MD_Os_Rule10.1_4115, MD_Os_C90BooleanCompatibility, MD_Os_Rule10.1_4558 */
}
...
))
{
  ...
  return (Os_StdReturnType)((Os_ErrIsServiceProtectionEnabled()) && (OsStatus != OS_STATUS_OK));                        /* PRQA S 4115, 4304, 4558 */ /* MD_Os_Rule10.1_4115, MD_Os_C90BooleanCompatibility, MD_Os_Rule10.1_4558 */
}
...
{
  return (OS_CFG_KILLING == STD_ON);                                                                                    /* PRQA S 4404, 2995 */ /* MD_Os_C90BooleanCompatibility, MD_Os_Rule2.2_2995 */
}
...
{
  return (OS_CFG_ASSERTIONS == STD_ON);                                                                                 /* PRQA S 4404, 2995, 2996 */ /* MD_Os_C90BooleanCompatibility, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
}
...
{
  return (OS_CFG_SERVICE_PROTECTION == STD_ON);                                                                         /* PRQA S 4404, 2995 */ /* MD_Os_C90BooleanCompatibility, MD_Os_Rule2.2_2995 */
}
...
{
  return (OS_CFG_EXTENDED_STATUS == STD_ON);                                                                            /* PRQA S 4404, 2995 */ /* MD_Os_C90BooleanCompatibility, MD_Os_Rule2.2_2995 */
}
