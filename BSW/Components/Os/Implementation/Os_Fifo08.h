...
))
{
  ...
  Os_FifoIdxIncrement(&(Fifo->Dyn->WriteIdx), Fifo->Size, OS_FIFO_WRITE_SYNCHRONIZED);                                  /* SBSW_OS_FF08_FIFOIDXINCREMENT_001 */
}


/***********************************************************************************************************************
 *  Os_Fifo08HasFreeSpaceAvailable()
 **********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
...
))
{
  ...
  readIdx = Os_Hal_LoadAcquire16(&(Fifo->Read->ReadIdx));                                                               /* SBSW_OS_FF08_LOADACQUIRE_001 */
...
))
{
  ...
  Os_FifoIdxIncrement(&(Fifo->Dyn->ReadIdx), Fifo->Size, OS_FIFO_WRITE_SYNCHRONIZED);                                   /* SBSW_OS_FF08_FIFOIDXINCREMENT_001 */
...
))
{
  ...
  writeIdx = Os_Hal_LoadAcquire16(&(Fifo->Write->WriteIdx));                                                            /* SBSW_OS_FF08_LOADACQUIRE_001 */
