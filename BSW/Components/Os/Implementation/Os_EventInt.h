 ...
 *  \retval       OS_STATUS_STATE_1                   (EXTENDED status:) Events can not be set as the referenced task
 *                                                                       is in the SUSPENDED state.
 *  \retval       OS_STATUS_EVENT_DISABLED_BY_CONFIG  (EXTENDED status:) Events are not enabled in the configuration.
 *  \retval       OS_STATUS_NOTACCESSIBLE_1   (Service Protection:) Given object's owner application is not accessible.
 ...
 *  \details      For further details see SetEventAsyn().
 *
 *  \param[in]    TaskID          See SetEventAsyn().
 *  \param[in]    Mask            See SetEventAsyn().
 *
 *  \retval       OS_STATUS_OK                No error.
 *  \retval       OS_STATUS_ID_1                      (EXTENDED status:) Invalid TaskID.
 *  \retval       OS_STATUS_NOEXTENDEDTASK_1          (EXTENDED status:) Task is no extended task.
 ...
 *  \retval       OS_STATUS_CALLEVEL          (Service Protection:) Called from invalid context.
 *  \retval       OS_STATUS_DISABLEDINT       (Service Protection:) Caller is in interrupt API sequence.
 *  \retval       OS_STATUS_ID_1              Asynchronous Local Task event setting.
 *
 *  \context      TASK|ISR2
 *
 *  \reentrant    TRUE
 *  \synchronous  FALSE
 *
 *  \pre          See SetEventAsyn().
 *
 *  \trace        CREQ-Os-AsynCrossCoreSetEvent, CREQ-40
 **********************************************************************************************************************/
