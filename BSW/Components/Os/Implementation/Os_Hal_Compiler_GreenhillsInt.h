 ...
 * \brief      Compiler abstraction of the Green Hills compiler
 *
 * \{
 *
 * \file    Os_Hal_Compiler_GreenhillsInt.h
 * \brief   This file contains the specific keyword definition for the Green Hills compiler
 * \details
 * The definitions are based on the Green Hills user Manual:
 * "MULTI: Building Applications for Embedded TriCore - March 26, 2019"
 *********************************************************************************************************************/
/***********************************************************************************************************************
 *  REVISION HISTORY
 *  --------------------------------------------------------------------------------------------------------------------
...
# define OS_FLATTEN                  /* "flatten" attribute is not supported by GHS */
 ...
 *  \param[in]  x       The called macro which needs string concatenation.
 */
 ...
 *  \pre           -
 */
# define Os_Hal_Mfcr(x)           (int)__mfcr((int)(x))
 ...
 *  \pre           -
 */
# define Os_Hal_Mtcr(x, y)        __mtcr((int)(x),(int)(y))
 ...
 *  \pre           -
 */
# define Os_Hal_Clz(x)            (unsigned int)__clz((int)(x)) /* According to compiler UM, this argument should be uint. But, <intrinsics.h> uses int */
 ...
 *  \pre           -
 */
# define Os_Hal_CmpSwap(x, y, z)  (int)__cmpswapw((int *)(x), (int)(y), (int)(z))
 ...
 *  \param[in]     core       On which logical core the exception entry is registered. It must be in range [0, 5].
...
# define Os_Hal_UnhandledTrapEntry(core, class) \
  __asm(".section .OS_EXCVEC_CORE" #core "_CODE,ax"); \
  __asm (".align 32"); \
 ...
 *  \param[in]     core       On which logical core the entry is registered. It must be in range [0, 5].
 *  \context       ANY
 *  \reentrant     TRUE
 *  \synchronous   TRUE
 *  \pre           -
...
# define Os_Hal_UserTrapEntryClass3(core, class, UserFunc) \
  ...
  __asm ("  movh.a a15, %hi(" #UserFunc ")");  \
  __asm ("  lea a15,[a15]%lo(" #UserFunc ")"); \
  __asm ("  ji a15");\
  __asm(".previous");
...
# define Os_Hal_Cat2InterruptEntry(core, level, systemlevel, isrconfig) \
  __asm(".section .OS_INTVEC_CORE" #core "_CODE,ax"); \
  __asm (".align 32"); \
 ...
 *                 own interrupt handler using the HighTec compiler key word __attribute__(("interrupt_handler")).
 *  \param[in]     core       On which logical core the entry is registered.
 ...
 *  \pre           -
 */
asm void Os_Hal_Mta10(uint32 x)
{
%areg x
  mov.aa  a10, x
%dreg x
 ...
 *  \pre           -
 */
asm void Os_Hal_Mta11(uint32 x)
{
%areg x
  mov.aa  a11, x
%dreg x
 ...
 *  \pre           -
 */
asm uint32 Os_Hal_Mfa0(void)
{
  mov.d  d2, a0
}

/***********************************************************************************************************************
 *  uint32 Os_Hal_Mfa1(void)
 **********************************************************************************************************************/
 ...
 *  \pre           -
 */
asm uint32 Os_Hal_Mfa1(void)
{
  mov.d  d2, a1
}

/***********************************************************************************************************************
 *  uint32 Os_Hal_Mfa9(void)
 **********************************************************************************************************************/
 ...
 *  \pre           -
 */
asm uint32 Os_Hal_Mfa9(void)
{
  mov.d  d2, a9
}

/***********************************************************************************************************************
 *  uint32 Os_Hal_Mfa10(void)
 **********************************************************************************************************************/
 ...
 *  \pre           -
 */
asm uint32 Os_Hal_Mfa10(void)
{
  mov.d  d2, a10
}

/***********************************************************************************************************************
 *  uint32 Os_Hal_Mfa11(void)
 **********************************************************************************************************************/
 ...
 *  \pre           -
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(uint32, OS_CODE, OS_HAL_NOINLINE, Os_Hal_Mfa8, (void));
