...
/*! Initializer for variables of type Os_ErrorParamsType */
#define OS_ERR_PARAMS_ZERO_INITIALIZER {{{0},{0},{0}}}
...
struct Os_ErrorType_Tag
{
  ...
  /*! The address of the instruction, that raised the latest exception. */
 ...
 **********************************************************************************************************************/
/*! \brief        Retrieves the exception instruction address from the error object.
 *  \details      --no details--
 *
 *  \param[in]    Error            The error object to read. Parameter must not be NULL.
 *
 *  \context      OS_INTERNAL
 *
 *  \return       ExceptionInstructionAddress of the error object.
 *
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 *
 *  \pre          -
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE Os_AddressOfConstType, OS_CODE, OS_ALWAYS_INLINE,
Os_ErrGetExceptionInstructionAddress,
(
 ...
 **********************************************************************************************************************/
/*! \brief        Reports the given status value in case of errors by means of error hook.
 *  \details      --no details--
 *
 *  \param[in]    Status            The result of the API execution.
 *  \param[in]    TaskID            The first API parameter.
 ...
 *
 *  \param[in]    Status  The status that is passed when calling the panic hook.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 *  \trace        CREQ-133061
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(void, OS_CODE, OS_NORETURN, Os_ErrKernelPanic,
(
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
FUNC(Os_FastTrustedFunctionIndexType, OS_CODE) Os_ErrorGetParameter_FastTrustedFunctionIndexType
(
  Os_ErrorParmIndexType ParamIndex
);
