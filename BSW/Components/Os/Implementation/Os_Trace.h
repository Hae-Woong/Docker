...
/***********************************************************************************************************************
 *  Os_TraceIsArtiEnabled()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_StdReturnType, OS_CODE, OS_ALWAYS_INLINE,
Os_TraceIsArtiEnabled,
( void ))
{
  return (Os_StdReturnType)(OS_CFG_ARTI == STD_ON);                                                                     /* PRQA S 4304, 2996 */ /* MD_Os_C90BooleanCompatibility, MD_Os_Rule2.2_2996 */
}
...
))
{
  ...
  /* #100 Store the currently running task if Orti or Arti task tracing is enabled. */
  if ((Os_TraceIsOrtiTaskIsrTracingEnabled() != 0u) || (Os_TraceIsArtiEnabled() != 0u))                                 /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
  {
    P2CONST(Os_CoreConfigType, AUTOMATIC, OS_CONST) core;
    core = Os_CoreGetCurrentCore();
 ...
 *
  ...
  /* #140 Store the currently running ISR if Orti or Arti ISR tracing is enabled. */
  if ((Os_TraceIsOrtiTaskIsrTracingEnabled() != 0u) || (Os_TraceIsArtiEnabled() != 0u))                                 /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
  {
    P2CONST(Os_CoreConfigType, AUTOMATIC, OS_CONST) core;
...
))
{
  ...
  /* #110 Store the currently running ISR if Orti or Arti ISR tracing is enabled. */
  if ((Os_TraceIsOrtiTaskIsrTracingEnabled() != 0u) || (Os_TraceIsArtiEnabled() != 0u))                                 /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
  {
    P2CONST(Os_CoreConfigType, AUTOMATIC, OS_CONST) core;
    core = Os_CoreGetCurrentCore();
...
))
{
  ...
  if((Os_TraceIsSetEventTimingHookEnabled() != 0u)  || (Os_TraceIsArtiTaskHookEnabled() != 0u))                         /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
  {
    ...
    if ((Os_TraceIsArtiTaskHookEnabled() != 0u) && (StateChanged == TRUE))
    {
