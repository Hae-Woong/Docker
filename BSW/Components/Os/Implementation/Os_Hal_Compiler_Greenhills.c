 ...
 **********************************************************************************************************************/
__asm( " .section .OS_CODE,ax " );
__asm ( " .globl Os_Hal_Mfa8   " );
__asm ( " Os_Hal_Mfa8 :        " );
__asm ( " mov.d  d2, a8        " );
__asm ( " ret16                " );
__asm(".previous");
...
OS_FUNC_ATTRIBUTE_DEFINITION(void, OS_CODE, OS_HAL_NOINLINE, Os_Hal_UnhandledExceptionHandler, (void))
{
  ...
  __asm ("mfcr d14, " OS_HAL_EXPAND(OS_HAL_CORE_ID_REGISTER));      /* get core ID; D14 = Physical Core ID */
  __asm ("and  d14, d14, 7");                                       /* mask core ID */
  __asm ("movh.a a4, %hi(OsCfg_Stack_KernelStacks)");               /* get address of the correct kernel stack (indexed by core ID) */
  __asm ("lea a4,[a4]%lo(OsCfg_Stack_KernelStacks)");               /* get address of the correct kernel stack (indexed by core ID); A4 = &OsCfg_Stack_KernelStacks */
  ...
  __asm ("rfe");                                                    /* return from exception; old stack pointer is restored with this instruction */
}
...
# endif /* if defined (OS_CFG_COMPILER_GREENHILLS) */
 ...
 */
/**********************************************************************************************************************
 *  END OF FILE: Os_Hal_Compiler_GreenHills.c
 *********************************************************************************************************************/
