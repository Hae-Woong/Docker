...
typedef P2CONST(Os_IsrHwConfigType, TYPEDEF, OS_CONST) Os_InterruptSourceConfigRefType;
 ...
 **********************************************************************************************************************/
/*! \brief          Returns the interrupt api state of the core.
 *  \details        --no details--
 *
 *  \param[in]      Core    The core to query. Parameter must not be NULL.
 *
 *  \return         Interrupt api state of the core.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
...
OS_ALWAYS_INLINE, Os_CoreGetInterruptApiState,
(
  P2CONST(Os_CoreAsrConfigType, AUTOMATIC, OS_CONST) Core
));
 ...
 **********************************************************************************************************************/
/*! \brief          Returns the call parameters stored in the last occurred error.
 *  \details        In comparison to Os_CoreGetLastError(), it is not possible to pass this function the core to query.
 *                  This would possibly require a second trap. Instead, this function always uses the local core.
 *
 *  \return         The call parameters stored in the last occured error.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE Os_ErrorParamsType, OS_CODE, OS_ALWAYS_INLINE,
Os_CoreGetLastErrorParametersLocal,
(
  void
));
 ...
 **********************************************************************************************************************/
FUNC(void, OS_CODE) Os_Api_InitInterruptOnly
(
  void
);
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(void, OS_CODE, OS_NORETURN, Os_CorePreStartTaskWrapper,
(
  void
));
