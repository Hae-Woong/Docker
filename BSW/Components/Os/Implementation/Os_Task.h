...
))
{
  ...
  return (P2CONST(Os_TaskConfigType, AUTOMATIC, OS_CONST))Thread;                                                       /* PRQA S 0310, 3305 */ /* MD_Os_Rule11.3_0310, MD_Os_Rule11.3_3305 */
}
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_TaskInitRoundRobinCounter,             /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
(
  P2CONST(Os_TaskConfigType, AUTOMATIC, OS_CONST) Task
))
{
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_TaskRoundRobinCount,                   /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
(
  P2CONST(Os_TaskConfigType, AUTOMATIC, OS_CONST) Task
))
{
  ...
  if(Os_SchedulerIsRoundRobinEnabled() != 0u)                                                                           /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
    ...
    if(Task->RoundRobinEnabled != 0u)                                                                                   /* PRQA S 1881 */ /* MD_Os_C90BooleanCompatibility */
    {
      P2VAR(Os_TaskType, AUTOMATIC, OS_VAR_NOINIT) taskDyn = Os_TaskGetDyn(Task);                                       /* SBSW_OS_FC_PRECONDITION */
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_StdReturnType, OS_CODE, OS_ALWAYS_INLINE, Os_TaskIsRoundRobinNeeded,    /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
(
  P2CONST(Os_TaskConfigType, AUTOMATIC, OS_CONST) Task
))
{
  ...
  if(Os_SchedulerIsRoundRobinEnabled() != 0u)                                                                           /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
    ...
    if(Task->RoundRobinEnabled != 0u)                                                                                   /* PRQA S 1881 */ /* MD_Os_C90BooleanCompatibility */
    {
      P2CONST(Os_TaskType, AUTOMATIC, OS_VAR_NOINIT) taskDyn = Os_TaskGetDyn(Task);                                     /* SBSW_OS_FC_PRECONDITION */
