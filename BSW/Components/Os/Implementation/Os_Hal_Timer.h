...
# if ((OS_HAL_TIMER_STM == STD_ON) && (OS_HAL_TIMER_CORESTM == STD_ON))
# error "wrong derivative setup. A derivative cannot specify both type of timers (STM, CoreSTM)"
# endif

# if (OS_HAL_TIMER_STM == STD_ON)
#  include "Os_Hal_Timer_STM.h"
# endif

# if (OS_HAL_TIMER_GPT == STD_ON)
#  include "Os_Hal_Timer_GPT.h"
# else
#  include "Os_Hal_Timer_PIT_Dummy.h"
# endif

# if (OS_HAL_TIMER_CORESTM == STD_ON)
#  include "Os_Hal_Timer_CoreSTM.h"
# endif
