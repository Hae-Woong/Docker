 ...
 *  \details        Use this function for setting the first application's memory protection settings.
 *
 ...
 **********************************************************************************************************************/
/*! \brief          Switches application related access rights.
 *  \details        Switches the current memory protection settings to the given next settings.
 *
 *  \param[in]      CurrentAppConfig  Configuration for the current application's memory protection mechanism.
 *                                    Parameter must not be NULL.
 *  \param[in]      NextAppConfig     Configuration for the next application's memory protection mechanism.
 *                                    Parameter must not be NULL.
 *
 *  \context        OS_INTERNAL
 *
 ...
 *  \details        Use this function for setting the first thread's memory protection settings.
 *
 ...
 *  \pre            Interrupts locked to TP lock level.
 *  \pre            Supervisor mode.
 *  \pre            Application rights are switched (see \ref Os_Hal_MpAppSwitchTo()).
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE,
Os_Hal_MpThreadSwitchTo,
(
 ...
 *  \details        Switches the current memory protection settings to the given next settings.
 *
 *  \param[in]      CurrentThreadConfig  Configuration for the current thread's memory protection mechanism.
 *                                       Parameter must not be NULL.
 *  \param[in]      NextThreadConfig     Configuration for the next thread's memory protection mechanism.
 *                                       Parameter must not be NULL.
 *
 *  \context        OS_INTERNAL
 *
