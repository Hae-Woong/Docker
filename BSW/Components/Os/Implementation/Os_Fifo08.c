 ...
 *
 * \file
 * \brief       Contains the implementation of the Fifo08 management.
 *
 *
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
\ID SBSW_OS_FF08_LOADACQUIRE_001
  \DESCRIPTION    Os_Hal_LoadAcquire16 is called with a pointer derived from a Fifo object. The Fifo is passed as
                  an argument to the caller.
  \COUNTERMEASURE \M [CM_OS_FIFO08READ_WRITE_M]
  \COUNTERMEASURE \M [CM_OS_FIFO08WRITE_READ_M]
