 ...
 *
 *  \retval       !0    Orti Task/ISR tracing is enabled.
 *  \retval       0     Orti Task/ISR tracing is disabled.
 *
 *  \context      OS_INTERNAL
 *
 *  \reentrant    TRUE
 ...
 **********************************************************************************************************************/
/*! \brief        Returns whether Arti Task/ISR tracing is enabled or not.
 *  \details      This allows the Arti debugger to trace which task or ISR is currently performed.
 *
 *  \retval       !0    Arti Task/ISR tracing is enabled.
 *  \retval       0     Arti Task/ISR tracing is disabled.
 *
 *  \context      OS_INTERNAL
 *
 *  \reentrant    TRUE
