 ...
 *  \trace      SPEC-63736
 **********************************************************************************************************************/
#define ALARMCALLBACK(AlarmCbkName) void AlarmCbkName(void)
 ...
 *  \trace        SPEC-2088243
 **********************************************************************************************************************/
# define OSMEMORY_IS_READABLE(x) ( ((uint32)(x)) & ((uint32)(OS_MEM_ACCESS_TYPE_READ)) )
 ...
 *  \trace        SPEC-2088243
 **********************************************************************************************************************/
# define OSMEMORY_IS_WRITEABLE(x) ( ((uint32)(x)) & ((uint32)(OS_MEM_ACCESS_TYPE_WRITE)) )
 ...
 *  \trace        SPEC-2088243
 **********************************************************************************************************************/
# define OSMEMORY_IS_EXECUTABLE(x) ( ((uint32)(x)) & ((uint32)(OS_MEM_ACCESS_TYPE_EXECUTE)) )
 ...
 *  \trace        SPEC-2088243
 **********************************************************************************************************************/
# define OSMEMORY_IS_STACKSPACE(x) ( ((uint32)(x)) & ((uint32)(OS_MEM_ACCESS_TYPE_STACK)) )
 ...
 *  \details      --no details--
 *
 *  \param[in]    Status  The reason why the panic hook was called.
 *
 *  \context      OS_INTERNAL
 *
 *  \reentrant    TRUE
