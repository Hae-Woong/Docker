 ...
 * \brief   Primitives definition for TriCore Processor Core TC1.8
 *
 * \{
 *
 * \file       Os_Hal_Core_18Int.h
 * \brief      This file contains hardware specific addresses for TriCore Processor Core TC1.8
 *
...
#ifndef OS_HAL_CORE_18INT_H
# define OS_HAL_CORE_18INT_H
...
# define OS_HAL_CORE_ID_MASK              0x7u

/*! Address of BTV register. */
# define OS_HAL_BTV_REGISTER              0xFE24

/*! Address of BIV register. */
# define OS_HAL_BIV_REGISTER              0xFE20
...
/*! Address of the CORECON register. */
# define OS_HAL_SYSCON_CORECON_OFFSET             0xFE14
/*! Bit mask (bit 2) for timing protection exception flag */
# define OS_HAL_SYSCON_CORECON_TP_MASK            0x00000004uL
/*! Bit mask (bit 1) for memory protection exception flag */
# define OS_HAL_SYSCON_CORECON_MP_MASK            0x00000002uL
/*! Bit mask (bit 3) for initial state for PSW.S bit in trap handler */
# define OS_HAL_SYSCON_CORECON_IS_MASK            0x00000008uL
/*! Bit mask (bit 4) for initial state of PSW.S bit in interrupt handler */
# define OS_HAL_SYSCON_CORECON_TS_MASK            0x00000010uL
/*! Bit mask (bit 16) for forbid the usage of "enable", 
    "disable" and "restore" instructions in user1 mode */
# define OS_HAL_SYSCON_CORECON_U1IED_MASK         0x00010000uL


/*! Address of the BOOTCON register. */
# define OS_HAL_BOOTCON_OFFSET             0xFE60
/*! Bit mask (bit 1) for boot halt status */
# define OS_HAL_BOOTCONCON_BHALT_MASK         0x00000001uL
...
/*! Bit mask (bit 2,1,0) for PPRS (Previous Protection Register) */
# define OS_HAL_PSW_PRS_MASK             0x0000B000uL
/*! Bit value (bit 2,1,0) for PRS0 (Protection Register Set 0) */
# define OS_HAL_PSW_PRS_PS0              0x00000000uL
/*! Bit value (bit 2,1,0) for PRS1 (Protection Register Set 1) */
# define OS_HAL_PSW_PRS_PS1              0x00000001uL
/*! Bit value (bit 2,1,0) for PRS2 (Protection Register Set 2) */
# define OS_HAL_PSW_PRS_PS2              0x00000002uL
/*! Bit value (bit 2,1,0) for PRS3 (Protection Register Set 3) */
# define OS_HAL_PSW_PRS_PS3              0x00000003uL
/*! Bit value (bit 2,1,0) for PRS4 (Protection Register Set 4) */
# define OS_HAL_PSW_PRS_PS4              0x00000004uL
/*! Bit value (bit 2,1,0) for PRS5 (Protection Register Set 5) */
# define OS_HAL_PSW_PRS_PS5              0x00000005uL
/*! Bit value (bit 2,1,0) for PRS6 (Protection Register Set 6) */
# define OS_HAL_PSW_PRS_PS6              0x00000006uL
/*! Bit value (bit 2,1,0) for PRS7 (Protection Register Set 7) */
# define OS_HAL_PSW_PRS_PS7              0x00000007uL
...
# define OS_HAL_CORE_18_CORE0_CSFR_BASE           0xF8810000uL
# define OS_HAL_CORE_18_CORE0_SFR_BASE            0xF8800000uL
# define OS_HAL_CORE_18_CORE1_CSFR_BASE           0xF8850000uL
# define OS_HAL_CORE_18_CORE1_SFR_BASE            0xF8840000uL
# define OS_HAL_CORE_18_CORE2_CSFR_BASE           0xF8890000uL
# define OS_HAL_CORE_18_CORE2_SFR_BASE            0xF8880000uL
# define OS_HAL_CORE_18_CORE3_CSFR_BASE           0xF88D0000uL
# define OS_HAL_CORE_18_CORE3_SFR_BASE            0xF88C0000uL
# define OS_HAL_CORE_18_CORE4_CSFR_BASE           0xF8910000uL
# define OS_HAL_CORE_18_CORE4_SFR_BASE            0xF8900000uL
# define OS_HAL_CORE_18_CORE5_CSFR_BASE           0xF8950000uL
# define OS_HAL_CORE_18_CORE5_SFR_BASE            0xF8940000uL
# define OS_HAL_CORE_18_CORE6_CSFR_BASE           0xF8990000uL
# define OS_HAL_CORE_18_CORE6_SFR_BASE            0xF8980000uL
# define OS_HAL_CORE0_PC                          (OS_HAL_CORE_18_CORE0_CSFR_BASE + 0xFE08uL)
# define OS_HAL_CORE0_DBGSR                       (OS_HAL_CORE_18_CORE0_CSFR_BASE + 0xFD00uL)
# define OS_HAL_CORE0_SYSCON_CORECON              (OS_HAL_CORE_18_CORE0_CSFR_BASE + 0xFE14uL)
# define OS_HAL_CORE0_BOOTCON                     (OS_HAL_CORE_18_CORE0_CSFR_BASE + 0xFE60uL)
# define OS_HAL_CORE1_PC                          (OS_HAL_CORE_18_CORE1_CSFR_BASE + 0xFE08uL)
# define OS_HAL_CORE1_DBGSR                       (OS_HAL_CORE_18_CORE1_CSFR_BASE + 0xFD00uL)
# define OS_HAL_CORE1_SYSCON_CORECON              (OS_HAL_CORE_18_CORE1_CSFR_BASE + 0xFE14uL)
# define OS_HAL_CORE1_BOOTCON                     (OS_HAL_CORE_18_CORE1_CSFR_BASE + 0xFE60uL)
# define OS_HAL_CORE2_PC                          (OS_HAL_CORE_18_CORE2_CSFR_BASE + 0xFE08uL)
# define OS_HAL_CORE2_DBGSR                       (OS_HAL_CORE_18_CORE2_CSFR_BASE + 0xFD00uL)
# define OS_HAL_CORE2_SYSCON_CORECON              (OS_HAL_CORE_18_CORE2_CSFR_BASE + 0xFE14uL)
# define OS_HAL_CORE2_BOOTCON                     (OS_HAL_CORE_18_CORE2_CSFR_BASE + 0xFE60uL)
# define OS_HAL_CORE3_PC                          (OS_HAL_CORE_18_CORE3_CSFR_BASE + 0xFE08uL)
# define OS_HAL_CORE3_DBGSR                       (OS_HAL_CORE_18_CORE3_CSFR_BASE + 0xFD00uL)
# define OS_HAL_CORE3_SYSCON_CORECON              (OS_HAL_CORE_18_CORE3_CSFR_BASE + 0xFE14uL)
# define OS_HAL_CORE3_BOOTCON                     (OS_HAL_CORE_18_CORE3_CSFR_BASE + 0xFE60uL)
# define OS_HAL_CORE4_PC                          (OS_HAL_CORE_18_CORE4_CSFR_BASE + 0xFE08uL)
# define OS_HAL_CORE4_DBGSR                       (OS_HAL_CORE_18_CORE4_CSFR_BASE + 0xFD00uL)
# define OS_HAL_CORE4_SYSCON_CORECON              (OS_HAL_CORE_18_CORE4_CSFR_BASE + 0xFE14uL)
# define OS_HAL_CORE4_BOOTCON                     (OS_HAL_CORE_18_CORE4_CSFR_BASE + 0xFE60uL)
# define OS_HAL_CORE5_PC                          (OS_HAL_CORE_18_CORE5_CSFR_BASE + 0xFE08uL)
# define OS_HAL_CORE5_DBGSR                       (OS_HAL_CORE_18_CORE5_CSFR_BASE + 0xFD00uL)
# define OS_HAL_CORE5_SYSCON_CORECON              (OS_HAL_CORE_18_CORE5_CSFR_BASE + 0xFE14uL)
# define OS_HAL_CORE5_BOOTCON                     (OS_HAL_CORE_18_CORE5_CSFR_BASE + 0xFE60uL)
# define OS_HAL_CORE6_PC                          (OS_HAL_CORE_18_CORE6_CSFR_BASE + 0xFE08uL)
# define OS_HAL_CORE6_DBGSR                       (OS_HAL_CORE_18_CORE6_CSFR_BASE + 0xFD00uL)
# define OS_HAL_CORE6_SYSCON_CORECON              (OS_HAL_CORE_18_CORE6_CSFR_BASE + 0xFE14uL)
# define OS_HAL_CORE6_BOOTCON                     (OS_HAL_CORE_18_CORE6_CSFR_BASE + 0xFE60uL)

/*! Define the start core mask */
# define OS_HAL_DBGSR_START_CORE                  (0x00000004uL)

/*! Define the number of protection sets */
# define OS_HAL_COREMPU_NUM_OF_PS        8
...
# define OS_HAL_COREMPU_DPR_LOW18        0xC090
# define OS_HAL_COREMPU_DPR_LOW19        0xC098
# define OS_HAL_COREMPU_DPR_LOW20        0xC0A0
# define OS_HAL_COREMPU_DPR_LOW21        0xC0A8
# define OS_HAL_COREMPU_DPR_LOW22        0xC0B0
# define OS_HAL_COREMPU_DPR_LOW23        0xC0B8
...
# define OS_HAL_COREMPU_DPR_UPPER18      0xC094
# define OS_HAL_COREMPU_DPR_UPPER19      0xC09C
# define OS_HAL_COREMPU_DPR_UPPER20      0xC0A4
# define OS_HAL_COREMPU_DPR_UPPER21      0xC0AC
# define OS_HAL_COREMPU_DPR_UPPER22      0xC0B4
# define OS_HAL_COREMPU_DPR_UPPER23      0xC0BC
...
# define OS_HAL_COREMPU_CPR_LOW10        0xD050
# define OS_HAL_COREMPU_CPR_LOW11        0xD058
# define OS_HAL_COREMPU_CPR_LOW12        0xD060
# define OS_HAL_COREMPU_CPR_LOW13        0xD068
# define OS_HAL_COREMPU_CPR_LOW14        0xD070
# define OS_HAL_COREMPU_CPR_LOW15        0xD078
...
# define OS_HAL_COREMPU_CPR_UPPER10      0xD054
# define OS_HAL_COREMPU_CPR_UPPER11      0xD05C
# define OS_HAL_COREMPU_CPR_UPPER12      0xD064
# define OS_HAL_COREMPU_CPR_UPPER13      0xD06C
# define OS_HAL_COREMPU_CPR_UPPER14      0xD074
# define OS_HAL_COREMPU_CPR_UPPER15      0xD07C
...
# define OS_HAL_COREMPU_DPRE6            0xE058
# define OS_HAL_COREMPU_DPRE7            0xE05C
...
# define OS_HAL_COREMPU_DPWE6            0xE068
# define OS_HAL_COREMPU_DPWE7            0xE06C
...
# define OS_HAL_COREMPU_CPXE6            0xE048
# define OS_HAL_COREMPU_CPXE7            0xE04C
...
# define OS_HAL_COREMPU_ENABLE_REGION18  (0x00040000uL)
# define OS_HAL_COREMPU_ENABLE_REGION19  (0x00080000uL)
# define OS_HAL_COREMPU_ENABLE_REGION20  (0x00100000uL)
# define OS_HAL_COREMPU_ENABLE_REGION21  (0x00200000uL)
# define OS_HAL_COREMPU_ENABLE_REGION22  (0x00400000uL)
# define OS_HAL_COREMPU_ENABLE_REGION23  (0x00800000uL)
...
# define OS_HAL_COREMPU_DISABLE_REGION18 (0x00000000uL)
# define OS_HAL_COREMPU_DISABLE_REGION19 (0x00000000uL)
# define OS_HAL_COREMPU_DISABLE_REGION20 (0x00000000uL)
# define OS_HAL_COREMPU_DISABLE_REGION21 (0x00000000uL)
# define OS_HAL_COREMPU_DISABLE_REGION22 (0x00000000uL)
# define OS_HAL_COREMPU_DISABLE_REGION23 (0x00000000uL)

/*! previous protection set register */
# define OS_HAL_PPRS_OFFSET               0xFE34

/*! virtualization registers */
# define OS_HAL_VCON0_OFFSET               0xB000
# define OS_HAL_VCON1_OFFSET               0xB004
# define OS_HAL_VCON2_OFFSET               0xB008
...
# define Os_Hal_SetDataRegion(Slot, LowerValue, UpperValue)                                                 \
         ...
         {                                                                                                  \
           ...
           case 17:                                                                                         \
             ...
             break;                                                                                         \
           case 18:                                                                                         \
             Os_Hal_Mtcr(OS_HAL_COREMPU_DPR_LOW18, (LowerValue));                                           \
             Os_Hal_Mtcr(OS_HAL_COREMPU_DPR_UPPER18, (UpperValue));                                         \
             break;                                                                                         \
           case 19:                                                                                         \
             Os_Hal_Mtcr(OS_HAL_COREMPU_DPR_LOW19, (LowerValue));                                           \
             Os_Hal_Mtcr(OS_HAL_COREMPU_DPR_UPPER19, (UpperValue));                                         \
             break;                                                                                         \
           case 20:                                                                                         \
             Os_Hal_Mtcr(OS_HAL_COREMPU_DPR_LOW20, (LowerValue));                                           \
             Os_Hal_Mtcr(OS_HAL_COREMPU_DPR_UPPER20, (UpperValue));                                         \
             break;                                                                                         \
           case 21:                                                                                         \
             Os_Hal_Mtcr(OS_HAL_COREMPU_DPR_LOW21, (LowerValue));                                           \
             Os_Hal_Mtcr(OS_HAL_COREMPU_DPR_UPPER21, (UpperValue));                                         \
             break;                                                                                         \
           case 22:                                                                                         \
             Os_Hal_Mtcr(OS_HAL_COREMPU_DPR_LOW22, (LowerValue));                                           \
             Os_Hal_Mtcr(OS_HAL_COREMPU_DPR_UPPER22, (UpperValue));                                         \
             break;                                                                                         \
           case 23:                                                                                         \
             Os_Hal_Mtcr(OS_HAL_COREMPU_DPR_LOW23, (LowerValue));                                           \
             Os_Hal_Mtcr(OS_HAL_COREMPU_DPR_UPPER23, (UpperValue));                                         \
             break;                                                                                         \
           default:                                                                                         \
             break;                                                                                         \
         }
...
# define Os_Hal_SetCodeRegion(Slot, LowerValue, UpperValue)                                                 \
         ...
         {                                                                                                  \
           ...
           case 9:                                                                                          \
             ...
             break;                                                                                         \
           case 10:                                                                                          \
             Os_Hal_Mtcr(OS_HAL_COREMPU_CPR_LOW10, (LowerValue));                                            \
             Os_Hal_Mtcr(OS_HAL_COREMPU_CPR_UPPER10, (UpperValue));                                          \
             break;                                                                                         \
           case 11:                                                                                          \
             Os_Hal_Mtcr(OS_HAL_COREMPU_CPR_LOW11, (LowerValue));                                            \
             Os_Hal_Mtcr(OS_HAL_COREMPU_CPR_UPPER11, (UpperValue));                                          \
             break;                                                                                         \
           case 12:                                                                                          \
             Os_Hal_Mtcr(OS_HAL_COREMPU_CPR_LOW12, (LowerValue));                                            \
             Os_Hal_Mtcr(OS_HAL_COREMPU_CPR_UPPER12, (UpperValue));                                          \
             break;                                                                                         \
           case 13:                                                                                          \
             Os_Hal_Mtcr(OS_HAL_COREMPU_CPR_LOW13, (LowerValue));                                            \
             Os_Hal_Mtcr(OS_HAL_COREMPU_CPR_UPPER13, (UpperValue));                                          \
             break;                                                                                         \
           case 14:                                                                                          \
             Os_Hal_Mtcr(OS_HAL_COREMPU_CPR_LOW14, (LowerValue));                                            \
             Os_Hal_Mtcr(OS_HAL_COREMPU_CPR_UPPER14, (UpperValue));                                          \
             break;                                                                                         \
           case 15:                                                                                          \
             Os_Hal_Mtcr(OS_HAL_COREMPU_CPR_LOW15, (LowerValue));                                            \
             Os_Hal_Mtcr(OS_HAL_COREMPU_CPR_UPPER15, (UpperValue));                                          \
             break;                                                                                         \
           default:                                                                                         \
             break;                                                                                         \
         }
 ...
 **********************************************************************************************************************/
/*! \brief          prepares the PRS register within one CSA
 *  \param[in]      PcxiAddr      -> pointer to the CSA.
 *  \param[in]      CurrentConfig -> pointer to the context configuration.
 *  \context        OS_INTERNAL
 *  \reentrant      FALSE
 *  \synchronous    TRUE
 *  \pre            -
...
Os_Hal_ContextPreparePRS,
(
  CONST(uint32, AUTOMATIC) PcxiAddr,
 ...
 *  Os_Hal_SetPPRS()
 **********************************************************************************************************************/
/*! \brief          sets the previous protection set register
 *  \param[in]      PprsValue -> value to be set.
 *  \context        OS_INTERNAL
 *  \reentrant      FALSE
 *  \synchronous    TRUE
 *  \pre            -
...
Os_Hal_SetPPRS,
(
  CONST(uint32, AUTOMATIC) PprsValue
));
 ...
 *  Os_Hal_GetPPRS()
 **********************************************************************************************************************/
/*! \brief          reads the previous protection set register
 *  \param[out]     The value of PPRS.
 *  \context        OS_INTERNAL
 *  \reentrant      FALSE
 *  \synchronous    TRUE
 *  \pre            -
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE uint32, OS_CODE, OS_ALWAYS_INLINE,                                           /* COV_OS_HALUNSUPPORTEDCODEREGIONS */ /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
Os_Hal_GetPPRS,
(
  void
));
 ...
 *  Os_Hal_InitBtvBiv()
 **********************************************************************************************************************/
/*! \brief          Initializes BTV and BIV registers
 *  \param[in]      Config -> pointer to the ASR core configuration.
 *  \context        OS_INTERNAL
 *  \reentrant      FALSE
 *  \synchronous    TRUE
 *  \pre            -
...
#endif /* OS_HAL_CORE_18INT_H */

/*!
 * \}
 */
/**********************************************************************************************************************
 *  END OF FILE: Os_Hal_Core_18Int.h
 *********************************************************************************************************************/
