 ...
 **********************************************************************************************************************/
/*! Possible values to be set for the switch OS_CFG_TIMING_PROTECTION (generated).*/
# define OS_CFG_TP_NO_CORE    (0u) /*!< No timing protection configured on any ASR core. */
# define OS_CFG_TP_SOME_CORES (1u) /*!< Timing protection configured on some ASR cores. */
# define OS_CFG_TP_ALL_CORES  (2u) /*!< Timing protection configured for all ASR cores. */
