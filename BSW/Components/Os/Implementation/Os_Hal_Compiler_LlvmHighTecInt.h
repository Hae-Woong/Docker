 ...
 * \brief      Compiler abstraction of the Llvm HighTec GCC compiler
 *
 * \{
 *
 * \file    Os_Hal_Compiler_LlvmHighTecInt.h
 * \brief   This file contains the specific keyword definition for the Llvm Hightec GCC compiler
 * \details
 * The definitions are based on the HighTec Compiler User Manuals
 * "HighTec TriCore Development Platform User Guide v8.0.0"
 *********************************************************************************************************************/
/***********************************************************************************************************************
 *  REVISION HISTORY
 *  --------------------------------------------------------------------------------------------------------------------
...
#ifndef OS_HAL_COMPILER_LLVMHIGHTECINT_H
# define OS_HAL_COMPILER_LLVMHIGHTECINT_H
 ...
 *  \pre           -
 */
# define Os_Hal_Disable()         __builtin_tricore_disable()
 ...
 *  \pre           -
 */
# define Os_Hal_Enable()          __builtin_tricore_enable()
 ...
 *  \pre           -
 */
# define Os_Hal_Mfcr(x)           __builtin_tricore_mfcr((unsigned int)x)
 ...
 *  \pre           -
 */
# define Os_Hal_Mtcr(x, y)        __builtin_tricore_mtcr((unsigned int)(x),(unsigned int)(y))
 ...
 *  \pre           -
 */
# define Os_Hal_Isync()           __builtin_tricore_isync()
 ...
 *  \pre           -
 */
# define Os_Hal_Dsync()           __builtin_tricore_dsync()
 ...
 *  \pre           -
 */
# define Os_Hal_Svlcx()           __asm("svlcx")
 ...
 *  \pre           -
 */
# define Os_Hal_Rslcx()           __asm("rslcx")
 ...
 *  \pre           -
 */
# define Os_Hal_Clz(x)            __builtin_clz((unsigned int)x)
 ...
 *  \pre           -
 */
# define Os_Hal_CmpSwap(x, y, z)  __builtin_tricore_cmpswap_w((volatile int *)x, (int)z, (int)y)
 ...
 *  \pre           -
 */
# define Os_Hal_Debug()           __builtin_tricore_debug()
 ...
 *  \pre           -
 */
# define Os_Hal_Nop()             __builtin_tricore_nop()
...
# define Os_Hal_UnhandledTrapEntry(core, class) \
  __asm (".pushsection .OS_EXCVEC_CORE" #core "_CODE, \"ax\""); \
  __asm (".p2align 5"); \
...
# define Os_Hal_Cat2InterruptEntry(core, level, systemlevel, isrconfig) \
  __asm (".pushsection .OS_INTVEC_CORE" #core "_CODE, \"ax\""); \
  __asm (".p2align 5"); \
...
#endif /* OS_HAL_COMPILER_LLMVHIGHTECINT_H */
