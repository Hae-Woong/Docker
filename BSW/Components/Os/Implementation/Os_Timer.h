 ...
 **********************************************************************************************************************/
/*! Timeout for setting a FRT compare value before calling the ErrorHook.
 *  Choosing a power of two enables the compiler to optimize the modulo operation using bitwise AND.
 */
#define OS_TIMER_SET_FRT_COMPARE_VALUE_TIMEOUT 256u
 ...
 *  Os_TimerPitInit()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE,                                           /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_HALPLATFORMPITUNSUPPORTED_XX */
Os_TimerPitInit,
(
 ...
 *  Os_TimerPfrtInit()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE,                                           /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_HALPLATFORMPFRTUNSUPPORTED_XX */
Os_TimerPfrtInit,
(
...
))
{
  ...
  OS_IGNORE_UNREF_PARAM(Timer);                                                                                         /* PRQA S 3112 */ /* MD_Os_Rule2.2_3112 */
}
 ...
 *  Os_TimerPitGetValue()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_TickType, OS_CODE, OS_ALWAYS_INLINE,                                    /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_HALPLATFORMPITUNSUPPORTED_XX */
Os_TimerPitGetValue,
(
  P2CONST(Os_TimerPitConfigType, AUTOMATIC, OS_CONST) Timer
))                                                                                                                      /* COV_OS_HALPLATFORMPITUNSUPPORTED_XX */
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(                                                                                           /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_HALPLATFORMPITUNSUPPORTED_XX */
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_TickType, OS_CODE, OS_ALWAYS_INLINE,                                    /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_HALPLATFORMPFRTUNSUPPORTED_XX */
Os_TimerPfrtUserModulo,
(
  P2CONST(Os_TimerPfrtConfigType, AUTOMATIC, OS_CONST) Timer,
  Os_TickType Value
...
OS_LOCAL_INLINE Os_TickType, OS_CODE, OS_ALWAYS_INLINE, Os_TimerHrtComputeHardwareCompareValue,
(
  P2CONST(Os_TimerHrtConfigType, AUTOMATIC, OS_CONST) Timer,
  Os_TickType ExpirationTime
))                                                                                                                      /* COV_OS_HALPLATFORMFRTUNSUPPORTED_XX */
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE,                                           /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_HALPLATFORMTPUNSUPPORTED_XX */
Os_TimerHrtInitCompareValue,
(
  P2CONST(Os_TimerHrtConfigType, AUTOMATIC, OS_CONST) Timer,
...
{
  Timer->Dyn->Compare = CompareValue;                                                                                   /* SBSW_OS_TIMER_TIMERGETDYN_001 */
}
...
))                                                                                                                      /* COV_OS_HALPLATFORMFRTUNSUPPORTED_XX */
{
  ...
  if(OS_UNLIKELY(Os_CounterIsFutureValue(&(Timer->Counter), ExpirationTime, now) == 0u))                                /* SBSW_OS_FC_PRECONDITION */
  {
    ...
    {
      /* #80 Set the compare value into the near future. */
      Os_TimerFrtSetFutureCompareValue(Timer->HwConfig,                                                                 /* SBSW_OS_TIMER_TIMERFRTSETFUTURECOMPAREVALUE_001 */
                                       Timer->Counter.Characteristics.MaxCountingValue,
                                       Timer->Counter.Characteristics.MaxAllowedValue);
    }
  }
}
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE,                                           /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_HALPLATFORMPERIPHERALINTTRIGGERSUPPORTED */
Os_TimerFrtSetFutureCompareValue,
(
...
))                                                                                                                      /* COV_OS_HALPLATFORMPERIPHERALINTTRIGGERSUPPORTED */
{
  ...
  /* #10 Do */
  do                                                                                                                    /* PRQA S 2871 */ /* MD_Os_Dir4.1_2871 */ /* FETA_OS_SETNEXTCOMPAREVALUE */
  {

    /* #20 If the compare value can not be set after a certain time: */
    if ((iterationId % OS_TIMER_SET_FRT_COMPARE_VALUE_TIMEOUT) == 0u)                                                   /* COV_OS_TIMEOUT_XF */
    {
      /* #30 Report error if applicable. */
      Os_ErrReportFrtSetFutureCompareValue(OS_STATUS_FRT_NO_FUTURE_VALUE);
    }

    /* #40 Read the current counter value from hardware timer. */
    timeBeforeSetCompare = Os_TimerFrtTickType2TickType(Os_Hal_TimerFrtGetCounterValue(TimerConfig));                   /* SBSW_OS_TIMER_HAL_TIMERFRTGETCOUNTERVALUE_001 */

    /* #50 Set the compare value to the previously read counter value plus delay. */
    compareValue = timeBeforeSetCompare + delta + iterationId;                                                          /* PRQA S 2986 */ /* MD_Os_Rule2.2_2986 */
    Os_TimerFrtSetCompareValue(TimerConfig, compareValue);                                                              /* SBSW_OS_TIMER_TIMERFRTSETCOMPAREVALUE_001 */

    /* #60 Read again the current hardware counter value and update the delay, taking into
           account the counter values difference and the loop iteration count. */
    timeAfterSetCompare = Os_TimerFrtTickType2TickType(Os_Hal_TimerFrtGetCounterValue(TimerConfig));                    /* SBSW_OS_TIMER_HAL_TIMERFRTGETCOUNTERVALUE_001 */
    delta = timeAfterSetCompare - timeBeforeSetCompare;
    iterationId++;

  /* #70 Loop while compare value is in the past or now with respect to the last read counter value. */
  }while (OS_UNLIKELY(Os_CounterIsFutureValueInternal(                                                                  /* PRQA S 2871, 2990, 2995 */ /* MD_Os_Dir4.1_2871, MD_Os_Rule14.3_2990, MD_Os_Rule2.2_2995 */
          MaxCountingValue, MaxDifferentialValue, compareValue, timeAfterSetCompare) == 0u));                           /* SBSW_OS_FC_PRECONDITION */
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_StdReturnType, OS_CODE, OS_ALWAYS_INLINE,                               /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_HALPLATFORMFRTUNSUPPORTED_XX */
Os_TimerHrtIsLogicalCompareValueReached,
(
  P2CONST(Os_TimerHrtConfigType, AUTOMATIC, OS_CONST) Timer
))                                                                                                                      /* COV_OS_HALPLATFORMFRTUNSUPPORTED_XX */
...
{
  /* #05 Convert the passed CompareValue to a HAL tick type and store it to a local compare value. */
  Os_Hal_TimerFrtTickType localCompareValue = Os_TimerTickType2FrtTickType(CompareValue);
  ...
  if(Os_TimerIsFrtLongCorrectionNeeded() != 0u)                                                                         /* COV_OS_HALPLATFORMFRT64BITAVAILABILITY */ /* PRQA S 2991, 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
  {
    ...
    hwCompareValue = (now & Os_TimerFrtGetLongValueMask()) + localCompareValue;
    ...
    if(Os_TimerIsCompareValueCorrectionNeeded(shortNow, CompareValue) != 0u)
    {
      ...
      hwCompareValue += Os_TimerTickType2FrtTickType(OS_OS_TICKTYPE_MAX) + 1u;                                          /* COMP_WARN_OS_CONST_EXPR_OVERFLOW */
    }

    /* #60 Set the local compare value to the corrected value. */
    localCompareValue = hwCompareValue;
  }

  /* #70 Write the local compare value into the hardware. */
  Os_Hal_TimerFrtSetCompareValue(TimerConfig, localCompareValue);                                                       /* SBSW_OS_FC_PRECONDITION */

  /* #80 Poll the hardware register to check that the local compare value is written into the register. */
  {
    Os_Hal_TimerFrtTickType readBack = 0u;                                                                              /* COMP_WARN_OS_USELESS_ASSIGNMENT */
    uint32 iterationId = 1;

    do                                                                                                                  /* FETA_OS_SETHALCOMPAREVALUE */
    {
      /* #90 If the compare value is not set after a certain time, report an error. */
      if (iterationId >= OS_TIMER_SET_FRT_COMPARE_VALUE_TIMEOUT)                                                        /* COV_OS_TIMEOUT_XF */
      {
        Os_ErrReportFrtSetCompareValue(OS_STATUS_FRT_SET_COMPARE_VALUE_FAILED);
      }

      readBack = Os_Hal_TimerFrtGetCompareValue(TimerConfig);                                                           /* SBSW_OS_FC_PRECONDITION */
      iterationId++;
    } while (OS_UNLIKELY(readBack != localCompareValue));                                                               /* COV_OS_NOFUNCCALL_XF */
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_Hal_TimerFrtTickType, OS_CODE, OS_ALWAYS_INLINE,                        /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_HALPLATFORMFRTUNSUPPORTED_XX */
Os_TimerTickType2FrtTickType,
(
  Os_TickType Value
))                                                                                                                      /* COV_OS_HALPLATFORMFRTUNSUPPORTED_XX */
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_StdReturnType, OS_CODE, OS_ALWAYS_INLINE,                               /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_HALPLATFORMFRT64BITAVAILABILITY */
Os_TimerIsCompareValueCorrectionNeeded,
(
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_Hal_TimerFrtTickType, OS_CODE, OS_ALWAYS_INLINE,                        /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_HALPLATFORMFRT64BITAVAILABILITY */
