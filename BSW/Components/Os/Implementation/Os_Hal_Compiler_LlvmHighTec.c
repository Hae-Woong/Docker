 ...
 *
 *  \file
 *  \brief        Compiler abstraction for LlvmHighTec compiler.
 *  \details
...
# if defined (OS_CFG_COMPILER_LLVMHIGHTEC)
...
# endif /* if defined (OS_CFG_COMPILER_LLVMHIGHTEC) */
 ...
 */
/**********************************************************************************************************************
 *  END OF FILE: Os_Hal_Compiler_HighTec.c
 *********************************************************************************************************************/
