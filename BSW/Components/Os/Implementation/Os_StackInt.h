 ...
 **********************************************************************************************************************/
/*! \brief        Get the current init hook stack usage on the given core.
 *  \details      For further details see Os_GetInitHookStackUsage().
 *
 *  \param[in]    CoreID         See Os_GetInitHookStackUsage().
 *
 *  \return       See Os_GetInitHookStackUsage().
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 *
 *  \pre          See Os_GetInitHookStackUsage().
 *
 *  \trace        CREQ-159, CREQ-40
 **********************************************************************************************************************/
 ...
 **********************************************************************************************************************/
/*! \brief        Get the current stack usage of the given non-trusted function.
 *  \details      For further details see Os_GetNonTrustedFunctionStackUsage().
 *
 *  \param[in]    FunctionIndex  See Os_GetNonTrustedFunctionStackUsage().
 *
 *  \return       See Os_GetNonTrustedFunctionStackUsage().
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 *
 *  \pre          See Os_GetNonTrustedFunctionStackUsage().
 *
 *  \trace        CREQ-159, CREQ-40
 **********************************************************************************************************************/
 ...
 *  \synchronous  TRUE
 *
 *  \pre          The given core has a init hook configured.
 **********************************************************************************************************************/
FUNC(uint32, OS_CODE) Os_StackGetInitHookStackUsageLocal
(
  P2CONST(Os_CoreAsrConfigType, AUTOMATIC, OS_CONST) Core
);
 ...
 **********************************************************************************************************************/
/*! \brief        Get the current stack usage of the given non-trusted function.
 *  \details      Iterates through all stacks from the function's pool and returns the maximum consumption.
 *
 *  \param[in]    NonTrustedFunction    The non-trusted function which shall be queried. Parameter must not be NULL.
 *
 *  \return       The stack usage.
 *
 *  \context      OS_INTERNAL
