 ...
 *
 *  \file
 *  \brief        Compiler abstraction for Tasking compiler.
 *  \details
...
#define OS_HAL_COMPILER_TASKING_SOURCE
...
# include "Os_MemMap_OsCode.h"                                                                                           /* PRQA S 5087 */ /* MD_MSR_MemMap */
  ...
  __asm ("  .EXTERN OsCfg_Stack_KernelStacks");
  __asm ("  .EXTERN Os_Hal_UnhandledExc");
  __asm ("  .EXTERN Os_Hal_MemFault");
...
OS_FUNC_ATTRIBUTE_DEFINITION(void, OS_CODE, OS_HAL_NOINLINE, Os_Hal_UnhandledExceptionHandler, (void))
{
  ...
  __asm ("and  d14, d14, #7");                                      /* mask core ID */
  __asm ("movh.a a4, #@his(OsCfg_Stack_KernelStacks)");             /* get address of the correct kernal stack (indexed by core ID) */                                  /* PRQA S 0286 */ /* MD_Os_Hal_Dir1.1_0286 */
  __asm ("lea a4,[a4]@los(OsCfg_Stack_KernelStacks)");              /* get address of the correct kernal stack (indexed by core ID); A4 = &OsCfg_Stack_KernelStacks */  /* PRQA S 0286 */ /* MD_Os_Hal_Dir1.1_0286 */
...
# endif /* if defined (OS_CFG_COMPILER_TASKING) */
 ...
 */
/**********************************************************************************************************************
 *  END OF FILE: Os_Hal_Compiler_Tasking.c
 *********************************************************************************************************************/
