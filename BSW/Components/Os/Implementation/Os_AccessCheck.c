...
))
{
  ...
  addressStart = (Os_AccessCheckAddress)Address;                                                                        /* PRQA S 0306, 0326 */ /* MD_Os_Rule11.4_0306_AccessCheckTest, MD_Os_Rule11.6_0326 */ /* COMP_WARN_OS_CONV_PTR_TO_INT */
  ...
  {
    Os_AccessCheckIdx_IteratorType idx;
    ...
    for(idx = 0; idx < (Os_AccessCheckIdx_IteratorType) AccessRights->RegionCount; ++idx)                               /* FETA_OS_CONSTANTASFUNCTIONPARAMETER */
    {
...
{
  return (Os_StdReturnType)(OS_CFG_ACCESSCHECK == STD_ON);                                                              /* PRQA S 2995, 4304 */ /* MD_Os_Rule2.2_2995, MD_Os_C90BooleanCompatibility */
}
