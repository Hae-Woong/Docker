 ...
 **********************************************************************************************************************/
/*! \brief        Returns whether application access rights are stored in a array type (!0) or not (0).
 *  \details        --no details--
 *
 *  \retval       !0  Array type used.
 *  \retval       0   Integral type used.
 *
 *  \context      OS_INTERNAL
 *
 *  \reentrant    TRUE
 ...
 *  \param[in]    AppMask         The application bit mask.
 *  \param[in]    AccessMask      The mask to check.
 *
 *  \retval       !0   If access is granted.
 *  \retval       0    If access is denied.
 *
 *  \context      OS_INTERNAL
 *
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 *
 *  \pre          AppId has to be in valid range.
 *
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE Os_StdReturnType, OS_CODE, OS_ALWAYS_INLINE, Os_AppIsAccessAllowed,
(
