...
/*! Illegal access. Reported in: ErrorHook; in case of Peripheral APIs: ProtectionHook. */
# define E_OS_ACCESS                            ((StatusType)0x01)
/*! Invalid calling context. Reported in: ErrorHook; in case of Shutdown and Peripheral APIs: ProtectionHook. */
# define E_OS_CALLEVEL                          ((StatusType)0x02)
/*! Invalid OS object ID. Reported in: ErrorHook; in case of Peripheral APIs: ProtectionHook. */
# define E_OS_ID                                ((StatusType)0x03)
/*! Maximum task activations reached. Reported in: ErrorHook. */
# define E_OS_LIMIT                             ((StatusType)0x04)
/*! OS object is currently not in use. Reported in: ErrorHook. */
# define E_OS_NOFUNC                            ((StatusType)0x05)
/*! Scheduling requested with occupied resource. Reported in: ErrorHook. */
# define E_OS_RESOURCE                          ((StatusType)0x06)
/*! OS object is not in correct state to perform the requested operation. Reported in: ErrorHook. */
# define E_OS_STATE                             ((StatusType)0x07)
/*! Given value is out of the configured range. Reported in: ErrorHook. */
# define E_OS_VALUE                             ((StatusType)0x08)

/* ----- AUTOSAR OS ----- */
/*! Service can not be called. Reported in: ErrorHook. */
...
/*! Tasks terminates without a TerminateTask() or ChainTask() call. Reported in: ErrorHook. */
# define E_OS_MISSINGEND                        ((StatusType)0x0B)
/*! A service of the OS is called inside an interrupt disable/enable pair. Reported in: ErrorHook. */
# define E_OS_DISABLEDINT                       ((StatusType)0x0C)
/*! A stack fault detected via stack monitoring by the OS. Reported in: ProtectionHook. */
# define E_OS_STACKFAULT                        ((StatusType)0x0D)
/*! A memory access violation occurred. Reported in: ProtectionHook. */
# define E_OS_PROTECTION_MEMORY                 ((StatusType)0x0E)
/*! A Task/ISR2 exceeds its execution time budget. Repoted in: ProtectionHook. */
# define E_OS_PROTECTION_TIME                   ((StatusType)0x0F)
/*! A Task/ISR2 arrives before its timeframe has expired. Reported in: ProtectionHook. */
# define E_OS_PROTECTION_ARRIVAL                ((StatusType)0x10)
/*! A Task/Category 2 ISR blocks for too long. Reported in: ProtectionHook. */
# define E_OS_PROTECTION_LOCKED                 ((StatusType)0x11)
/*! A trap occurred. Reported in: ProtectionHook. */
# define E_OS_PROTECTION_EXCEPTION              ((StatusType)0x12)
/*! Deadlock situation due to interference. Reported in: ErrorHook. */
# define E_OS_INTERFERENCE_DEADLOCK             ((StatusType)0x13)
/*! Potential deadlock due to wrong nesting. Reported in: ErrorHook. */
# define E_OS_NESTING_DEADLOCK                  ((StatusType)0x14)
/*! De-scheduling with occupied spinlock. Reported in: ErrorHook. */
# define E_OS_SPINLOCK                          ((StatusType)0x15)
/*! Core is not available. Reported in: ErrorHook. */
# define E_OS_CORE                              ((StatusType)0x16)
/*! A null pointer was given as argument. Reported in: ErrorHook; in case of Peripheral APIs: ProtectionHook. */
# define E_OS_PARAM_POINTER                     ((StatusType)0x17)

/* ----- Vector Extensions ----- */
/*! The given functionality is not enabled in the configuration. Reported in: ErrorHook. */
# define E_OS_SYS_DISABLED                      ((StatusType)0xF1)
/*! The calling Task is not configured to participate in the given barrier. Reported in: ErrorHook. */
# define E_OS_SYS_NO_BARRIER_PARTICIPANT        ((StatusType)0xF2)
/*! Functionality is not implemented on this hardware. Reported in: ErrorHook. */
 ...
 *  Reported in: ErrorHook. */
# define E_OS_SYS_NO_NTFSTACK                   ((StatusType)0xF4)
/*! A buffer or value overflow occurred. Reported in: ErrorHook. */
# define E_OS_SYS_OVERFLOW                      ((StatusType)0xF5)
/*! Forcible termination of OS object requested. Reported in: ErrorHook. */
# define E_OS_SYS_KILL_KERNEL_OBJ               ((StatusType)0xF6)
/*! Application restart requested but no restarttask configured. Reported in: ErrorHook. */
# define E_OS_SYS_NO_RESTARTTASK                ((StatusType)0xF7)
/*! The current core may not send cross core calls to the target core. Reported in: ErrorHook. */
# define E_OS_SYS_CALL_NOT_ALLOWED              ((StatusType)0xF8)
/*! The triggered cross core function is not available on the target core. Reported in: ErrorHook. */
# define E_OS_SYS_FUNCTION_UNAVAILABLE          ((StatusType)0xF9)
/*! An unhandled syscall occurred. Reported in: ProtectionHook. */
# define E_OS_SYS_PROTECTION_SYSCALL            ((StatusType)0xFA)
/*! An unhandled interrupt occurred. Reported in: ProtectionHook. */
# define E_OS_SYS_PROTECTION_IRQ                ((StatusType)0xFB)
/*! Wrong API usage. Reported in: ProtectionHook. */
# define E_OS_SYS_API_ERROR                     ((StatusType)0xFC)
/*! Internal OS assertion. Never reported. */
# define E_OS_SYS_ASSERTION                     ((StatusType)0xFD)
/*! A job could not be done in time. Reported in: ErrorHook. */
# define E_OS_SYS_OVERLOAD                      ((StatusType)0xFE)
/*! An OS internal functionality could not be done in time. Reported in: ErrorHook. */
# define E_OS_SYS_TIMEOUT                       ((StatusType)0xFF)
...
typedef enum
{
  ...
  OSServiceId_ActivateTaskAsyn            = 0x33u,  /*!< ActivateTaskAsyn() */
  OSServiceId_SetEventAsyn                = 0x34u,  /*!< SetEventAsyn() */
  ...
  OSServiceId_GetCoreStartState           = 0xC0u,  /*!< Os_GetCoreStartState() */
  OSServiceId_GetNonTrustedFunctionStackUsage = 0xC1u,  /*!< Os_GetNonTrustedFunctionStackUsage() */
  OSServiceId_FrtSetFutureCompareValue    = 0xC2u,  /*!< Os_TimerFrtSetFutureCompareValue() */
  OSServiceId_FrtSetCompareValue          = 0xC3u,  /*!< Os_TimerFrtSetCompareValue() */
  OSServiceId_GetInitHookStackUsage       = 0xC4u,  /*!< Os_GetInitHookStackUsage() */
...
typedef enum
{
   ...
   * \details This value may only be returned in memory protected systems. As this error is hard to detect,
   *          it is handled by the Protection Hook and so E_OS_ILLEGAL_ADDRESS will never be returned by any function.*/
  ...
  /*! A Task/ISR exceeds its execution time budget. Reported in: ProtectionHook. */
  OS_STATUS_PROTECTION_TIME                   = E_OS_PROTECTION_TIME,
  /*! A Task/ISR arrives before its time frame has expired. Reported in: ProtectionHook. */
  ...
  /* ----- Vector Extensions ----- */
  /*! Forcible termination of kernel object requested. Reported in: ErrorHook. */
  OS_STATUS_KILL_KERNEL_OBJ                   = E_OS_SYS_KILL_KERNEL_OBJ,
  /*! Application restart requested but no restart task configured. Reported in: ErrorHook. */
  ...
  /*! The triggerd cross core function is not available on the target core. Reported in: ErrorHook. */
  OS_STATUS_FUNCTION_UNAVAILABLE              = E_OS_SYS_FUNCTION_UNAVAILABLE,
  /*! A buffer or value overflow occurred. Reported in: ErrorHook. */
  OS_STATUS_OVERFLOW                          = E_OS_SYS_OVERFLOW,

  /*! Invalid calling context. Reported in: ErrorHook. */
  ...
  /*! No access for object given in parameter 1. Reported in: ErrorHook; in case of Peripheral APIs: ProtectionHook. */
  OS_STATUS_ACCESSRIGHTS_1                    = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 1u)),
  /*! No access for object given in parameter 2. Reported in: ErrorHook. */
  OS_STATUS_ACCESSRIGHTS_2                    = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 2u)),
  /*! Application state for object given in parameter 1 is not accessible. Reported in: ErrorHook. */
  OS_STATUS_NOTACCESSIBLE_1                   = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 3u)),
  /*! Application state for object given in parameter 2 is not accessible. Reported in: ErrorHook. */
  OS_STATUS_NOTACCESSIBLE_2                   = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 4u)),
  /*! ID given in parameter 1 does not belong to an extended task. Reported in: ErrorHook. */
  OS_STATUS_NOEXTENDEDTASK_1                  = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 5u)),
  /*! ID given in parameter 2 does not belong to an extended task. Reported in: ErrorHook. */
  OS_STATUS_NOEXTENDEDTASK_2                  = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 6u)),
  /*! The caller is not an extended task. Reported in: ErrorHook. */
  OS_STATUS_NOEXTENDEDTASK_CALLER             = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 7u)),
  /*! The given lock is already locked. Reported in: ErrorHook. */
  OS_STATUS_LOCKED                            = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 8u)),
  /*! The given object has an invalid priority. Reported in: ErrorHook. */
  OS_STATUS_PRIORITY                          = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 9u)),
  /*! The caller is not the owner of the accessed object in parameter 1. Reported in: ErrorHook. */
  OS_STATUS_NOT_THE_OWNER_1                   = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 10u)),
  /*! ID given in parameter 1 is invalid. Reported in: ErrorHook; in case of Peripheral APIs: ProtectionHook. */
  OS_STATUS_ID_1                              = (OS_STATUS_TYPE_VARIANT(E_OS_ID, 1u)),
  /*! ID given in parameter 2 is invalid. Reported in: ErrorHook. */
  OS_STATUS_ID_2                              = (OS_STATUS_TYPE_VARIANT(E_OS_ID, 2u)),
  /*! Type given in parameter 1 is invalid. Reported in: ErrorHook. */
  OS_STATUS_ID_TYPE_1                         = (OS_STATUS_TYPE_VARIANT(E_OS_ID, 3u)),
  /*! Type given objects are assigned to different counters. Reported in: ErrorHook. */
  OS_STATUS_ID_DIFFERENT_COUNTER              = (OS_STATUS_TYPE_VARIANT(E_OS_ID, 4u)),
  /*! Type given objects have different synchronization types. Reported in: ErrorHook. */
  OS_STATUS_ID_DIFFERENT_SYNC                 = (OS_STATUS_TYPE_VARIANT(E_OS_ID, 5u)),
  /*! The requested hook is not available. Reported in: ErrorHook. */
  OS_STATUS_HOOK_NOT_AVAILABLE                = (OS_STATUS_TYPE_VARIANT(E_OS_ID, 6u)),
  /*! OS object is currently unlocked. Reported in: ErrorHook. */
  OS_STATUS_UNLOCKED                          = (OS_STATUS_TYPE_VARIANT(E_OS_NOFUNC, 1u)),
  /*! OS object given in parameter 1 is currently not in use. Reported in: ErrorHook. */
  OS_STATUS_NOFUNC_1                          = (OS_STATUS_TYPE_VARIANT(E_OS_NOFUNC, 2u)),
  /*! OS object given in parameter 2 is currently not in use. Reported in: ErrorHook. */
  OS_STATUS_NOFUNC_2                          = (OS_STATUS_TYPE_VARIANT(E_OS_NOFUNC, 3u)),
  /*! OS object given in parameter 1 is currently not in use. Reported in: ErrorHook. */
  OS_STATUS_SPINLOCK_ORDER                    = (OS_STATUS_TYPE_VARIANT(E_OS_NOFUNC, 4u)),
  /*! OS object given in parameter 1 is currently stopped. Reported in: ErrorHook. */
  OS_STATUS_STOPPED_1                         = (OS_STATUS_TYPE_VARIANT(E_OS_NOFUNC, 5u)),
  /*! OS object given in parameter 2 is currently not stopped. Reported in: ErrorHook. */
  OS_STATUS_NOT_STOPPED_2                     = (OS_STATUS_TYPE_VARIANT(E_OS_NOFUNC, 6u)),
  /*! OS object given in parameter 1 is currently nexted. Reported in: ErrorHook. */
  OS_STATUS_NEXTED_1                          = (OS_STATUS_TYPE_VARIANT(E_OS_NOFUNC, 7u)),
  /*! Operation not permitted when killing is disabled. Reported in: ErrorHook. */
  OS_STATUS_KILLING_IS_DISABLED               = (OS_STATUS_TYPE_VARIANT(E_OS_NOFUNC, 8u)),
  /*! OS object is accessed in the wrong order. Reported in: ErrorHook. */
  OS_STATUS_ORDER                             = (OS_STATUS_TYPE_VARIANT(E_OS_NOFUNC, 9u)),
  /*! OS object is not in correct state to perform the requested operation. Reported in: ErrorHook. */
  OS_STATUS_STATE_1                           = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 1u)),
  /*! OS object is not in correct state to perform the requested operation. Reported in: ErrorHook. */
  OS_STATUS_STATE_2                           = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 2u)),
  /*! OS object is in stopped state and not allowed to perform the requested operation. Reported in: ErrorHook. */
  OS_STATUS_STATE_STOPPED                     = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 3u)),
  /*! OS object is in running state and not allowed to perform the requested operation. Reported in: ErrorHook. */
  OS_STATUS_STATE_RUNNING                     = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 4u)),
  /*! OS object is in next state and not allowed to perform the requested operation. Reported in: ErrorHook. */
  OS_STATUS_STATE_NEXTED                      = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 5u)),
  /*! OS object is in waiting state and not allowed to perform the requested operation. Reported in: ErrorHook. */
  OS_STATUS_STATE_WAITING                     = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 6u)),
  /*! The current application is not in the restarting state. Reported in: ErrorHook. */
  OS_STATUS_STATE_NO_RESTART                  = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 7u)),
  /*! Termination requested for an application which is already terminated. Reported in: ErrorHook. */
  OS_STATUS_STATE_ALREADY_TERMINATED          = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 8u)),
  /*! The application is restarting AND the caller does not belong to the application. Reported in: ErrorHook. */
  OS_STATUS_STATE_RESTARTING_NO_MEMBER        = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 9u)),
  /*! Restart requested for an application which is already restarting. Reported in: ErrorHook. */
  OS_STATUS_STATE_ALREADY_RESTARTING          = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 10u)),
  /*! Value given in parameter 1 is zero. Reported in: ErrorHook. */
  OS_STATUS_VALUE_IS_ZERO_1                   = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 1u)),
  /*! Value given in parameter 2 is zero. Reported in: ErrorHook. */
  OS_STATUS_VALUE_IS_ZERO_2                   = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 2u)),
  /*! Value given in parameter 1 is to high. Reported in: ErrorHook. */
  OS_STATUS_VALUE_IS_TOO_HIGH_1               = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 3u)),
  /*! Value given in parameter 2 is to high. Reported in: ErrorHook. */
  OS_STATUS_VALUE_IS_TOO_HIGH_2               = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 4u)),
  /*! Value given in parameter 3 is to high. Reported in: ErrorHook. */
  OS_STATUS_VALUE_IS_TOO_HIGH_3               = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 5u)),
  /*! Value given in parameter 1 is out of bounds. Reported in: ErrorHook. */
  OS_STATUS_VALUE_IS_OUT_OF_BOUNDS_1          = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 6u)),
  /*! Value given in parameter 2 is out of bounds. Reported in: ErrorHook. */
  OS_STATUS_VALUE_IS_OUT_OF_BOUNDS_2          = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 7u)),
  /*! Value given in parameter 1 is to low. Reported in: ErrorHook. */
  OS_STATUS_VALUE_IS_TOO_LOW_1                = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 8u)),
  /*! Value given in parameter 2 is to low. Reported in: ErrorHook. */
  OS_STATUS_VALUE_IS_TOO_LOW_2                = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 9u)),
  /*! Value given in parameter 3 is to low. Reported in: ErrorHook. */
  OS_STATUS_VALUE_IS_TOO_LOW_3                = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 10u)),
  /*! Value given in parameter 2 has to be TRUE or FALSE. Reported in: ErrorHook. */
  OS_STATUS_VALUE_IS_NOT_BOOLEAN              = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 11u)),
  /*! The data passed to the receiver of a cross core request is invalid. Reported in: ErrorHook. */
  OS_STATUS_CORE_CROSS_DATA                   = (OS_STATUS_TYPE_VARIANT(E_OS_CORE, 1u)),
  /*! Pointer given in parameter 1 is null. Reported in: ErrorHook. */
  OS_STATUS_PARAM_POINTER_1                   = (OS_STATUS_TYPE_VARIANT(E_OS_PARAM_POINTER, 1u)),
  /*! Pointer given in parameter 2 is null. Reported in: ErrorHook; in case of Peripheral APIs: ProtectionHook. */
  OS_STATUS_PARAM_POINTER_2                   = (OS_STATUS_TYPE_VARIANT(E_OS_PARAM_POINTER, 2u)),
  /*! Pointer given in parameter 3 is null. Reported in: ErrorHook. */
  ...
  /*! Not enough Non-Trusted Function stacks configured for the caller application. Reported in: ErrorHook. */
  OS_STATUS_NO_NTFSTACK_APPLIMIT_EXCEEDED     = (OS_STATUS_TYPE_VARIANT(E_OS_SYS_NO_NTFSTACK, 2u)),
  /*! Hardware does not support to clear an interrupt pending flag. Reported in: ErrorHook. */
  OS_STATUS_UNIMPLEMENTED_CLEARPENDING        = (OS_STATUS_TYPE_VARIANT(E_OS_SYS_UNIMPLEMENTED_FUNCTIONALITY, 1u)),
  /*! The functionality of exception context manipulation is not implemented for this hardware. Reported in: ErrorHook. */
  ...
  /*! Stack Usage Measurement is not enabled in the configuration. Reported in: ErrorHook. */
  OS_STATUS_STACKUSAGE_DISABLED_BY_CONFIG     = (OS_STATUS_TYPE_VARIANT(E_OS_SYS_DISABLED, 1u)),
  /*! Event is not enabled in the configuration. Reported in: ErrorHook. */
  OS_STATUS_EVENT_DISABLED_BY_CONFIG          = (OS_STATUS_TYPE_VARIANT(E_OS_SYS_DISABLED, 2u)),
  /*! XSignal is not enabled in the configuration. Reported in: ErrorHook. */
  OS_STATUS_XSIGNAL_DISABLED_BY_CONFIG        = (OS_STATUS_TYPE_VARIANT(E_OS_SYS_DISABLED, 3u)),

  /*! The compare value of the timer could not be set to a future value. Reported in: ErrorHook. */
  OS_STATUS_FRT_NO_FUTURE_VALUE               = E_OS_SYS_TIMEOUT,
  /*! The compare value could not be written to the hardware register. Reported in: ErrorHook. */
  OS_STATUS_FRT_SET_COMPARE_VALUE_FAILED      = (OS_STATUS_TYPE_VARIANT(E_OS_SYS_TIMEOUT, 1u))

} Os_StatusType;

/*!
 *  \brief  Statuses for panic hook calls.
 *  \trace  CREQ-133061
 */
typedef enum
{
  /*! Assertion failed. */
  OS_STATUS_PANIC_ASSERTION,
  /*! The given hook reference is null (hook initialization). */
  OS_STATUS_PANIC_CORE_INIT_HOOK_NULL,
  /*! A protection exception occurred and the user critical section is active. */
  OS_STATUS_PANIC_EXC_ERR_CRITICAL_SECTION,
  /*! A protection exception occurred and the OS is potentially in an inconsistent state. */
  OS_STATUS_PANIC_EXC_ERR_INSIDE_OS,
  /*! Activation of the restart task of an application failed. */
  OS_STATUS_PANIC_FAILED_RESTARTTASK_ACTIVATION,
  /*! The functionality is not available. */
  OS_STATUS_PANIC_FUNCTIONALITY_NOT_AVAILABLE,
  /*! Hook nesting is not allowed. */
  OS_STATUS_PANIC_HOOK_NESTING,
  /*! The given index of an interrupted thread is invalid. */
  OS_STATUS_PANIC_INTERRUPTED_THREADS_INVALID_IDX,
  /*! Too many interrupted threads. */
  OS_STATUS_PANIC_INTERRUPTED_THREADS_OVERFLOW,
  /*! No interrupted thread exists. */
  OS_STATUS_PANIC_INTERRUPTED_THREADS_UNDERFLOW,
  /*! The overall app mode is invalid. */
  OS_STATUS_PANIC_INVALID_APP_MODE,
  /*! The core activation state is invalid. */
  OS_STATUS_PANIC_INVALID_CORE_STATE,
  /*! The type of the current thread is invalid. */
  OS_STATUS_PANIC_INVALID_CURRENT_TYPE,
  /*! The type of the next thread is invalid. */
  OS_STATUS_PANIC_INVALID_NEXT_TYPE,
  /*! The next run reason is invalid. */
  OS_STATUS_PANIC_INVALID_TASK_NEXTRUNREASON,
  /*! The state of the current task is invalid. */
  OS_STATUS_PANIC_INVALID_TASK_STATE,
  /*! Protection reaction verification: No responsible application was found. */
  OS_STATUS_PANIC_KILLING_NO_RESPONSIBLE_APPLICATION,
  /*! Protection reaction verification: No responsible thread was found. */
  OS_STATUS_PANIC_KILLING_NO_RESPONSIBLE_THREAD,
  /*! Protection reaction: Task/ISR could not be terminated. */
  OS_STATUS_PANIC_KILLING_NO_TASK_OR_ISR,
  /*! A memory fault occurred but the OS is configured for the interrupt only use case. */
  OS_STATUS_PANIC_MEMFAULT,
  /*! Shutdown hook nesting is not allowed. */
  OS_STATUS_PANIC_NESTED_SHUTDOWN,
  /*! The core has not been started as an AUTOSAR core. */
  OS_STATUS_PANIC_NON_ASR_STARTED,
  /*! The default case of a switch/case statement was reached. */
  OS_STATUS_PANIC_SWITCH_CASE_DEFAULT,
  /*! The TP ISR was killed. */
  OS_STATUS_PANIC_TP_ISR_KILLED,
  /*! Code should not be reached. */
  OS_STATUS_PANIC_UNEXPECTED_CONTROL_FLOW,
  /*! An unhandled exception occurred but the OS is configured for the interrupt only use case. */
  OS_STATUS_PANIC_UNHANDLEDEXC,
  /*! Invalid self termination. */
  OS_STATUS_PANIC_INVALID_SUICIDE,
  /*! No pre-start task is configured. */
  OS_STATUS_PANIC_NO_PRESTARTTASK,
  /*! Faulty use of the OS API. */
  OS_STATUS_PANIC_OS_API_USAGE,
  /*! Unexpected control flow inside an unhandled interrupt request. */
  OS_STATUS_PANIC_UNEXPECTED_CONTROL_FLOW_IRQ,
  /*! Unexpected control flow inside an unhandled system call. */
  OS_STATUS_PANIC_UNEXPECTED_CONTROL_FLOW_SYSCALL,
  /*! Return from shutdown hook. */
  OS_STATUS_PANIC_SHUTDOWNHOOK_RETURN
} Os_PanicStatusType;
...
/*! \brief The start state type of a AUTOSAR or Non-AUTOSAR core.
 *  \details The start of a core can be requested by the API \ref StartCore() or \ref StartNonAutosarCore().
 *           The start state of a core can be requested by the API \ref Os_GetCoreStartState().
 *           A core is in state OS_CORESTARTSTATE_STARTED_ASR after the call of Os_Init().
 *           The state OS_CORESTARTSTATE_STARTED_NONASR can only be determined for a Non-AUTOSAR master core.
 */
typedef enum
{
  /*! The start of core has not been requested. */
  OS_CORESTARTSTATE_START_UNREQUESTED = 0,
  /*! The start of AUTOSAR core has been requested. */
  OS_CORESTARTSTATE_START_REQUESTED_ASR,
  /*! The start of non-AUTOSAR core has been requested. */
  OS_CORESTARTSTATE_START_REQUESTED_NONASR,
  /*! The AUTOSAR core has been started. */
  OS_CORESTARTSTATE_STARTED_ASR,
  /*! The non-AUTOSAR core has been started. */
