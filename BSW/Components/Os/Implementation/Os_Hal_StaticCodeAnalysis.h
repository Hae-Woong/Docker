...
/*! \brief VM Id for MSSV test CM_OS_BETA_FEATURE_VIRTUALIZATION_M */
# ifndef OS_CFG_VIRTUAL_MACHINE_ID                                                                                      /* COV_OS_DERIVATIVEBETAMODULE */
#  define OS_CFG_VIRTUAL_MACHINE_ID (1000uL)
# endif
 ...
 *  \pre           -
 */
# define Os_Hal_Mfcr(x)           Os_Hal_DummyRead(x)
 ...
 *  \pre           -
 */
# define Os_Hal_Mtcr(x, y)        (void)Os_Hal_DummyRead(y)
 ...
 *  \pre           -
 */
# define Os_Hal_Clz(x)            Os_Hal_DummyRead(x)
 ...
 *  \pre           -
 */
# define Os_Hal_Mta11(x)          (void)Os_Hal_DummyRead(x)
 ...
 *  \pre           -
 */
# define Os_Hal_Mta10(x)          (void)Os_Hal_DummyRead(x)
 ...
 *  \pre           -
 */
# define Os_Hal_Mta8(x)           (void)Os_Hal_DummyRead(x)
 ...
 *  \pre           -
 */
# define Os_Hal_Mta9(x)           (void)Os_Hal_DummyRead(x)
 ...
 *  \pre           -
 */
# define Os_Hal_Mta0(x)           (void)Os_Hal_DummyRead(x)
 ...
 *  \pre           -
 */
# define Os_Hal_Mta1(x)           (void)Os_Hal_DummyRead(x)
 ...
 *  \pre           -
 */
# define Os_Hal_Mta2(x)           (void)Os_Hal_DummyRead(x)
 ...
 *  \pre           -
 */
# define Os_Hal_Mta4(x)           (void)Os_Hal_DummyRead(x)
...
/*! \brief         Abstraction of user defined exception entry class 3.
 *  \details       This macro is defined as empty on purpose for MISRA and ReviewHelper
 *                 analysis.
 *  \param[in]     core       On which core the entry is registered.
 *  \param[in]     class      For which class the entry is registered.
...
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE uint32, OS_CODE, OS_ALWAYS_INLINE, Os_Hal_DummyRead, (uint32 x))           /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
{
  ...
  dummy = x;
  while(dummy == 0uL)                                                                                                   /* FETA_OS_HAL_DUMMYREAD */
  {
    ;
  }
  return dummy;
