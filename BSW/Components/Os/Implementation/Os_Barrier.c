 ...
 *  Os_BarrierGetAttendeeDyn()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE P2VAR(Os_BarrierBaseType volatile, AUTOMATIC, OS_VAR_NOINIT),              /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
OS_CODE, OS_ALWAYS_INLINE, Os_BarrierGetAttendeeDyn,
(
  P2CONST(Os_BarrierBaseConfigType, AUTOMATIC, OS_VAR_NOINIT) Barrier,
  Os_BarrierAttendeeIdxType AttendeeIdx
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_BarrierCounterType,  OS_CODE, OS_ALWAYS_INLINE,                         /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
Os_BarrierGetLowestCounter,
(
  P2CONST(Os_BarrierBaseConfigType, AUTOMATIC, OS_VAR_NOINIT) Barrier
))                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
  ...
  P2CONST(Os_BarrierBaseType volatile, AUTOMATIC, OS_VAR_NOINIT) attendee;

  /* #10 Initial result is 0. */
  result = 0;

  /* #20 Iterate over all attendees. */
  for(attendeeIdx = 0; attendeeIdx < (Os_BarrierAttendeeIdx_IteratorType) Barrier->AttendeeCount; ++attendeeIdx)        /* FETA_OS_CONSTANTASFUNCTIONPARAMETER */
  {
  ...
  for(; attendeeIdx < (Os_BarrierAttendeeIdx_IteratorType) Barrier->AttendeeCount; ++attendeeIdx)                       /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* FETA_OS_CONSTANTASFUNCTIONPARAMETER */
  {
    attendee = Os_BarrierGetAttendeeDyn(Barrier, (Os_BarrierAttendeeIdxType) attendeeIdx);                              /* SBSW_OS_FC_PRECONDITION */
 ...
 *  Os_BarrierCheckId()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_StdReturnType, OS_CODE, OS_ALWAYS_INLINE,                               /* COV_OS_TESTSUITEOSC4998 */
Os_BarrierCheckId,
(
  Os_BarrierIdType BarrierId
...
)
{
  if(Os_CoreIsSingleAsrCoreOs() == 0u)                                                                                  /* PRQA S 2991, 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
  {
    ...
    do                                                                                                                  /* FETA_OS_BARRIERSYNCHRONIZE */
    {
      synchronized = TRUE;                                                                                              /* PRQA S 4404 */ /* MD_Os_C90BooleanCompatibility */
    ...
    } while (synchronized == FALSE);                                                                                    /* PRQA S 4404, 1881 */ /* MD_Os_C90BooleanCompatibility, MD_Os_C90BooleanCompatibility */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
  }
}
...
FUNC(Os_StatusType, OS_CODE) Os_Api_BarrierSynchronize
(
  Os_BarrierIdType BarrierID
)
{
...
\CM CM_OS_BARRIER_USERBARRIERTASKPTR_M
        Verify that TaskPtr is a non NULL_PTR for user defined barriers.
