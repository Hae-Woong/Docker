...
#------------------------------------------------------------------------------
# 1.00.00   2012-04-26  Mdr     Creation
# 1.00.01   2018-06-25  srk     fixed case sensitivity of generated files
...
LIBRARIES_TO_BUILD      += FrNm
FrNm_FILES              = FrNm$(BSW_SRC_DIR)\FrNm.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += FrNm$(BSW_SRC_DIR)\FrNm.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\FrNm_Cfg.c $(GENDATA_DIR)\FrNm_Lcfg.c $(GENDATA_DIR)\FrNm_PBcfg.c
