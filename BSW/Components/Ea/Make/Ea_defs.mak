...
# REVISION HISTORY
#------------------------------------------------------------------------------
# Refer to the Ea_rules.mak file.
############################################################################### 
...
EA_CORE_PATH       =   $(SSC_ROOT)\Ea


# e.g.: CAN_OUTPUT_PATH = $(GENDATA_DIR)


EA_OUTPUT_PATH     =  $(GENDATA_DIR)
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     +=  $(EA_CORE_PATH)  $(EA_OUTPUT_PATH)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
