 ...
 *
 */
FUNC (uint16, EA_PUBLIC_CODE) EaBh_GetPartitionIndex(uint16 BlockNumber)
{
  return Ea_BlockConfigList[EaBh_GetBlockIndex(BlockNumber)].PartitionIndex;
}
