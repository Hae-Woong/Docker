 ...
 *                                                        layer are invoked
 *  3.03.00     2018-01-29  virbka         ESCAN00098119  Improvement of Block searching in a partition
 *              2019-07-18  virbka, virbmz MWDG-65        Implementation - MISRA 2012 compliance
 *  3.03.01     2019-08-06  virbka         MWDG-62        EA shall reduce write cycles by optimization of the Task
 *                                                        Manager behaviour
 *  3.03.02     2021-03-18  virbka         -              Update due to updated Misra analyzer findings
 *  3.03.03     2021-04-27  virbka         ESCAN00109148  Eeprom Abstraction (EA) will return job Result
 *                                                        MEMIF_JOB_INVALID instead of MEMIF_BLOCK_INCONSISTENT
 *                                                        in unlikely constellation
 *              2021-05-12  virbmz         MWDG-33        Ea Improvements
 *  4.00.00     2022-07-22  virbka         MWDG-5694      Generate Ea_MemMap.h
 *********************************************************************************************************************/
