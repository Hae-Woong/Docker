 ...
 *  21.00.00  2020-12-21  vismij
 *                        visssg  COM-1848      Introduce Com Units
 ...
 *  22.00.00  2021-01-16  visssg  COM-2215      Support a ComIPdu references to a MainFunction
 *  22.01.00  2021-02-24  vismij  COM-2319      Merge Signal Gateway according ASR 4.3 with Multicore trunk
 *  22.02.00  2021-03-09  visssg
 *                        vismij
 *                        viscpe  COM-1849      Implement Com Multipartition - without Signal Gateway
 *  22.03.00  2021-04-09  visbbk  COM-2523      Remove ComDescriptionRoutingCodeGeneration
 *            2021-04-09  visssg
 *                        visbbk
 *                        viscpe
 *                        vismij  COM-2526      Basic Refactorings for MC Signal Gateway
 *            2021-04-16  viscpe  ESCAN00109118 Compiler error: Compiler error: Identifier not declared
 *            2021-04-26  visbbk  COM-2458      Remove Com_IpduGroupControl
 *            2021-04-29  visssg  COM-2544      PRQA This 'if' controlling expression is a constant expression and its value is 'true'
 *            2021-04-29  visssg  COM-2520      Support only I-PDU Callouts with PduInfoPtr
 *  23.00.00  2021-09-06  visssg
 *                        vismij
 *                        visbbk
 *                        viscpe  COM-1851      Implement Multipartition Com - Description Routing
 *            2021-10-05  visbbk  ESCAN00110352 Com_InvalidateShadowSignal() isn't working
 *            2021-10-06  visbbk  ESCAN00110380 Compiler error: undeclared identifier COM_MINPROCGWBUFFER<ApplType>_MINPROCGWBUFFEROFRXACCESSINFO
 *            2021-10-15  visssg  ESCAN00110483 ComDescriptionGateway isn't working as intended
 *            2021-11-02  visbbk  ESCAN00110347 Compiler error: undeclared identifier COM_CONSTVALUE<APPL_TYPE>_INVVALUEOFRXACCESSINFO
 *            2021-11-17  vismij
 *                        visbbk
 *                        visssg  COM-2885      Implement Multipartition Com - Signal Gateway
 *  24.00.00  2022-03-25  viscpe  ESCAN00111562 Compiler warning: Conversion from Com_RxSigGrpInfoIndStartIdxOfRxPduInfoType to Com_RxSigGrpInfoIterType, possible loss of data
 *                        visbbk  ESCAN00111573 Compiler warning: Conversion from Com_RxSigGrpInfoIndStartIdxOfRxPduInfoType to Com_RxSigGrpInfoIndIterType, possible loss of data
 *            2022-03-31  visssg  COM-3284      Design and Implementation of Lower Layer Reception Units (If and Tp)
 *            2022-04-12  vishho  COM-3430      Design and Implementation of a Generic Timer Unit
 *            2022-04-12  vishho  COM-3520      Design and Implementation of a Generic ISR Threshold Counter
 *            2022-05-25  visssg  COM-3178      Design and Implementation of a Generic Filter Unit
 *            2022-05-25  visssg  COM-3208      Design and Implementation of a Rx Invalidation Unit
 *            2022-05-25  visssg  COM-3212      Design and Implementation of a Tx Buffer Unit
 *            2022-05-25  vismvi  COM-3250      Design and Implementation of a Serializer Unit
 *            2022-05-25  visssg  COM-3396      Design and Implementation of Reception Processing Units
 *            2022-05-25  vismvi  COM-3410      Design and Implementation of a Deserializer Unit
 *            2022-05-25  visssg  COM-3415      Design and Implementation of Reception Filtering Unit
 *            2022-05-25  visssg  COM-3442      Design and Implementation of Transmission Filtering Unit
 *            2022-05-25  visssg  COM-3152      Use CompileTimeChecking where Necessary
 *            2022-05-25  visssg  COM-3527      Design and Implementation of a Tx Invalidation Unit
 *            2022-06-01  viscpe  COM-3203      Design and Implementation of a Reporting Unit
 *            2022-06-01  viscpe  COM-3422      Design and Implementation of Signal Interface Units
 *            2022-06-01  viscpe  COM-3426      Design and Implementation of a Initialization Unit
 *            2022-06-01  vishho  COM-3534      Design and Implementation of a Tx Pdu Processing
 *            2022-06-30  viscpe  ESCAN00111847 Compiler error: undeclared identifier COM_FILTERINFO_<ApplType>_FILTERINFOOFRXACCESSINFO
 *            2022-07-29  visssg  COM-3306      Design and Implementation of a General Unit
 *            2022-07-29  viscpe  COM-3281      Design and Implementation of a Caching Unit
 *            2022-07-29  visbbk  COM-3578      Design and Implementation of a Rx Buffer Unit
 *            2022-07-29  visbbk  COM-3852      Design and Implementation of TxSigIf and TxSigGrpIf Unit
 *            2022-08-11  viscpe  ESCAN00112557 Wrong datatype Com_GwSigGrpMappingIterType is used (type is too small).
 *            2022-08-17  viscpe  ESCAN00090831 Compiler warning: integer conversion resulted in a change of sign
 *                                ESCAN00109554 MISRA deviation: MISRA-C:2012 Rule 1.3 in Com.c
 *                                ESCAN00110188 Compiler warning: left and right operands are identical
 *                                ESCAN00111013 PduR_ComCancelTransmit is not called for normal Pdus on Tx Timeout
 *                                ESCAN00111201 unresolved external symbol Com_RxInv_Sig_<ApplType>_EvaluateInvalidValue
 *            2022-08-30  visssg  ESCAN00112689 Com_SwitchIpduTxMode() in combination with ALWAYS/NEVER filters does not change TransmissionMode
 *            2022-09-27  vishho  COM-3981      Do Misra Analysis
 *            2022-09-28  viscpe  ESCAN00113172 Rx pdus are stored in a DeferredEventCache of an incorrect partition/mainfunction after an overflow occurred
 *                                ESCAN00113246 Rx pdus are stored in a DeferredEventCache of an incorrect partition/mainfunction
 *  24.01.00  2022-11-02  viscpe  COM-3141      Perform FETA Analysis and Implement Measures
 *            2022-11-22  visssg  ESCAN00113266 Reception of zero byte Tp Pdus is not working
 *            2022-12-16  visssg  ESCAN00113454 Calling Com_Init twice initializes the Com twice
 *            2023-01-12  vishho
 *                        visbbk  COM-1008      Replace RH by VCA
 *            2023-02-01  visaol  COM-4131      Use IterType instead of SizeOf when casting from IdType
 *            2023-02-01  visbbk  COM-4160      [TC:Standard_Embedded.CheckQAC9] shall be green in TestReport.html
 *            2023-02-01  visbbk  COM-4148      CT_Components/Il/Il_AsrComCfg5 Test2020 no VCA MSVC shall be green in TestReport.html
 *            2023-02-01  visaol  COM-4071      [TC:Standard_Embedded.VariantCoverage] shall be green in TestReport.html
 *            2023-02-01  visssg  COM-4168      fix implicit fallthrouh in Com_LLRxTp.c and Com_LLTxTp.c
 *            2023-02-01  visssg  COM-4102      Use PP switch COM_STRICT_REPETITION_PERIOD for Com_Repetition_ResetRepCycle in declaration and definition
 *            2023-02-01  visssg  COM-4104      Use PP switch CPU_BYTE_ORDER in the unit ComUtil in declaration and definition of LE and BE specfific functions
 *            2023-02-01  visssg  COM-4108      Use PP switch COM_USE_INIT_POINTER for Com_Reporting_CallBswErrorHook in declaration and definition
 *            2023-02-01  visssg  COM-4106      Remove unused API Com_Timer_StartCounterWithValue
 *            2023-02-01  visssg  COM-4114      Use PP switch COM_DEV_ERROR_DETECT for Com_LLRxTp_IsRxTpBufferMetaDataUsed/Com_LLRxTp_GetRxTpBufferMetaDataLength in declaration and definition
 *            2023-02-10  cta     CARC-3414     COM: VCA add justifications
 *            2023-02-08  vishho
 *                        visbbk  COM-1008      Replace RH by VCA
 *            2023-02-13  vishho  COM-3816      Do not support BIG_ENDIAN CPU_BYTE_ORDER == HIGH_BYTE_FIRST
 *            2023-02-13  vishho  COM-3916      Do not support Gateway
 *            2023-02-14  visssg
 *                        vadgsz
 *                        vadnra  COM-4037      RMW Analysis
 *  25.00.00  2023-03-14  visssg ESCAN00113973  Wrong data can be routed in the signal gateway across partitions
 *            2023-03-16  visssg ESCAN00113762  Alignment issue in Com_TxSignal_EvaluateFilter leads to Memory Exception
 *            2023-03-20  visssg COM-4441       Refactor SignalGateway
 *            2023-03-21  oalka  COM-4261       Use custom type to store void pointer and length
 *            2023-03-24  oalka  COM-4172       Use const pointer types
 *            2023-03-28  oalka  COM-4444       Refactor DescriptionGateway
 *            2023-04-06  oalka  COM-4365       Support FIFO behavior in the event cache
 *            2023-04-17  visssg COM-4335       Re-evaluate usage of Logical Units
 *            2023-04-26  vadnra COM-4525       Support verification of CprQueue indices
 *            2023-04-27  vadgsz COM-4502       Refactor DescriptionGateway
 *            2023-05-04  visssg COM-3820       Support BIG_ENDIAN CPU_BYTE_ORDER == HIGH_BYTE_FIRST
 *            2023-05-09  visssg ESCAN00114579  Wrong datatype ComCom_MainFunctionTxStructIterType is used in Com_Notifications_MainFunctionTx (type is too small).
 *            2023-05-15  oalka  COM-4411       Use BitCopy in DescrciptionGateway
 *            2023-05-25  vadnra ESCAN00114718  Wrong datatype Com_PartitionsAlwaysActiveRxComIPdusStructIterType is used (type is too small)
 *            2023-05-30  oalka  COM-4498       Use VstdLib BitCopy
 *            2023-06-27  visssg ESCAN00114967  Gateway Event Cache overflows
 *            2023-06-28  visssg
 *                        vismvi COM-4607       Deserializer Unit: Reduce complexity of Sign Extension
 *            2023-07-20  vadgsz ESCAN00115002  Endless loop in the com multi partition gateway.
 *            2023-08-04  visssg ESCAN00113810  Timeout monitoring is stopped on a call to Com_SwitchIpduTxMode() for pdus with a configured ComTxModeTimeOffset
 *            2023-08-08  visssg COM-2790       Support Com_MemMap.h
 *            2023-08-14  visssg ESCAN00115367  Endless loop in the com multi partition signal gateway
 *            2023-08-21  visbbk ESCAN00115430  Compiler error in Com_SignalGw_SignalRoutings due to undefined ServiceId when used without error reporting
 *  25.01.00  2023-08-30  visssg COM-4648       Structural Improvements based on SafetyAnalysis
 *            2023-09-11  visssg ESCAN00115630  TxTimeout not started after immediate description routing
 *            2023-09-11  visssg ESCAN00115622  Compiler warning: conversion from 'uint16' to 'PduLengthType', possible loss of data
 *            2023-09-28  jdorst ESCAN00115722  Compiler warning: conversion from 'Com_TxTpWrittenBytesCounterType' to 'Com_TxBufferIterType', possible loss of data
 *            2023-10-05  vismvi ESCAN00115841  MISRA deviation: MISRA-C:2012
 *            2023-10-09  jdorst ESCAN00115863  Compiler warning: conversion from 'const Com_RxPduInfoIterType' to 'Com_HandleRxDeferredGwDescriptionIterType', possible loss of data
 *  25.01.01  2024-01-14  visssg COM-5137       Adapt to changes in evaluation metrics
 *            2024-01-14  visssg COM-5135       Adapt FETA justification style
 *  25.02.00  2024-03-04  visms  COM-5234       Compile Code as Unity Build
 *            2024-03-07  visms  COM-5254       Remove COM_DUMMY_STATEMENT* in Compile Time Checked Code
 *********************************************************************************************************************/
#if !defined (COM_H)
# define COM_H
...
/*!
  ...
  \pre      -
    \{
*/
# define COM_SW_MAJOR_VERSION                 25u    /**< Major version */
...
*/
# define COM_E_NO_ERROR                                  ((uint8)0x00u) /**< this code is used to detect that no error occurred. Det_ReportError() is not called.  */
# define COM_E_PARAM                                     ((uint8)0x01u) /**< the API service has been called with a wrong parameter. */
# define COM_E_UNINIT                                    ((uint8)0x02u) /**< the API service has been called before COM was initialized with Com_Init() or after a call to Com_DeInit() */
# define COM_E_PARAM_POINTER                             ((uint8)0x03u) /**< the API service has been called with a not expected NULL pointer */
# define COM_E_INIT_FAILED                               ((uint8)0x04u) /**< the API service has been called when COM was already initialized. */
# define COM_E_CPRQUEUE_OVERFLOW                         ((uint8)0xB0u) /**< cross partition routing queue overflow. */
# define COM_E_IDXOUTOFBOUNDS                            ((uint8)0xB1u) /**< a read or write index is out-of-bounds and was sanitized. */
# define COM_E_BITCOPY                                   ((uint8)0xB2u) /**< bitcopy operation failed */
...
# define COMServiceId_DisableReceptionDM                 ((uint8)0x05u)
# define COMServiceId_EnableReceptionDM                  ((uint8)0x06u)
# define COMServiceId_GetStatus                          ((uint8)0x07u)
# define COMServiceId_GetConfigurationId                 ((uint8)0x08u)    /**< This service Id is not used in Autosar 4.2.1 */
...
# define COMServiceId_SendDynSignal                      ((uint8)0x21u)
# define COMServiceId_ReceiveDynSignal                   ((uint8)0x22u)
# define COMServiceId_SendSignalGroupArray               ((uint8)0x23u)
# define COMServiceId_ReceiveSignalGroupArray            ((uint8)0x24u)
# define COMServiceId_SwitchIpduTxMode                   ((uint8)0x27u)
# define COMServiceId_TriggerIPDUSendWithMetaData        ((uint8)0x28u)
# define COMServiceId_TxConfirmation                     ((uint8)0x40u)
# define COMServiceId_TriggerTransmit                    ((uint8)0x41u)
# define COMServiceId_RxIndication                       ((uint8)0x42u)
# define COMServiceId_CopyTxData                         ((uint8)0x43u)
# define COMServiceId_CopyRxData                         ((uint8)0x44u)
# define COMServiceId_TpRxIndication                     ((uint8)0x45u)
# define COMServiceId_StartOfReception                   ((uint8)0x46u)
# define COMServiceId_TpTxConfirmation                   ((uint8)0x48u)
/* ! Service IDs for internal functions */
# define COMServiceId_CprQueue_ReadIdx                   ((uint8)0xA0u)
# define COMServiceId_CprQueue_WriteIdx                  ((uint8)0xA1u)
# define COMServiceId_CprQueueDescrGw_Write              ((uint8)0xA2u)
# define COMServiceId_CprQueueSigGw_Write_Signal         ((uint8)0xA3u)
# define COMServiceId_CprQueueSigGw_Write_SignalGroup    ((uint8)0xA4u)
# define COMServiceId_BitCopy                            ((uint8)0xB0u)
# define COMServiceId_EventCache_ReadIdx                 ((uint8)0xB1u)
# define COMServiceId_EventCache_WriteIdx                ((uint8)0xB2u)
...
# include "Com_MemMap.h"    /* PRQA S 5087 */       /* MD_MSR_19.1 */
...
* \usedin Com_DeInit, Com_Init, Com_IPduGroupStart, Com_IPduGroupStop, Com_MainFunctionRxInternal, Com_MainFunctionRouteSignalsInternal, Com_ReceiveDynSignal, Com_EnableReceptionDM, Com_ReceiveSignal, Com_ReceiveSignalGroup, Com_ReceiveSignalGroupArray, Com_RxIndication, Com_TpRxIndication, Com_StartOfReception, Com_CopyRxData
* \exclude All functions provided by Com.
* \length SHORT to LONG depending on the API, the call graph and configured thresholds. See DSGN-COM_ISRTHRESHOLD_CONCEPT.
* \endexclusivearea
*/
...
* \usedin Com_Deinit, Com_Init, Com_InvalidateSignal, Com_InvalidateSignalGroup, Com_IpduGroupStart, Com_IpduGroupStop, Com_MainFunctionTxInternal, Com_MainFunctionRouteSignalsInternal, Com_RxIndication, Com_SendDynSignal, Com_SendSignal, Com_SendSignalGroup, Com_SendSignalGroupArray, Com_TpRxIndication, Com_TriggerTransmit, Com_TxConfirmation, Com_TpTxConfirmation, Com_TriggerIPDUSend, Com_TriggerIPDUSendWithMetaData, Com_CopyTxData, Com_SwitchIpduTxMode
* \exclude All functions provided by Com.
* \length SHORT to LONG depending on the API, the call graph and configured thresholds. See DSGN-COM_ISRTHRESHOLD_CONCEPT.
* \endexclusivearea
*/
...
* \usedin Com_MainFunctionRouteSignalsInternal
* \exclude All functions provided by Com.
* \length SHORT to LONG depending on the number of configured Gateway Mappings (Description or Signal Routings). See DSGN-COM_ISRTHRESHOLD_CONCEPT.
* \endexclusivearea
*/
