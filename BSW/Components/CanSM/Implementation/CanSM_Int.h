...
# define CCL_ASR4SMCAN_INT_HEADER_VERSION                                        0x0600u   /* BCD coded version number */
...
typedef struct CanSM_ChannelVarRecordTypeTag
{
  ...
  uint8           CanSM_TxOnlineDelayTime;   /*!< Value of the bus-off timer as returned by BusOffDelayFunction */
  boolean         CanSM_IsTxOnlineDelayTimeActive;/*!< Used values are boolean */
  uint8           CanSM_WakeUpValidationProcess;  /*!< Used values are boolean */
