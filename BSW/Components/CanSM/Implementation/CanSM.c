 ...
 *  05.00.00  2023-03-13  MFi     NMM-2220      Finite Execution Time Analysis for CanSM;FTA-01 loop may not terminate
 *  06.00.00  2023-03-23  MFi     NMM-2688      Wakeup Validation support for asynchronous (CAN controller/transceiver) mode change
 *  07.00.00  2024-02-22  ohamed  NMM-3031      Change parameter BusOffBegin to CanSMGetBusOffDelayFunction and adapt the behavior of the universal CanSM timer accordingly
 *********************************************************************************************************************/
...
#if ( ( 0x06u != CANSM_SW_MAJOR_VERSION ) || ( 0x00u != CANSM_SW_MINOR_VERSION ) || ( 0x00u != CANSM_SW_PATCH_VERSION ) )
...
#define CANSM_S_START_WAKEUPSOURCES_SUCCESSFUL 0x60u /* 96 */
...
#define CANSM_MAX_ITERATION_GUARD_VALUE       0x0Au
...
#define CANSM_DELAY_TIMER_IGNORE_VALUE        0xFFu
...
{ /* Context: CanSM_Init, CanSM_InitializeVariables; CanSM_MainFunction, CanSM_EvaluateComModeRequest CanSM_MainFunction, CanSM_EvaluateMaxModeRequests CanSM_TxTimeoutException, no bus-off */
  ...
  /* \trace..SPEC-11365 */
  (*CanSM_CurrentChannelVarPtr).CanSM_UniversalTimer = CANSM_CANCEL_TIMER; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
  (*CanSM_CurrentChannelVarPtr).CanSM_WakeUpValidationProcess = CANSM_WAKEUP_VALIDATION_NOP; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
...
{ /* Context: Called by CanSM_Init */
  CONSTP2VAR(CanSM_ChannelVarRecordType, AUTOMATIC, CANSM_VAR_NOINIT) CanSM_CurrentChannelVarPtr = CanSM_GetAddrChannelVarRecord( CanSM_CanNetworkIdx );
  ...
  (*CanSM_CurrentChannelVarPtr).CanSM_TxTimeoutEndIndicationFlag = FALSE; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
  (*CanSM_CurrentChannelVarPtr).CanSM_EnfroceComModeIndication = FALSE; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
#if ( CANSM_BUSOFF_DELAY_FUNCTION == STD_ON )
  (*CanSM_CurrentChannelVarPtr).CanSM_TxOnlineDelayTime = CANSM_DELAY_TIMER_IGNORE_VALUE; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
  (*CanSM_CurrentChannelVarPtr).CanSM_IsTxOnlineDelayTimeActive = FALSE; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
#endif /* ( CANSM_BUSOFF_DELAY_FUNCTION == STD_ON ) */
...
{ /* Context: CanSM_Init */
  ...
  CONSTP2VAR(CanSM_ChannelVarRecordType, AUTOMATIC, CANSM_VAR_NOINIT) CanSM_CurrentChannelVarPtr = CanSM_GetAddrChannelVarRecord( CanSM_CanNetworkIdx ); /* PRQA S 2812, 2812, 2813 */ /* MD_CANSM_Dir4.1, MD_CANSM_Rule1.3 */  /* SBSW_CANSM_CFG_POINTER_2 */
...
#if !defined CANSM_PARTIAL_NETWORK_TRCV_SUPPORT_ALWAYS_ON
  if ( (*CanSM_CurrentChannelVarPtr).CanSM_RequestedComMode == COMM_NO_COMMUNICATION ) /* CANSM_E_START_WAKEUPSOURCES_RUNNING */
  { /* CanSM_StartWakeupSources  Skip FullCom Indication */
    (*CanSM_CurrentChannelVarPtr).CanSM_CurrentState = CANSM_S_START_WAKEUPSOURCES_SUCCESSFUL; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
...
#if ( CANSM_BUSOFF_DELAY_FUNCTION == STD_ON )
    if ( (*CanSM_CurrentChannelVarPtr).CanSM_TxOnlineDelayTime != CANSM_DELAY_TIMER_IGNORE_VALUE )
    {
      (*CanSM_CurrentChannelVarPtr).CanSM_UniversalTimer = (*CanSM_CurrentChannelVarPtr).CanSM_TxOnlineDelayTime; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */ /* \trace..SPEC-2181238 */
    }
    else
#endif /* CANSM_BUSOFF_DELAY_FUNCTION == STD_ON */
...
# if ( CANSM_EXTENDED_RAM_CHECK == STD_ON )
      if ( (*CanSM_CurrentChannelVarPtr).CanSM_WakeUpValidationProcess != CANSM_E_STOP_WAKEUPSOURCES_RUNNING )
      {
        (*CanSM_CurrentChannelVarPtr).CanSM_CurrentState = CANSM_SD_CHECK_RAM; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
      }
# endif /* CANSM_EXTENDED_RAM_CHECK  */
...
# endif /* Trcv ID runtime check, mixed on off */
    {
      /* Trcv active at least at one channel, but not this one */
...
#if !defined CANSM_PARTIAL_NETWORK_TRCV_SUPPORT_ALWAYS_ON
    ( (*CanSM_CurrentChannelVarPtr).CanSM_WakeUpValidationProcess != CANSM_E_START_WAKEUPSOURCES_RUNNING ) &&
#endif
  ( (*CanSM_CurrentChannelVarPtr).CanSM_RequestedComMode == COMM_NO_COMMUNICATION ) && ( (*CanSM_CurrentChannelVarPtr).CanSM_CurrentState <= CANSM_S_SILENTCOM )  ) /* check if ShutDown is already running; NoComReq and not on the way */
...
#if !defined CANSM_PARTIAL_NETWORK_TRCV_SUPPORT_ALWAYS_ON
          || ( (*CanSM_CurrentChannelVarPtr ).CanSM_CurrentState == CANSM_S_START_WAKEUPSOURCES_SUCCESSFUL )
#endif /* !defined CANSM_PARTIAL_NETWORK_TRCV_SUPPORT_ALWAYS_ON */
          )   )
...
#if ( CANSM_BUSOFF_DELAY_FUNCTION == STD_ON )
  (*CanSM_CurrentChannelVarPtr).CanSM_IsTxOnlineDelayTimeActive = TRUE; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
  (*CanSM_CurrentChannelVarPtr).CanSM_TxOnlineDelayTime = CANSM_DELAY_TIMER_IGNORE_VALUE; /* detect missing BusOffEndIndication in case of ComModeRequest */ /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
  (*CanSM_BusOffDelayFctPtr)( CanSM_GetNetworkHandleOfChannelConfig( CanSM_CanNetworkIdx ), &( (*CanSM_CurrentChannelVarPtr ).CanSM_TxOnlineDelayTime ) ); /* SBSW_CANSM_GETBUSOFFDELAY_POINTERWRITEACCESS */ /* SBSW_CANSM_GETBUSOFFDELAY_INDICATION */
#endif /* ( CANSM_BUSOFF_DELAY_FUNCTION == STD_ON ) */
...
#if ( CANSM_BUSOFF_DELAY_FUNCTION == STD_ON )
  if ( (*CanSM_CurrentChannelVarPtr).CanSM_IsTxOnlineDelayTimeActive == TRUE )
  { /* BusOffDelay has been called, eventually BusOffEndIndication missing */
    (*CanSM_CurrentChannelVarPtr).CanSM_TxOnlineDelayTime = CANSM_DELAY_TIMER_IGNORE_VALUE; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
    (*CanSM_CurrentChannelVarPtr).CanSM_IsTxOnlineDelayTimeActive = FALSE; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
# if ( CANSM_BUSOFF_END_INDICATION == STD_ON )
    (*CanSM_BusOffEndIndicationFctPtr)( CanSM_GetNetworkHandleOfChannelConfig( CanSM_CanNetworkIdx ) ); /* J1939Nm_BusOffEnd(); */  /* SBSW_CANSM_BUS_OFF_END_INDICATION */
 ...
 *
 */
CANSM_LOCAL FUNC(void, CANSM_CODE) CanSM_NetworkStatemachine( CanSM_SizeOfChannelVarRecordType CanSM_CanNetworkIdx, P2VAR(CanSM_ChannelVarRecordType, AUTOMATIC, CANSM_VAR_NOINIT) CanSM_CurrentChannelVarPtr )   /* PRQA S 6010, 6030, 6050 */  /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
{ /* Context: CanSM_MainFunction; CANSM_TIMER_EXPIRED, CANSM_S_INTERIM_STATE_DETECTED resp. ComModeChanged; CanSM_StartWakeupSources; CanSM_StopWakeupSources;  CanSM_Init; CanSM_UninitToNoCom  */
  ...
  uint8 CanSM_MaxIterGuard;
#if ( CANSM_BOR_TX_CONFIRMATION_POLLINGOFCHANNELCONFIG == STD_ON )
  CanIf_NotifStatusType CanSM_TxNotificationStatus;
#endif

  for ( CanSM_MaxIterGuard = 0; CanSM_MaxIterGuard < CANSM_MAX_ITERATION_GUARD_VALUE; CanSM_MaxIterGuard++ )  /* COV_CANSM_FETA_MAX_ITERATION_GUARD_VALUE */ /* lint +e442 +e440 */
  {
...
# endif /* if ( CANSM_PARTIAL_NETWORK_TRCV_SUPPORTOFCHANNELCONFIG == STD_ON ) */
      ...
      {
#if ( CANSM_BUSOFF_DELAY_FUNCTION == STD_ON )
        (*CanSM_CurrentChannelVarPtr).CanSM_TxOnlineDelayTime = CANSM_DELAY_TIMER_IGNORE_VALUE; /* BusOffEndIndication not missing */ /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
        (*CanSM_CurrentChannelVarPtr).CanSM_IsTxOnlineDelayTimeActive = FALSE; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
#endif /* ( CANSM_BUSOFF_DELAY_FUNCTION == STD_ON ) */
#if ( CANSM_BUSOFF_END_INDICATION == STD_ON )
        (*CanSM_BusOffEndIndicationFctPtr)( CanSM_GetNetworkHandleOfChannelConfig( CanSM_CanNetworkIdx ) ); /* J1939Nm_BusOffEnd(); */  /* SBSW_CANSM_BUS_OFF_END_INDICATION */
...
# endif /* ( CANSM_BUSOFF_END_INDICATION == STD_ON ) */
    ...
    if ( (*CanSM_CurrentChannelVarPtr).CanSM_CurrentState == CANSM_S_NOCOM ) /* PRQA S   2992, 2996 */ /*  MD_CANSM_Rule14.3, MD_CANSM_Rule2.2_2996 */
    {
    ...
    if ( CanSM_OldState == (*CanSM_CurrentChannelVarPtr).CanSM_CurrentState )
    {
      break;
    }

  } /* for MAX iteration guart FETA */



  CANSM_DUMMY_STATEMENT( CanSM_CanNetworkIdx );  /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */

} /* end  Func CanSM_NetworkStatemachine */  /* PRQA S 6010, 6030, 6050 */  /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
{ /* \trace SPEC-834 */
  ...
  else if ( CanSM_HasChannelConfig() ) /* COV_CANSM_POSTBUILD_HAS_CHANNEL_CONFIG */
...
{ /* \trace SPEC-834, SPEC-47130 */
  ...
  if ( CanSM_IsInitialized == CANSM_PRE_INITIALIZED )
  {
    ...
    /* lint -e442 -e440 */
    for ( CanSM_CanNetworkIdx = 0; CanSM_CanNetworkIdx < CanSM_GetSizeOfChannelVarRecord(); CanSM_CanNetworkIdx++ ) /* lint +e442 +e440 */ /* PRQA S 2812, 2812 */ /* MD_CANSM_Dir4.1, MD_CANSM_Rule1.3 */
    {
 ...
 *
 */
FUNC(void, CANSM_CODE) CanSM_MainFunction( void ) /* PRQA S 6050 */  /* MD_MSR_STCAL */
{ /* \trace SPEC-853 */
 ...
 *
 */
FUNC(Std_ReturnType, CANSM_CODE) CanSM_RequestComMode( NetworkHandleType CanSM_NetworkHandle, ComM_ModeType CanSM_RequestedComMMode ) /* PRQA S 6030 */ /* MD_MSR_STCYC */
{ /* \trace SPEC-819 */
...
FUNC(void, CANSM_CODE) CanSM_SetEcuPassive( boolean CanSM_TxOfflineActive )
{
  ...
  if ( CanSM_EcuPassiveMode != CanSM_TxOfflineActive )
  {
    ...
    for ( CanSM_CanNetworkIdx = 0; CanSM_CanNetworkIdx < CanSM_GetSizeOfChannelVarRecord(); CanSM_CanNetworkIdx++ ) /* lint +e442 +e440 */
    {
      CONSTP2CONST(CanSM_ChannelVarRecordType, AUTOMATIC, CANSM_VAR_NOINIT) CanSM_CurrentChannelVarPtr = CanSM_GetAddrChannelVarRecord( CanSM_CanNetworkIdx );
 ...
 *
 */
FUNC(void, CANSM_CODE) CanSM_ControllerModeIndication( uint8 CanSM_ControllerId, CanIf_ControllerModeType CanSM_ControllerMode ) /* PRQA S 6050, 6080 */ /* MD_MSR_STCAL, MD_MSR_STMIF */
{ /* \trace SPEC-847 */
  CanSM_SizeOfChannelVarRecordType CanSM_CanNetworkIdx;
  uint8 CanSM_DetErrorId = CANSM_E_NO_ERROR;
  /* \trace SPEC-812, SPEC-811 */
 ...
 *
 */
FUNC(Std_ReturnType, CANSM_CODE) CanSM_SetBaudrate( NetworkHandleType Network, uint16 BaudRateConfigID ) /* PRQA S 6080 */ /* MD_MSR_STMIF */
{
  CanSM_SizeOfChannelVarRecordType CanSM_CanNetworkIdx;
  uint8 CanSM_DetErrorId = CANSM_E_NO_ERROR;
 ...
 *
 */
FUNC(Std_ReturnType, CANSM_CODE) CanSM_ChangeBaudrate( NetworkHandleType CanSM_NetworkHandle, CONST( uint16, AUTOMATIC ) CanSM_Baudrate ) /* PRQA S 6080 */ /* MD_MSR_STMIF */
{ /* \trace SPEC-11336 */
  CanSM_SizeOfChannelVarRecordType CanSM_CanNetworkIdx;
  uint8 CanSM_DetErrorId = CANSM_E_NO_ERROR;
  Std_ReturnType CanSM_StdReturnValue = E_NOT_OK;
 ...
 *
 */
FUNC(Std_ReturnType, CANSM_CODE) CanSM_CheckBorLevel( CONST( NetworkHandleType, AUTOMATIC ) CanSM_NetworkHandle, P2VAR( CanSM_BorStateType, AUTOMATIC, CANSM_APPL_VAR ) CanSM_BorStatePtr ) /* PRQA S 6080 */ /* MD_MSR_STMIF */
{
  CanSM_SizeOfChannelVarRecordType CanSM_CanNetworkIdx;
  Std_ReturnType CanSM_StdReturnValue;
 ...
 *
 */
FUNC(Std_ReturnType, CANSM_CODE) CanSM_StartWakeupSources( NetworkHandleType CanSM_NetworkHandle ) /* PRQA S 6080 */ /* MD_MSR_STMIF */
{
  Std_ReturnType CanSM_StdReturnValue = E_NOT_OK;
#if !defined CANSM_PARTIAL_NETWORK_TRCV_SUPPORT_ALWAYS_ON
  CanSM_SizeOfChannelVarRecordType CanSM_CanNetworkIdx;
...
# endif /* CANSM_PARTIAL_NETWORK_TRCV_SUPPORT_MIXED_ON_AND_OFF */
      {
        ...
        SchM_Enter_CanSM_CANSM_EXCLUSIVE_AREA_5(); /* RequestComMode MainFunction */
        if (  ( (*CanSM_CurrentChannelVarPtr).CanSM_RequestedComMode == COMM_NO_COMMUNICATION ) && ( (*CanSM_CurrentChannelVarPtr).CanSM_CurrentState != CANSM_S_START_WAKEUPSOURCES_SUCCESSFUL ) && ( (*CanSM_CurrentChannelVarPtr).CanSM_WakeUpValidationProcess != CANSM_E_START_WAKEUPSOURCES_RUNNING )  )
        {
...
# endif /* if ( CANSM_TRANSCEIVER_CHANNEL_SUPPORTOFCHANNELCONFIG == STD_ON ) */
          ...
          (*CanSM_CurrentChannelVarPtr).CanSM_WakeUpValidationProcess = CANSM_E_START_WAKEUPSOURCES_RUNNING; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
 ...
 *
 */
FUNC(Std_ReturnType, CANSM_CODE) CanSM_StopWakeupSources( NetworkHandleType CanSM_NetworkHandle, EcuM_WakeupSourceType WakeupSource ) /* PRQA S 6080 */ /* MD_MSR_STMIF */
{
  Std_ReturnType CanSM_StdReturnValue = E_NOT_OK;
#if !defined CANSM_PARTIAL_NETWORK_TRCV_SUPPORT_ALWAYS_ON
  CanSM_SizeOfChannelVarRecordType CanSM_CanNetworkIdx;
...
# endif /* CANSM_PARTIAL_NETWORK_TRCV_SUPPORT_MIXED_ON_AND_OFF */
      {
        ...
        if (  ( (*CanSM_CurrentChannelVarPtr).CanSM_CurrentState == CANSM_S_START_WAKEUPSOURCES_SUCCESSFUL ) || ( (*CanSM_CurrentChannelVarPtr).CanSM_WakeUpValidationProcess == CANSM_E_START_WAKEUPSOURCES_RUNNING )  )
        {

          (*CanSM_CurrentChannelVarPtr).CanSM_CurrentState = CANSM_SD_CC_STOPPED; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
          (*CanSM_CurrentChannelVarPtr).CanSM_WakeUpValidationProcess = CANSM_E_STOP_WAKEUPSOURCES_RUNNING; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */ /* Avoid/skip CANSM_SD_CHECK_RAM during shutdown */
        ...
        else  if ( (*CanSM_CurrentChannelVarPtr).CanSM_RequestedComMode == COMM_NO_COMMUNICATION )
        { /* NoComReq && ! S_NOCOM => CANSM_BSM_S_PRE_NOCOM */
          CanSM_StdReturnValue = CANSM_E_STOP_WAKEUPSOURCES_RUNNING;
        } /* COMM_NO_COMMUNICATION request; trigger valid */
        else
        {
          CanSM_StdReturnValue = CANSM_E_REQUESTED_COMM_MODE;
        }
 ...
 *
 * MD_CANSM_Dir4.1
 *   Reason:     The pointer is valid if CanSM_IsInitialized != CANSM_INITFUNCTION_NOT_CALLED, set in CanSM PreInit.
 *   Risk:       Wrong adaption and review not well performed
...
/* SBSW_JUSTIFICATION_BEGIN
   ...
   \COUNTERMEASURE \S Verify that the function pointer CanSM_BusOffDelayFctPtr refers to a valid function. [SMI-389]
   ...
   \ID SBSW_CANSM_CFG_POINTER_2
   \DESCRIPTION CanSM_UninitToNoCom() which uses the pointer is only called if the pointer is valid and was set in the CanSM_PreInit(), see HasChannelConfig().
   \COUNTERMEASURE \N NULL pointer check is already executed within prior function
...
/* COV_JUSTIFICATION_BEGIN
   ...
   \ID COV_CANSM_FETA_MAX_ITERATION_GUARD_VALUE
   \ACCEPT TX
   \REASON Just an additional safeguard mechanism to ensure FETA

   \ID COV_CANSM_POSTBUILD_HAS_CHANNEL_CONFIG
   \ACCEPT TX
   \REASON The condition checks if the CanSM is (in)active in the choosen variant.
