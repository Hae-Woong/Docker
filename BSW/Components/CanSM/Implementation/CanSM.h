 ...
 *  05.00.00  2023-03-13  MFi     NMM-2220      Finite Execution Time Analysis for CanSM
...
# define CCL_ASR4SMCAN_VERSION                                        0x0600u   /* BCD coded version number */
...
/* CanSM_WakeUpValidationProcess values */
/* The values are also used as return values of CanSM_StopWakeupSources()  */
#define CANSM_WAKEUP_VALIDATION_NOP                                    E_OK 
#define CANSM_E_START_WAKEUPSOURCES_RUNNING                           (0x01u+E_OK+E_NOT_OK)
#define CANSM_E_STOP_WAKEUPSOURCES_RUNNING                            (0x02u+E_OK+E_NOT_OK)   
#define CANSM_E_REQUESTED_COMM_MODE                                   (0x03u+E_OK+E_NOT_OK)   
