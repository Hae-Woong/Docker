 ...
 *********************************************************************************************************************/
/*! \brief          Forwards user data of manufacturer-specific payload types to user.
 *  \details        -
 *  \param[in]      ConnectionId    DoIP unique identifier of the connection.
 *  \param[in]      PayloadType     The payload type that has been received.
 *  \param[in]      PayloadDataPtr  PDU information structure which contains the length and the payload data of the
 *                                  received message.
