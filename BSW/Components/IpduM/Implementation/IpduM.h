 ...
 *         \file  IpduM.h
 *         \unit  General
 *        \brief  Microsar IpduM header file
 ...
 *  11.00.00  2021-03-25    visfrm    COM-2199          Refactor IpduM into units
 *            2021-03-25    visfrm    ESCAN00109021     Compiler warning: IpduM_Container.c: warning : 'initializing' : conversion from 'IpduM_ContainerXXXXIdxOfTxContainerPduType' to 'IpduM_ContainerTxXXXXXIterType', possible loss of data
 *            2021-03-25    visfrm    ESCAN00108709     Multiplexed PDU with JIT Update of both parts and TriggerTransmit to lower layer transmits old data
 *            2021-03-25    visfrm    ESCAN00108708     Container PDUs with HeaderSize=NONE are transmitted with wrong data for unset PDUs after ECU startup
 *            2021-04-09    visbms    COM-2212          IpduMRxDirectComInvocation shall always be false
 *            2021-04-19    visms     COM-2227          Support IPDUM_LOCAL_INLINE
 *  11.01.00  2021-06-11    visfrm    COM-1836          [MC] ASR 4.5 Multi-Partition Support in IpduM
 *            2021-06-23    visbms    ESCAN00109476     Compiler error: identifier txDynamicPartId not declared
 *  11.02.00  2021-08-10    visssg    COM-2736          Usage of <Ma>_MemMap.h in IpduM
 *            2021-08-20    visbms    ESCAN00110004     Compiler error: C4013: IpduM_GetTxConfirmationTimeoutOfTxPathway undefined
 *  11.02.01  2022-06-07    visbms    ESCAN00110956     Container Pdus with metadata are handled improperly
 *  12.00.00  2023-02-09    visbms    COM-3995          Perform FETA Analysis and Implement Measures
 *            2023-02-10    vadgsz    ESCAN00112739     Send Timeout Trigger is not working for Container PDUs where only the Contained PDUs have a configured timeout
 *            2023-02-10    vadnra    ESCAN00113330     Container PDU with Meta Data is transmitted with wrong DLC in ContainedPduHeader
 *            2023-02-10    vadnra    ESCAN00113429     Received Container PDUs with MetaData containing padding bytes are not correctly received by IpduM
 *  13.00.00  2023-03-13    visfrm    COM-4244          IpduM: Prepare Test2020 testsuite
 *            2023-03-15    visfrm    COM-4424          Split up units into separate files
 *            2023-03-15    visfrm    COM-4434          Refactor units for better testability
 *            2023-03-28    visfrm    COM-4242          Use CompileTimeChecking and remove preprocessor variants
 *            2023-04-11    visfrm    COM-4496          Harmonize TxConfirmation
 *            2023-04-13    visfrm    COM-4500          Use ComStackLib Inline functions
 *            2023-08-30    visfrm    COM-1413          Replace RH by VCA Step 2
 *            2023-10-19    vismvi    COM-4949          ESCAN00115900: MISRA deviation: MISRA-C:2012 - fix "MISRA Results on Product level for MS "
 *            2023-10-19    visfrm    COM-4819          Verify necessity of MISRA justifications
 *            2023-10-20    oalka     COM-2547          Support unsigned long long as least Type 
 *            2023-10-26    oalka     COM-4889          Use VStdLib Bitcopy in IpduM
 *            2023-11-07    oalka     COM-4895          Do RMW Analysis 
 *            2023-11-09    visfrm    COM-4993          Add Safe-BSW check to IpduM_MuxTx_Transmit
 *            2023-11-09    visfrm    COM-5003          Remove IpduM_ContainerUtil_CalculateSizeOfContainer iteration limit
 *            2023-11-10    oalka     COM-5005          API naming consistency
 *            2023-11-14    oalka     COM-5036          Improve robustness of RxContainer parsing
 *            2023-11-20    visfrm    COM-1791          IpduM Safety Analysis
 *  13.01.00  2024-01-11    visbms    COM-4626          Receive several contained PDUs with MetaData within one Container PDU
 *            2024-02-01    visbms    ESCAN00116610     C4242: 'function': conversion from 'PduIdType' to 'IpduM_TxUpInfoIterType', possible loss of data
 *            2024-02-13    visbms    ESCAN00115337     Compiler warning: conversion from IpduM_UpdateIndicationBitPositionOfTxContainedPduType to uint16, possible loss of data
 *  13.02.00  2024-03-18    visms     COM-5300          Compile Code as Unity Build
 *********************************************************************************************************************/
#ifndef IPDUM_H
# define IPDUM_H
...
/*!
  ...
  \{
*/
# define IPDUM_SW_MAJOR_VERSION       13u
...
#  define IPDUM_E_GENERATED_DATA                80u /**< generated data is malformed */
/*!
  \}
*/
...
#  define IPDUM_APIID_MUXRX_RXINDICATION                            0xF0
#  define IPDUM_APIID_MUX_COPYSEGMENTS                              0xF1
#  define IPDUM_APIID_MUXTX_WRITEMUXFILLERSEGMENTS                  0xF2
#  define IPDUM_APIID_CONTAINERRX_RXINDICATION                      0xF3
#  define IPDUM_APIID_CONTAINERTX_TRANSMIT                          0xF4
#  define IPDUM_APIID_CONTAINERRX_UNPACKCONTAINERPDU_DYNAMICLAYOUT  0xF5
#  define IPDUM_APIID_CONTAINERTX_DATAQUEUE_QUEUECURRCONTAINERPDU   0xF6
#  define IPDUM_APIID_CONTAINERTX_REQUESTQUEUE_PEEK                 0xF7
#  define IPDUM_APIID_CONTAINERTX_REQUESTQUEUE_ADDPDU               0xF8
#  define IPDUM_APIID_CONTAINERTX_DATAQUEUE_ADDPDU2IDBUFFER         0xF9
#  define IPDUM_APIID_CONTAINERTX_DATAQUEUEINSTANCE_CLEARBIT        0xFA
#  define IPDUM_APIID_CONTAINERTX_DATAQUEUEINSTANCE_SETBIT          0xFB
#  define IPDUM_APIID_CONTAINERTX_DATAQUEUEINSTANCE_PUTHEADER       0xFC
#  define IPDUM_APIID_CONTAINERTX_DATAQUEUEINSTANCE_PUT             0xFD
#  define IPDUM_APIID_MUXTX_TRANSMIT                                0xFE
/*!
  \}
*/

#define IPDUM_HEADERSIZE_NONE                   0u
#define IPDUM_HEADERSIZE_SHORT                  4u
#define IPDUM_HEADERSIZE_LONG                   8u

#define IPDUM_MAX_METADATA_SIZE                 4u
#define IPDUM_METADATA_DLC_POSITION             3u
...
*******************************************************************************************/
/*! \brief        Function which handles cyclic processing/events in IpduM.
 *  \details      -
 *  \param[in]    mainFunctionTxIndirectionIdx determines the partition context in which this MainFunction is called.
 *  \pre          -
 *  \context      TASK
 *  \reentrant    TRUE for different handle IDs
 *  \synchronous  TRUE
...
/*! \brief        Function which handles cyclic processing/events in IpduM.
 *  \details      -
 *  \param[in]    mainFunctionRxIndirectionIdx determines the partition context in which this MainFunction is called.
 *  \pre          -
 *  \context      TASK
 *  \reentrant    TRUE for different handle IDs
 *  \synchronous  TRUE
