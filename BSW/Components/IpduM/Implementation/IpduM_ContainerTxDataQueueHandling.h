 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *         \file  IpduM_ContainerTxDataQueueHandling.h
 *         \unit  ContainerTxDataQueueHandling
 *        \brief  Microsar IpduM Container Tx Data Queue Handling header file
 ...
 *  Refer to the module's header file.
 *********************************************************************************************************************/
#ifndef IPDUM_CONTAINERTXDATAQUEUEHANDLING_H
# define IPDUM_CONTAINERTXDATAQUEUEHANDLING_H
 ...
 *    requires IpduM_IsDataQueueInfoUsedOfTxContainerPdu(txContainerId);
 *  \endspec
*******************************************************************************************/
 ...
 *    requires IpduM_IsDataQueueInfoUsedOfTxContainerPdu(IpduM_GetTxContainerPduIdxOfTxContainedPdu(txContainedId));
 *  \endspec
*******************************************************************************************/
...
#endif /* IPDUM_CONTAINERTXDATAQUEUEHANDLING_H */

/**********************************************************************************************************************
 *  END OF FILE: IpduM_ContainerTxDataQueueHandling.h
 *********************************************************************************************************************/
