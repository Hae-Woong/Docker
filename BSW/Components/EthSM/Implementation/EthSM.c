...
ETHSM_LOCAL FUNC(void, ETHSM_CODE) EthSM_TransWaitTrcvLinkToWaitOnline(EthSM_NetworkIdxType NetIdx)
{
  ...
  if( isModeSetSucceeded == E_OK )
  {
    ...
    /* #22 Only report a DEM event if it is configured (DEM Event ID 0U is invalid) */
 ...
 *
 */
ETHSM_LOCAL_INLINE FUNC(void, ETHSM_CODE) EthSM_EthernetInterfaceTimeout(EthSM_NetworkIdxType NetIdx) /* PRQA S 6080 */ /* MD_MSR_STMIF */
{
 ...
 *
 */
ETHSM_LOCAL_INLINE FUNC(void, ETHSM_CODE) EthSM_StateMachine(EthSM_NetworkIdxType NetIdx) /* PRQA S 6030,6050,6080 */ /* MD_MSR_STCYC, MD_MSR_STCAL, MD_MSR_STMIF */
{
  /* ----- Local Variables ---------------------------------------------- */
 ...
 *
 */
FUNC(Std_ReturnType, ETHSM_CODE) EthSM_GetCurrentInternalMode(NetworkHandleType NetworkHandle, /* PRQA S 6030 */ /* MD_MSR_STCYC */
