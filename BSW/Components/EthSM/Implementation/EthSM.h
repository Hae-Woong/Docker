 ...
 *  05.00.02  2022-03-16  vischh  ESCAN00111347 Production error ETHSM_E_LINK_DOWN is not set to PASS after a resolved link
 *                                ESCAN00104960 Compiler warning: declaration of function but never referenced
 *                                ESCAN00112204 Compiler warning: "EthSM_EthernetInterfaceTimeout" was declared but never referenced
 *********************************************************************************************************************/
...
#define ETHSM_SW_PATCH_VERSION                 (2U)
