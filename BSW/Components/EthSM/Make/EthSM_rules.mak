...
# 1.01.00   2013-07-26  vismha  removed EthSM_PBcfg.c
# 2.00.00   2018-04-27  vischh  adapted revision history
...
LIBRARIES_TO_BUILD      += EthSM
EthSM_FILES              = EthSM$(BSW_SRC_DIR)\EthSM.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
ifeq ($(GET_IMPLEMENTION_FROM), LIB)
CC_FILES_TO_BUILD       +=
else
CC_FILES_TO_BUILD       += EthSM$(BSW_SRC_DIR)\EthSM.c
endif
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\EthSM_Cfg.c
