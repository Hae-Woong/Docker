 ...
 *********************************************************************************************************************/
#define LINSM_CBK_MAJOR_VERSION                    (0x07u)
#define LINSM_CBK_MINOR_VERSION                    (0x00u)
#define LINSM_CBK_PATCH_VERSION                    (0x03u)
...
*********************************************************************************************************************/
/*! \brief      Triggers the go-to-sleep
*  \details     The LinIf will call this callback when the go to sleep command is received on the network or a bus
*               idle timeout occurs. Only applicable for LIN slave nodes.
*  \param[in]   network         System channel handle
*  \pre         -
*  \context     TASK
*  \reentrant   FALSE
*  \synchronous FALSE
*  \config      LINSM_SLAVENODE_POSSIBLE == STD_ON, i.e. LinSMNodeType has been set to SLAVE at least at one cluster
*  \trace       CREQ-204329
**********************************************************************************************************************/
FUNC( void, LINSM_CODE ) LinSM_GotoSleepIndication( VAR( NetworkHandleType, AUTOMATIC ) network  );
#endif /* LINSM_SLAVENODE_POSSIBLE */
...
#if ( LINSM_SCHEDULEENDNOTIFICATIONOFCHANNELCONFIG == STD_ON )
/* ESCAN00080029 */
/**********************************************************************************************************************
 ...
 *  \reentrant   FALSE
 *  \synchronous TRUE
 *  \config      LINSM_SCHEDULE_END_NOTIFICATION == STD_ON, implicit also LinSMNodeType has been set to MASTER at least at one cluster
 *  \trace       SPEC-10492
**********************************************************************************************************************/
