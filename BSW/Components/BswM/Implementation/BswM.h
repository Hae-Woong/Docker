 ...
 * 15.00.00   2021-12-03  visvjn      NMM-1209      Usage of <Ma>_MemMap.h in BswM
 *            2021-12-07  visvjn      NMM-1398      Update to QAC Helix
 *            2021-12-07  visvjn      NMM-1409      Remove Com_IpduGroupControl
 * 15.00.01   2022-01-28  visvjn      ESCAN00108407 Exception thrown: read access violation during initialization
 * 15.00.02   2022-04-21  visvjn      NMM-2097      Added MISRA justification MD_BSWM_2889
 * 16.00.00   2022-08-26  visuca      NMM-2262      Added MISRA justification MD_BSWM_3334
 * 16.01.00   2023-02-07  visuca      NMM-2656      Finite Execution Time Analysis
 * 17.00.00   2023-02-28  visuca      NMM-2199      Allow the configuration of a BswM rule to forward channel ready information
 *                                                  from DoIP(Int) to Dcm
 * 17.01.00   2023-03-15  shagemann   ESCAN00114137 Changed preprocessor-condition of BswM_Action_ActionListHandler() function
 *                                                  definition
 *            2023-03-16  visuca      NMM-2678      removed obsolete SBSW_BSWM_SETIPDUGROUPVECTOR justification
 * 17.02.00   2023-08-16  visuca      NMM-2521      Use defines for NvM ServiceIds instead of fix values
 * 18.00.00   2023-12-08  visuca      ESCAN00114910 Dcm_SetChannelReady() is not called for a channel
 * 18.00.01   2024-01-10  visuca      ESCAN00116461 Dcm_SetChannelReady() is not called for a channel
 *********************************************************************************************************************/
#if !defined BSWM_H
# define BSWM_H
 ...
 *********************************************************************************************************************/
# define SYSSERVICE_ASR4BSWMCFG5_VERSION          (0x1800u)
...
# define BSWM_DOIP_SET_CHANNEL_READY_ID           ((uint8)0x24u)
# define BSWM_DOIPINT_SET_CHANNEL_READY_ID        ((uint8)0x25u)
