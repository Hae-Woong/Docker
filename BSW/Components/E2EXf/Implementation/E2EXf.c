...
/* Whether any of the profiles is enabled */
    ...
    || (E2EXF_P22_ENABLED == STD_ON) || (E2EXF_P44_ENABLED == STD_ON) || (E2EXF_PJ193976_ENABLED == STD_ON)	)
...
# endif
  else
  {
    ...
    if (retVal == E_OK)
    {
      ...
      /* [SWS_E2EXf_00107] */
      E2EXF_ASSERT_SILENCE(buffer[4U])
      retVal = E2E_PJ193976Protect(config, state, buffer);
...
} /* E2EXf_PJ193976() */ /* PRQA S 6060, 6080 */ /* MD_MSR_STPAR, MD_MSR_STMIF */
  ...
  else
  {
    ...
    if (retVal == E_OK)
    {
      if (options->disableEndToEndCheck == FALSE)
      {
        ...
        retVal = E2E_PJ193976Check(config, state, pCheckBuffer);

        /* [SWS_E2EXf_00029] */
        profileStatus = E2E_PJ193976MapStatusToSM(retVal, state->Status);
...
} /* E2EXf_PJ193976_Inv() */ /* PRQA S 6060, 6080 */ /* MD_MSR_STPAR, MD_MSR_STMIF */
#endif /* (E2EXF_PJ193976_ENABLED == STD_ON) */
