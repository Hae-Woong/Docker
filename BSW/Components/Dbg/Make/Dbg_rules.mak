...
#------------------------------------------------------------------------------
# 1.00.00   2013-10-04  visore  Creation
...
LIBRARIES_TO_BUILD      += Dbg
Dbg_FILES               = Dbg$(BSW_SRC_DIR)\Dbg.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Dbg$(BSW_SRC_DIR)\Dbg.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Dbg_Cfg.c
