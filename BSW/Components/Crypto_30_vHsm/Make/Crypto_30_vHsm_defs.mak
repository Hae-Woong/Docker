############################################################################### 
# File Name  : Crypto_30_vHsm_defs.mak 
...
# REVISION HISTORY
#------------------------------------------------------------------------------
# Refer to the Crypto_30_vHsm_rules.mak file.
############################################################################### 
...
CRYPTO_30_VHSM_CORE_PATH       =
# e.g.: CAN_OUTPUT_PATH = $(GENDATA_DIR)
CRYPTO_30_VHSM_OUTPUT_PATH     = $(GENDATA_DIR)
...
CRYPTO_30_VHSM_DEPENDENT_PLUGINS = 
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     += Crypto_30_vHsm$(BSW_SRC_DIR)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
