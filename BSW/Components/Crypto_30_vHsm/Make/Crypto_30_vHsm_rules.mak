############################################################################### 
# File Name  : Crypto_30_vHsm_rules.mak 
...
#------------------------------------------------------------------------------
# 1.00.00   2015-05-22  vistof  Creation for ASR 4.0.3
# 1.01.00   2015-08-03  vistof  Added Crypto_SheKeyWrapSym
# 1.01.01   2015-09-29  vistof  Corrected reference to Crypto_SheKeyWrapSym.c
...
LIBRARIES_TO_BUILD      += Crypto_30_vHsm
Crypto_30_vHsm_FILES   = Crypto_30_vHsm$(BSW_SRC_DIR)\Crypto_30_vHsm*.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Crypto_30_vHsm$(BSW_SRC_DIR)\Crypto_30_vHsm*.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Crypto_30_vHsm_Cfg.c
