...
#else /* !(CRYPTO_30_VHSM_MEMORYAREA == STD_ON) */
...
#endif /* (CRYPTO_30_VHSM_NOBUFFERING_ENABLED == STD_ON) */
...
#endif /* (CRYPTO_30_VHSM_DEV_ERROR_DETECT == STD_OFF) */
  {
  ...
  )
{
  ...
  if (((Crypto_30_vHsm_JobIOAvailable[cryptoJobPtr->jobPrimitiveInfo->primitiveInfo->service] & CRYPTO_30_VHSM_IO_OUTPUT) == CRYPTO_30_VHSM_IO_OUTPUT)
    ...
    || ((cryptoJobPtr->jobPrimitiveInputOutput.mode & CRYPTO_OPERATIONMODE_SAVE_CONTEXT) == CRYPTO_OPERATIONMODE_SAVE_CONTEXT))
#else
      )
#endif
  {
...
# endif /* (CRYPTO_30_VHSM_KEY_DERIVE_JOB_SUPPORT == STD_ON) */
    ...
    Crypto_30_vHsm_Serialize_Uint32( /* PRQA S 0310, 3305, 4304, 0404 */ /* MD_CRYPTO_30_VHSM_SERIALIZATION_MACRO, MD_CRYPTO_30_VHSM_SERIALIZATION_MACRO, MD_CRYPTO_30_VHSM_SERIALIZATION_MACRO, MD_CRYPTO_30_VHSM_0404_VOLATILE_READ */ /* SBSW_CRYPTO_30_VHSM_IPC_SERIALIZE_UINT32 */
...
# endif /* (CRYPTO_30_VHSM_KEY_DERIVE_JOB_SUPPORT == STD_ON) */
#endif /* (CRYPTO_30_VHSM_IPC_PROTOCOL_VERSION == 2) */
 ...
 *
 */
 /* PRQA S 6030, 6080 1 */ /* MD_MSR_STMIF, MD_MSR_STCYC */
...
#if (CRYPTO_30_VHSM_SUPPORT_SAVE_RESTORE_CONTEXT == STD_ON)
      || ((jobTmp->jobPrimitiveInputOutput.mode & CRYPTO_OPERATIONMODE_SAVE_CONTEXT) == CRYPTO_OPERATIONMODE_SAVE_CONTEXT))
#else
      )
#endif
    {
...
# endif
#endif /* !(CRYPTO_30_VHSM_READWRITE_AVAILABLE == STD_ON) */
        {
