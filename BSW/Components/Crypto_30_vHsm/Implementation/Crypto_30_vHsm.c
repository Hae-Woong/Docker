...
#if (  (CRYPTO_30_VHSM_MAJOR_VERSION != (4u)) \
    || (CRYPTO_30_VHSM_MINOR_VERSION != (0u)) \
    || (CRYPTO_30_VHSM_PATCH_VERSION != (1u)) )
...
/*!
 *
 * \brief       Use the Ipc to transmit a job request
 * \details     -
  ...
  boolean cancel)
{
  ...
  if (Crypto_30_vHsm_IsCryptoJobAccepted(jobRequestId, job->jobInfo->jobId) == E_OK) /* SBSW_CRYPTO_30_VHSM_STACK_VARIABLE_AS_PTR */
  {
    ...
    Crypto_30_vHsm_SetContextClassOfJobRequest(jobRequestId, CRYPTO_30_VHSM_CALLOUT_CRYPTOJOB); /* SBSW_CRYPTO_30_VHSM_CSL02_OBJECTINFO */
    Crypto_30_vHsm_SetContextIdOfJobRequest(jobRequestId, Crypto_30_vHsm_GetCryptoJobOfJobRequest(jobRequestId)->jobInfo->jobId); /* SBSW_CRYPTO_30_VHSM_CSL02_OBJECTINFO */
#endif
    ...
    retVal = Crypto_30_vHsm_ProcessJobRequest(jobRequestId, Crypto_30_vHsm_GetCurrentPartitionIdxOfObjectInfo(jobRequestId));
  ...
  Crypto_30_vHsm_PartitionIdentifiersIterType partitionIdx)
{
  /* ----- Local Variables ---------------------------------------------- */
  Std_ReturnType retVal;
  Crypto_30_vHsm_ChannelIdType channel = Crypto_30_vHsm_GetIpcChannelsOfvHsm(partitionIdx);

  /* ----- Implementation ----------------------------------------------- */
#if (CRYPTO_30_VHSM_MULTI_PARTITION_RUNTIME_CHECKS == STD_ON)
  /* Check if the driver object is used by the correct partition */
  if (Crypto_30_vHsm_GetApplicationIdOfObjectInfo(jobRequestId) != GetApplicationID())
  {
# if (CRYPTO_30_VHSM_DEV_ERROR_REPORT == STD_ON)
    /* #40 Call the Det */
    (void)Det_ReportError(CRYPTO_30_VHSM_MODULE_ID, CRYPTO_30_VHSM_INSTANCE_ID, CRYPTO_30_VHSM_SID_PROCESS_JOB_REQUEST, CRYPTO_E_PARAM_HANDLE);
# endif
    retVal = E_NOT_OK;
  }
  else
#endif /* (CRYPTO_30_VHSM_MULTI_PARTITION_RUNTIME_CHECKS == STD_ON) */
  ...
  else
  {
    ...
    if (retVal == E_OK)
    {
      ...
      Crypto_30_vHsm_Ipc_GetTxChannelWriteIdx(partitionIdx, channel) += 1u; /* PRQA S 0310, 3305 */ /* MD_CRYPTO_30_VHSM_IPC_MACRO */ /* SBSW_CRYPTO_30_VHSM_SET_VALUE_IN_IPC */

      Crypto_30_vHsm_TriggerInterruptOfPartition(partitionIdx); /* PRQA S 0303 */ /* MD_CRYPTO_30_VHSM_TRIGGER_INTERRUPT */

      /* #30 Check if it is a synchronous job */
      if (Crypto_30_vHsm_GetProcessingTypeOfJobRequest(jobRequestId) == CRYPTO_PROCESSING_SYNC)
      {
#if (CRYPTO_30_VHSM_TIMEOUT_CALLOUT == STD_ON)
        Crypto_30_vHsm_TimeoutDetect_Start_Callout( /* PRQA S 0404 */ /* MD_CRYPTO_30_VHSM_0404_VOLATILE_READ */
          CRYPTO_30_VHSM_CALLOUT_JOBREQUEST,
        ...
        while (Crypto_30_vHsm_GetStateOfJobRequest(jobRequestId) == CRYPTO_30_VHSM_JOBREQUEST_STATE_PROCESSING) /* FETA_CRYPTO_30_VHSM_WAIT_FOR_HSM_WITH_CALLOUT */
        {
          /* #32 Process the job response available in the IPC if interrupt mode is disabled */
          Crypto_30_vHsm_Ipc_ReceiveResponse(partitionIdx, channel);

#if (CRYPTO_30_VHSM_WAIT_LOOP_CALLOUT_ENABLED == STD_ON)
          Crypto_30_vHsm_GetWaitLoopCallout()();
#endif
#if (CRYPTO_30_VHSM_TIMEOUT_CALLOUT == STD_ON)
          Crypto_30_vHsm_TimeoutDetect_Loop_Callout( /* PRQA S 0404 */ /* MD_CRYPTO_30_VHSM_0404_VOLATILE_READ */
            CRYPTO_30_VHSM_CALLOUT_JOBREQUEST,
            Crypto_30_vHsm_GetHsmObjIdOfObjectInfo(jobRequestId),
            Crypto_30_vHsm_GetContextClassOfJobRequest(jobRequestId),
            Crypto_30_vHsm_GetContextIdOfJobRequest(jobRequestId));
    ...
    else
    {
      ...
      if (channel < Crypto_30_vHsm_GetSizeOfChannelState(partitionIdx))
      {
        Crypto_30_vHsm_SetChannelState(channel, CRYPTO_30_VHSM_IPC_CHANNELSTATE_FREE, partitionIdx); /* SBSW_CRYPTO_30_VHSM_CSL01_CHANNELSTATE */
      }
#endif
      Crypto_30_vHsm_SetStateOfJobRequest(jobRequestId, CRYPTO_30_VHSM_JOBREQUEST_STATE_IDLE ); /* SBSW_CRYPTO_30_VHSM_CSL02_OBJECTINFO */
    }
  ...
  P2VAR(Crypto_30_vHsm_ChannelIdType, AUTOMATIC, CRYPTO_30_VHSM_APPL_VAR) channel)
{
  ...
  SchM_Enter_Crypto_30_vHsm_CRYPTO_30_VHSM_EXCLUSIVE_AREA_0();
  for (txChannelIdTmp = 0u; txChannelIdTmp < Crypto_30_vHsm_GetSizeOfChannelState(partitionIdx); txChannelIdTmp++)
  {
    if (Crypto_30_vHsm_GetChannelState(txChannelIdTmp, partitionIdx) == CRYPTO_30_VHSM_IPC_CHANNELSTATE_FREE)
    {
      *channel = txChannelIdTmp; /* SBSW_CRYPTO_30_VHSM_VARIABLE_ACCESS_PTR_FROM_STACK */
      Crypto_30_vHsm_SetChannelState(txChannelIdTmp, (Crypto_30_vHsm_ChannelStateType)(Crypto_30_vHsm_GetProcessingTypeOfJobRequest(jobRequestId) + 1u), partitionIdx); /* SBSW_CRYPTO_30_VHSM_CSL01_CHANNELSTATE */
      break;
    }
  }
  SchM_Exit_Crypto_30_vHsm_CRYPTO_30_VHSM_EXCLUSIVE_AREA_0();

  if (txChannelIdTmp >= Crypto_30_vHsm_GetSizeOfChannelState(partitionIdx))
  {
    retVal = CRYPTO_E_BUSY;
  }
  else
...
FUNC(void, CRYPTO_30_VHSM_CODE) Crypto_30_vHsm_Init(void)
{
  ...
  Crypto_30_vHsm_PartitionIdentifiersIterType partitionIdx = Crypto_30_vHsm_GetCurrentPartitionIdx();

  /* ----- Development Error Checks ------------------------------------- */
#if (CRYPTO_30_VHSM_DEV_ERROR_DETECT == STD_ON)
  /* #10 Check initialization state of the component for the partition */
  if (Crypto_30_vHsm_GetPartitionInitialized(partitionIdx) == (uint8)CRYPTO_30_VHSM_INITIALIZED)
  {
    errorId = CRYPTO_E_INIT_FAILED;
  }
  else
#endif /* (CRYPTO_30_VHSM_DEV_ERROR_DETECT == STD_ON) */
  {
    /* ----- Implementation ----------------------------------------------- */
...
# endif
    ...
    for (txChannel = 0u; txChannel < Crypto_30_vHsm_GetSizeOfChannelState(partitionIdx); txChannel++)
    {
      Crypto_30_vHsm_SetChannelState(txChannel, CRYPTO_30_VHSM_IPC_CHANNELSTATE_FREE, partitionIdx); /* SBSW_CRYPTO_30_VHSM_CSL01_CHANNELSTATE */
    }

#if (CRYPTO_30_VHSM_IPC_PROTOCOL_VERSION == 2u)
    Crypto_30_vHsm_Ipc_DriverProtocolVersion(partitionIdx) = CRYPTO_30_VHSM_IPC_PROTOCOL_VERSION; /* PRQA S 0310, 3305 */ /* MD_CRYPTO_30_VHSM_IPC_MACRO */ /* SBSW_CRYPTO_30_VHSM_SET_VALUE_IN_IPC */
#endif
    ...
    {
#if (CRYPTO_30_VHSM_NUMBER_OF_IPC_INSTANCES > 1u)
      /* Initialize only the objects mapped to the current partition */
      if (Crypto_30_vHsm_GetPartitionIdxOfObjectInfo(objectInfo) == partitionIdx)
#endif
      {
    ...
    /* #40 Set module state to initialized for the partition */
#if (CRYPTO_30_VHSM_DEV_ERROR_DETECT == STD_ON)
    Crypto_30_vHsm_SetPartitionInitialized(CRYPTO_30_VHSM_INITIALIZED, partitionIdx); /* SBSW_CRYPTO_30_VHSM_WRITE_PARTITION_DATA */
#endif
  }
  ...
  P2VAR(Crypto_JobType, AUTOMATIC, CRYPTO_30_VHSM_APPL_VAR) job)
{
  ...
  /* ----- Development Error Checks ------------------------------------- */
#if (CRYPTO_30_VHSM_DEV_ERROR_DETECT == STD_ON)
  /* #9 Check plausibility of input parameters */
  /* [SWS_Crypto_00058] Check if driver object is valid */
  if (objectId >= Crypto_30_vHsm_GetSizeOfObjMap())
  {
  ...
  {
    /* ----- Implementation ----------------------------------------------- */
    /* #10 Get internal handle */
    if (Crypto_30_vHsm_IsObjectInfoUsedOfObjMap(objectId) == FALSE) /* SBSW_CRYPTO_30_VHSM_STACK_VARIABLE_AS_PTR */
    {
      /* [SWS_Crypto_00058] Check if object id is out of range */
      errorId = CRYPTO_E_PARAM_HANDLE;
    }
#if (CRYPTO_30_VHSM_DEV_ERROR_DETECT == STD_ON)
    /* #11 Check initialization state of the component */
    else if(Crypto_30_vHsm_GetPartitionInitialized(Crypto_30_vHsm_GetCurrentPartitionIdxOfObjectInfo(Crypto_30_vHsm_GetObjectInfoIdxOfObjMap(objectId))) == (uint8)CRYPTO_30_VHSM_UNINIT)
    {
...
#if (CRYPTO_30_VHSM_DEV_ERROR_DETECT == STD_ON)
    /* #11 Check if module is initialized */
    /* [SWS_Crypto_00057] Check initialization state of the component */
    else if (Crypto_30_vHsm_GetPartitionInitialized(Crypto_30_vHsm_GetCurrentPartitionIdxOfObjectInfo(Crypto_30_vHsm_GetObjectInfoIdxOfObjMap(objectId))) == (uint8)CRYPTO_30_VHSM_UNINIT)
    {
      errorId = CRYPTO_E_UNINIT;
...
{
  Crypto_30_vHsm_PartitionIdentifiersIterType partitionIdx = 0u;
  Crypto_30_vHsm_PartitionIdentifiersIterType partitionIdentifierIdx = 0u;
  ApplicationType applicationId = GetApplicationID();

  for (partitionIdentifierIdx = 0u; partitionIdentifierIdx < Crypto_30_vHsm_GetSizeOfPartitionIdentifiers(); partitionIdentifierIdx++)
  {
    if (applicationId == Crypto_30_vHsm_GetPartitionSNVOfPartitionIdentifiers(partitionIdentifierIdx))
    {
      partitionIdx = Crypto_30_vHsm_GetPCPartitionConfigIdxOfPartitionIdentifiers(partitionIdentifierIdx);
      break;
    }
  }
  return partitionIdx;
...
{
#if (CRYPTO_30_VHSM_FLAG_SETTING_CHECK_NEEDED == STD_ON)
  /* #10 Check if the interrupt triggering for the partition is enabled */
  if (Crypto_30_vHsm_GetFlagSetting(partitionIdx) == 1u)
#endif
  {
#if (CRYPTO_30_VHSM_INTERRUPT_SETTING_AVAILABLE ==STD_ON)
# if (CRYPTO_30_VHSM_IS_VTT == STD_OFF)
    /* #20 Check how the interrupt shall be trigegred for RealTarget */
    switch (Crypto_30_vHsm_GetFlagSetHandling(partitionIdx))
    {
#  if (CRYPTO_30_VHSM_INTERRUPT_SET_INCLUSIVE_OR_ASSIGNMENT_AVAILABLE == STD_ON)
    case CRYPTO_30_VHSM_SET_INCLUSIVE_OR_ASSIGNMENT:
      (*(volatile uint32*)((uint32)Crypto_30_vHsm_GetFlagSetAddress(partitionIdx))) |= Crypto_30_vHsm_GetFlagSetMask(partitionIdx); /* PRQA S 0303 */ /* MD_CRYPTO_30_VHSM_REGISTER_ACCESS */ /* SBSW_CRYPTO_30_VHSM_REGISTER_ACCESS */
      break;
#  endif
#  if (CRYPTO_30_VHSM_INTERRUPT_SET_CALLOUT_AVAILABLE == STD_ON)
    case CRYPTO_30_VHSM_SET_CALLOUT:
      Crypto_30_vHsm_RequestInterruptSet_Callout(Crypto_30_vHsm_GetFlagSetAddress(partitionIdx), Crypto_30_vHsm_GetFlagSetMask(partitionIdx)); /* SBSW_CRYPTO_30_VHSM_HANDLE_INTERRUPT */
      break;
#  endif
#  if (CRYPTO_30_VHSM_INTERRUPT_SET_ONLY_ASSIGNMENT_AVAILABLE == STD_ON)
    case CRYPTO_30_VHSM_SET_ONLY_ASSIGNMENT:
      (*(volatile uint32*)((uint32)Crypto_30_vHsm_GetFlagSetAddress(partitionIdx))) = Crypto_30_vHsm_GetFlagSetMask(partitionIdx); /* PRQA S 0303 */ /* MD_CRYPTO_30_VHSM_REGISTER_ACCESS */ /* SBSW_CRYPTO_30_VHSM_REGISTER_ACCESS */
      break;
#  endif
...
# else /* !(CRYPTO_30_VHSM_IS_VTT == STD_OFF) */
    /* #30 Call the helper funtion for VTT */
    Ht2Hsmf();
# endif
#endif /* (CRYPTO_30_VHSM_INTERRUPT_SETTING_AVAILABLE ==STD_ON) */
  }
...
{
#if (CRYPTO_30_VHSM_FLAG_CLEARING_CHECK_NEEDED == STD_ON)
  /* #10 Check if the interrupt clearing for the partition is enabled */
  if (Crypto_30_vHsm_GetFlagClearing(partitionIdx) == 1u) /*lint !e506 */
#endif
  {
#if (CRYPTO_30_VHSM_INTERRUPT_CLEARING_AVAILABLE ==STD_ON)
# if (CRYPTO_30_VHSM_IS_VTT == STD_OFF)
    /* #20 Check how the interrupt shall be clearded */
    switch (Crypto_30_vHsm_GetFlagClearHandling(partitionIdx))
    {
#  if (CRYPTO_30_VHSM_INTERRUPT_CLEAR_INCLUSIVE_AND_NOT_ASSIGNMENT_AVAILABLE == STD_ON)
    case CRYPTO_30_VHSM_CLEAR_INCLUSIVE_AND_NOT_ASSIGNMENT:
      (*(volatile uint32*)((uint32)Crypto_30_vHsm_GetFlagClearAddress(partitionIdx))) &= ~((uint32)Crypto_30_vHsm_GetFlagClearMask(partitionIdx)); /* PRQA S 0303 */ /* MD_CRYPTO_30_VHSM_REGISTER_ACCESS */ /* SBSW_CRYPTO_30_VHSM_REGISTER_ACCESS */
      break;
#  endif
#  if (CRYPTO_30_VHSM_INTERRUPT_CLEAR_INCLUSIVE_OR_ASSIGNMENT_AVAILABLE == STD_ON)
    case CRYPTO_30_VHSM_CLEAR_INCLUSIVE_OR_ASSIGNMENT:
      (*(volatile uint32*)((uint32)Crypto_30_vHsm_GetFlagClearAddress(partitionIdx))) |= Crypto_30_vHsm_GetFlagClearMask(partitionIdx); /* PRQA S 0303 */ /* MD_CRYPTO_30_VHSM_REGISTER_ACCESS */ /* SBSW_CRYPTO_30_VHSM_REGISTER_ACCESS */
      break;
#  endif
#  if (CRYPTO_30_VHSM_INTERRUPT_CLEAR_CALLOUT_AVAILABLE == STD_ON)
    case CRYPTO_30_VHSM_CLEAR_CALLOUT:
      Crypto_30_vHsm_ResponseInterruptClear_Callout(Crypto_30_vHsm_GetFlagClearAddress(partitionIdx), Crypto_30_vHsm_GetFlagClearMask(partitionIdx), Crypto_30_vHsm_GetFlagClearValue(partitionIdx)); /* SBSW_CRYPTO_30_VHSM_HANDLE_INTERRUPT */
      break;
#  endif
#  if (CRYPTO_30_VHSM_INTERRUPT_CLEAR_ONLY_READ_AVAILABLE == STD_ON)
    case CRYPTO_30_VHSM_CLEAR_ONLY_READ:
      {
        volatile uint32 dummy = (*(volatile uint32*)(uint32)Crypto_30_vHsm_GetFlagClearAddress(partitionIdx)); /* PRQA S 3205, 0303 */ /* MD_CRYPTO_30_VHSM_3205_DUMMY_READ */
        CRYPTO_30_VHSM_DUMMY_STATEMENT(dummy); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
      }
      break;
#  endif /* (CRYPTO_30_VHSM_INTERRUPT_CLEAR_ONLY_READ_AVAILABLE == STD_ON) */
    default: /* COV_CRYPTO_30_VHSM_MISRA_ADDITIONAL_STATEMENT */ /* PRQA S 2016 */ /* MD_MSR_EmptyClause */
      break;
    }
# endif /* (CRYPTO_30_VHSM_IS_VTT == STD_OFF) */
#endif /* (CRYPTO_30_VHSM_INTERRUPT_CLEARING_AVAILABLE ==STD_ON) */
  }
...
{
#if (CRYPTO_30_VHSM_NUMBER_OF_IPC_INSTANCES>1)
  SchM_Enter_Crypto_30_vHsm_CRYPTO_30_VHSM_EXCLUSIVE_AREA_4();
  *(volatile uint32*)CRYPTO_30_VHSM_HOST2_HSM_ADDRESS |= (uint32)((uint32)1u << (uint32)Crypto_30_vHsm_GetIpcInstanceId(partitionIdx)); /* PRQA S 0303 */ /* MD_CRYPTO_30_VHSM_REGISTER_ACCESS */ /* SBSW_CRYPTO_30_VHSM_REGISTER_ACCESS */
  SchM_Exit_Crypto_30_vHsm_CRYPTO_30_VHSM_EXCLUSIVE_AREA_4();
#else
  Crypto_30_vHsm_IndicateInitializedIpc(); /* PRQA S 0303 */ /* MD_CRYPTO_30_VHSM_REGISTER_ACCESS */ /* SBSW_CRYPTO_30_VHSM_REGISTER_ACCESS */
  CRYPTO_30_VHSM_DUMMY_STATEMENT(partitionIdx); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
#endif /* !(CRYPTO_30_VHSM_NUMBER_OF_IPC_INSTANCES>1) */
} /* Crypto_30_vHsm_IndicateInitializedIpcOfPartition() */
...
{
  /* #10 Call partiion handler function with default partition */
  Crypto_30_vHsm_Ipc_WaitForHsmRamForPartition(Crypto_30_vHsm_GetCurrentPartitionIdx());
} /* Crypto_30_vHsm_WaitForHsmRam() */
...
FUNC(Std_ReturnType, CRYPTO_30_VHSM_CODE) Crypto_30_vHsm_WaitForHsmRamForApplication(ApplicationType applicationId)
{
  ...
  for (partitionIdentifierIdx = 0u; partitionIdentifierIdx < Crypto_30_vHsm_GetSizeOfPartitionIdentifiers(); partitionIdentifierIdx++)
  {
    if (applicationId == Crypto_30_vHsm_GetPartitionSNVOfPartitionIdentifiers(partitionIdentifierIdx))
    {
      /* #10 Call partition handler function with partition of the passed application if a matching one is found */
      Crypto_30_vHsm_Ipc_WaitForHsmRamForPartition(Crypto_30_vHsm_GetPCPartitionConfigIdxOfPartitionIdentifiers(partitionIdentifierIdx));
      retVal = E_OK;
      break;
    }
  }
...
MD_CRYPTO_30_VHSM_0404_VOLATILE_READ
Reason:       Volatile reads could have side-effects. More than 1 volatile read is done at a sequence point, so the order of the read cannot be guaranteed.
Risk:         None, as no registers with side-effects are read.
Prevention:   Covered by code review.

MD_CRYPTO_30_VHSM_3415_LOGICAL_OPERATOR
Reason:       Volatile reads could have side-effects. The right side of the logical operator may not get evaluated and therefore doesn't produce the side-effect.
Risk:         None, as no registers with side-effects are read or access is enclosed via exclusive areas
Prevention:   Covered by code review.

MD_CRYPTO_30_VHSM_3205_DUMMY_READ
Reason:       Read to a dummy variable needs to be performed to clear interrupts. The read value will not be used.
Risk:         None, as reading the register to clear interrupt flags is required by the hardware.
Prevention:   Covered by code review.

MD_CRYPTO_30_VHSM_3205_SINGLE_PARTITION_IPC_ACCESS
Reason:       A variable is passed to a macro which does not use it when only a single partition is configured. The macro does not evaluate the parameter due to performance reasons and because it will be replaced by the constant 0u.
Risk:         None, as variable is not read in a specific configuration
Prevention:   Covered by code review.

MD_CRYPTO_30_VHSM_3206_SINGLE_PARTITION_IPC_ACCESS
Reason:       A parameter for the partition is passed and is not used when only a single partition is configured. The parameter will be replaced via a macro by the constant 0u due to performance reasons.
Risk:         None, as variable is not read in a specific configuration
Prevention:   Covered by code review.
...
\ID SBSW_CRYPTO_30_VHSM_HANDLE_INTERRUPT
\DESCRIPTION An address is accessed as uint32 to trigger the interrupt or clear the interrupt flag
\COUNTERMEASURE \S The address, mask and value is configured by the user and is platform dependant. The user must make sure to only provide a valid address. [SMI-427853]
...
\ID SBSW_CRYPTO_30_VHSM_IPC_MEMORY_PTR_ARRAY
\DESCRIPTION The array is accessed with an always valid partition index.
             The array is not generated via CSL via partition indirection because of performance reasons during access of the IPC in the multi partition use-case.
\COUNTERMEASURE \N The partition index is either 0 or a valid one is returned from Crypto_30_vHsm_GetCurrentPartitionIdx() which searches via CSL for a matching one.
                   Validations are in place that there will always be a match.

\ID SBSW_CRYPTO_30_VHSM_WRITE_PARTITION_DATA
...
\COUNTERMEASURE \N The index for the Partition specific data is either fixed (for single partition usecase) or provided by searching the current application id
                   in the PartitionIdentifiers and using its corresponding partitionIdx or passed as parameter (Qualified use-case CSL05 of ComStackLib).
                   Therefore it is guaranteed to be in the acceptable range.
...
/* FETA_JUSTIFICATION_BEGIN
 ...
 \ID FETA_CRYPTO_30_VHSM_WAIT_FOR_HSM_WITH_CALLOUT
 \DESCRIPTION The loop waits for an action done by the HSM core. This action could possibly never occur.
 \COUNTERMEASURE \N The loop can be terminated by using a callout which has to be implemented by the user.

 \ID FETA_CRYPTO_30_VHSM_MONOTONIC_LOOP_UP_WITH_UNCHANGED_BOUNDS_STATIC_GENDATA
