...
# define Crypto_30_vHsm_Ipc_GetRxChannelMemoryOffset(rxChannelId)     (Crypto_30_vHsm_Ipc_GetTxChannelMemoryOffset(CRYPTO_30_VHSM_IPC_CHANNELS) + \
...
#endif /* !defined (CRYPTO_30_VHSM_IPC_TYPES_H) */
