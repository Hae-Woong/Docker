...
typedef enum
{
  CRYPTO_30_VHSM_CALLOUT_JOBREQUEST = 0,
...
} Crypto_30_vHsm_CalloutIdType;

typedef enum
{
  CRYPTO_30_VHSM_CALLOUT_CRYPTOJOB = CRYPTO_30_VHSM_CRYPTO_JOBKIND,
  CRYPTO_30_VHSM_CALLOUT_KEYMJOB = CRYPTO_30_VHSM_KEYMANAGEMENT_JOBKIND,
  CRYPTO_30_VHSM_CALLOUT_NOT_DEFINED
} Crypto_30_vHsm_CalloutContextClassType;

#endif /* !defined (CRYPTO_30_VHSM_TYPES_H) */
