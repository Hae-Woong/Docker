...
# viszda        David Zentner             Vector Informatik GmbH              #
#-----------------------------------------------------------------------------#
...
# 2019/02/06   1.03.01  Cbl         Added support of component-based SIP structure
# 2020-03-02   2.00.01   viszda     SWAT-12                                   #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
Dlt_FILES               = Dlt$(BSW_SRC_DIR)\Dlt.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Dlt$(BSW_SRC_DIR)\Dlt.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Dlt_Lcfg.c
