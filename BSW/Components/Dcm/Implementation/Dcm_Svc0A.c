...
/**        \file  Dcm_Svc0A.c
 *         \unit  Svc0A
 *        \brief  Contains the implementation of Service 0x0A unit.
 *
 ...
 *********************************************************************************************************************/
#include "Dcm_Svc0A.h"
#if (DCM_SVC_0A_SUPPORT_ENABLED == STD_ON)                                                                                                           /* COV_MSR_UT_OPTIONAL_UNIT */
  ...
  )
{
  ...
  Dcm_ObdDtcManagerContextPtrType pRepContext = &Dcm_RepeaterGetSvc0AContext(pContext->ThreadId)->ReadDtcContext;
  ...
  )
{
  ...
  return Dcm_ObdDtcMgrCpyDemGetNxtFltrdDtc(pDataContext, ErrorCode,  &Dcm_RepeaterGetSvc0AContext(pContext->ThreadId)->ReadDtcContext);              /* SBSW_DCM_COMB_PTR_FORWARD */
}
# endif
