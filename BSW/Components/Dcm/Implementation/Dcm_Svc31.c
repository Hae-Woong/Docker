...
/**        \file  Dcm_Svc31.c
 *         \unit  Svc31
 *        \brief  Contains the implementation of Service 0x31 unit.
 *
 ...
 *  \return         Valid Svc31 thread context.
 *  \context        TASK
 *  \reentrant      TRUE
 *  \pre            -
 *********************************************************************************************************************/
 ...
 *
 */
DCM_LOCAL_INLINE FUNC(Std_ReturnType, DCM_CODE) Dcm_Svc31Handler(                                                                                    /* PRQA S 6050, 6080 */ /* MD_MSR_STCAL, MD_MSR_STMIF */
  Dcm_ContextPtrType pContext,
  Dcm_OpStatusType opStatus,
  Dcm_MsgContextPtrType pMsgContext,
  Dcm_NegativeResponseCodePtrType ErrorCode,
  ...
  )
{
  ...
  lStdResult = Dcm_RidMgrRidLookUp(pContext->ThreadId
                                  ,opStatus
  ...
  )
{
  ...
  Dcm_Svc31RepeaterProxyContextPtrType pRepContext = Dcm_RepeaterGetSvc31Context(pContext->ThreadId);
