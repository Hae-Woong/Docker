...
/**        \file  Dcm_Svc03.c
 *         \unit  Svc03
 *        \brief  Contains the implementation of Service 0x03 unit.
 *
 ...
 *********************************************************************************************************************/
#include "Dcm_Svc03.h"
#if (DCM_SVC_03_SUPPORT_ENABLED == STD_ON)                                                                                                           /* COV_MSR_UT_OPTIONAL_UNIT */
  ...
  )
{
  ...
  Dcm_ObdDtcManagerContextPtrType pRepContext = &Dcm_RepeaterGetSvc03Context(pContext->ThreadId)->ReadDtcContext;
  ...
  )
{
  ...
  return Dcm_ObdDtcMgrCpyDemGetNxtFltrdDtc(pDataContext, ErrorCode, &Dcm_RepeaterGetSvc03Context(pContext->ThreadId)->ReadDtcContext);               /* SBSW_DCM_COMB_PTR_FORWARD */
}
# endif
