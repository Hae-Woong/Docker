...
/**        \file  Dcm_Svc19Uti.c
 *         \unit  Svc19Uti
 *        \brief  Contains the implementation of Service 0x19 Utilities unit.
 *
...
# if (DCM_SVC_19_UTI_SELECTDTC_ENABLED == STD_ON)
/*! DEM API "SelectDTC" result to NRC map */
DCM_LOCAL CONST(uint8, DCM_CONST) Dcm_Svc19UtiNrcMapSelectDTC[3] =                                                                                   /* PRQA S 3218 */ /* MD_Dcm_CodingRule_3218 */
{
 ...
 *
 */
DCM_LOCAL_INLINE FUNC(Std_ReturnType, DCM_CODE) Dcm_Svc19UtiCpyDemGetExtRecord(                                                                      /* PRQA S 6030, 6050 */ /* MD_MSR_STCYC, MD_MSR_STCAL */
  Dcm_DiagDataContextPtrType pDataContext,
  Dcm_NegativeResponseCodePtrType ErrorCode,
  Dcm_Svc19RepeaterProxyContextPtrType pRepContext
  )
  ...
  )
{
  ...
  case E_OK:
    ...
    break;
  default:
    *ErrorCode = Dcm_DemIfGetNrcForDemRetValue(lStdResult, Dcm_Svc19UtiNrcMapSelectDTC);                                                             /* SBSW_DCM_POINTER_FORWARD_GLOBAL */ /* SBSW_DCM_PARAM_PTR_WRITE */
    lStdResult = DCM_E_NOT_OK;
    break;
  }
  return lStdResult;
 ...
 *
 */
FUNC(Std_ReturnType, DCM_CODE) Dcm_Svc19UtiDemSetDTCFilter(                                                                                          /* PRQA S 6060 */ /* MD_MSR_STPAR */
  Dcm_NegativeResponseCodePtrType ErrorCode,
 ...
 *
 */
FUNC(Std_ReturnType, DCM_CODE) Dcm_Svc19UtiCopyData(                                                                                                 /* PRQA S 6050 */ /* MD_MSR_STCAL */
  Dcm_ContextPtrType pContext,                                                                                                                       /* PRQA S 3673 */ /* MD_Dcm_Design_3673 */
  Dcm_DiagDataContextPtrType pDataContext,
  Dcm_NegativeResponseCodePtrType ErrorCode,
  Dcm_Svc19RepeaterProxyContextPtrType pRepContext                                                                                                   /* PRQA S 3673 */ /* MD_Dcm_Design_3673 */
...
#  if (DCM_DEMIF_421_ENABLED == STD_ON)
      if (pRepContext->RecordNumList != NULL_PTR)
      {
        ...
        Dcm_DebugAssert((DCM_SVC_19_UTI_RECNUM_ALL != pRepContext->RecordNum), DCM_SID_INTERNAL, DCM_E_ILLEGAL_STATE);                               /* COV_DCM_RTM_DEV_DEBUG TX */
      }
#  endif
  ...
  )
{
  ...
  lDemResult = Dem_SetDTCFilterByExtendedDataRecordNumber(pRepContext->DemClientId, ExtendedDataRecordNumber, pRepContext->DtcFormat);
 ...
 *
 */
FUNC(Std_ReturnType, DCM_CODE) Dcm_Svc19UtiReportNumDtcByStatusMaskData(                                                                             /* PRQA S 6060 */ /* MD_MSR_STPAR */
  Dcm_ContextPtrType pContext,
  Dcm_Svc19UtiDemSetFilterClassType dsfClass,
  Dem_DTCSeverityType dtcSeverity,
  Dcm_MsgContextPtrType pMsgContext,
 ...
 *
 */
FUNC(Std_ReturnType, DCM_CODE) Dcm_Svc19UtiReportDtcByStatusMaskData(                                                                                /* PRQA S 6060 */ /* MD_MSR_STPAR */
  Dcm_ContextPtrType pContext,
  Dcm_Svc19UtiDemSetFilterClassType dsfClass,
...
# endif
/**********************************************************************************************************************
 *  Dcm_Svc19UtiGetObdUdsDtcSeparationFormat()
 *********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
 *
 */
FUNC(uint8, DCM_CODE) Dcm_Svc19UtiGetObdUdsDtcSeparationFormat(                                                                                      /* PRQA S 3219 */ /* MD_MSR_Unreachable */
  void
  )
{
# if (DCM_SVC_19_OBD_UDS_DTC_SEPARATION_ENABLED == STD_ON)
  return DEM_DTC_FORMAT_OBD_3BYTE;
# else
  return DEM_DTC_FORMAT_UDS;
# endif
}
# define DCM_STOP_SEC_CODE
# include "Dcm_MemMap.h"                                                                                                                             /* PRQA S 5087 */ /* MD_MSR_MemMap */
