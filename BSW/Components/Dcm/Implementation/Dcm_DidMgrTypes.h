 ...
 *         \unit  DidMgr
 *        \brief  Contains native types and forward declarations of DID Manager unit.
 *
...
#  define DCM_DIDMGR_OP_CODING                                       DCM_DID_OP_CODING
...
#  define DCM_DID_OP_CODING                                          ((Dcm_DidOpType)0x80u)
