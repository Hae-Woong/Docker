...
/* Authentication with PKI Certificate Exchange (APCE) handling */
# if (DCM_SVC_29_01_SUPPORT_ENABLED == STD_ON) || \
     (DCM_SVC_29_02_SUPPORT_ENABLED == STD_ON)
#  define DCM_AUTHMGR_APCE_INTERNAL_ENABLED                          STD_ON
# else
#  define DCM_AUTHMGR_APCE_INTERNAL_ENABLED                          STD_OFF
# endif
...
# if (DCM_NET_GENERIC_CONNECTION_ENABLED == STD_ON) ||\
     (DCM_DCM_AR_VERSION >= DCM_DCM_AR_VERSION_450)
#  define DCM_NET_CONNECTION_ID_ENABLED                              STD_ON
# else
#  define DCM_NET_CONNECTION_ID_ENABLED                              STD_OFF
# endif
...
# if (DCM_SPLIT_TASKS_ENABLED == STD_ON) && \
     (DCM_MULTI_THREAD_ENABLED == STD_OFF)
...
# define DCM_SID_SETPROGCONDITIONS                                   (0x61u) /*!< Service ID: Dcm_SetProgConditions() */
# define DCM_SID_GETPROGCONDITIONS                                   (0x62u) /*!< Service ID: Dcm_GetProgConditions() */
# define DCM_SID_INDICATIONFUNC                                      (0x65u) /*!< Service ID: Xxx_Indication() */
# define DCM_SID_CONFIRMATIONFUNC                                    (0x66u) /*!< Service ID: Xxx_Confirmation() */
# define DCM_SID_STARTPROTOCOL                                       (0x67u) /*!< Service ID: Xxx_StartProtocol() */
# define DCM_SID_SETDEAUTHENTICATEDROLE                              (0x79u) /*!< Service ID: Dcm_SetDeauthenticatedRole() */
...
# define DCM_SID_CSMSECURECODINGVALIDATIONFINISHED                   (0xB5u) /*!< Service ID: Dcm_CsmSecureCodingValidationFinished() */
# define DCM_SID_GETAUTHENTICATIONROLES                              (0xB6u) /*!< Service ID: Dcm_GetAuthenticationRoles() */
# define DCM_SID_SETCHANNELREADY                                     (0xB7u) /*!< Service ID: Dcm_SetChannelReady() */
# define DCM_SID_PREHANDLERFUNC                                      (0xB8u) /*!< Service ID: PreHandler() */
# define DCM_SID_POSTHANDLERFUNC                                     (0xB9u) /*!< Service ID: PostHandler() */
# define DCM_SID_DEAUTHENTICATECONNECTION                            (0xBAu) /*!< Service ID: Dcm_DeauthenticateConnection() */
# define DCM_SID_AUTHENTICATECONNECTION                              (0xBBu) /*!< Service ID: Dcm_AuthenticateConnection() */
# define DCM_SID_SETAUTHENTICATIONBYPASS                             (0xBCu) /*!< Service ID: Dcm_SetAuthenticationBypass() */
# define DCM_SID_SETROEACTIVATIONSTATE                               (0xBDu) /*!< Service ID: Dcm_SetRoeActivationState() */
...
/*! Positive response and negative response confirmation values */
# define DCM_POS_RESPONSE_SENT                                       (0x04u)  /*!< Positive response is sent */
# define DCM_POS_RESPONSE_FAILED                                     (0x05u)  /*!< Positive response is failed to be sent */
# define DCM_NEG_RESPONSE_SENT                                       (0x06u)  /*!< Negative response is sent */
# define DCM_NEG_RESPONSE_FAILED                                     (0x07u)  /*!< Negative repsonse is failed to be sent */
...
typedef P2CONST(Dcm_ContextType, TYPEDEF, DCM_VAR_NOINIT) Dcm_ContextConstPtrType;
typedef uint8 Dcm_EcuStartModeType;
typedef Dcm_MsgLenType Dcm_DiagBufferIndexType;
typedef Dcm_OpStatusType Dcm_ExtendedOpStatusType;
...
typedef P2CONST(Dcm_DiagP2TimingsType, TYPEDEF, DCM_VAR_NOINIT) Dcm_DiagP2TimingsConstPtrType;
