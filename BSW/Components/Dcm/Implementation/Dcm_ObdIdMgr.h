...
/**        \file  Dcm_ObdIdMgr.h
 *         \unit  ObdIdMgr
 *        \brief  Contains public types, function declarations and inline function definitions of OBD ID Manager unit.
 *
...
# if (DCM_OBDIDMGR_SUPPORT_ENABLED == STD_ON) || (DCM_OBDUDSIDMGR_SUPPORT_ENABLED == STD_ON)                                                         /* COV_MSR_UT_OPTIONAL_UNIT */
#  include "Dcm.h"
