...
/**        \file  Dcm_Uti.h
 *         \unit  Uti
 *        \brief  Contains public types, function declarations and inline function definitions of Utilities unit.
 *
...
/*! Returns the argument with the higher value */
# define Dcm_UtiMathMax(a, b)                                        (((a)>=(b))?(a):(b))                                                            /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Remove the sign of an integer */
# define Dcm_UtiMathAbs(a)                                           (((a)>=0)?(a):((a)*-1))                                                         /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
...
# define Dcm_UtiSetReqLength(msgContextPtr, value)                   ((msgContextPtr)->reqDataLen = (Dcm_MsgLenType)(value))                         /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
...
/**********************************************************************************************************************
 *  Dcm_UtiResetDataContext()
 *********************************************************************************************************************/
/*! \brief          Resets the data context.
 *  \details        -
 *  \param[out]     pDataContext    Pointer to the data context to be reset
 *  \context        TASK
 *  \reentrant      TRUE
 *  \synchronous    TRUE
 *  \pre            -
 *********************************************************************************************************************/
DCM_GLOBAL_INLINE FUNC(void, DCM_CODE) Dcm_UtiResetDataContext(
  Dcm_DiagDataContextPtrType pDataContext
  );
...
/**********************************************************************************************************************
 *  Dcm_UtiLookUpUint8IsEmpty()
 *********************************************************************************************************************/
/*! \brief          Checks if a byte table is empty.
 *  \details        -
 *  \param[in]      lookUpTable    Pointer to the table to be scanned (first element is table-size!)
 *  \return         TRUE           Table is empty
 *  \return         FALSE          Table containes values
 *  \context        ISR1|ISR2|TASK
 *  \reentrant      TRUE
 *  \synchronous    TRUE
 *  \pre            -
 *********************************************************************************************************************/
FUNC(boolean, DCM_CODE) Dcm_UtiLookUpUint8IsEmpty(
  Dcm_Uint8ConstDataPtrType lookUpTable
  );
...
# if !defined(DCM_NOUNIT_UTI)                                                                                                                        /* COV_DCM_NOUNIT TX */
/**********************************************************************************************************************
 *  Dcm_UtiBitSetGetRowIdxSafe()
 *********************************************************************************************************************/
/*!
  ...
  )
{
  ...
  DCM_IGNORE_UNREF_PARAM(bitsetSize);
 ...
 *
 */
DCM_GLOBAL_INLINE FUNC(void, DCM_CODE) Dcm_UtiResetDataContext(                                                                                      /* PRQA S 3219 */ /* MD_MSR_Unreachable */
  Dcm_DiagDataContextPtrType pDataContext
  )
{
  pDataContext->Usage    = 0u;                                                                                                                       /* SBSW_DCM_POINTER_WRITE_DATA_CONTEXT */
  pDataContext->AvailLen = pDataContext->Size;                                                                                                       /* SBSW_DCM_POINTER_WRITE_DATA_CONTEXT */
}
...
# endif /* !defined(DCM_NOUNIT_UTI) */
# define DCM_STOP_SEC_CODE
# include "Dcm_MemMap.h"                                                                                                                             /* PRQA S 5087 */ /* MD_MSR_MemMap */

#endif /* !defined(DCM_UTI_H) */

/**********************************************************************************************************************
 *  END OF FILE: Dcm_Uti.h
 *********************************************************************************************************************/
