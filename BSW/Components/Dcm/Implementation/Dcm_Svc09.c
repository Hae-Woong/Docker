...
/**        \file  Dcm_Svc09.c
 *         \unit  Svc09
 *        \brief  Contains the implementation of Service 0x09 unit.
 *
 ...
 *********************************************************************************************************************/
#include "Dcm_Svc09.h"
#if (DCM_SVC_09_SUPPORT_ENABLED == STD_ON)                                                                                                           /* COV_MSR_UT_OPTIONAL_UNIT */
  ...
  )
{
  ...
  Dcm_Svc09RepeaterProxyContextPtrType pRepContext = Dcm_RepeaterGetSvc09Context(pContext->ThreadId);
