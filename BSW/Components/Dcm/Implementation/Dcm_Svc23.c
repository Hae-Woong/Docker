...
/**        \file  Dcm_Svc23.c
 *         \unit  Svc23
 *        \brief  Contains the implementation of Service 0x23 unit.
 *
 ...
 *********************************************************************************************************************/
#include "Dcm_Svc23.h"
#if (DCM_SVC_23_SUPPORT_ENABLED == STD_ON)                                                                                                           /* COV_MSR_UT_OPTIONAL_UNIT */
  ...
  )
{
  ...
  Dcm_Svc23RepeaterProxyContextPtrType pRepContext = Dcm_RepeaterGetSvc23Context(pContext->ThreadId);
