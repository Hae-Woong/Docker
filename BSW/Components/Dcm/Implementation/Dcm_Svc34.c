...
/**        \file  Dcm_Svc34.c
 *         \unit  Svc34
 *        \brief  Contains the implementation of Service 0x34 unit.
 *
 ...
 *********************************************************************************************************************/
#include "Dcm_Svc34.h"
#if (DCM_SVC_34_SUPPORT_ENABLED == STD_ON)                                                                                                           /* COV_MSR_UT_OPTIONAL_UNIT */
# include "Dcm_Debug.h"
# include "Dcm_Uti.h"
  ...
  )
{
  ...
  Dcm_FblMgrSetDataTransferState(DCM_FBL_DOWNLOAD_STATE_READY_FOR_TRANSFER);
  ...
  )
{
  ...
  Dcm_Svc34RepeaterProxyContextPtrType pRepContext = Dcm_RepeaterGetSvc34Context(pContext->ThreadId);
