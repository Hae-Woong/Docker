...
/**        \file  Dcm_Svc14.c
 *         \unit  Svc14
 *        \brief  Contains the implementation of Service 0x14 unit.
 *
 ...
 *********************************************************************************************************************/
#include "Dcm_Svc14.h"
#if (DCM_SVC_14_SUPPORT_ENABLED == STD_ON)                                                                                                           /* COV_MSR_UT_OPTIONAL_UNIT */
...
# if (DCM_DEMIF_SVC_14_SELECT_DTC_ENABLED == STD_ON)
/**********************************************************************************************************************
  ...
  )
{
  ...
  Dcm_Svc14RepeaterProxyContextPtrType pRepContext = Dcm_RepeaterGetSvc14Context(pContext->ThreadId);
