...
/**        \file  Dcm_Svc37.c
 *         \unit  Svc37
 *        \brief  Contains the implementation of Service 0x37 unit.
 *
 ...
 *********************************************************************************************************************/
#include "Dcm_Svc37.h"
#if (DCM_SVC_37_SUPPORT_ENABLED == STD_ON)                                                                                                           /* COV_MSR_UT_OPTIONAL_UNIT */
# include "Dcm_Debug.h"
# include "Dcm_Uti.h"
  ...
  )
{
  ...
  if (Dcm_FblMgrGetDataTransferState() == DCM_FBL_DATATRANSFER_STATE_IDLE)
  {
  ...
  )
{
  ...
  Dcm_Svc37RepeaterProxyContextPtrType pRepContext = Dcm_RepeaterGetSvc37Context(pContext->ThreadId);
