...
/**        \file  Dcm_MemMgr.h
 *         \unit  MemMgr
 *        \brief  Contains public types, function declarations and inline function definitions of Memory Manager unit.
 *
 ...
 *  Dcm_MemMgrInit()
 *********************************************************************************************************************/
/*! \brief          Initializes the memory manager sub-component.
 *  \details        -
 *  \context        TASK
 *  \reentrant      FALSE
 *  \synchronous    TRUE
