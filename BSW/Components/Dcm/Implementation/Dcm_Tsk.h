...
/**        \file  Dcm_Tsk.h
 *         \unit  Tsk
 *        \brief  Contains public types, function declarations and inline function definitions of Task Manager unit.
 *
...
/*! Dcm_Svc86Task() configuration */
# if !defined (DCM_TSK_NUM_ROE)
...
# define DCM_TSK_ID_ROE                                              ((Dcm_TskTaskIdMemType)(DCM_TSK_ID_PGDBUF + DCM_TSK_NUM_PGDBUF))                   /*!< The task ID of the Dcm_Svc86Task() task */
...
# define DCM_TSK_EV_ALL_EVENTS                                       (Dcm_UtiMaxValueOfUintType(Dcm_TskTaskEvMemType))
...
# define DCM_TSK_EV_DIAG_WORK_CANCEL_OP                              ((Dcm_TskTaskEvMemType)0x0040u)  /*!< A background diagnostic request operation (e.g. paged-buffer processing) cancelation */
...
# define DCM_TSK_EV_DIAG_WORK_EXT_AUTHENTICATION                     ((Dcm_TskTaskEvMemType)0x0400u)  /*!< An external request for setting the deauthenticated role (via Dcm_SetDeauthenticatedRole()) */
# define DCM_TSK_EV_DIAG_WORK_EXT_SETAUTHBYPASS                      ((Dcm_TskTaskEvMemType)0x0800u)  /*!< An external request for enabling authentication bypass (via Dcm_SetAuthenticationBypass()) */
 ...
 *********************************************************************************************************************/
/*! \brief          Get event(s) of a task of a specific thread.
 ...
 *********************************************************************************************************************/
/*! \brief          Notifies a task for events of a specific thread.
 ...
 *********************************************************************************************************************/
/*! \brief          Clears event(s) of a task of a specific thread.
 ...
 *  \reentrant      TRUE
 *  \synchronous    TRUE
 *  \pre            Allowed to be called for single threaded tasks only
 *********************************************************************************************************************/
 ...
 *  Dcm_TskKillAllTasks()
 *********************************************************************************************************************/
/*! \brief          Kills all killable tasks of a specific thread.
 ...
 *********************************************************************************************************************/
/*! \brief          Revives all killed tasks of a specific thread.
 *  \details        -
 *  \param[in]      threadId  Active thread
 *  \context        TASK
 *  \reentrant      TRUE
...
#endif /* !defined(DCM_TSK_H) */

/**********************************************************************************************************************
 *  END OF FILE: Dcm_Tsk.h
 *********************************************************************************************************************/
