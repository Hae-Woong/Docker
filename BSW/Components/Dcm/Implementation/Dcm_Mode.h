...
/**        \file  Dcm_Mode.h
 *         \unit  Mode
 *        \brief  Contains public types, function declarations and inline function definitions of Mode Manager unit.
 *
 ...
 *  Refer to the module's header file.
 *********************************************************************************************************************/
#if !defined(DCM_MODE_H)
# define DCM_MODE_H

/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
# include "Dcm_ModeTypes.h"
# include "Dcm_Net.h"
...
#  define Dcm_ModeGetCommControlState(networkRef)                    (Dcm_NetPbCfgGetComCtrlChannelState(networkRef))                                /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#  define Dcm_ModeSetCommControlState(networkRef, mode)              (Dcm_NetPbCfgSetComControlChannelState((networkRef), (mode)))                   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
# else
...
#endif /* !defined(DCM_MODE_H) */

/**********************************************************************************************************************
 *  END OF FILE: Dcm_Mode.h
 *********************************************************************************************************************/
