...
/**        \file  Dcm_Svc19.c
 *         \unit  Svc19
 *        \brief  Contains the implementation of Service 0x19 unit.
 *
 ...
 *********************************************************************************************************************/
#include "Dcm_Svc19.h"
#if (DCM_SVC_19_SUPPORT_ENABLED == STD_ON)                                                                                                           /* COV_MSR_UT_OPTIONAL_UNIT */
# include "Dcm_Svc19Uti.h"
...
/**********************************************************************************************************************
 *  Dcm_Svc19GetObdUdsDtcSeparationFormatFFRec()
 *********************************************************************************************************************/
/*! \brief          Returns the DTC format depending on the freeze frame record number
 *  \details        -
 *  \param[in]      ffRec                            Freeze frame record number
 *  \return         DEM_DTC_FORMAT_OBD_3BYTE         The DTC format is OBD 3 bytes.
 *  \return         DEM_DTC_FORMAT_UDS               The DTC format is UDS.
 *  \context        TASK
 *  \reentrant      FALSE
 *  \pre            -
 *********************************************************************************************************************/
DCM_LOCAL_INLINE FUNC(uint8, DCM_CODE) Dcm_Svc19GetObdUdsDtcSeparationFormatFFRec(
  uint8 ffRec
  );
# endif

# if (DCM_SVC_19_06_SUPPORT_ENABLED == STD_ON) || (DCM_SVC_19_1A_SUPPORT_ENABLED == STD_ON)
/**********************************************************************************************************************
 *  Dcm_Svc19GetObdUdsDtcSeparationFormatExtDataRec()
 *********************************************************************************************************************/
/*! \brief          Returns the DTC format depending on the extended data record number
 *  \details        -
 *  \param[in]      extDataRec                       Extended data record number
 *  \return         DEM_DTC_FORMAT_OBD_3BYTE         The DTC format is OBD 3 bytes.
 *  \return         DEM_DTC_FORMAT_UDS               The DTC format is UDS.
 *  \context        TASK
 *  \reentrant      FALSE
 *  \pre            -
 *********************************************************************************************************************/
DCM_LOCAL_INLINE FUNC(uint8, DCM_CODE) Dcm_Svc19GetObdUdsDtcSeparationFormatExtDataRec(
  uint8 extDataRec
  );
# endif
  ...
  )
{
  ...
  pRepContext->DtcFormat = DEM_DTC_FORMAT_UDS;                                                                                                       /* SBSW_DCM_PARAM_PTR_WRITE */
  ...
  )
{
  ...
  if ((ffRec == 0x00u) || (ffRec == 0xF0u))
  {
    lResult = Dcm_Svc19UtiGetObdUdsDtcSeparationFormat();
  }
  else
  {
    lResult = DEM_DTC_FORMAT_UDS;
  }
  ...
  )
{
  ...
  if ((extDataRec >= 0x90u) && (extDataRec <= 0x9Fu))
  {
    lResult = Dcm_Svc19UtiGetObdUdsDtcSeparationFormat();
  }
  else
 ...
 *
 */
FUNC(Std_ReturnType, DCM_CALLOUT_CODE) Dcm_Service19Processor(                                                                                       /* PRQA S 6030, 6050 */ /* MD_MSR_STCYC, MD_MSR_STCAL */
  Dcm_ContextPtrType pContext,
  Dcm_OpStatusType opStatus,
  Dcm_MsgContextPtrType pMsgContext,
  Dcm_NegativeResponseCodePtrType ErrorCode
...
{
  Std_ReturnType lStdResult;
  Dcm_Svc19RepeaterProxyContextPtrType pRepContext = Dcm_RepeaterGetSvc19Context(pContext->ThreadId);
...
# if (DCM_SVC_19_UTI_COPY_LINEAR_DATA_ENABLED == STD_ON)
  case DCM_SVC19_PROGRESS_UTI_COPYLINEARDATA:
    ...
    break;
# endif
# if (DCM_SVC_19_UTI_SELECTDTC_ENABLED == STD_ON)
...
#  if (DCM_DEMIF_430_ENABLED == STD_ON) || (DCM_DEMIF_431_ENABLED == STD_ON)
  Dcm_Svc19RepeaterProxyContextConstPtrType pRepContext = Dcm_RepeaterGetSvc19Context(pContext->ThreadId);
#  endif
# endif
...
{
  Dcm_Svc19RepeaterProxyContextPtrType pRepContext = Dcm_RepeaterGetSvc19Context(pContext->ThreadId);
  uint8 lRecordId = Dcm_UtiGetReqDataAsU8Rel(pMsgContext, 3u);

  DCM_IGNORE_UNREF_PARAM(opStatus);
  DCM_IGNORE_UNREF_PARAM(ErrorCode);

  pRepContext->DtcFormat = Dcm_Svc19GetObdUdsDtcSeparationFormatFFRec(lRecordId);                                                                    /* SBSW_DCM_PARAM_PTR_WRITE */
 ...
 *
 */
FUNC(Std_ReturnType, DCM_CALLOUT_CODE) Dcm_Service19_05Processor(                                                                                    /* PRQA S 6050 */ /* MD_MSR_STCAL */
  Dcm_ContextPtrType pContext,
  Dcm_OpStatusType opStatus,
  Dcm_MsgContextPtrType pMsgContext,
  Dcm_NegativeResponseCodePtrType ErrorCode
  ...
  )
{
  ...
  pRepContext->DtcFormat = Dcm_Svc19GetObdUdsDtcSeparationFormatExtDataRec(lRecordId);                                                               /* SBSW_DCM_PARAM_PTR_WRITE */
  ...
  )
{
  ...
  if(lStdResult == E_OK)
  {
    ...
    Dcm_Svc19UtiPatchDtcStatusSetForFilter(&dtcStatusMask);                                                                                          /* SBSW_DCM_PARAM_PTR_WRITE */
  ...
  )
{
  ...
  pRepContext = Dcm_RepeaterGetSvc19Context(pContext->ThreadId);
  ...
  )
{
  ...
  pRepContext->DtcFormat = Dcm_Svc19GetObdUdsDtcSeparationFormatExtDataRec(lExtDataRecNumber);                                                       /* SBSW_DCM_PARAM_PTR_WRITE */
 ...
 *
 */
FUNC(Std_ReturnType, DCM_CALLOUT_CODE) Dcm_Service19_42Processor(                                                                                    /* PRQA S 6050, 6080 */ /* MD_MSR_STCAL, MD_MSR_STMIF */
  Dcm_ContextPtrType pContext,
  Dcm_OpStatusType opStatus,
  Dcm_MsgContextPtrType pMsgContext,
  Dcm_NegativeResponseCodePtrType ErrorCode
  )
{
  ...
  pRepContext->DtcFormat = Dcm_Svc19UtiGetObdUdsDtcSeparationFormat();                                                                               /* SBSW_DCM_PARAM_PTR_WRITE */
