...
/**        \file  Dcm_Svc07.c
 *         \unit  Svc07
 *        \brief  Contains the implementation of Service 0x07 unit.
 *
 ...
 *********************************************************************************************************************/
#include "Dcm_Svc07.h"
#if (DCM_SVC_07_SUPPORT_ENABLED == STD_ON)                                                                                                           /* COV_MSR_UT_OPTIONAL_UNIT */
  ...
  )
{
  ...
  Dcm_ObdDtcManagerContextPtrType pRepContext = &Dcm_RepeaterGetSvc07Context(pContext->ThreadId)->ReadDtcContext;
  ...
  )
{
  ...
  return Dcm_ObdDtcMgrCpyDemGetNxtFltrdDtc(pDataContext, ErrorCode, &Dcm_RepeaterGetSvc07Context(pContext->ThreadId)->ReadDtcContext);               /* SBSW_DCM_COMB_PTR_FORWARD */
}
# endif
