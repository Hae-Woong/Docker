...
/**        \file  Dcm_Svc35.c
 *         \unit  Svc35
 *        \brief  Contains the implementation of Service 0x35 unit.
 *
 ...
 *********************************************************************************************************************/
/*! Service 0x35 processing steps */
# define DCM_Svc35_PROGRESS_EXECUTEOP                                ((Dcm_RepeaterProgressType)(DCM_REPEATER_PROGRESS_USERS_FIRST + 0u))

/**********************************************************************************************************************
 *  LOCAL FUNCTION MACROS
 *********************************************************************************************************************/
/*! ProcessRequestDownoad is called */
# define Dcm_Svc35ProcessRequestUploadWrapper                        DCM_PROCESS_REQUEST_UPLOAD                                                      /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

# define DCM_FBL_DATA_IDENTIFIER                                     (0x40u)   /* parameter maxNumberOfBlockLength in the response of Service 0x35 always has a size of 4 bytes independent of the value */
 ...
 *  \pre            -
 *********************************************************************************************************************/
DCM_LOCAL_INLINE FUNC(Std_ReturnType, DCM_CODE) Dcm_Svc35Handler(
  Dcm_ContextPtrType pContext,
  Dcm_OpStatusType opStatus,
  Dcm_MsgContextPtrType pMsgContext,
  Dcm_NegativeResponseCodePtrType ErrorCode,
  Dcm_Svc35RepeaterProxyContextPtrType pRepContext
  );

/**********************************************************************************************************************
 *  Dcm_Svc35FinalizeProcessing()
 *********************************************************************************************************************/
/*! \brief          Finalize Processing for Service 0x35 Request Download.
 *  \details        -
 *  \param[in,out]  pMsgContext             Current message context
 *  \param[in,out]  pRepContext             Current repeater proxy context
 *  \context        TASK
 ...
 *  \pre            -
 *********************************************************************************************************************/
DCM_LOCAL_INLINE FUNC(void, DCM_CODE) Dcm_Svc35FinalizeProcessing(
  Dcm_MsgContextPtrType pMsgContext,
  Dcm_Svc35RepeaterProxyContextPtrType pRepContext
  );

/**********************************************************************************************************************
 *  Dcm_Svc35ProcessRequestUpload()
 *********************************************************************************************************************/
/*! \brief          Service 0x35 Request Upload.
 *  \details        -
 *  \param[in]      opStatus                The operations status
 *  \param[in,out]  pMsgContext             Current message context
 *  \param[out]     ErrorCode               The NRC
...
DCM_LOCAL_INLINE FUNC(Std_ReturnType, DCM_CODE) Dcm_Svc35ProcessRequestUpload(
  Dcm_OpStatusType opStatus,
  Dcm_MsgContextPtrType pMsgContext,
  Dcm_NegativeResponseCodePtrType ErrorCode,
  Dcm_Svc35RepeaterProxyContextPtrType pRepContext
...
DCM_LOCAL_INLINE FUNC(Std_ReturnType, DCM_CODE) Dcm_Svc35Handler(
  ...
  Dcm_MsgContextPtrType pMsgContext,
  Dcm_NegativeResponseCodePtrType ErrorCode,
  Dcm_Svc35RepeaterProxyContextPtrType pRepContext                                                                                                   /* PRQA S 3673 */ /* MD_Dcm_Design_3673 */
  )
{
  ...
  if (lStdResult == DCM_E_OK)
  {
    ...
    if (lStdResult == DCM_E_OK)
    {
      ...
      Dcm_RepeaterNextStep(pContext, DCM_Svc35_PROGRESS_EXECUTEOP);                                                                                  /* SBSW_DCM_PARAM_PTR_FORWARD */
  ...
  )
{
  ...
  Dcm_FblMgrSetDataTransferState(DCM_FBL_UPLOAD_STATE_READY_FOR_TRANSFER);
  Dcm_FblMgrSetBlockSequenceCounter(0u);
  Dcm_FblMgrSetRemainingBlockLength(pRepContext->MemoryBlock.Length);
  ...
  )
{
  ...
  lStdResult = Dcm_Svc35ProcessRequestUploadWrapper(opStatus
    ...
    else
    {
      if (pRepContext->MaxBlockLength > lBlockLength)
      {
        ...
        *ErrorCode = DCM_E_PANIC_NRC;                                                                                                                /* SBSW_DCM_PARAM_PTR_WRITE */
        Dcm_DebugReportError(DCM_SID_PROCESSREQUESTUPLOAD, DCM_E_INTERFACE_BUFFER_OVERFLOW);
      }
      else
      {
        Dcm_Svc35FinalizeProcessing(pMsgContext, pRepContext);                                                                                       /* SBSW_DCM_PARAM_PTR_FORWARD */
      }
    }
    break;
  case DCM_E_NOT_OK:
  ...
  default:
    lStdResult = DCM_E_NOT_OK;
    *ErrorCode = DCM_E_PANIC_NRC;                                                                                                                    /* SBSW_DCM_PARAM_PTR_WRITE */
    Dcm_DebugReportError(DCM_SID_PROCESSREQUESTUPLOAD, DCM_E_INTERFACE_RETURN_VALUE);
    break;
  }
 ...
 *
 */
FUNC(Std_ReturnType, DCM_CALLOUT_CODE) Dcm_Service35Processor(
  Dcm_ContextPtrType pContext,
  Dcm_OpStatusType opStatus,
  Dcm_MsgContextPtrType pMsgContext,
  Dcm_NegativeResponseCodePtrType ErrorCode
  )
{
  ...
  Dcm_Svc35RepeaterProxyContextPtrType pRepContext = Dcm_RepeaterGetSvc35Context(pContext->ThreadId);

  switch (Dcm_RepeaterGetProgress(pContext))                                                                                                         /* SBSW_DCM_PARAM_PTR_FORWARD */
  {
  case DCM_REPEATER_PROGRESS_SERVICE_HANDLER_INITIAL:
    lStdResult = Dcm_Svc35Handler(pContext, opStatus, pMsgContext, ErrorCode, pRepContext);                                                          /* SBSW_DCM_COMB_PTR_FORWARD */
    break;
  case DCM_Svc35_PROGRESS_EXECUTEOP:
    lStdResult = Dcm_Svc35ProcessRequestUpload(opStatus, pMsgContext, ErrorCode, pRepContext);                                                       /* SBSW_DCM_COMB_PTR_FORWARD */
    break;
