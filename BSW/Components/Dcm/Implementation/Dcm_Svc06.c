...
/**        \file  Dcm_Svc06.c
 *         \unit  Svc06
 *        \brief  Contains the implementation of Service 0x06 unit.
 *
 ...
 *********************************************************************************************************************/
#include "Dcm_Svc06.h"
#if (DCM_SVC_06_SUPPORT_ENABLED == STD_ON)                                                                                                           /* COV_MSR_UT_OPTIONAL_UNIT */
  ...
  )
{
  ...
  Dcm_Svc06RepeaterProxyContextPtrType pRepContext = Dcm_RepeaterGetSvc06Context(pContext->ThreadId);
