 ...
 *         \unit  RsrcMgr
 *        \brief  Contains native types and forward declarations of Resource Manager unit.
 *
...
#  define DCM_RSRCMGR_SERVICE_LOCK_LIST_SIZE                         DCM_NUM_THREADS
# endif
...
# if (DCM_MULTI_THREAD_ENABLED == STD_ON)
/*! Definition for the owner of a Service resource */
typedef uint8 Dcm_RsrcMgrServiceLockOwnerType;
# endif
