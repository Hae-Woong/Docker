...
/**        \file  Dcm_Svc01.c
 *         \unit  Svc01
 *        \brief  Contains the implementation of Service 0x01 unit.
 *
 ...
 *********************************************************************************************************************/
#include "Dcm_Svc01.h"
#if (DCM_SVC_01_SUPPORT_ENABLED == STD_ON)                                                                                                           /* COV_MSR_UT_OPTIONAL_UNIT */
  ...
  )
{
  ...
  Dcm_Svc01RepeaterProxyContextPtrType pRepContext = Dcm_RepeaterGetSvc01Context(pContext->ThreadId);
