...
/**        \file  Dcm_Svc19Uti.h
 *         \unit  Svc19Uti
 *        \brief  Contains public types, function declarations and inline function definitions of Service 0x19 Utilities unit.
 *
 ...
 *  Refer to the module's header file.
 *********************************************************************************************************************/
#if !defined(DCM_SVC19UTI_H)
# define DCM_SVC19UTI_H

/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
# include "Dcm_Svc19UtiTypes.h"
...
#   define DCM_SVC_19_UTI_SELECTDTC_ENABLED                          STD_ON
#  else
#   define DCM_SVC_19_UTI_SELECTDTC_ENABLED                          STD_OFF
#  endif
...
#  if (DCM_SVC_19_03_SUPPORT_ENABLED == STD_ON) || \
      (DCM_SVC_19_08_SUPPORT_ENABLED == STD_ON) || \
      (DCM_SVC_19_14_SUPPORT_ENABLED == STD_ON) || \
      (DCM_SVC_19_16_SUPPORT_ENABLED == STD_ON) || \
      (DCM_SVC_19_42_SUPPORT_ENABLED == STD_ON) || \
...
#   define Dcm_Svc19UtiPatchDtcStatusSetForFilter(dtcStatusMaskPtr)  { if((*(dtcStatusMaskPtr) & 0x0Cu) == 0x0Cu) {*(dtcStatusMaskPtr) |= 0x20u; }  } /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#  else
/*! Per default - patching of DTC status masks is not required */
#   define Dcm_Svc19UtiPatchDtcStatusSetForFilter(dtcStatusMaskPtr)  /* not used */
#  endif
 ...
 *  \details        This is shared utility function of the Repeater and paged-buffer.
 *  \param[in]      pContext        Pointer to the context
 *  \param[in]      pMsgContext     Pointer to current message context
 ...
 *********************************************************************************************************************/
 /*! \brief          Returns the DTC format whether it's a UDS format or an OBD format depending on a configuration parameter.
  *  \details        -
  *  \return         DEM_DTC_FORMAT_OBD_3BYTE         The DTC format is three bytes.
  ...
  *  \pre            -
  *********************************************************************************************************************/
FUNC(uint8, DCM_CODE) Dcm_Svc19UtiGetObdUdsDtcSeparationFormat(
  void
  );
...
#endif /* !defined(DCM_SVC19UTI_H) */

/**********************************************************************************************************************
 *  END OF FILE: Dcm_Svc19Uti.h
 *********************************************************************************************************************/
