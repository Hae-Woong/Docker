...
/**        \file  Dcm_DemIf.h
 *         \unit  DemIf
 *        \brief  Contains public types, function declarations and inline function definitions of Dem Interface unit.
 *
...
#  define DCM_DEMIF_SVC_04_SELECT_DTC_ENABLED                        STD_ON
# else
#  define DCM_DEMIF_SVC_04_SELECT_DTC_ENABLED                        STD_OFF
# endif

# if ((DCM_DEMIF_430_ENABLED == STD_ON) || (DCM_DEMIF_431_ENABLED == STD_ON)) && \
     (DCM_SVC_14_SUPPORT_ENABLED == STD_ON)
#  define DCM_DEMIF_SVC_14_SELECT_DTC_ENABLED                        STD_ON
# else
#  define DCM_DEMIF_SVC_14_SELECT_DTC_ENABLED                        STD_OFF
# endif
  ...
  )
{
  ...
  DCM_IGNORE_UNREF_PARAM(dtcFormat);
