...
/**        \file  Dcm_Svc04.c
 *         \unit  Svc04
 *        \brief  Contains the implementation of Service 0x04 unit.
 *
 ...
 *********************************************************************************************************************/
#include "Dcm_Svc04.h"
#if (DCM_SVC_04_SUPPORT_ENABLED == STD_ON)                                                                                                           /* COV_MSR_UT_OPTIONAL_UNIT */
...
# if (DCM_DEMIF_SVC_04_SELECT_DTC_ENABLED == STD_ON)
/**********************************************************************************************************************
...
{
  Std_ReturnType                       lStdResult;
  Dcm_Svc04RepeaterProxyContextPtrType pRepContext = Dcm_RepeaterGetSvc04Context(pContext->ThreadId);
