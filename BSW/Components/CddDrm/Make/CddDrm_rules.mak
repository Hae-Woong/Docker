...
#------------------------------------------------------------------------------
# 1.00.00   2015-12-11  Ade       Initial Version
# 1.00.01   2016-07-22  Ade       ESCAN00091114: Incorrect filename used
# 1.01.00   2019-02-06  vircbl    Added support of component-based SIP structure
# 4.00.00   2020-07.28  vsarcmiem CARC-340 vDrm P2 timer: Add LL functionality
#------------------------------------------------------------------------------
...
LIBRARIES_TO_BUILD      += CddDrm
CddDrm_FILES             = CddDrm$(BSW_SRC_DIR)\CddDrm.c CddDrm$(BSW_SRC_DIR)\CddDrm_LowerLayer.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += CddDrm$(BSW_SRC_DIR)\CddDrm.c CddDrm$(BSW_SRC_DIR)\CddDrm_LowerLayer.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\CddDrm_Cfg.c
