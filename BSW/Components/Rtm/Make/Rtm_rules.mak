...
#------------------------------------------------------------------------------
# 1.00.00   2013-05-02  Azb     Initial Version
...
LIBRARIES_TO_BUILD      += Rtm
Rtm_FILES               = Rtm$(BSW_SRC_DIR)\Rtm.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Rtm$(BSW_SRC_DIR)\Rtm.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Rtm_Cfg.c
