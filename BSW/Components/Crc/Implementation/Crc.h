 ...
 *  07.00.00  2022-02-22  Eno     MWDG-5805      Generate Crc_MemMap.h
 *  07.00.01  2022-10-04  Eno     MWDG-6789      Finite Execution Time Analysis on CRCLib
 *  08.00.00  2024-01-22  speter  MEMSLP-9225    Provide CRC calculation for E2E Profile J1939-76 
 **********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
/*!
 * \brief      Calculates 32-bit SAE-J1939-76 CRC value of passed data
 * \details    Calculates 32-bit CRC value of data pointed to by Crc_DataPtr over a number of data bytes (Crc_Length)
 *             based on E2E Profile J193976.
 * \param[in]  Crc_DataPtr - Pointer to start address of data block to be calculated.
 * \param[in]  Crc_Length - Length of data block to be calculated in bytes
 * \param[in]  Crc_StartValue32 - Start value when the algorithm starts.
 * \param[in]  Crc_IsFirstCall - TRUE: First call in a sequence; start from initial value; ignore Crc_StartValue32
 *                               FALSE: Subsequent call in a call sequence; Crc_StartValue32 has to be return value 
 *                                      of previous call
 * \return     Calculated CRC32 PJ193976 value
 * \pre        -
 * \context    TASK
 * \reentrant  TRUE
 * \synchronous TRUE
 * \trace CREQ-Profile-SAE-J1939-76
 * \trace DSGN-Profile-SAE-J1939-76
 */
