############################################################################### 
# File Name  : FrTrcv_30___Your_Trcv___rules.mak 
...
# 1.02.00   2008-02-05  Hr      Adapted to AUTOSAR FrTrcv
# 1.03.00   2008-04-30  fbg     Changes for ASR library support
# 1.04.00   2009-04-21  Ore     Renamed FrTrcv to FrTrcv_Tja1080
# 1.05.00   2009-11-16  lo      no usage of template c files
...
LIBRARIES_TO_BUILD      += FrTrcv_30_Generic
FrTrcv_30_Tja1080_FILES  = FrTrcv_30_Generic\FrTrcv_30___Your_Trcv__.c

# e.g.: CC_FILES_TO_BUILD += drv\can_drv.c
CC_FILES_TO_BUILD       += FrTrcv_30_Generic$(BSW_SRC_DIR)\FrTrcv_30___Your_Trcv__.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\FrTrcv_30___Your_Trcv___Cfg.c
