############################################################################### 
# File Name  : FrTrcv_30___Your_Trcv___defs.mak 
...
# REVISION HISTORY
#------------------------------------------------------------------------------
# Refer to the FrTrcv_30___Your_Trcv___rules.mak file.
############################################################################### 
...
FRTRCV_CORE_PATH        = FrTrcv_30_Generic\
FRTRCV_OUTPUT_PATH      = $(GENDATA_DIR)
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     += FrTrcv_30_Generic$(BSW_SRC_DIR)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
