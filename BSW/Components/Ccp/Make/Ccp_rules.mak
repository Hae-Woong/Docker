...
LIBRARIES_TO_BUILD      += Ccp
Ccp_FILES                = Ccp$(BSW_SRC_DIR)\Ccp.c Ccp$(BSW_SRC_DIR)\Ccp_Tl.c

# e.g.: CC_FILES_TO_BUILD       += <MSN>\<MSN>.c <MSN>\<MSN>_Irq.c
CC_FILES_TO_BUILD       += Ccp$(BSW_SRC_DIR)\Ccp.c Ccp$(BSW_SRC_DIR)\Ccp_Tl.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Ccp_Cfg.c $(GENDATA_DIR)\Ccp_PBcfg.c
