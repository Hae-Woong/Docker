...
| 2017-10-17  3.00.01  Hr      ESCAN00096893: Measurement can not be stopped - START_STOP checks for prescaler even in stop mode
|                              ESCAN00094891: Compiler error: 'STATIC' not defined
| 2017-11-29  3.00.02  Hr      ESCAN00097492: Out of bounds access during DAQ list assembly
|***************************************************************************/
...
#endif
#if ( CP_ASR4CCP_RELEASE_VERSION != 0x02u )
  #error "Source and Header file of CCP-Module inconsistent!"
#endif
...
STATIC FUNC(uint32, CCP_CODE) Ccp_SampleAndTransmitDtm( CCP_BYTE pid, CCP_BYTE daq, CCP_BYTE odt )
{
  ...
  /* Sample */
    ...
    /* ESCAN00097492 */
    el = e+7; /* PRQA S 0488 */ /* MD_Ccp_0488 */
    d = &dtm[1];
    dl = d+7; /* PRQA S 0488 */ /* MD_Ccp_0488 */
    /* ESCAN00093488 */
    while ((e<el) && ((d+(e->siz))<=dl) && (e->ptr)) /* PRQA S 0488 */ /* MD_Ccp_0488 */
    {
      ...
      case CC_GET_DAQ_SIZE: /* Return the size of a DAQ list and clear */
        {
          ...
          #define daqId   (*(P2VAR(CCP_DWORD, AUTOMATIC, CCP_APPL_VAR))&com[4]) /* PRQA S 0842 */ /* MD_Ccp_0842 */
            ...
            ccp.Crm[4] = (uint8)(daqList * Ccp_GetMaxOdt()); /* PID of the first ODT */
              ...
              if((daqId & 0x7FFFFFFF) != Ccp_CanGetCurrentCANId()) /* PRQA S 0310, 3305 */ /* MD_Ccp_0310 */ /* MD_Ccp_3305 */
              {
                ccp.Crm[1] = CRC_OUT_OF_RANGE;
              }
            #endif
          ...
          else
          {
            switch (ssCmd)
            {
              ...
              case 1: /* start */
                ...
                if( ssPrescaler == 0 ) /* PRQA S 0310, 3305 */ /* MD_Ccp_0310 */ /* MD_Ccp_3305 */
                {
                  ccp.Crm[1] = CRC_OUT_OF_RANGE;
                }
                else
