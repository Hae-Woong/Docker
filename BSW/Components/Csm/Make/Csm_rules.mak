...
#------------------------------------------------------------------------------
# 1.00.00   2012-10-01  visrpp  Creation for ASR 4.0.3
# 1.00.01   2017-08-21  visrpp  Updated to new template
# 1.01.00   2019-02-06  vircbl  Added support of component-based SIP structure
# 1.02.00   2019-11-25  visenc  Added new file
#------------------------------------------------------------------------------
...
Csm_FILES                = Csm$(BSW_SRC_DIR)\Csm.c Csm$(BSW_SRC_DIR)\Csm_Rte.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Csm$(BSW_SRC_DIR)\Csm.c Csm$(BSW_SRC_DIR)\Csm_Rte.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Csm_*Cfg.c
