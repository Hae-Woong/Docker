 ...
 *********************************************************************************************************************/
/*! \brief        Add an ARP Entry, if the address is already present, update this entry
 *  \details      -
 *  \pre          -
 *  \return       E_OK                  Address is added to ARP table
 *                E_NOT_OK              Address is not added to ARP table
 *  \context      TASK
 *  \reentrant    FALSE
 *  \synchronous  TRUE
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
/*! \brief        Remove an ARP Entry based on the IPaddress
 *  \details      -
 *  \pre          -
 *  \return       E_OK                  At least one entry was cleared
 *                E_NOT_OK              Address was not found in dynamic table
 *  \context      TASK
 *  \reentrant    FALSE
 *  \synchronous  TRUE
 *********************************************************************************************************************/
 ...
 *                                        \spec requires (SocketIdx < TcpIp_GetSizeOfIpV4SocketDyn() || SocketIdx == IPV4_INV_SOCK_IDX); \endspec
