 ...
 *  \param[in]     DhcpV4ServerAddrLeaseRecsIdx       IP address lease record index.
...
STATIC FUNC(void, TCPIP_CODE) TcpIp_DhcpV4Server_VInitAddrLeaseRec(
  TcpIp_DhcpV4ServerConfigIterType           DhcpV4ServerConfigIdx,
  TcpIp_SizeOfDhcpV4ServerAddrLeaseRecsType  DhcpV4ServerAddrLeaseRecsIdx,
 ...
 *  \param[in]    DhcpV4ServerAddrLeaseRecsIdx         Client address lease record.
 ...
 *  \details      -
 *  \param[in]    DhcpV4ServerAddressAssignmentConfigIdx    Address assignment configuration Index.
...
STATIC FUNC(IpBase_AddrInType, TCPIP_CODE) TcpIp_DhcpV4Server_VGetClientAddr(
  TcpIp_SizeOfDhcpV4ServerAddressAssignmentConfigType  DhcpV4ServerAddressAssignmentConfigIdx,
 ...
 *  \details      -
 *  \param[in]    DhcpV4ServerConfigIdx     DHCP Server Configuration Index.
 *  \param[in]    DhcpV4ServerAddrLeaseRecsIdx           Address lease record.
 ...
 *  \details      -
 *  \param[in]    DhcpV4ServerAddressAssignmentConfigIdx  IP address assignment configuration Index.
 ...
 *  \param[in]    DhcpV4ServerConfigIdx             DHCP Server Configuration Index.
 *  \param[in]    DhcpV4ServerAddressAssignmentConfigIdx  IP address assignment configuration.
 ...
 *  \details      -
 *  \param[in]    DhcpV4ServerConfigIdx DHCP Server Configuration Index.
 *  \param[in]    DhcpV4ServerAddrLeaseRecsIdx       IP address lease record.
 *  \param[in]    ClientIdPtr           Client identifier
 *  \param[in]    ClientIdLen           Length of the client identifier in bytes.
  ...
  uint8                                      ClientIdLen)
{
  ...
  TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->LeaseState = TCPIP_DHCPV4SERVER_LEASE_STATE_INIT;
  ...
  /* create new record */
  TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientIdLen = localClientIdLen;

  /* #20 Store client ID in address lease record. */
  /* PRQA S 0315 1 */ /* MD_MSR_VStdLibCopy */
  IpBase_Copy((IpBase_CopyDataType *)&TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientId[0],
  ...
  uint8                                      ClientIdLen)
{
  ...
  if (TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientIdLen == localClientIdLen)
  {
    ...
    {
      if (TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientId[clientIdDataIdx] != ClientIdPtr[clientIdDataIdx])
      {
  ...
  boolean                                              CreateIfNotExist)
{
  ...
  TcpIp_DhcpV4ServerAddrLeaseRecsIterType newDhcpV4ServerAddrLeaseRecsIdx    = TCPIP_DHCPV4SERVER_INV_ADDR_LEASE_REC_IDX;
  TcpIp_DhcpV4ServerAddrLeaseRecsIterType dhcpV4ServerAddrLeaseRecsIdx;

  TCPIP_ASSERT_MSG(DhcpV4ServerAddressAssignmentConfigIdx < TcpIp_GetDhcpV4ServerAddressAssignmentConfigEndIdxOfDhcpV4ServerConfig(DhcpV4ServerConfigIdx), "addrAssignmentCfgIdx < TcpIp_GetDhcpV4ServerAddressAssignmentConfigEndIdxOfDhcpV4ServerConfig(DhcpV4ServerConfigIdx)");
  for (dhcpV4ServerAddrLeaseRecsIdx = TcpIp_GetDhcpV4ServerAddrLeaseRecsStartIdxOfDhcpV4ServerAddressAssignmentConfig(DhcpV4ServerAddressAssignmentConfigIdx);
       dhcpV4ServerAddrLeaseRecsIdx < TcpIp_GetDhcpV4ServerAddrLeaseRecsEndIdxOfDhcpV4ServerAddressAssignmentConfig(DhcpV4ServerAddressAssignmentConfigIdx);
       dhcpV4ServerAddrLeaseRecsIdx++)
  {
    /* #10 Select lease record that is currently assigned to the client or was assigned to the client before. */
    if (TcpIp_DhcpV4Server_VCmpClientId(DhcpV4ServerConfigIdx, (TcpIp_SizeOfDhcpV4ServerAddrLeaseRecsType)dhcpV4ServerAddrLeaseRecsIdx, ClientIdPtr, ClientIdLen) == TRUE)
    {
      /* Valid address lease record found. Stop searching. */
      addrLeaseRecIdxMatch = dhcpV4ServerAddrLeaseRecsIdx;
      break;
    }
    /* Record oldest expired lease record. (will be required later if no matching lease is found) */
    if (TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->LeaseState == TCPIP_DHCPV4SERVER_LEASE_STATE_EXPIRED)
    {
      if (   (newDhcpV4ServerAddrLeaseRecsIdx == TCPIP_DHCPV4SERVER_INV_ADDR_LEASE_REC_IDX)                             /* PRQA S 3415 3 */ /* MD_TCPIP_Rule13.5_3415_CslReadOnly */
          || (TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->LeaseTimeSec
           < TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(newDhcpV4ServerAddrLeaseRecsIdx)->LeaseTimeSec))
      {
        newDhcpV4ServerAddrLeaseRecsIdx = dhcpV4ServerAddrLeaseRecsIdx;
      }
    }
  }
  ...
  if (addrLeaseRecIdxMatch == TCPIP_DHCPV4SERVER_INV_ADDR_LEASE_REC_IDX)
  {
    ...
    if (ReqIpAddr != 0u)
    {
      ...
      TcpIp_SizeOfDhcpV4ServerAddrLeaseRecsType requestedDhcpV4ServerAddrLeaseRecsIdx = TcpIp_DhcpV4Server_VGetAddrLeaseRecIdxByIpAddr(DhcpV4ServerAddressAssignmentConfigIdx, ReqIpAddr);

      if (requestedDhcpV4ServerAddrLeaseRecsIdx != TCPIP_DHCPV4SERVER_INV_ADDR_LEASE_REC_IDX)
      {
        if (TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(requestedDhcpV4ServerAddrLeaseRecsIdx)->LeaseState == TCPIP_DHCPV4SERVER_LEASE_STATE_EXPIRED)
        {
          /* Requested IP address is available. */
          newDhcpV4ServerAddrLeaseRecsIdx = requestedDhcpV4ServerAddrLeaseRecsIdx;
        }
      }
    }
    /* #30 Otherwise select lease record of least recently expired lease and assign it to the client. */
    if ((CreateIfNotExist == TRUE) && (newDhcpV4ServerAddrLeaseRecsIdx != TCPIP_DHCPV4SERVER_INV_ADDR_LEASE_REC_IDX))   /* PRQA S 3415 */ /*  MD_TCPIP_Rule13.5_3415_CslReadOnly */
    {
      /* Assign address lease received to client. */
      addrLeaseRecIdxMatch = newDhcpV4ServerAddrLeaseRecsIdx;
...
# if defined(TCPIP_DHCPV4SERVER_GET_PORT_MAC_ADDR_FUNC)
  ...
  if (TCPIP_DHCPV4SERVER_GET_PORT_MAC_ADDR_FUNC(PhysAddrPtr, &ethIfSwitchIdx, &ethIfSwitchPortIdx) == E_OK)
  {
    ...
    {
      TcpIp_DhcpV4ServerAddressAssignmentConfigIterType iterDhcpV4ServerAddressAssignmentConfigIdx;
      for (iterDhcpV4ServerAddressAssignmentConfigIdx = TcpIp_GetDhcpV4ServerAddressAssignmentConfigStartIdxOfDhcpV4ServerConfig(DhcpV4ServerConfigIdx);
           iterDhcpV4ServerAddressAssignmentConfigIdx < (TcpIp_GetDhcpV4ServerAddressAssignmentConfigEndIdxOfDhcpV4ServerConfig(DhcpV4ServerConfigIdx));
           iterDhcpV4ServerAddressAssignmentConfigIdx++)
      {
        if (ethIfSwitchPortIdx == TcpIp_GetEthSwitchPortIdxOfDhcpV4ServerAddressAssignmentConfig(iterDhcpV4ServerAddressAssignmentConfigIdx))
        {
          /* Found address assignment configuration */
          dhcpV4ServerAddrAssignmentCfgIdxMatch = (TcpIp_SizeOfDhcpV4ServerAddressAssignmentConfigType)iterDhcpV4ServerAddressAssignmentConfigIdx;
        }
      }
    }
  }
  ...
  if (dhcpV4ServerAddrAssignmentCfgIdxMatch == TCPIP_DHCPV4SERVER_INV_ADDR_ASSIGN_IDX)
  {
    ...
    {
      TcpIp_SizeOfDhcpV4ServerAddressAssignmentConfigType dhcpV4ServerAddressAssignmentConfigIdx = TcpIp_GetDhcpV4ServerAddressAssignmentConfigStartIdxOfDhcpV4ServerConfig(DhcpV4ServerConfigIdx);
      ...
      */
      if (TcpIp_GetEthSwitchPortIdxOfDhcpV4ServerAddressAssignmentConfig(dhcpV4ServerAddressAssignmentConfigIdx) == TCPIP_DHCPV4SERVER_ANY_SWITCH_OR_PORT_IDX)
      {
        /* there exists no switch independent address assignment configuration */
        dhcpV4ServerAddrAssignmentCfgIdxMatch = dhcpV4ServerAddressAssignmentConfigIdx;
      }
    }
  ...
  uint8                                      MsgType)
{
  ...
  if (BufPtr != NULL_PTR)
  {
    ...
    BufPtr[dataLen + 1u] = TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientIdLen;

    TcpIp_DhcpV4Server_VCopyAndPad(&BufPtr[dataLen + TCPIP_DHCPV4SERVER_MSG_OPT_HDR_LEN], TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientIdLen,
                                   &TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientId[0], TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientIdLen);
  }
  dataLen += TCPIP_DHCPV4SERVER_MSG_OPT_HDR_LEN + (uint16) TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientIdLen;
  ...
  if ((MsgType == TCPIP_DHCPV4SERVER_TX_MSG_DHCPOFFER) || (MsgType == TCPIP_DHCPV4SERVER_TX_MSG_DHCPACK))
  {
    if (BufPtr != NULL_PTR)
    {
      ...
      if (TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->LeaseTimeSec < TCPIP_DHCPV4SERVER_TIME_INFINITE)
      {
        uint32 LeaseTimeRemainSec = TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->LeaseTimeSec - TcpIp_DhcpV4Server_TimeSec;
  ...
  if (   (TCPIP_DHCPV4SERVER_TX_MSG_DHCPOFFER == MsgType)                                                               /* PRQA S 3415 3 */ /* MD_TCPIP_Rule13.5_3415_CslReadOnly */
      ...
      || ((TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientParamReqSet & TCPIP_DHCPV4SERVER_MSG_OPT_REQ_FLAG_SUBNET_MASK) != 0u))
  {
  ...
  if ((TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientParamReqSet & TCPIP_DHCPV4SERVER_MSG_OPT_REQ_FLAG_ROUTER) != 0u)
  {
  ...
  /* [RFC2132 9.9. Message] */
  TCPIP_ASSERT(TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ErrorMsgId <= TCPIP_DHCPV4SERVER_ERROR_MESSAGE_COUNT);
  /* #60 Add 'Message' option, if required. */
  if (TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ErrorMsgId > 0u)
  {
    uint8_least msgIdx    = (uint8_least)TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ErrorMsgId - (uint8_least)1;
    ...
    if (NULL_PTR != BufPtr)
    {
      ...
      TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ErrorMsgId = TCPIP_DHCPV4SERVER_ERROR_MESSAGE_NONE;
    }
...
{
  uint8 dhcpAddrIdx;
  TCPIP_ASSERT(AddrLeaseRecIdx >= TcpIp_GetDhcpV4ServerAddrLeaseRecsStartIdxOfDhcpV4ServerAddressAssignmentConfig(DhcpV4ServerAddressAssignmentConfigIdx));
  TCPIP_ASSERT(AddrLeaseRecIdx < TcpIp_GetDhcpV4ServerAddrLeaseRecsEndIdxOfDhcpV4ServerAddressAssignmentConfig(DhcpV4ServerAddressAssignmentConfigIdx));
  /* #10 Calculate IP address of the given address lease record index. */
  dhcpAddrIdx = (uint8)(AddrLeaseRecIdx - TcpIp_GetDhcpV4ServerAddrLeaseRecsStartIdxOfDhcpV4ServerAddressAssignmentConfig(DhcpV4ServerAddressAssignmentConfigIdx));

  return (TcpIp_GetDhcpAddrFirstOfDhcpV4ServerAddressAssignmentConfig(DhcpV4ServerAddressAssignmentConfigIdx) + dhcpAddrIdx);
} /* TcpIp_DhcpV4Server_VGetClientAddr() */
  ...
  IpBase_AddrInType                                    ClientAddr)
{
  ...
  if (   (ClientAddr >= TcpIp_GetDhcpAddrFirstOfDhcpV4ServerAddressAssignmentConfig(DhcpV4ServerAddressAssignmentConfigIdx))/* PRQA S 3415 4 */ /*  MD_TCPIP_Rule13.5_3415_CslReadOnly */
      && (ClientAddr < ((uint32) TcpIp_GetDhcpAddrFirstOfDhcpV4ServerAddressAssignmentConfig(DhcpV4ServerAddressAssignmentConfigIdx)
                        + ((uint32) TcpIp_GetDhcpV4ServerAddrLeaseRecsEndIdxOfDhcpV4ServerAddressAssignmentConfig(DhcpV4ServerAddressAssignmentConfigIdx)
                        - (uint32) TcpIp_GetDhcpV4ServerAddrLeaseRecsStartIdxOfDhcpV4ServerAddressAssignmentConfig(DhcpV4ServerAddressAssignmentConfigIdx) ))))
  {
    uint8 dhcpAddrIdx = (uint8)(ClientAddr - TcpIp_GetDhcpAddrFirstOfDhcpV4ServerAddressAssignmentConfig(DhcpV4ServerAddressAssignmentConfigIdx));

    TCPIP_ASSERT(dhcpAddrIdx < (  TcpIp_GetDhcpV4ServerAddrLeaseRecsEndIdxOfDhcpV4ServerAddressAssignmentConfig(DhcpV4ServerAddressAssignmentConfigIdx)
                                - TcpIp_GetDhcpV4ServerAddrLeaseRecsStartIdxOfDhcpV4ServerAddressAssignmentConfig(DhcpV4ServerAddressAssignmentConfigIdx)));

    addrLeaseRecIdx = (TcpIp_SizeOfDhcpV4ServerAddrLeaseRecsType)(TcpIp_GetDhcpV4ServerAddrLeaseRecsStartIdxOfDhcpV4ServerAddressAssignmentConfig(DhcpV4ServerAddressAssignmentConfigIdx) + dhcpAddrIdx);
  }
  else
  {
  ...
  uint8                                                MsgType)
{
  ...
  if (TcpIp_SocketIsOnHold(TcpIp_GetSocketIdOfDhcpV4ServerConfigDyn(DhcpV4ServerConfigIdx)) == FALSE)
  {
    ...
    if (TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientGiAddr == 0u)
    {
      if (   ((TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientFlags & TCPIP_DHCPV4SERVER_MSG_FLAG_BROADCAST) != 0u)
      ...
      {
        IpBase_AddrInType clientAddr = TcpIp_DhcpV4Server_VGetClientAddr(AddrAssignmentCfgIdx, DhcpV4ServerAddrLeaseRecsIdx);
        ...
        if (TcpIp_ChangeParameter(TcpIp_GetSocketIdOfDhcpV4ServerConfigDyn(DhcpV4ServerConfigIdx),
          ...
          &TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientChAddr[0])
          != E_OK)
        {
    ...
    else
    {
       ...
       */
      destSockAddr.addr[0] = TCPIP_HTONL(TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientGiAddr);
      destSockAddr.port = TCPIP_HTONS(TCPIP_DHCPV4SERVER_SERVER_PORT);
    }

    /* #40 Calculate Message Length. */

    msgLen += TcpIp_DhcpV4Server_VAddOptions(DhcpV4ServerConfigIdx, NULL_PTR, DhcpV4ServerAddrLeaseRecsIdx, MsgType);
    ...
    TcpIp_DhcpV4Server_TxDataInfo.TxData_AddrLeaseRecIdx = DhcpV4ServerAddrLeaseRecsIdx;
...
# endif
  {
    ...
    TcpIp_SizeOfDhcpV4ServerAddrLeaseRecsType dhcpV4ServerAddrLeaseRecsIdx                              =  TcpIp_DhcpV4Server_TxDataInfo.TxData_AddrLeaseRecIdx;
    ...
    IpBase_AddrInType                   clientAddr                                         =  TcpIp_DhcpV4Server_VGetClientAddr(dhcpV4ServeraddrAssignmentCfgIdx, dhcpV4ServerAddrLeaseRecsIdx);
    ...
    TCPIP_PUT_UINT32(BufPtr, TCPIP_DHCPV4SERVER_MSG_OFS_XID, TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->ClientXid);
    ...
    if (TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->LeaseState == TCPIP_DHCPV4SERVER_LEASE_STATE_TX_NAK_BROADCAST)
    {
      TCPIP_PUT_UINT16(BufPtr, TCPIP_DHCPV4SERVER_MSG_OFS_FLAGS, (TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->ClientFlags | TCPIP_DHCPV4SERVER_MSG_FLAG_BROADCAST));
    }
    else
    {
      TCPIP_PUT_UINT16(BufPtr, TCPIP_DHCPV4SERVER_MSG_OFS_FLAGS, (TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->ClientFlags));
    }
    ...
    /* Set address fields depending on message type. */
    {
      ...
      IpBase_AddrInType giAddr = TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->ClientGiAddr; /* "Relay agent IP address, used in booting via a relay agent." */
    ...
    TcpIp_DhcpV4Server_VCopyAndPad( &BufPtr[TCPIP_DHCPV4SERVER_MSG_OFS_CHADDR], TCPIP_DHCPV4SERVER_MSG_LEN_CHADDR,
                                    &TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->ClientChAddr[0], TCPIP_DHCPV4SERVER_MSG_HLEN_10MBIT_ETH );
        ...
        && (TcpIp_IsDhcpV4ServerHostnameUsedOfDhcpV4ServerConfig(dhcpV4ServerConfigIdx) == TRUE))
    {
      ...
      TcpIp_DhcpV4Server_VCopyAndPad( &BufPtr[TCPIP_DHCPV4SERVER_MSG_OFS_SNAME],
                                     ...
                                     TcpIp_GetAddrDhcpV4ServerHostname(TcpIp_GetDhcpV4ServerHostnameStartIdxOfDhcpV4ServerConfig(
                                                                          dhcpV4ServerConfigIdx)),
                                     dhcpHostNameLen );
    }
    else
    {
    ...
    /* Add Options */
    {
      ...
      payloadOfs += TcpIp_DhcpV4Server_VAddOptions(TcpIp_DhcpV4Server_TxDataInfo.TxData_ServerConfigIdx, &BufPtr[payloadOfs], dhcpV4ServerAddrLeaseRecsIdx, msgType);
...
STATIC FUNC(void, TCPIP_CODE) TcpIp_DhcpV4Server_VHandleDhcpDiscover(
  ...
  TCPIP_DHCPV4SERVER_P2C(TcpIp_DhcpV4Server_KnownOptionsInfoType)  KnownOptionsPtr)
{
  TcpIp_SizeOfDhcpV4ServerAddrLeaseRecsType dhcpV4ServerAddrLeaseRecsIdx = TcpIp_DhcpV4Server_VGetAddrLeaseRecIdx( DhcpV4ServerConfigIdx,
                                                                                                      ...
                                                                                                      TRUE );
  if (dhcpV4ServerAddrLeaseRecsIdx != TCPIP_DHCPV4SERVER_INV_ADDR_LEASE_REC_IDX)
  {
    /* #10 Find or create address lease record for this client, Update IP address lease and client information. */
    TcpIp_DhcpV4Server_VUpdateClientInfo(dhcpV4ServerAddrLeaseRecsIdx, MsgDataPtr, MsgDataLen, KnownOptionsPtr);
    TcpIp_DhcpV4Server_VUpdateLeaseTime(DhcpV4ServerConfigIdx, dhcpV4ServerAddrLeaseRecsIdx, KnownOptionsPtr->LeaseTime);

    TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->LeaseState = TCPIP_DHCPV4SERVER_LEASE_STATE_TX_OFFER;
  }
} /* TcpIp_DhcpV4Server_VHandleDhcpDiscover() */
  ...
  TCPIP_DHCPV4SERVER_P2C(TcpIp_DhcpV4Server_KnownOptionsInfoType)  KnownOptionsPtr)
{
  ...
  {
    IpBase_AddrInType  clientIpAddr    = TcpIp_DhcpV4Server_VGetClientAddr(DhcpV4ServerAddrAssignmentCfgIdx, dhcpV4ServerAddrLeaseRecsIdx);
    ...
    clientMovedToOtherSubnet = (boolean)(TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->ClientGiAddr != msgGiAddr); /* PRQA S 4304 */ /* MD_MSR_AutosarBoolean */
      ...
      else
      {
        ...
        if (clientMovedToOtherSubnet == TRUE)
        {
          /* Client has moved to new subnet.
            * -> Tx NAK.
            */
          TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->ErrorMsgId = TCPIP_DHCPV4SERVER_ERROR_MESSAGE_CLIENT_MOVED_SUBNET;
          TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->LeaseState = TCPIP_DHCPV4SERVER_LEASE_STATE_TX_NAK;
        }
        ...
        else if (KnownOptionsPtr->ReqIpAddr != clientIpAddr)
        {
          /* Requested IP address does not match currently assigned IP address.
            * -> Tx NAK.
            */
          TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->ErrorMsgId = TCPIP_DHCPV4SERVER_ERROR_MESSAGE_INVALID_IP_ADDRESS_REQUESTED;
          TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->LeaseState = TCPIP_DHCPV4SERVER_LEASE_STATE_TX_NAK;
        }
        ...
        else
        {
          ...
          TcpIp_DhcpV4Server_VUpdateLeaseTime(DhcpV4ServerConfigIdx, dhcpV4ServerAddrLeaseRecsIdx, KnownOptionsPtr->LeaseTime);
          TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->LeaseState = TCPIP_DHCPV4SERVER_LEASE_STATE_TX_ACK;
        }
      }
    }
        ...
        if ((KnownOptionsPtr->ReqIpAddr != clientIpAddr) || (clientMovedToOtherSubnet == TRUE))
        {
          ...
          else
          {
            /* "If 'giaddr' is set in the DHCPREQUEST message, the client is on a
              ...
              */
            TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->LeaseState = TCPIP_DHCPV4SERVER_LEASE_STATE_TX_NAK_BROADCAST;
          }
        }
        else
        {
...
# endif
  ...
  dhcpV4ServerAddrLeaseRecsIdx = TcpIp_DhcpV4Server_VGetAddrLeaseRecIdx( DhcpV4ServerConfigIdx,
                                                            DhcpV4ServerAddrAssignmentCfgIdx,
                                                            &MsgDataPtr[KnownOptionsPtr->ClientId.OptOfs],
                                                            KnownOptionsPtr->ClientId.OptLen,
                                                            0,
  ...
  if (dhcpV4ServerAddrLeaseRecsIdx != TCPIP_DHCPV4SERVER_INV_ADDR_LEASE_REC_IDX)
  {
    ...
    TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->LeaseState  = TCPIP_DHCPV4SERVER_LEASE_STATE_EXPIRED;
    ...
    {
      TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->ClientIdLen = 0;
    }
  }
} /* TcpIp_DhcpV4Server_VHandleDhcpDeclineRelease() */
...
# endif
  ...
  {
    TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->LeaseTimeSec = TCPIP_DHCPV4SERVER_TIME_INFINITE;
  }
  else
  {
    TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->LeaseTimeSec = TcpIp_DhcpV4Server_TimeSec + updatedLeaseTimeSec;
  }
} /* TcpIp_DhcpV4Server_VUpdateLeaseTime() */
...
# endif
  ...
  IPBASE_GET_UINT32(MsgDataPtr, TCPIP_DHCPV4SERVER_MSG_OFS_XID,    TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientXid);    /* Transaction ID, a random number chosen by the client */
  IPBASE_GET_UINT16(MsgDataPtr, TCPIP_DHCPV4SERVER_MSG_OFS_FLAGS,  TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientFlags);  /* Flags */
  IPBASE_GET_UINT32(MsgDataPtr, TCPIP_DHCPV4SERVER_MSG_OFS_GIADDR, TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientGiAddr); /* gateway ip address */
  TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientParamReqSet = KnownOptionsPtr->ParamReqSet;

  /* Store client hardware address */
  TcpIp_DhcpV4Server_VCopyAndPad( &TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(DhcpV4ServerAddrLeaseRecsIdx)->ClientChAddr[0], TCPIP_DHCPV4SERVER_MSG_HLEN_10MBIT_ETH,
...
FUNC(void, TCPIP_CODE) TcpIp_DhcpV4Server_MainFunction(void)                                                            /* PRQA S 2889 */ /* MD_DHCPV4SERVER_Rule15.5_2889 */
{
  ...
  for (dhcpV4ServerConfigIdx = 0; dhcpV4ServerConfigIdx < TcpIp_GetSizeOfDhcpV4ServerConfig(); dhcpV4ServerConfigIdx++)
  {
    ...
    if (TcpIp_GetSocketIdOfDhcpV4ServerConfigDyn(dhcpV4ServerConfigIdx) != TCPIP_INV_SOCKET_ID)
    {
      TcpIp_DhcpV4ServerAddressAssignmentConfigIterType DhcpV4ServerAddressAssignmentConfigIdx;
      /* #40 Iterate over all Address Assignment Configurations of the DHCP Server instance. */
      for (DhcpV4ServerAddressAssignmentConfigIdx = TcpIp_GetDhcpV4ServerAddressAssignmentConfigStartIdxOfDhcpV4ServerConfig(dhcpV4ServerConfigIdx);
           DhcpV4ServerAddressAssignmentConfigIdx < TcpIp_GetDhcpV4ServerAddressAssignmentConfigEndIdxOfDhcpV4ServerConfig(dhcpV4ServerConfigIdx);
           DhcpV4ServerAddressAssignmentConfigIdx++)
      {
       TcpIp_DhcpV4ServerAddrLeaseRecsIterType dhcpV4ServerAddrLeaseRecsIdx;
       /* #50 Iterate over all Address Lease Records of the current Address Assignment Configuration. */
             ...
             dhcpV4ServerAddrLeaseRecsIdx++)
        {
          ...
          switch (TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->LeaseState)
          {
          case TCPIP_DHCPV4SERVER_LEASE_STATE_TX_OFFER:
                ...
                == E_OK )
            {
              ...
              TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->LeaseState        = TCPIP_DHCPV4SERVER_LEASE_STATE_RX_REQUEST;
              TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->ExpirationTimeSec = (TcpIp_DhcpV4Server_TimeSec + TcpIp_GetOfferValidTimeSecOfDhcpV4ServerConfig(dhcpV4ServerConfigIdx));
            }
            break;
          ...
          case TCPIP_DHCPV4SERVER_LEASE_STATE_RX_REQUEST:
            ...
            if (TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->ExpirationTimeSec < TcpIp_DhcpV4Server_TimeSec)
            {
              /* OFFER expired. Did not receive REQUEST in time */
              TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->LeaseState        = TCPIP_DHCPV4SERVER_LEASE_STATE_EXPIRED;
              TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->LeaseTimeSec      = 0u;
              TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->ExpirationTimeSec = 0u;
            }
            break;
          ...
          case TCPIP_DHCPV4SERVER_LEASE_STATE_TX_ACK:
                ...
                == E_OK )
            {
              ...
              TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->LeaseState        = TCPIP_DHCPV4SERVER_LEASE_STATE_RX_REQUEST;
              TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->ExpirationTimeSec = TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->LeaseTimeSec;
            }
            break;
  ...
  TcpIp_DhcpV4ServerConfigIterType  DhcpV4ServerConfigIdx)
{
       ...
       dhcpV4ServerAddressAssignmentConfigIdx++)
  {
         ...
         dhcpV4ServerAddrLeaseRecsIdx++)
    {
      ...
      TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->ErrorMsgId        = TCPIP_DHCPV4SERVER_ERROR_MESSAGE_NONE;
      TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->ClientIdLen       = 0;
      TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->LeaseTimeSec      = 0;
      TcpIp_GetAddrDhcpV4ServerAddrLeaseRecs(dhcpV4ServerAddrLeaseRecsIdx)->ExpirationTimeSec = 0;
    }
  }
  ...
  TcpIp_DhcpV4ServerConfigIterType DhcpV4ServerConfigIdx)
{
  ...
  {
    /* #20 Close the socket */
    TcpIp_SocketIdType socketId = TcpIp_GetSocketIdOfDhcpV4ServerConfigDyn(DhcpV4ServerConfigIdx);
...
FUNC(Std_ReturnType, TCPIP_CODE) TcpIp_DhcpV4Server_Start(void)
{
  ...
  for (dhcpV4ServerConfigIdx = 0; dhcpV4ServerConfigIdx < TcpIp_GetSizeOfDhcpV4ServerConfig(); dhcpV4ServerConfigIdx++)
  {
        ...
        && (TcpIp_GetIpAddrAssignmentStateOfDhcpV4ServerConfigDyn(dhcpV4ServerConfigIdx) == TCPIP_IPADDR_STATE_ASSIGNED))
    {
      ...
      if (TcpIp_DhcpV4Server_VOpenSocket((TcpIp_SizeOfDhcpV4ServerConfigType)dhcpV4ServerConfigIdx) != E_OK)
      {
        retVal = E_NOT_OK;
      }
    }
...
FUNC(Std_ReturnType, TCPIP_CODE) TcpIp_DhcpV4Server_Stop(void)
{
  ...
  for (dhcpV4ServerConfigIdx = 0; dhcpV4ServerConfigIdx < TcpIp_GetSizeOfDhcpV4ServerConfig(); dhcpV4ServerConfigIdx++)
  {
    if (TcpIp_GetSocketIdOfDhcpV4ServerConfigDyn(dhcpV4ServerConfigIdx) != TCPIP_INV_SOCKET_ID)
    {
      ...
      if (TcpIp_DhcpV4Server_VCloseSocket((TcpIp_SizeOfDhcpV4ServerConfigType)dhcpV4ServerConfigIdx) != E_OK)
      {
        retVal = E_NOT_OK;
      }
    }
