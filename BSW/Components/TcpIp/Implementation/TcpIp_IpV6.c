...
# define IPV6_SUPPORTED_UNICAST_NETMASK  64u
/**********************************************************************************************************************
...
typedef TCPIP_P2C(IpV6_AddrType)           IpV6_AddrTypeP2C;
/**********************************************************************************************************************
 ...
 *                                         \spec requires SatEntryAPtr < TcpIp_GetSizeOfIpV6SourceAddress(); \endspec
 *  \param[in]  SatEntryBPtr               Source Address B SAT Entry
  *                                        \spec requires SatEntryBPtr < TcpIp_GetSizeOfIpV6SourceAddress(); \endspec
 ...
 *  \details    -
 *  \param[in]  IpV6FragmentationConfigIdx   Index of Fragment Configuration Data
 *  \param[in]  IpV6ReassemblyBufferDescriptorIdx     Index of Reassembly Buffer
 *                                  \spec requires IpV6ReassemblyBufferDescriptorIdx < TcpIp_GetSizeOfIpV6ReassemblyBufferDescriptor(); \endspec
 *  \param[in]  FragHdrOfs          Offset of Fragment Extension Header in IP Payload
 *  \param[in]  FragLen             Length of Fragment payload
 *  \param[in]  FragOfs             Offset of the Fragment in the reassembled packet
 *  \return     TRUE                Reassembly Buffer Descriptor is valid
 *  \return     FALSE               Reassembly Buffer Descriptor is invalid
 *  \pre        FragConfigIdx was configured by TcpIp_GetIpV6FragmentationConfigIdxOfIpV6Ctrl
 *              IpV6ReassemblyBufferDescriptorIdx was configured by IpV6_VGetReassemblyBufferIdx()
 *  \context    TASK|ISR
 *  \reentrant  FALSE
 *********************************************************************************************************************/
TCPIP_LOCAL FUNC(boolean, TCPIP_CODE) IpV6_Ip_VRaBuffDescValidate(
  TcpIp_SizeOfIpV6FragmentationConfigType        IpV6FragmentationConfigIdx,
  TcpIp_SizeOfIpV6ReassemblyBufferDescriptorType IpV6ReassemblyBufferDescriptorIdx,
  uint16                                         FragHdrOfs,
  uint16                                         FragLen,
  uint16                                         FragOfs);
# endif
 ...
 *  \return          TRUE             Source address is in valid state
 *  \return          FALSE            Source address is in invalid state
 *  \pre             IpV6SourceAddressTableEntryIdx is configured by TcpIp_GetIpV6SourceAddressIdxOfLocalAddrV6()
 *  \context         TASK|ISR
 *  \reentrant       FALSE
 *********************************************************************************************************************/
TCPIP_LOCAL FUNC(boolean, TCPIP_CODE) IpV6_Ip_VIsSourceAddressActive(
# if (TCPIP_SUPPORT_NDP_DAD == STD_ON)
  TcpIp_IpV6CtrlIterType                      IpCtrlIdx,
 ...
 *  \param[in]       IpV6DestinationCacheEntryIdx         Index to entry in Destination Cache
 *                                      \spec requires IpV6DestinationCacheEntryIdx < TcpIp_GetSizeOfIpV6DestinationCacheEntry(); \endspec
...
TCPIP_LOCAL FUNC(void, TCPIP_CODE) IpV6_Ip_VNextHopLLDadOptimistic(
  ...
  IpV6_ListIdxType                IpV6DestinationCacheEntryIdx,
  IPV6_P2V(IpV6_AddrTypeP2C)      NextHopAddrPtrPtr,
...
TCPIP_LOCAL FUNC(BufReq_ReturnType, TCPIP_CODE) IpV6_Ip_VRequestTxFragmentBuffer(
  TcpIp_SizeOfIpV6CtrlType                  IpCtrlIdx,
  uint16                                    PathMtu,
  IPV6_P2V(TcpIp_Uint8P2V)                  BufPtrPtr,
 ...
 *  \param[in]   IpV6DestinationCacheEntryIdx            Index of the destination address in destination cache
 *                                     \spec requires IpV6DestinationCacheEntryIdx < TcpIp_GetSizeOfIpV6DestinationCacheEntry(); \endspec
 ...
 *  \details    -
 *  \param[in]  IpV6DestinationCacheEntryIdx      Index of entry in destination cache
 *                              \spec requires IpV6DestinationCacheEntryIdx < TcpIp_GetSizeOfIpV6DestinationCacheEntry(); \endspec
 *  \param[in]  IpCtrlIdx       IP controller index
 *                              \spec requires IpCtrlIdx < TcpIp_GetSizeOfIpV6ctrl(); \endspec
...
# if (TCPIP_SUPPORT_NDP_DAD_OPTIMISTIC == STD_ON)
  boolean                    SrcAddrOptimistic,
# endif
  IPV6_P2V(IpV6_AddrTypeP2C) NextHopAddrPtrPtr,                                                                         /* PRQA S 3673 */ /* MD_IPV6_Rule8.3_3673 */
 ...
 *  \param[in]    IpCtrlIdx            Ip controller index
 *                                     \spec requires IpCtrlIdx < TcpIp_GetSizeOfIpV6ctrl(); \endspec
 *  \param[in]    IpV6SourceAddressTableEntryIdx           Source Ip address index
 *                                     \spec requires IpV6SourceAddressTableEntryIdx < TcpIp_GetSizeOfIpV6SourceAddress(); \endspec
 ...
 *                                     \spec requires IpV6SocketIdx < TcpIp_GetSizeOfSocketDyn(); \endspec
...
TCPIP_LOCAL FUNC(uint32, TCPIP_CODE) IpV6_Ip_VSetVersionTcFlNbo(
  TcpIp_SizeOfIpV6CtrlType      IpCtrlIdx,
  TcpIp_SizeOfIpV6SocketDynType IpV6SocketIdx);
 ...
 *  \return       E_OK                      Unicast Address Set successfully
 *  \return       E_NOT_OK                  Unicast Address Set failed due to Nvm error
 *  \pre          -
 *  \context      TASK|ISR
 *  \reentrant    FALSE
 *********************************************************************************************************************/
 ...
 *                                          \spec requires IpV6MulticastAddrIdx < TcpIp_GetSizeOfIpV6MulticastAddr(); \endspec
 ...
 *  \details      -
 *  \param[in]    IpV6ReassemblyBufferDescriptorIdx   Index to the reassembly buffer
 *                                  \spec requires IpV6ReassemblyBufferDescriptorIdx < TcpIp_GetSizeOfIpV6ReassemblyBufferDescriptor(); \endspec
 ...
 *  \details      -
 *  \param[in]    IpV6SourceAddressIdx       IP Source Address Index
 *                                     \spec requires IpV6SourceAddressIdx < TcpIp_GetSizeOfIpV6SourceAddress(); \endspec
 *  \param[in]    PreferredLifetime    Preferred Address Lifetime
 *  \param[in]    ValidLifetime        Valid Address Lifetime
 *  \param[in]    AddressPtr           Pointer to Source Address
 *  \param[in]    NoDad                Do not perform DAD for this address (address may be used immediately)
 *  \param[in]    ResetAddress         Indicate that the address, shall be reseted or not
...
TCPIP_LOCAL FUNC(Std_ReturnType, TCPIP_CODE) IpV6_Ip_VAddNewSourceAddress(
  TcpIp_SizeOfIpV6SourceAddressType                  IpV6SourceAddressIdx,
  uint32                                             PreferredLifetime,
  uint32                                             ValidLifetime,
  P2CONST(IpV6_AddrType, AUTOMATIC, TCPIP_APPL_DATA) AddressPtr,
  boolean                                            NoDad,
  boolean                                            ResetAddress);

# if (TCPIP_SUPPORT_IPV6_RX_FRAGMENTATION == STD_ON) && (TCPIP_SUPPORT_ICMPV6_ERROR_MESSAGES == STD_ON)
/**********************************************************************************************************************
 ...
 *  \param[in]     IpV6PktDataLen           Length of the IPv6 packet (IPv6 header and payload) in bytes
 ...
 *  \param[in]     DstAddrPtr               Destination address
 *  \return        TRUE                     Destination address is valid
 *  \return        FALSE                    Destination address is not valid
 *  \pre           -
 *  \context       TASK|ISR
 *  \reentrant     FALSE
 *********************************************************************************************************************/
TCPIP_LOCAL FUNC(boolean, TCPIP_CODE) IpV6_Ip_VValidateDestAddr(
 IPV6_P2V(TcpIp_LocalAddrIterType)   LocalAddrV6IdxPtr,
 ...
 *  \param[out]    LocalAddrV6IdxPtr Ip address index for destination address is stored here
 ...
 *  \details       -
 *  \param[in]     TxReqDescrPtr      Pointer to the IP tx request descriptor
 ...
 *                  multicast address will be returned.
  *  \param[in]     IpCtrlIdx           IP Controller Index
 *                                      \spec requires IpCtrlIdx < TcpIp_GetSizeOfIpV6ctrl(); \endspec
 *  \param[in]      IpV6SourceAddressTableEntryIdx          IP Source Address Index
 *                                      \spec requires IpV6SourceAddressTableEntryIdx < TcpIp_GetSizeOfIpV6SourceAddress(); \endspec
 ...
 *  \return         E_NOT_OK         Processing of fragment failed
 *  \pre            -
 *  \context        TASK|ISR
 *  \reentrant      FALSE
 *********************************************************************************************************************/
 ...
 *  \param[in]     IpV6SourceAddressIdx   Source Address Index
 *                                  \spec requires IpV6SourceAddressIdx < TcpIp_GetSizeOfIpV6SourceAddress(); \endspec
 ...
 *  \details         Assign default address to all dynamic multicast address indexes. If no default address is
 *                   configured, assign to unspecified address.
 *  \param[in]       IpCtrlIdx     IP Controller Index
 *                                 \spec requires IpCtrlIdx < TcpIp_GetSizeOfIpV6ctrl(); \endspec
 *  \pre             -
 *  \context         TASK
 ...
 *  \details          Configure link local, source a multicast addresses
 *  \param[in]        IpCtrlIdx    IP Controller Index
 *                                 \spec requires IpCtrlIdx < TcpIp_GetSizeOfIpV6ctrl(); \endspec
 *  \pre              -
 *  \context          TASK
 ...
 *********************************************************************************************************************/
/*! \brief         This function is called by the lower layer (e.g. EthIf) and signals reception of a new ethernet packet
 *  \details       -
...
/**********************************************************************************************************************
 *  TcpIp_VerifyNewAddress()
 *********************************************************************************************************************/
/*! \brief         Verify if this IP address can be set to a LocalAddrV6
 *  \details       -
 *  \param[in]     LocalAddrV6Idx  Index of the Ip address
 *                                 CONSTRAINT: [0...TcpIp_GetSizeOfLocalAddrV6()-1]
 *  \param[in]     LocalIpAddrPtr  Ip address that shall be set
 *  \param[in]     Netmask         Netmask that shall be set
 *  \pre           -
 *  \context       TASK|ISR
 *  \reentrant     FALSE
 *  \synchronous   TRUE
 *********************************************************************************************************************/
FUNC(Std_ReturnType, TCPIP_CODE) TcpIp_VerifyNewAddress(
  TcpIp_LocalAddrV6IterType LocalAddrV6Idx,
  TCPIP_P2C(IpV6_AddrType)  LocalIpAddrPtr,
  uint8                     Netmask);

/**********************************************************************************************************************
 *  IpV6_Ip_CheckIfChecksumCalcIsRequired()
 *********************************************************************************************************************/
/*! \brief         Verify when the protocol checksum shall be calculated.
 *  \details       -
 *  \param[in]     IpTxReqDescrPtr        Pointer to the IP tx request descriptor
 *  \pre           -
 *  \context       TASK|ISR
 *  \reentrant     FALSE
 *  \synchronous   TRUE
 *********************************************************************************************************************/
TCPIP_LOCAL FUNC(TcpIp_IpProtocolChecksumType, TCPIP_CODE) IpV6_Ip_CheckIfChecksumCalcIsRequired(
...
{
  /* ----- Local Variables ---------------------------------------------- */
  Eth_PhysAddrType EthPhysAddr = {0u};
  ...
  P2VAR(IpV6_ListIdxType, AUTOMATIC, TCPIP_APPL_VAR) NcEntryIdxPtr)
{
  ...
  TCPIP_P2V(IpV6_NeighborCacheEntryType) ncEntryPtr = NULL_PTR;
  ...
  IPV6_P2C(IpV6_AddrType)               IpAddrPtr)
{
  ...
  if (IpV6_VMatchPrefix(IpAddrPtr, &IpV6_PrefixSolicitedNode.Prefix.addr[0], IpV6_PrefixSolicitedNode.PrefixLenBits) == E_OK)
  {
         ...
         ipV6SourceAddressTableEntryIdx++)
    {
      ...
      if (   (TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx)->Address.addr[13] == IpAddrPtr->addr[13])/* PRQA S 3415 3 */ /* MD_TCPIP_Rule13.5_3415_CslReadOnly */
          && (TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx)->Address.addr[14] == IpAddrPtr->addr[14])
          && (TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx)->Address.addr[15] == IpAddrPtr->addr[15]))
      {
  ...
  IPV6_P2C(IpV6_AddrType)               IpAddrPtr)
{
  ...
  else
  {
         ...
         ipV6MulticastAddrIdx++)
    {
      ...
      {
        TcpIp_SizeOfIpV6MulticastAddrActiveType ipV6MulticastAddrActiveIdx = TcpIp_GetIpV6MulticastAddrActiveIdxOfIpV6MulticastAddr(ipV6MulticastAddrIdx);
        mcAddrPtr = TcpIp_GetAddrIpV6MulticastAddrActive(ipV6MulticastAddrActiveIdx);
      }
      else if (TcpIp_IsDefaultAddrV6UsedOfIpV6MulticastAddr(ipV6MulticastAddrIdx) == TRUE)
      {
        TcpIp_SizeOfDefaultAddrV6Type defaultAddrV6Idx = TcpIp_GetDefaultAddrV6IdxOfIpV6MulticastAddr(ipV6MulticastAddrIdx);
        mcAddrPtr = TcpIp_GetAddrDefaultAddrV6(defaultAddrV6Idx);
      }
      else
      {
  ...
  IPV6_P2V(TcpIp_SizeOfLocalAddrV6Type) LocalAddrV6IdxPtr)
{
  ...
  IpV6_AddrTypeType     DstAddrType = IpV6_VGetAddrType(DstAddrPtr);
  /*
  ...
  if ((DstAddrType == IPV6_ADDR_TYPE_LL_UNICAST) || (DstAddrType == IPV6_ADDR_TYPE_UNICAST))
  {
    /* #10 If destination is unicast determine if it matches a valid local source address */
    TcpIp_SizeOfIpV6SourceAddressType ipV6SourceAddressIdx = 0u;
    if (E_OK == IpV6_VSATLookup(IpCtrlIdx, DstAddrPtr, &ipV6SourceAddressIdx))
    {
# if (TCPIP_SUPPORT_NDP_DAD == STD_ON)
       IpV6_LocAddrStateType SrcAddrState = TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressIdx)->State;

      if (IPV6_LADDR_STATE_TENTATIVE != SrcAddrState)
# endif
      {
        /* accept packets going to one of our unicast source addresses */
        (*LocalAddrV6IdxPtr) = TcpIp_GetLocalAddrV6IdxOfIpV6SourceAddress(ipV6SourceAddressIdx);
        retVal = E_OK;
      }
    }
  }
  /* packet destination is multicast with valid scope */
  else if (   (DstAddrType == IPV6_ADDR_TYPE_MULTICAST)
  ...
  P2CONST(IpV6_AddrType, AUTOMATIC, TCPIP_APPL_DATA) Addr2Ptr)
{
  ...
  */
  ...
  for (AddrByteIdx = 0; AddrByteIdx < IPV6_ADDRESS_LEN_BYTE; AddrByteIdx++)
  {
    ...
    MatchingBits += TCPIP_BITS_IN_BYTE;
  }
...
# if (TCPIP_SUPPORT_ICMPV6_MSG_PARAM_PROBLEM == STD_ON) && (TCPIP_SUPPORT_ICMPV6_ERROR_MESSAGES == STD_ON)
...
# else
      TCPIP_DUMMY_STATEMENT_CONST(LocalAddrV6Idx);
      TCPIP_DUMMY_STATEMENT_CONST(IpV6PktDataLen);
      TCPIP_DUMMY_STATEMENT_CONST(IpV6PktDataPtr);
# endif
...
{
  /* ----- Local Variables ---------------------------------------------- */
  IpV6_AddrTypeType AddrType = IPV6_ADDR_TYPE_UNICAST;
  ...
  {
    /* AddrType remains IPV6_ADDR_TYPE_UNICAST */
  }
  ...
  uint8                   PrefixLenBits)
{
  ...
  while (TCPIP_BITS_IN_BYTE <= lenBits)
  {
      ...
      && (0u < lenBits))
  {
    /* create a mask that masks the first PrefixLenBits bits in a byte */
     uint8 ByteMask = (uint8)(0xFFu << (TCPIP_BITS_IN_BYTE - lenBits)); /* 11..00.. */
...
# endif
  {
    ...
    for (ipV6SourceAddressTableEntryIdx = TcpIp_GetIpV6SourceAddressStartIdxOfIpV6Ctrl(IpCtrlIdx);
         ...
         ipV6SourceAddressTableEntryIdx++)
    {
      if (   (TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx)->State != IPV6_LADDR_STATE_INVALID)/* PRQA S 3415 2 */ /*  MD_TCPIP_Rule13.5_3415_CslReadOnly */
          && (TcpIp_IsPrefixIsOnLinkOfIpV6SourceAddress(ipV6SourceAddressTableEntryIdx) == TRUE)
          && (IPV6_CMP_64BIT_PREFIX(*PrefixPtr, TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx)->Address) == TRUE))
      {
...
)
{
  ...
  {
    TCPIP_P2C(IpV6_PrefixListEntryType) plEntryPtr = TcpIp_GetAddrIpV6PrefixListEntry(ipV6PrefixListEntryIdx);
  ...
  P2CONST(IpV6_AddrType, AUTOMATIC, TCPIP_APPL_DATA) DstAddrPtr)
{
  ...
  if (   (DstAddrType == IPV6_ADDR_TYPE_MULTICAST)
      || (DstAddrType == IPV6_ADDR_TYPE_LL_UNICAST)) /* multicast and link local prefix is always on-link */
  {
    result = TRUE;
  }
  ...
  IPV6_P2V(TcpIp_SizeOfIpV6DefaultRouterListEntryType) DrlEntryIdxPtr)
{
  ...
  else
  {
    ...
    {
      TCPIP_P2V(IpV6_DefaultRouterListEntryType) drlEntryPtr = TcpIp_GetAddrIpV6DefaultRouterListEntry(ipV6DefaultRouterListEntryIdx);
      ...
      ipV6NeighborCacheEntryIdx = TcpIp_GetIpV6DefaultRouterListEntry(ipV6DefaultRouterListEntryIdx).NcIdxHint;

      if (E_OK == IpV6_Ndp_VNCLookup(IpCtrlIdx, &drlEntryPtr->NextHopAddress, &ipV6NeighborCacheEntryIdx))
      {
        /* store updated neighbor cache index */
        drlEntryPtr->NcIdxHint = ipV6NeighborCacheEntryIdx;

        if (TcpIp_GetIpV6NeighborCacheEntry(ipV6NeighborCacheEntryIdx).State != IPV6_REACHABLE_STATE_INCOMPLETE)
        {
    ...
    if (reachableRouterFound == FALSE)
    {
      ...
      ipV6DefaultRouterListEntryIdx = TcpIp_GetNextRouterProbeIdxOfIpV6CtrlDyn(IpCtrlIdx);

      /* Iterate over the default router list to skip unusable static default router entries */
      while ((drLstStartIdx != ipV6DefaultRouterListEntryIdx) || (wrap != TRUE))
      {
        ...
        {
          ipV6DefaultRouterListEntryIdx = TcpIp_GetIpV6DefaultRouterListEntryStartIdxOfIpV6Ctrl(IpCtrlIdx);
          TcpIp_SetNextRouterProbeIdxOfIpV6CtrlDyn(IpCtrlIdx, ipV6DefaultRouterListEntryIdx);
          wrap = TRUE;
        }

        drlEntryPtr = TcpIp_GetAddrIpV6DefaultRouterListEntry(ipV6DefaultRouterListEntryIdx);
    ...
    *DrlEntryIdxPtr = ipV6DefaultRouterListEntryIdx;
  }
  ...
  IPV6_P2V(TcpIp_SizeOfIpV6SourceAddressType)  SrcAddrIdxPtr)
{
  ...
  if (IpV6_VSATLookup(IpCtrlIdx, SrcAddrPtr, SrcAddrIdxPtr) == E_OK)
  {
    IpV6_LocAddrStateType SrcAddrState = TcpIp_GetIpV6SourceAddressTableEntry(*SrcAddrIdxPtr).State;
...
# endif
  ...
  else if (   (AllowUnspecAddr == TRUE)                                                                                 /* PRQA S 3415 2 */ /* MD_TCPIP_Rule13.5_3415_ReadOnly */
...
{
  /* ----- Local Variables ---------------------------------------------- */
  IpV6_MulticastScopeType dstAddrScope = 0u;
  uint8 preference = IPV6_CMP_RES_NO_PREFERENCE;

  /* ----- Implementation ----------------------------------------------- */
  /* Determine scope of the two addresses being compared
  ...
  IpV6_LocAddrStateType StateB)
{
  ...
  if (   (StateA == IPV6_LADDR_STATE_PREFERRED)
      && (StateB != IPV6_LADDR_STATE_PREFERRED))
  {
    preference = IPV6_CMP_RES_PREFER_A;
  }
  else if (   (StateB == IPV6_LADDR_STATE_PREFERRED)
           && (StateA != IPV6_LADDR_STATE_PREFERRED))
  {
    preference = IPV6_CMP_RES_PREFER_B;
  }
  else
 ...
 *
 */
FUNC(uint8, TCPIP_CODE) IpV6_VSourceAddrIsBetterThan(
  TcpIp_SizeOfIpV6SourceAddressType                  AIpV6SourceAddressTableEntryIdx,
  TcpIp_SizeOfIpV6SourceAddressType                  BIpV6SourceAddressTableEntryIdx,
  P2CONST(IpV6_AddrType, AUTOMATIC, TCPIP_APPL_DATA) DstAddrPtr)
{
  /* ----- Local Variables ---------------------------------------------- */

  uint8 preference = IPV6_CMP_RES_NO_PREFERENCE;
  TCPIP_P2C(IpV6_SourceAddressTableEntryType) satEntryAPtr = TcpIp_GetAddrIpV6SourceAddressTableEntry(AIpV6SourceAddressTableEntryIdx);
  TCPIP_P2C(IpV6_SourceAddressTableEntryType) satEntryBPtr = TcpIp_GetAddrIpV6SourceAddressTableEntry(BIpV6SourceAddressTableEntryIdx);

  /* ----- Implementation ----------------------------------------------- */
  TCPIP_ASSERT(NULL_PTR != DstAddrPtr);
  TCPIP_ASSERT(AIpV6SourceAddressTableEntryIdx < TcpIp_GetSizeOfIpV6SourceAddress());
  TCPIP_ASSERT(BIpV6SourceAddressTableEntryIdx < TcpIp_GetSizeOfIpV6SourceAddress());

  if (AIpV6SourceAddressTableEntryIdx == BIpV6SourceAddressTableEntryIdx)
  {
  ...
  else
  {
    ...
    if (preference == IPV6_CMP_RES_NO_PREFERENCE)
    {
      uint8 PrefixLenA = IpV6_VGetCommonPrefixLen(&satEntryAPtr->Address, DstAddrPtr);
      uint8 PrefixLenB = IpV6_VGetCommonPrefixLen(&satEntryBPtr->Address, DstAddrPtr);
  ...
  TCPIP_P2V(TcpIp_SizeOfIpV6SourceAddressType) SrcAddrIdxPtr)
{
  ...
  else
  {
      ...
      TcpIp_SizeOfIpV6SourceAddressType selectedIpV6SourceAddressTableEntryIdx
        = TcpIp_GetIpV6SourceAddressStartIdxOfIpV6Ctrl(IpCtrlIdx);

      /* #20 traverse through the source address table, select the most preferred address */
      for (ipV6SourceAddressTableEntryIdx = TcpIp_GetIpV6SourceAddressStartIdxOfIpV6Ctrl(IpCtrlIdx) + 1u;
        ipV6SourceAddressTableEntryIdx < TcpIp_GetIpV6SourceAddressEndIdxOfIpV6Ctrl(IpCtrlIdx);
        ipV6SourceAddressTableEntryIdx++)
      {
        if (TcpIp_GetIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx).State == IPV6_LADDR_STATE_INVALID)
        {
          /* skip invalid entry */
          continue;
        }
...
# if (TCPIP_SUPPORT_NDP_DAD == STD_ON)
      if (TcpIp_GetIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx).State != IPV6_LADDR_STATE_TENTATIVE)
# endif
        {
          if (IPV6_CMP_RES_PREFER_A == IpV6_VSourceAddrIsBetterThan(ipV6SourceAddressTableEntryIdx, selectedIpV6SourceAddressTableEntryIdx, DstAddrPtr))
          {
            selectedIpV6SourceAddressTableEntryIdx = ipV6SourceAddressTableEntryIdx;
          }
        }
      }
    ...
    if (selectedIpV6SourceAddressTableEntryIdx == TcpIp_IpV6_GetLinkLocalSourceAddrIdxOfIpV6Ctrl(IpCtrlIdx))
    {
      /* link-local address shall be used as source address? */
# if (TCPIP_SUPPORT_NDP_DAD == STD_ON)
      if (TcpIp_GetIpV6SourceAddressTableEntry(selectedIpV6SourceAddressTableEntryIdx).State == IPV6_LADDR_STATE_TENTATIVE)
      {
        retVal = E_NOT_OK;
      }
# endif
    ...
    if (retVal == E_OK)
    {
      *SrcAddrIdxPtr = selectedIpV6SourceAddressTableEntryIdx;
    }
  }
  ...
  uint8                                       AddrCfgSrc)
{
  ...
  for (ipV6SourceAddressIdx = *SrcAddrIdxPtr;
       ipV6SourceAddressIdx < TcpIp_GetIpV6SourceAddressEndIdxOfIpV6Ctrl(IpCtrlIdx);
       ipV6SourceAddressIdx++)
  {
    if (TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressIdx)->State != IPV6_LADDR_STATE_INVALID)
    {
      if (IpV6_MemCmp(&TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressIdx)->Address.addr[0], AddrPrefixPtr, (IPV6_PREFIX_LEN_BYTE)) == TRUE)
      {
        /* #20 If source address with matching prefix is found, check if
         *     any specific address configuration has been requested */
        if (   (AddrCfgSrc == TCPIP_IPADDR_ASSIGNMENT_ANY)                                                              /* PRQA S 3415 2 */ /*  MD_TCPIP_Rule13.5_3415_CslReadOnly */
            || (TcpIp_GetAddressAssignVariantOfIpV6SourceAddress(ipV6SourceAddressIdx) == AddrCfgSrc))
        {
          *SrcAddrIdxPtr = ipV6SourceAddressIdx;
          result = E_OK;
          break;
        }
      }
  ...
  P2VAR(TcpIp_SizeOfIpV6SourceAddressType, AUTOMATIC, TCPIP_APPL_VAR) SrcAddrIdxPtr)
{
  ...
  for (ipV6SourceAddressTableEntryIdx = TcpIp_GetIpV6SourceAddressStartIdxOfIpV6Ctrl(IpCtrlIdx);
       ...
       ipV6SourceAddressTableEntryIdx++)
  {
    if (TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx)->State == IPV6_LADDR_STATE_INVALID)
    {
      /* skip invalid entry */
      continue;
    }

    if (IPV6_CMP_64BIT_PREFIX(TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx)->Address, *SrcAddrPtr) == TRUE)
    {
      /* #20 If matching prefix is found store source address index */
      (*SrcAddrIdxPtr) = ipV6SourceAddressTableEntryIdx;

      if (IPV6_CMP_64BIT_INTERFACE_IDENTIFIER(TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx)->Address, *SrcAddrPtr) == TRUE)
      {
        Result = E_OK;
        break;
      }
 ...
 *
 */
FUNC(void, TCPIP_CODE) IpV6_VSATRemoveEntry(TcpIp_SizeOfIpV6SourceAddressType IpV6SourceAddressTableEntryIdx)
{
  /* ----- Implementation ----------------------------------------------- */

  /* #10 Remove specific entry from source address table */
  TcpIp_GetAddrIpV6SourceAddressTableEntry(IpV6SourceAddressTableEntryIdx)->State = IPV6_LADDR_STATE_INVALID;
...
FUNC(void, TCPIP_CODE) IpV6_VSATRemoveAllEntries(TcpIp_IpV6CtrlIterType IpCtrlIdx)
{
       ...
       ipV6SourceAddressTableEntryIdx++)
  {
    ...
    TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx)->State = IPV6_LADDR_STATE_INVALID;
    TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx)->Triggered = FALSE;
  }
  ...
  boolean                            AddrAssigned)
{
  /* ----- Local Variables ---------------------------------------------- */
  TcpIp_SizeOfLocalAddrV6Type localAddrV6Idx
    = TcpIp_GetLocalAddrV6IdxOfIpV6SourceAddress(IpV6SourceAddressTableEntryIdx);
  ...
  if (AddrAssigned == TRUE)
  {
    ...
    if (IpV6SourceAddressTableEntryIdx == TcpIp_IpV6_GetLinkLocalSourceAddrIdxOfIpV6Ctrl(ipCtrlIdx))
    {
...
# endif
    ...
    IPV6_VJOIN_SOLICITED_NODE_MULTICAST_GROUP(ipCtrlIdx,
      &(TcpIp_GetAddrIpV6SourceAddressTableEntry(IpV6SourceAddressTableEntryIdx)->Address), FALSE);
  }

  /* #40 Notify upper-layer by invoking address change callback function */
  {
    TcpIp_IpAddrStateType AddrState = TCPIP_IPADDR_STATE_UNASSIGNED;

    if (AddrAssigned == TRUE)
    {
      AddrState = TCPIP_IPADDR_STATE_ASSIGNED;
    }
    /* Else: AddrState = TCPIP_IPADDR_STATE_UNASSIGNED */

    TcpIp_Cbk_VLocalIpAssignmentChg(TCPIP_IPV6_TO_LOCAL_ADDR_IDX(TcpIp_GetLocalAddrV6IdxOfIpV6SourceAddress(IpV6SourceAddressTableEntryIdx)), AddrState);
  ...
  TcpIp_IpV6CtrlIterType IpCtrlIdx)
{
  ...
  TcpIp_CtrlStateOfIpV6CtrlDynType expectedState = IPV6_CTRL_STATE_UNINIT;
  ...
  uint8                              EventType)
{
  ...
  if (IpV6SourceAddressTableEntryIdx == TcpIp_IpV6_GetLinkLocalSourceAddrIdxOfIpV6Ctrl(ipCtrlIdx))
  {
    ...
    TcpIp_VDuplicateAddrDetected(TCPIP_IPV6_TO_LOCAL_ADDR_IDX(localAddrV6Idx), &(TcpIp_GetAddrIpV6SourceAddressTableEntry(IpV6SourceAddressTableEntryIdx)->Address.addr[0]), PhysAddrPtr);
...
#  if (TCPIP_SUPPORT_DHCPV6 == STD_ON)
    if (IPV6_DHCPV6_MODE_DISABLED != TcpIp_GetDhcpModeOfIpV6Ctrl(ipCtrlIdx))
    {
      ...
      if (TcpIp_GetAddressAssignVariantOfIpV6SourceAddress(IpV6SourceAddressTableEntryIdx) == TCPIP_IPADDR_ASSIGNMENT_DHCP)
      {
        ...
        (void)TcpIp_DhcpV6_Decline(ipCtrlIdx,
          (IpBase_AddrIn6Type*)&(TcpIp_GetAddrIpV6SourceAddressTableEntry(IpV6SourceAddressTableEntryIdx)->Address));
      }
    }
#  endif
  }
  ...
  boolean                                            Join)
{
  ...
  /* ----- Implementation ---------------------------------------------- */
#  if (TCPIP_SUPPORT_IPV6_ETHIF_ADDR_FILTER_API == STD_ON)
  Eth_PhysAddrType PhysMulticastAddr = { 0u };
#  endif
  ...
  uint32                  BaseValue)
{
  ...
  return TcpIp_VGetRandomValue(MinValue, MaxValue);
  ...
  uint8                                          SegInsertIdx)
{
  ...
  TcpIp_SizeOfIpV6ReassemblySegmentType segEndIdx =
    TcpIp_GetIpV6ReassemblySegmentEndIdxOfIpV6ReassemblyBufferDescriptor(IpV6ReassemblyBufferDescriptorIdx);

  TcpIp_SizeOfIpV6ReassemblySegmentType segEndActiveIdx =
    TcpIp_GetIpV6ReassemblyBufferDescriptorDyn(IpV6ReassemblyBufferDescriptorIdx).IpV6ReassemblySegmentActiveEndIdx;

  /* ----- Implementation ---------------------------------------------- */
  TCPIP_ASSERT(IpV6ReassemblyBufferDescriptorIdx < TcpIp_GetSizeOfIpV6ReassemblyBufferDescriptor());
  TCPIP_ASSERT(TcpIp_GetIpV6ReassemblySegmentStartIdxOfIpV6ReassemblyBufferDescriptor(IpV6ReassemblyBufferDescriptorIdx) <= segEndActiveIdx);
  ...
  {
    TcpIp_SizeOfIpV6ReassemblySegmentType ipV6ReassemblySegmentIdx;

    /* #20 Copy all segments after insert position to the right to create space for new element */
    for (ipV6ReassemblySegmentIdx = segEndActiveIdx; ipV6ReassemblySegmentIdx > SegInsertIdx; ipV6ReassemblySegmentIdx--)
    {
      IpV6_SegmentType reassSeg = { 0u, 0u};
      reassSeg.StartOfs = (TcpIp_GetIpV6ReassemblySegment(ipV6ReassemblySegmentIdx - 1u)).StartOfs;
      reassSeg.EndOfs = (TcpIp_GetIpV6ReassemblySegment(ipV6ReassemblySegmentIdx - 1u)).EndOfs;
      TcpIp_SetIpV6ReassemblySegment(ipV6ReassemblySegmentIdx, reassSeg);
    }

    TcpIp_GetAddrIpV6ReassemblyBufferDescriptorDyn(IpV6ReassemblyBufferDescriptorIdx)->IpV6ReassemblySegmentActiveEndIdx += 1u;
    retVal = E_OK;
  }
  else
  {
  ...
  uint8                                           SegRemoveIdx)
{
  ...
  /* ----- Implementation ---------------------------------------------- */
  TCPIP_ASSERT(IpV6ReassemblyBufferDescriptorIdx < TcpIp_GetSizeOfIpV6ReassemblyBufferDescriptor());
  TCPIP_ASSERT_MSG(TcpIp_GetIpV6ReassemblySegmentStartIdxOfIpV6ReassemblyBufferDescriptor(IpV6ReassemblyBufferDescriptorIdx) <  segEndActiveIdx, "List must contain at least on element.");

  TCPIP_ASSERT(segEndActiveIdx <= TcpIp_GetIpV6ReassemblySegmentEndIdxOfIpV6ReassemblyBufferDescriptor(IpV6ReassemblyBufferDescriptorIdx));

  TCPIP_ASSERT(SegRemoveIdx < segEndActiveIdx);

  /* #10 Shift segments after the delete position to the left to remove the element */
  for (ipV6ReassemblySegmentIdx = SegRemoveIdx + 1u; ipV6ReassemblySegmentIdx < segEndActiveIdx; ipV6ReassemblySegmentIdx++)
  {
    IpV6_SegmentType reassSeg;
    reassSeg.StartOfs = (TcpIp_GetIpV6ReassemblySegment(ipV6ReassemblySegmentIdx)).StartOfs;
    reassSeg.EndOfs = (TcpIp_GetIpV6ReassemblySegment(ipV6ReassemblySegmentIdx)).EndOfs;
    TcpIp_SetIpV6ReassemblySegment(ipV6ReassemblySegmentIdx - 1u, reassSeg);
  }
  ...
  uint16                                          SegLen)
{
  /* ----- Local Variables ---------------------------------------------- */
  TcpIp_SizeOfIpV6ReassemblySegmentType ipV6ReassemblySegmentIdx;
  uint16 segEndOfs = SegOfs + SegLen;
  Std_ReturnType Result = E_OK;

  TcpIp_SizeOfIpV6ReassemblySegmentType segStartIdx =
    TcpIp_GetIpV6ReassemblySegmentStartIdxOfIpV6ReassemblyBufferDescriptor(IpV6ReassemblyBufferDescriptorIdx);
  ...
  for (ipV6ReassemblySegmentIdx = segStartIdx; ipV6ReassemblySegmentIdx < segEndActiveIdx; ipV6ReassemblySegmentIdx++)
  {
    if (TcpIp_GetIpV6ReassemblySegment(ipV6ReassemblySegmentIdx).StartOfs >= segEndOfs)
    {
      break;
    }
  }
  ...
  if (   (ipV6ReassemblySegmentIdx > segStartIdx)
      && (SegOfs < TcpIp_GetIpV6ReassemblySegment(ipV6ReassemblySegmentIdx - 1u).EndOfs))
  {
    /* segment overlaps with previous segment */
    Result = E_NOT_OK;
  }
  else if (   (ipV6ReassemblySegmentIdx < segEndActiveIdx)
           && (segEndOfs > TcpIp_GetIpV6ReassemblySegment(ipV6ReassemblySegmentIdx).StartOfs))
  {
  ...
  else if (   (ipV6ReassemblySegmentIdx > segStartIdx)
           && (SegOfs == TcpIp_GetIpV6ReassemblySegment(ipV6ReassemblySegmentIdx - 1u).EndOfs))
  {
    /* new segment can be appended to previous segment */
    /* ----|#PREV#|*NEW*|----|#NEXT#|---- */
    (TcpIp_GetAddrIpV6ReassemblySegment(ipV6ReassemblySegmentIdx - 1u))->EndOfs += SegLen;

    if (   (ipV6ReassemblySegmentIdx < segEndActiveIdx)                                                                 /* PRQA S 3415 2 */ /* MD_TCPIP_Rule13.5_3415_CslReadOnly */
        && ((TcpIp_GetAddrIpV6ReassemblySegment(ipV6ReassemblySegmentIdx - 1u))->EndOfs == TcpIp_GetIpV6ReassemblySegment(ipV6ReassemblySegmentIdx).StartOfs))
    {
      /* new segment fits exactly between previous and next segment */
      /* ----|#PREV#|***NEW***|#NEXT#|---- */
      (TcpIp_GetAddrIpV6ReassemblySegment(ipV6ReassemblySegmentIdx - 1u))->EndOfs = TcpIp_GetAddrIpV6ReassemblySegment(ipV6ReassemblySegmentIdx)->EndOfs;

      IpV6_VSegmentListRemove(IpV6ReassemblyBufferDescriptorIdx, ipV6ReassemblySegmentIdx);
    }
  }
  else if (   (ipV6ReassemblySegmentIdx < segEndActiveIdx)                                                              /* PRQA S 3415 2 */ /* MD_TCPIP_Rule13.5_3415_CslReadOnly */
           && (segEndOfs == TcpIp_GetAddrIpV6ReassemblySegment(ipV6ReassemblySegmentIdx)->StartOfs))
  {
    /* new segment can be prepended to next segment */
    /* ----|#PREV#|----|*NEW*|#NEXT#|---- */
    TcpIp_GetAddrIpV6ReassemblySegment(ipV6ReassemblySegmentIdx)->StartOfs = SegOfs;
  }
  else if (E_OK == IpV6_VSegmentListInsert(IpV6ReassemblyBufferDescriptorIdx, ipV6ReassemblySegmentIdx))
  {
    /* new segment is isolated */
    /* ----|?PREV?|--|*NEW*|--|?NEXT?|---- */
    TcpIp_GetAddrIpV6ReassemblySegment(ipV6ReassemblySegmentIdx)->StartOfs = SegOfs;
    TcpIp_GetAddrIpV6ReassemblySegment(ipV6ReassemblySegmentIdx)->EndOfs   = segEndOfs;
  }
  else
  {
    Result = E_NOT_OK;
  ...
  TCPIP_P2V(TcpIp_SizeOfIpV6ReassemblyBufferDescriptorType) RaBufferDescIdxPtr)
{
  /* ----- Local Variables ---------------------------------------------- */
  Std_ReturnType result = E_NOT_OK;
  TcpIp_SizeOfIpV6ReassemblyBufferDescriptorType unusedIpV6ReassemblyBufferDescriptorIdx = IPV6_INV_LIST_IDX;
  TcpIp_SizeOfIpV6CtrlType ipCtrlIdx = TcpIp_GetIpV6CtrlIdxOfLocalAddrV6(LocalAddrV6Idx);
  TcpIp_SizeOfIpV6FragmentationConfigType  ipV6FragmentationConfigIdx
    = TcpIp_GetIpV6FragmentationConfigIdxOfIpV6Ctrl(ipCtrlIdx);
  ...
  TCPIP_ASSERT(ipV6FragmentationConfigIdx < TcpIp_GetSizeOfIpV6FragmentationConfig());

  /* #10 Traverse through the reassembly buffer descriptor list */
  for (ipV6ReassemblyBufferDescriptorIdx = TcpIp_GetIpV6ReassemblyBufferDescriptorStartIdxOfIpV6FragmentationConfig(ipV6FragmentationConfigIdx);
       ipV6ReassemblyBufferDescriptorIdx < TcpIp_GetIpV6ReassemblyBufferDescriptorEndIdxOfIpV6FragmentationConfig(ipV6FragmentationConfigIdx);
       ipV6ReassemblyBufferDescriptorIdx++)
  {
    ...
    if (TcpIp_GetAddrIpV6ReassemblyBufferDescriptorDyn(ipV6ReassemblyBufferDescriptorIdx)->Status != IPV6_FRAG_STATUS_UNUSED)
    {
      if (   (FragmentId == TcpIp_GetIpV6ReassemblyBufferDescriptorDyn(ipV6ReassemblyBufferDescriptorIdx).FragmentId)   /* PRQA S 3415 2 */ /*  MD_TCPIP_Rule13.5_3415_CslReadOnly */
          && (IPV6_ADDR_EQUALS(*SrcAddrPtr, TcpIp_GetAddrIpV6ReassemblyBufferDescriptorDyn(ipV6ReassemblyBufferDescriptorIdx)->SrcAddr))
          && (TcpIp_GetAddrIpV6ReassemblyBufferDescriptorDyn(ipV6ReassemblyBufferDescriptorIdx)->IpAddrIdx == LocalAddrV6Idx))
      {
        /* match found. */
        (*RaBufferDescIdxPtr) = ipV6ReassemblyBufferDescriptorIdx;
        result = E_OK;
        break;
      }
    }
    ...
    {
      if (unusedIpV6ReassemblyBufferDescriptorIdx == IPV6_INV_LIST_IDX)
      {
        /* store index of free buffer in case we need one */
        unusedIpV6ReassemblyBufferDescriptorIdx = ipV6ReassemblyBufferDescriptorIdx;
      }
    }
  }
  ...
  if (result != E_OK)
  {
    if (unusedIpV6ReassemblyBufferDescriptorIdx != IPV6_INV_LIST_IDX)
    {
      TCPIP_P2V(IpV6_ReassemblyBufferDescType) raBufDescPtr =
        TcpIp_GetAddrIpV6ReassemblyBufferDescriptorDyn(unusedIpV6ReassemblyBufferDescriptorIdx);
      ...
      raBufDescPtr->IpV6ReassemblySegmentActiveEndIdx =
        TcpIp_GetIpV6ReassemblySegmentStartIdxOfIpV6ReassemblyBufferDescriptor(unusedIpV6ReassemblyBufferDescriptorIdx);
      ...
      IPV6_SET_EVENT_TIME_MS(raBufDescPtr->ReassemblyTimeout,
        TcpIp_GetReassemblyTimeoutOfIpV6FragmentationConfig(ipV6FragmentationConfigIdx));
      (*RaBufferDescIdxPtr) = unusedIpV6ReassemblyBufferDescriptorIdx;
      result = E_OK;
    }
    else
    {
  ...
  TCPIP_P2V(TcpIp_SizeOfIpV6FragmentTxBufferDescriptorType) FragTxBufDescIdxPtr)
{
  /* ----- Local Variables ---------------------------------------------- */
  Std_ReturnType result = E_NOT_OK;
  TcpIp_SizeOfIpV6FragmentTxBufferDescriptorType ipV6FragmentTxBufferDescriptorIdx;
  TcpIp_SizeOfIpV6FragmentationConfigType ipV6FragmentationConfigIdx = TcpIp_GetIpV6FragmentationConfigIdxOfIpV6Ctrl(IpCtrlIdx);

  /* ----- Implementation ---------------------------------------------- */
  TCPIP_ASSERT(ipV6FragmentationConfigIdx < TcpIp_GetSizeOfIpV6FragmentationConfig());

  /* #10 Traverse through the fragment tx buffer descriptor list and return unused descriptor */
  for (ipV6FragmentTxBufferDescriptorIdx = TcpIp_GetIpV6FragmentTxBufferDescriptorStartIdxOfIpV6FragmentationConfig(ipV6FragmentationConfigIdx);
       ipV6FragmentTxBufferDescriptorIdx < TcpIp_GetIpV6FragmentTxBufferDescriptorEndIdxOfIpV6FragmentationConfig(ipV6FragmentationConfigIdx);
       ipV6FragmentTxBufferDescriptorIdx++)
  {
    if (TcpIp_GetAddrIpV6FragmentTxBufferDescriptorDyn(ipV6FragmentTxBufferDescriptorIdx)->Status == IPV6_FRAG_TX_STATUS_UNUSED)
    {
      TcpIp_GetAddrIpV6FragmentTxBufferDescriptorDyn(ipV6FragmentTxBufferDescriptorIdx)->Status = IPV6_FRAG_TX_STATUS_PROVIDED;
      *FragTxBufDescIdxPtr = ipV6FragmentTxBufferDescriptorIdx;
      result = E_OK;
      break;
    }
  }
...
{
  /* ----- Local Variables ---------------------------------------------- */
  boolean lastFrag = FALSE; /* M(ore) bit is not set */
  Std_ReturnType Result = E_OK;
...
{
  /* ----- Local Variables ---------------------------------------------- */
  boolean validRaBuffDesc = FALSE;
  TCPIP_P2V(IpV6_ReassemblyBufferDescType) raBufferDescPtr =
    TcpIp_GetAddrIpV6ReassemblyBufferDescriptorDyn(IpV6ReassemblyBufferDescriptorIdx);
  ...
  if (raBufferDescPtr->Status != IPV6_FRAG_STATUS_ACTIVE)
  {
    ...
    validRaBuffDesc = FALSE;
  }
  else if (TcpIp_GetReassemblyBufferSizeOfIpV6FragmentationConfig(IpV6FragmentationConfigIdx) < (FragHdrOfs + FragOfs + FragLen))
  {
  ...
  else if (raBufferDescPtr->IpV6ReassemblySegmentActiveEndIdx == TcpIp_GetIpV6ReassemblySegmentStartIdxOfIpV6ReassemblyBufferDescriptor(IpV6ReassemblyBufferDescriptorIdx))
  {
 ...
 uint16                                          DataLen)
{
  ...
  TcpIp_IpV6ReassemblyDataBufferStartIdxOfIpV6ReassemblyBufferDescriptorType startIpV6ReassemblyDataBufferIdx =
      TcpIp_GetIpV6ReassemblyDataBufferStartIdxOfIpV6ReassemblyBufferDescriptor(IpV6ReassemblyBufferDescriptorIdx);
   ...
   *     and add to to the beginning of the segment reassembly list */
  /* PRQA S 0315 1 */ /* MD_MSR_VStdLibCopy */
  IpV6_MemCpy(TcpIp_GetAddrIpV6ReassemblyDataBuffer(startIpV6ReassemblyDataBufferIdx), &DataPtr[0], FragHdrOfs);

  /* add unfragmentable part to segment list */
  if (E_OK != IpV6_VSegmentListAdd(IpV6ReassemblyBufferDescriptorIdx, 0, FragHdrOfs))
  {
    /* Too much out-of-order segments received. Check for overlapping fragments according to [RFC5722] not possible.
  ...
  else
  {
    ...
    if (0u == PrevHdrOfs)
    {
      ...
      TcpIp_SetIpV6ReassemblyDataBuffer(startIpV6ReassemblyDataBufferIdx + IPV6_HEADER_NXT_HDR_FIELD_OFFS, FragExtNextHdr);
    ...
    else
    {
       ...
       */
      TcpIp_SetIpV6ReassemblyDataBuffer(startIpV6ReassemblyDataBufferIdx + PrevHdrOfs, FragExtNextHdr);
 ...
 uint16                                         PrevHdrOfs)
{
  ...
  uint16 FragOfs = (uint16)(TCPIP_NTOHS(fragmentOffsetNbo) & 0xFFF8U); /* fragment offset in bytes (original packet) */
  uint16 FragPayloadOfs = (FragHdrOfs + IPV6_FRAGMENT_EXT_HDR_LEN);   /* offset of fragment payload (in current packet) */
  uint16 FragLen = (DataLen - FragPayloadOfs);                        /* length of fragment */

  /* #10 Process the first fragment when received */
  if (   (FragOfs == 0u)                                                                                                /* PRQA S 3415 2 */ /*  MD_TCPIP_Rule13.5_3415_CslReadOnly */
      && (IpV6_Ip_VProcessFirstFragment(IpV6ReassemblyBufferDescriptorIdx, FragHdrOfs, PrevHdrOfs, DataPtr, DataLen) != E_OK))
  {
    result = E_NOT_OK;
  }
  ...
  else
  {
    ...
    if (E_OK != IpV6_VSegmentListAdd(IpV6ReassemblyBufferDescriptorIdx, raBufferDescPtr->FirstFragHdrOfs + FragOfs, FragLen))
    {
      raBufferDescPtr->Status = IPV6_FRAG_STATUS_SEGM_ERROR;
      result = E_NOT_OK;
    }
    else
    {
      ...
      if (   (raBufferDescPtr->FirstReceived == TRUE)
          && (raBufferDescPtr->LastReceived == TRUE))
      {
        TcpIp_SizeOfIpV6ReassemblySegmentType startIpV6ReassemblySegmentIdx =
          TcpIp_GetIpV6ReassemblySegmentStartIdxOfIpV6ReassemblyBufferDescriptor(IpV6ReassemblyBufferDescriptorIdx);
        ...
        if (   ((startIpV6ReassemblySegmentIdx + 1u) == raBufferDescPtr->IpV6ReassemblySegmentActiveEndIdx)
            && (TcpIp_GetIpV6ReassemblySegment(startIpV6ReassemblySegmentIdx).StartOfs == 0u))
        {
  ...
  uint16                      PrevHdrOfs)
{
  ...
  TcpIp_SizeOfIpV6CtrlType                ipCtrlIdx = TcpIp_GetIpV6CtrlIdxOfLocalAddrV6(LocalAddrV6Idx);
  uint16                                  FragOfs   = 0u;
  uint16                                  FragPayloadOfs = 0u;
  uint16                                  FragLen = 0u;
  uint32                                  FragId  = 0u;
  TcpIp_SizeOfIpV6FragmentationConfigType fragConfigIdx = TcpIp_GetSizeOfIpV6FragmentationConfig();
  TcpIp_SizeOfIpV6ReassemblyBufferDescriptorType raBufferDescIdx = IPV6_INV_LIST_IDX;
  uint32 fragIdNbo = 0u;
  uint16 fragmentOffsetNbo = 0u;
  uint8  fragExtNextHdr = 0u;
...
#  if (TCPIP_SUPPORT_IPV6_RX_FRAGMENTATION == STD_ON)
  ...
  if ( ((uint32)FragHdrOfs + FragOfs + FragLen) > 0x0000FFFFU)
  {
#   if (TCPIP_SUPPORT_ICMPV6_MSG_PARAM_PROBLEM == STD_ON) && (TCPIP_SUPPORT_ICMPV6_ERROR_MESSAGES == STD_ON)
...
#   endif
  ...
  else if (E_OK == IpV6_VGetReassemblyBufferIdx(LocalAddrV6Idx, &srcAddr, FragId, &raBufferDescIdx))
  {
    ...
    if (FALSE == IpV6_Ip_VRaBuffDescValidate(fragConfigIdx, raBufferDescIdx, FragHdrOfs, FragLen, FragOfs))
    {
      result = E_NOT_OK;
    }
    else if (E_OK != IpV6_Ip_VProcessValidFragment(raBufferDescIdx, FragHdrOfs, DataPtr, DataLen, PrevHdrOfs))
    {
      result = E_NOT_OK;
    }
    else
...
)
{
  ...
  TcpIp_SizeOfIpV6ReassemblyDataBufferType startIpV6ReassemblyDataBufferIdx =
    TcpIp_GetIpV6ReassemblyDataBufferStartIdxOfIpV6ReassemblyBufferDescriptor(IpV6ReassemblyBufferDescriptorIdx);
      ...
      (IPV6_FRAG_STATUS_ACTIVE == raBufferDescPtr->Status))
  {
    ...
    /* PRQA S 0315 1 */ /* MD_MSR_VStdLibCopy */
    IPV6_ADDR_COPY(srcAddr, (TcpIp_GetAddrIpV6ReassemblyDataBuffer(startIpV6ReassemblyDataBufferIdx))[IPV6_HDR_OFF_SRCADDR]);
    ...
    if (IpV6_Icmp_VTxTimeExceeded(localAddrV6Idx, &srcAddr, IPV6_ICMP_MSG_TIME_EXCEEDED_CODE_TIME_EXCEEDED, &OrigPktBufPtr, &OrigPktBufLen, NULL_PTR, 0u) == E_OK)
    {
      uint16 OrigPktBufPos;

      /* copy original packet unfragmentable part into icmp tx buffer */
      /* PRQA S 0315 1 */ /* MD_MSR_VStdLibCopy */
      IpV6_MemCpy(OrigPktBufPtr, TcpIp_GetAddrIpV6ReassemblyDataBuffer(startIpV6ReassemblyDataBufferIdx), raBufferDescPtr->FirstFragHdrOfs);
      ...
      TCPIP_ASSERT((startIpV6ReassemblyDataBufferIdx + raBufferDescPtr->FirstFragHdrOfs) < TcpIp_GetIpV6ReassemblyDataBufferEndIdxOfIpV6ReassemblyBufferDescriptor(IpV6ReassemblyBufferDescriptorIdx));
      /* PRQA S 0315 1 */ /* MD_MSR_VStdLibCopy */
      IpV6_MemCpy(&OrigPktBufPtr[OrigPktBufPos], TcpIp_GetAddrIpV6ReassemblyDataBuffer(startIpV6ReassemblyDataBufferIdx + raBufferDescPtr->FirstFragHdrOfs), ((uint32) OrigPktBufLen - (uint32) OrigPktBufPos));
    }
    else
    {
...
TCPIP_LOCAL FUNC(void, TCPIP_CODE) IpV6_VRxFragments(TcpIp_IpV6CtrlIterType IpCtrlIdx)
{
       ...
       ipV6ReassemblyBufferDescriptorIdx++)
  {
    ...
    if (raBufferDescPtr->Status == IPV6_FRAG_STATUS_UNUSED)
    {
      /* skip */
    }
    /* #20 Invoke ipv6 rx indication routine for descriptors for which fragment reassembly has been completed */
    else if (raBufferDescPtr->Status == IPV6_FRAG_STATUS_COMPLETE)
    {
      /* fragment reassembly complete */

      /* update payload length field in IPv6 header of reassembled packet */
      TcpIp_SetIpV6ReassemblyDataBuffer(startIpV6ReassemblyDataBufferIdx + 4u, (uint8)(raBufferDescPtr->OrigPktPayloadLen >> 8));
      TcpIp_SetIpV6ReassemblyDataBuffer(startIpV6ReassemblyDataBufferIdx + 5u, (uint8)(raBufferDescPtr->OrigPktPayloadLen));

      /* call IpV6_RxIndication_Internal() with reassembled packet */
      IpV6_RxIndication_Internal(TcpIp_GetEthIfCtrlIdxOfIpV6Ctrl(IpCtrlIdx), (uint8*)NULL_PTR,
        TcpIp_GetAddrIpV6ReassemblyDataBuffer(startIpV6ReassemblyDataBufferIdx), IPV6_HDR_LEN + raBufferDescPtr->OrigPktPayloadLen, TRUE);
...
#  if (TCPIP_SUPPORT_IPV6_RX_FRAGMENTATION == STD_ON) && (TCPIP_SUPPORT_ICMPV6_ERROR_MESSAGES == STD_ON)
      IpV6_VFragReassemblyTimeExpired(IpCtrlIdx, ipV6ReassemblyBufferDescriptorIdx);
#  endif
      raBufferDescPtr->Status = IPV6_FRAG_STATUS_UNUSED;
    }
    else
...
TCPIP_LOCAL FUNC(void, TCPIP_CODE) IpV6_VTxFragments(TcpIp_IpV6CtrlIterType IpCtrlIdx)
{
       ...
       ipV6FragmentTxBufferDescriptorIdx++)
  {
    ...
    TCPIP_P2V(IpV6_FragmentTxBufferDescType) fragTxBufferDescPtr =
      TcpIp_GetAddrIpV6FragmentTxBufferDescriptorDyn(ipV6FragmentTxBufferDescriptorIdx);

    TcpIp_SizeOfIpV6FragmentTxDataBufferType startIpV6FragmentTxDataBufferIdx =
      TcpIp_GetIpV6FragmentTxDataBufferStartIdxOfIpV6FragmentTxBufferDescriptor(ipV6FragmentTxBufferDescriptorIdx);

    uint8  EthBufIdx;
    IPV6_P2V(Eth_DataType) EthBufPtr = NULL_PTR;
    uint16 EthBufLen = 0u;
    uint16 FragLen = 0u;
    uint8 MoreDataBit = 0u;

    /* #20 If fragment is ready for transmission, request for eth buffer and transmit fragment */
    if (fragTxBufferDescPtr->Status == IPV6_FRAG_TX_STATUS_TRANSMIT)
    {
      IpV6_AddrType destAddr;                                                                                           /* PRQA S 0759 */ /* MD_MSR_Union */
      IpV6_AddrType srcAddr;                                                                                            /* PRQA S 0759 */ /* MD_MSR_Union */
      uint8         *ipV6PacketHdr = TcpIp_GetAddrIpV6FragmentTxDataBuffer(startIpV6FragmentTxDataBufferIdx);
      uint8         nextHdr = TCPIP_GET_UINT8(ipV6PacketHdr, IPV6_HDR_OFF_NEXTHDR);
      TcpIp_IpTxRequestDescriptorType tmpDesc;
      ...
      /* Store values to tmp tx request description */
      tmpDesc.ChecksumHwCalced = fragTxBufferDescPtr->ChecksumCalcType;
      tmpDesc.TmpChecksum = fragTxBufferDescPtr->TmpChecksum;

      IpV6_Ip_VCalculateandStoreChecksum(&tmpDesc, nextHdr, &ipV6PacketHdr[IPV6_HDR_LEN], &destAddr, &srcAddr, FragLen);

      if (FragLen > fragTxBufferDescPtr->MaxFragLen)
      {
        /* remaining fragmentable part does not fit into one fragment */
      ...
      {
        uint16  EthBufOfs = fragTxBufferDescPtr->UnfragPartLen;
        ...
        /* PRQA S 0315 1 */ /* MD_MSR_VStdLibCopy */
        IpV6_MemCpy(EthBufUint8Ptr, TcpIp_GetAddrIpV6FragmentTxDataBuffer(startIpV6FragmentTxDataBufferIdx), fragTxBufferDescPtr->UnfragPartLen);
        ...
        TCPIP_ASSERT((startIpV6FragmentTxDataBufferIdx + fragTxBufferDescPtr->UnfragPartLen + fragTxBufferDescPtr->TxOfs) < TcpIp_GetIpV6FragmentTxDataBufferEndIdxOfIpV6FragmentTxBufferDescriptor(ipV6FragmentTxBufferDescriptorIdx));
        /* PRQA S 0315 1 */ /* MD_MSR_VStdLibCopy */
        IpV6_MemCpy(&EthBufUint8Ptr[EthBufOfs], TcpIp_GetAddrIpV6FragmentTxDataBuffer(startIpV6FragmentTxDataBufferIdx + fragTxBufferDescPtr->UnfragPartLen + fragTxBufferDescPtr->TxOfs), FragLen);
        EthBufOfs += FragLen;
...
TCPIP_LOCAL FUNC(void, TCPIP_CODE) IpV6_VInitFragments(TcpIp_IpV6CtrlIterType IpCtrlIdx)
{
  ...
  if (TcpIp_IsIpV6FragmentationConfigUsedOfIpV6Ctrl(IpCtrlIdx) == TRUE)
  {
    ...
    /*#10 Initialize all fragment tx and reassembly buffer descriptors states to UNUSED */
#  if (TCPIP_SUPPORT_IPV6_RX_FRAGMENTATION == STD_ON)
    if (TcpIp_GetReassemblyBufferCountOfIpV6FragmentationConfig(ipV6FragmentationConfigIdx) > 0u)
    {
      TcpIp_IpV6ReassemblyBufferDescriptorIterType ipV6ReassemblyBufferDescriptorIdx;

      for (ipV6ReassemblyBufferDescriptorIdx = TcpIp_GetIpV6ReassemblyBufferDescriptorStartIdxOfIpV6FragmentationConfig(ipV6FragmentationConfigIdx);
           ipV6ReassemblyBufferDescriptorIdx < TcpIp_GetIpV6ReassemblyBufferDescriptorEndIdxOfIpV6FragmentationConfig(ipV6FragmentationConfigIdx);
           ipV6ReassemblyBufferDescriptorIdx++)
      {
        TcpIp_GetAddrIpV6ReassemblyBufferDescriptorDyn(ipV6ReassemblyBufferDescriptorIdx)->Status = IPV6_FRAG_STATUS_UNUSED;
        TcpIp_GetAddrIpV6ReassemblyBufferDescriptorDyn(ipV6ReassemblyBufferDescriptorIdx)->IpV6ReassemblySegmentActiveEndIdx = TcpIp_GetIpV6ReassemblySegmentStartIdxOfIpV6ReassemblyBufferDescriptor(ipV6ReassemblyBufferDescriptorIdx);
      }
    }
#  endif
...
#  if (TCPIP_SUPPORT_IPV6_TX_FRAGMENTATION == STD_ON)
    ...
    if (TcpIp_GetTxFragmentBufferCountOfIpV6FragmentationConfig(ipV6FragmentationConfigIdx) > 0u)
    {
      TcpIp_SizeOfIpV6FragmentTxBufferDescriptorType ipV6FragmentTxBufferDescriptorIdx;
      ...
      for (ipV6FragmentTxBufferDescriptorIdx = TcpIp_GetIpV6FragmentTxBufferDescriptorStartIdxOfIpV6FragmentationConfig(ipV6FragmentationConfigIdx);
           ...
           ipV6FragmentTxBufferDescriptorIdx++)
      {
        TcpIp_GetAddrIpV6FragmentTxBufferDescriptorDyn(ipV6FragmentTxBufferDescriptorIdx)->Status = IPV6_FRAG_TX_STATUS_UNUSED;
      }
    }
#  endif
  }
...
{
  /* ----- Local Variables ---------------------------------------------- */
  TcpIp_SizeOfNvmDataType nvmDataIdx = TcpIp_GetNvmDataIdxOfIpV6SourceAddress(IpV6SourceAddressIdx);
  Std_ReturnType          retVal    = E_NOT_OK;
  uint8                   nvMStatus = NVM_REQ_PENDING;

  /* ----- Implementation ----------------------------------------------- */
  TCPIP_ASSERT(TcpIp_IsNvmDataUsedOfIpV6SourceAddress(IpV6SourceAddressIdx) == TRUE);
...
TCPIP_LOCAL FUNC(void, TCPIP_CODE) IpV6_VConfigureSourceAddresses(TcpIp_IpV6CtrlIterType IpCtrlIdx)
{
  ...
  for (ipV6SourceAddressIdx = TcpIp_GetIpV6SourceAddressStartIdxOfIpV6Ctrl(IpCtrlIdx);
       ...
       ipV6SourceAddressIdx++)
  {
    /* Only Unicast Automatic addresses shall be assign at startup */
    if (TcpIp_GetAddressAssignmentTriggerOfLocalAddrV6(TcpIp_GetLocalAddrV6IdxOfIpV6SourceAddress(ipV6SourceAddressIdx))
      == TCPIP_AUTOMATIC)
    {
...
# if (TCPIP_SUPPORT_IPV6_NVM_ADDR_STORAGE == STD_ON)
      ...
      if (TcpIp_IsNvmDataUsedOfIpV6SourceAddress(ipV6SourceAddressIdx) == TRUE)
      {
        if (IpV6_Ip_VNvmGetAddress(ipV6SourceAddressIdx, &NvmAddr) == E_OK)
        {
          addressPtr = &NvmAddr;
        }
      }
# endif
    ...
    TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressIdx)->Triggered = TRUE;

      /* #30 If no stored address present, assign configured default addresses for the source index */
      if ((TcpIp_IsDefaultAddrV6UsedOfIpV6SourceAddress(ipV6SourceAddressIdx) == TRUE)
# if (TCPIP_SUPPORT_IPV6_NVM_ADDR_STORAGE == STD_ON)
...
# endif
          )
      {
        ...
        addressPtr = TcpIp_GetAddrDefaultAddrV6(TcpIp_GetDefaultAddrV6IdxOfIpV6SourceAddress(ipV6SourceAddressIdx));
      }

      if (addressPtr != NULL_PTR)
      {
        /* Address has been found in the NvM or default address will be configured */
        if (E_OK != IpV6_Ndp_VAddSourceAddress(ipV6SourceAddressIdx, addressPtr, IPV6_LIFETIME_UNLIMITED,
        ...
        IpV6_SelectDefaultRouterConfigAndCreateEntry(TcpIp_GetLocalAddrV6IdxOfIpV6SourceAddress(ipV6SourceAddressIdx), NULL_PTR);
      }
    }
  }
...
TCPIP_LOCAL FUNC(void, TCPIP_CODE) IpV6_VConfigureMulticastAddresses(TcpIp_IpV6CtrlIterType IpCtrlIdx)
{
  ...
  else
  {
         ...
         ipV6MulticastAddrIdx++)
    {
      ...
      /* Only autmatic multicast addresses shall be assign at startup */
      if (  TcpIp_GetAddressAssignmentTriggerOfLocalAddrV6(TcpIp_GetLocalAddrV6IdxOfIpV6MulticastAddr(ipV6MulticastAddrIdx))
          == TCPIP_AUTOMATIC)
      {
        ...
        if (TcpIp_IsDefaultAddrV6UsedOfIpV6MulticastAddr(ipV6MulticastAddrIdx) == TRUE)
        {
          ...
          {
            /* PRQA S 0315 1 */ /* MD_MSR_VStdLibCopy */
            IPV6_ADDR_COPY(*TcpIp_GetAddrIpV6MulticastAddrActive(ipV6MulticastAddrActiveIdx), *defaultAddrPtr);
          }
        ...
        /* #40 If no default address configured assign unspecified address to index */
        else
        {
          ...
          /* PRQA S 0315 1 */ /* MD_MSR_VStdLibCopy */
          IPV6_ADDR_COPY(*TcpIp_GetAddrIpV6MulticastAddrActive(ipV6MulticastAddrActiveIdx), IpV6_AddrUnspecified);
        }
      }
    }
  }
...
TCPIP_LOCAL FUNC(void, TCPIP_CODE) IpV6_VCtrlStateStartup(uint8 IpCtrlIdx)
{
  ...
  else
  {
    ...
    IpV6_VGetInterfaceIdentifier(IpCtrlIdx, TcpIp_GetAddrInterfaceIdentifier(startInterfaceIdentifierIdx));
...
TCPIP_LOCAL FUNC(void, TCPIP_CODE) IpV6_VCtrlStateChangeToOnHold(TcpIp_IpV6CtrlIterType IpCtrlIdx)
{
  ...
  for (ipV6SourceAddressIdx = TcpIp_GetIpV6SourceAddressStartIdxOfIpV6Ctrl(IpCtrlIdx);
    ...
    ipV6SourceAddressIdx++)
  {
    TcpIp_LocalAddrIterType localAddrIdx = TCPIP_IPV6_TO_LOCAL_ADDR_IDX(TcpIp_GetLocalAddrV6IdxOfIpV6SourceAddress(ipV6SourceAddressIdx));
...
{
  /* ----- Local Variables ---------------------------------------------- */
  TcpIp_SizeOfIpV6SourceAddressTableEntryType ipV6SourceAddressTableEntryTypeIdx;
  TcpIp_SizeOfIpV6MulticastAddrType ipV6MulticastAddrIdx;
  ...
  for (ipV6SourceAddressTableEntryTypeIdx = TcpIp_GetIpV6SourceAddressStartIdxOfIpV6Ctrl(IpCtrlIdx);
    ipV6SourceAddressTableEntryTypeIdx < TcpIp_GetIpV6SourceAddressEndIdxOfIpV6Ctrl(IpCtrlIdx);
    ipV6SourceAddressTableEntryTypeIdx++)
  {
    TcpIp_LocalAddrIterType localAddrIdx = TCPIP_IPV6_TO_LOCAL_ADDR_IDX(TcpIp_GetLocalAddrV6IdxOfIpV6SourceAddress(ipV6SourceAddressTableEntryTypeIdx));
...
# if (TCPIP_SUPPORT_DHCPV6 == STD_ON)
  ...
  {
    TcpIp_SizeOfIpV6SourceAddressType dhcpIpV6SourceAddressTableEntryIdx = TcpIp_GetIpV6SourceAddressDhcpIdxOfIpV6Ctrl(IpCtrlIdx);

    TCPIP_ASSERT(TcpIp_IsIpV6SourceAddressDhcpUsedOfIpV6Ctrl(IpCtrlIdx));

    if (TcpIp_GetIpV6SourceAddressTableEntry(dhcpIpV6SourceAddressTableEntryIdx).State == IPV6_LADDR_STATE_INVALID)
    {
...
TCPIP_LOCAL FUNC(void, TCPIP_CODE) IpV6_VCtrlStateShutdown(TcpIp_IpV6CtrlIterType IpCtrlIdx)
{
  ...
  for (ipV6SourceAddressTableEntryIdx = TcpIp_GetIpV6SourceAddressStartIdxOfIpV6Ctrl(IpCtrlIdx);
       ...
       ipV6SourceAddressTableEntryIdx++)
  {
    TCPIP_P2V(IpV6_SourceAddressTableEntryType) srcAddrPtr = TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx);

    if (IPV6_LADDR_STATE_INVALID != TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx)->State)
    {
      IpV6_VHandleSourceAddrAssignmentChange(ipV6SourceAddressTableEntryIdx, FALSE);
    }
    /* PRQA S 0315 1 */ /* MD_MSR_VStdLibCopy */
    IPV6_ADDR_COPY(srcAddrPtr->Address, IpV6_AddrUnspecified);
  }
...
# if (TCPIP_SUPPORT_DHCPV6 == STD_ON)
  ...
  if (   (TcpIp_GetDhcpModeOfIpV6Ctrl(IpCtrlIdx) == IPV6_DHCPV6_MODE_MANUAL)
...
# endif
  ...
  /* block used for limitation of variable scope */
  {
         ...
         ipV6MulticastAddrIdx++)
    {
      ...
      if (TcpIp_IsIpV6MulticastAddrActiveUsedOfIpV6MulticastAddr(ipV6MulticastAddrIdx) == TRUE)
      {
        TcpIp_SizeOfIpV6MulticastAddrActiveType ipV6MulticastAddrActiveIdx =
        ...
        if (IPV6_ADDR_IS_MULTICAST(*TcpIp_GetAddrIpV6MulticastAddrActive(ipV6MulticastAddrActiveIdx)))
        {
          mcAddrPtr = TcpIp_GetAddrIpV6MulticastAddrActive(ipV6MulticastAddrActiveIdx);
        }
      }
      ...
      {
        TcpIp_SizeOfDefaultAddrV6Type defaultAddrV6Idx =
...
# if (TCPIP_SUPPORT_IPV6_PATH_MTU == STD_ON)
    if (TcpIp_IsEnablePathMtuOfIpV6Ctrl(IpCtrlIdx) == TRUE)
    {
      ...
      {
        TCPIP_P2V(IpV6_DestinationCacheEntryType) dcEntryPtr = TcpIp_GetAddrIpV6DestinationCacheEntry(ipV6DestinationCacheEntryIdx);
...
FUNC(void, TCPIP_CODE) IpV6_MainFunctionState(void)
{
  ...
  else
  {
    ...
    for (ipCtrlIdx = 0; ipCtrlIdx < TcpIp_GetSizeOfIpV6Ctrl(); ipCtrlIdx++)
    {
      ...
      if (TcpIp_GetCtrlStateOfIpV6CtrlDyn(ipCtrlIdx) == IPV6_CTRL_STATE_LLADDR_DAD_FAIL)
      {
        continue;
      }
  ...
  TcpIp_SizeOfIpV6SourceAddressTableEntryType IpV6SourceAddressTableEntryIdx)
{
  ...
  */
  IpV6_LocAddrStateType srcAddrState = TcpIp_GetAddrIpV6SourceAddressTableEntry(IpV6SourceAddressTableEntryIdx)->State;
  boolean isActive;
  ...
  IPV6_P2V(IpV6_DstAddrFlagsType) DstAddrFlagsPtr)
{
  ...
  IpV6_ListIdxType ipV6NeighborCacheEntryIdx = TcpIp_GetAddrIpV6DestinationCacheEntry(IpV6DestinationCacheEntryIdx)->NcIdxHint;
  ...
  if (E_OK == IpV6_Ndp_VNCLookup(IpCtrlIdx, *NextHopAddrPtrPtr, &ipV6NeighborCacheEntryIdx))
  {
    ...
    {
      /* PRQA S 0315 1 */ /* MD_MSR_VStdLibCopy */
      IPV6_LL_ADDR_COPY(PhysAddrPtr, &TcpIp_GetAddrIpV6NeighborCacheEntry(ipV6NeighborCacheEntryIdx)->LinkLayerAddress[0]);
      nextHopReachable = TRUE;
    }
  }
  /* #20 If destination address is optimistic, send packet to default router instead */
  if (   (nextHopReachable == FALSE)
      && ((DstAddrFlagsPtr->DstAddrOnLink) == TRUE))
  {
    TcpIp_SizeOfIpV6DefaultRouterListEntryType  ipV6DefaultRouterListEntryIdx
      = TcpIp_GetIpV6DefaultRouterListEntryValidEndIdxOfIpV6CtrlDyn(IpCtrlIdx);
    ...
    if (IpV6_VGetDefaultRouterAddr(IpCtrlIdx, LocalAddrV6Idx, DstAddrPtr, &nextHopReachable, &ipV6DefaultRouterListEntryIdx) == E_OK)
    {
      /* PRQA S 0315 1 */ /* MD_MSR_VStdLibCopy */
      *NextHopAddrPtrPtr = &(TcpIp_GetAddrIpV6DefaultRouterListEntry(ipV6DefaultRouterListEntryIdx)->NextHopAddress);
    }
    else
    {
  ...
  IPV6_P2V(TcpIp_IpTxRequestDescriptorType) TxReqDescrPtr)
{
  ...
  if ((*BufLenPtr) <= TcpIp_GetTxFragmentBufferSizeOfIpV6FragmentationConfig(ipV6FragmentationConfigIdx))
  {
    TcpIp_SizeOfIpV6FragmentTxBufferDescriptorType ipV6FragmentTxBufferDescriptorIdx;

    if (IpV6_VGetFragmentTxBufferIdx(IpCtrlIdx, &ipV6FragmentTxBufferDescriptorIdx)  == E_OK)
    {
      TCPIP_P2V(IpV6_FragmentTxBufferDescType)  fragTxBufDescPtr
       = TcpIp_GetAddrIpV6FragmentTxBufferDescriptorDyn(ipV6FragmentTxBufferDescriptorIdx);
      TcpIp_SizeOfIpV6FragmentTxDataBufferType startIpV6FragmentTxDataBufferIdx = 0u;

      TCPIP_ASSERT(ipV6FragmentTxBufferDescriptorIdx < TcpIp_GetSizeOfIpV6FragmentTxBufferDescriptor());
      ...
      fragTxBufDescPtr->ChecksumCalcType = TxReqDescrPtr->ChecksumHwCalced;
      fragTxBufDescPtr->TmpChecksum = TxReqDescrPtr->TmpChecksum;
      /* IPV6_CTRL_VAR(IpV6_FragmentTxBufferDescriptors)[BufIdx].NextHopPhysAddr  will be set in IpV6_Transmit() */

      IPV6_END_CRITICAL_SECTION();

      startIpV6FragmentTxDataBufferIdx =
        TcpIp_GetIpV6FragmentTxDataBufferStartIdxOfIpV6FragmentTxBufferDescriptor(ipV6FragmentTxBufferDescriptorIdx);

      (*BufPtrPtr) = TcpIp_GetAddrIpV6FragmentTxDataBuffer(startIpV6FragmentTxDataBufferIdx);
      (*BufLenPtr) = TcpIp_GetTxFragmentBufferSizeOfIpV6FragmentationConfig(ipV6FragmentationConfigIdx);
      TxReqDescrPtr->BufIdx = ipV6FragmentTxBufferDescriptorIdx;
 ...
 IPV6_P2C(IpV6_AddrType)                               DstAddrPtr)
{
  ...
  TcpIp_SizeOfIpV6SourceAddressTableEntryType ipV6SourceAddressTableEntryIdx = TCPIP_IPV6_SRC_ADDR_IDX_INV;
  TCPIP_P2V(IpV6_DestinationCacheEntryType) dcEntryPtr = TcpIp_GetAddrIpV6DestinationCacheEntry(IpV6DestinationCacheEntryIdx);

  /* ----- Implementation ----------------------------------------------- */

  /* #10 Select and assign a valid source address index to send packet to destination */
  if (IpV6_VSelectSourceAddress(IpCtrlIdx, DstAddrPtr, &ipV6SourceAddressTableEntryIdx) == E_OK)
  {
    TCPIP_ASSERT(ipV6SourceAddressTableEntryIdx < TcpIp_GetSizeOfIpV6SourceAddress());
    ...
    dcEntryPtr->SourceAddressIdx = ipV6SourceAddressTableEntryIdx;

# if (TCPIP_SUPPORT_NDP_DAD_OPTIMISTIC == STD_ON)
    if (IPV6_LADDR_STATE_OPTIMISTIC == TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx)->State)
    {
...
#  if (TCPIP_SUPPORT_IPV6_PATH_MTU == STD_ON)
  if (TcpIp_IsEnablePathMtuOfIpV6Ctrl(IpCtrlIdx) == TRUE)
  {
    pathMtu = TcpIp_GetAddrIpV6DestinationCacheEntry(IpV6DestinationCacheEntryIdx)->Mtu;
  }
  else
#  endif
...
# endif
  ...
  if (TcpIp_IsIpV6SourceAddressUsedOfLocalAddrV6(LocalAddrV6Idx) == TRUE)
  {
    ...
    if (IpV6_Ip_VIsSourceAddressActive(
# if (TCPIP_SUPPORT_NDP_DAD == STD_ON)
          IpCtrlIdx,
          SrcAddrFlagsPtr,
# endif
  ...
  IPV6_P2C(IpV6_AddrType)                                DstAddrPtr)
{
  ...
  if ((IpV6_Ndp_VDCLookup(IpCtrlIdx, DstAddrPtr, DcEntryIdxPtr) == E_OK))
  {
 ...
 IPV6_P2V(TcpIp_IpV6_AddrTypeP2C)    NextHopAddrPtrPtr)
{
  ...
  else
  {
    ...
    if (DstAddrFlagsPtr->DstAddrOnLink == TRUE)
    {
    ...
    else
    {
      ...
      if (IpV6_VGetDefaultRouterAddr(ipCtrlIdx, LocalAddrV6Idx, DstAddrPtr, &(DstAddrFlagsPtr->NextHopReachable), DcEntryIdxPtr) == E_OK)
      {
...
{
  /* ----- Local Variables ----------------------------------------------- */
  boolean validDestAddr = TRUE;

  /* ----- Implementation ----------------------------------------------- */

  /*#10 Validate the destination address */
  /* Get Ip Controller index */
  if (IpV6_Ip_VGetIpControllerIdx(LocalAddrV6IdxPtr, IpCtrlIdxPtr) != E_OK)
  {
    /* No default controller configured. */
    validDestAddr = FALSE;
  }
 ...
 boolean                    ForceProvideBuffer)
{
  ...
  IpV6_ListIdxType NcEntryIdx = TcpIp_GetAddrIpV6DestinationCacheEntry(IpV6DestinationCacheEntryIdx)->NcIdxHint;

  IpV6_DstAddrFlagsType  DstAddrFlags = { FALSE, FALSE };
  Eth_PhysAddrType       NextHopLLAddr = { 0u };

  /* ----- Implementation ----------------------------------------------- */

  DstAddrFlags.DstAddrOnLink =  TcpIp_GetAddrIpV6DestinationCacheEntry(IpV6DestinationCacheEntryIdx)->DestinationOnLink; /* PRQA S 2983 */ /* MD_TCPIP_Rule2.2_2981_2983 */
...
# if (TCPIP_SUPPORT_NDP_DAD_OPTIMISTIC == STD_ON)
  ...
  {
    IpV6_Ip_VNextHopLLDadOptimistic(ipCtrlIdx, LocalAddrV6Idx, IpV6DestinationCacheEntryIdx, NextHopAddrPtrPtr,
                             DstAddrPtr, &NextHopLLAddr[0], &DstAddrFlags);
  }
# endif
  /* #20 Perform link layer address resolution */
  else if (IpV6_VResolveLinkLayerAddr(ipCtrlIdx, srcAddrIdx, *NextHopAddrPtrPtr, &NextHopLLAddr[0], &NcEntryIdx) == E_OK)
  {
    ...
    TcpIp_GetAddrIpV6DestinationCacheEntry(IpV6DestinationCacheEntryIdx)->NcIdxHint = NcEntryIdx;
    DstAddrFlags.NextHopReachable = TRUE;
  }
  else
  {
  ...
  if ((DstAddrFlags.NextHopReachable == FALSE) && (ForceProvideBuffer == FALSE))
  {
    ...
    /* PRQA S 0315 1 */ /* MD_MSR_VStdLibCopy */
    IPV6_ADDR_COPY(TcpIp_GetAddrIpV6DestinationCacheEntry(IpV6DestinationCacheEntryIdx)->NextHopAddress, *nextHopAddrPtr);
 ...
 IPV6_P2C(IpV6_AddrType)                                DstAddrPtr)
{
  ...
  if (BUFREQ_OK != IpV6_Ip_VCallerSpecifiedSourceAddress(ipCtrlIdx, LocalAddrV6Idx,
# if (TCPIP_SUPPORT_NDP_DAD == STD_ON)
    SrcAddrFlagsPtr,
# endif
    SrcAddrIdxPtr))
  ...
  else if (BUFREQ_OK != IpV6_Ip_VDCSourceAddressLookup(ipCtrlIdx, SrcAddrIdxPtr,
# if (TCPIP_SUPPORT_NDP_DAD_OPTIMISTIC == STD_ON)
...
# endif
  {
    ...
    IPV6_ADDR_COPY(*SrcAddrPtr, TcpIp_GetAddrIpV6SourceAddressTableEntry(IpV6SourceAddressTableEntryIdx)->Address);
  }
}
/**********************************************************************************************************************
...
FUNC(BufReq_ReturnType, TCPIP_CODE) IpV6_ProvideTxBuffer(                                                               /* PRQA S 2889 */ /* MD_IPV6_Rule15.5_ComplexFunction */
    ...
    IPV6_P2V(uint16)                          BufLenPtr,
    IPV6_P2V(TcpIp_IpTxRequestDescriptorType) TxReqDescrPtr,
    TcpIp_IpProtocolType                      Protocol,
    boolean                                   ForceProvideBuffer)
{
  /* ----- Local Variables ----------------------------------------------- */
  TcpIp_SizeOfIpV6CtrlType ipCtrlIdx = TcpIp_GetSizeOfIpV6Ctrl();
  TcpIp_SizeOfIpV6SourceAddressTableEntryType ipV6SourceAddressIdx = TCPIP_IPV6_SRC_ADDR_IDX_INV;

  IPV6_P2C(IpV6_AddrType)NextHopAddrPtr = NULL_PTR;
  IpV6_ListIdxType       IpV6DestinationCacheEntryIdx     = 0u;
  BufReq_ReturnType      Result         = BUFREQ_E_NOT_OK;
  IpV6_DstAddrFlagsType  DstAddrFlags   = { FALSE, FALSE };
...
# if (TCPIP_SUPPORT_NDP_DAD == STD_ON)
  IpV6_SrcAddrFlagsType SrcAddrFlags = { FALSE };
# endif
...
# endif
  ...
  if (FALSE == IpV6_Ip_VValidateDestAddr(LocalAddrV6IdxPtr, &ipCtrlIdx, DstAddrPtr))
  {
  ...
  IpV6DestinationCacheEntryIdx = TcpIp_GetIpV6DestinationCacheEntryHintIdxOfIpV6SocketDyn(IpV6SocketIdx);

  /* #20 Perform next hop address resolution */
  if (BUFREQ_OK !=
    IpV6_Ip_VObtainNextHopAddress(*LocalAddrV6IdxPtr, &IpV6DestinationCacheEntryIdx, DstAddrPtr,
...
# if (TCPIP_SUPPORT_NDP_DAD_OPTIMISTIC == STD_ON)
  TcpIp_GetAddrIpV6DestinationCacheEntry(IpV6DestinationCacheEntryIdx)->DestinationOnLink = DstAddrFlags.DstAddrOnLink;
# endif
   ...
   */
  TcpIp_SetIpV6DestinationCacheEntryHintIdxOfIpV6SocketDyn(IpV6SocketIdx, IpV6DestinationCacheEntryIdx);

  /* #30 Invoke routine to obtain Source Address to send packet to destination */
  if (BUFREQ_OK != IpV6_Ip_VObtainSourceAddress((*LocalAddrV6IdxPtr), &ipV6SourceAddressIdx,
# if (TCPIP_SUPPORT_NDP_DAD == STD_ON)
    &SrcAddrFlags,
# endif
    &IpV6DestinationCacheEntryIdx, DstAddrPtr))
  {
    /* no matching source address found */
    TCPIP_P2V(IpV6_DestinationCacheEntryType) dcEntryPtr = TcpIp_GetAddrIpV6DestinationCacheEntry(IpV6DestinationCacheEntryIdx);

    /* uninitialized the destination cache source address index */
    dcEntryPtr->SourceAddressIdx = TCPIP_IPV6_SRC_ADDR_IDX_INV;
  ...
  TCPIP_ASSERT(ipV6SourceAddressIdx < TcpIp_GetSizeOfIpV6SourceAddress());

  (*LocalAddrV6IdxPtr) = TcpIp_GetLocalAddrV6IdxOfIpV6SourceAddress(ipV6SourceAddressIdx);

  /* Source address and next hop determination completed. (ipV6SourceAddressTableEntryIdx and NextHopAddrPtr valid) */

  /* #40 Perform link-layer address resolution for next hop address */
  if (FALSE == DstAddrFlags.NextHopReachable)
  {
    if (BUFREQ_E_BUSY == IpV6_Ip_VNextHopLLResolution(*LocalAddrV6IdxPtr, IpV6DestinationCacheEntryIdx, DstAddrPtr,
# if (TCPIP_SUPPORT_NDP_DAD_OPTIMISTIC == STD_ON)
...
#  endif
  ...
  if ((   (TcpIp_IsIpV6FragmentationConfigUsedOfIpV6Ctrl(ipCtrlIdx) == TRUE)
       ...
       && (   ((*BufLenPtr) > PathMtu)
#  if (TCPIP_SUPPORT_IPV6_PATH_MTU == STD_ON)
           || (TcpIp_GetAddrIpV6DestinationCacheEntry(IpV6DestinationCacheEntryIdx)->MtuReported < PathMtu)
#  endif
    ))
  {
...
# endif
  ...
  if (BUFREQ_OK == Result)
  {
    ...
    IpV6_Ip_VConfigureSourceAddress(ipCtrlIdx, ipV6SourceAddressIdx,
# if (TCPIP_SUPPORT_NDP_DAD == STD_ON)
...
# endif
     ...
     */
    TxReqDescrPtr->SrcAddrIdx    = ipV6SourceAddressIdx;
    ...
    TxReqDescrPtr->SockIdx       = (TcpIp_SizeOfIpV6SocketDynType)IpV6SocketIdx;
    TxReqDescrPtr->AddressFamily = TCPIP_AF_INET6;
    TxReqDescrPtr->XptProtocol   = Protocol;
    TxReqDescrPtr->ChecksumHwCalced = IpV6_Ip_CheckIfChecksumCalcIsRequired(TxReqDescrPtr);
    TxReqDescrPtr->TmpChecksum = 0u;
...
{
  /* ----- Local Variables ----------------------------------------------- */
  TcpIp_SizeOfIpV6SourceAddressType ipV6SourceAddressIdx = TxReqDescrPtr->SrcAddrIdx;
  TcpIp_SizeOfLocalAddrV6Type       localAddrV6Idx = TcpIp_GetLocalAddrV6IdxOfIpV6SourceAddress(ipV6SourceAddressIdx);
  TcpIp_SizeOfIpV6CtrlType          ipCtrlIdx = TcpIp_GetIpV6CtrlIdxOfLocalAddrV6(localAddrV6Idx);
  ...
  uint16                                               PayloadLen)
{
  ...
  if (TxReqDescrPtr->ChecksumHwCalced == TCPIP_IP_PROTOCOL_CHECKSUM_CHECK_COMPLETE)
  {
    protocolChecksum = IpBase_TcpIpChecksumAdd(PayloadPtr, PayloadLen, protocolChecksum, TRUE);
  }
  else /* if (TxReqDescrPtr->ChecksumHwCalced == TCPIP_IP_PROTOCOL_CHECKSUM_CHECK_COPY) */
  {
    protocolChecksum = TcpIp_AddPartialChecksums(protocolChecksum, TxReqDescrPtr->TmpChecksum);
    protocolChecksum = IpBase_TcpIpChecksumAdd(PayloadPtr, 0, protocolChecksum, TRUE); /* Finalize checksum */
  }
    ...
    boolean                                   RetryOnPhysAddrMiss)
{
  ...
  TcpIp_SizeOfIpV6DestinationCacheEntryType ipV6DestinationCacheEntryIdx     = 0u;
  ...
  ipV6DestinationCacheEntryIdx = TcpIp_GetIpV6DestinationCacheEntryHintIdxOfIpV6SocketDyn(IpV6SocketIdx);
  Result = IpV6_Ndp_VDCLookup(ipCtrlIdx, &destAddr, &ipV6DestinationCacheEntryIdx);
  TcpIp_SetIpV6DestinationCacheEntryHintIdxOfIpV6SocketDyn(IpV6SocketIdx, ipV6DestinationCacheEntryIdx);
...
# if (TCPIP_SUPPORT_NDP_INV_NS == STD_ON)
        ...
        && (TcpIp_IsIcmpNextHopLLAddrOverrideOfIpV6CtrlDyn(ipCtrlIdx) == TRUE))
    {
       ...
       * This is necessary only for sending Inverse Neighbor Discovery Solicitations.
...
# endif
    {
      ...
      TCPIP_ASSERT(ipV6DestinationCacheEntryIdx >= TcpIp_GetIpV6DestinationCacheEntryStartIdxOfIpV6Ctrl(ipCtrlIdx));
      TCPIP_ASSERT(ipV6DestinationCacheEntryIdx  < TcpIp_GetIpV6DestinationCacheEntryEndIdxOfIpV6Ctrl(ipCtrlIdx));

      dcEntryPtr = TcpIp_GetAddrIpV6DestinationCacheEntry(ipV6DestinationCacheEntryIdx);
      ...
      if (IpV6_VResolveLinkLayerAddr(ipCtrlIdx, dcEntryPtr->SourceAddressIdx, &dcEntryPtr->NextHopAddress, &NextHopLLAddr[0], &dcEntryPtr->NcIdxHint) != E_OK)
      {
...
# if (TCPIP_SUPPORT_IPV6_TX_FRAGMENTATION == STD_ON)
    if (FALSE == TxReqDescrPtr->IsEthBufV6)
    {
      ...
      /* Store the current state of the checksum in fragmentation Desc. */
      fragTxBufferDescPtr->TmpChecksum = TxReqDescrPtr->TmpChecksum;
...
# endif
    {
      ...
      if (TxReqDescrPtr->ChecksumHwCalced != TCPIP_IP_PROTOCOL_CHECKSUM_CHECK_HW_OR_NOT_REQ)
      {
        P2VAR(uint8, AUTOMATIC, TCPIP_APPL_VAR) payloadPtr = &TxReqDescrPtr->EthPayloadPtr[IPV6_HDR_LEN];
        IpV6_Ip_VCalculateandStoreChecksum(TxReqDescrPtr, NextHeader, payloadPtr, &destAddr, &srcAddr, PayloadLen);
      }
      else
      {
        P2VAR(uint8, AUTOMATIC, TCPIP_APPL_VAR) payloadPtr = &TxReqDescrPtr->EthPayloadPtr[IPV6_HDR_LEN];
        IpV6_Ip_VStoreChecksumInHeader(NextHeader, 0u, payloadPtr);
      }
  ...
  if ((Result == TCPIP_E_NOT_OK) || ((Result == TCPIP_E_PHYS_ADDR_MISS) && (RetryOnPhysAddrMiss == FALSE)))
  {
# if (TCPIP_SUPPORT_IPV6_TX_FRAGMENTATION == STD_ON)
    if (TxReqDescrPtr->IsEthBufV6 == FALSE)
    {
 ...
 */
TCPIP_LOCAL FUNC(TcpIp_IpProtocolChecksumType, TCPIP_CODE) IpV6_Ip_CheckIfChecksumCalcIsRequired(
  IPV6_P2C(TcpIp_IpTxRequestDescriptorType) IpTxReqDescrPtr                                                             /* PRQA S 3673 */ /* MD_IPV4_Rule8.3 */
)
{
  /* ----- Local Variables ---------------------------------------------- */
  TcpIp_IpProtocolChecksumType retVal = TCPIP_IP_PROTOCOL_CHECKSUM_CHECK_COPY;
  TcpIp_EthIfCtrlIterType ethIfCtrlIdx = IpTxReqDescrPtr->CtrlIdx;
  TcpIp_SizeOfIpV6CtrlType ipV6CtrlIdx = TcpIp_GetIpV6CtrlIdxOfEthIfCtrl(ethIfCtrlIdx);

  /* ----- Implementation ----------------------------------------------- */
  /* #10 Check where shall calculate the checksum */
# if (TCPIP_SUPPORT_IPV6_TX_FRAGMENTATION == STD_ON)
  if (IpTxReqDescrPtr->IsEthBufV6 == FALSE) /* Test for fragmentation */
  {
    /* For this transmission, the packet will contain a fragmentation header */
    retVal = TCPIP_IP_PROTOCOL_CHECKSUM_CHECK_COPY;
    /* For UDP the checksum is manitory. */
  }
  else
# endif
  {
...
# if (TCPIP_SUPPORT_TCP == STD_ON)
    case TCPIP_PROTOCOL_TCP:
      if (TcpIp_IsHwChecksumTcpOfIpV6Ctrl(ipV6CtrlIdx) == TRUE)
      {
        retVal = TCPIP_IP_PROTOCOL_CHECKSUM_CHECK_HW_OR_NOT_REQ;
      }
      break;
# endif
    case TCPIP_PROTOCOL_UDP:
      if (TcpIp_IsHwChecksumUdpOfIpV6Ctrl(ipV6CtrlIdx) == TRUE)
      {
        retVal = TCPIP_IP_PROTOCOL_CHECKSUM_CHECK_HW_OR_NOT_REQ;
      }
      break;
    ...
    case TCPIP_PROTOCOL_ICMP:
      if (TcpIp_IsHwChecksumIcmpOfIpV6Ctrl(ipV6CtrlIdx) == TRUE)
      {
        retVal = TCPIP_IP_PROTOCOL_CHECKSUM_CHECK_HW_OR_NOT_REQ;
      }
      break;
    ...
    default:
      /* retVal is already set to 'checkByCopy' */
      IpV6_DetReportInternalError(IPV6_E_NOT_SUPPORTED);
      break;
    }
  }
...
{
  /* ----- Local Variables ----------------------------------------------- */
  IpV6_LocAddrStateType  SrcAddrState = IPV6_LADDR_STATE_INVALID;
  TcpIp_SizeOfIpV6SourceAddressType ipV6SourceAddressIdx = TCPIP_IPV6_SRC_ADDR_IDX_INV;
  Std_ReturnType Result = E_OK;
  uint16 dataLen = 0u;
  uint32 VersionTcFl = 0u;
  ...
  /* #10 Validate the IpV6 packet payload length and version */
  ...
  if(Result == E_OK)
  {
    ...
    if (IpV6_VIsValidSourceAddress(IpCtrlIdx, &IpV6HdrPtr->SrcAddr, FALSE, &SrcAddrState, &ipV6SourceAddressIdx) == TRUE)
    {
# if (TCPIP_SUPPORT_NDP_DAD_OPTIMISTIC == STD_ON)
...
# endif
      {
        ...
        */
        (void)IpV6_VSATLookup(IpCtrlIdx, &IpV6HdrPtr->SrcAddr, &ipV6SourceAddressIdx);
        /* #60 In case it is not a multicast address, calculate the TcpIp LocalAddrId */
        if (ipV6SourceAddressIdx != TCPIP_IPV6_SRC_ADDR_IDX_INV)
        {
          /* #70 Handle duplicate address. This handling includes PhysAddr comparison! */
          TcpIp_VDuplicateAddrDetected(
            TCPIP_IPV6_TO_LOCAL_ADDR_IDX(TcpIp_GetLocalAddrV6IdxOfIpV6SourceAddress(ipV6SourceAddressIdx)),
  ...
  uint16                      DataLen)
{
  ...
  Std_ReturnType Result = E_OK;
  /* type of the currently processed TLV option (Hop-by-Hop Opt, DestOpt) */
  uint8          OptType = 0u;
  /* option data length of the currently processed TLV option */
  uint16         OptDataLen = 0u;
  /* offset to the currently processed TLV option relative to PayloadPtr */ /* process Type-Length-Value (TLV) encoded options */
  uint16         optOfs = ThisHdrOfs + 2u; /* first option starts after NextHeader and HdrExtLen bytes */

  /* ----- Implementation ----------------------------------------------- */

  /*#10 Process the defined hop by hop options according to RFC2460 4.3 (the Pad0 and PadN option) */
  /* option loop */
  while (((uint32)optOfs + 1u)  < ((uint32)ThisHdrOfs + ThisHdrLen))
  {
  ...
  uint16                      DataLen)
{
  ...
  /* option data length of the currently processed TLV option */
  uint16         OptDataLen = 0u;
  /* offset to the currently processed TLV option relative to PayloadPtr */ /* process TLV encoded options */
  uint16         optOfs = ThisHdrOfs + 2u; /* first option starts after NextHeader and HdrExtLen bytes */
...
# endif
  ...
  if(!IPV6_ADDR_IS_UNSPECIFIED(srcAddr))
  {
    ...
    {
# if (TCPIP_SUPPORT_DHCPV6 == STD_ON)
      if(   ((DataLen + ThisHdrOfs) >= TCPIP_DHCPV6_UDP_HDR_LEN_BYTE)
         && (TCPIP_GET_UINT16(DataPtr, ThisHdrOfs) == TCPIP_DHCPV6_SERVER_PORT)
         && (TCPIP_GET_UINT16(DataPtr, ThisHdrOfs + UDP_HDR_OFF_TGTPORT) == TCPIP_DHCPV6_CLIENT_PORT))
      {
...
{
  /* ----- Local Variables ----------------------------------------------- */
  /* length of the IPv6 packet in bytes */
  uint16                 dataLen = 0u;
  /* offset of the current header relative to DataPtr */
  uint16                 thisHdrOfs = IPV6_HDR_LEN;
# if (TCPIP_SUPPORT_IPV6_RX_FRAGMENTATION == STD_ON)
  /* offset of the previous header relative to DataPtr */
  uint16                 prevHdrOfs = 0u;
# endif
...
# endif
  /* holds next header type value */
  uint8                  nextHdrValue = DataPtr[IPV6_HDR_OFF_NEXTHDR];
  /* contains the length of the currently parsed header */
  uint16                 hdrLenCalculated = 0u;
  uint16                 payloadLenNbo = 0u;
      ...
      case IPV6_EXT_HDR_ID_FRAGMENT:
        {
          ...
          if ((IpV6_Ip_VFragLenValidate(LocalAddrV6Idx, DataPtr, dataLen, thisHdrOfs) == E_OK)
            && ((TcpIp_IsIpV6FragmentationConfigUsedOfIpV6Ctrl(IpCtrlIdx) == TRUE)
              && (TcpIp_GetReassemblyBufferCountOfIpV6FragmentationConfig(ipV6FragmentationConfigIdx) > 0u)))
          {
  ...
  boolean                                  IsReassembledPacket)
{
  /* ----- Local Variables ----------------------------------------------- */
  Std_ReturnType                    result = E_OK;
  TcpIp_SizeOfIpV6CtrlType          ipCtrlIdx = TcpIp_GetSizeOfIpV6Ctrl();           /* ip controller index */
  ...
  /* #10 Check minimal IPv6 packet size */
  if (LenByte >= IPV6_HDR_LEN)
  {

    /* #20 Copy IpV6 header fields from packet */
    ...
    else
    {
      ...
      /* #30 Validate the IpV6 header fields */
      if (TcpIp_GetCtrlStateOfIpV6CtrlDyn(ipCtrlIdx) < IPV6_CTRL_STATE_ONHOLD)
      {
     ...
     * This would only be neccessary if we have to forward the packet.
       ...
       */
        ...
        */
      else if (IpV6_Ip_VCheckIPv6HeaderValid(ipCtrlIdx, &localAddrV6Idx, &ipV6Hdr, PhysAddrPtr, LenByte) != E_OK)
      {
        result = E_NOT_OK;
      }
       ...
       ***********************************************/
      /* #40 Process the extension headers if IpV6 headers are valid */
      if (result == E_OK)
      {
        TCPIP_ASSERT(localAddrV6Idx != TcpIp_GetSizeOfLocalAddrV6());
  ...
  {
    /* Packet must be discarded because it does not contain a complete IPv6 header. */
    IPV6_DBG_COUNTER_RX_INC(DropInvHdr);
  }
...
# if (TCPIP_DEV_ERROR_DETECT == STD_ON)                                                                                 /* COV_TCPIP_DEV_ERROR_DETECT */
  ...
  /* Check parameter 'BufIdx' */
  else if (BufIdx >= (  TcpIp_GetIpV6EthBufDataEndIdxOfIpV6Ctrl(TcpIp_GetIpV6CtrlIdxOfEthIfCtrl(EthIfCtrlIdx))
                      - TcpIp_GetIpV6EthBufDataStartIdxOfIpV6Ctrl(TcpIp_GetIpV6CtrlIdxOfEthIfCtrl(EthIfCtrlIdx))))
  {
    errorId = TCPIP_E_INV_ARG;
  }
  else
# endif
  {
    ...
    TcpIp_SizeOfIpV6SocketDynType ipV6SocketIdx = TcpIp_GetIpV6SocketDynIdxOfIpV6EthBufData(ipV6EthBufDataIdx);
    TcpIp_SizeOfSocketDynType socketIdx = (TcpIp_SizeOfSocketDynType)TCPIP_IPV6_SOCKET_TO_SOCKET(ipV6SocketIdx);

    if (TCPIP_SOCKET_VX_IDX_IS_VALID_SOCKET_IDX(ipV6SocketIdx) && TCPIP_SOCKET_IDX_IS_UDP(socketIdx))                   /* PRQA S 2995 */ /* MD_TCPIP_Rule14.3_2741_2742_2991_2992_2995_2996 */
    {
      TcpIp_SocketUdpDynIterType udpSocketIdx = TCPIP_SOCKET_IDX_TO_UDP_IDX(socketIdx);

      /* #20 Invoke Udp tx confirmation routine */
      TcpIp_Udp_TxConfirmation(udpSocketIdx, TcpIp_GetUlTxReqTabIdxOfIpV6EthBufData(ipV6EthBufDataIdx));
    }
  }
  ...
  if (TcpIp_GetCtrlStateOfIpV6CtrlDyn(ipCtrlIdx) > IPV6_CTRL_STATE_INIT)
  {
    ...
    if (Type == TCPIP_IPADDR_ASSIGNMENT_STATIC)
    {
      ...
      if (RetVal == E_OK)
      {
        if (TcpIp_IsIpV6SourceAddressUsedOfLocalAddrV6(LocalAddrV6Idx) == TRUE)
        {
          TcpIp_IpV6SourceAddressIterType ipV6SourceAddressTableEntryIdx = TcpIp_GetIpV6SourceAddressIdxOfLocalAddrV6(LocalAddrV6Idx);
          TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx)->Triggered = TRUE;
        }
...
# endif
# if TCPIP_SUPPORT_NDP_ROUTER_SOLICITATIONS
    else if (Type == TCPIP_IPADDR_ASSIGNMENT_IPV6_ROUTER)
    {
      /* Only Unicast is acceptable for router */
      if (TcpIp_IsIpV6SourceAddressUsedOfLocalAddrV6(LocalAddrV6Idx) == TRUE)
      {
        TcpIp_IpV6SourceAddressIterType ipV6SourceAddressTableEntryIdx = TcpIp_GetIpV6SourceAddressIdxOfLocalAddrV6(LocalAddrV6Idx);

        /* Trigger address assignment only if the Ip address index is a manual RA */
        if (   (TcpIp_GetAddressAssignVariantOfIpV6SourceAddress(ipV6SourceAddressTableEntryIdx) == TCPIP_IPADDR_ASSIGNMENT_IPV6_ROUTER)
            && (TcpIp_GetAddressAssignmentTriggerOfLocalAddrV6(TcpIp_GetLocalAddrV6IdxOfIpV6SourceAddress(ipV6SourceAddressTableEntryIdx))
                == TCPIP_MANUAL))
        {
          TCPIP_P2C(IpV6_SourceAddressTableEntryType) srcAddrPtr = TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx);

          if (IpV6_CmpNetAddr(&srcAddrPtr->Address, &IpV6_AddrUnspecified) == FALSE)
          {
...
{
  /* ----- Local Variables ---------------------------------------------- */
  TcpIp_SizeOfIpV6SourceAddressType ipV6SourceAddressTableEntryIdx = TcpIp_GetIpV6SourceAddressIdxOfLocalAddrV6(LocalAddrV6Idx);
  TCPIP_P2V(IpV6_SourceAddressTableEntryType) srcAddrPtr = TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx);

  /* ----- Implementation ----------------------------------------------- */

  /* #10 Compare the current SAT entry with the provided address */
  if (IpV6_CmpNetAddr(AddressPtr, &srcAddrPtr->Address) == TRUE)
  {
...
# endif
  ...
  else
  {
    ...
    IpV6_VHandleSourceAddrAssignmentChange(ipV6SourceAddressTableEntryIdx, FALSE);
    IpV6_VSATRemoveEntry(ipV6SourceAddressTableEntryIdx); /* changes state to IPV6_LADDR_STATE_INVALID */
  }
  return E_OK;
}
  ...
  boolean                                            ResetAddress)
{
  ...
  if (  (ResetAddress == FALSE )
      &&(!IPV6_ADDR_IS_UNSPECIFIED(*AddressPtr)))                                                                       /* PRQA S 3415 */ /* MD_TCPIP_Rule13.5_3415_ReadOnly */
  {
    retVal = IpV6_Ndp_VAddSourceAddress(IpV6SourceAddressIdx, AddressPtr, PreferredLifetime, ValidLifetime, 0,
                  (TRUE == NoDad) ? IPV6_SRC_ADDR_DAD_MODE_NONE : IPV6_SRC_ADDR_DAD_MODE_OPTIMISTIC);
  }
  /* #20 Use Static default address if available */
  else if (   (TcpIp_IsDefaultAddrV6UsedOfIpV6SourceAddress(IpV6SourceAddressIdx) == TRUE)
           && (ResetAddress == FALSE))
  {
    TcpIp_DefaultAddrV6IterType defaultAddrV6Idx = TcpIp_GetDefaultAddrV6IdxOfIpV6SourceAddress(IpV6SourceAddressIdx);

    retVal = IpV6_Ndp_VAddSourceAddress(IpV6SourceAddressIdx, TcpIp_GetAddrDefaultAddrV6(defaultAddrV6Idx), PreferredLifetime,
                   ValidLifetime, 0, (TRUE == NoDad) ? IPV6_SRC_ADDR_DAD_MODE_NONE : IPV6_SRC_ADDR_DAD_MODE_OPTIMISTIC);
  }

# if (TCPIP_SUPPORT_DHCPV6 == STD_ON)
  /* #30 Otherwise, if DHCPv6 is enabled, stop DHCP */
  else if(  (ResetAddress == TRUE)
          &&(TCPIP_IPADDR_ASSIGNMENT_DHCP == TcpIp_GetAddressAssignVariantOfIpV6SourceAddress(IpV6SourceAddressIdx)))
  {
    TcpIp_SizeOfLocalAddrV6Type localAddrV6Idx = TcpIp_GetLocalAddrV6IdxOfIpV6SourceAddress(IpV6SourceAddressIdx);
    TcpIp_IpV6CtrlIterType ipCtrlIdx = TcpIp_GetIpV6CtrlIdxOfLocalAddrV6(localAddrV6Idx);
    ...
    {
      (void)TcpIp_DhcpV6_Stop(ipCtrlIdx);
    }
  }
  else if (TCPIP_IPADDR_ASSIGNMENT_DHCP == TcpIp_GetAddressAssignVariantOfIpV6SourceAddress(IpV6SourceAddressIdx))
  {
    TcpIp_SizeOfLocalAddrV6Type localAddrV6Idx = TcpIp_GetLocalAddrV6IdxOfIpV6SourceAddress(IpV6SourceAddressIdx);
    TcpIp_IpV6CtrlIterType ipCtrlIdx = TcpIp_GetIpV6CtrlIdxOfLocalAddrV6(localAddrV6Idx);
    if (TcpIp_IsDhcpV6ConfigUsedOfIpV6Ctrl(ipCtrlIdx) == TRUE)
...
# if (TCPIP_SUPPORT_NDP_ROUTER_SOLICITATIONS == STD_ON)
           ...
           && (TCPIP_IPADDR_ASSIGNMENT_IPV6_ROUTER == TcpIp_GetAddressAssignVariantOfIpV6SourceAddress(IpV6SourceAddressIdx)))
  {
...
# if (TCPIP_SUPPORT_IPV6_NVM_ADDR_STORAGE == STD_ON)
  /* #40 Check if the new source address was successfully added into the SAT */
  if (retVal == E_OK)
  {
    /* #50 Check If Nvm block has been configured for the source address index */
    if (TcpIp_IsNvmDataUsedOfIpV6SourceAddress(IpV6SourceAddressIdx) == TRUE)
    {
      /* #60 Set the new address in the NvM block */
      retVal = IpV6_Ip_VNvmSetAddress(IpV6SourceAddressIdx, AddressPtr);
    }
  }
# endif
  return retVal;
  ...
  boolean                                            NoDad)
{
  ...
  /* Set Unicast address */
  /* PRQA S 3415 2 */ /* MD_TCPIP_Rule13.5_3415_CslReadOnly */
  if ((TCPIP_IPADDR_ASSIGNMENT_STATIC != TcpIp_GetAddressAssignVariantOfIpV6SourceAddress(ipV6SourceAddressTableEntryIdx)) &&
      (TCPIP_IPADDR_ASSIGNMENT_DHCP   != TcpIp_GetAddressAssignVariantOfIpV6SourceAddress(ipV6SourceAddressTableEntryIdx)) &&
      (    (TCPIP_IPADDR_ASSIGNMENT_IPV6_ROUTER != TcpIp_GetAddressAssignVariantOfIpV6SourceAddress(ipV6SourceAddressTableEntryIdx))
        && (NULL_PTR == AddressPtr))) /* only release is allowed to use this API */
  {
  ...
  else
  {
    ...
    /* if AddressPtr == null the IP address shall be reset, write the IP [::] into and set to invalid. */
    if (NULL_PTR == AddressPtr)
    {
      /* Address shall be released, set the unspecified address. */
    ...
    if (srcAddrPtr->State != IPV6_LADDR_STATE_INVALID)
    {
    ...
    if (srcAddrPtr->State == IPV6_LADDR_STATE_INVALID)
    {
      Result = IpV6_Ip_VAddNewSourceAddress(ipV6SourceAddressTableEntryIdx, preferredLt, validLt, (const IpV6_AddrType*) addrLocalPtr, NoDad, AddressPtr == NULL_PTR);
    }

    /* #40 For released addresses, set triggered to false */
    if (AddressPtr == NULL_PTR)
    {
      TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx)->Triggered = FALSE;
    }
  ...
  TCPIP_P2C(IpV6_AddrType)        AddressPtr)
{
  ...
  else if (    (IPV6_ADDR_EQUALS(*AddressPtr, IpV6_AddrUnspecified))
            && (TcpIp_IsDefaultAddrV6UsedOfIpV6MulticastAddr(IpV6MulticastAddrIdx) == TRUE))
  {
      TcpIp_SizeOfDefaultAddrV6Type defaultAddrV6Idx = TcpIp_GetDefaultAddrV6IdxOfIpV6MulticastAddr(IpV6MulticastAddrIdx);
      addrLocalPtr = TcpIp_GetAddrDefaultAddrV6(defaultAddrV6Idx);
  }
  else
  {
    addrLocalPtr = AddressPtr;
  ...
  if (IPV6_ADDR_IS_MULTICAST(*addrLocalPtr) || IPV6_ADDR_IS_UNSPECIFIED(*addrLocalPtr))                                 /* PRQA S 3415 */ /* MD_TCPIP_Rule13.5_3415_ReadOnly */
  {
    ...
    if (TcpIp_IsIpV6MulticastAddrActiveUsedOfIpV6MulticastAddr(IpV6MulticastAddrIdx) == TRUE)
    {
      ...
      if (   (!IPV6_ADDR_EQUALS(*TcpIp_GetAddrIpV6MulticastAddrActive(ipV6MulticastAddrActiveIdx), *addrLocalPtr))
          || (TcpIp_GetAssignmentStateOfLocalAddr(localAddrIdx) == TCPIP_IPADDR_STATE_UNASSIGNED)) /* IP address shall be released */
      {
...
# endif
        ...
        if (    IPV6_ADDR_IS_MULTICAST(*TcpIp_GetAddrIpV6MulticastAddrActive(ipV6MulticastAddrActiveIdx))
             && (TcpIp_GetAssignmentStateOfLocalAddr(localAddrIdx) != TCPIP_IPADDR_STATE_UNASSIGNED))
        {
          /* There is currently a different multicast assigned for this IpAddrId.
            * Notify upper-layer about removed assignment...
            */
          IPV6_VJOIN_MULTICAST_GROUP(ipCtrlIdx, TcpIp_GetAddrIpV6MulticastAddrActive(ipV6MulticastAddrActiveIdx), FALSE);

          TcpIp_Cbk_VLocalIpAssignmentChg(localAddrIdx, TCPIP_IPADDR_STATE_UNASSIGNED);
        }

        /* Change IP address */
        /* PRQA S 0315 1 */ /* MD_MSR_VStdLibCopy */
        IPV6_ADDR_COPY(*TcpIp_GetAddrIpV6MulticastAddrActive(ipV6MulticastAddrActiveIdx), *addrLocalPtr);
            ...
            && (AddressPtr != NULL_PTR))
        {
          /* A new address has been assigned for this IpAddrId.
            * Notify upper-layer...
            */
          IPV6_VJOIN_MULTICAST_GROUP(ipCtrlIdx, TcpIp_GetAddrIpV6MulticastAddrActive(ipV6MulticastAddrActiveIdx), TRUE);
      ...
      {
        /* The value of *AddressPtr is already assigned to this IpAddrId. No action necessary. */
        Result = E_OK;
      }
    }
    else
  ...
  IPV6_P2V(uint8)             AddressPrefixBitLenPtr)
{
  ...
  else if (TcpIp_IsIpV6SourceAddressUsedOfLocalAddrV6(LocalAddrV6Idx) == TRUE)
  {
    ...
    PrefixBitLen = (IPV6_PREFIX_LEN_BYTE * TCPIP_BITS_IN_BYTE);
  ...
  else
  {
    ...
    if (TcpIp_IsIpV6MulticastAddrActiveUsedOfIpV6MulticastAddr(ipV6MulticastAddrIdx) == TRUE)
    {
      ...
      /* PRQA S 0315 1 */ /* MD_MSR_VStdLibCopy */
      IPV6_ADDR_COPY(*AddressPtr, *TcpIp_GetAddrIpV6MulticastAddrActive(ipV6MulticastAddrActiveIdx));
      PrefixBitLen = IPV6_MULTICAST_PREFIX_LEN_BIT;
      Result = E_OK;
    }
    else
    {
      ...
      /* PRQA S 0315 1 */ /* MD_MSR_VStdLibCopy */
      IPV6_ADDR_COPY(*AddressPtr, *TcpIp_GetAddrDefaultAddrV6(defaultAddrV6Idx));
      PrefixBitLen = IPV6_MULTICAST_PREFIX_LEN_BIT;
      Result = E_OK;
    }
  }
  ...
  IPV6_P2V(boolean)            RouterIsReachablePtr)
{
  ...
  Std_ReturnType          retVal = E_NOT_OK;
  TcpIp_SizeOfIpV6CtrlType ipCtrlIdx = TcpIp_GetIpV6CtrlIdxOfLocalAddrV6(LocalAddrV6Idx);
  TcpIp_SizeOfIpV6DefaultRouterListEntryType ipV6DefaultRouterListEntryIdx = 0u;
  ...
  if (IpV6_VGetDefaultRouterAddr(ipCtrlIdx, LocalAddrV6Idx, NULL_PTR, RouterIsReachablePtr, &ipV6DefaultRouterListEntryIdx) == E_OK)
  {
    /* PRQA S 0315 1 */ /* MD_MSR_VStdLibCopy */
    IPV6_ADDR_COPY(*RouterAddressPtr, TcpIp_GetAddrIpV6DefaultRouterListEntry(ipV6DefaultRouterListEntryIdx)->NextHopAddress);
    retVal = E_OK;
  }
  else
  {
  ...
  IPV6_P2C(IpV6_AddrType)  DstAddrPtr)
{
  ...
  boolean result = TRUE;
  IpV6_LocAddrStateType SrcAddrState = IPV6_LADDR_STATE_INVALID;
  TcpIp_SizeOfIpV6SourceAddressTableEntryType srcAddrIdx = 0u;
...
{
  /* ----- Local Variables ---------------------------------------------- */
  uint8 ipAddrCfgSrc = TCPIP_IPADDR_ASSIGNMENT_NONE;
  ...
  if (TcpIp_IsIpV6SourceAddressUsedOfLocalAddrV6(LocalAddrV6Idx) == TRUE)
  {
    ...
    ipAddrCfgSrc = TcpIp_GetAddressAssignVariantOfIpV6SourceAddress(ipV6SourceAddressIdx);
  }
  else
  {
  ...
  boolean                   InitRes)
{
  ...
  if (TcpIp_IsIpV6CtrlUsedOfEthIfCtrl(EthIfCtrlIdx) == TRUE)
  {
    ...
    {
      /* Physical addresses are only resolvable for IPv6 addresses that are available locally */
    ...
    else
    {
          ...
          && (TcpIp_GetCtrlStateOfIpV6CtrlDyn(ipCtrlIdx) != IPV6_CTRL_STATE_ONHOLD))
      {
        ...
        IpV6_Ndp_VNCGetOrCreateEntry(ipCtrlIdx, IpAddrPtr, &ipV6NeighborCacheEntryIdx);
        entryFound = TRUE;
      }
      else
      {
        ...
        /* PRQA S 3415 3 */ /* MD_TCPIP_Rule13.5_3415_CslReadOnly */
        if (   (E_OK == IpV6_Ndp_VNCLookup(ipCtrlIdx, IpAddrPtr, &ipV6NeighborCacheEntryIdx))
            && (ipV6NeighborCacheEntryIdx >= TcpIp_GetIpV6NeighborCacheEntryStartIdxOfIpV6Ctrl(ipCtrlIdx))
            && (ipV6NeighborCacheEntryIdx <  TcpIp_GetIpV6NeighborCacheEntryEndIdxOfIpV6Ctrl(ipCtrlIdx)))
        {
          entryFound = TRUE;
        }
      }

      if ((entryFound == TRUE) && (TcpIp_GetAddrIpV6NeighborCacheEntry(ipV6NeighborCacheEntryIdx)->State != IPV6_REACHABLE_STATE_INCOMPLETE))/* PRQA S 3415 */ /* MD_TCPIP_Rule13.5_3415_CslReadOnly */
      {
        /* PRQA S 0315 1 */ /* MD_MSR_VStdLibCopy */
        IPV6_LL_ADDR_COPY(PhysAddrPtr, &TcpIp_GetAddrIpV6NeighborCacheEntry(ipV6NeighborCacheEntryIdx)->LinkLayerAddress[0]);
        retVal = TCPIP_OK;
  ...
  IPV6_P2C(IpV6_AddrType)                               RouterAddrPtr)
{
  ...
  Std_ReturnType result = E_NOT_OK;
  TcpIp_IpV6CtrlIterType ipCtrlIdx = TcpIp_GetIpV6CtrlIdxOfLocalAddrV6(LocalAddrV6Idx);
  /* needed for out value */
  TcpIp_SizeOfIpV6DefaultRouterListEntryType drlEntry
    = TcpIp_GetIpV6DefaultRouterListEntryValidEndIdxOfIpV6CtrlDyn(ipCtrlIdx);
...
/* coding +v34 */
  {
    ...
    TcpIp_SizeOfIpV6DefaultRouterListEntryType ipV6DefaultRouterListEntryIdx;
    if (E_OK == IpV6_Ndp_VDRLCreateEntry(ipCtrlIdx, RouterAddrPtr, &ipV6DefaultRouterListEntryIdx))
    {
      ...
      IPV6_TIME_SET_INFINITY(TcpIp_GetAddrIpV6DefaultRouterListEntry(ipV6DefaultRouterListEntryIdx)->ExpireTime);
      TcpIp_GetAddrIpV6DefaultRouterListEntry(ipV6DefaultRouterListEntryIdx)->StaticEntry = TRUE;
      TcpIp_GetAddrIpV6DefaultRouterListEntry(ipV6DefaultRouterListEntryIdx)->NcIdxHint = ncIdx;
      TcpIp_GetAddrIpV6DefaultRouterListEntry(ipV6DefaultRouterListEntryIdx)->LocalIpV6Idx = (IpV6_AddrIdxType)LocalAddrV6Idx;
    }
  ...
  uint8                     Netmask)
{
  ...
  if (   (LocalIpAddrPtr == NULL_PTR)
      || (IpV6_CmpNetAddr(LocalIpAddrPtr, &IpV6_AddrUnspecified)))                                                      /* PRQA S 3415 */ /* MD_TCPIP_Rule13.5_3415_ReadOnly */
  {
    /* #10 Use default address */
    /* NULL_PTR is only for Router and DHCP, because this parameter is not used or for reset. For Static-request there is a DET check. */
    retVal = E_OK;
  }
  else if (    (TcpIp_IsIpV6SourceAddressUsedOfLocalAddrV6(LocalAddrV6Idx) == TRUE)
            && (LocalIpAddrPtr->addr[0] != MulticastPrefix))
  {
    /* #20 Address is Unicast and Prefix is not the Multicast prefix. */
    if (Netmask == IPV6_SUPPORTED_UNICAST_NETMASK) /* Only netmasks with 64 bits are currently supported for unicast. */
    {
      TcpIp_IpV6SourceAddressIterType ipV6SourceAddressTableEntryIdx;

      retVal = E_OK;

      /* #30 Verify that this IP address is not already in use by the equal controller. */
      for (ipV6SourceAddressTableEntryIdx = TcpIp_GetIpV6SourceAddressStartIdxOfIpV6Ctrl(TcpIp_GetIpV6CtrlIdxOfLocalAddrV6(LocalAddrV6Idx));
        ipV6SourceAddressTableEntryIdx < TcpIp_GetIpV6SourceAddressEndIdxOfIpV6Ctrl(TcpIp_GetIpV6CtrlIdxOfLocalAddrV6(LocalAddrV6Idx));
        ipV6SourceAddressTableEntryIdx++)
      {
        TCPIP_P2C(IpV6_SourceAddressTableEntryType) sourceAddrPtr = TcpIp_GetAddrIpV6SourceAddressTableEntry(ipV6SourceAddressTableEntryIdx);

        if (   (IpV6_CmpNetAddr(&sourceAddrPtr->Address, LocalIpAddrPtr) == TRUE)
            && (ipV6SourceAddressTableEntryIdx != TcpIp_GetIpV6MulticastAddrIdxOfLocalAddrV6(LocalAddrV6Idx))
            && (TcpIp_GetAssignmentStateOfLocalAddr(localAddrIdx) != TCPIP_IPADDR_STATE_UNASSIGNED)
            && (!IpV6_CmpNetAddr(LocalIpAddrPtr, &IpV6_AddrUnspecified)))                                               /* PRQA S 3415 */ /* MD_TCPIP_Rule13.5_3415_ReadOnly */
        {
          retVal = E_NOT_OK;
  ...
  else if (    (TcpIp_IsIpV6MulticastAddrUsedOfLocalAddrV6(LocalAddrV6Idx) == TRUE)
            && (LocalIpAddrPtr->addr[0] == MulticastPrefix))
  {
    /* #40 Address is Multicast and Prefix is the Multicast prefix. */
    if (Netmask == 0u) /* Multicast do not use Netmasks. */
    {
      TcpIp_IpV6MulticastAddrIterType ipV6MulticastAddrIdx;

      retVal = E_OK;

      /* #50 Verify that this IPaddress is not already in use by the equal controller. */
      for (ipV6MulticastAddrIdx = TcpIp_GetIpV6MulticastAddrStartIdxOfIpV6Ctrl(TcpIp_GetIpV6CtrlIdxOfLocalAddrV6(LocalAddrV6Idx));
           ipV6MulticastAddrIdx < TcpIp_GetIpV6MulticastAddrEndIdxOfIpV6Ctrl(TcpIp_GetIpV6CtrlIdxOfLocalAddrV6(LocalAddrV6Idx));
           ipV6MulticastAddrIdx++)
      {
        TcpIp_SizeOfIpV6MulticastAddrActiveType ipV6MulticastAddrActiveIdx = TcpIp_GetIpV6MulticastAddrActiveIdxOfIpV6MulticastAddr(ipV6MulticastAddrIdx);

        if (   (IpV6_CmpNetAddr(TcpIp_GetAddrIpV6MulticastAddrActive(ipV6MulticastAddrActiveIdx), LocalIpAddrPtr) == TRUE)
            && (ipV6MulticastAddrIdx != TcpIp_GetIpV6MulticastAddrIdxOfLocalAddrV6(LocalAddrV6Idx))
            && (TcpIp_GetAssignmentStateOfLocalAddr(localAddrIdx) != TCPIP_IPADDR_STATE_UNASSIGNED)
            && (!IpV6_CmpNetAddr(LocalIpAddrPtr, &IpV6_AddrUnspecified)))                                               /* PRQA S 3415 */ /* MD_TCPIP_Rule13.5_3415_ReadOnly */
        {
          retVal = E_NOT_OK;
  ...
  {
    /* #60 Prefix do not fit to the type. */
