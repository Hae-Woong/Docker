 ...
 *                                     \spec requires (IpV4SocketIdx < TcpIp_GetSizeOfIpV4SocketDyn()); \endspec
 ...
 *********************************************************************************************************************/
/*! \brief            Cancel the transmission of the given descriptor. This will release all assigned Ethernet buffers.
 *  \details          -
 *  \param[in]        IpTxReqDescrPtr         Pointer to TX request descriptor that was used at the related calls to:
 *                                            - IpV4_Ip_ProvideTxBuffer()
 *                                            - IpV4_Ip_FragmentProvideTxBuffer()
 ...
 *                                      \spec requires DefRouterNetAddrPtr != NULL_PTR; \endspec
 *  \pre            -
 *  \context        TASK
 *  \reentrant      FALSE
 *  \synchronous    TRUE
 ...
 *                                 \spec requires NetMaskPtr != NULL_PTR; \endspec
 ...
 *                                     \spec requires BindLocalAddrV4Idx < TcpIp_GetSizeOfLocalAddrV4(); \endspec
 *  \param[in]      RecvLocalAddrV4Idx Index of the IPv4 address a packet has been received with.
 *                                     \spec requires RecvLocalAddrV4Idx < TcpIp_GetSizeOfLocalAddrV4(); \endspec
