 ...
 *                                     \spec requires *LocalAddrV6IdxPtr < TcpIp_GetSizeOfLocalAddr(); \endspe
 ...
 *  \details       -
 *  \param[in]     LocalAddrV6IdxPtr Ip address index
 *                                   \spec requires *LocalAddrV6IdxPtr < TcpIp_GetSizeOfLocalAddr(); \endspec or TCPIP_LOCAL_ADDR_V6_IDX_ANY
 *  \param[in]     DstAddrPtr        Destination address
 ...
 *  \details       -
 *  \param[in]     IpV6SourceAddressTableEntryIdx    Index of the source address getting added
 *                                                   \spec requires IpV6SrcAddrIdx < TcpIp_GetSizeOfIpV6SourceAddress(); \endspec
 ...
 *  \param[in]     IpCtrlIdx                   Index of Ip Controller
 *                                             \spec requires IpCtrlIdx < TcpIp_GetSizeOfIpV6ctrl(); \endspec
 *  \param[in]     IpV6NeighborCacheEntryIdx   Index of neighbor cache entry
