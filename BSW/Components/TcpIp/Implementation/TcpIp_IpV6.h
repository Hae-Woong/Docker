 ...
 *********************************************************************************************************************/
  ...
  *  \param[in]     AIpV6SourceAddressTableEntryIdx                   Source address table index of first address
  *  \param[in]     BIpV6SourceAddressTableEntryIdx                   Source address table index of second address
 ...
 *  \param[out]    Protocol           The upper layer protocol
 ...
 *                                    \spec requires BindLocalAddrV6Idx < TcpIp_GetSizeOfLocalAddr(); \endspec or TCPIP_LOCAL_ADDR_V6_IDX_ANY
 *  \param[in]    RecvLocalAddrV6Idx  Ip address identifier of the received packet
 *                                    \spec requires RecvLocalAddrV6Idx < TcpIp_GetSizeOfLocalAddr(); \endspec or TCPIP_LOCAL_ADDR_V6_IDX_ANY
