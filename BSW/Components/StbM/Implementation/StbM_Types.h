...
# define STBM_SYSTEM_WIDE_MASTER_DISABLED        (0x00U)
# define STBM_SYSTEM_WIDE_MASTER_ENABLED         (0x01U)
...
/* Clone config masks */
#define STBM_DEFERRED_COPY_MASK                  (0x01U)
#define STBM_IMMEDIATE_TX_MASK                   (0x02U)
#define STBM_APPLY_RATE_MASK                     (0x04U)

/* Type of local clock adjustment */
#define STBM_NONE_CLOCK_ADJUSTMENT               (0x00U)
#define STBM_MINOR_CLOCK_ADJUSTMENT              (0x01U)
#define STBM_MAJOR_CLOCK_ADJUSTMENT              (0x02U)
