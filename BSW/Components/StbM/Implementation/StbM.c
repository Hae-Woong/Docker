...
# define STBM_PPM_CONVERSION                             (1000000)
#endif
...
#if (((STBM_CONFIG_SLAVE_RATE_CORRECTION == STD_ON) || (STBM_CONFIG_MASTER_RATE_CORRECTION == STD_ON)) && (STBM_USE_FLOAT64 == STD_ON))
...
#if !defined (StbM_Enter_CRITICAL_SECTION_GET_TS) /* COV_STBM_ADAPTIVE_RETRY */
# define StbM_Enter_CRITICAL_SECTION_GET_TS()
#endif
#if !defined (StbM_Exit_CRITICAL_SECTION_GET_TS) /* COV_STBM_ADAPTIVE_RETRY */
...
# else
typedef sint64 StbM_InternalRateDeviationType;
# endif
#endif
 ...
 *  \details     Sets the given global time without incrementing the update counter.
 ...
 *********************************************************************************************************************/
/*! \brief       Get the main time tuple (TGsync, TVsync), status and rate deviation
 *  \details     -
 *  \param[in]   timeBaseIdx, timebase index.
 *  \param[out]  globalTimeSyncPtr, TGsync and status.
 *  \param[out]  localTimeSyncPtr, TVsync.
 *  \param[out]  rateDeviation, rate deviation if valid, 0 otherwise.
 *  \param[in]   partitionIdx, valid partition index.
 *  \pre         -
 *  \context     TASK|ISR2
 *  \reentrant   FALSE
 ...
 *  \param[in]   customerPartitionIdx, valid partition index of customer.
 *  \param[in]   timeBaseIdx, time base index of time base referenced by customer.
 *  \param[in]   timeBasePartitionIdx, partition index of time base referenced by customer.
...
STBM_LOCAL_INLINE FUNC(boolean, STBM_CODE) StbM_TriggeredCustomer_IsTriggerable(
        ...
        StbM_PartitionIdentifiersIterType customerPartitionIdx,
        StbM_SynchronizedTimeBaseType timeBaseIdx,
        StbM_PartitionIdentifiersIterType timeBasePartitionIdx);
 ...
 *  \param[in]   timeBaseIdx, index of timebase.
 *  \param[in]   partitionIdx, valid partition index.
 *  \return      rate, the rate or 1.0 if not configured.
 *  \pre         -
 *  \context     TASK|ISR2
 *  \reentrant   TRUE
 *  \unit        TimeCorrection
...
# else
/**********************************************************************************************************************
 *  StbM_TimeCorrection_GetRateInPPM
 *********************************************************************************************************************/
/*! \brief       Get the rate in ppm for time correction depending upon the given timebase.
 *  \details     Return value can only be used as input for StbM_Calc_MultiplyTimeStampWithRatePPM.
 *  \param[in]   timeBaseIdx, index of timebase.
 *  \param[in]   partitionIdx, valid partition index.
 *  \return      rate in ppm.
 *  \pre         -
 ...
 *  \unit        TimeCorrection
 *********************************************************************************************************************/
STBM_LOCAL FUNC(StbM_InternalRateDeviationType, STBM_CODE) StbM_TimeCorrection_GetRateInPPM(
        StbM_SynchronizedTimeBaseType timeBaseIdx,
        StbM_PartitionIdentifiersIterType partitionIdx);
# endif
...
#  else
/**********************************************************************************************************************
 *  StbM_TimeCorrection_GetRateDeviationMaster
 *********************************************************************************************************************/
/*! \brief       Get the rate deviation of the given global time master.
 *  \details     -
 *  \param[in]   timeBaseIdx, valid index of master timebase.
 *  \param[in]   partitionIdx, valid partition index.
 ...
 *  \unit        TimeCorrection
 *********************************************************************************************************************/
STBM_LOCAL_INLINE FUNC(StbM_RateDeviationType, STBM_CODE) StbM_TimeCorrection_GetRateDeviationMaster(
        StbM_SynchronizedTimeBaseType timeBaseIdx,
        StbM_PartitionIdentifiersIterType partitionIdx);
#  endif /* (STBM_USE_FLOAT64 == STD_ON) */
...
#  else
/**********************************************************************************************************************
 *  StbM_TimeCorrection_CalculateRateDeviationForRateCorrectionSlave
 *********************************************************************************************************************/
/*! \brief       Calculate rate deviation for rate correction.
 *  \details     This is only relevant for time slave.
 *  \param[in]   timeBaseIdx, valid index of timebase.
 *  \param[in]   rateMeasurementIdx, index of rate measurement.
 *  \param[out]  rateDeviation, calculated rate deviation.
 *  \param[in]   partitionIdx, valid partition index.
 *  \return      E_OK, if succeeded
 *               E_NOT_OK, otherwise
 *  \pre         -
 ...
 *  \unit        TimeCorrection
 *********************************************************************************************************************/
STBM_LOCAL_INLINE FUNC(Std_ReturnType, STBM_CODE) StbM_TimeCorrection_CalculateRateDeviationForRateCorrectionSlave(
        StbM_SynchronizedTimeBaseType timeBaseIdx,
        uint32 rateMeasurementIdx,
        P2VAR(StbM_RateDeviationType, AUTOMATIC, STBM_APPL_VAR) rateDeviation,
        StbM_PartitionIdentifiersIterType partitionIdx);
...
/**********************************************************************************************************************
 *  StbM_TimeCorrection_CalculateRateDeviationForOffsetRateCorrectionSlave
 *********************************************************************************************************************/
/*! \brief       Calculate rate deviation for offset rate correction.
 *  \details     This is only relevant for time slave.
 *  \param[in]   timeBaseIdx, valid index of timebase.
 *  \param[in]   partitionIdx, valid partition index.
 *  \return      rateDeviation, calculated rate deviation.
 *  \pre         -
 *  \context     TASK|ISR2
 *  \reentrant   TRUE
 *  \visibility  Private
 *  \unit        TimeCorrection
 *********************************************************************************************************************/
STBM_LOCAL_INLINE FUNC(StbM_InternalRateDeviationType, STBM_CODE) StbM_TimeCorrection_CalculateRateDeviationForOffsetRateCorrectionSlave(
        StbM_SynchronizedTimeBaseType timeBaseIdx,
        StbM_PartitionIdentifiersIterType partitionIdx);

/**********************************************************************************************************************
 *  StbM_TimeCorrection_SetRateDeviationForRateCorrectionSlave
 *********************************************************************************************************************/
/*! \brief       Set the rate deviation for rate correction of the given timebase.
 *  \details     This is only relevant for time slave.
 *  \param[in]   timeBaseIdx, valid index of timebase.
 *  \param[in]   rateDeviation, the rate deviation to set.
 *  \param[in]   partitionIdx, valid partition index.
 *  \pre         -
 *  \context     TASK|ISR2
 *  \reentrant   FALSE
 ...
 *  \unit        TimeCorrection
 *********************************************************************************************************************/
STBM_LOCAL_INLINE FUNC(void, STBM_CODE) StbM_TimeCorrection_SetRateDeviationForRateCorrectionSlave(
        StbM_SynchronizedTimeBaseType timeBaseIdx,
        StbM_RateDeviationType rateDeviation,
        StbM_PartitionIdentifiersIterType partitionIdx);

/**********************************************************************************************************************
 *  StbM_TimeCorrection_SetRateDeviationForOffsetRateCorrection
 *********************************************************************************************************************/
/*! \brief       Set the rate deviation for offset rate correction of the given timebase.
 *  \details     This is only relevant for time slave.
 *  \param[in]   timeBaseIdx, valid index of timebase.
 *  \param[in]   rateDeviation, the rate deviation to set.
 *  \param[in]   partitionIdx, valid partition index.
 ...
 *  \unit        TimeCorrection
 *********************************************************************************************************************/
STBM_LOCAL_INLINE FUNC(void, STBM_CODE) StbM_TimeCorrection_SetRateDeviationForOffsetRateCorrection(
        StbM_SynchronizedTimeBaseType timeBaseIdx,
        StbM_InternalRateDeviationType rateDeviation,
        StbM_PartitionIdentifiersIterType partitionIdx);

/**********************************************************************************************************************
 *  StbM_TimeCorrection_GetRateDeviationForRateCorrection
 *********************************************************************************************************************/
/*! \brief       Get the rate deviation for rate correction of the given timebase.
 *  \details     This is only relevant for time slave.
 *  \param[in]   timeBaseIdx, index of timebase.
 *  \param[in]   partitionIdx, valid partition index.
 *  \return      rate deviation in ppm.
 ...
 *  \unit        TimeCorrection
 *********************************************************************************************************************/
STBM_LOCAL FUNC(StbM_RateDeviationType, STBM_CODE) StbM_TimeCorrection_GetRateDeviationForRateCorrection(
        StbM_SynchronizedTimeBaseType timeBaseIdx,
        StbM_PartitionIdentifiersIterType partitionIdx);

/**********************************************************************************************************************
 *  StbM_TimeCorrection_GetRateDeviationForOffsetRateCorrection
 *********************************************************************************************************************/
/*! \brief       Get the rate deviation for offset rate correction of the given timebase.
 *  \details     This is only relevant for time slave.
 *  \param[in]   timeBaseIdx, index of timebase.
 *  \param[in]   partitionIdx, valid partition index.
 *  \return      rate deviation in ppm.
 ...
 *  \unit        TimeCorrection
 *********************************************************************************************************************/
STBM_LOCAL_INLINE FUNC(StbM_InternalRateDeviationType, STBM_CODE) StbM_TimeCorrection_GetRateDeviationForOffsetRateCorrection(
        StbM_SynchronizedTimeBaseType timeBaseIdx,
        StbM_PartitionIdentifiersIterType partitionIdx);
#  endif /* (STBM_USE_FLOAT64 == STD_ON) */
 ...
 *  \param[in]   timeBaseIdx, index of timebase.
 *  \param[in]   partitionIdx, valid partition index.
 *  \return      offset correction adaption interval.
 *  \pre         -
 *  \context     TASK|ISR2
 *  \reentrant   TRUE
 *  \visibility  Private
 ...
 *  \param[in]   timeBaseIdx, timebase index.
 *  \param[in]   partitionIdx, valid partition index.
 *  \pre         The virtual local time can be retrieved successfully and is valid throughout the function
 *  \context     TASK|ISR2
 *  \reentrant   FALSE
 *  \unit        LocalTime
 *********************************************************************************************************************/
 ...
 *  \return      TRUE, if lhs >= rhs. Therefore positive difference.
 *               FALSE, if lhs < rhs, underflow occurred. Therefore negative difference.
 *  \pre         -
 *  \context     TASK|ISR2
 *  \reentrant   TRUE
 *  \unit        Calc
 *********************************************************************************************************************/
STBM_LOCAL FUNC(boolean, STBM_CODE) StbM_Calc_SubtractTimeStamps(
        P2CONST(StbM_InternalTimeStampType, AUTOMATIC, STBM_APPL_DATA) lhs,
        P2CONST(StbM_InternalTimeStampType, AUTOMATIC, STBM_APPL_DATA) rhs,
 ...
 *  \param[out]  difference, lhs - rhs.
 *  \return      E_OK, if succeeded.
 *               E_NOT_OK, underflow occurred.
 *  \pre         -
 *  \context     TASK|ISR2
 *  \reentrant   TRUE
 *  \unit        Calc
 *********************************************************************************************************************/
STBM_LOCAL FUNC(Std_ReturnType, STBM_CODE) StbM_Calc_SubtractVirtualLocalTimes(
        P2CONST(StbM_VirtualLocalTimeType, AUTOMATIC, STBM_APPL_DATA) lhs,
        P2CONST(StbM_VirtualLocalTimeType, AUTOMATIC, STBM_APPL_DATA) rhs,
...
# else
/**********************************************************************************************************************
 *  StbM_Calc_MultiplyTimeStampWithRatePPM
 *********************************************************************************************************************/
/*! \brief           Multiply the given timestamp by the given rate in ppm.
 *  \details         -
 *  \param[in,out]   timeStamp, timestamp.
 *  \param[in]       ratePPM, rate in ppm.
 *  \return          E_OK, if succeeded.
 *                   E_NOT_OK, overflow occurred.
 *  \pre             -
 *  \context         TASK|ISR2
 ...
 *  \unit            Calc
 *********************************************************************************************************************/
STBM_LOCAL FUNC(Std_ReturnType, STBM_CODE) StbM_Calc_MultiplyTimeStampWithRatePPM(
        P2VAR(StbM_InternalTimeStampType, AUTOMATIC, STBM_APPL_VAR) timeStamp, StbM_InternalRateDeviationType ratePPM);
# endif /* (STBM_USE_FLOAT64 == STD_ON) */
...
#if ((STBM_CONFIG_SLAVE_RATE_CORRECTION == STD_ON) || (STBM_CONFIG_MASTER_RATE_CORRECTION == STD_ON) || (STBM_CONFIG_ETH_CLOCK == STD_ON))
/**********************************************************************************************************************
...
#endif /* ((STBM_CONFIG_SLAVE_RATE_CORRECTION == STD_ON) || (STBM_CONFIG_MASTER_RATE_CORRECTION == STD_ON) || (STBM_CONFIG_ETH_CLOCK == STD_ON)) */
        ...
        StbM_PartitionIdentifiersIterType partitionIdx)
{
  ...
  /* #20 If update of received time tuple succeeded: */
  if (retVal == E_OK)
  {
    /* #30 Update synclocal time tuple */
    retVal = StbM_LocalTime_UpdateSynclocalTimeTuple(timeBaseIdx, partitionIdx); /* PRQA S 2985 */ /* MD_StbM_Rule2.2_2985 */
  }

  /* #40 If update of synclocal time tuple succeeded: */
  if (retVal == E_OK)
  {
    /* #50 Update time leap */
    StbM_LocalTime_UpdateTimeLeap(timeBaseIdx, partitionIdx);

    /* #60 Reset timeout monitoring */
#  if (STBM_CONFIG_TIMEOUT == STD_ON)
    StbM_Timeout_Reset(timeBaseIdx, partitionIdx);
#  endif

    /* #70 Update TimeLeap unit */
#  if (STBM_CONFIG_TIME_LEAP == STD_ON)
    StbM_TimeLeap_Update(timeBaseIdx, partitionIdx);
#  endif

    /* #80 Update Status unit */
    StbM_Status_Update(timeBaseIdx, timeBaseStatus, partitionIdx);

    /* #90 Update TimeCorrection unit */
#  if (STBM_CONFIG_SLAVE_RATE_CORRECTION == STD_ON)
    StbM_TimeCorrection_Update(timeBaseIdx, partitionIdx);
#  endif

    /* #100 Set global timebase bit */
    StbM_Status_SetSynchronized(timeBaseIdx, partitionIdx);

    /* #110 Update TimeRecording unit */
#  if (STBM_CONFIG_TIME_RECORDING == STD_ON)
    StbM_TimeRecording_Update(timeBaseIdx, partitionIdx);
#  endif

    /* #120 Increment timebase update counter */
    StbM_TimeBase_IncrementUpdateCounter(timeBaseIdx, partitionIdx);

    /* #130 Update status notification that resync event occurred */
#  if (STBM_CONFIG_STATUS_NOTIFICATION == STD_ON)
    StbM_StatusNotification_OnReSyncEvent(timeBaseIdx, partitionIdx);
#  endif

    /* #140 Update main time tuple */
    StbM_LocalTime_UpdateMainTimeTupleAfterBusReceive(timeBaseIdx, partitionIdx);

    /* #150 Handle local clock synchronization */
#  if (STBM_USE_SYNCHRONIZED_LOCAL_CLOCK == STD_ON)
...
STBM_LOCAL_INLINE FUNC(void, STBM_CODE) StbM_TriggeredCustomer_Update(StbM_PartitionIdentifiersIterType partitionIdx)
{
  ...
  for (customerId = 0u; customerId < StbM_GetSizeOfTriggeredCustomerConfig(partitionIdx); customerId++)
  {
    ...
    StbM_TimeBase_GetPartitionMapping(StbM_GetTimeBasePartitionMappingIdxOfTriggeredCustomerConfig(customerId, partitionIdx), &timeBaseIdx, &timeBasePartitionIdx); /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */

    /* #30 Check if customer is triggerable */
    if (StbM_TriggeredCustomer_IsTriggerable(customerId, partitionIdx, timeBaseIdx, timeBasePartitionIdx) == TRUE)
    {
      TickType osTicks;
...
#  if (STBM_MULTIPARTITION_USED == STD_ON)
      ...
      /* #40 Check if timebase is mapped to a different partition */
      if (partitionIdx != timeBasePartitionIdx)
      {
        /* #50 Get current time of associated timebase */
...
#  endif
  ...
  return (TickType)(((microseconds * StbM_GetUsToTicksConversionNumeratorOfTriggeredCustomerConfig(customerIdx, partitionIdx)) / StbM_GetUsToTicksConversionDenominatorOfTriggeredCustomerConfig(customerIdx, partitionIdx)) % StbM_GetScheduleTableDurationOfTriggeredCustomerConfig(customerIdx, partitionIdx));
} /* StbM_TriggeredCustomer_ToOsTicks */
...
#  if (STBM_MULTIPARTITION_USED == STD_OFF)
  /* dummy statement because of customerPartitionIdx is not used by the ComStackLib in a non multi-partition configuration */
  STBM_DUMMY_STATEMENT(customerPartitionIdx); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
#  endif

  if (
       /* #10 Check if triggered customer period counter is zero */
          (StbM_GetPeriodCounterOfTriggeredCustomerState(customerId, customerPartitionIdx) == StbM_GetTriggeredCustomerPeriodOfTriggeredCustomerConfig(customerId, customerPartitionIdx))
       /* #20 Check if time base has been synchronized to global time */
       && (StbM_Status_IsSynchronized(timeBaseIdx, timeBasePartitionIdx) == TRUE)

#  if (STBM_CONFIG_TIMEOUT == STD_ON)
       /* #30 Check if timeout has not occurred */
       && (StbM_Status_IsTimeout(timeBaseIdx, timeBasePartitionIdx) == FALSE)
#  endif

#  if (STBM_CONFIG_TIME_LEAP == STD_ON)
       /* #40 Check if no time leap has occurred */
       && (StbM_Status_IsTimeLeap(timeBaseIdx, timeBasePartitionIdx) == FALSE)
#  endif
    )
  {
    /* #50 Check if table status is RUNNING || WAITING || RUNNING_AND_SYNCHRONOUS */
    ScheduleTableStatusType scheduleStatus = 0u;
    StatusType currentScheduleTableStatus = GetScheduleTableStatus(StbM_GetScheduleTableIDOfTriggeredCustomerConfig(customerId, customerPartitionIdx), &scheduleStatus); /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */
...
# endif
  ...
  {
    /* #20 Initialize the update counter */
  ...
  if (StbM_TimeNotification_IsTimerStopped(customerId, partitionIdx) == TRUE)
  {
    ...
    if ((StbM_Calc_LessEqualThan(expireTime, &mainFunctionCycle) == FALSE) && ((StbM_TimeNotification_IsGptTimerStopped() == TRUE) || (StbM_Calc_LessEqualThan(expireTime, &thresholdMax) == FALSE))) /* PRQA S 3415 */ /* MD_StbM_Rule13.5_3415 */ /* SBSW_STBM_FUNCTIONCALL_PARAMPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_PARAMPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */
    {
      ...
      if (retVal == E_OK)
      {
        ...
        isResultPositive = StbM_Calc_SubtractTimeStamps(&expirationPointForImmediateStart, &threshold, &expirationPointForGptStart); /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */

        /* #70 If expiration point is not expired: */
        if (isResultPositive == TRUE)
        {
...
STBM_LOCAL_INLINE FUNC(boolean, STBM_CODE) StbM_TimeNotification_IsGptTimerStopped(void)
{
  ...
  return (StbM_GptTimerState == STBM_GPT_TIMER_STOPPED);
} /* StbM_TimeNotification_IsGptTimerStopped */
        ...
        StbM_PartitionIdentifiersIterType partitionIdx)
{
  ...
  Std_ReturnType retVal;
  boolean isDeviationTimePositive;
  ...
  if (isDeviationTimePositive == FALSE)
  {
...
#    endif
    {
      /* #30 Reset rate correction for master */
#    if (STBM_USE_FLOAT64 == STD_ON)
...
#    else
      StbM_SetRateDeviationOfTimeCorrectionMasterState(StbM_GetTimeCorrectionMasterConfigIdxOfTimeBaseConfig(timeBaseIdx, partitionIdx), 0, partitionIdx); /* SBSW_STBM_ACCESS_TIMECORRECTIONMASTERSTATE_IND_TIMEBASECONFIG */ /* VCA_STBM_CSL02_CSL03 */
#    endif
    }
#    if (STBM_CONFIG_SLAVE_RATE_CORRECTION == STD_ON)
    else
...
#   if (STBM_CONFIG_SLAVE_RATE_CORRECTION == STD_ON)
    ...
    {
      /* #50 Reset rate correction for slave */
#    if (STBM_USE_FLOAT64 == STD_ON)
      StbM_TimeCorrection_SetRateForRateCorrectionSlave(timeBaseIdx, 1.0, partitionIdx);
#    else
      StbM_TimeCorrection_SetRateDeviationForRateCorrectionSlave(timeBaseIdx, 0, partitionIdx);
#    endif
    }
#   endif
  }
...
{
  /* ----- Local Variables ---------------------------------------------- */
  StbM_InternalRateType r_rc = 1.0;
...
{
  /* ----- Local Variables ---------------------------------------------- */
  StbM_RateDeviationType r_rc = 0;

  /* ----- Implementation ----------------------------------------------- */
  /* #10 If time correction is configured, get rate deviation */
#   if (STBM_CONFIG_SLAVE_RATE_CORRECTION == STD_ON)
#    if (STBM_CONFIG_MASTER_RATE_CORRECTION == STD_ON)
  if (StbM_TimeBase_IsSlave(timeBaseIdx, partitionIdx) == TRUE)
#    endif
  {
    r_rc = StbM_TimeCorrection_GetRateDeviationForRateCorrection(timeBaseIdx, partitionIdx);
  }
#   endif
...
#    endif
  {
    r_rc = StbM_TimeCorrection_GetRateDeviationMaster(timeBaseIdx, partitionIdx);
  }
#   endif
...
{
  /* ----- Local Variables ---------------------------------------------- */
  /* As this function returns a rate in ppm rather than a rate deviation, STBM_PPM_CONVERSION is used for the rate 1.0 */
  StbM_InternalRateDeviationType r = STBM_PPM_CONVERSION;
...
#    endif
    {
      r += StbM_TimeCorrection_GetRateDeviationMaster(timeBaseIdx, partitionIdx);
    }
#    if (STBM_CONFIG_SLAVE_RATE_CORRECTION == STD_ON)
    else
#    endif
...
#   if (STBM_CONFIG_SLAVE_RATE_CORRECTION == STD_ON)
    ...
    {
      /* #40 Get last calculated rate correction factor */
      r += (StbM_TimeCorrection_GetRateDeviationForRateCorrection(timeBaseIdx, partitionIdx) + StbM_TimeCorrection_GetRateDeviationForOffsetRateCorrection(timeBaseIdx, partitionIdx));
      /* To correctly add two rate deviations, the result is adapted by adding STBM_PPM_CONVERSION */
      r += STBM_PPM_CONVERSION;
    }
#   endif
  }
...
#   endif
  ...
  {
    /* #10 Reset rate deviation / rate correction for master */
#   if (STBM_USE_FLOAT64 == STD_ON)
    StbM_SetRateCorrectionRateOfTimeCorrectionMasterState(i, 1.0, partitionIdx); /* SBSW_STBM_ACCESS_TIMECORRECTIONMASTERSTATE */
#   else
    StbM_SetRateDeviationOfTimeCorrectionMasterState(i, 0, partitionIdx); /* SBSW_STBM_ACCESS_TIMECORRECTIONMASTERSTATE */
#   endif
...
{
  /* ----- Local Variables ---------------------------------------------- */
  StbM_RateDeviationType newRateDeviation = rateDeviation;
  StbM_RateDeviationType maxRateDeviation;
...
#   endif
  ...
  /* #10 Get configured max rate deviation: r_max */
  maxRateDeviation = (StbM_RateDeviationType) StbM_GetMaxRateDeviationOfTimeCorrectionMasterConfig(StbM_GetTimeCorrectionMasterConfigIdxOfTimeBaseConfig(timeBaseIdx, partitionIdx), partitionIdx);

  /* #20 Ensure that rate deviation is bound to configured max value like: -r_max < r < r_max */
  if ((rateDeviation > maxRateDeviation) || (rateDeviation < -maxRateDeviation))
  {
    if (rateDeviation > 0)
    {
      newRateDeviation = maxRateDeviation;
    }
    else
    {
      newRateDeviation = -maxRateDeviation;
  ...
  /* #30 Convert given rate from ppm into internal type */
#   if (STBM_USE_FLOAT64 == STD_ON)
  /* #40 Store new converted rate */
  StbM_SetRateCorrectionRateOfTimeCorrectionMasterState(StbM_GetTimeCorrectionMasterConfigIdxOfTimeBaseConfig(timeBaseIdx, partitionIdx), StbM_ToStbMInternalRateType((StbM_InternalRateType)newRateDeviation), partitionIdx); /* SBSW_STBM_ACCESS_TIMECORRECTIONMASTERSTATE_IND_TIMEBASECONFIG */
#   else
  /* #40 Store new converted rate */
  StbM_SetRateDeviationOfTimeCorrectionMasterState(StbM_GetTimeCorrectionMasterConfigIdxOfTimeBaseConfig(timeBaseIdx, partitionIdx), newRateDeviation, partitionIdx); /* SBSW_STBM_ACCESS_TIMECORRECTIONMASTERSTATE_IND_TIMEBASECONFIG */
#   endif
...
#   if (STBM_CONFIG_STATUS_NOTIFICATION == STD_ON)
  /* #50 Update status notification event with: RateCorrection */
...
#    endif
  ...
  /* #10 Get rate deviation for rate correction */
  return StbM_GetRateDeviationOfTimeCorrectionMasterState(StbM_GetTimeCorrectionMasterConfigIdxOfTimeBaseConfig(timeBaseIdx, partitionIdx), partitionIdx);
} /* StbM_TimeCorrection_GetRateDeviationMaster */
#   endif /* (STBM_USE_FLOAT64 == STD_ON) */
...
#   else
    /* #10 Reset rate correction */
    StbM_SetRateDeviationOfTimeCorrectionSlaveState(slaveIdx, 0, partitionIdx); /* SBSW_STBM_ACCESS_TIMECORRECTIONSLAVESTATE */

    /* #20 Reset offset rate correction */
    StbM_SetOffsetRateDeviationOfTimeCorrectionOffsetSlaveState(StbM_GetIndirectionToTimeCorrectionOffsetSlaveStateIdxOfTimeBasePartitionMapping(timeBaseIdx), -STBM_PPM_CONVERSION, StbM_GetIndirectionToTimeCorrectionOffsetSlaveStatePartitionIdxOfTimeBasePartitionMapping(timeBaseIdx)); /* SBSW_STBM_ACCESS_TIMECORRECTIONOFFSETSLAVESTATE_IND_TIMEBASEPARTITIONMAPPING */
#   endif

    /* #30 Set valid rate correction to FALSE */
    ...
    /* #40 Set valid offset rate correction to FALSE */
        ...
        StbM_PartitionIdentifiersIterType partitionIdx)
{
  ...
  {
#   if (STBM_USE_FLOAT64 == STD_ON)
    /* #20 Calculate offset rate correction, denoted as r_oc */
    StbM_InternalRateType rate = StbM_TimeCorrection_CalculateRateForOffsetRateCorrectionSlave(timeBaseIdx, partitionIdx);

    /* #30 Set r_oc */
    StbM_TimeCorrection_SetRateForOffsetRateCorrection(timeBaseIdx, rate, partitionIdx); /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */
#   else
    /* #20 Calculate offset rate correction, denoted as r_oc */
    StbM_InternalRateDeviationType rateDeviation = StbM_TimeCorrection_CalculateRateDeviationForOffsetRateCorrectionSlave(timeBaseIdx, partitionIdx);;

    /* #30 Set r_oc */
    StbM_TimeCorrection_SetRateDeviationForOffsetRateCorrection(timeBaseIdx, rateDeviation, partitionIdx); /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */
#   endif
  }
  /* #40 Otherwise set offset rate correction invalid */
  else
  {
...
#   if (STBM_USE_FLOAT64 == STD_ON)
  /* #10 Reset offset rate correction */
...
#   else
  /* #10 Reset offset rate correction */
  StbM_SetOffsetRateDeviationOfTimeCorrectionOffsetSlaveState(StbM_GetIndirectionToTimeCorrectionOffsetSlaveStateIdxOfTimeBasePartitionMapping(timeBaseId), -STBM_PPM_CONVERSION, StbM_GetIndirectionToTimeCorrectionOffsetSlaveStatePartitionIdxOfTimeBasePartitionMapping(timeBaseId)); /* SBSW_STBM_ACCESS_TIMECORRECTIONOFFSETSLAVESTATE_IND_TIMEBASEPARTITIONMAPPING */
#   endif
  ...
  if (StbM_Status_IsTimeLeap(timeBaseIdx, partitionIdx) == FALSE)
  {
    ...
    for (i = startIdx; i < stopIdx; i++) /* FETA_StbM_2 */
    {
      ...
      if (StbM_IsValidOfRateMeasurements(i, partitionIdx))
      {
        ...
        (void) StbM_Calc_SubtractVirtualLocalTimes(&virtualLocalTimeStart, &startTimeMeasurement, &deltaStartTime); /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */
        ...
        StbM_PartitionIdentifiersIterType partitionIdx)
{
  ...
  for (i = startIdx; i < stopIdx; i++) /* FETA_StbM_2 */
  {
    ...
    if (StbM_IsValidOfRateMeasurements(i, partitionIdx))
    {
      ...
      (void) StbM_Calc_SubtractVirtualLocalTimes(&virtualLocalTimeStop, &virtualLocalTimeStart, &deltaVirtualLocalTime); /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */
...
#   if (STBM_USE_FLOAT64 == STD_ON)
        ...
        /* #80 Calculate new rate correction */
        ...
        /* #90 If new rate correction is valid: */
        if (retVal == E_OK)
        {
          /* #100 Set new rate correction */
          StbM_TimeCorrection_SetRateForRateCorrectionSlave(timeBaseIdx, newRate, partitionIdx);
#   else
        StbM_RateDeviationType newRateDeviation = 0;

        /* #80 Calculate new rate correction */
        retVal = StbM_TimeCorrection_CalculateRateDeviationForRateCorrectionSlave(timeBaseIdx, i, &newRateDeviation, partitionIdx); /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */

        /* #90 If new rate correction is valid: */
        if (retVal == E_OK)
        {
          /* #100 Set new rate correction */
          StbM_TimeCorrection_SetRateDeviationForRateCorrectionSlave(timeBaseIdx, newRateDeviation, partitionIdx);
#   endif
        ...
        StbM_PartitionIdentifiersIterType partitionIdx)
{
  ...
  StbM_InternalTimeStampType deltaGlobalTime = STBM_INIT_TIME_ZERO;
  uint64 deltaTG = 0u;
  StbM_InternalRateDeviationType calculatedRateDeviation = 0;
...
#    endif
  ...
  /* #90 Calculate rate deviation = (dTG / dTV) */
  calculatedRateDeviation =  (((StbM_InternalRateDeviationType) deltaTG * STBM_PPM_CONVERSION) / (StbM_InternalRateDeviationType) (deltaTV));
  calculatedRateDeviation -= STBM_PPM_CONVERSION;

#    if (STBM_CONFIG_OFFSET_TIMEBASE == STD_ON)
  /* #100 If offset timebase, rate deviation = (dTG / dTV) + 1 */
  if (StbM_TimeBase_IsOffset(timeBaseIdx, partitionIdx) == TRUE)
  {
    calculatedRateDeviation += STBM_PPM_CONVERSION;

    /* #120 Consider sign of rate deviation */
    if (isdTGpositive == FALSE)
    {
      calculatedRateDeviation *= -1;
    }
  }
  else
#    endif
  {
    /* #110 If no offset timebase and dTG negative, set retVal to E_NOT_OK */
    if (isdTGpositive == FALSE)
    {
      retVal = E_NOT_OK;
    }
  ...
  /* #130 Ensure rate is within bounds [-32000, 32000] ppm */
  if ((calculatedRateDeviation > STBM_MAX_RATE_PPM) || (calculatedRateDeviation < STBM_MIN_RATE_PPM))
  {
    retVal = E_NOT_OK;
  }
  else
  {
    *rateDeviation = (StbM_RateDeviationType) calculatedRateDeviation; /* SBSW_STBM_ACCESS_PARAMPTR */
  }
        ...
        StbM_PartitionIdentifiersIterType partitionIdx)
{
  ...
  /* #60 Calculate (dT / Tcorr_int), Tcorr_int = OffsetCorrectionAdaptionInterval */
  rateDeviation = ((StbM_InternalRateDeviationType) deltaNs * STBM_PPM_CONVERSION) / ((StbM_InternalRateDeviationType) offsetCorrectionAdaptionInterval);
  ...
  rateDeviation -= STBM_PPM_CONVERSION;
...
#    endif
  ...
  /* #10 Set rate deviation for rate correction to given slave */
  StbM_SetRateDeviationOfTimeCorrectionSlaveState(StbM_GetTimeCorrectionSlaveConfigIdxOfTimeBaseConfig(timeBaseIdx, partitionIdx), rateDeviation, partitionIdx); /* SBSW_STBM_ACCESS_TIMECORRECTIONSLAVESTATE_IND_TIMEBASECONFIG */ /* VCA_STBM_CSL02_CSL03 */
} /* StbM_TimeCorrection_SetRateDeviationForRateCorrectionSlave */
...
#    endif
  ...
  /* #10 Set rate deviation for offset correction to given slave */
  StbM_SetOffsetRateDeviationOfTimeCorrectionOffsetSlaveState(StbM_GetIndirectionToTimeCorrectionOffsetSlaveStateIdxOfTimeBasePartitionMapping(timeBaseId), rateDeviation, StbM_GetIndirectionToTimeCorrectionOffsetSlaveStatePartitionIdxOfTimeBasePartitionMapping(timeBaseId)); /* SBSW_STBM_ACCESS_TIMECORRECTIONOFFSETSLAVESTATE_IND_TIMEBASEPARTITIONMAPPING */
...
#    endif
  ...
  /* #10 Get current stored rate deviation for rate correction */
  return StbM_GetRateDeviationOfTimeCorrectionSlaveState(StbM_GetTimeCorrectionSlaveConfigIdxOfTimeBaseConfig(timeBaseIdx, partitionIdx), partitionIdx);
} /* StbM_TimeCorrection_GetRateDeviationForRateCorrection */
...
#    endif
  ...
  /* #10 Get current stored rate deviation for offset rate correction */
  return StbM_GetOffsetRateDeviationOfTimeCorrectionOffsetSlaveState(StbM_GetIndirectionToTimeCorrectionOffsetSlaveStateIdxOfTimeBasePartitionMapping(timeBaseId), StbM_GetIndirectionToTimeCorrectionOffsetSlaveStatePartitionIdxOfTimeBasePartitionMapping(timeBaseId));
} /* StbM_TimeCorrection_GetRateDeviationForOffsetRateCorrection */
#   endif /* (STBM_USE_FLOAT64 == STD_ON) */
        ...
        StbM_PartitionIdentifiersIterType partitionIdx)
{
  ...
  {
    uint16 timeCorrectionIdx = StbM_GetTimeCorrectionMasterConfigIdxOfTimeBaseConfig(destinationTimeBaseIdx, partitionIdx);

    /*@ assert timeCorrectionIdx < StbM_GetSizeOfTimeCorrectionMasterState(partitionIdx); */ /* VCA_STBM_CSL02_CSL03 */
    /* #20 If rate deviation of source time base is valid: */
    boolean isRateDeviationValid = StbM_TimeCorrection_IsRateDeviationValid(sourceTimeBaseIdx, partitionIdx);
    if (isRateDeviationValid == TRUE)
    {
      /* #30 Get rate deviation of source time base */
      StbM_RateDeviationType sourceRateDeviation = StbM_TimeCorrection_GetRateDeviation(sourceTimeBaseIdx, partitionIdx);

      /* #40 Get configured max rate deviation: r_max */
      StbM_RateDeviationType maxRateDeviation = (StbM_RateDeviationType) StbM_GetMaxRateDeviationOfTimeCorrectionMasterConfig(timeCorrectionIdx, partitionIdx);

      /* #50 Ensure that rate deviation is bound to configured max value like: -r_max < r < r_max */
      if ((sourceRateDeviation > maxRateDeviation) || (sourceRateDeviation < -maxRateDeviation))
      {
        if (sourceRateDeviation > 0)
        {
          sourceRateDeviation = maxRateDeviation;
        }
        else
        {
          sourceRateDeviation = -maxRateDeviation;
      ...
      /* #60 Store new rate value */
#  if (STBM_USE_FLOAT64 == STD_ON)
      StbM_SetRateCorrectionRateOfTimeCorrectionMasterState(timeCorrectionIdx, StbM_ToStbMInternalRateType((StbM_InternalRateType)sourceRateDeviation), partitionIdx); /* SBSW_STBM_ACCESS_TIMECORRECTIONMASTERSTATE_IND_TIMEBASECONFIG */
#  else
      StbM_SetRateDeviationOfTimeCorrectionMasterState(timeCorrectionIdx, sourceRateDeviation, partitionIdx); /* SBSW_STBM_ACCESS_TIMECORRECTIONMASTERSTATE_IND_TIMEBASECONFIG */
#  endif
    }

    /* #70 Store validity of rate value */
    StbM_SetRateDeviationValidOfTimeCorrectionMasterState(timeCorrectionIdx, isRateDeviationValid, partitionIdx); /* SBSW_STBM_ACCESS_TIMECORRECTIONMASTERSTATE_IND_TIMEBASECONFIG */
  }
} /* StbM_TimeCorrection_CloneRateValue */
# endif /* (STBM_CONFIG_MASTER_RATE_CORRECTION == STD_ON) && (STBM_CONFIG_SOURCE_TIMEBASE == STD_ON) */
...
#  if (STBM_USE_FLOAT64 == STD_ON)
  StbM_InternalRateType rate;
#  else
  StbM_InternalRateDeviationType ratePPM;
#  endif
# endif
...
#   if (STBM_CONFIG_OFFSET_TIMEBASE == STD_ON)
  ...
  if (rate < 0.0)
  {
    ...
    isResultPositive = StbM_Calc_SubtractTimeStamps(&globalTimeSync, &elapsedVirtualLocalInternalTimeStamp, localTime); /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_PARAMPTR */
    if (isResultPositive == FALSE)
    {
      retVal = E_NOT_OK;
    }
  }
...
#  else
  ratePPM = StbM_TimeCorrection_GetRateInPPM(timeBaseIdx, partitionIdx);
...
#   if (STBM_CONFIG_OFFSET_TIMEBASE == STD_ON)
  ...
  if (ratePPM < 0)
  {
    ...
    retVal = StbM_Calc_MultiplyTimeStampWithRatePPM(&elapsedVirtualLocalInternalTimeStamp, -ratePPM); /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */

    /* #70 Subtract corrected elapsed virtual local time from global time */
    isResultPositive = StbM_Calc_SubtractTimeStamps(&globalTimeSync, &elapsedVirtualLocalInternalTimeStamp, localTime); /* PRQA S 2986 */ /* MD_StbM_Rule2.2_2986 */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_PARAMPTR */
    if (isResultPositive == FALSE)
    {
      retVal = E_NOT_OK;
    }
        ...
        StbM_PartitionIdentifiersIterType partitionIdx)
{
  ...
  if (StbM_Status_IsSynchronized(referredTimeBaseIdx, referredPartitionIdx) == TRUE)
  {
    ...
    isResultPositive = StbM_Calc_SubtractTimeStamps(globalTime, &underlyingSyncTimeBaseLocalTime, offsetValue); /* SBSW_STBM_FUNCTIONCALL_PARAMPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_PARAMPTR */
    if (isResultPositive == FALSE)
    {
      retVal = E_NOT_OK;
    }
        ...
        P2CONST(StbM_InternalTimeStampType, AUTOMATIC, STBM_APPL_DATA) localTime)
{
  ...
  isPositive = StbM_Calc_SubtractTimeStamps(globalTime, localTime, &difference); /* SBSW_STBM_FUNCTIONCALL_PARAMPTR */ /* SBSW_STBM_FUNCTIONCALL_PARAMPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */
        ...
        StbM_PartitionIdentifiersIterType partitionIdx)
{
  ...
  retVal |= StbM_Calc_SubtractVirtualLocalTimes(&currentVirtualLocalTime, localTimePtr, &receptionDelay); /* SBSW_STBM_FUNCTIONCALL_PARAMPTR */ /* SBSW_STBM_FUNCTIONCALL_PARAMPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */

  /* #30 Calculate updated received global time, if succeeded: */
...
#   else
      /* Convert rate deviation in a rate in ppm */
      ratePPM = (StbM_InternalRateDeviationType) StbM_TimeCorrection_GetRateDeviationForRateCorrection(timeBaseIdx, partitionIdx) + STBM_PPM_CONVERSION;
#    if (STBM_CONFIG_OFFSET_TIMEBASE == STD_ON)
      if (StbM_TimeBase_IsOffset(timeBaseIdx, partitionIdx) == TRUE)
      {
        ratePPM -= STBM_PPM_CONVERSION;
      }
#    endif
      retVal = StbM_Calc_MultiplyTimeStampWithRatePPM(&receptionDelayInternalTimeStamp, ratePPM); /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */
#   endif
      retVal |= StbM_Calc_AddTimeStamps(&receptionDelayInternalTimeStamp, globalTimePtr, updatedGlobalTimePtr); /* PRQA S 2986 */ /* MD_StbM_Rule2.2_2986 */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_PARAMPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */
    }
    else
#  endif
    {
...
#  endif
        {
          ...
          (void) StbM_Calc_SubtractVirtualLocalTimes(virtualLocalTime, &virtualLocalTimeTemp, &virtualLocalTimeElapsedAfterAdaptionInterval); /* SBSW_STBM_FUNCTIONCALL_PARAMPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */
        ...
        StbM_PartitionIdentifiersIterType partitionIdx)
{
  ...
  (void) StbM_Calc_SubtractVirtualLocalTimes(virtualLocalTime, &virtualLocalTimeSync, elapsedVirtualLocalTime); /* SBSW_STBM_FUNCTIONCALL_PARAMPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_PARAMPTR */
} /* StbM_LocalTime_CalculateElapsedVirtualLocalTime */
...
STBM_LOCAL FUNC(uint8, STBM_CODE) StbM_LocalTime_TriggerLocalClockSync(StbM_SynchronizedTimeBaseType timeBaseIdx, StbM_PartitionIdentifiersIterType partitionIdx)
{
  ...
  clockAdjustment = StbM_LocalClockSyncCallback(timeBaseIdx, ethIfCtrlIdx, &tgSync, &tvSync, rateDeviation, timeLeap, updateCounter); /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */
...
STBM_LOCAL_INLINE FUNC(void, STBM_CODE) StbM_LocalTime_HandleLocalClockSync(StbM_SynchronizedTimeBaseType timeBaseIdx, StbM_PartitionIdentifiersIterType partitionIdx)
{
  ...
  /* #20 If local clock was adjusted: */
  if (clockAdjustment != STBM_NONE_CLOCK_ADJUSTMENT)
  {
    ...
    /* #30 For all time bases with the same local clock: */
    for (localClockIdx = 0u; localClockIdx < StbM_GetSizeOfLocalClockConfig(partitionIdx); localClockIdx++)
    {
      if (ethClockIdx == StbM_GetEthClockConfigIdxOfLocalClockConfig(localClockIdx, partitionIdx))
      {
        ...
        /* #40 If update of VirtualLocalTime succeeded (assumed to always be successful as stated in this functions precondition) */
        if (StbM_LocalTime_OnGetCurrentVirtualLocalTime(currentTimeBaseIdx, &virtualLocalTime, partitionIdx) == E_OK) /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* COV_STBM_READ_MODIFIED_CLOCK */
        {
          StbM_LocalTime_GetLastClockValue(StbM_LocalTime_GetLocalClockIdx(currentTimeBaseIdx, partitionIdx), &globalTimeSync, partitionIdx); /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */

          /* #50 Update the main time tuple */
          StbM_LocalTime_SetGlobalTimeSync(currentTimeBaseIdx, &globalTimeSync, partitionIdx); /* SBSW_STBM_FUNCTIONCALL_PARAMPTR */
          StbM_LocalTime_SetVirtualLocalTimeSync(currentTimeBaseIdx, &virtualLocalTime, partitionIdx); /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */

          /* #60 Update the received time tuple */
          StbM_LocalTime_SetGlobalTimeRx(currentTimeBaseIdx, &globalTimeSync, partitionIdx); /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */
          StbM_LocalTime_SetVirtualLocalTimeRx(currentTimeBaseIdx, &virtualLocalTime, partitionIdx); /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */

          /* #70 Update the synclocal time tuple */
          StbM_LocalTime_SetLocalTimeSync(currentTimeBaseIdx, &globalTimeSync, partitionIdx); /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */
        }
#  if ((STBM_CONFIG_MASTER_RATE_CORRECTION == STD_ON) || (STBM_CONFIG_SLAVE_RATE_CORRECTION == STD_ON))
        /* #80 Reset rate */
        StbM_TimeCorrection_ResetRate(currentTimeBaseIdx, partitionIdx);
#   if (STBM_CONFIG_SLAVE_RATE_CORRECTION == STD_ON)
        /* #90 If major adjustment and timebase has time correction for slave configured: */
        ...
        StbM_PartitionIdentifiersIterType partitionIdx)
{
  ...
  if (StbM_IsDifferentLocalClockSourceForCloningOfTimeBaseConfig(destinationTimeBaseIdx, partitionIdx) == TRUE)
  {
  ...
  {
    StbM_InternalTimeStampType lastClockValue = STBM_INIT_CLOCK_ZERO;
        ...
        P2VAR(StbM_VirtualLocalTimeType, AUTOMATIC, STBM_APPL_VAR) difference)
{
  ...
  /* #10 If lhs < rhs, set retVal to E_NOT_OK */
  if (StbM_Calc_LessThan_VirtualLocalTime(lhs, rhs) == TRUE) /* SBSW_STBM_FUNCTIONCALL_PARAMPTR */ /* SBSW_STBM_FUNCTIONCALL_PARAMPTR */
  {
    retVal = E_NOT_OK;
  }
        ...
        StbM_InternalRateDeviationType ratePPM)
{
  /* ----- Local Variables ---------------------------------------------- */
  Std_ReturnType retVal;
  uint64 timeStampNanoseconds = 0uL;
  uint64 timeStampResult;

  /* ----- Implementation ----------------------------------------------- */
  /* #10 Convert timestamp to nanoseconds */
  retVal = StbM_Calc_ToNanoseconds_Uint64(timeStamp, &timeStampNanoseconds); /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */

  /* #20 Multiply timestamp in nanoseconds with rate deviation */
  timeStampResult = ((timeStampNanoseconds * (uint64)ratePPM));

  /* #30 If no overflow occurs, or in case of an offset timebase the rate deviation is zero */
  if ((retVal == E_OK) && ((ratePPM == 0) || (timeStampResult >= timeStampNanoseconds)))
  {
    /* #40 Divide by STBM_PPM_CONVERSION to get a timestamp without ppm scaling */
    timeStampResult = timeStampResult / (uint64)STBM_PPM_CONVERSION;

    /* #50 Convert the timestamp into the InternalTimeStampType */
    timeStamp->nanoseconds = (StbM_NanosecondsType)(timeStampResult % STBM_NANOSECONDS_IN_ONE_SECOND); /* SBSW_STBM_ACCESS_PARAMPTR */
    timeStamp->seconds = (StbM_SecondsType)(timeStampResult / STBM_NANOSECONDS_IN_ONE_SECOND); /* SBSW_STBM_ACCESS_PARAMPTR */
    /* If the multiplication does not overflow, secondsHi can never be > 0 */
    timeStamp->secondsHi = 0u; /* SBSW_STBM_ACCESS_PARAMPTR */
  }
  else
  {
    retVal = E_NOT_OK;
...
{
  /* ----- Local Variables ---------------------------------------------- */
  StbM_InternalTimeStampType roundedTimeStamp;
  StbM_InternalTimeStampType correctionNs = {500u, 0u, 0u};

  /* ----- Implementation ----------------------------------------------- */
  /* #10 Add 500ns to timeStamp to account for division inaccuracy by rounding */
  (void) StbM_Calc_AddTimeStamps(timeStamp, &correctionNs, &roundedTimeStamp); /* SBSW_STBM_FUNCTIONCALL_PARAMPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */ /* SBSW_STBM_FUNCTIONCALL_LOCALPTR */

  /* #20 Convert into microseconds by: seconds * 1000000 + nanoseconds / 1000 */
  return (((((StbM_MicrosecondType)roundedTimeStamp.secondsHi) << 32u) | (StbM_MicrosecondType)roundedTimeStamp.seconds) * (StbM_MicrosecondType)STBM_MICROSECOND_IN_ONE_SECOND)
            + ((StbM_MicrosecondType)roundedTimeStamp.nanoseconds / (StbM_MicrosecondType)STBM_NANOSECONDS_IN_ONE_MICROSECOND);
} /* StbM_Calc_ToMicroseconds */
# endif /* (STBM_CONFIG_TRIGGERED_CUSTOMER == STD_ON) */
...
# endif
  {
    ...
    /* #40 Get main time tuple, time base status and rate deviation */
...
/* COV_JUSTIFICATION_BEGIN
  ...
  \ID COV_STBM_ADAPTIVE_RETRY
    \ACCEPT TX
    \REASON This define is only used for retry mechanism in Adaptive.
  ...
  \ID COV_STBM_READ_MODIFIED_CLOCK
    \ACCEPT TX
    \REASON This check ensures that errors during virtual local time retrieval are handled in the best possible way.
    These errors are assumed to never happen in normal configurations, as stated by the precondition of StbM_LocalTime_HandleLocalClockSync.
