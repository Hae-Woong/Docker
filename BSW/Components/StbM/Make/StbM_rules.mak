...
#------------------------------------------------------------------------------
# 1.00.00   2012-12-05  ssf     Initial Version
# 1.01.00   2019-01-23  si      Support of new SIP structure
# 1.01.01   2019-02-06  vircbl  Added support of component-based SIP structure
# 2.00.00   2022-04-01  ssf     Added inclusion of generated source files
#------------------------------------------------------------------------------
...
LIBRARIES_TO_BUILD      += StbM
StbM_FILES               = StbM$(BSW_SRC_DIR)\StbM.c

# e.g.: CC_FILES_TO_BUILD       += <MSN>\<MSN>.c <MSN>\<MSN>_Irq.c
CC_FILES_TO_BUILD       += StbM$(BSW_SRC_DIR)\StbM.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
include $(GENDATA_DIR)\Make\StbM_rules_generated.mak
