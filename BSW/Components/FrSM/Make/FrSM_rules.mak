...
#------------------------------------------------------------------------------
# 1.00.00   2012-06-22  MFi     Initial Version
# 1.01.00   2013-05-02  MFi     remove FrSM_PBCfg.c
...
LIBRARIES_TO_BUILD      += FrSM
FrSM_FILES               = FrSM$(BSW_SRC_DIR)\FrSM.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += FrSM$(BSW_SRC_DIR)\FrSM.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\FrSM_Lcfg.c
