 ...
 *  02.02.01  2017-11-23  MFi     ESCAN00097415 FlexRay communication not possible at  non wakeup cluster (multi cluster system, with mixed wakeup and non wakeup clusters, with deactivated check wake up reason)
 *  02.02.02  2018-03-28  MFi     ESCAN00098952 Adapt SW version
 *  03.00.00  2018-08-28  MFi     STORYC-6136   MISRA-C:2012 Compliance
 *  04.00.00  2018-11-13  MFi     STORYC-7039   Fix Remedy ReviewLogSheet_SafetyCheck_FrSM findings
 *********************************************************************************************************************/
...
#if (  ( FRSM_SW_MAJOR_VERSION != 0x04u ) || ( FRSM_SW_MINOR_VERSION != 0x00u ) || ( FRSM_SW_PATCH_VERSION != 0x00u )  )
/* \trace SPEC-10927 */
...
/* FRSM_TRANSITION_T02_NEEDED */
#if ( FRSM_WAKEUPECUOFCLUSTERCONFIG == STD_OFF )
/* All clusters without wakeup configured */
# define FRSM_STARTUP_WITHOUT_WAKEUP_POSSIBLE       STD_ON
#elif ( FRSM_CHECKWAKEUPREASONOFCLUSTERCONFIG == STD_ON )
/* Some clusters without wakeup, depending on the wakeup type */
# define FRSM_STARTUP_WITHOUT_WAKEUP_POSSIBLE       STD_ON
#elif ( FRSM_WAKEUP_ECU_ALL_CLUSTERS == FALSE )
/* Some clusters without wakeup configured  */
# define FRSM_STARTUP_WITHOUT_WAKEUP_POSSIBLE       STD_ON
#else
/* All clusters with wakeup configured  */
# define FRSM_STARTUP_WITHOUT_WAKEUP_POSSIBLE       STD_OFF
#endif
...
/*! Ecu passive mode of the module */
...
FRSM_LOCAL FUNC( void, FRSM_CODE ) FrSM_StopTrcvGoToReady( FrSM_SizeOfVarStructType FrSM_ClusterIndex )
{
  ...
  BswM_FrSM_CurrentState( FrSM_GetNetworkHandleOfClusterConfig( FrSM_ClusterIndex ), (FrSM_BswM_StateType)( FRSM_BSWM_READY + (uint8)FrSM_EcuPassiveMode ) );  /* PRQA S 2985, 2986 */ /*  MD_FRSM_Rule2.2 */
  /* \trace  SPEC-11009 */
...
FRSM_LOCAL_INLINE FUNC(void, FRSM_CODE) FrSM_HandleComModeRequest( FrSM_SizeOfVarStructType FrSM_ClusterIndex )
{
  ...
  {
    SchM_Enter_FrSM_FRSM_EXCLUSIVE_AREA_2( );   /* FrSM_Mainfunction interrupts * T10 T16 T17 FrSM_RequestComMode T14 T09 */
       ...
       )
    {
      ...
      ComM_BusSM_ModeIndication( FrSM_GetNetworkHandleOfClusterConfig( FrSM_ClusterIndex ), &FrSM_ComMMode );   /* CREQ-105686 */  /* SBSW_FRSM_COMMMODEINDICATION_CALL */
      BswM_FrSM_CurrentState( FrSM_GetNetworkHandleOfClusterConfig( FrSM_ClusterIndex ), (FrSM_BswM_StateType)( FRSM_BSWM_HALT_REQ + (uint8)FrSM_EcuPassiveMode ) );  /* PRQA S 2985, 2986 */ /*  MD_FRSM_Rule2.2 */
      /* \trace  SPEC-11009 */
    ...
    SchM_Exit_FrSM_FRSM_EXCLUSIVE_AREA_2( );   /* FrSM_Mainfunction interrupts * T10 T16 T17 FrSM_RequestComMode T14 T09 */
...
#if ( FRSM_TRCV_HANDLINGOFCLUSTERCONFIG == STD_ON )
# if ( FRSM_ECU_PASSIVE_MODE == STD_ON )
      SchM_Enter_FrSM_FRSM_EXCLUSIVE_AREA_1( ); /* FrSM_SetEcuPassive interrupts Main T01 T02 */
...
# if ( FRSM_ENABLE_CONSECUTIVE_WUPOFCLUSTERCONFIG == STD_ON )
          FrSM_SetWakeUpPatternCounterOfVarStruct( FrSM_ClusterIndex, ( FrSM_GetNumWakeupPatternsOfClusterConfig( FrSM_ClusterIndex ) - 1u ) ); /* SBSW_FRSM_ARRAY_WRITE_ACCESS */
...
#  else /*  FRSM_WAKEUP_ON_BOTH_CHANNELS_ALLOWED  */
          if ( FrSM_GetWakeUpTypeOfVarStruct( FrSM_ClusterIndex ) == FRSM_PERFORM_INITIAL_WAKEUP )  /* 4 */ 
          {
...
# endif /* ( FRSM_TIMER_COLDSTARTDELAY_USED == STD_ON ) */
...
#endif /* WakeupEcu FRSM_WAKEUPECUOFCLUSTERCONFIG */
        {
          if (  ( FrSM_GetStartup_CounterOfVarStruct( FrSM_ClusterIndex ) <= FrSM_GetStartupRepetitionsOfClusterConfig( FrSM_ClusterIndex ) )
              ...
              || ( FrSM_IsStartUp_UnlimitedOfClusterConfig( FrSM_ClusterIndex ) ) 
...
# if ( FRSM_COLDSTARTECUOFCLUSTERCONFIG == STD_ON )
            if ( FrSM_IsColdstartEcuOfClusterConfig( FrSM_ClusterIndex ) ) /* COV_FRSM_CONFIG_PARAMETER_BOOLEAN_AFTEREFFECT */
            {
...
# endif /* ( FRSM_COLDSTARTECUOFCLUSTERCONFIG == STD_ON ) */
            if ( FrSM_GetStartup_CounterOfVarStruct( FrSM_ClusterIndex ) < FRSM_MAX_STARTUP_COUNTEROFVARSTRUCT )   /* avoid WUP in case of unlimited FrSMStartupRepetitions */ /* COV_FRSM_VARIABLE_TYPE_RANGE */
            {
              FrSM_IncStartup_CounterOfVarStruct( FrSM_ClusterIndex ); /* SBSW_FRSM_ARRAY_WRITE_ACCESS */ /* incrementation after evaluation */
            }
      ...
      else
      {
        ...
        if ( FrSM_IsColdstartEcuOfClusterConfig( FrSM_ClusterIndex ) ) /* COV_FRSM_CONFIG_PARAMETER_BOOLEAN */
        {
          ...
          if ( FrSM_GetTimer_ColdstartDelayOfVarStruct( FrSM_ClusterIndex ) == FRSM_COLDSTART_DELAY_TIMER_EXPIRED )  /* union FrSM_GetTimer_ColdstartDelayOfVarStruct FrSM_GetTrcvStbyDelay  */
          {
# if (  ( FRSM_GET_WAKEUP_RX_STATUS_SUPPORT == STD_ON ) &&  ( FRSM_DUAL_CHANNEL_SUPPORTOFCLUSTERCONFIG == STD_ON ) && ( FRSM_WAKEUP_ON_BOTH_CHANNELS_ALLOWED == STD_OFF )  ) /* FrIf_GetWakeupRxStatus */
            ...
            if ( FrSM_GetWakeUpTypeOfVarStruct( FrSM_ClusterIndex ) == FRSM_PERFORM_DUAL_CHANNEL_WAKEUP )  /* 4 */ 
            ...
            if ( FrSM_WakeupRxStatus == FRSM_WU_DETECTED_ON_CHANNEL_B )  /*  NO 0d; ChA 1d; ChB 2d */
...
#if ( FRSM_TRCV_HANDLINGOFCLUSTERCONFIG == STD_ON )
# if ( FRSM_ECU_PASSIVE_MODE == STD_ON )
      SchM_Exit_FrSM_FRSM_EXCLUSIVE_AREA_1( ); /* FrSM_SetEcuPassive interrupts Main T01 T02 */
# endif /* end if ( FRSM_ECU_PASSIVE_MODE == STD_ON ) */
#endif /* end #if ( FRSM_TRCV_HANDLINGOFCLUSTERCONFIG == STD_ON ) */
...
#if ( FRSM_WAKEUPECUOFCLUSTERCONFIG == STD_ON )
    /* fall through */
    case FRSM_BSWM_WAKEUP :   /* PRQA S 2003 */  /* MD_FRSM_Rule16.3 */
#endif /* WakeupEcu FRSM_WAKEUPECUOFCLUSTERCONFIG */
    case FRSM_BSWM_ONLINE_PASSIVE :   /* PRQA S 2003 */  /* MD_FRSM_Rule16.3 */
    {
...
#   if ( FRSM_CHECKWAKEUPREASONOFCLUSTERCONFIG == STD_ON )
        ...
        case FRSM_WU_DETECTED_ON_CHANNEL_B: /* PRQA S 2003 */  /* MD_FRSM_Rule16.3 */
        { /* DualCh initial WU XOR WU on ChB forward WuToChA */
...
#if (  ( FRSM_WAKEUPECUOFCLUSTERCONFIG == STD_ON ) && ( FRSM_STARTUP_WITHOUT_WAKEUP_POSSIBLE == STD_ON )  )
  else                    /* NO Wakeup ECU */
#endif
#if ( FRSM_STARTUP_WITHOUT_WAKEUP_POSSIBLE == STD_ON )
  {
    (void)FrIf_StartCommunication( FrSM_GetControllerIndexOfClusterConfig( FrSM_ClusterIndex ) );
    /* \trace SPEC-11007 */
...
#  if ( FRSM_DELAYSTARTUPWITHOUTWAKEUPOFCLUSTERCONFIG == STD_ON )
    if ( FrSM_IsDelayStartupWithoutWakeupOfClusterConfig( FrSM_ClusterIndex ) )   /* PRQA S 1881 */ /* MD_MSR_AutosarBoolean */  /* COV_FRSM_CONFIG_PARAMETER_BOOLEAN */
    {
...
#endif /* FRSM_STARTUP_WITHOUT_WAKEUP_POSSIBLE*/
...
#if ( FRSM_WAKEUP_ON_BOTH_CHANNELS_ALLOWED == STD_OFF )
# if ( FRSM_ENABLE_CONSECUTIVE_WUPOFCLUSTERCONFIG == STD_ON )
    if ( FrSM_GetNumWakeupPatternsOfClusterConfig( FrSM_ClusterIndex ) == 1u )   /* COV_FRSM_CONFIG_PARAMETER_CONST_NUMBER */
    {
# endif /* if ( FRSM_ENABLE_CONSECUTIVE_WUPOFCLUSTERCONFIG == STD_ON ) */
      /* T03a restart t1 for single channel with single WUP */
      if ( FrSM_GetFrChannelOfClusterConfig( FrSM_ClusterIndex ) != FR_CHANNEL_AB ) /* COV_FRSM_CONFIG_PARAMETER_DUAL_SINGLE_CHANNEL_NUM_WUP  */
      {
        FrSM_SetTimer_ColdstartDelayOfVarStruct( FrSM_ClusterIndex, FrSM_GetDurationT1OfClusterConfig( FrSM_ClusterIndex ) );   /* union FrSM_SetTimer_ColdstartDelayOfVarStruct FrSM_SetTrcvStbyDelay  */ /* SBSW_FRSM_ARRAY_WRITE_ACCESS */
      }
...
# if ( FRSM_WAKEUP_ON_BOTH_CHANNELS_ALLOWED == STD_OFF )
    ...
    else if ( FrSM_CurrentPocStatusWakeupStatus == FR_WAKEUP_TRANSMITTED ) 
...
# else  /* FRSM_WAKEUP_ON_BOTH_CHANNELS_ALLOWED  */
    ...
    if ( FrSM_CurrentPocStatusWakeupStatus == FR_WAKEUP_TRANSMITTED ) 
    {
      /* proceed initial DualChannelWakeup; if all WUP are triggered, TxWUP is evaluated and T03d will follow  */
    }
# endif /* FRSM_WAKEUP_ON_BOTH_CHANNELS_ALLOWED  */
    else if (  ( FrSM_CurrentPocStatusWakeupStatus == FR_WAKEUP_RECEIVED_HEADER ) || ( FrSM_CurrentPocStatusWakeupStatus == FR_WAKEUP_RECEIVED_WUP )  )
    ...
    /* FrSM_IsEnable_Consecutive_WupOfClusterConfig irrelevant, special case "==1" implicit correct, WakeUpPatternCounterOfVarStruct is already set to FRSM_MIN_WAKEUPPATTERNCOUNTEROFVARSTRUCT */
    if ( FrSM_GetWakeUpPatternCounterOfVarStruct( FrSM_ClusterIndex ) > FRSM_MIN_WAKEUPPATTERNCOUNTEROFVARSTRUCT ) 
    {
      (void)FrIf_SendWUP( FrSM_GetControllerIndexOfClusterConfig( FrSM_ClusterIndex ) );
      /* \trace SPEC-11007 */
...
#else
      FRSM_DUMMY_STATEMENT( FrSM_CurrentPocStatusWakeupStatus ); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
#endif /* if ( FRSM_ENABLE_CONSECUTIVE_WUPOFCLUSTERCONFIG == STD_ON ) */
    { /* T03[abcdef] */

#if ( FRSM_WAKEUP_ON_BOTH_CHANNELS_ALLOWED == STD_ON )
      /* Transition T03 (WAKEUP to STARTUP) resp. T03f */
      if (  (  FrSM_GetWakeUpTypeOfVarStruct( FrSM_ClusterIndex )  != FRSM_PERFORM_INITIAL_WAKEUP ) || ( FrSM_CurrentPocStatusWakeupStatus == FR_WAKEUP_TRANSMITTED )  ) 
      {
        ...
        if (  FrSM_GetWakeUpTypeOfVarStruct( FrSM_ClusterIndex )  == FRSM_PERFORM_INITIAL_WAKEUP )
...
#   if ( FRSM_TIMER_COLDSTARTDELAY_USED == STD_ON )
        ...
        if ( FrSM_GetWakeUpTypeOfVarStruct( FrSM_ClusterIndex ) != FRSM_PERFORM_STANDARD_WAKEUP ) /*   1 2; DualCh AND Partial WU on A or B  */ /* COV_FRSM_CONFIG_CHECKWAKEUP_NOT_POSSIBLE */
        { /* T03e */
          FrSM_SetTimer_ColdstartDelayOfVarStruct( FrSM_ClusterIndex, FRSM_COLDSTART_DELAY_TIMER_EXPIRED ); /* T04 armed to add CS for T03b resp. T03e */  /* union FrSM_SetTimer_ColdstartDelayOfVarStruct FrSM_SetTrcvStbyDelay  */ /* SBSW_FRSM_ARRAY_WRITE_ACCESS */
...
#if ( FRSM_WAKEUP_ON_BOTH_CHANNELS_ALLOWED == STD_ON )
      } /* Transition T03 (WAKEUP to STARTUP) */
      else
...
{ /* not FRSM_BSWM_READY  not FRSM_BSWM_WAKEUP  not FRSM_BSWM_HALT_REQ */
  ...
  {
    if (  ( FrSM_GetInternalStateOfVarStruct( FrSM_ClusterIndex ) == FRSM_BSWM_ONLINE ) || ( FrSM_GetInternalStateOfVarStruct( FrSM_ClusterIndex )  == FRSM_BSWM_KEYSLOT_ONLY )  )  /* COV_FRSM_CONFIG_PARAMETER_SLOT_MODE_KEY_SLOT */
    { /* T16a T16b */
  ...
  else if ( FrSM_CurrentPocStatusState == FR_POCSTATE_HALT )
  {
    ...
    if (  ( FrSM_GetInternalStateOfVarStruct( FrSM_ClusterIndex ) == FRSM_BSWM_ONLINE ) || ( FrSM_GetInternalStateOfVarStruct( FrSM_ClusterIndex )  == FRSM_BSWM_KEYSLOT_ONLY )  ) /* COV_FRSM_CONFIG_PARAMETER_COMBINATION_3 */
...
# endif /* FRSM_CHECKWAKEUPREASONOFCLUSTERCONFIG  */
         ) /*  COV_FRSM_CONFIG_PARAMETER_COMBINATION_2 */
      { /* * T20a T20b T20c */
...
# endif /* if ( FRSM_ENABLE_CONSECUTIVE_WUPOFCLUSTERCONFIG == STD_ON ) */
  ...
  if (  ( FrSM_GetInternalStateOfVarStruct( FrSM_ClusterIndex ) == FRSM_BSWM_KEYSLOT_ONLY ) && ( FrSM_CurrentPocStatusSlotMode == FR_SLOTMODE_ALL )  )/* */ /* */ /* COV_FRSM_CONFIG_PARAMETER_SLOT_MODE */
  ...
  else  /* else if ( FRSM_IsInitialized == true ) */
  {
    ...
    if ( FrSM_GetInternalStateOfVarStruct( FrSM_ClusterIndex ) == FRSM_BSWM_HALT_REQ )
    {
      ...
      if ( FrIf_GetPOCStatus( FrSM_GetControllerIndexOfClusterConfig( FrSM_ClusterIndex ), &FrSM_CurrentPocStatus ) == E_OK )  /* SBSW_FRSM_FUNCTIONCALL_WITHPOINTERTOLOCALVARIABLE */
      {
        ...
        {  /* * T11 * */
          /*  Freeze handled equal as FR_POCSTATE_HALT */
#if ( FRSM_TRANSCEIVER_STANDBY_DELAYOFCLUSTERCONFIG == STD_ON )
    ...
    else if ( FrSM_GetRequestedComModeOfVarStruct( FrSM_ClusterIndex ) == COMM_FULL_COMMUNICATION )
    {
      ...
      else
      {
        ...
        SchM_Enter_FrSM_FRSM_EXCLUSIVE_AREA_0( ); /* FrSM_RequestComMode( NoCom ) T09 T12 T13 T14  interrupts  Main *  FRSM_STATE_ONLINE T10 T16 * T14 vs  FRSM_STATE_ONLINE_PASSIVE  T15 + T17  vs */
        if ( FrIf_GetPOCStatus( FrSM_GetControllerIndexOfClusterConfig( FrSM_ClusterIndex ), &FrSM_CurrentPocStatus ) == E_OK )  /* SBSW_FRSM_FUNCTIONCALL_WITHPOINTERTOLOCALVARIABLE */
        {
        ...
        SchM_Exit_FrSM_FRSM_EXCLUSIVE_AREA_0( ); /* FrSM_RequestComMode( NoCom ) T09 T12 T13 T14  interrupts  Main *  FRSM_STATE_ONLINE T10 T16 * T14 vs  FRSM_STATE_ONLINE_PASSIVE  T15 + T17  vs */
      ...
      { /* FrSM_PriorState = FRSM_CurrentStateOfVarStruct; */
        BswM_FrSM_CurrentState(  FrSM_GetNetworkHandleOfClusterConfig( FrSM_ClusterIndex ), (FrSM_BswM_StateType)( FrSM_GetInternalStateOfVarStruct( FrSM_ClusterIndex ) + (uint8)FrSM_EcuPassiveMode ) );  /* PRQA S 2985, 2986 */ /*  MD_FRSM_Rule2.2 */
        /* \trace  SPEC-11009 */
      }
...
#else
  FRSM_DUMMY_STATEMENT( FrSM_DetErrorId );  /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
...
# endif /* end #if ( FRSM_TRCV_HANDLINGOFCLUSTERCONFIG == STD_ON ) */
  ...
  FRSM_DUMMY_STATEMENT_CONST( ConfigPtr );  /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
#endif /* FRSM_USE_INIT_POINTER  */
...
{
  /* \trace SPEC-10997 */
  Std_ReturnType            FrSM_StdReturnValue = E_NOT_OK;  /* PRQA S 2981 */ /* MD_MSR_RetVal */
  /* \trace SPEC-11003 */
  uint8                     FrSM_DetErrorId     = FRSM_E_NO_ERROR;
...
#else
  FRSM_DUMMY_STATEMENT( FrSM_DetErrorId );  /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
  FRSM_DUMMY_STATEMENT( NetworkHandle );   /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
#endif /* end   FRSM_DEV_ERROR_REPORT */
...
FUNC( Std_ReturnType, FRSM_CODE ) FrSM_GetCurrentComMode( NetworkHandleType NetworkHandle, P2VAR( ComM_ModeType, AUTOMATIC, FRSM_APPL_VAR ) ComM_ModePtr )
{
...
#endif /* FRSM_DEV_ERROR_DETECT  */
  {
    ...
    { /* FRSM_E_NO_ERROR */
      ...
      if ( FrSM_GetInternalStateOfVarStruct( FrSM_ClusterIndex ) == FRSM_BSWM_ONLINE )
      {
        *ComM_ModePtr = COMM_FULL_COMMUNICATION;   /* CREQ-105685 */  /* SBSW_FRSM_GETCURRENTCOMMODE_POINTERWRITEACCESS */
        /* \trace SPEC-10957 */
      }
      else                        /* NOT FULL communication */
      {
        *ComM_ModePtr = COMM_NO_COMMUNICATION;   /* CREQ-105686 */  /* SBSW_FRSM_GETCURRENTCOMMODE_POINTERWRITEACCESS */
        /* \trace SPEC-10957 */
      }
    } /* NetworkHandle index in list ==> NetworkHandle valid */
  } /* FRSM_E_NO_ERROR */
    ...
    if ( FrSM_EcuPassiveMode != FrSM_Passive )
    {
      ...
      for ( FrSM_ClusterIndex = 0; FrSM_ClusterIndex < FrSM_GetSizeOfVarStruct( ); FrSM_ClusterIndex ++ ) /* lint +e442 +e440 */
      {
        if ( FrSM_IsTrcv_HandlingOfClusterConfig( FrSM_ClusterIndex ) )  /* COV_FRSM_CONFIG_PARAMETER_BOOLEAN */
        {
          ...
          SchM_Enter_FrSM_FRSM_EXCLUSIVE_AREA_3( );  /* FrSM_Mainfunction * T01 T02   interrupts FrSM_SetEcuPassive T01 T02 */
          ...
          SchM_Exit_FrSM_FRSM_EXCLUSIVE_AREA_3( );   /* FrSM_Mainfunction * T01 T02   interrupts FrSM_SetEcuPassive T01 T02 */
...
# else  /* else #if ( FRSM_TRCV_HANDLINGOFCLUSTERCONFIG == STD_ON ) */
    FRSM_DUMMY_STATEMENT( FrSM_Passive ); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
 ...
 * 
 * MD_FRSM_Rule2.2
 * Reason:     The variable is set to the neutral element if not used to improve readability and avoid excessive PreProcesor statements in the code.
 * Risk:       Wrong state is reported to BswM
 * Prevention: Covered by code review.
 * MD_FRSM_Rule8.9
 * Reason:     The actual function pointer value is generated. So the declaration has to stay in the gererated c file.
 * Risk:       The element might be used outside of that translation unit.
 * Prevention: Covered by code review.
 * MD_FRSM_Rule16.3
 * Reason:     Intentional switch case without break statement to proceed the next step immediately. Used for code optimizations.
 * Risk:       There is a risk that a fall through is overseen.
 * Prevention: Fall through is marked with explicit comments to draw attention. Covered by code review.
 *
*/
...
/* START_COVERAGE_JUSTIFICATION
   ...
   \ACCEPT TX
   \ACCEPT XX
   \REASON Variable type limit not reachable with automate test framework. Correctness is checked by review.
