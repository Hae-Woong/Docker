...
# if (  (FRIF_CFG_MAJOR_VERSION != (4u)) \
     || (FRIF_CFG_MINOR_VERSION != (5u)) )
#  error "Version numbers of FrIf_Priv.h and FrIf_Cfg.h are inconsistent"
# endif
...
# define FRIF_PRIV_MINOR_VERSION              (5u)
# define FRIF_PRIV_PATCH_VERSION              (0u)
...
# else
#  define GET_TRANSCEIVER_INDEX(CtrlIdx, ChnlIdx)   ((2u * (CtrlIdx)) + (ChnlIdx))
# endif
...
# else
#  define FRIF_IS_INITIALIZED()        (NULL_PTR != FrIf_Status[0].pConfigData)
...
# define FrIf_GetGdCycleInNanoSeconds(ClstIdx)          FrIf_GetCfgClstElemC(GdCycleInNanoSeconds, ClstIdx)
