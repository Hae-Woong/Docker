 ...
 *                                              of FrIf_Cbk_WakeupByTransceiver should be removed
 ...
 -            2009-07-17  ore     -             Add compiler abstraction modifier <MSN>_PBCFG_GLOBALROOT
 ...
 -            2009-11-03  ore     ESCAN00038930 The revision history of all source and header files shall contain all implementation relevant ClearQuest issues of the FrIf.
 ...
 -            2011-05-04  ore     ESCAN00050585 [ASR3.2.1] Trcv APIs shall use 'Fr_ChannelType FrIf_ChnlIdx' in their signature instead of 'uint8 FrIf_ChnlIDx'
 ...
 -  03.08.02  2011-09-29  ore     ESCAN00053923 Compiler error is thrown because FrTrcv_SetTransceiverMode symbol is undefined when using "Wrapper APIs as Macro"
 ...
 -            2012-09-18  ore     ESCAN00061399 The FrIf_GetMacroticksPerCycle() and FrIf_GetMacroticksDuration() API services are missing in AUTOSAR4 use case
 ...
 -            2013-10-10  ore     ESCAN00071035 Compiler warning: warning C4255: 'FrIf_GetMacroticksPerCycle' : no function prototype given: converting '()' to '(void)'
 ...
 -  05.01.02  2017-10-04  ath     ESCAN00095968 C4189: 'JobDataPtr' : local variable is initialized but not referenced
 -  05.01.03  2018-05-02  ath     ESCAN00099203 Fixed return type of FrIf_PrepareTxPdus
 -  05.02.00  2019-04-04  ath     STORYC-5183   MISRA-C:2012 Compliance
 -  05.03.00  2020-06-23  ore     SWAT-1001     Reintroduce FrIf_GetTxConflictStatus
 -  05.04.00  2021-03-19  ore     SWAT-1211     [FrIf] Allow more than one PDU in frames configured with dynamic length
 -  05.05.00  2021-10-29  ore     SWAT-1768     FrIf: Usage of <Mip>_MemMap
 -            2022-02-07  ore     ESCAN00111200 FrIf_GetCycleLength doesn't return the configured cycle length (FrIfGdCycle)
 *********************************************************************************************************************/
...
# define FRIF_SW_MINOR_VERSION                    (5u)
...
# define FRIF_SID_GET_TX_CONFLICT_STATUS            (uint8)0x44u /**< FrIf_GetTxConflictStatus() service ID */
 ...
 * \ingroup      StateH
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_SetState(FRIF_VCLST_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      StateH
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_GetState(FRIF_VCLST_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      Generic
 *********************************************************************************************************************/
     extern FUNC(uint16, FRIF_CODE) FrIf_GetMacroticksPerCycle(FRIF_VCTRL_ONLY); /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      Generic
 *********************************************************************************************************************/
     extern FUNC(uint16, FRIF_CODE) FrIf_GetMacrotickDuration(FRIF_VCTRL_ONLY); /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      ComC
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE)FrIf_GetNumOfStartupFrames(FRIF_VCTRL_FIRST  /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      ComC
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE)FrIf_AllSlots(FRIF_VCTRL_ONLY); /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      Wakeup
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE)FrIf_GetWakeupRxStatus (FRIF_VCTRL_FIRST  /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      Generic
 *********************************************************************************************************************/
     extern FUNC(uint32, FRIF_CODE) FrIf_GetCycleLength(FRIF_VCTRL_ONLY); /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      ComC
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_ControllerInit(FRIF_VCTRL_ONLY); /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      ComC
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_StartCommunication(FRIF_VCTRL_ONLY); /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      ComC
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_HaltCommunication(FRIF_VCTRL_ONLY); /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      ComC
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_AbortCommunication(FRIF_VCTRL_ONLY); /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
#  endif
 ...
 * \ingroup      Wakeup
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_SendWUP(FRIF_VCTRL_ONLY); /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      Wakeup
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_SetWakeupChannel(FRIF_VCTRL_FIRST Fr_ChannelType  FrIf_ChnlIdx); /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      ComC
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_AllowColdstart(FRIF_VCTRL_ONLY); /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      CCS
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_GetPOCStatus(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      CCS
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_GetChannelStatus(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      CCS
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_GetClockCorrection(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      CCS
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_GetNmVector(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      CCS
 *********************************************************************************************************************/
    extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_ReadCCConfig(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      CCS
 *********************************************************************************************************************/
      extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_GetSyncFrameList(FRIF_VCTRL_FIRST  /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
                                                  uint8 FrIf_ListSize,
 ...
 * \ingroup      FrR
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_ReconfigLPdu(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
                                                  uint16 FrIf_LPduIdx,
                                                  uint16 FrIf_FrameId,
 ...
 * \ingroup      FrR
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_DisableLPdu(FRIF_VCTRL_FIRST uint16 FrIf_LPduIdx); /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      CCS
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_GetGlobalTime(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      AbsT
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_SetAbsoluteTimer(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      AbsT
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_CancelAbsoluteTimer(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
                                                               uint8 FrIf_AbsTimerIdx);
 ...
 * \ingroup      AbsT
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_EnableAbsoluteTimerIRQ(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
                                                                  uint8 FrIf_AbsTimerIdx);
 ...
 * \ingroup      AbsT
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_AckAbsoluteTimerIRQ(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
                                                               uint8 FrIf_AbsTimerIdx);
 ...
 * \ingroup      AbsT
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_DisableAbsoluteTimerIRQ(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
                                                                   uint8 FrIf_AbsTimerIdx);
 ...
 * \ingroup      AbsT
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_GetAbsoluteTimerIRQStatus(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
                                                      uint8 FrIf_AbsTimerIdx,
                                                      P2VAR(boolean, AUTOMATIC, FRIF_APPL_DATA) FrIf_IRQStatusPtr);
#  endif /* (FRIF_ABSOLUTE_TIMER_API_DISABLE == STD_OFF) */

#  if ( FRIF_TX_CONFLICT_STATUS_ENABLE == STD_ON )
/**********************************************************************************************************************
  FrIf_GetTxConflictStatus
**********************************************************************************************************************/
/*!
 *
 * \brief        Retrieves the TX conflict state of a given LPDU.
 * \details      Wraps the FlexRay Driver API function Fr_GetTxConflictStatus.
 * \param[in]    FrIf_CtrlIdx          Index of the FlexRay CC to address.
 *                                     This parameter exists only if FRIF_CTRL_ENABLE_API_OPTIMIZATION = STD_OFF.
 * \param[in]    FrIf_LPduIdx          Index of the FlexRay frame which TX status is to be determined.
 * \param[out]   FrIf_TxConflictStatusPtr Address where the TxConflict status information shall be stored.
 ...
 * \reentrant    FALSE
 * \synchronous  TRUE
 * \config       Available only if FRIF_TX_CONFLICT_STATUS_ENABLE == STD_ON.
 * \ingroup      CCS
 *********************************************************************************************************************/
FUNC(Std_ReturnType, FRIF_CODE) FrIf_GetTxConflictStatus(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
                                                      uint16 FrIf_LPduIdx,
                                                      P2VAR(Fr_TxConflictStatusType, AUTOMATIC, FRIF_APPL_DATA) FrIf_TxConflictStatusPtr);
#  endif /* ( FRIF_TX_CONFLICT_STATUS_ENABLE == STD_ON ) */
 ...
 * \ingroup      Trcv
 *********************************************************************************************************************/
     FUNC(Std_ReturnType, FRIF_CODE) FrIf_SetTransceiverMode(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
                                                              Fr_ChannelType FrIf_ChnlIdx, 
 ...
 * \ingroup      Trcv
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_GetTransceiverMode(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
                                             Fr_ChannelType FrIf_ChnlIdx,
 ...
 * \ingroup      Trcv
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_GetTransceiverWUReason(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
                                     Fr_ChannelType FrIf_ChnlIdx, 
 ...
 * \ingroup      Trcv
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_EnableTransceiverBranch(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */	
                                                            Fr_ChannelType FrIf_ChnlIdx,
 ...
 * \ingroup      Trcv
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_DisableTransceiverBranch(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
                                                             Fr_ChannelType FrIf_ChnlIdx,
                                                             uint8          FrIf_BranchIdx);
 ...
 * \ingroup      Trcv
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_ClearTransceiverWakeup(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
                                                                  Fr_ChannelType FrIf_ChnlIdx);
 ...
 * \ingroup      Trcv
 *********************************************************************************************************************/
     extern FUNC(Std_ReturnType, FRIF_CODE) FrIf_GetTransceiverError(FRIF_VCTRL_FIRST /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
                                                           Fr_ChannelType FrIf_ChnlIdx,
                                                           uint8 FrIf_BranchIdx,
...
#  define FrIf_GetCycleLength(CtrlIdx)                                                    (uint32)(FrIf_GetGdCycleInNanoSeconds(CtrlIdx))
...
#  if (FRIF_TX_CONFLICT_STATUS_ENABLE == STD_ON)
#   define FrIf_GetTxConflictStatus(CtrlIdx, FrIf_LPduIdx, FrIf_TxConflictStatusPtr)      Fr_GetTxConflictStatus(CtrlIdx, FrIf_LPduIdx, FrIf_TxConflictStatusPtr)
#  endif /* (FRIF_TX_CONFLICT_STATUS_ENABLE == STD_ON) */
...
#   if (FRIF_TX_CONFLICT_STATUS_ENABLE == STD_ON)
#    define FrIf_GetTxConflictStatus(FrIf_CtrlIdx, FrIf_LPduIdx, FrIf_TxConflictStatusPtr) FrIf_GetTxConflictStatus(FrIf_LPduIdx, FrIf_TxConflictStatusPtr)
#   endif /* (FRIF_TX_CONFLICT_STATUS_ENABLE == STD_ON) */
