...
# if (  (FRIF_EXT_MAJOR_VERSION != (5u)) \
     || (FRIF_EXT_MINOR_VERSION != (5u)) \
     || (FRIF_EXT_PATCH_VERSION != (0u)) )
 ...
 * \ingroup      Generic
 *********************************************************************************************************************/
FRIF_LOCAL FUNC(sint16_least, FRIF_CODE) FrIf_DiffTime(FRIF_VCLST_ONLY, sint16_least MacroTickDiff, sint16_least CycleDiff); /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
...
FRIF_LOCAL FUNC(void, FRIF_CODE)FrIf_ExecCurrentJob(FRIF_VCLST_ONLY)
{
  ...
  /* ----- Implementation ----------------------------------------------- */
  FrIf_Rtm_Start(FrIf_ExecCurrentJob_0);
  ...
  if(retVal == E_OK)
  {
    ...
    if((0 <= FrIf_Delay) && ((sint16_least)JobDataPtr->MaxDelay > FrIf_Delay))
    {
      ...
      {
        FrIf_Rtm_Start(FrIf_TxConfTask_0);
        FrIf_TxConfTask(FRIF_VCLST_OPT);
        FrIf_Rtm_Stop(FrIf_TxConfTask_0);
      }
      ...
      {
        FrIf_Rtm_Start(FrIf_RxTask_0);
        retVal = FrIf_RxTask(FRIF_VCLST_OPT);
        FrIf_Rtm_Stop(FrIf_RxTask_0);
      }
      else
      {
        FrIf_Rtm_Start(FrIf_TxTask_0);
        FrIf_TxTask(FRIF_VCLST_OPT);
        FrIf_Rtm_Stop(FrIf_TxTask_0);
      }
  ...
  FrIf_Rtm_Stop(FrIf_ExecCurrentJob_0);
...
{
  sint16_least tmpMacroTickDiff = MacroTickDiff;
  sint16_least tmpCycleDiff = CycleDiff;
  ...
  if(tmpMacroTickDiff < 0)
  {
    tmpCycleDiff -= 1;
    tmpMacroTickDiff = tmpMacroTickDiff + (sint16_least) FrIf_GetNumberOfMacroTicksPerCycle(FRIF_VCLST_IDX); /* ESCAN00066875 */
  }
  if(tmpCycleDiff > 0)
  {
    tmpMacroTickDiff = tmpMacroTickDiff + (sint16_least) FrIf_GetNumberOfMacroTicksPerCycle(FRIF_VCLST_IDX); /* ESCAN00066875 */
...
FRIF_LOCAL FUNC(void, FRIF_CODE)FrIf_EnableJobListExecution(FRIF_VCLST_ONLY)
{
  ...
  FrIf_InitializeTransmission(FRIF_VCLST_OPT); /* PRQA S 2987 */ /* MD_MSR_DummyStmt */

  /* #20 Enter FRIF_EXCLUSIVE_AREA_1. */
  SchM_Enter_FrIf_FRIF_EXCLUSIVE_AREA_1();
  ...
  if(retVal == E_OK)
  {
    ...
    /* PRQA S 4304, 4340 1 */ /* MD_MSR_AutosarBoolean */ 
    FrIf_Status[FRIF_VCLST_IDX].JobListExecutionEnabled = (uint8)TRUE;                            /* SBSW_FRIF_STATUS_WRT */
  ...
  SchM_Exit_FrIf_FRIF_EXCLUSIVE_AREA_1();
...
FRIF_LOCAL FUNC(void, FRIF_CODE) FrIf_DisableJobListExecution(FRIF_VCLST_ONLY)
{
  ...
  /* PRQA S 4304, 4340 1 */ /* MD_MSR_AutosarBoolean */ 
  FrIf_Status[FRIF_VCLST_IDX].JobListExecutionEnabled = (uint8)FALSE;                        /* SBSW_FRIF_STATUS_WRT */
...
FRIF_LOCAL FUNC(void, FRIF_CODE) FrIf_InitializeTransmission(FRIF_VCLST_ONLY)
{
...
#else
  for(i = FrIf_GetDirtyBitByteIdx((sint16_least)FrIf_GetMaxTxPduId(FRIF_VCLST_IDX)); i >= (sint16_least) 0; i--)
  {
  ...
  for(i = (sint16_least) FrIf_GetNumberOfTxRequestCounters(FRIF_VCLST_IDX) - 1; i >= (sint16_least) 0; i--)
  {
...
# endif /* !FrIf_IsPostbuild() */
    ...
    /* PRQA S 4304, 4340 1 */ /* MD_MSR_AutosarBoolean */ 
    FrIf_Status[FRIF_VCLST_IDX].JobListExecutionEnabled = (uint8)FALSE;                      /* SBSW_FRIF_STATUS_WRT */
    FrIf_InitializeTransmission();  /* PRQA S 2987 */ /* MD_MSR_DummyStmt */
# if (FRIF_DUALCHANNELREDUNDANCYSUPPORT == STD_ON)
...
# endif /* !FrIf_IsPostbuild() */
      ...
      FrIf_Status[i].State = FRIF_STATE_OFFLINE;                                             /* SBSW_FRIF_STATUS_WRT */
      /* PRQA S 4304, 4340 1 */ /* MD_MSR_AutosarBoolean */ 
      FrIf_Status[i].JobListExecutionEnabled = (uint8)FALSE;                                 /* SBSW_FRIF_STATUS_WRT */
                                             ...
                                             FrIf_StateTransitionType  FrIf_State)
{
  ...
  else if (FRIF_VCLST_IDX >= FrIf_GetNumberOfClusters()) /* COV_FRIF_CTRL_OPTIMIZATION */
  {
  ...
  /* #30 If the initial checks are passed or not required: */
  {
    ...
    if ((FrIf_State == FRIF_GOTO_ONLINE) && (FrIf_Status[FRIF_VCLST_IDX].State == FRIF_STATE_OFFLINE))
    {
      ...
      SchM_Enter_FrIf_FRIF_EXCLUSIVE_AREA_2();
       ...
       */
      if((boolean)FrIf_Status[FRIF_VCLST_IDX].JobListExecutionEnabled == TRUE) /* PRQA S 4304, 4340 */ /* MD_MSR_AutosarBoolean */ 
      {
      ...
      SchM_Exit_FrIf_FRIF_EXCLUSIVE_AREA_2();
    }
...
FUNC(uint16, FRIF_CODE) FrIf_GetMacroticksPerCycle(FRIF_VCTRL_ONLY)
{
  /* ----- Local Variables ---------------------------------------------- */
  uint8 errorId = FRIF_E_NO_ERROR;
  uint16 retVal = 0; /* PRQA S 2981 */ /* MD_MSR_RetVal */
...
#else
  FRIF_DUMMY_STATEMENT_CONST(FRIF_VCTRL_IDX); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
#endif
...
FUNC(void, FRIF_CODE) FrIf_MainFunction(FRIF_VCLST_ONLY)
{
  ...
  {    
    ...
    if ((retVal != E_OK) || ((2u < uint8CycleDiffTime) && (62u > uint8CycleDiffTime)))
    {
...
FUNC(void, FRIF_CODE) FrIf_JobListExec(FRIF_VCLST_ONLY)
{
  ...
  /* #20 If the initial check is passed or not required: */
  {
    FrIf_Rtm_Start(FrIf_JobListExec_0);
    ...
    if(FrIf_IsOnline(FRIF_VCLST_IDX))
    {
      ...
      FRIF_DUMMY_STATEMENT(JobDataPtr);  /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
    }
    FrIf_Rtm_Stop(FrIf_JobListExec_0);
  }
...
FUNC(uint32, FRIF_CODE) FrIf_GetCycleLength(FRIF_VCTRL_ONLY)
{
  /* ----- Local Variables ---------------------------------------------- */
  uint8 errorId = FRIF_E_NO_ERROR;
  uint32 retVal = 0; /* PRQA S 2981 */ /* MD_MSR_RetVal */
  ...
  /* #30 If the initial checks are passed or not required: */
  {
    ...
    retVal = FrIf_GetGdCycleInNanoSeconds(FRIF_VCTRL_IDX);
  }
...
FUNC(Std_ReturnType, FRIF_CODE) FrIf_StartCommunication(FRIF_VCTRL_ONLY)
{
  ...
  /* #30 If the initial checks are passed or not required: */
  {
    ...
    /* SPEC-29973 Dev: The FrIf and Fr controller indices are expected to be the same, so no index translation is required. */
...
FUNC(Std_ReturnType, FRIF_CODE) FrIf_HaltCommunication(FRIF_VCTRL_ONLY)
{
  ...
  /* SPEC-30199 Dev: The FrIf and Fr controller indices are expected to be the same, so no index translation is required. */
...
FUNC(Std_ReturnType, FRIF_CODE) FrIf_AbortCommunication(FRIF_VCTRL_ONLY)
{
  ...
  /* #30 If the initial checks are passed or not required: */
  {
    ...
    /* SPEC-29919 Dev: The FrIf and Fr controller indices are expected to be the same, so no index translation is required. */
...
FUNC(Std_ReturnType, FRIF_CODE) FrIf_SendWUP(FRIF_VCTRL_ONLY)
{
  ...
  /* #30 If the initial checks are passed or not required: */
  {
    ...
    /* SPEC-29983 Dev: The FrIf and Fr controller indices are expected to be the same, so no index translation is required. */
                                                      ...
                                                      Fr_ChannelType  FrIf_ChnlIdx)
{
  ...
  /* #40 If the initial checks are passed or not required: */
  {
    ...
    /* SPEC-29907 Dev: The FrIf and Fr controller indices are expected to be the same, so no index translation is required. */
...
FUNC(Std_ReturnType, FRIF_CODE) FrIf_AllowColdstart(FRIF_VCTRL_ONLY)
{
  ...
  /* #30 If the initial checks are passed or not required: */
  {
    ...
    /* SPEC-29848 Dev: The FrIf and Fr controller indices are expected to be the same, so no index translation is required. */
                                                  ...
                                                  P2VAR(Fr_POCStatusType, AUTOMATIC, FRIF_APPL_DATA) FrIf_POCStatusPtr)
{
  ...
  /* #30 If the initial checks are passed or not required: */
  {
    ...
    /* SPEC-29898 Dev: The FrIf and Fr controller indices are expected to be the same, so no index translation is required. */
...
{ 
  ...
  else if (FrIf_LPduIdx > (((uint16)FrIf_GetInvalidRxHandle(FRIF_VCTRL_IDX) + FrIf_GetInvalidTxHandle(FRIF_VCTRL_IDX)) - 1u))
  {
    errorId = FRIF_E_INV_LPDU_IDX;
  }
  /* #50 If required, check the validity of the FlexRay frame ID given as input. \trace SPEC-30129 */
  else if (FrIf_FrameId > 2047u)
  {
 ...
 *
 */
FUNC(Std_ReturnType, FRIF_CODE) FrIf_GetTxConflictStatus(FRIF_VCTRL_ONLY, 
                                                      uint16 FrIf_LPduIdx,
                                                      P2VAR(Fr_TxConflictStatusType, AUTOMATIC, FRIF_APPL_DATA) FrIf_TxConflictStatusPtr)
{
  ...
  /* #20 If required, check the validity of the FlexRay CC index given as input. */
  else if (FRIF_VCTRL_IDX >= FrIf_GetNumberOfControllers()) /* COV_FRIF_CTRL_OPTIMIZATION */
  {
    errorId = FRIF_E_INV_CTRL_IDX;
  }
  /* #30 If required, check the validity of the L-PDU index given as input. */
  else if (FrIf_LPduIdx > (((uint16)FrIf_GetInvalidRxHandle(FRIF_VCTRL_IDX) + FrIf_GetInvalidTxHandle(FRIF_VCTRL_IDX)) - 1u))
  {
    errorId = FRIF_E_INV_LPDU_IDX;
  }
  /* #40 If required, check the validity of the FrIf_TxConflictStatusPtr given as input. */
  else if (FrIf_TxConflictStatusPtr == NULL_PTR)
  {
    errorId = FRIF_E_INV_POINTER;
  }
  else
  ...
  /* #50 If the initial checks are passed or not required: */
  {
    /* #60 Call Fr_GetTxConflictStatus with the FrIf_TxConflictStatusPtr and CC index as arguments. */
    retVal = Fr_GetTxConflictStatus(FRIF_VCTRL_IDX, FrIf_LPduIdx, FrIf_TxConflictStatusPtr);              /* SBSW_FRIF_FCT_CALL_PTRFWD */
  }
  ...
  if (errorId != FRIF_E_NO_ERROR)
  {
    (void)Det_ReportError(FRIF_MODULE_ID, 0, FRIF_SID_GET_TX_CONFLICT_STATUS, errorId);
  }
#else
  FRIF_DUMMY_STATEMENT(errorId); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
#endif
...
# endif
/* ( FRIF_TX_CONFLICT_STATUS_ENABLE == STD_ON ) */
...
# endif 
    ...
    SchM_Enter_FrIf_FRIF_EXCLUSIVE_AREA_0();

    /* #50 Flag the FlexRay PDU as non-dirty. */
# if (FRIF_PDUDIRTYBYTE_USAGE == STD_ON)
    /* PRQA S 4304, 4340 1 */ /* MD_MSR_AutosarBoolean */ 
    FrIf_GetTxPduDirtyByte(FRIF_VCTRL_IDX, FrTxPduId) = (uint8)FALSE;                                 /* SBSW_FRIF_DIRTY_BYTES_WRT2 */
# else
...
# endif
    ...
    SchM_Exit_FrIf_FRIF_EXCLUSIVE_AREA_0();

    /* #80 For each FlexRay frame: */
    for (Handle = 0u; Handle < FrIf_GetInvalidTxHandle(FRIF_VCTRL_IDX); Handle++)
    {
      ...
      for(; PduNumber >= (sint16_least) 0; PduNumber--) 
      {
        ...
        if (    (FrTxPduId == TmpFrTxPduId) 
             && (FrIf_GetTxPduWasSentFlags(FRIF_VCTRL_IDX, Handle) != (uint8)FALSE)) /* PRQA S 4304, 4340 */ /* MD_MSR_AutosarBoolean */ 
        {
          retVal = Fr_CancelTxLPdu(FRIF_VCTRL_IDX, (uint16)Handle);
          /* PRQA S 4304, 4340 1 */ /* MD_MSR_AutosarBoolean */ 
          FrIf_GetTxPduWasSentFlags(FRIF_VCTRL_IDX, Handle) = (uint8)FALSE;                           /* SBSW_FRIF_SENT_FLAGS_RST2 */
          break;
        }
        FrameLayoutElIndex++;
      }
...
/* Justification for module-specific MISRA deviations:
 ...
 MD_FrIf_VotingFct:
   Reason:     The voting function expects a 'const PduInfoType * *' instead of a 'PduInfoType * *'
   Risk:       None.
   Prevention: None.
   
 MD_FrIf_IdentifierAsMacro:
   Reason:     Macros with the same name some identifiers are used to implement the single controler optimization.
   Risk:       The resulting code could be difficult to understand or may not work as expected.
   Prevention: Code review and testing of the single controller optimization.

  MD_FrIf_ExpressionAlwaysTrue:
...
\ID SBSW_FRIF_FCT_CALL_PTR2TXPDUDESC1
  \DESCRIPTION    Function call with a pointer to a Tx PDU descriptor. The Tx PDU descriptor is either a static link time array 
                  or is obtained from the postbuild struct.
