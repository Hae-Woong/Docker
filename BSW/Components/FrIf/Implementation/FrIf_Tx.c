 ...
 * \ingroup      TX
 *********************************************************************************************************************/
FRIF_LOCAL_INLINE FUNC(void, FRIF_CODE) FrIf_TxConfirmation(FRIF_VCLST_ONLY, /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup      TX
 *********************************************************************************************************************/
FRIF_LOCAL_INLINE FUNC(Std_ReturnType, FRIF_CODE) FrIf_IncrementTxReqCounter(FRIF_VCLST_ONLY,  /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
 ...
 * \ingroup        TX
 *********************************************************************************************************************/
FRIF_LOCAL_INLINE FUNC(Std_ReturnType, FRIF_CODE) FrIf_PrepareTxPdus(FRIF_VCLST_ONLY, /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
                                            FRIF_P2CONSTCFG(FrIf_FrameDescriptorType) FrameDescriptorPtr,
 ...
 * \ingroup        TX
 *********************************************************************************************************************/
FRIF_LOCAL_INLINE FUNC(Std_ReturnType, FRIF_CODE) FrIf_PrepareFrameBuffer(FRIF_VCLST_ONLY, /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
                                            FRIF_P2CONSTCFG(FrIf_FrameDescriptorType) FrameDescriptorPtr,
                                            P2VAR(uint8*, AUTOMATIC, FRIF_VAR_NOINIT) FrameBuffer,
                                            P2VAR(uint8_least, AUTOMATIC, FRIF_VAR_NOINIT) CurrentPos,
                                            P2VAR(FrIf_NumberOfPduType, AUTOMATIC, FRIF_VAR_NOINIT) PduUsage,
 ...
 * \ingroup      TX
 *********************************************************************************************************************/
FRIF_LOCAL_INLINE FUNC(void, FRIF_CODE) FrIf_TxRollback(FRIF_VCLST_ONLY, FRIF_P2CONSTCFG(FrIf_FrameDescriptorType) FrameDescriptorPtr, /* PRQA S 0784 */ /* MD_FrIf_IdentifierAsMacro */
                                            uint16 Handle);
                                            ...
                                            FRIF_P2CONSTCFG(FrIf_TxPduDescriptorType) TxPduDescriptorPtr)
{
  ...
  if((TxPduDescriptorPtr->PduConfig & FrIf_TxPduHasTxRequestCounter) == FrIf_TxPduHasTxRequestCounter)
  {
     ...
     */
    if(FrIf_GetTxPduTxRequestCounter(FRIF_VCLST_IDX, TxReqCounterIndex) == 0u)
    {
      FrIf_GetTxPduTxRequestCounter(FRIF_VCLST_IDX, TxReqCounterIndex)--;                          /* SBSW_FRIF_REQUEST_COUNTER_WRT1 */
      retVal = E_NOT_OK;
    }
...
#else
  FRIF_DUMMY_STATEMENT(TxPduDescriptorPtr); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
  FRIF_DUMMY_STATEMENT(FRIF_VCLST_IDX); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
#endif
  return retVal;
} /* FrIf_IncrementTxReqCounter() */
...
{
  /* ----- Local Variables ---------------------------------------------- */
  FrIf_NumberOfPduType FrameLayoutElIndex = FrameDescriptorPtr->FirstFrameLayoutElementHandle;
  FrIf_NumberOfPduType PduUsage = FrIf_GetTxPduWasSentFlags(FRIF_VCLST_IDX, Handle); /* Flag of the last PDU-in-frame in LSB */
  FrIf_NumberOfPduType FrIf_Mask = 1u << (FrameDescriptorPtr->NumberOfPdus - 1u); /* Start from the MSB */
  uint16_least i;

  /* ----- Implementation ----------------------------------------------- */
  /* #10 Flag all the PDUs-in-frame as non-sent. */
  FrIf_GetTxPduWasSentFlags(FRIF_VCLST_IDX, Handle) = 0u;                               /* SBSW_FRIF_SENT_FLAGS_WRT1 */
   ...
   */
  for(i = 0; i < FrameDescriptorPtr->NumberOfPdus; i++)
  {
    FRIF_P2CONSTCFG(FrIf_TxPduDescriptorType) TxPduDescriptorPtr = 
    ...
    if (((PduUsage & FrIf_Mask) != 0u) && ((TxPduDescriptorPtr->PduConfig & FrIf_TxPduIsTxConfirmation) == FrIf_TxPduIsTxConfirmation))
    {
                             ...
                             uint16 Handle)
{
  ...
  for(; PduNumber >= (sint16_least) 0; PduNumber--)
  {
    ...
    *PduUsage <<= 1u;                                                                 /* SBSW_FRIF_PTR_WRT_UNCHANGED */
    ...
    /* PRQA S 4304, 4340, 4394 5 */ /* MD_MSR_AutosarBoolean */ 
#if (FRIF_PDUDIRTYBYTE_USAGE == STD_ON)
    PduIsDirty = (boolean) FrIf_GetTxPduDirtyByte(FRIF_VCLST_IDX, FrTxPduId);
#else
 ...
 *
       */
      if ((0u < FrIf_GetTxPduTxRequestCounter(FRIF_VCLST_IDX, TxReqCounterIndex)) && (FrIf_GetTxPduWasSentFlags(FRIF_VCLST_IDX, Handle) == 0u))
      {
    ...
    if((PduIsDirty != FALSE) || ((txPduConfig & FrIf_TxPduIsTransmitAlways) == FrIf_TxPduIsTransmitAlways)) /* PRQA S 2995, 2996  */ /* MD_MSR_ConstantCondition */
    {
      ...
      {
        VStdLib_MemSet(&(*FrameBuffer)[*CurrentPos], /* PRQA S 0314, 0315, 2823 */ /* MD_MSR_VStdLibCopy, MD_MSR_MacroArgumentEmpty */ /* SBSW_FRIF_FCT_CALL_FILLFRAME1 */
                       FRIF_FILL_PATTERN,
      ...
      FrIf_GetTxPduDirtyByte(FRIF_VCLST_IDX, FrTxPduId) = (uint8)FALSE;                 /* SBSW_FRIF_DIRTY_BYTES_WRT1 */
#else
      SchM_Enter_FrIf_FRIF_EXCLUSIVE_AREA_0();
 ...
 *
 */
FRIF_LOCAL_INLINE FUNC(Std_ReturnType, FRIF_CODE) FrIf_PrepareFrameBuffer(FRIF_VCLST_ONLY,  /* PRQA S 3673 */ /* MD_FrIf_3673 */
                     FRIF_P2CONSTCFG(FrIf_FrameDescriptorType) FrameDescriptorPtr, 
                     P2VAR(uint8*, AUTOMATIC, FRIF_VAR_NOINIT) FrameBuffer, 
                     P2VAR(uint8_least, AUTOMATIC, FRIF_VAR_NOINIT) CurrentPos, 
                     P2VAR(FrIf_NumberOfPduType, AUTOMATIC, FRIF_VAR_NOINIT) PduUsage,
                     ...
                     uint8 txFrameConfig)
{
  ...
  /* #20 If a frame buffer is available: */
  {
    ...
    {
      /* PRQA S 2995, 2996  1 */ /* MD_MSR_ConstantCondition */
      if((boolean)(txFrameConfig & FrIf_FrameIsDynamicLSduLength) == FALSE) /* PRQA S 4304, 4340, 4394 */ /* MD_MSR_AutosarBoolean */ 
      {
        VStdLib_MemSet(&(*FrameBuffer)[*CurrentPos], /* PRQA S 0314, 0315, 2823 */ /* MD_MSR_VStdLibCopy, MD_MSR_MacroArgumentEmpty */ /* SBSW_FRIF_FCT_CALL_FILLFRAME2 */
                       FRIF_FILL_PATTERN,
...
{
  /* ----- Local Variables ---------------------------------------------- */
  FrIf_NumberOfPduType FrameLayoutElIndex = FrameDescriptorPtr->FirstFrameLayoutElementHandle + (FrameDescriptorPtr->NumberOfPdus - 1u);
  ...
  for(i = 0; i < FrameDescriptorPtr->NumberOfPdus; i++)
  {
    ...
    if((PduUsage & (uint16) 0x01) != (uint16) 0)
    {
      /* PRQA S 4304, 4340 5 */ /* MD_MSR_AutosarBoolean */ 
#if (FRIF_PDUDIRTYBYTE_USAGE == STD_ON)
      FrIf_GetTxPduDirtyByte(FRIF_VCLST_IDX, FrTxPduId) = (uint8)TRUE;                            /* SBSW_FRIF_DIRTY_BYTES_WRT1 */
#else
...
FUNC(void, FRIF_CODE) FrIf_TxConfTask(FRIF_VCLST_ONLY)
{
  ...
  for(; JobNumber <= MaxJobNumber; JobNumber++)
  {
    ...
    /* PRQA S 2995, 2996  1 */ /* MD_MSR_ConstantCondition */
    if((boolean)(JobDataPtr->JobConfig & FrIf_JobDataIsRxTask) == FALSE) /* PRQA S 4304, 4340, 4394 */ /* MD_MSR_AutosarBoolean */ 
    {
      ...
      for(; ColumnNumber <= MaxColumn; ColumnNumber++)
      {
        ...
        if (   (FrameDescriptorPtr != NULL_PTR)
            && ((boolean)FrIf_GetTxPduWasSentFlags(FRIF_VCLST_IDX, Handle) != FALSE) /* PRQA S 4304, 4340 */ /* MD_MSR_AutosarBoolean */ 
...
FUNC(void, FRIF_CODE) FrIf_TxTask(FRIF_VCLST_ONLY)
{
  ...
  for(; ColumnNumber <= MaxColumn; ColumnNumber++)
  {
    ...
    /* PRQA S 2995, 2996  1 */ /* MD_MSR_ConstantCondition */
    if ((boolean)(txFrameConfig & FrIf_FrameIsImmediateTx) == FALSE) /* PRQA S 4304, 4340, 4394 */ /* MD_MSR_AutosarBoolean */ 
    {
      ...
      FrameBuffer = (uint8*)FRIF_GET_FRAMEBUFFER(FRIF_VCLST_IDX);
      ...
      /* PRQA S 2991, 2995 1 */ /* MD_FrIf_ExpressionAlwaysTrue, MD_FrIf_OperationAlwaysTrue */
...
# if (FRIF_DIRECT_BUFFER_ACCESS_ENABLE == STD_ON)
            ...
            {
              VStdLib_MemCpy(FrameBuffer, FrameBufferToCopy, (uint8)(CurrentPos)); /* PRQA S 0315 */ /* MD_MSR_VStdLibCopy */ /* SBSW_FRIF_FCT_CALL_REDCOPY */
            }
...
} /* FrIf_TxTask() */ /* PRQA S 6030, 6080 */ /* MD_MSR_STCYC */ /* MD_MSR_STMIF */ 
                                              ...
                                              FRIF_P2CONSTAPPLDATA(PduInfoType) PduInfoPtr)
{
...
#endif
  {
    ...
    if (FrIf_IsOnline(FRIF_VCLST_IDX))
    {
       ...
       *       Request the transmission of the frame to the Fr, using the data from PduInfo as arguments. \trace SPEC-29965, SPEC-29966
      ...
      if((TxPduDescriptorPtr->PduConfig & FrIf_TxPduIsImmediateTx) == FrIf_TxPduIsImmediateTx)
      {
         ...
         */
        const uint16 Handle = (uint16)FrIf_GetTxFrameHandle(FRIF_VCLST_IDX, FrTxPduId);
      ...
      else
      {
        ...
        /* PRQA S 4304, 4340 5 */ /* MD_MSR_AutosarBoolean */ 
#if (FRIF_PDUDIRTYBYTE_USAGE == STD_ON)
        FrIf_GetTxPduDirtyByte(FRIF_VCLST_IDX, FrTxPduId) = (uint8)TRUE;                               /* SBSW_FRIF_DIRTY_BYTES_WRT2 */
#else
