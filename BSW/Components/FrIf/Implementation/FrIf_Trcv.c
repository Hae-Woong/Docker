...
# if (  (FRIF_CBK_MAJOR_VERSION != (5u)) \
     || (FRIF_CBK_MINOR_VERSION != (5u)) \
     || (FRIF_CBK_PATCH_VERSION != (0u)) )
                                                       ...
                                                       FrTrcv_TrcvModeType  FrIf_TrcvMode)
{
  ...
  /* #30 If required, check the validity of the FlexRay channel index given as input. \trace SPEC-30068 */
           ...
           || (FrIf_GetTransceiverMapIdx(GET_TRANSCEIVER_INDEX(FRIF_VCTRL_IDX, FrIf_ChnlIdx)) >= FrIf_NumberOfFrTrcvs) /* PRQA S 2986 */ /* MD_FrIf_RedundantOperation */
          )
  {
  ...
  /* #40 If the initial checks are passed or not required: */
  {
    ...
    if (FrTrcv_SetTransceiverMode(GET_TRANSCEIVER_INDEX(FRIF_VCTRL_IDX, FrIf_ChnlIdx), FrIf_TrcvMode) == BUSTRCV_E_OK) /* PRQA S 2986 */ /* MD_FrIf_RedundantOperation */ /* SBSW_FRIF_FCT_PTR_FRTRCVMAP */
    {
      retVal = E_OK;
    }
  }
                                            ...
                                            P2VAR(FrTrcv_TrcvModeType, AUTOMATIC, FRIF_APPL_DATA) FrIf_TrcvModePtr)
{
  ...
  /* #40 If the initial checks are passed or not required: */
  {
    ...
    if (FrTrcv_GetTransceiverMode(GET_TRANSCEIVER_INDEX(FRIF_VCTRL_IDX, FrIf_ChnlIdx), FrIf_TrcvModePtr) == BUSTRCV_E_OK ) /* PRQA S 2986 */ /* MD_FrIf_RedundantOperation */ /* SBSW_FRIF_FCT_PTR_FRTRCVMAP */
    {
      retVal = E_OK;
    }
  }
                                       ...
                                       P2VAR(FrTrcv_TrcvWUReasonType, AUTOMATIC, FRIF_APPL_DATA) FrIf_TrcvWUReasonPtr)
{
  ...
  /* #40 If the initial checks are passed or not required: */
  {
    ...
    if (FrTrcv_GetTransceiverWUReason(GET_TRANSCEIVER_INDEX(FRIF_VCTRL_IDX, FrIf_ChnlIdx), FrIf_TrcvWUReasonPtr) == BUSTRCV_E_OK ) /* PRQA S 2986 */ /* MD_FrIf_RedundantOperation */ /* SBSW_FRIF_FCT_PTR_FRTRCVMAP */
    {
      retVal = E_OK;
    }
  }
                                                            ...
                                                            uint8          FrIf_BranchIdx)
{
  ...
  /* #40 If the initial checks are passed or not required: */
  {
    ...
    if (FrTrcv_EnableTransceiverBranch(GET_TRANSCEIVER_INDEX(FRIF_VCTRL_IDX, FrIf_ChnlIdx), FrIf_BranchIdx) == BUSTRCV_E_OK ) /* PRQA S 2986 */ /* MD_FrIf_RedundantOperation */ /* SBSW_FRIF_FCT_PTR_FRTRCVMAP */
    {
      retVal = E_OK;
    }
  }
                                                             ...
                                                             uint8          FrIf_BranchIdx)
{
  ...
  /* #40 If the initial checks are passed or not required: */
  {
    ...
    if (FrTrcv_DisableTransceiverBranch(GET_TRANSCEIVER_INDEX(FRIF_VCTRL_IDX, FrIf_ChnlIdx), FrIf_BranchIdx) == BUSTRCV_E_OK ) /* PRQA S 2986 */ /* MD_FrIf_RedundantOperation */ /* SBSW_FRIF_FCT_PTR_FRTRCVMAP */
    {
      retVal = E_OK;
    }
  }
                                                           ...
                                                           Fr_ChannelType FrIf_ChnlIdx)
{
  ...
  /* #40 If the initial checks are passed or not required: */
  {
    ...
    if (FrTrcv_ClearTransceiverWakeup(GET_TRANSCEIVER_INDEX(FRIF_VCTRL_IDX, FrIf_ChnlIdx)) == BUSTRCV_E_OK ) /* PRQA S 2986 */ /* MD_FrIf_RedundantOperation */ /* SBSW_FRIF_FCT_PTR_FRTRCVMAP */
    {
      retVal = E_OK;
    }
  }
                                                           ...
                                                           P2VAR(uint32, AUTOMATIC, FRIF_APPL_DATA) FrIf_BusErrorState)
{
  ...
  /* #40 If the initial checks are passed or not required: */
  {
    ...
    if (FrTrcv_GetTransceiverError(GET_TRANSCEIVER_INDEX(FRIF_VCTRL_IDX, FrIf_ChnlIdx), FrIf_BranchIdx, FrIf_BusErrorState) == BUSTRCV_E_OK ) /* PRQA S 2986 */ /* MD_FrIf_RedundantOperation */ /* SBSW_FRIF_FCT_PTR_FRTRCVMAP */
    {
      retVal = E_OK;
    }
  }
                                                    ...
                                                    Fr_ChannelType FrIf_ChnlIdx )
{
  /* ----- Local Variables ---------------------------------------------- */
  uint8 errorId = FRIF_E_NO_ERROR;
  FRIF_DUMMY_STATEMENT(FrIf_CtrlIdx); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
  ...
  /* #40 If the initial checks are passed or not required: */
  {
    ...
    FrTrcv_CheckWakeupByTransceiver(GET_TRANSCEIVER_INDEX(FrIf_CtrlIdx, FrIf_ChnlIdx)); /* PRQA S 2986 */ /* MD_FrIf_RedundantOperation */ /* SBSW_FRIF_FCT_PTR_FRTRCVMAP */
  }
