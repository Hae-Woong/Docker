...
# 1.01.00   2007-06-20  Jsr     Added support of AUTOSAR FrIf
# 1.02.00   2008-10-01  Ore     ESCAN00030038
# 1.03.00   2010-07-06  Ore     Fixed CORE_PATH,OUTPUT_PATH and DEPENDENT_PLUGINS
# 1.04.00   2011-05-06  Ore     ESCAN00050586
# 2.00.00   2014-11-28  Ath     ESCAN00079883: Removed ExtSync.c and RelTimer.c
...
LIBRARIES_TO_BUILD      += FrIf
FrIf_FILES               = FrIf$(BSW_SRC_DIR)\FrIf.c FrIf$(BSW_SRC_DIR)\FrIf_AbsTimer.c FrIf$(BSW_SRC_DIR)\FrIf_Rx.c \
FrIf$(BSW_SRC_DIR)\FrIf_Time.c FrIf$(BSW_SRC_DIR)\FrIf_Trcv.c FrIf$(BSW_SRC_DIR)\FrIf_Tx.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += FrIf$(BSW_SRC_DIR)\FrIf.c
CC_FILES_TO_BUILD       += FrIf$(BSW_SRC_DIR)\FrIf_AbsTimer.c
CC_FILES_TO_BUILD       += FrIf$(BSW_SRC_DIR)\FrIf_Rx.c
CC_FILES_TO_BUILD       += FrIf$(BSW_SRC_DIR)\FrIf_Time.c
CC_FILES_TO_BUILD       += FrIf$(BSW_SRC_DIR)\FrIf_Trcv.c
CC_FILES_TO_BUILD       += FrIf$(BSW_SRC_DIR)\FrIf_Tx.c
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\FrIf_PBCfg.c $(GENDATA_DIR)\FrIf_LCfg.c
