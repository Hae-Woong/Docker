...
# 1.01.00   2008-02-14  HH      Added support of AUTOSAR DET
# 1.02.00   2008-04-30  fbg     Changes for ASR library support
# 1.03.00   2017-02-27  HH      Added Det_Cfg.c in file list
...
LIBRARIES_TO_BUILD      += Det
Det_FILES               = Det$(BSW_SRC_DIR)\Det.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Det$(BSW_SRC_DIR)\Det.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Det_Cfg.c
