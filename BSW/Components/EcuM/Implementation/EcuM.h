 ...
 * 10.00.01   2019-08-08  visvjn  ESCAN00102032 OsResources are not configurable for each EcuM Core
 * 10.00.02   2020-02-06  visols  ESCAN00105576 Wrong order of function calls in EcuM_GoDown in case of multicore configuration
 *            2020-04-30  visols  ESCAN00106260 Introduction of ECUM_EXCLUSIVE_AREA_3 to guard shutdown target and mode
 * 11.00.00   2020-12-02  visols  NMM-1060      Provide EcuM_StartupTwo according to ASR 4.3.1
 * 11.00.01   2021-01-21  visols  ESCAN00108355 Correct order of execution of SchM_Init and BswM_Init.
 * 12.00.00   2021-12-03  visols  NMM-1210      Use MemMap module
 * 13.00.00   2022-06-09  mbach   NMM-1486      Support of multiple communication channels for a single EcuM wakeup source
 * 14.00.00   2022-10-20  mbach   ESCAN00112932 An E_OS_CALLEVEL error is raised during the shutdown of the ECU
 * 14.00.01   2023-01-04  mbach   NMM-2598      Adapt CDD Traceability
 * 15.00.01   2024-02-09  visuca  ESCAN00116684 Getting unexpected OS Resource on enter sleep
 *            2024-02-12  visuca  NMM-3479      Update to QAC 2022.2
 *********************************************************************************************************************/
...
# define SYSSERVICE_ASR4ECUM_VERSION                                  0x1500u
# define SYSSERVICE_ASR4ECUM_RELEASE_VERSION                          0x01u
 ...
 *  \trace       CREQ-445
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ECUM_CODE) EcuM_SelectShutdownTarget /* PRQA S 3449, 3451 */ /* MD_EcuM_3449_3451 */
(
  VAR(EcuM_StateType, AUTOMATIC) targetState,
 ...
 *  \trace       CREQ-483
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ECUM_CODE) EcuM_GetShutdownTarget /* PRQA S 3449, 3451 */ /* MD_EcuM_3449_3451 */
(
 ...
 *  \trace       CREQ-522
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ECUM_CODE) EcuM_GetLastShutdownTarget /* PRQA S 3449, 3451 */ /* MD_EcuM_3449_3451 */
(
  P2VAR(EcuM_StateType, AUTOMATIC, ECUM_APPL_DATA) target,
  P2VAR(EcuM_ModeType, AUTOMATIC, ECUM_APPL_DATA) resetSleepMode
);
 ...
 *  \trace       CREQ-531
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ECUM_CODE) EcuM_SelectShutdownCause /* PRQA S 3449, 3451 */ /* MD_EcuM_3449_3451 */
(
  VAR(EcuM_ShutdownCauseType, AUTOMATIC) shutdownCause
);
 ...
 *  \trace       CREQ-438
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ECUM_CODE) EcuM_GetShutdownCause /* PRQA S 3449, 3451 */ /* MD_EcuM_3449_3451 */
(
 ...
 *  \trace       CREQ-492
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ECUM_CODE) EcuM_GetBootTarget /* PRQA S 3449, 3451 */ /* MD_EcuM_3449_3451 */
(
 ...
 *  \trace       CREQ-442
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ECUM_CODE) EcuM_SelectBootTarget /* PRQA S 3449, 3451 */ /* MD_EcuM_3449_3451 */
(
  VAR(EcuM_BootTargetType, AUTOMATIC) BootTarget
);
 ...
 *  \trace       DSGN-EcuM-AlarmClock
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ECUM_CODE) EcuM_SetRelWakeupAlarm /* PRQA S 3449, 3451 */ /* MD_EcuM_3449_3451 */
(
 ...
 *  \trace       DSGN-EcuM-AlarmClock
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ECUM_CODE) EcuM_SetAbsWakeupAlarm /* PRQA S 3449, 3451 */ /* MD_EcuM_3449_3451 */
(
  VAR(EcuM_UserType, AUTOMATIC) user, 
  VAR(EcuM_TimeType, AUTOMATIC) sec
);
 ...
 *  \trace       DSGN-EcuM-AlarmClock
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ECUM_CODE) EcuM_AbortWakeupAlarm /* PRQA S 3449, 3451 */ /* MD_EcuM_3449_3451 */
(
  VAR(EcuM_UserType, AUTOMATIC) user
);
 ...
 *  \trace       DSGN-EcuM-AlarmClock
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ECUM_CODE) EcuM_GetWakeupTime /* PRQA S 3449, 3451 */ /* MD_EcuM_3449_3451 */
(
  P2VAR(EcuM_TimeType, AUTOMATIC, ECUM_APPL_DATA) sec
);
 ...
 *  \trace       DSGN-EcuM-AlarmClock
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ECUM_CODE) EcuM_GetCurrentTime /* PRQA S 3449, 3451 */ /* MD_EcuM_3449_3451 */
(
  P2VAR(EcuM_TimeType, AUTOMATIC, ECUM_APPL_DATA) sec
);
 ...
 *  \trace       DSGN-EcuM-AlarmClock
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ECUM_CODE) EcuM_SetClock /* PRQA S 3449, 3451 */ /* MD_EcuM_3449_3451 */
(
  VAR(EcuM_UserType, AUTOMATIC) user, 
  VAR(EcuM_TimeType, AUTOMATIC) sec
);
 ...
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ECUM_CODE) EcuM_RequestRUN(EcuM_UserType User); /* PRQA S 3449, 3451 */ /* MD_EcuM_3449_3451 */
 ...
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ECUM_CODE) EcuM_ReleaseRUN(EcuM_UserType User); /* PRQA S 3449, 3451 */ /* MD_EcuM_3449_3451 */
 ...
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ECUM_CODE) EcuM_RequestPOST_RUN(EcuM_UserType User); /* PRQA S 3449, 3451 */ /* MD_EcuM_3449_3451 */
 ...
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ECUM_CODE) EcuM_ReleasePOST_RUN(EcuM_UserType User); /* PRQA S 3449, 3451 */ /* MD_EcuM_3449_3451 */
# endif
 ...
 * \endexclusivearea
 *
 * \exclusivearea ECUM_EXCLUSIVE_AREA_3
 * Ensures consistency of the current shutdown target and mode while modifying them.
 * \protects EcuM_CurrentShutdownTarget, EcuM_CurrentShutdownMode
 * \usedin EcuM_EnterSleep, EcuM_InternalEnterPollingMode, EcuM_Shutdown, EcuM_GetShutdownTarget,
           EcuM_GoToSelectedShutdownTarget, EcuM_Init, EcuM_GoDown
 * \exclude EcuM_EnterSleepOnSlave, EcuM_InternalEnterHaltMode, EcuM_Statemachine, EcuM_GoDown
            (No exclusive access for reading a single variable needed)
 * \length SHORT
 * \endexclusivearea
 */
/**********************************************************************************************************************
