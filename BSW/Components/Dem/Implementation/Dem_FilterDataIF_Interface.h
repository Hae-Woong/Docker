 ...
 *****************************************************************************/
/*!
 * \brief         Get the number of events matching the J1939 DTC filter.
 *
 * \details       Get the number of events matching the J1939 DTC filter.
 *
 * \param[in]     FilterId
 *                The filter to modify.
 *
 ...
 *
 * \details       Get the next ratio matching the filter set with 
 *                Dem_Client_FilterData_SetJ1939RatioFilter().
 *
 * \param[in]     FilterId
 *                The filter to modify.
 * \param[out]    FilterResult
 *                Pointer to receive the SPN, Numerator and 
 *                Denominator of the next matching ratio.
 *
 * \return        E_OK
 *                Matching element returned in FilterResult.
 * \return        DEM_NO_SUCH_ELEMENT
 ...
 *****************************************************************************/
/*!
 * \brief         Initialize a Ratio filter.
 *
 * \details       Initializes a Ratio filter based on the passed filter
 *                information.
 *
 * \param[in]     FilterId
 *                The filter to modify.
 ...
 *
 * \pre           J1939 readiness calculation is supported
 * \config        -
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
