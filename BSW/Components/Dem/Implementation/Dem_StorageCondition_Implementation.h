...
#include "Dem_MemMap.h"                                                                                                          /* PRQA S 5087 */ /* MD_MSR_19.1 */
 /*!
 * \defgroup Dem_StorageCondition_PrivateProperties Private Properties
 * \{
 */

 /* ****************************************************************************
 * Dem_GlobalDiagnostics_StorageCondition_IsStorageConditionSupported
 *****************************************************************************/
 /*!
...
{
  Dem_StorageCondition_Group_IdentifierType lStorageConditionGroup = DEM_STORAGECONDITION_NO_STORAGE_CONDITION_GROUP;
  if (EventId != DEM_EVENT_INVALID)
  {
# if (DEM_CFG_HAS_STORAGE_CONDITIONS == STD_ON)
    lStorageConditionGroup = Dem_Cfg_GetStorageConditionGroupTableIdxOfEventTable(EventId);
# endif
  }
  return lStorageConditionGroup;
}
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_StorageCondition_TestFulfilled
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_StorageCondition_SetActiveState
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_StorageCondition_Group_GetNotFulfilledCount
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_StorageCondition_Group_SetNotFulfilledCounter
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_StorageCondition_GetInitValue
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_StorageCondition_Group_IterExists
 *****************************************************************************/
/*!
 ...
 *
 * \return        TRUE
 *                Dem_GlobalDiagnostics_StorageCondition_Group_GetIter() will return a valid element
 *                on this iterator
 * \return        FALSE
 *                Dem_GlobalDiagnostics_StorageCondition_Group_GetIter() is undefined on this iterator
 *
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_StorageCondition_Group_GetIter
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_StorageCondition_Group_InitIter
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_StorageCondition_Group_NextIter
 *****************************************************************************/
/*!
...
#  endif
  {
    Dem_Cfg_SetStorageConditionFulfilled(StorageConditionID, ActiveStatus);                                                      /* PRQA S 2841 */ /* MD_DEM_Dir4.1_RunTimeCheckWriteOperation */ /* SBSW_DEM_ARRAY_WRITE_STORAGECONDITIONFULFILLED */
  }
# endif
}
...
{
  if (Dem_GlobalDiagnostics_StorageCondition_IsStorageConditionSupported() == TRUE)
  {
    ...
    for (lStorageConditionId = 0u;
      ...
      ++lStorageConditionId)
    {
      Dem_GlobalDiagnostics_StorageCondition_SetActiveState(lStorageConditionId, TRUE);
    }
    ...
    {
      Dem_GlobalDiagnostics_StorageCondition_Group_SetNotFulfilledCounter(lStorageConditionGroupCounter, 0u);
    }
  }
}
  ...
  )
{
  if (Dem_GlobalDiagnostics_StorageCondition_IsStorageConditionSupported() == TRUE)
  {
    ...
    for (lStorageCondition = 0u; lStorageCondition < Dem_GlobalDiagnostics_StorageCondition_GetGlobalCount(); ++lStorageCondition) /* PRQA S 2994 */ /* MD_DEM_2994 */
    {
      boolean lStorageConditionInitState;
      Dem_StorageCondition_Group_IterType lStorageConditionIter;

      lStorageConditionInitState = Dem_GlobalDiagnostics_StorageCondition_GetInitValue(lStorageCondition);

      if (lStorageConditionInitState == FALSE)
      {
        for (Dem_GlobalDiagnostics_StorageCondition_Group_InitIter(lStorageCondition, &lStorageConditionIter);                   /* SBSW_DEM_CALL_ITERATOR_POINTER */
          Dem_GlobalDiagnostics_StorageCondition_Group_IterExists(&lStorageConditionIter) == TRUE;                               /* SBSW_DEM_CALL_ITERATOR_POINTER */
          Dem_GlobalDiagnostics_StorageCondition_Group_NextIter(&lStorageConditionIter))                                         /* SBSW_DEM_CALL_ITERATOR_POINTER */
        {
          Dem_StorageCondition_Group_IdentifierType lStorageConditionGroup;

          lStorageConditionGroup = Dem_GlobalDiagnostics_StorageCondition_Group_GetIter(&lStorageConditionIter);                 /* SBSW_DEM_CALL_ITERATOR_POINTER */

          Dem_GlobalDiagnostics_StorageCondition_Group_SetNotFulfilledCounter(lStorageConditionGroup,
            (uint8)(Dem_GlobalDiagnostics_StorageCondition_Group_GetNotFulfilledCount(lStorageConditionGroup) + 1u));
        }
      }
      Dem_GlobalDiagnostics_StorageCondition_SetActiveState(lStorageCondition, lStorageConditionInitState);
    }
  }
...
{
  boolean lStorageConditionsSatisfied = TRUE;
  if (Dem_GlobalDiagnostics_StorageCondition_IsStorageConditionSupported() == TRUE)
  {
    if (StorageConditionGroupId != DEM_STORAGECONDITION_NO_STORAGE_CONDITION_GROUP)
    {
      if (Dem_GlobalDiagnostics_StorageCondition_Group_GetNotFulfilledCount(StorageConditionGroupId) > 0u)
      {
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_GlobalDiagnostics_StorageCondition_SetFulfilled(                                                                             /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONST(uint8, AUTOMATIC)  StorageConditionID
  )
{
  if (Dem_GlobalDiagnostics_StorageCondition_IsStorageConditionSupported() == TRUE)                                              /* COV_DEM_UNIT_ENTRY_CONFIGURATION_CHECK */
  {
    /* >>>> -------------------------------- Enter Critical Section: StateManager */
    Dem_EnterCritical_StateManager();

    if (Dem_GlobalDiagnostics_StorageCondition_TestFulfilled(StorageConditionID) == FALSE)
    {
      Dem_StorageCondition_Group_IterType lStorageConditionIter;
      for (Dem_GlobalDiagnostics_StorageCondition_Group_InitIter(StorageConditionID, &lStorageConditionIter);                    /* SBSW_DEM_CALL_ITERATOR_POINTER */
        Dem_GlobalDiagnostics_StorageCondition_Group_IterExists(&lStorageConditionIter) == TRUE;                                 /* SBSW_DEM_CALL_ITERATOR_POINTER */
        Dem_GlobalDiagnostics_StorageCondition_Group_NextIter(&lStorageConditionIter))                                           /* SBSW_DEM_CALL_ITERATOR_POINTER */
      {
        Dem_StorageCondition_Group_IdentifierType lStorageConditionGroup;
        ...
        if (Dem_GlobalDiagnostics_StorageCondition_Group_GetNotFulfilledCount(lStorageConditionGroup) > 0u)
        {
          Dem_GlobalDiagnostics_StorageCondition_Group_SetNotFulfilledCounter(lStorageConditionGroup,
            (uint8)(Dem_GlobalDiagnostics_StorageCondition_Group_GetNotFulfilledCount(lStorageConditionGroup) - 1u));
        }
      }
      Dem_GlobalDiagnostics_StorageCondition_SetActiveState(StorageConditionID, TRUE);
    }
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_GlobalDiagnostics_StorageCondition_ResetFulfilled(                                                                           /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONST(uint8, AUTOMATIC)  StorageConditionID
  )
{
  if (Dem_GlobalDiagnostics_StorageCondition_IsStorageConditionSupported() == TRUE)                                              /* COV_DEM_UNIT_ENTRY_CONFIGURATION_CHECK */
  {
    ...
    if (Dem_GlobalDiagnostics_StorageCondition_TestFulfilled(StorageConditionID) == TRUE)
    {
      Dem_StorageCondition_Group_IterType lStorageConditionIter;
      for (Dem_GlobalDiagnostics_StorageCondition_Group_InitIter(StorageConditionID, &lStorageConditionIter);                    /* SBSW_DEM_CALL_ITERATOR_POINTER */
        Dem_GlobalDiagnostics_StorageCondition_Group_IterExists(&lStorageConditionIter) == TRUE;                                 /* SBSW_DEM_CALL_ITERATOR_POINTER */ /* PRQA S 2994 */ /* MD_DEM_2994 */
        Dem_GlobalDiagnostics_StorageCondition_Group_NextIter(&lStorageConditionIter))                                           /* SBSW_DEM_CALL_ITERATOR_POINTER */
      {
        Dem_StorageCondition_Group_IdentifierType lStorageConditionGroup;
      ...
      Dem_GlobalDiagnostics_StorageCondition_SetActiveState(StorageConditionID, FALSE);
    }
