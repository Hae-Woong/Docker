...
#define DEM_SATELLITEDATA_PTOTIMER_STATUS    DEM_NBIT(DEM_SATELLITEDATA_PTOTIMER_SIZE, DEM_SATELLITEDATA_PTOTIMER_POS)  /*!< Bit mask for PTO timer status bit(s) */

#define DEM_SATELLITEDATA_CUSTOMTRIGGER_STATUS      DEM_NBIT(DEM_SATELLITEDATA_CUSTOMTRIGGER_STATUS_SIZE, DEM_SATELLITEDATA_CUSTOMTRIGGER_STATUS_POS)  /*!< Bit mask for custom triggered freeze frame status bit */
  ...
  )
{
  ...
  if ( (Dem_SatelliteData_IsSimilarConditionsEnabled() == TRUE)
    && (Dem_Cfg_IsEmissionObdSupportedInVariant() == TRUE) )                                                                     /* COV_DEM_ROBUSTNESS TF tf tx */
  {
...
{
  return (Dem_Memories_PrestorageMemory_QueueActionType)(SatelliteExtendedData.Data.SharedData & DEM_SATELLITEDATA_PRESTOREFF_STATUS);
}
  ...
  )
{
  ...
  lReturnValue.Data.SharedData = ((lReturnValue.Data.SharedData & ~DEM_SATELLITEDATA_PRESTOREFF_STATUS)
                                  | DEM_PRESTORAGEMEMORY_QUEUE_PRESTOREFF);
  return lReturnValue;
}
  ...
  )
{
  ...
  lReturnValue = SatelliteExtendedData;
  lReturnValue.Data.SharedData = ((lReturnValue.Data.SharedData & ~DEM_SATELLITEDATA_PRESTOREFF_STATUS)
                                 | DEM_PRESTORAGEMEMORY_QUEUE_CLEAR);
  return lReturnValue;
}
...
/* ****************************************************************************
 % Dem_SatelliteData_GetPtoTimerActionsQueued
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
{
  return (Dem_Pto_ActivationTimer_QueueActionType)(SatelliteExtendedData.Data.SharedData & DEM_SATELLITEDATA_PTOTIMER_STATUS);
}

/* ****************************************************************************
 % Dem_SatelliteData_QueuePtoTimerAction
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
  ...
  )
{
  Dem_SatelliteData_ExtendedDataType lReturnValue;                                                                               /* PRQA S 0759 */ /* MD_MSR_Union */
  lReturnValue = SatelliteExtendedData;
  lReturnValue.Data.SharedData = lReturnValue.Data.SharedData | DEM_PTO_ACTIVATIONTIMER_QUEUE_RESTART;
  return lReturnValue;
}

/* ****************************************************************************
 % Dem_SatelliteData_DequeuePtoTimerActions
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
  ...
  )
{
  Dem_SatelliteData_ExtendedDataType lReturnValue;                                                                               /* PRQA S 0759 */ /* MD_MSR_Union */
  lReturnValue = SatelliteExtendedData;
  lReturnValue.Data.SharedData = (lReturnValue.Data.SharedData & ~DEM_SATELLITEDATA_PTOTIMER_STATUS);
  return lReturnValue;
}

/* ****************************************************************************
 % Dem_SatelliteData_QueueCustomTriggerAction
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
  ...
  )
{
  Dem_SatelliteData_ExtendedDataType lReturnValue;                                                                               /* PRQA S 0759 */ /* MD_MSR_Union */
  lReturnValue = SatelliteExtendedData;
  lReturnValue.Data.SharedData = (lReturnValue.Data.SharedData | DEM_CUSTOMTRIGGERMEMORY_QUEUE_STOREFF);

  return lReturnValue;
}

/* ****************************************************************************
 % Dem_SatelliteData_GetCustomTriggerActionsQueued
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
{
  return (Dem_Memories_CustomTriggerMemory_QueueActionType)(SatelliteExtendedData.Data.SharedData & DEM_SATELLITEDATA_CUSTOMTRIGGER_STATUS);
}

/* ****************************************************************************
 % Dem_SatelliteData_DequeueCustomTriggerActions
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
  ...
  )
{
  Dem_SatelliteData_ExtendedDataType lReturnValue;                                                                               /* PRQA S 0759 */ /* MD_MSR_Union */
  lReturnValue = SatelliteExtendedData;
  lReturnValue.Data.SharedData = (lReturnValue.Data.SharedData & ~DEM_SATELLITEDATA_CUSTOMTRIGGER_STATUS);
  return lReturnValue;
}
