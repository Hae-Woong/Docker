...
#define DEM_FILTERDATA_FILTER_J1939RATIO         4u  /*!< A filter for Ratios was set up */
/*!
 * \}
 */
...
#define DEM_FILTERDATA_J1939FILTER_PERMANENT            (5U)  /*!< Filter permanent DTCs */
/*!
 * \}
 */
...
enum Dem_FilterData_DTCFilteringStrategy
{
  ...
  Dem_FilterData_FilterEventBased_ExtendedDataRecord  /*!< Non-ordered filtering by extended data record */
};
