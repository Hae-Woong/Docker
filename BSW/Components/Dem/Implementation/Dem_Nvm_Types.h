...
{
  Dem_Cfg_NvBlockIndexType BlockIndex;  /*!< Currently processed memory block */
  Dem_Cfg_NvBlockIndexType PendingCount;  /*!< Number of pending commits */
  uint8 CommitState;  /*!<State of current commit */
# if (DEM_CFG_CLEAR_NV_END_RESPONSE == STD_ON)
  Dem_Cfg_NvBlockIndexType PendingClearCount;  /*!< Number of pending cleared block commits */
