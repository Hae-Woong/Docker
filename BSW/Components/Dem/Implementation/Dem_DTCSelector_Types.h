...
#define DEM_DTCSELECTOR_GROUP_OBD_ALL_DTC        3u  /*!< WWHOBD or OBDonUDS or ZEVonUDS group All DTCs (emission system group) */
/*!
 * \}
 */
...
struct Dem_DTCSelector_DataType_s
{
  ...
  uint16                          MemoryId;       /*!< MemoryId the event or group belongs to */
...
typedef P2VAR(Dem_DTCSelector_DataType, TYPEDEF, DEM_VAR_NO_INIT) Dem_DTCSelector_DataPtrType;
