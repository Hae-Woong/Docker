...
#if (DEM_CFG_SUPPORT_DCM == STD_ON) && (DEM_CFG_DATA_MONITOR_ACTIVITY_DATA == STD_ON)
#include "Dcm_Types.h"
#endif
/* ------------------------------------------------------------------------- */
 ...
 *                0x04, 0x08 and 0x0C filter in chronological order
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_GetDTCStatusAvailabilityMask(                                                                                                /* PRQA S 3449, 3451 */ /* MD_DEM_8.5_multipleDeclarations, MD_DEM_8.5_declarationInMultipleFiles */
  uint8  ClientId,
 ...
 *
 * \details       Completely disables the storage of all events and
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPID01(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.5_declarationInMultipleFiles */
 ...
 * \brief         Provides the monitoring status since DTCs cleared
 *
 * \details       Provides the monitoring status since DTCs cleared
 *                Pointer to PIDF501value buffer. The buffer is returned as such:
 *                supported - 0 == FALSE; 1 == TRUE
 *                complete  - 0 == TRUE;  1 == FALSE
 *                Byte A
 *                  bit 0...6 - # of DTCs stored in this ECU
 *                  bit 7 - Malfunction Indicator Lamp (MIL) Status
 *                Byte B
 ...
 *                  bit 1 - Fuel System Monitoring supported
 *                  bit 2 - Comprehensive component Monitoring supported
 *                  bit 3 - Engine Cooling System Monitoring
 *                  bit 4 - Misfire Monitoring completed
 *                  bit 5 - Fuel System Monitoring completed
 *                  bit 6 - Comprehensive component Monitoring completed
 *                  bit 7 - Engine Cooling System Monitoring completed
 *                Byte C
 *                  bit 0 - Catalyst Monitoring supported
 *                  bit 1 - NMHC catalyst Monitoring supported
 *                  bit 2 - Heated catalyst Monitoring supported
 *                  bit 3 - NOx aftertreatment Monitoring supported
 *                  bit 4 - Catalyst Monitoring completed
 *                  bit 5 - NMHC catalyst Monitoring completed
 *                  bit 6 - Heated catalyst Monitoring completed
 *                  bit 7 - NOx aftertreatment Monitoring completed
 *                Byte D
 *                  bit 0 - Evaporative System Monitoring supported
 *                  bit 1 - Secondary air System Monitoring supported
 *                  bit 2 - Boost pressure System Monitoring supported
 *                  bit 3 - PM Filter Monitoring supported
 *                  bit 4 - Evaporative System Monitoring completed
 *                  bit 5 - Secondary air System Monitoring completed
 *                  bit 6 - Boost pressure System Monitoring completed
 *                  bit 7 - PM Filter Monitoring completed
 *                Byte E
 *                  bit 0 - Exhaust gas sensor Monitoring supported
 *                  bit 1 - Positive/Crankcase Ventilation (PCV) System Monitoring supported
 *                  bit 2 - EGR System Monitoring supported
 *                  bit 3 - Variable Valve Timing, Lift, and/or Control (VVT) System Monitoring supported
 *                  bit 4 - Exhaust gas sensor Monitoring completed
 *                  bit 5 - Positive/Crankcase Ventilation (PCV) System Monitoring completed
 *                  bit 6 - EGR System Monitoring completed
 *                  bit 7 - Variable Valve Timing, Lift, and/or Control (VVT) System Monitoring completed
 *                Byte F
 *                  bit 0 - Direct Ozone Reduction (DOR) System Monitoring supported
 *                  bit 1 - Cold Start Emission Reduction Strategy Monitoring supported
 *                  bit 2 - NOx Adsorber Monitoring supported
 *                  bit 3 - Other Emission Control or Source System Monitoring supported
 *                  bit 4 - Direct Ozone Reduction (DOR) System Monitoring completed
 *                  bit 5 - Cold Start Emission Reduction Strategy Monitoring completed
 *                  bit 6 - NOx Adsorber Monitoring completed
 *                  bit 7 - Other Emission Control or Source System Monitoring completed
 *
 * \param[out]    PIDF501value
 *                Buffer with size of six bytes to receive the PID data
 *
 * \return        E_OK
 *                PID F501 is provided successfully
 * \return        E_NOT_OK
 *                Operation failed. PID F501 can not be provided.
 *
 * \config        DEM_CFG_SUPPORT_DCM == STD_ON
 * \pre           -
 *
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPIDF501(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.5_declarationInMultipleFiles */
...
*****************************************************************************/
/*!
* \brief         Readout Monitor Activity Denominator (MAD).
*
* \details       Readout Monitor Activity Denominator (MAD).
*
* \param[in]     OpStatus
*                Unused parameter
*
* \param[in]     DataValueBuffer
*                Buffer containing the contents of the monitor activity denominator
* \param[in,out] DataValueBufferSize
*                In:  Maximal number of data bytes that can be written to the DataValueBuffer
*                Out: Number of written bytes
*
* \return        E_OK
*                Denominator value was returned
* \return        E_NOT_OK
*                Feature IUMPR is disabled
* \return        DEM_BUFFER_TOO_SMALL
*                Provided buffer size too small
*
* \config        (DEM_CFG_SUPPORT_DCM == STD_ON) 
*                && (DEM_CFG_DATA_MONITOR_ACTIVITY_DATA == STD_ON)
* \pre           -
*
* \context       TASK|ISR2, from the master partition only
* \synchronous   TRUE
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPID1C(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.5_declarationInMultipleFiles */
 ...
 *****************************************************************************/
/*!
 * \brief         Returns the distance travelled with malfunction active.
 *
 * \details       Returns the distance travelled with MIL on. In ZEVonUDS variant
 *                returns the distance travelled since any ZEVonUDS event was 
 *                confirmed. The value is latched at 0xFFFF
 *
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPID21(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.5_declarationInMultipleFiles */
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPID30(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.5_declarationInMultipleFiles */
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPID31(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.5_declarationInMultipleFiles */
 ...
 *                  bit 7 - reserved
 *                Byte C
 *                  bit 0 - Catalyst Monitoring / NMHC catalyst Monitoring enabled
 *                  bit 1 - Heated catalyst Monitoring / NOx aftertreatment Monitoring enabled
 *                  bit 2 - Evaporative System Monitoring / reserved enabled
 *                  bit 3 - Secondary air System Monitoring / Boost pressure System Monitoring enabled
 *                  bit 4 - reserved
 *                  bit 5 - Oxygen sensor Monitoring / Exhaust gas sensor Monitoring enabled
 *                  bit 6 - Oxygen sensor heater / PM Filter Monitoring Monitoring enabled
 *                  bit 7 - EGR System Monitoring enabled
 *                Byte D
 *                  bit 0 - Catalyst Monitoring / NMHC catalyst Monitoring completed
 *                  bit 1 - Heated catalyst Monitoring / NOx aftertreatment Monitoring completed
 *                  bit 2 - Evaporative System Monitoring / reserved completed
 ...
 * \return        E_NOT_OK *                Operation failed. PID41 can not be provided.
 *
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPID41(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.5_declarationInMultipleFiles */
 ...
 *****************************************************************************/
/*!
 * \brief         Returns the engine runtime with malfunction active.
 *
 * \details       Returns the engine runtime with Mil on. In ZEVonUDS variant
 *                it returns the engine runtime since any ZEVonUDS DTC was
 *                confirmed. The value is latched at 0xFFFF
 *
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPID4D(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.5_declarationInMultipleFiles */
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPID4E(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.5_declarationInMultipleFiles */
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPID91(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.5_declarationInMultipleFiles */
 ...
 *****************************************************************************/
/*!
 * \brief         Calculate the size of records matching the filter criteria.
 *
 * \details       Calculates the size of records matching the filter criteria.
 *
 * \param[in]     ClientId
 *                The client to query
 * \param[out]    NumberOfFilteredRecords
 ...
 *                The size in bytes of the filtered records.
 *
 * \return        E_OK
