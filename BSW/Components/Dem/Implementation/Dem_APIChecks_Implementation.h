...
/*!
 * \defgroup Dem_APIChecks_PrivateProperties Private Properties
 * \{
 */

/* ****************************************************************************
 * Dem_Infrastructure_APIChecks_GetEventKind
 *****************************************************************************/
/*!
 * \brief         Get the event kind
 *
 * \details       Get the event kind
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *                The EventId must be in range [1..Dem_Cfg_GlobalEventCount()[.
 *
 * \return        Unique identifier of the event kind (BSW or SWC)
 *
 * \pre           -
 *
 * \context       TASK|ISR2
...
)
{
  ...
  return (uint8)(Dem_Cfg_GetEventKindOfEventPrecompileDataTable(EventId));
}
...
#include "Dem_MemMap.h"                                                                                                          /* PRQA S 5087 */ /* MD_MSR_19.1 */
/*!
 * \addtogroup Dem_APIChecks_Properties
 * \{
 */
...
#include "Dem_MemMap.h"                                                                                                          /* PRQA S 5087 */ /* MD_MSR_19.1 */
/*!
 * \defgroup Dem_APIChecks_Private Private Methods
 * \{
 */
...
#include "Dem_MemMap.h"                                                                                                          /* PRQA S 5087 */ /* MD_MSR_19.1 */
/*!
 * \addtogroup Dem_APIChecks_Private
 * \{
 */
 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Infrastructure_APIChecks_TestEventKind(                                                                                      /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_EventIdType EventId,
  uint8 EventKind
)
{
  return Dem_Error_DetectionHandler(Dem_Infrastructure_APIChecks_GetEventKind(EventId) == EventKind);
}
...
{
  return Dem_Error_DetectionHandler(Dem_Memories_EventMemory_TestDTCOriginValid(DTCOrigin));
}
...
{
  return Dem_Error_DetectionHandler(!Dem_Event_IsSlaveEvent(EventId));
}
...
{
  return Dem_Error_DetectionHandler(Dem_Satellite_CheckEventApplicationIdEqualsMaster(EventId));
}
...
{
  return Dem_Error_DetectionHandler(Dem_Cfg_IsEmissionObdSupportedInVariant());
}
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_APIChecks_IsObdOnUdsSupportedInVariant(                                                                                      /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  void
)
{
  return Dem_Error_DetectionHandler(Dem_Cfg_IsObdOnUdsSupportedInVariant());
}
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_APIChecks_IsObdIIOrObdOnUdsSupportedInVariant(                                                                               /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  void
)
{
  return Dem_Error_DetectionHandler(Dem_Cfg_IsObdIIOrObdOnUdsSupportedInVariant());
}
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_APIChecks_IsOBDIILegislationEnabledInVariant(                                                                                /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  void
)
{
  return Dem_Error_DetectionHandler(Dem_Cfg_IsObdIIExclusivelySupportedInVariant());
}
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Infrastructure_APIChecks_TestObdSupportedInVariant(                                                                          /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  void
)
{
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_APIChecks_IsDTCFormatAllowedWithFilter(                                                                                      /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
...
{
  return Dem_Error_DetectionHandler(
    Dem_Client_FilterData_IsDTCFormatAllowed(DTCFormat, DTCOrigin, FilterWithSeverity, FilterForFDC)
    );
}
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_APIChecks_IsDTCFormatValidWithOrigin(                                                                                        /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_DTCFormatType  DTCFormat,
  Dem_DTCOriginType  DTCOrigin,
  Dem_DTCFormat_ContextType Context
)
{
  return Dem_Error_DetectionHandler(Dem_DTC_IsDTCFormatValidWithOrigin(DTCFormat, DTCOrigin, Context));
}
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_APIChecks_IsDTCFormatValid(                                                                                                  /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_DTCFormatType  DTCFormat,
  Dem_DTCFormat_ContextType  Context
)
{
  return Dem_Error_DetectionHandler(Dem_DTC_IsDTCFormatValidInVariant(DTCFormat, Context));
}
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_APIChecks_TestJ1939NodeValid(                                                                                                /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  uint8 ClientId
)
{
  return Dem_Error_DetectionHandler((boolean)Dem_Client_ClientAccess_TestNodeValid(ClientId));
}
...
*****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_APIChecks_TestJ1939RatioFilterSet(                                                                                           /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  uint8 ClientId
)
{
  return Dem_Error_DetectionHandler( (boolean) Dem_Client_ClientAccess_TestJ1939RatioFilterSet(ClientId) );
}
...
{
  return Dem_Error_DetectionHandler(Dem_Core_StatusIndicator_IsExtendedFimEnabled());
}
...
{
  return Dem_Error_DetectionHandler(Dem_FilterData_0x191A_IsService19_1AEnabled());
}
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_APIChecks_TestExtendedDataRecordNumberReadableInSwcApi(                                                                      /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  uint8 ExtendedDataRecordNumber
)
{
  return Dem_Error_DetectionHandler(Dem_EnvDataSwcApi_IsExtendedDataRecordReadable(ExtendedDataRecordNumber));
}
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_APIChecks_IsExtendedDataRecordNumberAllowedInDTCFilter(                                                                      /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_DTCFormatType DTCFormat,
  uint8 ExtendedDataRecordNumber
)
{
  return Dem_Error_DetectionHandler(Dem_RecordReader_ERec_IsERecNumberAllowedInVariant(DTCFormat, ExtendedDataRecordNumber));
}
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_APIChecks_IsExtendedDataRecordNumberAllowedInDTCSelection(                                                                   /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  uint8 ClientId,
  uint8 ExtendedDataRecordNumber
)
{
  Dem_DTCFormatType lDtcFormat = Dem_Client_ClientAccess_GetSelectedDTCFormat(ClientId);
  return Dem_Error_DetectionHandler(Dem_RecordReader_ERec_IsERecNumberAllowedInVariant(lDtcFormat, ExtendedDataRecordNumber));
}
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_APIChecks_IsSnapshotRecordNumberAllowedInDTCSelection(                                                                       /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  uint8 ClientId,
  uint8 RecordNumber
)
{
  Dem_DTCFormatType lDtcFormat = Dem_Client_ClientAccess_GetSelectedDTCFormat(ClientId);
  return Dem_Error_DetectionHandler(Dem_RecordReader_0x1904_IsSRecNumberAllowed(lDtcFormat, RecordNumber));
}
 ...
 *
  *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_APIChecks_IsStorageConditionIDValid(                                                                                         /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  uint8  StorageConditionID
)
{
  return Dem_Error_DetectionHandler(Dem_GlobalDiagnostics_TestStorageConditionValid(StorageConditionID) == TRUE);
}
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_APIChecks_IsEnableConditionNotDtcSettingAndValid(                                                                            /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  uint8  EnableConditionID
)
{
  return Dem_Error_DetectionHandler((EnableConditionID != DEM_ENABLECONDITION_CONTROLDTCSETTING)
    && (Dem_GlobalDiagnostics_TestEnableConditionValid(EnableConditionID) == TRUE));
}
