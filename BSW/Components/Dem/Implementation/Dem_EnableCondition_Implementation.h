...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_Group_GetState
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_IsEnableConditionSupported
 *****************************************************************************/
 /*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_IsNotifyEnableConditionSupported
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_GroupState_TestActive
 *****************************************************************************/
/*!
 * \brief         Test if the enable condition group is active.
 *
 * \details       Test if the enable condition group is active.
 *
 * \param[in]     State
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_GlobalDiagnostics_EnableCondition_GroupState_TestActive(Dem_EnableCondition_GroupState_StateType State);

/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_GroupState_SetActive
 *****************************************************************************/
/*!
...
Dem_GlobalDiagnostics_EnableCondition_GroupState_SetActive(Dem_EnableCondition_GroupState_StateType State);

/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_GroupState_ResetActive
 *****************************************************************************/
/*!
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(Dem_EnableCondition_GroupState_StateType, DEM_CODE)
Dem_GlobalDiagnostics_EnableCondition_GroupState_ResetActive(Dem_EnableCondition_GroupState_StateType State);

/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_GroupState_TestQueueDeactivation
 *****************************************************************************/
/*!
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_GlobalDiagnostics_EnableCondition_GroupState_TestQueueDeactivation(Dem_EnableCondition_GroupState_StateType State);

/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_GroupState_SetQueueDeactivation
 *****************************************************************************/
/*!
 * \brief         Plan to deactivate the enable condition group in the next main function.
 *
 * \details       Plan to deactivate the enable condition group in the next main function.
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(Dem_EnableCondition_GroupState_StateType, DEM_CODE)
Dem_GlobalDiagnostics_EnableCondition_GroupState_SetQueueDeactivation(Dem_EnableCondition_GroupState_StateType State);

/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_GroupState_ResetQueueDeactivation
 *****************************************************************************/
/*!
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(Dem_EnableCondition_GroupState_StateType, DEM_CODE)
Dem_GlobalDiagnostics_EnableCondition_GroupState_ResetQueueDeactivation(Dem_EnableCondition_GroupState_StateType State);


/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_GroupState_TestQueueActivation
 *****************************************************************************/
/*!
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_GlobalDiagnostics_EnableCondition_GroupState_TestQueueActivation(Dem_EnableCondition_GroupState_StateType State);

/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_GroupState_SetQueueActivation
 *****************************************************************************/
/*!
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(Dem_EnableCondition_GroupState_StateType, DEM_CODE)
Dem_GlobalDiagnostics_EnableCondition_GroupState_SetQueueActivation(Dem_EnableCondition_GroupState_StateType State);

/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_GroupState_ResetQueueActivation
 *****************************************************************************/
/*!
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(Dem_EnableCondition_GroupState_StateType, DEM_CODE)
Dem_GlobalDiagnostics_EnableCondition_GroupState_ResetQueueActivation(Dem_EnableCondition_GroupState_StateType State);

/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_GroupState_TestProcessDeactivationTransition
 *****************************************************************************/
/*!
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_GlobalDiagnostics_EnableCondition_GroupState_TestProcessDeactivationTransition(Dem_EnableCondition_GroupState_StateType State);

/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_GroupState_SetProcessDeactivationTransition
 *****************************************************************************/
/*!
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(Dem_EnableCondition_GroupState_StateType, DEM_CODE)
Dem_GlobalDiagnostics_EnableCondition_GroupState_SetProcessDeactivationTransition(Dem_EnableCondition_GroupState_StateType State);

/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_GroupState_ResetProcessDeactivationTransition
 *****************************************************************************/
/*!
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(Dem_EnableCondition_GroupState_StateType, DEM_CODE)
Dem_GlobalDiagnostics_EnableCondition_GroupState_ResetProcessDeactivationTransition(Dem_EnableCondition_GroupState_StateType State);

/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_GroupState_TestProcessActivationTransition
 *****************************************************************************/
/*!
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_GlobalDiagnostics_EnableCondition_GroupState_TestProcessActivationTransition(Dem_EnableCondition_GroupState_StateType State);

/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_GroupState_SetProcessActivationTransition
 *****************************************************************************/
/*!
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(Dem_EnableCondition_GroupState_StateType, DEM_CODE)
Dem_GlobalDiagnostics_EnableCondition_GroupState_SetProcessActivationTransition(Dem_EnableCondition_GroupState_StateType State);

/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_GroupState_ResetProcessActivationTransition
 *****************************************************************************/
/*!
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(Dem_EnableCondition_GroupState_StateType, DEM_CODE)
Dem_GlobalDiagnostics_EnableCondition_GroupState_ResetProcessActivationTransition(Dem_EnableCondition_GroupState_StateType State);
...
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_GlobalDiagnostics_EnableCondition_GroupState_TestActive(
  Dem_EnableCondition_GroupState_StateType State
)
{
...
{
  boolean lGroupActive = TRUE;
  if (Dem_GlobalDiagnostics_EnableCondition_IsEnableConditionSupported() == TRUE)
  {
    Dem_EnableCondition_GroupState_StateType lGroupState =
      Dem_GlobalDiagnostics_EnableCondition_Group_GetState(EnableConditionGroupId);
    lGroupActive = Dem_GlobalDiagnostics_EnableCondition_GroupState_TestActive(lGroupState);
  }
  return lGroupActive;
}
...
{
  uint16 lEnableConditionGroup = DEM_ENABLECONDITION_CONTROLDTCSETTING;
  if (EventId != DEM_EVENT_INVALID)
  {
#if (DEM_CFG_SUPPORT_ENABLE_CONDITIONS == STD_ON)
    lEnableConditionGroup = (Dem_Cfg_GetEnableConditionGroupTableIdxOfEventTable(EventId));
#endif
  }
  return lEnableConditionGroup;
}
 ...
 */
 ...
 /* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_GetGlobalGroupCount
 *****************************************************************************/
 /*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_GetEnableConditionInitValue
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_Group_GetNotFulfilledCount
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_SetInternallyFulfilled
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_Group_SetState
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_Group_SetCounter
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_Group_ConditionNotFulfilled
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_Group_ConditionFulfilled
 *****************************************************************************/
/*!
 * \brief         Set current internal counter of enable condition group
 *
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_TaskFunction
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_Group_IterExists
 *****************************************************************************/
/*!
 ...
 * 
 * \return        TRUE
 *                Dem_GlobalDiagnostics_EnableCondition_Group_GetIter() will return a valid element
 *                on this iterator
 * \return        FALSE
 *                Dem_GlobalDiagnostics_EnableCondition_Group_GetIter() is undefined on this iterator
 *
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_Group_GetIter
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_Group_InitIter
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_Group_NextIter
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_Group_Init
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_Group_MainFunctionProcessQueuedChanges
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_Group_MainFunctionUpdateState
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_Group_SetFulfilled
 *****************************************************************************/
/*!
 * \brief         Update enable condition group state.
 *
...
/* ****************************************************************************
 * Dem_GlobalDiagnostics_EnableCondition_Group_ResetFulfilled
 *****************************************************************************/
/*!
 ...
 *                Enable condition group identifier
 *
 * \pre           Dem_GlobalDiagnostics_EnableCondition_Group_SetState
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
 * \reentrant     FALSE
...
{
  return Dem_Cfg_GetSizeOfEnableConditionGroupTable();
}
...
{
  return Dem_Cfg_GetEnableConditionGroupCounter(EnableConditionGroupId);                                                         /* PRQA S 2842, 2843 */ /* MD_DEM_Dir4.1_ReadOperation, MD_DEM_Dir4.1_ReadOperation */
}
...
#endif
  {
    Dem_Cfg_SetEnableConditionFulfilled(EnableConditionID, ActiveStatus);                                                        /* PRQA S 2841 */ /* MD_DEM_Dir4.1_RunTimeCheckWriteOperation */ /* SBSW_DEM_ARRAY_WRITE_ENABLECONDITIONFULFILLED */
  }
}
...
#endif
  {
    Dem_Cfg_SetEnableConditionGroupState(EnableConditionGroupId, State);                                                         /* PRQA S 2841 */ /* MD_DEM_Dir4.1_RunTimeCheckWriteOperation */ /* SBSW_DEM_ARRAY_WRITE_ENABLECONDITIONGROUPSTATE */
  }
}
...
#endif
  {
    Dem_Cfg_SetEnableConditionGroupCounter(EnableConditionGroupId, Counter);                                                     /* PRQA S 2841 */ /* MD_DEM_Dir4.1_RunTimeCheckWriteOperation */ /* SBSW_DEM_ARRAY_WRITE_ENABLECONDITIONGROUPCOUNTER */
  }
}
...
Dem_GlobalDiagnostics_EnableCondition_Group_ConditionNotFulfilled(
  CONST(Dem_EnableCondition_Group_IdentifierType, AUTOMATIC)  EnableConditionGroupId)
{
  Dem_GlobalDiagnostics_EnableCondition_Group_SetCounter(EnableConditionGroupId,
    (uint8)(Dem_GlobalDiagnostics_EnableCondition_Group_GetNotFulfilledCount(EnableConditionGroupId) + 1u));
}
...
)
{
  ...
  Dem_EnableCondition_GroupState_StateType lGroupState
    = Dem_GlobalDiagnostics_EnableCondition_Group_GetState(lEnableConditionGroupId);

  /* Transition to Inactive */
  if (Dem_GlobalDiagnostics_EnableCondition_GroupState_TestProcessDeactivationTransition(lGroupState))
  {
    Dem_SatelliteCore_ProcessEnableConditionTransitionToInactive(EventId);
  }

  /* Transition to Active */
  if (Dem_GlobalDiagnostics_EnableCondition_GroupState_TestProcessActivationTransition(lGroupState))
  {
    Dem_SatelliteCore_ProcessEnableConditionTransitionToActive(EventId);

    if ((Dem_GlobalDiagnostics_EnableCondition_IsNotifyEnableConditionSupported() == TRUE))
    {
...
)
{
  ...
  Dem_GlobalDiagnostics_EnableCondition_Group_ConditionNotFulfilled(GroupId);

  lGroupState = Dem_GlobalDiagnostics_EnableCondition_GroupState_ResetActive(Dem_GlobalDiagnostics_EnableCondition_Group_GetState(GroupId));
  Dem_GlobalDiagnostics_EnableCondition_Group_SetState(GroupId, lGroupState);
}
...
{
  Dem_EnableCondition_GroupState_StateType lGroupState;
  lGroupState = Dem_GlobalDiagnostics_EnableCondition_Group_GetState(GroupId);
  if (Dem_GlobalDiagnostics_EnableCondition_GroupState_TestQueueDeactivation(lGroupState))
  {
    lGroupState = Dem_GlobalDiagnostics_EnableCondition_GroupState_ResetQueueDeactivation(lGroupState);
    if (Dem_GlobalDiagnostics_EnableCondition_Group_GetNotFulfilledCount(GroupId) > 0u)
    {
      lGroupState = Dem_GlobalDiagnostics_EnableCondition_GroupState_SetProcessDeactivationTransition(lGroupState);
    }
  }
  if (Dem_GlobalDiagnostics_EnableCondition_GroupState_TestQueueActivation(lGroupState))
  {
    lGroupState = Dem_GlobalDiagnostics_EnableCondition_GroupState_ResetQueueActivation(lGroupState);
    if (Dem_GlobalDiagnostics_EnableCondition_Group_GetNotFulfilledCount(GroupId) == 0u)
    {
      lGroupState = Dem_GlobalDiagnostics_EnableCondition_GroupState_SetProcessActivationTransition(lGroupState);
    }
  }
  Dem_GlobalDiagnostics_EnableCondition_Group_SetState(GroupId, lGroupState);
}                                                                                                                                /* PRQA S 6050 */ /* MD_MSR_STCAL */
...
)
{
  ...
  if (Dem_GlobalDiagnostics_EnableCondition_GroupState_TestProcessActivationTransition(lGroupState))
  {
    lGroupState = Dem_GlobalDiagnostics_EnableCondition_GroupState_SetActive(lGroupState);
    lGroupState = Dem_GlobalDiagnostics_EnableCondition_GroupState_ResetProcessActivationTransition(lGroupState);
  }
  lGroupState = Dem_GlobalDiagnostics_EnableCondition_GroupState_ResetProcessDeactivationTransition(lGroupState);
  Dem_GlobalDiagnostics_EnableCondition_Group_SetState(GroupId, lGroupState);
}
...
)
{
  ...
  if (Dem_GlobalDiagnostics_EnableCondition_Group_GetNotFulfilledCount(GroupId) > 0u)
  {
    Dem_GlobalDiagnostics_EnableCondition_Group_ConditionFulfilled(GroupId);
  }

  lGroupState = Dem_GlobalDiagnostics_EnableCondition_Group_GetState(GroupId);
  lGroupState = Dem_GlobalDiagnostics_EnableCondition_GroupState_SetQueueActivation(lGroupState);
  Dem_GlobalDiagnostics_EnableCondition_Group_SetState(GroupId, lGroupState);
}
...
)
{
  ...
  lGroupState = Dem_GlobalDiagnostics_EnableCondition_Group_GetState(GroupId);
  lGroupState = Dem_GlobalDiagnostics_EnableCondition_GroupState_ResetActive(lGroupState);
  if (Dem_GlobalDiagnostics_EnableCondition_Group_GetNotFulfilledCount(GroupId) == 1u)
  {
    lGroupState = Dem_GlobalDiagnostics_EnableCondition_GroupState_SetQueueDeactivation(lGroupState);
  }
  lGroupState = Dem_GlobalDiagnostics_EnableCondition_GroupState_ResetQueueActivation(lGroupState);
  Dem_GlobalDiagnostics_EnableCondition_Group_SetState(GroupId, lGroupState);
}
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
  Dem_GlobalDiagnostics_EnableCondition_SetFulfilled(                                                                            /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONST(uint8, AUTOMATIC)  EnableConditionID
  )
{
  if (Dem_GlobalDiagnostics_EnableCondition_IsEnableConditionSupported() == TRUE)                                                /* COV_DEM_UNIT_ENTRY_CONFIGURATION_CHECK */
  {
    ...
    if (Dem_GlobalDiagnostics_EnableCondition_TestFulfilled(EnableConditionID) == FALSE)
    {
      Dem_Cfg_EventEnableConditionGroupIterType lEnableConditionIter;
      for (Dem_GlobalDiagnostics_EnableCondition_Group_InitIter(EnableConditionID, &lEnableConditionIter);                       /* SBSW_DEM_CALL_ITERATOR_POINTER */
        Dem_GlobalDiagnostics_EnableCondition_Group_IterExists(&lEnableConditionIter) == TRUE;                                   /* SBSW_DEM_CALL_ITERATOR_POINTER */
        Dem_GlobalDiagnostics_EnableCondition_Group_NextIter(&lEnableConditionIter))                                             /* SBSW_DEM_CALL_ITERATOR_POINTER */
      {
        Dem_GlobalDiagnostics_EnableCondition_Group_SetFulfilled(Dem_GlobalDiagnostics_EnableCondition_Group_GetIter(&lEnableConditionIter)); /* SBSW_DEM_CALL_ITERATOR_POINTER */
        lEnableConditionGroupStatePending = TRUE;
      }
      Dem_GlobalDiagnostics_EnableCondition_SetInternallyFulfilled(EnableConditionID, TRUE);
    }
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_GlobalDiagnostics_EnableCondition_ResetFulfilled(                                                                            /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONST(uint8, AUTOMATIC)  EnableConditionID
  )
{
  if (Dem_GlobalDiagnostics_EnableCondition_IsEnableConditionSupported() == TRUE)                                                /* COV_DEM_UNIT_ENTRY_CONFIGURATION_CHECK */
  {
    ...
    if (Dem_GlobalDiagnostics_EnableCondition_TestFulfilled(EnableConditionID) == TRUE)
    {
      Dem_Cfg_EventEnableConditionGroupIterType lEnableConditionIter;
      for (Dem_GlobalDiagnostics_EnableCondition_Group_InitIter(EnableConditionID, &lEnableConditionIter);                       /* SBSW_DEM_CALL_ITERATOR_POINTER */
        Dem_GlobalDiagnostics_EnableCondition_Group_IterExists(&lEnableConditionIter) == TRUE;                                   /* SBSW_DEM_CALL_ITERATOR_POINTER */
        Dem_GlobalDiagnostics_EnableCondition_Group_NextIter(&lEnableConditionIter))                                             /* SBSW_DEM_CALL_ITERATOR_POINTER */
      {
        Dem_GlobalDiagnostics_EnableCondition_Group_ResetFulfilled(Dem_GlobalDiagnostics_EnableCondition_Group_GetIter(&lEnableConditionIter)); /* SBSW_DEM_CALL_ITERATOR_POINTER */


        lEnableConditionGroupStatePending = TRUE;
      }
      Dem_GlobalDiagnostics_EnableCondition_SetInternallyFulfilled(EnableConditionID, FALSE);
    }
  ...
  )
{
  if (Dem_GlobalDiagnostics_EnableCondition_IsEnableConditionSupported() == TRUE)                                                /* COV_DEM_UNIT_ENTRY_CONFIGURATION_CHECK */
  {
    ...
    for (lEnableConditionGroupId = 0u; 
         lEnableConditionGroupId < Dem_GlobalDiagnostics_EnableCondition_GetGlobalGroupCount();
         ++lEnableConditionGroupId)
    {
      Dem_GlobalDiagnostics_EnableCondition_Group_MainFunctionProcessQueuedChanges(lEnableConditionGroupId);
    }
    ...
    for (lEventId = DEM_EVENT_FIRST; lEventId < Dem_Cfg_GlobalEventCount(); ++lEventId)
    {
      if (Dem_Event_TestEventAvailable(lEventId) == TRUE)
      {
        ...
        Dem_GlobalDiagnostics_EnableCondition_TaskFunction(lEventId);
      }
    }
    ...
    for (lEnableConditionGroupId = 0u; 
         ...
         ++lEnableConditionGroupId)
    {
      Dem_GlobalDiagnostics_EnableCondition_Group_MainFunctionUpdateState(lEnableConditionGroupId);
    }
...
)
{
  if (Dem_GlobalDiagnostics_EnableCondition_IsEnableConditionSupported() == TRUE)
  {
    ...
    for (lEnableCondition = 0u;
      ...
      ++lEnableCondition)
    {
      Dem_GlobalDiagnostics_EnableCondition_SetInternallyFulfilled(lEnableCondition, TRUE);
    }
    ...
    for (lEnableConditionGroupId = 0u;
      ...
      ++lEnableConditionGroupId)
    {
      Dem_GlobalDiagnostics_EnableCondition_Group_SetCounter(lEnableConditionGroupId, 0u);
    }
    ...
    for (lEnableConditionGroupId = 0u;
      ...
      ++lEnableConditionGroupId)
    {
      Dem_GlobalDiagnostics_EnableCondition_Group_SetState(lEnableConditionGroupId, lGroupState);
    }
  }
}
  ...
  )
{
  if (Dem_GlobalDiagnostics_EnableCondition_IsEnableConditionSupported() == TRUE)
  {
    ...
    for (lEnableCondition = 0u;
      lEnableCondition < Dem_GlobalDiagnostics_EnableCondition_GetGlobalCount();
      ++lEnableCondition)
    {
      boolean lEnableConditionInitState;
      Dem_Cfg_EventEnableConditionGroupIterType lEnableConditionIter;

      lEnableConditionInitState = Dem_GlobalDiagnostics_EnableCondition_GetEnableConditionInitValue(lEnableCondition);

      if (lEnableConditionInitState == FALSE)
      {
        for (Dem_GlobalDiagnostics_EnableCondition_Group_InitIter(lEnableCondition, &lEnableConditionIter);                      /* SBSW_DEM_CALL_ITERATOR_POINTER */
          Dem_GlobalDiagnostics_EnableCondition_Group_IterExists(&lEnableConditionIter) == TRUE;                                 /* SBSW_DEM_CALL_ITERATOR_POINTER */
          Dem_GlobalDiagnostics_EnableCondition_Group_NextIter(&lEnableConditionIter))                                           /* SBSW_DEM_CALL_ITERATOR_POINTER */
        {
          Dem_GlobalDiagnostics_EnableCondition_Group_Init(Dem_GlobalDiagnostics_EnableCondition_Group_GetIter(&lEnableConditionIter)); /* SBSW_DEM_CALL_ITERATOR_POINTER */
        }
      }
      Dem_GlobalDiagnostics_EnableCondition_SetInternallyFulfilled(lEnableCondition, lEnableConditionInitState);
    }
  }
}                                                                                                                                /* PRQA S 6050 */ /* MD_MSR_STCAL */
 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_GlobalDiagnostics_EnableCondition_TestEnableConditionStateOfEvent(                                                           /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONST(Dem_EventIdType, AUTOMATIC)  EventId
  )
{
  ...
  if (Dem_GlobalDiagnostics_EnableCondition_IsEnableConditionSupported() == TRUE)                                                /* COV_DEM_UNIT_ENTRY_CONFIGURATION_CHECK */
  {
    Dem_EnableCondition_Group_IdentifierType lEnableConditionGroupId
      = Dem_GlobalDiagnostics_EnableCondition_GetEnableConditionGroupId(EventId);
    uint8 lCounter = Dem_GlobalDiagnostics_EnableCondition_Group_GetNotFulfilledCount(lEnableConditionGroupId);
    ...
    else if ((Dem_GlobalDiagnostics_EnableCondition_TestFulfilled(DEM_ENABLECONDITION_CONTROLDTCSETTING) == FALSE)
      && (lCounter == 1u))
    {
      ConditionFulfilled = TRUE;
    }
