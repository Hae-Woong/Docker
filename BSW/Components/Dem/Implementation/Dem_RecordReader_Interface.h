 ...
 */
/*!
 *  \defgroup   Dem_RecordReader Dem Record Reader
 *  \{
 *  \file       Dem_RecordReader_Interface.h
 *  \brief      Diagnostic Event Manager (Dem) header file
 *  \details    Public Interface of RecordReader Logical Unit
 *  \entity     RecordReader
 *********************************************************************************************************************/
...
#if !defined (DEM_RECORDREADER_INTERFACE_H)
#define DEM_RECORDREADER_INTERFACE_H
...
#endif /* DEM_RECORDREADER_INTERFACE_H */

/*!
 * \}
 */
/* ********************************************************************************************************************
 *  END OF FILE: Dem_RecordReader_Interface.h
 *********************************************************************************************************************/
