 ...
 * \{
 */
/*! This used for DTCReadoutBuffer data entry Indexing. */
...
typedef enum
{
  ...
  Dem_DTCReadoutBuffer_SnapshotSource_TimeSeries,                  /*!< Classic Time Series source */
  Dem_DTCReadoutBuffer_SnapshotSource_CustomTriggerSrec,           /*!< Custom triggered snapshot source */
  Dem_DTCReadoutBuffer_SnapshotSource_CustomTriggerTssr,           /*!< Custom triggered time series source */
  ...
  Dem_DTCReadoutBuffer_SnapshotSource_ObdOnUds_Updateable,         /*!< OBD on UDS updateable snapshot */
 ...
 * \{
 */
/*!< Default value indicating which entry inside Readout Buffer shall be used. 
     By default for events in non-combined type 2 configurations, the entry at 
