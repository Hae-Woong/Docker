 ...
 *  \{
 *  \file       Dem_SatelliteIF_SvcImplementation.h
...
#if !defined (DEM_SATELLITEIF_SVCIMPLEMENTATION_H)
#define DEM_SATELLITEIF_SVCIMPLEMENTATION_H
...
#define DEM_SATELLITEIF_SVCIMPLEMENTATION_FILENAME "Dem_SatelliteIF_SvcImplementation.h"
  ...
  )
{
  ...
  {
  /* ----- Implementation ------------------------------------------------ */
    lReturnValue = Dem_SatelliteSat_SetEventStatus(EventId, EventStatus);

    Dem_SatelliteSat_MultiEvent_SetEventStatus(EventId, EventStatus);
  }
  ...
  )
{
  ...
  /* ----- Implementation ------------------------------------------------ */
    ...
    Dem_SatelliteSat_MultiEvent_ResetEventStatus(EventId);
  }
  ...
  )
{
  ...
  {
  /* ----- Implementation ------------------------------------------------ */
    lReturnValue = Dem_SatelliteSat_ResetEventDebounceStatus(EventId, DebounceResetStatus);

    Dem_SatelliteSat_MultiEvent_ResetEventDebounceStatus(EventId, DebounceResetStatus);
  }
...
# if (DEM_DEV_ERROR_DETECT == STD_ON)
  if (Dem_Nvm_IsDebounceCounterStorageSupported() == FALSE)
  {
...
# endif
  ...
  else
  {
    ...
    Dem_MemSet((Dem_NvDataPtrType)&Dem_Cfg_DebounceData[0], 0x00, Dem_Cfg_GlobalDebounceStorageEventCount()*sizeof(Dem_Cfg_DebounceData[0])); /* PRQA S 0315, 0602, 0310 */ /* MD_MSR_VStdLibCopy, MD_DEM_20.2, MD_DEM_11.4_cpy */ /* SBSW_DEM_MEMSET_DEBOUNCEDATA */
#endif
  }
...
#endif /* DEM_SATELLITEIF_SVCIMPLEMENTATION_H */

/*!
 * \}
 */
/* ********************************************************************************************************************
 *  END OF FILE: Dem_SatelliteIF_SvcImplementation.h
 *********************************************************************************************************************/
