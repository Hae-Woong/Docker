...
#define DEM_DTR_CONVERSION_UNDERFLOW                  (0x01U)  /*!< DTR conversion underflow */
...
/* Unfortunately, the config access macros are generated strangely is case DTR is not supported.
* Therefore, own access macros are defined and used in that case.  */
#if (DEM_CFG_SUPPORT_DTR == STD_ON)
# define DEM_DTRDATA_CFG_GETSTATUS(x) (Dem_Cfg_GetDtrStatus(x))
# define DEM_DTRDATA_CFG_GETDIVISOROFDTRTABLE(x) Dem_Cfg_GetDivisorOfDtrTable(x)
#else
# define DEM_DTRDATA_CFG_GETSTATUS(x) (0)
# define DEM_DTRDATA_CFG_GETDIVISOROFDTRTABLE(x) (1)
#endif
...
#if (DEM_CFG_SUPPORT_DTR == STD_ON)
  DEM_LOCAL volatile VAR(boolean, DEM_VAR_NO_INIT)  Dem_Dtr_DataChanged;
#endif
...
{
  return (boolean)(DEM_CFG_SUPPORT_DTR == STD_ON);
}
 ...
 *                The function must not be called if DEM_CFG_SUPPORT_DTR
 *                is STD_OFF.
 *
 * \param[in]     IterPtr
 *                Pointer to the iterator
 ...
 *                configured for an event. Must not be called with 
 *                DEM_CFG_SUPPORT_DTR == STD_OFF.
 *
 * \param[in]     EventId
...
Dem_DtrData_RoundFloatToInt(
  CONST(Dem_DtrData_FloatType, AUTOMATIC)  Value
  );
 ...
 * \reentrant     TRUE
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(Dem_DtrData_FloatType, DEM_CODE)
Dem_DtrData_GetDivisor(
  CONST(DTRIdType, AUTOMATIC) DtrId
  );
 ...
 *                Must not be called when DEM_CFG_SUPPORT_DTR == STD_OFF
 *
 * \param[in]     DtrId
 *                Unique handle of the Dtr.
 *                The DtrId must be in range [0..Dem_DtrData_GetGlobalDtrCount()-1[.
 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_DtrData_EventDtrIterExists(                                                                                                  /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONSTP2CONST(Dem_Cfg_EventDtrIterType, AUTOMATIC, AUTOMATIC) IterPtr
)
{
 ...
 */
DEM_LOCAL_INLINE FUNC(DTRIdType, DEM_CODE)
Dem_DtrData_EventDtrIterGet(                                                                                                     /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONSTP2CONST(Dem_Cfg_EventDtrIterType, AUTOMATIC, AUTOMATIC) IterPtr
  )
{
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_DtrData_EventDtrIterInit(                                                                                                    /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONST(Dem_EventIdType, AUTOMATIC)  EventId,
  ...
  )
{
  ...
  if (lDTRsHaveEvent  == TRUE)
  {
    IterPtr->mIdx = Dem_Cfg_GetDtrTableIndStartIdxOfEventTable(EventId);                                                         /* PRQA S 2842 */ /* MD_DEM_Dir4.1_ReadOperation */ /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
    IterPtr->mEndIdx = Dem_Cfg_GetDtrTableIndEndIdxOfEventTable(EventId);                                                        /* PRQA S 2842 */ /* MD_DEM_Dir4.1_ReadOperation */ /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
  }
  else
  {
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_DtrData_EventDtrIterNext(                                                                                                    /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONSTP2VAR(Dem_Cfg_EventDtrIterType, AUTOMATIC, AUTOMATIC) IterPtr                                                             /* PRQA S 3673 */ /* MD_DEM_8.13_fp */
  )
{
 ...
 */
DEM_LOCAL_INLINE FUNC(sint32, DEM_CODE)
Dem_DtrData_RoundFloatToInt(                                                                                                     /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONST(Dem_DtrData_FloatType, AUTOMATIC)  Value
  )
{
  sint32 lConvertedValue;

  if (Value > DEM_DTRDATA_FLOATZERO)
  {
    lConvertedValue = (sint32)(Value + DEM_DTRDATA_FLOATONEHALF);                                                                /* PRQA S 4395 */ /* MD_DEM_10.8_DTRFloatToInteger */
  }
  else
  {
    lConvertedValue = (sint32)(Value - DEM_DTRDATA_FLOATONEHALF);                                                                /* PRQA S 4395 */ /* MD_DEM_10.8_DTRFloatToInteger */
 ...
 */
DEM_LOCAL_INLINE FUNC(uint8, DEM_CODE)
Dem_DtrData_GetUpdateKind(                                                                                                       /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONST(DTRIdType, AUTOMATIC) DtrId
  )
{
  uint8 lReturnValue;
 ...
 */
DEM_LOCAL_INLINE FUNC(Dem_DtrData_FloatType, DEM_CODE)
Dem_DtrData_GetDivisor(                                                                                                          /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
CONST(DTRIdType, AUTOMATIC) DtrId
)
{
  Dem_DtrData_FloatType lReturnValue;
  lReturnValue = (Dem_DtrData_FloatType) DEM_DTRDATA_CFG_GETDIVISOROFDTRTABLE(DtrId);
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(DtrId)                                                                                        /* PRQA S 3112 */ /* MD_DEM_14.2 */
  return lReturnValue;
}
 ...
 */
DEM_LOCAL_INLINE FUNC(Dem_DtrData_FloatType, DEM_CODE)
Dem_DtrData_GetLinearFactor(                                                                                                     /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONST(DTRIdType, AUTOMATIC) DtrId
  )
{
  Dem_DtrData_FloatType lReturnValue;
 ...
 */
DEM_LOCAL_INLINE FUNC(Dem_DtrData_FloatType, DEM_CODE)
Dem_DtrData_GetOffset(                                                                                                           /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONST(DTRIdType, AUTOMATIC) DtrId
  )
{
  Dem_DtrData_FloatType lReturnValue;
  ...
  )
{
  uint8 lReturnValue;
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(DtrId)                                                                                        /* PRQA S 3112 */ /* MD_DEM_14.2 */
  lReturnValue = DEM_DTRDATA_CFG_GETSTATUS(DtrId);
  return lReturnValue;
}
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_DtrData_SetStatus(                                                                                                           /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONST(DTRIdType, AUTOMATIC) DtrId,
  CONST(uint8, AUTOMATIC) Status
  )
{
...
# endif
  {
    ...
    DEM_IGNORE_UNUSED_CONST_ARGUMENT(DtrId)
#endif
}
...
# endif
  {
    Dem_Cfg_GetDtrData().LowLimValue[DtrId] = Value;                                                                             /* PRQA S 2841 */ /* MD_DEM_Dir4.1_RunTimeCheckWriteOperation */  /* SBSW_DEM_ARRAY_WRITE_DTRDATA_LOWLIMVALUE */
  }
#else
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(DtrId)                                                                                        /* PRQA S 3112 */ /* MD_DEM_14.2 */
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(Value)                                                                                        /* PRQA S 3112 */ /* MD_DEM_14.2 */
...
# endif
  {
    Dem_Cfg_GetDtrData().UppLimValue[DtrId] = Value;                                                                             /* PRQA S 2841 */ /* MD_DEM_Dir4.1_RunTimeCheckWriteOperation */ /* SBSW_DEM_ARRAY_WRITE_DTRDATA_UPPLIMVALUE */
  }
#else
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(DtrId)                                                                                        /* PRQA S 3112 */ /* MD_DEM_14.2 */
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(Value)                                                                                        /* PRQA S 3112 */ /* MD_DEM_14.2 */
  ...
  )
{
  ...
  Dem_DtrData_FloatType lDivisor, lLinFactor, lOffset, lConvertedValue;

  lDivisor = Dem_DtrData_GetDivisor(DTRId);
  lLinFactor = Dem_DtrData_GetLinearFactor(DTRId);
  lOffset = Dem_DtrData_GetOffset(DTRId);

  lConvertedValue = ((lLinFactor * (Dem_DtrData_FloatType)InitialValue) + lOffset) / lDivisor;
  ...
  )
{
  ...
  /* Global limits have been exceeded or at least one threshold has to be shifted by more than one --> reset Dtr values */
  else
  {
  /* ----- Development Error Report ---------------------------------------- */
# if (DEM_DEV_ERROR_REPORT == STD_ON)
    Dem_Error_ReportError(DEM_SETDTR_APIID, DEM_E_PARAM_CONFIG);
# endif
  ...
  )
{
  ...
  if (lEventId != DEM_EVENT_INVALID)
  {
    if ((Dem_Cfg_EventAvailableByVariant(lEventId) == FALSE)
      || (Dem_Event_InternalStatus_TestBit(Dem_Event_InternalStatus_GetEventStatus(lEventId), Dem_InternalStatus_Disconnected) == TRUE))
    {
...
{
#if (DEM_CFG_SUPPORT_DTR == STD_ON)
  Dem_MemSet((Dem_DataPtrType)(&Dem_Cfg_GetDtrStatus(0)),                                                                        /* PRQA S 0310, 0312, 0315, 0602 */ /* MD_DEM_11.4_cpy, MD_DEM_11.8, MD_MSR_VStdLibCopy, MD_DEM_20.2 */ /* SBSW_DEM_MEMSET_DTRSTATUS */
             DEM_DTR_VISIBLE,
  ...
  )
{
  ...
  for (lDtrId = 0u; lDtrId < Dem_DtrData_GetGlobalDtrCount(); lDtrId++)
  {
    ...
    EventId = Dem_DtrData_GetRelatedEvent(lDtrId);
 ...
 *
 */
DEM_LOCAL_INLINE FUNC(Dem_Cfg_UasidOfDtrTableType, DEM_CODE)
Dem_DtrData_GetUaSId(
  CONST(DTRIdType, AUTOMATIC) DtrId
  )
{
  Dem_Cfg_UasidOfDtrTableType lReturnValue;
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(DtrId)                                                                                        /* PRQA S 3112 */ /* MD_DEM_14.2 */
#if (DEM_CFG_SUPPORT_DTR == STD_ON)
...
/* ****************************************************************************
 % Dem_DtrData_GetDtrDataIfEventAvailable
*****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_DtrData_GetDtrDataIfEventAvailable(                                                                                          /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
...
)
{
  ...
  if (Dem_Event_TestEventAvailable(lEventId) == TRUE)
  {
    ...
    lUasid = (uint16)Dem_DtrData_GetUaSId(DtrId);

    /* >>>> -------------------------------- Enter Critical Section: DiagMonitor */
    Dem_EnterCritical_DiagMonitor();

    lTestValue = Dem_DtrData_GetTestValue(DtrId);
    lLowerLimit = Dem_DtrData_GetLowerLimit(DtrId);
    lUpperLimit = Dem_DtrData_GetUpperLimit(DtrId);

    Dem_LeaveCritical_DiagMonitor();
    /* <<<< -------------------------------- Leave Critical Section: DiagMonitor */

    Dem_Data_WriteDestinationBufferUint16(DestinationBuffer, lUasid);                                                            /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    Dem_Data_WriteDestinationBufferUint16(DestinationBuffer, lTestValue);                                                        /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    Dem_Data_WriteDestinationBufferUint16(DestinationBuffer, lLowerLimit);                                                       /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    Dem_Data_WriteDestinationBufferUint16(DestinationBuffer, lUpperLimit);                                                       /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
  }
  else
  {
    Dem_Data_WriteDestinationBufferUint16(DestinationBuffer, 0);                                                                 /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    Dem_Data_WriteDestinationBufferUint16(DestinationBuffer, 0);                                                                 /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    Dem_Data_WriteDestinationBufferUint16(DestinationBuffer, 0);                                                                 /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    Dem_Data_WriteDestinationBufferUint16(DestinationBuffer, 0);                                                                 /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
  }
 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_DtrData_IsDtrOfEvent(                                                                                                        /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
CONST(DTRIdType, AUTOMATIC)  DtrId,
CONST(Dem_EventIdType, AUTOMATIC)  EventId
)
{
  ...
  if (Dem_Event_CombinedStorage_IsSupported())
  {
    Dem_EventIdType lSubEventOfDtr;
    lSubEventOfDtr = Dem_DtrData_GetRelatedEvent(DtrId);
    if (lSubEventOfDtr != DEM_EVENT_INVALID)
    {
      Dem_Cfg_CombinedGroupIndexType lGroupIdOfDtr;
      lGroupIdOfDtr = Dem_Cfg_EventCombinedGroup(lSubEventOfDtr);
      if (lGroupIdOfDtr != DEM_CFG_COMBINED_GROUP_INVALID)
      {
        /* If the DTR belongs to a combined event, compare the group IDs of both events */
        lRetVal = (lGroupIdOfDtr == Dem_Cfg_EventCombinedGroup(EventId));
      }
      else
      {
        /* else compare the event IDs */
        lRetVal = (lSubEventOfDtr == EventId);
      }
    }
  }
  else
  {
    /* In case that no event combination type 1 is supported, compare the event IDs */
    Dem_EventIdType lDtrsEvent;
    lDtrsEvent = Dem_DtrData_GetRelatedEvent(DtrId);
    lRetVal = (lDtrsEvent == EventId);
  }
  return lRetVal;
}
