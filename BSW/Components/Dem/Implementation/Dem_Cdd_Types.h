...
typedef uint16                                   Dem_EventIdType;              /*!< Type for DemEventParameter handles */
#endif
...
#endif
#if !defined (DEM_DTC_FORMAT_OBD_3BYTE)                                                                                          /* COV_DEM_RTE_TYPEDEFS TX */
# define DEM_DTC_FORMAT_OBD_3BYTE                (0x03U)                       /*!< DTC format: OBD 3-Byte DTC number */
#endif
