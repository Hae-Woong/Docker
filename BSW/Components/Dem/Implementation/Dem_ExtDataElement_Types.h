...
/*! storage for float/uint32 conversion */
union Dem_ExtDataElement_FloatU32ConverterType_u
{                                                                                                                                /* PRQA S 0750 */ /* MD_MSR_Union */
  uint32  AsUint32;   /*!< Value as uint32 */
  float32 AsFloat32;  /*!< Value as float32 */
};
/*! type for float/uint32 conversion */
typedef union Dem_ExtDataElement_FloatU32ConverterType_u Dem_ExtDataElement_FloatU32ConverterType;
