 ...
 *
 * \return        TRUE
 *                Prestorage queue updated flag is set.
 * \return        FALSE
 *                Prestorage queue updated flag is not set.
 *
 * \pre           Function should only be invoked when the features "Support 
 *                prestorage of freeze frames" and "Multiple Satellites" are supported.
 *
 ...
 *
 * \return        TRUE
 *                StatusIndicator queue updated flag is set.
 * \return        FALSE
 *                StatusIndicator queue updated flag is not set.
 *
 * \pre           Function should only be invoked when the features "Support 
 *                Extended FiM" is enabled.
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Unset the PTO timer queue updated flag in the satellite info object.
 *
 * \details       Unset the PTO timer queue updated flag in the satellite info object.
 *
 * \param[in]     SatelliteInfo
 *                The data object to modify
 *
 ...
 *****************************************************************************/
 /*!
 * \brief         Reads the PTO timer queue updated status from the 
 *                satellite info object.
 *
 * \details       Reads the PTO timer queue updated status from the 
*                 satellite info object.
 *
 * \param[in]     SatelliteInfo
 *                The data object to read from.
 *
 * \return        TRUE
 *                PTO timer queue updated flag is set.
 * \return        FALSE
 *                PTO timer queue updated flag is not set.
 *
 * \pre           Function should only be invoked when the feature "PTO
 ...
 *****************************************************************************/
 /*!
 * \brief         Set the PTO timer queue updated status in the satellite 
 *                info object.
 *
 * \details       Set the PTO timer queue updated status in the satellite 
 *                info object.
 *
 * \param[in]     SatelliteInfo
 *                The data object to modify
 ...
 *****************************************************************************/
 /*!
 * \brief         Set the custom trigger queue updated status in the satellite 
 *                info object.
 *
 * \details       Set the custom trigger queue updated status in the satellite 
 *                info object.
 *
 * \param[in]     SatelliteInfo
 *                The data object to modify
 ...
 * \return        The modified satellite info object.
 *
 * \pre           Function should only be invoked when the feature "Custom
 *                Snapshot Trigger" is enabled.
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
 * \reentrant     TRUE
 ...
 *****************************************************************************/
/*!
 * \brief         Unset the custom trigger queue updated flag in the satellite info object.
 *
 * \details       Unset the custom trigger queue updated flag in the satellite info object.
 *
 * \param[in]     SatelliteInfo
 *                The data object to modify
 *
 ...
 *****************************************************************************/
 /*!
 * \brief         Reads the custom trigger queue updated status from the 
 *                satellite info object.
 *
 * \details       Reads the custom trigger queue updated status from the 
*                 satellite info object.
 *
 * \param[in]     SatelliteInfo
 *                The data object to read from.
 *
 * \return        TRUE
 *                Custom trigger queue updated flag is set.
 * \return        FALSE
 *                Custom trigger queue updated flag is not set.
 *
 * \pre           Function should only be invoked when the feature "Custom
 *                Snapshot Trigger" is enabled.
 *
