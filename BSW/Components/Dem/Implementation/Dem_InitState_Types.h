 ...
 * \{
 */
#define DEM_INITSTATE_UNINITIALIZED              (0U)                /*!< Initialization state directly after system startup - If value changed to not zero, change Initialization of SatelliteInfo.InitStatus too*/
