 ...
 *****************************************************************************/
/*!
 * \brief         Get the DTC format stored in the selector object
 *
 * \details       Get the DTC format stored in the selector object
 *
 * \param[in]     DTCSelectorId
 *                The object to read from.
 *
 * \return        The DTC Format stored in the selector object.
 *                DEM_DTC_FORMAT_INVALID if no selection was requested
 *
 * \pre           -
 *
 * \context       TASK|ISR2
