...
enum Dem_Scheduler_TaskId
{
  ...
  Dem_Scheduler_Task_SamplerCollectData,    /* To collect samples. Must be executed before samples are copied from ring buffer into entry */
  Dem_Scheduler_Task_CustomTrigger,
  ...
  Dem_Scheduler_Task_Pto,
  Dem_Scheduler_Task_ReadinessCompletion,
  Dem_Scheduler_Task_SamplerReset,       /* To restart updating new sample. Must be executed after samples are copied from ring buffer into entry */
