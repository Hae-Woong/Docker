...
{
  return (boolean)(IterPtr->mIdx < IterPtr->mEndIdx);                                                                            /* PRQA S 2841 */ /* MD_DEM_Dir4.1_ReadOperation */
}
...
{
  IterPtr->mIdx = StartIndex;                                                                                                    /* PRQA S 2841 */ /* MD_DEM_Dir4.1_DereferencedPointerWriteOperation */ /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
  IterPtr->mEndIdx = EndIndex;                                                                                                   /* PRQA S 2841 */ /* MD_DEM_Dir4.1_DereferencedPointerWriteOperation */ /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
}
...
/* ****************************************************************************
 % Dem_Cfg_ComplexIter32BitExists
 *****************************************************************************/
 /*!
  * Internal comment removed.
 *
 *
  */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Cfg_ComplexIter32BitExists(                                                                                                       /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  CONSTP2CONST(Dem_Cfg_ComplexIterType32Bit, AUTOMATIC, AUTOMATIC)  IterPtr
)
{
 ...
 *
  */
DEM_LOCAL_INLINE FUNC(Dem_Cfg_DataIndexType32Bit, DEM_CODE)
Dem_Cfg_ComplexIter32BitGet(                                                                                                          /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  CONSTP2CONST(Dem_Cfg_ComplexIterType32Bit, AUTOMATIC, AUTOMATIC)  IterPtr
)
{
  return (Dem_Cfg_DataIndexType32Bit)IterPtr->mIdx;
}


/* ****************************************************************************
 % Dem_Cfg_ComplexIter32BitInit
 *****************************************************************************/
 /*!
  * Internal comment removed.
 *
...
Dem_Cfg_ComplexIter32BitInit(
  ...
  uint32_least StartIndex,
  uint32_least EndIndex
)
{
 ...
 *
  */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Cfg_ComplexIter32BitNext(                                                                                                         /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  CONSTP2VAR(Dem_Cfg_ComplexIterType32Bit, AUTOMATIC, AUTOMATIC)  IterPtr                                                             /* PRQA S 3673 */ /* MD_DEM_8.13_fp */
)
{
  IterPtr->mIdx += 1u;                                                                                                           /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
}
 ...
 *
  */
DEM_LOCAL_INLINE FUNC(uint8, DEM_CODE)
Dem_Cfg_DataElementDataType(                                                                                                     /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  CONST(Dem_Cfg_DataIndexType, AUTOMATIC)  DataIndex
)
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(DataIndex)                                                                                    /* PRQA S 3112 */ /* MD_DEM_14.2 */
  return (uint8)(Dem_Cfg_GetElementDataTypeOfDataElementTable(DataIndex));                                                       /* PRQA S 2842 */ /* MD_DEM_Dir4.1_ReadOperation */
}
...
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(DataIndex)                                                                                    /* PRQA S 3112 */ /* MD_DEM_14.2 */
  return (uint16)(Dem_Cfg_GetElementSizeOfDataElementTable(DataIndex));
}
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if (Dem_Cfg_GetCallbackClearEventAllowedIdxOfEventPrecompileDataTable(EventId) >= Dem_Cfg_GetSizeOfCallbackClearEventAllowed())
  {
...
# endif
  {
    lReturnValue = Dem_Cfg_GetCallbackClearEventAllowed(
      Dem_Cfg_GetCallbackClearEventAllowedIdxOfEventPrecompileDataTable(EventId));
  }
  return lReturnValue;
}
#endif
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if (Dem_Cfg_GetEventDataChangedIdxOfEventPrecompileDataTable(EventId) >= Dem_Cfg_GetSizeOfEventDataChanged())
  {
...
# endif
  {
    lReturnValue = (Dem_EventDataChangedFPtrType)Dem_Cfg_GetEventDataChanged(Dem_Cfg_GetEventDataChangedIdxOfEventPrecompileDataTable(EventId));
  }
#else
  lReturnValue = (Dem_EventDataChangedFPtrType)NULL_PTR;
#endif
  ...
  )
{
...
#if ((DEM_CFG_SUPPORT_DEBOUNCE_MONITORINTERNAL == STD_ON) && (DEM_CFG_SUPPORT_DEBOUNCE_MONITORINTERNAL_GETFDC == STD_ON))
  {
    ...
    lCheckResult = (boolean)(Dem_Cfg_GetCallbackGetFdcIdxOfEventPrecompileDataTable(EventId) >= Dem_Cfg_GetSizeOfCallbackGetFdc());
...
# endif
    {
      lReturnValue = Dem_Cfg_GetCallbackGetFdc(Dem_Cfg_GetCallbackGetFdcIdxOfEventPrecompileDataTable(EventId));
    }
  }
#endif
  ...
  )
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
#if (DEM_CFG_NOTIFY_INIT_FUNC == STD_ON)
  IterPtr->mIdx = Dem_Cfg_GetInitMonitorsForFuncStartIdxOfInitMonListForFunc(                                                    /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
    Dem_Cfg_GetInitMonListForFuncIdxOfEventPrecompileDataTable(EventId));
  IterPtr->mEndIdx = Dem_Cfg_GetInitMonitorsForFuncEndIdxOfInitMonListForFunc(                                                   /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
    Dem_Cfg_GetInitMonListForFuncIdxOfEventPrecompileDataTable(EventId));
#else
  IterPtr->mIdx    = 0u;                                                                                                         /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
  IterPtr->mEndIdx = 0u;                                                                                                         /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if (Dem_Cfg_GetInitMonitorForEventIdxOfEventPrecompileDataTable(EventId) >= Dem_Cfg_GetSizeOfInitMonitorForEvent())
  {
...
# endif
  {
    lReturnValue = (Dem_InitMonitorForEventFPtrType)(Dem_Cfg_GetInitMonitorForEvent(Dem_Cfg_GetInitMonitorForEventIdxOfEventPrecompileDataTable(EventId)));
  }
#else
  lReturnValue = (Dem_InitMonitorForEventFPtrType)NULL_PTR;
#endif
  ...
  )
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(IterPtr)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
#if (DEM_CFG_NOTIFY_EVENT_STATUS == STD_ON) && (Dem_Cfg_HasEventStatusChanged() == TRUE)
  IterPtr->mIdx = Dem_Cfg_GetEventStatusChangedStartIdxOfEventPrecompileDataTable(EventId);                                      /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
  IterPtr->mEndIdx = Dem_Cfg_GetEventStatusChangedEndIdxOfEventPrecompileDataTable(EventId);                                     /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
#else
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
  IterPtr->mIdx = 0u;                                                                                                            /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
  IterPtr->mEndIdx = 0u;                                                                                                         /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
  ...
  )
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
#if (DEM_FEATURE_SUPPORT_EVENTCOMBINATION == STD_ON)
  return (Dem_Cfg_CombinedGroupIndexType)(Dem_Cfg_GetCombinedGroupsIdxOfEventPrecompileDataTable(EventId));                      /* PRQA S 2842 */ /* MD_DEM_Dir4.1_ReadOperation */
#else
  ...
  )
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
#if (DEM_FEATURE_SUPPORT_EVENTCOMBINATION == STD_ON)
  return (boolean)Dem_Cfg_IsCombinedGroupsUsedOfEventPrecompileDataTable(EventId);
#else
  return FALSE;
#endif
}
  ...
  )
{
  ...
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
   ...
   || (DEM_CFG_RESET_DEBOUNCE_ON_ENABLE_ENABLE_CONDITIONS == STD_ON))
    lReturnValue = (boolean)(Dem_Cfg_IsDebounceContinuousOfDebounceTable(Dem_Cfg_GetDebounceTableIdxOfDebounceIndexTable(EventId)));
#else
  lReturnValue = FALSE;
#endif
...
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
  return (boolean)(Dem_Cfg_IsEventDebounceBehaviorOfDebounceTable(Dem_Cfg_GetDebounceTableIdxOfDebounceIndexTable(EventId)));
}
...
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
  return (uint8)(Dem_Cfg_GetEventDebounceAlgorithmOfDebounceTable(Dem_Cfg_GetDebounceTableIdxOfDebounceIndexTable(EventId)));
}
...
# if (DEM_CFG_SUPPORT_DEBOUNCE_COUNTER == STD_ON)
  return (sint16)(Dem_Cfg_GetFailedThresholdOfDebounceTable(Dem_Cfg_GetDebounceTableIdxOfDebounceIndexTable(EventId)));
# else
  return 1;
# endif
}
...
# endif
#else
  return DEM_CFG_DTC_J1939_INVALID;
#endif
}
 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Cfg_EventJ1939NodeIterExists(                                                                                                /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
 ...
 */
DEM_LOCAL_INLINE FUNC(uint8, DEM_CODE)
Dem_Cfg_EventJ1939NodeIterGet(                                                                                                   /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONSTP2CONST(Dem_Cfg_EventJ1939NodeIterType, AUTOMATIC, AUTOMATIC)  IterPtr                                                    /* PRQA S 3206 */ /* MD_DEM_3206 */
  )
{
  uint8 lNodeIndex = Dem_Cfg_GetInvalidJ1939NodeIndex();
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(IterPtr)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
#if (DEM_CFG_SUPPORT_J1939 == STD_ON)
    lNodeIndex = Dem_Cfg_GetJ1939NodeIdInd(IterPtr->mIdx);
#endif
  return lNodeIndex;
}
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Cfg_EventJ1939NodeIterInit(                                                                                                  /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONST(Dem_EventIdType, AUTOMATIC)  EventId,                                                                                    /* PRQA S 3206 */ /* MD_DEM_3206 */
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Cfg_EventJ1939NodeIterNext(                                                                                                  /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONSTP2VAR(Dem_Cfg_EventJ1939NodeIterType, AUTOMATIC, AUTOMATIC)  IterPtr                                                      /* PRQA S 3206, 3673 */ /* MD_DEM_3206, MD_DEM_8.13_fp */
  )
{
  IterPtr->mIdx += 1u;                                                                                                           /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
...
#if (DEM_CFG_SUPPORT_DEBOUNCE_COUNTER == STD_ON)
  lReturnValue = (sint16)(Dem_Cfg_GetJumpDownValueOfDebounceTable(Dem_Cfg_GetDebounceTableIdxOfDebounceIndexTable(EventId)));
#else
  lReturnValue = 0;
#endif
...
#if (DEM_CFG_SUPPORT_DEBOUNCE_COUNTER == STD_ON)
  lReturnValue = (sint16)(Dem_Cfg_GetJumpUpValueOfDebounceTable(Dem_Cfg_GetDebounceTableIdxOfDebounceIndexTable(EventId)));
#else
  lReturnValue = 0;
#endif
...
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
  return (boolean)(Dem_Cfg_IsEventLatchTFOfEventPrecompileDataTable(EventId));
}
...
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(IterPtr)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
#if (DEM_CFG_SUPPORT_WWHOBD == STD_ON) || (DEM_CFG_SUPPORT_OBDONUDS == STD_ON)
  return (boolean)(IterPtr->mIdx < IterPtr->mEndIdx);
#else
  return FALSE;
#endif
  ...
  )
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
#if (DEM_CFG_SUPPORT_WWHOBD == STD_ON) || (DEM_CFG_SUPPORT_OBDONUDS == STD_ON)
  IterPtr->mIdx = Dem_Cfg_GetDataCollectionTableFfm2CollIndStartIdxOfFreezeFrameTable(Dem_Cfg_GetFreezeFrameTableObdFFIdxOfEventTable(EventId));   /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
  IterPtr->mEndIdx = Dem_Cfg_GetDataCollectionTableFfm2CollIndEndIdxOfFreezeFrameTable(Dem_Cfg_GetFreezeFrameTableObdFFIdxOfEventTable(EventId));  /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
#else
  IterPtr->mIdx = 0u;                                                                                                            /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
  IterPtr->mEndIdx = 0u;                                                                                                         /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
#endif
...
#if (DEM_CFG_SUPPORT_DEBOUNCE_COUNTER == STD_ON)
  lReturnValue = (sint16)(Dem_Cfg_GetPassedThresholdOfDebounceTable(Dem_Cfg_GetDebounceTableIdxOfDebounceIndexTable(EventId)));
#else
  lReturnValue = 1;
#endif
  ...
  )
{
  ...
  return (uint16)(Dem_Cfg_GetPreconfirmedThresholdOfDebounceTable(Dem_Cfg_GetDebounceTableIdxOfDebounceIndexTable(EventId)));
#else
  Dem_Internal_AssertAlways(DEM_E_INCONSISTENT_STATE)
  return 0;
#endif
...
#if (DEM_CFG_SUPPORT_DEBOUNCE_COUNTER == STD_ON)
  lReturnValue = (sint16)(Dem_Cfg_GetIncrementStepSizeOfDebounceTable(Dem_Cfg_GetDebounceTableIdxOfDebounceIndexTable(EventId)));
#else
  lReturnValue = 0;
#endif
...
#if (DEM_CFG_SUPPORT_DEBOUNCE_COUNTER == STD_ON)
    lReturnValue = (sint16)(Dem_Cfg_GetDecrementStepSizeOfDebounceTable(Dem_Cfg_GetDebounceTableIdxOfDebounceIndexTable(EventId)));
#else
    lReturnValue = 0;
#endif
  ...
  )
{
...
#else
  lReturnValue = DEM_PRESTORAGEMEMORY_NOT_CONFIGURED_FOR_EVENT;
#endif
  ...
  return lReturnValue;
   ...
   || ( ( (DEM_FEATURE_NEED_STATISTICAL_DATA == STD_ON) || (DEM_FEATURE_NEED_EMISSIONOBD == STD_ON) ) && (DEM_CFG_DATA_PRIORITY == STD_ON)) )
/* ****************************************************************************
...
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
  return Dem_Cfg_GetSatelliteEventIdxOfEventPrecompileDataTable(EventId);
}
...
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
  return Dem_Cfg_GetSatelliteInfoIdxOfEventPrecompileDataTable(EventId);
}
 ...
 */
DEM_LOCAL_INLINE FUNC(uint16, DEM_CODE)
Dem_Cfg_GlobalSRecUdsSize(                                                                                                       /* PRQA S 3219 */ /*  MD_DEM_14.1_CONFIGURATION_SWITCH  */
  void
  )
{
  uint16 lGlobalSRecSize;

#if ((DEM_CFG_SUPPORT_DCM == STD_ON) && (DEM_CFG_SUPPORT_GLOBAL_SRECS == STD_ON))
  lGlobalSRecSize = (uint16)(Dem_Cfg_GetRecordSizeUdsOfFreezeFrameTable(Dem_Cfg_GetFreezeFrameTableIdxOfGlobalSnapshotRecord(0)));
#else
  lGlobalSRecSize = 0U;
#endif

  return lGlobalSRecSize;
}
...
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
  return (uint8)(Dem_Cfg_GetEventSignificanceOfEventPrecompileDataTable(EventId));
}
  ...
  )
{
  ...
  lReturnValue = (uint16)(Dem_Cfg_GetStorageThresholdOfDebounceTable(Dem_Cfg_GetDebounceTableIdxOfDebounceIndexTable(EventId)));
#else
  lReturnValue = 0u;
#endif
...
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
  return (boolean)(Dem_Cfg_IsAgingAllowedOfEventPrecompileDataTable(EventId));
}
...
/* ****************************************************************************
 % Dem_Cfg_IsObdIIOrObdOnUdsSupportedInVariant
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
{
  return (boolean)(Dem_Cfg_IsUseOBDIIOrOBDonUDSInVariant() == TRUE);                                                             /* PRQA S 2811, 2812, 2813 */ /* MD_DEM_Dir4.1_NullPointerDereference, MD_DEM_Dir4.1_NullPointerDereference, MD_DEM_Dir4.1_NullPointerDereference */
}


/* ****************************************************************************
 % Dem_Cfg_IsObdIIExclusivelySupportedInVariant
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
{
  return (boolean)((Dem_Cfg_IsUseOBDIIOrOBDonUDSInVariant() == TRUE) && (Dem_Cfg_IsUseOBDonUDSInVariant() == FALSE));            /* PRQA S 2812 */ /* MD_DEM_Dir4.1_NullPointerDereference */
}

/* ****************************************************************************
 % Dem_Cfg_IsObdOnUdsSupportedInVariant
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
{
  return (boolean)(Dem_Cfg_IsUseOBDonUDSInVariant() == TRUE);                                                                    /* PRQA S 2812 */ /* MD_DEM_Dir4.1_NullPointerDereference */
}

/* ****************************************************************************
 % Dem_Cfg_IsObdOnUdsSupported
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
{
  return (boolean)(DEM_CFG_SUPPORT_OBDONUDS == STD_ON);
}

/* ****************************************************************************
 % Dem_Cfg_IsZevOnUdsSupportedInVariant
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
{
  return (boolean)(Dem_Cfg_IsUseZEVonUDSInVariant() == TRUE);                                                                    /* PRQA S 2812 */ /* MD_DEM_Dir4.1_NullPointerDereference */
}

/* ****************************************************************************
 % Dem_Cfg_IsSRecSupportEnabled
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Cfg_IsSRecSupportEnabled(                                                                                                    /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
void
)
{
  return (boolean)(DEM_CFG_SUPPORT_SRECS == STD_ON);
}

/* ****************************************************************************
 % Dem_Cfg_IsGlobalSRecSupportEnabled
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Cfg_IsGlobalSRecSupportEnabled(                                                                                              /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
void
)
{
...
/* ****************************************************************************
 % Dem_Cfg_IsEmissionObdSupportedInVariant
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
{
  return (Dem_Cfg_IsObdIIExclusivelySupportedInVariant() || Dem_Cfg_IsWwhObdSupportedInVariant() || Dem_Cfg_IsObdOnUdsSupportedInVariant());
}

/* ****************************************************************************
 % Dem_Cfg_IsZeroEmissionObdSupportedInVariant
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Cfg_IsZeroEmissionObdSupportedInVariant(                                                                                     /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  void
)
{
  return Dem_Cfg_IsZevOnUdsSupportedInVariant();
}
...
{
  return (Dem_Cfg_IsEmissionObdSupportedInVariant() || Dem_Cfg_IsZeroEmissionObdSupportedInVariant());
}
...
#if (DEM_CFG_SUPPORT_DEBOUNCE_COUNTER == STD_ON)
  lReturnValue = (boolean)(Dem_Cfg_IsJumpDownOfDebounceTable(Dem_Cfg_GetDebounceTableIdxOfDebounceIndexTable(EventId)));
#else
  lReturnValue = FALSE;
#endif
...
#if (DEM_CFG_SUPPORT_DEBOUNCE_COUNTER == STD_ON)
    lReturnValue = (boolean)(Dem_Cfg_IsJumpUpOfDebounceTable(Dem_Cfg_GetDebounceTableIdxOfDebounceIndexTable(EventId)));
#else
    lReturnValue = FALSE;
#endif
  ...
  )
{
  ...
  return Dem_Cfg_GetRecordSizeUdsOfFreezeFrameTable(Dem_Cfg_GetFreezeFrameTableObdFFIdxOfEventTable(EventId));
#else
  return 0u;
#endif
}
...
/* ****************************************************************************
 % Dem_Cfg_EventObdOnUdsFFUdsSize
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL_INLINE FUNC(uint16, DEM_CODE)
Dem_Cfg_EventObdOnUdsFFUdsSize(                                                                                                  /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
 ...
 */
DEM_LOCAL_INLINE FUNC(uint16, DEM_CODE)
Dem_Cfg_GlobalDataElementCount(                                                                                                  /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  void
  )
{
...
/* ****************************************************************************
% Dem_Cfg_EventCountOfStatusBlock
*****************************************************************************/
/*!
* Internal comment removed.
 *
...
*/
DEM_LOCAL_INLINE FUNC(uint16, DEM_CODE)
Dem_Cfg_EventCountOfStatusBlock(                                                                                                 /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  void
  )
{
  return (uint16)DEM_G_NUMBER_OF_EVENTS;
}
...
{
#if (DEM_FEATURE_NEED_EMISSIONOBD == STD_ON) && (DEM_DEV_RUNTIME_CHECKS == STD_ON)
...
Dem_Cfg_GlobalNvBlockCount(                                                                                                      /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  void
  )
{
...
{
  return Dem_Cfg_GetDTCStatusAvailabilityMaskInVariant();
}
...
#if (DEM_CFG_SUPPORT_J1939 == STD_ON)
    lNodeId = Dem_Cfg_GetJ1939NodeId(NodeIndex);
#else
    lNodeId = DEM_CFG_NMNODEID_INVALID;
#endif
    return lNodeId;
}
...
{
  return DEM_CFG_NVBLOCK_ADMIN_INDEX;
}
#endif

#if (DEM_CFG_USE_NVM == STD_ON) && (DEM_CFG_SUPPORT_DEBOUNCE_NV == STD_ON)
/* ****************************************************************************
 % Dem_Cfg_NvBlockDebounceIndex
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
{
  return DEM_CFG_NVBLOCK_DEBOUNCE_INDEX;
}
#endif
 ...
 */
DEM_LOCAL_INLINE FUNC(Dem_Cfg_NvBlockIndexType, DEM_CODE)
Dem_Cfg_NvBlockDtrIndex(                                                                                                          /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  void
  )
{
#if (DEM_CFG_USE_NVM == STD_ON) && (DEM_CFG_SUPPORT_DTR == STD_ON)
  return DEM_CFG_NVBLOCK_DTR_DATA_INDEX;
#else
  Dem_Internal_AssertAlways(DEM_E_INCONSISTENT_STATE)
  return 0u;
#endif
...
/* ****************************************************************************
 % Dem_Cfg_NvBlockEventAvailableIndex
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
{
  return DEM_CFG_NVBLOCK_EVENT_AVAILABLE_INDEX;
}
#endif

/* ****************************************************************************
 % Dem_Cfg_NvBlockFreezeFrameIndex
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL_INLINE FUNC(Dem_Cfg_NvBlockIndexType, DEM_CODE)
Dem_Cfg_NvBlockFreezeFrameIndex(                                                                                                  /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  void
)
{
  Dem_Cfg_NvBlockIndexType lReturnValue;
#if (DEM_CFG_USE_NVM == STD_ON) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_ON)
  if (Dem_Cfg_IsObdIIOrObdOnUdsSupportedInVariant() == TRUE)
  {
    lReturnValue = DEM_CFG_NVBLOCK_FREEZEFRAME_INDEX;
  }
  else
#endif
  {
 ...
 */
DEM_LOCAL_INLINE FUNC(Dem_Cfg_NvBlockIndexType, DEM_CODE)
Dem_Cfg_NvBlockPermanentIndex(                                                                                                    /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  void
)
{
  Dem_Cfg_NvBlockIndexType lReturnValue;
  ...
  {
    lReturnValue = DEM_CFG_NVBLOCK_PERMANENT_INDEX;
  }
  else
#endif
  {
...
{
  return DEM_CFG_NVBLOCK_STATUS_INDEX;
}
#endif
...
{
  return DEM_CFG_NVBLOCK_AGING_INDEX;
}
#endif
...
/* ****************************************************************************
 % Dem_Cfg_NvBlockCycleCounterDataIndex
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
{
  return DEM_CFG_NVBLOCK_CYCLE_COUNTER_INDEX;
}
#endif
  ...
  )
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
#if (DEM_CFG_SUPPORT_WWHOBD == STD_ON)
  return (boolean)(Dem_Cfg_GetRecordSizeOfFreezeFrameTable(Dem_Cfg_GetFreezeFrameTableObdFFIdxOfEventTable(EventId)) != 0u);
#else
  return FALSE;
#endif
}
 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Cfg_SRecUpdate(                                                                                                              /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  CONST(Dem_Cfg_SRecIndexType, AUTOMATIC)  SRecIndex                                                                             /* PRQA S 3206 */ /* MD_DEM_3206 */
  )
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(SRecIndex)                                                                                    /* PRQA S 3112 */ /* MD_DEM_14.2 */
...
Dem_Cfg_SRecNumStartIdx(                                                                                                         /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_EventIdType  EventId                                                                                                       /* PRQA S 3206 */ /* MD_DEM_3206 */
)
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
#if (DEM_CFG_SUPPORT_SRECS == STD_ON)
  return Dem_Cfg_GetFreezeFrameNumTableStartIdxOfEventTable(EventId);                                                            /* PRQA S 2841 */ /* MD_DEM_Dir4.1_ReadOperation */
#else
  Dem_Internal_AssertAlways(DEM_E_INCONSISTENT_STATE)
  return 0u;
#endif
 ...
 */
DEM_LOCAL_INLINE FUNC(Dem_Cfg_SRecIndexType, DEM_CODE)
Dem_Cfg_SRecNumEndIdx(                                                                                                           /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_EventIdType  EventId                                                                                                       /* PRQA S 3206 */ /* MD_DEM_3206 */
)
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
#if (DEM_CFG_SUPPORT_SRECS == STD_ON)
  return Dem_Cfg_GetFreezeFrameNumTableEndIdxOfEventTable(EventId);                                                              /* PRQA S 2841 */ /* MD_DEM_Dir4.1_ReadOperation */
#else
  Dem_Internal_AssertAlways(DEM_E_INCONSISTENT_STATE)
  return 0u;
#endif
 ...
 */
DEM_LOCAL_INLINE FUNC(uint8, DEM_CODE)
Dem_Cfg_SRecNumConfigured(                                                                                                       /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_EventIdType  EventId                                                                                                       /* PRQA S 3206 */ /* MD_DEM_3206 */
)
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
#if (DEM_CFG_SUPPORT_SRECS == STD_ON)
    return (uint8) (Dem_Cfg_GetFreezeFrameNumTableEndIdxOfEventTable(EventId) -
    Dem_Cfg_GetFreezeFrameNumTableStartIdxOfEventTable(EventId));                                                                /* PRQA S 2841 */ /* MD_DEM_Dir4.1_ReadOperation */
#else
    Dem_Internal_AssertAlways(DEM_E_INCONSISTENT_STATE)
    return 0u;
#endif
...
/* ****************************************************************************
 % Dem_Cfg_FindJ1939NodeIndexFromNmNodeId
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL_INLINE FUNC(uint8, DEM_CODE)
Dem_Cfg_FindJ1939NodeIndexFromNmNodeId(                                                                                          /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  ...
  )
{
  ...
  lReturnValue = Dem_Cfg_GetInvalidJ1939NodeIndex();

  if (NmNodeId != DEM_CFG_NMNODEID_INVALID)
  {
    lNmNodeIndex = Dem_Cfg_GetInvalidJ1939NodeIndex();

    while (lNmNodeIndex > 0u)                                                                                                    /* PRQA S 2994 */ /* MD_DEM_2994 */
    {
      --lNmNodeIndex;
...
/* ****************************************************************************
 % Dem_Cfg_GetInvalidJ1939NodeIndex
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL_INLINE FUNC(uint8, DEM_CODE)
Dem_Cfg_GetInvalidJ1939NodeIndex(                                                                                                /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  void
  )
{
  return DEM_CFG_J1939_NODE_INVALID;
}
