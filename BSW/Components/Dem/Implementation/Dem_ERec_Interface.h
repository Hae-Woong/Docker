 ...
 *****************************************************************************/
/*!
 * \brief         Returns true if Aging through Reallocation is enabled
 * \details       Returns true if Aging through Reallocation is enabled
 *
 * \return        TRUE
 *                Support for Aging through Reallocation
 * \return        FALSE
 *                No support for Aging through Reallocation
 *
 * \pre           -
 *
 * \context       TASK|ISR2
 ...
 *                Sum size of all readable ERecs.
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Select the given extended data record
 *
 * \details       Select the given extended data record
 *
 * \param[in]     ClientId
 *                Unique client id, assigned to the instance of the calling
 *                module.
 ...
 *                used in context of service 0x191A and 0x1916.
 *
 * \param[in]     RecordNumber
 ...
 *****************************************************************************/
/*!
 * \brief         Function checks if an Extended Data Record is readable.
 *
 * \details       Find a certain extended data record number in the DataCollectionTable
 *                used in context of service 0x191A and 0x1916.
 *
 ...
 *
 * \return        TRUE
 *                Extended Data Record is readable
 *                FALSE
 *                Extended Data Record is not readable
 *
 * \pre           -
 *
 * \context       TASK|ISR2
 ...
 *****************************************************************************/
/*!
 * \brief         Check whether the provided extended data record is allowed in
 *                the current OBDonUDS variant.
 *
 * \details       Check whether the provided extended data record is allowed in
 *                the current OBDonUDS variant.
 *
 * \param[in]     DTCFormat
