 ...
 *****************************************************************************/
/*!
 * \brief         Get the event related to a ratio.
 *
 * \details       Get the event related to a ratio.
 *
 * \param[in]     RatioIndex
 *                Unique handle of the ratio
 *
 * \return        Event Id of the related event.
 *
 * \return        DEM_EVENT_INVALID if IUMPR is not enabled
 *
 * \pre           -
 *
 * \context       TASK|ISR2
 ...
 *****************************************************************************/
/*!
 * \brief         Initialize ratio specific information that is persisted to NvM
 *
