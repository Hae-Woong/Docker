...
/* ****************************************************************************
 * Dem_Mar_Mad_SetDenominatorIncrementQueued
 *****************************************************************************/
/*!
 * \brief         Set/Reset MAD increment queued flag
 *
 * \details       Set/Reset MAD increment queued flag
 *
 * \param[in]     IsQueued
 *                TRUE: Set MAD increment queued flag
 *                FALSE: Reset MAD increment queued flag
 *
 * \pre           -
 *
 * \context       TASK
...
/* ****************************************************************************
 * Dem_Mar_Mad_GetDenominatorIncrementQueued
 *****************************************************************************/
/*!
 * \brief         Tests if MAD increment is queued
 *
 * \details       Tests if MAD increment is queued
 *
 * \return        TRUE
 *                MAD increment request is queued
 * \return        FALSE
 *                No MAD increment request is queued
 *
 * \pre           -
 *
 * \context       TASK
...
{
#if (DEM_CFG_DATA_MONITOR_ACTIVITY_DATA == STD_ON)
  Dem_Cfg_ObdIumprData.MonitorActivityDenominatorIncrementationQueued = IsQueued;
#endif

  DEM_IGNORE_UNUSED_CONST_ARGUMENT(IsQueued)                                                                                     /* PRQA S 3112 */ /* MD_DEM_14.2 */
}
...
{
  boolean lIsQueued = FALSE;

#if (DEM_CFG_DATA_MONITOR_ACTIVITY_DATA == STD_ON)
  lIsQueued = Dem_Cfg_ObdIumprData.MonitorActivityDenominatorIncrementationQueued;
#endif
...
{
  Dem_Mar_Mad_SetDenominatorIncrementQueued(FALSE);
...
{
  Dem_Mar_Mad_SetDenominatorIncrementQueued(TRUE);
}
...
{
  if (Dem_Mar_Mad_GetDenominatorIncrementQueued()== TRUE)
  {
