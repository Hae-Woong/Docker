 ...
 *****************************************************************************/
/*!
 * \brief         Implementation of SWC API Dem_GetEventExtendedDataRecordEx().
 *
 * \details       This API is intended to be called via RTE_CALL interface,
 *                as Operation of port interface 'DiagnosticInfo'.
 *
...
*****************************************************************************/
/*!
* \brief         Tests if extended data record number can be read
*                out with SWC API.
*
* \details       Tests if extended data record number can be read
*                out with SWC API.
*
