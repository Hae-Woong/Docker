 ...
 *  \{
 *  \file       Dem_Client_Implementation.h
 *  \brief      Diagnostic Event Manager (Dem) header file
 *  \details    Implementation of Client Logical Unit
 *  \entity     Client
 *********************************************************************************************************************/
...
#if !defined (DEM_CLIENT_IMPLEMENTATION_H)
#define DEM_CLIENT_IMPLEMENTATION_H
...
#include "Dem_ClientIF_SvcImplementation.h"
#include "Dem_ClientIF_Implementation.h"
#include "Dem_ExtDataElement_Implementation.h"
