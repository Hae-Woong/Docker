  ...
  )
{
  ...
  else
  {
    ...
    {
      Dem_GlobalDiagnostics_EnableCondition_SetFulfilled(EnableConditionID);
    }
    else
    {
      Dem_GlobalDiagnostics_EnableCondition_ResetFulfilled(EnableConditionID);
    }
  ...
  )
{
  ...
  else
  {
    ...
    if (ConditionFulfilled == TRUE)
    {
      Dem_GlobalDiagnostics_StorageCondition_SetFulfilled(StorageConditionID);
    }
    else
    {
      Dem_GlobalDiagnostics_StorageCondition_ResetFulfilled(StorageConditionID);
    }
  ...
  )
{
  ...
  else
  {
    ...
    {
      *ConditionFulfilled = Dem_GlobalDiagnostics_EnableCondition_TestEnableConditionStateOfEvent(EventId);                      /* SBSW_DEM_POINTER_WRITE_API */
      lReturnValue = E_OK;
    }
  }
  ...
  )
{
  ...
  else
  {
    ...
    if (Dem_Cfg_IsWwhObdSupportedInVariant())
    {
      ...
      *B1Counter = (uint16)(Dem_GlobalDiagnostics_ActivationMode_B1Counter_GetValueInHours());                                   /* SBSW_DEM_POINTER_WRITE_API */
      lReturnValue = E_OK;
    }
  }
  ...
  )
{
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    Dem_GlobalDiagnostics_EnableCondition_ResetFulfilled(DEM_ENABLECONDITION_CONTROLDTCSETTING);
  ...
  )
{
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    Dem_GlobalDiagnostics_EnableCondition_SetFulfilled(DEM_ENABLECONDITION_CONTROLDTCSETTING);
  ...
  )
{
  ...
  if (Dem_Infrastructure_APIChecks_TestObdSupportedInVariant() == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_WRONG_CONDITION)
  }
  else
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    *PID1Cvalue = Dem_GlobalDiagnostics_GetGlobalObdRequirements();                                                              /* SBSW_DEM_POINTER_WRITE_API */
    lReturnValue = E_OK;
  }
  ...
  )
{
  ...
  else
  {
    /* ----- Implementation ------------------------------------------------ */
    uint16 lPid21Value;
    if ( Dem_Cfg_IsZevOnUdsSupportedInVariant() == TRUE )
    {
      lPid21Value = Dem_GlobalDiagnostics_GetDistanceTravelledSinceConfirmedDTC(); 
    }
    else
    {
      lPid21Value = Dem_GlobalDiagnostics_GetDistanceTravelledSinceMilOn();
    } 

    PID21value[0] = Dem_GetHiByte(lPid21Value);                                                                                  /* SBSW_DEM_POINTER_WRITE_API */
    PID21value[1] = Dem_GetLoByte(lPid21Value);                                                                                  /* SBSW_DEM_POINTER_WRITE_API */
    lReturnValue = E_OK;
  }
  ...
  )
{
  ...
  if (Dem_APIChecks_IsEmissionObdSupportedInVariant() == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_WRONG_CONDITION)
  }
  else
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    *PID30value = Dem_GlobalDiagnostics_GetWarmUpCycleCountSinceClear();                                                         /* SBSW_DEM_POINTER_WRITE_API */
    lReturnValue = E_OK;
  }
  ...
  )
{
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    uint16 lPid31Value = Dem_GlobalDiagnostics_GetDistanceTravelledSinceLastClear();
    PID31value[0] = Dem_GetHiByte(lPid31Value);                                                                                  /* SBSW_DEM_POINTER_WRITE_API */
    PID31value[1] = Dem_GetLoByte(lPid31Value);                                                                                  /* SBSW_DEM_POINTER_WRITE_API */
    lReturnValue = E_OK;
  }
  ...
  )
{
  ...
  else
  {
    ...
    if (Dem_Cfg_IsZevOnUdsSupportedInVariant() == TRUE)
    {
      lPid4D = Dem_GlobalDiagnostics_EngineRuntime_ConfirmedDTCRelatedData_GetTimeSinceConfirmedDTC();
    }
    else
    {
      lPid4D = Dem_GlobalDiagnostics_EngineRuntime_MilRelatedData_GetTimeSinceMilOn();
    }
  ...
  )
{
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    uint16 lPid4E = Dem_GlobalDiagnostics_EngineRuntime_ClearRelatedData_GetTimeSinceClear();
  ...
  )
{
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    PID91value[0] = Dem_GlobalDiagnostics_TranslateActivationMode(Dem_GlobalDiagnostics_ActivationMode_GetMILStatus());          /* SBSW_DEM_POINTER_WRITE_API */
    PID91value[1] = 0x00; /* continuous MI counter is latched at 255 hours */                                                    /* SBSW_DEM_POINTER_WRITE_API */
    PID91value[2] = (uint8)Dem_GlobalDiagnostics_ActivationMode_ContinuousMiCounter_GetValueInHours();                           /* SBSW_DEM_POINTER_WRITE_API */
    PID91value[3] = 0x00U; /* B1 counter is latched at 255 hours */                                                              /* SBSW_DEM_POINTER_WRITE_API */
    PID91value[4] = (uint8)Dem_GlobalDiagnostics_ActivationMode_B1Counter_GetValueInHours();                                     /* SBSW_DEM_POINTER_WRITE_API */
    lReturnValue = E_OK;
  }
  ...
  )
{
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    (void)Dem_Readiness_Readout_ReadDataOfPID01(PID01value, DEM_READINESS_PID01_SIZE);                                           /* SBSW_DEM_POINTER_FORWARD_API_ARGUMENT_BUFFER */
    lReturnValue = E_OK;
  }
...
)
{
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    (void)Dem_Readiness_Readout_ReadDataOfPID41(PID41value, DEM_READINESS_PID41_SIZE);                                           /* SBSW_DEM_POINTER_FORWARD_API_ARGUMENT_BUFFER */
    lReturnValue = E_OK;
  }
  ...
  )
{
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    (void)Dem_Readiness_Readout_ReadDataOfDIDF501(PIDF501value, DEM_READINESS_DIDF501_SIZE);                                     /* SBSW_DEM_POINTER_FORWARD_API_ARGUMENT_BUFFER */
    lReturnValue = E_OK;
  }
  ...
  )
{
  ...
  if (Dem_GlobalDiagnostics_Indicator_IsIndicatorIdValid(IndicatorId) == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_DATA)
  }
  else
  ...
  if ( (Dem_Cfg_IsWwhObdSupportedInVariant() == TRUE)
    && (Dem_GlobalDiagnostics_Indicator_GetGlobalMilIndicatorId() == IndicatorId) )
  {
    *IndicatorStatus = Dem_GlobalDiagnostics_ActivationMode_GetMILStatus();                                                      /* SBSW_DEM_POINTER_WRITE_API */
  }
  else
  {
    *IndicatorStatus = Dem_GlobalDiagnostics_Indicator_GetIndicatorState(IndicatorId, 0, TRUE);                                  /* SBSW_DEM_POINTER_WRITE_API */
  }
  ...
  )
{
  ...
  if (Dem_APIChecks_IsBoolean(PtoStatus) == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_DATA)
  }
  else
  ...
  else
  {
    ...
    {
      lReturnValue = Dem_GlobalDiagnostics_Pto_SetPtoStatus(PtoStatus);
    }
  }
  ...
  )
{
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    lReturnValue = Dem_GlobalDiagnostics_DisableEventMonitoring(EventId);
  }

  /* ----- Development Error Report ---------------------------------------- */
  if (Dem_Det_ErrorRegisterGet() != DEM_E_NO_ERROR)
  {
    Dem_Error_ReportError(DEM_DISABLEEVENTMONITORINGINCURRENTDCY_APIID, Dem_Det_ErrorRegisterGet());
  }
  return lReturnValue;
}                                                                                                                                /* PRQA S 6050, 6080 */ /* MD_MSR_STCAL, MD_MSR_STMIF */
