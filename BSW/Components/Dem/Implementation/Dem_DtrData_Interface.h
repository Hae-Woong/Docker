...
*****************************************************************************/
/*!
 * \brief         Returns whether or not DTRs are supported.
 *
 * \details       Returns whether or not DEM_CFG_SUPPORT_DTR is set to STD_ON.
 *
 * \return        TRUE
 *                Support for DTRs configured.
 * \return        FALSE
 *                No support for DTRs configured.
 *
 * \pre           -
 *
 * \context       TASK|ISR2
 ...
 *
 * \details       Must not be called with DEM_CFG_SUPPORT_DTR == STD_OFF.
 *
 * \param[in]     DTRId
 ...
 * \param[in]     LowerLimit
 *                The lower limit of TestValue.
 * \param[in]     UpperLimit
 *                The upper limit of TestValue.
 *
 * \pre           -
 *
 * \context       TASK|ISR2
 ...
 *
 * \details       Get the UaSId for the Dtr. Mind that the return value may be
 *                effectively uint8 or uint16. Conversion to one of these types
 *                shall be done on the knowledge about OBD on UDS configuration
 *                in the used variant.
 *
 * \param[in]     DtrId
 *                Unique handle of the Dtr.
...
*****************************************************************************/
/*!
 * \brief         Get the data of the given DTR.
 *
 * \details       Get the data of the DTR in case the owner event is available.
 *
 * \param[in,out] DestinationBuffer
 *                The destination buffer to copy the data to.
 *
 * \param[in]     DtrId
 *                The ID of the DTR to be read.
 *
 * \pre           The given DTR has a valid owner event configured. This may
 *                be assured by a call of Dem_DtrData_IsDtrOfEvent().
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
 * \reentrant     TRUE
...
*****************************************************************************/
/*!
 * \brief         Find out, whether the DTR belongs to the given event.
 *
 * \details       Returns TRUE in case the DTR belongs to the given event or
 *                in case of event compination type 1 to the given event group.
 *
 * \param[in]     DtrId
 *                The ID of the Dtr
 *
 ...
 *
 * \return        TRUE
 *                 The DTR belongs to the given event or event group.
 * \return        FALSE
 *                 The DTR does not belong to the given event
 *                 (or has not event configured)
 * \pre           -
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
