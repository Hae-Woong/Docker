 ...
 *****************************************************************************/
/*!
 * \brief         Check if OBD 3-Byte DTCs are supported in the active (PBS) variant
 *
 * \details       Check if OBD 3-Byte DTCs are supported in the active (PBS) variant
 *
 * \return        TRUE
 *                OBD 3-Byte DTCs are supported
 * \return        FALSE
 *                OBD 3-Byte DTCs are not supported
 *
 * \pre           -
 *
 * \context       TASK|ISR2
 ...
 *****************************************************************************/
/*!
 * \brief         Check if the requested DTC format is allowed with a given DTC origin
 *
 * \details       Check if the requested DTC format is allowed with a given DTC origin
 *
 * \param[in]     DTCFormat
 ...
 *
 * \return        TRUE
 *                The DTC format is allowed with the given DTC origin
 * \return        FALSE
 *                The DTC format is not allowed with the given DTC origin
 *
 * \pre           -
 *
 * \context       TASK|ISR2
 ...
 *****************************************************************************/
/*!
 * \brief         Check if the requested DTC format is supported in the active (PBS) variant
 *
 * \details       Check if the requested DTC format is supported in the active (PBS) variant
 *
 * \param[in]     DTCFormat
 *                The requested DTC Format
 * \param[in]     Context
 ...
 *****************************************************************************/
 /*!
  * \brief        Test if event's DTC has severity class B1
  *
  * \details      -
  *
  * \param[in]    EventId
  *               Unique handle of the event
  *
  * \return       TRUE: Event's DTC has severity class B1
  *               FALSE: Event's DTC has not severity class B1
  *
  * \pre           -
  *
  * \context       TASK|ISR2
 ...
 *****************************************************************************/
 /*!
  * \brief         Returns the WWH-OBD DTC Class of the given event
  *
  * \details       This function maps the severity of the given event to the 
  *                WWH-OBD DTC Class
 ...
 *****************************************************************************/
/*!
 * \brief        Test if event's DTC has a J1939 DTC
 *
 * \details      -
 *
 * \param[in]    EventId
 *               Unique handle of the event
 *
 * \return       TRUE: Event's DTC has a J1939 DTC
 *               FALSE: Event's DTC does not have a J1939 DTC
 *
 * \pre           -
 *
 * \context       TASK|ISR2
...
*****************************************************************************/
/*!
 * \brief         Get the OBD relevance of the event's DTC
 *
 * \details       Get the OBD relevance of the event's DTC dependent on the
 *                OBD DTC or ObdDtcClass
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *                The EventId must be in range [1..Dem_Cfg_GlobalEventCount()[.
 ...
 *****************************************************************************/
/*!
 * \brief         Find the event configured to use the requested DTC number
 *
 ...
 *
 * \pre           Function must only be invoked for the following memory Ids: 
 *                DEM_CFG_MEMORYID_PRIMARY
 *                DEM_CFG_MEMORYID_USERDEFINED_<MemoryID>
 ...
 *                of Confirmed and Wir bits are also taken into consideration.
 *
 *
...
*
* \details       Tests if the representive event is suppressed/available based
 ...
 * \return        FALSE
 *                The event or combined event group is not suppressed
 *
 * \pre           -
 *
 * \context       TASK|ISR2
 ...
 *                a permanent DTC. For B1 DTC additionally the B1 Counter is checked.
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *                The EventId must be in range [1..Dem_Cfg_GlobalEventCount()[.
