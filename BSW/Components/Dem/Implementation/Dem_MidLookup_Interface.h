...
*                Iterator runs over the elements in sequence or ascending 
*                Mid-value. In case of elements with identical Mid-Value, 
*                it runs over the elements in order of ascending Tid-value.
*
* \param[in]     IterPtr
*                Pointer to the iterator
*
...
*****************************************************************************/
/*!
* \brief         Get the DtrId of the element pointed to by the iterator.
*
* \details       Get the DtrId of the element pointed to by the iterator.
*
* \param[in]     IterPtr
*                Pointer to the iterator
*
* \return        Handle to DTR table
*
* \pre           IterPtr has been initialized.
* \config        DEM_CFG_SUPPORT_DTR == STD_ON
*
