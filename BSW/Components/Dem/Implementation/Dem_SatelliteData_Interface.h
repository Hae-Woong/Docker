 ...
 *****************************************************************************/
/*!
 * \brief         Reads the queued PTO timer action from the given satellite
 *                extended data object.
 *
 * \details       Reads the queued PTO timer action from the given satellite
 *                extended data object.
 *
 * \param[in]     SatelliteExtendedData
 *                The data object to read from.
 *
 * \return        Queued PTO timer action.
 *
 * \pre           Function should only be invoked when feature "PTO
 ...
 *****************************************************************************/
/*!
 * \brief         Queues the PTO timer action in the given satellite extended
 *                data object.
 *
 * \details       Queues the PTO timer action in the given satellite extended
 *                data object.
 *
 * \param[in]     SatelliteExtendedData
 *                The data object to read from.
 ...
 *****************************************************************************/
/*!
 * \brief         Clears PTO activation timer action in the given satellite 
 *                extended data object.
 *
 * \details       Clears PTO activation timer action in the given satellite 
 *                extended data object.
 *
 * \param[in]     SatelliteExtendedData
 *                The data object to read from.
 ...
 *****************************************************************************/
/*!
 * \brief         Queues the custom triggered freeze frame action in the given satellite
 *                extended data object.
 *
 * \details       -
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Clears the custom triggered freeze frame action in the given satellite 
 *                extended data object.
 *
 * \details       -
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Reads the queued custom triggered freeze frame action from the given
 *                satellite extended data object.
 *
 * \details       -
 *
 ...
 *                The data object to read from.
 *
 * \return        The queued custom triggered freeze frame action status
 *
 * \pre           Function should only be invoked when features "Custom Storage of 
 *                freeze frames" are supported
 *
