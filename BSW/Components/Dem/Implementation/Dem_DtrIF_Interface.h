 ...
 *****************************************************************************/
/*!
 * \brief         Gets the size of all DTRs of a specific event (group).
 *
 * \details       Gets the size of all DTRs of a specific event (group).
 *
 * \param[in]     EventId
 *                The ID of the event 
 *
 * \return        number of bytes which will be stored by function
 *                Dem_Dtr_GetDtrsOfEvent
 *
 * \pre           -
