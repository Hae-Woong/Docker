 ...
 *  \details    Type definitions of DTCIF subcomponent
 *  \entity     DTCIF
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
/*! Type to store the UDS status of a DTC */
typedef uint8 Dem_DTC_UDSStatusType;

/*! Type to store the internal status of a DTC */
...
struct Dem_DTC_Context_s
{
  ...
  boolean QualifyDTC;                     /*!< [in,out] Qualify single DTC without driving cycle qualification, due to OBD-II FF visibility */
};
...
struct Dem_DTC_ForEachCombinedArgType_s
{
  ...
  {                                                                                                                              /* PRQA S 0750 */ /* MD_MSR_Union */
    ...
    struct
   {
    ...
    struct
    {
      uint8 EventQualificationStatus;  /*!< Parameter used to retrieve the processed qualification status of DTC */
...
typedef P2VAR(Dem_DTC_ForEachCombinedArgType, TYPEDEF, DEM_VAR_NO_INIT) Dem_DTC_ForEachCombinedArgPtrType;
...
/*! DTC Format call context, used to identify in which API context a DTC Format request belongs to */
typedef enum
{
  Dem_DTCFormat_Context_SelectDTC,                 /*!< Context Dem_SelectDTC */
  Dem_DTCFormat_Context_SetDTCFilter,              /*!< Context Dem_SetDTCFilter */
  Dem_DTCFormat_Context_SetFilterByERecNumber,     /*!< Context Dem_SetDTCFilterByExtendedDataRecordNumber */
  Dem_DTCFormat_Context_SetFilterByReadinessGroup, /*!< Context Dem_SetDTCFilterByReadinessGroup */
  Dem_DTCFormat_Context_SetFFRecFilter,            /*!< Context Dem_SetFreezeFrameRecordFilter */
  Dem_DTCFormat_Context_SetERecFilter,             /*!< Context Dem_SetExtendedDataRecordFilter */
  Dem_DTCFormat_Context_GetDTCOfOBDFF              /*!< Context Dem_DcmGetDTCOfOBDFreezeFrame */
} Dem_DTCFormat_ContextType;
