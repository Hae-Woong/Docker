 ...
 *****************************************************************************/
DEM_LOCAL FUNC(boolean, DEM_CODE)
Dem_MemoryEntry_ExtendedEntry_TestDTCHasERecConfigured(
  CONST(uint8, AUTOMATIC)  ERecId,
  CONST(Dem_Cfg_CombinedGroupIndexType, AUTOMATIC)  CombinedDTCGroup,
...
Dem_MemoryEntry_ExtendedEntry_IterInit(
 ...
 *
 * \pre           ExtendedEntryIter->EventEntryIndex must be inside valid range
 * \config        -
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
 ...
 *****************************************************************************/
DEM_LOCAL FUNC(boolean, DEM_CODE)
Dem_MemoryEntry_ExtendedEntry_GetUserERecStorageStatus(
