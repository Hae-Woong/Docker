 ...
 */
/*!
 *  \defgroup   Dem_FaultMemory Dem FaultMemory
 *  \{
 *  \file       Dem_FaultMemory_Interface.h
 *  \brief      Diagnostic Event Manager (Dem) header file
 *  \details    Public Interface of Fault Memory Logical Unit
 *  \entity     FaultMemory
 *********************************************************************************************************************/
...
#if !defined (DEM_FAULTMEMORY_INTERFACE_H)
#define DEM_FAULTMEMORY_INTERFACE_H
...
#endif /* DEM_FAULTMEMORY_INTERFACE_H */

/*!
 * \}
 */
/* ********************************************************************************************************************
 *  END OF FILE: Dem_FaultMemory_Interface.h
 *********************************************************************************************************************/
