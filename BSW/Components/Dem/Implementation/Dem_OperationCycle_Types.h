...
#define DEM_OPERATIONCYCLE_CYCLE_QUALIFIED       (0x04U)     /*!< 0x04: Cycle state change from DCY unqualified to qualified */
...
# define Dem_OperationCycle_IsPendingDcyCycle()           (Dem_OperationCycle_DcyCycleFlag)
/*! Set qualification of DCY pending */
# define Dem_OperationCycle_SetPendingDcyCycle()          (Dem_OperationCycle_DcyCycleFlag = TRUE)
/*! Reset pending state of DCY qualification */
# define Dem_OperationCycle_ClearPendingDcyCycle()        (Dem_OperationCycle_DcyCycleFlag = FALSE)
