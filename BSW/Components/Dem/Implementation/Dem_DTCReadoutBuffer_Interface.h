...
/* ****************************************************************************
* Dem_DTCReadoutBuffer_SnapshotSource_GetCurrentTimeSeriesId
*****************************************************************************/
/*!
* \brief         Get the id of the series that should be read out
*
* \details       Get the id of the series that should be read out
*
* \param[in]     ReadoutBufferId
*                Index of the ReadoutBuffer
* 
* \return        Series id of series to be read out
*
* \pre           -
* \config        -
*
...
*****************************************************************************/
/*!
* \brief         Specify the series that should be read out next
*
* \details       Specify the series that should be read out next
*
* \param[in]     ReadoutBufferId
*                Index of the ReadoutBuffer
* 
* \param[in]     Value
*                What the series id should be set to
* 
* \pre           -
* \config        -
*
...
*****************************************************************************/
/*!
* \brief         Returns the time series entry index stored in the given readout
*                buffer.
*
* \details       Returns the time series entry index stored in the given readout
*                buffer.
*
* \param[in]     ReadoutBufferId
*                Index of the ReadoutBuffer
* 
* \return        Index of the time series entry in the readout buffer
*
* \pre           -
...
/* ****************************************************************************
 * Dem_DTCReadoutBuffer_GetUnusedFutureSamples
 *****************************************************************************/
/*!
 * \brief         Returns the captured event's unused future samples for 
 *                the specified series and set in the virtual buffer
 *
 * \details       -
 *
 * \param[in]     ReadoutBufferId
 ...
 *
 * \return        Unused future samples of set in virtual buffer
 *
 * \pre           -
 * \config        -
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Returns the index of the readout buffer in Dem_Cfg_EventEntryPtr
 *
 * \details       -
 *
 * \param[in]     ReadoutBufferId
 ...
 *                Index to ReadoutBufferData inside the ReadoutBuffer
 *
 * \return        Index of the readout buffer in Dem_Cfg_EventEntryPtr
 *
 * \pre           -
 *
 * \context       TASK|ISR2
 ...
 *****************************************************************************/
/*!
 * \brief         Get the memory id.
 *
 * \details       Get the memory id in the given readout buffer.
 *
 * \param[in]     ReadoutBufferId
 *                Index of the ReadoutBuffer, derived from the ClientId.
 *
 * \return        The memory id stored in the readout buffer.
 *
 * \pre           -
 * \config        DEM_CFG_SUPPORT_DCM == STD_ON
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Returns pointer to custom triggered snapshot data in ReadoutBuffer
 *
 * \details       -
 *
 * \param[in]     ReadoutBufferId
 *                Index of the ReadoutBuffer, derived from the ClientId.
 *
 * \return        Pointer to custom triggered snapshot data in ReadoutBuffer
 *
 * \pre           -
 * \config        DEM_CFG_SUPPORT_DCM == STD_ON
 *                && DEM_CFG_SUPPORT_CUSTOMTRIGGER_SREC == STD_ON
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
 * \reentrant     TRUE
 ...
 *****************************************************************************/
/*!
 * \brief         Returns pointer to custom triggered time series sample data
 *                in ReadoutBuffer
 *
 * \details       -
 *
 ...
 *                Index of the requested Tss sample in the custom trigger entry
 *
 * \return        Pointer to custom triggered time series sample in ReadoutBuffer
 *
 * \pre           -
 *
 * \config        DEM_CFG_SUPPORT_DCM == STD_ON
 *                && DEM_CFG_SUPPORT_CUSTOMTRIGGER_TSSR == STD_ON
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
 * \reentrant     TRUE
 ...
 *****************************************************************************/
/*!
 * \brief         Checks if requested record number is stored in
 *                readout buffer's custom trigger entry
 *
 * \details       -
 *
 * \param[in]     ReadoutBufferId
 ...
 *                A valid Custom trigger record number
 *
 * \pre           Record number passed to the function must be valid custom 
 ...
 *****************************************************************************/
/*!
 * \brief         Returns total number of custom triggered snapshot records and time
 *                series snapshot records stored in readout buffer
 *
 * \details       -
 *
 * \param[in]     ReadoutBufferId
 ...
 *                total number of custom triggered records stored
 *
 * \pre           -
 *
 * \context       TASK|ISR2
...
*****************************************************************************/
/*!
* \brief         Get pointer to copied memory independent counter in readout buffer.
*
* \details       Get pointer to copied memory independent counter in readout buffer.
*
* \param[in]     ReadoutBufferId
*                Index of the ReadoutBuffer, derived from the ClientId.
* \return        Pointer to memory independent counter copy in corresponding
*                readout buffer
* \pre           -
*
* \context       TASK|ISR2
 ...
 *                event entry of the readout buffer.
 *
 ...
 *
 * \pre           Readout buffer is initialized.
 * \config        DEM_CFG_SUPPORT_DCM == STD_ON &&
 ...
 *****************************************************************************/
/*!
 * \brief         Initialize event entry of the readout buffer.
 *
 * \details       Initialize event entry of the readout buffer.
 *
 * \param[in]     ReadoutBufferId
 *                Index of the ReadoutBuffer, derived from the ClientId.
 *
 ...
 *                the primary/user defined memory.
 *
 * \param[in]     ReadoutBufferId
 *                Index of the ReadoutBuffer, derived from the ClientId.
 * \param[in]     DTCSelector
 ...
 *****************************************************************************/
/*!
 * \brief         Release the event entry of the readout buffer.
 *
 * \details       Release the event entry of the readout buffer.
 * 
 * \param[in]     ReadoutBufferId
 *                Index of the ReadoutBuffer, derived from the ClientId.
 * \param[in]     DTCSelector
 ...
 *****************************************************************************/
/*!
 * \brief         Selects a data record, select the time series the record
 *                number belongs to, if any
 *
 * \details       Initializes the iterator for the selected event. Set the
 *                series Id used for time series readout
 *
 * \param[in]     ReadoutBufferId
 *                Index of the ReadoutBuffer
 * \param[in]     RecordNumber
