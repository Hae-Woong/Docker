 ...
 *                event entry as 1 byte data element.
 *
 * \details       Retrieves the occurrence counter of the event holding the
 *                event entry as 1 byte data element. An occurrence 
...
/*!
 * \brief         Retrieves the occurrence counter of the event holding the
 *                event entry as 2 byte data element
 *
 * \details       Retrieves the occurrence counter of the event holding the
 *                event entry as 2 byte data element
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Retrieves the 'Maximum FDC Since Last Clear' of the event 
 ...
 *                of the event holding the event entry.
 *
 ...
 *                the event holding the event entry.
 *
...
/*!
 * \brief         Retrieves the OBD DTC of the event that stored the
 *                event entry as 3 byte data element with trailing 0
 *
 * \details       Retrieves the OBD DTC of the event that stored the
 *                event entry as 3 byte data element with trailing 0
 *
...
#if ( (DEM_FEATURE_NEED_STATISTICAL_DATA == STD_ON) || (DEM_FEATURE_NEED_EMISSIONOBD == STD_ON) )
/* ****************************************************************************
* Dem_IntDataElement_CopyDtrsOfEvent
*****************************************************************************/
/*!
* \brief         Writes the DTRs of a specific event (group).
*
* \details       Writes DTRs in format:
*                NOTI, [ UASID_H, UASID_L, TestVal_H, TestVal_L, 
*                        MinLimit_H, MinLimit_L, MaxLimit_H, MaxLimit_L]
*                with: NOTI = Number of Test Results and 
*                      the part in [] is repeated NOTI times.
 ...
 *****************************************************************************/
/*!
 * \brief         Retrieves the ratio/IUMPR attached to the event
 *
 * \details       If ratio available copies
...
#if ( (DEM_FEATURE_NEED_STATISTICAL_DATA == STD_ON) || (DEM_FEATURE_NEED_EMISSIONOBD == STD_ON) )
/* ****************************************************************************
 * Dem_IntDataElement_CopyDtcIumpr
 *****************************************************************************/
/*!
 * \brief         Retrieves the ratio/IUMPR for a DTC
 *
 * \details       Copies the worst ratio/IUMPR of all events of a DTC
 *                in format
 *                [NumeratorHighByte] [NumeratorLowByte] [DenominatorHighByte] [DenominatorLowByte]
 *
 * \param[in,out] DidCopyInfoPtr
 ...
 *                was exceeded, of the event holding the event entry.
 *
 * \param[in,out] DidCopyInfoPtr
 *                CopyDid context
 *
 ...
 *                exceeded, of the event holding the event entry.
 *
 * \param[in,out] DidCopyInfoPtr
 *                CopyDid context
 *
...
#if ( (DEM_FEATURE_NEED_STATISTICAL_DATA == STD_ON) || (DEM_FEATURE_NEED_EMISSIONOBD == STD_ON) ) && (DEM_CFG_DATA_EXTENDED_ENV_DATA == STD_ON)
/* ****************************************************************************
...
/* ****************************************************************************
* Dem_IntDataElement_CopyMarOfEvent
*****************************************************************************/
/*!
* \brief         Retrieves the worst man of the DTC and the SMAR.
*
* \details       Retrieves the worst man of the DTC and the SMAR.
*
* \param[in,out] DidCopyInfoBasePtr
*                CopyDid Base context
*
* \return        TRUE
*                Data was copied
* \return        FALSE
...
#  if (DEM_CFG_SUPPORT_AGING_FOR_ALL_DTCS == STD_ON)
    Dem_Cfg_ReadoutMemIndeCounterConstPtrType lMemIndeCounterPtr;
#  else
    Dem_Internal_AssertReturnValue(DidCopyInfoPtr->EventEntryIndex != DEM_CFG_ENTRYINDEX_INVALID, DEM_E_INCONSISTENT_STATE, FALSE)
#  endif

#  if (DEM_CFG_SUPPORT_AGING_FOR_ALL_DTCS == STD_ON)
    lMemIndeCounterPtr = Dem_DTCReadoutBuffer_GetMemIndependentCounterPtr(DidCopyInfoPtr->ReadoutBufferId);
    if(lMemIndeCounterPtr != NULL_PTR)
    {
      /* aging counter is copied to readout buffer */
      lAgingCounter = lMemIndeCounterPtr->AgingCounter;
      lReturnValue = TRUE;
    }
    else
#  endif
    {
      lAgingCounter = Dem_Statistics_CalculateUpwardsAgingCounter(DidCopyInfoPtr->EventEntryIndex, DidCopyInfoPtr->Base.EventId);
      lReturnValue = TRUE;
    }
...
# if (DEM_CFG_DATA_OCCCTR_2BYTE == STD_ON)
  ...
  Dem_Data_WriteDestinationBufferUint16(DidCopyInfoPtr->Base.DestinationBuffer,                                                  /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
                                        Dem_MemoryEntry_EventEntry_GetOccurrenceCounter(DidCopyInfoPtr->EventEntryIndex));
  lReturnValue = TRUE;
...
# if (DEM_CFG_DATA_OVFLIND == STD_ON)
  ...
  Dem_Data_WriteDestinationBufferUint8(DidCopyInfoPtr->Base.DestinationBuffer,                                                   /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
                                      (uint8)Dem_FaultMemory_Memories_GetOverflow(                                               /* PRQA S 4304 */ /* MD_MSR_AutosarBoolean */
                                             Dem_Core_Event_GetDestination(DidCopyInfoPtr->Base.EventId)));
  lReturnValue = TRUE;
...
#  if (DEM_CFG_SUPPORT_AGING_FOR_ALL_DTCS == STD_ON)
    ...
    if(lMemIndeCounterPtr != NULL_PTR)
    {
      ...
      lDownwardAgingCounter = lMemIndeCounterPtr->AgingCounterInvert;
      lReturnValue = TRUE;
    }
    else
#  endif
    {
      ...
      lDownwardAgingCounter = Dem_Statistics_CalculateDownwardsAgingCounter(DidCopyInfoPtr->EventEntryIndex, DidCopyInfoPtr->Base.EventId);
      lReturnValue = TRUE;
    }
...
# if (DEM_CFG_DATA_MAX_FDC_SINCE_LAST_CLEAR == STD_ON)
  Dem_Internal_AssertReturnValue(DidCopyInfoPtr->Base.EventId != DEM_EVENT_INVALID, DEM_E_INCONSISTENT_STATE, FALSE)
  if (Dem_Core_Event_IsMemIndependentMaxFdcSlcSupported() == FALSE)
  {
    Dem_Internal_AssertReturnValue(DidCopyInfoPtr->EventEntryIndex != DEM_CFG_ENTRYINDEX_INVALID, DEM_E_INCONSISTENT_STATE, FALSE)
  }
...
#  if (DEM_CFG_SUPPORT_MEM_INDEPENDENT_MAX_FDC_SLC == STD_ON)
    Dem_Cfg_ReadoutMemIndeCounterConstPtrType lMemIndeCounterPtr;
    lMemIndeCounterPtr = Dem_DTCReadoutBuffer_GetMemIndependentCounterPtr(DidCopyInfoPtr->ReadoutBufferId);
    if (lMemIndeCounterPtr != NULL_PTR)
    {
      /* Get 'MaxFDCSinceLastClear' previously calculated and copied to readout buffer */
      lMaxFDCSinceLastClear = lMemIndeCounterPtr->MaxFDCSinceLastClear;
    }
    else
#  endif
    {
      /* Calculate 'MaxFDCSinceLastClear' */
      lMaxFDCSinceLastClear = Dem_Statistics_CalculateMaxFdcSinceLastClear(DidCopyInfoPtr->Base.EventId);
    }

    Dem_Data_WriteDestinationBufferUint8(DidCopyInfoPtr->Base.DestinationBuffer, (uint8)lMaxFDCSinceLastClear);                  /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    lReturnValue = TRUE;
  }
# else
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(DidCopyInfoPtr)                                                                               /* PRQA S 3112 */ /* MD_DEM_14.2 */
...
# if (DEM_CFG_DATA_MAX_FDC_DURING_CURRENT_CYCLE == STD_ON)
  ...
  Dem_Data_WriteDestinationBufferUint8(DidCopyInfoPtr->Base.DestinationBuffer,                                                   /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
                                       (uint8)Dem_Core_GetMaxFdcToc(DidCopyInfoPtr->Base.EventId));                              /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
  lReturnValue = TRUE;
...
#  if (DEM_CFG_SUPPORT_MEM_INDEPENDENT_CYCLE_COUNTERS == STD_ON)
    ...
    if (lMemIndeCounterPtr != NULL_PTR)
    {
      ...
      lFailedCycleCounter = lMemIndeCounterPtr->FailedCycles;
      lReturnValue = TRUE;
    }
    else
#  endif
    {
      ...
      lFailedCycleCounter = Dem_Statistics_CalculateFailedCycleCounter(DidCopyInfoPtr->EventEntryIndex, DidCopyInfoPtr->Base.EventId);
      lReturnValue = TRUE;
    }
...
# if (DEM_CFG_DATA_CONSECUTIVE_FAILED_CYCLES == STD_ON)
  ...
  Dem_Internal_AssertReturnValue(DidCopyInfoPtr->EventEntryIndex != DEM_CFG_ENTRYINDEX_INVALID, DEM_E_INCONSISTENT_STATE, FALSE)
  Dem_Data_WriteDestinationBufferUint8(DidCopyInfoPtr->Base.DestinationBuffer,                                                   /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
                                      Dem_MemoryEntry_EventEntry_GetConsecutiveFailedCycleCounter(DidCopyInfoPtr->EventEntryIndex));
  lReturnValue = TRUE;
...
# if (DEM_CFG_SUPPORT_MEM_INDEPENDENT_CYCLE_COUNTERS == STD_ON)
    ...
    if (lMemIndeCounterPtr != NULL_PTR)
    {
      ...
      lFaultPendingCounter = lMemIndeCounterPtr->FaultPendingCounter;
      lReturnValue = TRUE;
    }
    else
...
# endif
    {
      ...
      lFaultPendingCounter = Dem_Statistics_CalculateFaultPendingCounter(DidCopyInfoPtr->EventEntryIndex, DidCopyInfoPtr->Base.EventId);
      lReturnValue = TRUE;
    }
...
# if (DEM_CFG_DATA_CYCLES_TESTED_SINCE_FIRST_FAILED == STD_ON)
  ...
  Dem_Internal_AssertReturnValue(DidCopyInfoPtr->EventEntryIndex != DEM_CFG_ENTRYINDEX_INVALID, DEM_E_INCONSISTENT_STATE, FALSE)
  Dem_Data_WriteDestinationBufferUint8(DidCopyInfoPtr->Base.DestinationBuffer,                                                   /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
                                        Dem_MemoryEntry_EventEntry_GetTestedCyclesSinceFirstFailed(DidCopyInfoPtr->EventEntryIndex));
  lReturnValue = TRUE;
...
# if (DEM_CFG_DATA_CYCLES_TESTED_SINCE_LAST_FAILED == STD_ON)
  {
    ...
    if (lMemIndeCounterPtr != NULL_PTR)
    {
      ...
      lCyclesTestedSinceLastFailed = lMemIndeCounterPtr->CyclesTestSinceLastFailed;
      lReturnValue = TRUE;
    }
    else
    {
...
# if (DEM_CFG_DATA_HEALINGCTR_DOWNCNT == STD_ON)
  {
    ...
    if(lMemIndeCounterPtr != NULL_PTR)
    {
      ...
      lDownwardHealingCounter = lMemIndeCounterPtr->DownwardHealingCounter;
      lReturnValue = TRUE;
    }
    else
    {
...
# if (DEM_CFG_DATA_OBDDTC_3BYTE == STD_ON)
  uint32 lObd3ByteDtc = 0;
  
  Dem_Internal_AssertReturnValue(DidCopyInfoPtr->Base.EventId != DEM_EVENT_INVALID, DEM_E_INCONSISTENT_STATE, FALSE)

  if (Dem_Cfg_IsObdIIExclusivelySupportedInVariant() == TRUE)
  {
    lObd3ByteDtc = ((uint32)Dem_Cfg_EventObdDtc(DidCopyInfoPtr->Base.EventId) << 8u);
  }
  else if (Dem_Core_DTC_IsObdOnUds3ByteDTCSupportedInVariant() == TRUE)
  {
    lObd3ByteDtc = Dem_Core_Event_GetObdOnUds3ByteDtc(DidCopyInfoPtr->Base.EventId);
  }
  else
  {
    /* MISRA */
  }
  Dem_Data_WriteDestinationBufferUint8(DidCopyInfoPtr->Base.DestinationBuffer, Dem_GetHiLoByte(lObd3ByteDtc));                   /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
  Dem_Data_WriteDestinationBufferUint8(DidCopyInfoPtr->Base.DestinationBuffer, Dem_GetLoHiByte(lObd3ByteDtc));                   /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
  Dem_Data_WriteDestinationBufferUint8(DidCopyInfoPtr->Base.DestinationBuffer, Dem_GetLoLoByte(lObd3ByteDtc));                   /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
  lReturnValue = TRUE;
# else
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(DidCopyInfoPtr)                                                                               /* PRQA S 3112 */ /* MD_DEM_14.2 */
# endif
...
)
{
  ...
  {
    Dem_Internal_AssertReturnValue(DidCopyInfoBasePtr->EventId != DEM_EVENT_INVALID, DEM_E_INCONSISTENT_STATE, FALSE)
    Dem_Dtr_GetDtrsOfEvent(DidCopyInfoBasePtr);                                                                                  /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    lReturnValue = TRUE;
  }
  else
  {
  ...
  )
{
  ...
  Dem_Iumpr_CalculateDtcWorstObdRatio(DidCopyInfoPtr->Base.EventId, &lNumerator, &lDenominator);                                 /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */ /* SBSW_DEM_POINTER_FORWARD_STACK */
  Dem_Data_WriteDestinationBufferUint16(DidCopyInfoPtr->Base.DestinationBuffer, lNumerator);                                     /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
  Dem_Data_WriteDestinationBufferUint16(DidCopyInfoPtr->Base.DestinationBuffer, lDenominator);                                   /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
...
# if (DEM_FEATURE_NEED_CUSTOMIZED_MEMORY_PROCESSING == STD_ON)
  ...
  Dem_Data_WriteDestinationBufferUint8(DidCopyInfoPtr->Base.DestinationBuffer,                                                   /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
                                       Dem_MemoryEntry_EventEntry_GetOccurrenceCounter1(DidCopyInfoPtr->EventEntryIndex));
  lReturnValue = TRUE;
...
# if (DEM_FEATURE_NEED_CUSTOMIZED_MEMORY_PROCESSING == STD_ON)
  ...
  Dem_Data_WriteDestinationBufferUint8(DidCopyInfoPtr->Base.DestinationBuffer,                                                   /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
                                       Dem_MemoryEntry_EventEntry_GetOccurrenceCounter2(DidCopyInfoPtr->EventEntryIndex));
  lReturnValue = TRUE;
...
# if (DEM_FEATURE_NEED_CUSTOMIZED_MEMORY_PROCESSING == STD_ON)
  ...
  Dem_Data_WriteDestinationBufferUint8(DidCopyInfoPtr->Base.DestinationBuffer,                                                   /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
                                      Dem_MemoryEntry_EventEntry_GetOccurrenceCounter3(DidCopyInfoPtr->EventEntryIndex));
  lReturnValue = TRUE;
...
# if (DEM_FEATURE_NEED_CUSTOMIZED_MEMORY_PROCESSING == STD_ON)
  ...
  Dem_Data_WriteDestinationBufferUint8(DidCopyInfoPtr->Base.DestinationBuffer,                                                   /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
                                       Dem_MemoryEntry_EventEntry_GetOccurrenceCounter4(DidCopyInfoPtr->EventEntryIndex));
  lReturnValue = TRUE;
...
# if (DEM_FEATURE_NEED_CUSTOMIZED_MEMORY_PROCESSING == STD_ON)
  ...
  Dem_Data_WriteDestinationBufferUint8(DidCopyInfoPtr->Base.DestinationBuffer,                                                   /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
                                       Dem_MemoryEntry_EventEntry_GetOccurrenceCounter7(DidCopyInfoPtr->EventEntryIndex));
  lReturnValue = TRUE;
...
# if (DEM_FEATURE_NEED_CUSTOMIZED_MEMORY_PROCESSING == STD_ON)
  ...
  Dem_Data_WriteDestinationBufferUint8(DidCopyInfoPtr->Base.DestinationBuffer,                                                   /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
                                      Dem_MemoryEntry_EventEntry_GetPreConfirmedStatus(DidCopyInfoPtr->EventEntryIndex));
  lReturnValue = TRUE;
...

  {
    ...
    */
    ...
    lExternalTesterPresent =
      (uint8)(Dem_MemoryEntry_EventEntry_GetStdEnvData(DidCopyInfoPtr->EventEntryIndex, 0) & 0x02U);                             /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    ...
    {
      Dem_Data_WriteDestinationBufferUint8(DidCopyInfoPtr->Base.DestinationBuffer,                                               /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
                                           Dem_MemoryEntry_EventEntry_GetStdEnvData(DidCopyInfoPtr->EventEntryIndex, lDataIndex));
    }
    Dem_Data_WriteDestinationBufferUint8(DidCopyInfoPtr->Base.DestinationBuffer,                                                 /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
                                        (uint8)Dem_MemoryEntry_EventEntry_GetOccurrenceCounter(DidCopyInfoPtr->EventEntryIndex));
  ...
  )
{
...

  {
    ...
    */
    ...
    {
      Dem_Data_WriteDestinationBufferUint8(DidCopyInfoPtr->Base.DestinationBuffer,                                               /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
                                           Dem_MemoryEntry_EventEntry_GetStdEnvData(DidCopyInfoPtr->EventEntryIndex, lDataIndex + 5u));
    }
    lReturnValue = TRUE;
  }
...
)
{
  ...
  Dem_Data_WriteDestinationBufferUint8(DidCopyInfoPtr->Base.DestinationBuffer,                                                   /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
                                        Dem_Core_StatusIndicator_Get(DidCopyInfoPtr->Base.EventId));                             /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
  lReturnValue = TRUE;
...
*/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_IntDataElement_CopyMarOfEvent(                                                                                               /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONST(Dem_DataReport_DidCopyInfoBasePtrType, AUTOMATIC)  DidCopyInfoBasePtr                                                    /* PRQA S 3673 */ /* MD_DEM_8.13_Design */
)
{
  boolean lReturnValue;
  ...
  if (Dem_Cfg_IsObdOnUdsSupportedInVariant() == TRUE)
  {
    ...
    Dem_Data_WriteDestinationBufferUint8(DidCopyInfoBasePtr->DestinationBuffer,                                                  /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
      Dem_Mar_Man_CalculateWorstNumerator(DidCopyInfoBasePtr->EventId));                                                         /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    Dem_Data_WriteDestinationBufferUint8(DidCopyInfoBasePtr->DestinationBuffer,                                                  /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
      Dem_Mar_Smar_GetSmarByEventId(DidCopyInfoBasePtr->EventId));                                                               /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
...
)
{
  ...
  case DEM_CFG_DATA_FROM_IUMPR:
    lReturnValue = Dem_IntDataElement_CopyDtcIumpr(DidCopyInfoPtr);                                                              /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    break;
...
# endif
  ...
  case DEM_CFG_DATA_FROM_DTR:
    lReturnValue = Dem_IntDataElement_CopyDtrsOfEvent(&(DidCopyInfoPtr->Base));                                                  /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    break;

  case DEM_CFG_DATA_FROM_MONITOR_ACTIVITY_DATA:
    lReturnValue = Dem_IntDataElement_CopyMarOfEvent(&(DidCopyInfoPtr->Base));                                                   /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    break;
