...
#define DEM_SATELLITEINFO_PTOTIMERQUEUE_STATUS_POS              3u              /*!< Bit offset of the PTO timer queue status */
#define DEM_SATELLITEINFO_PTOTIMERQUEUE_STATUS_SIZE             1u              /*!< Size of PTO timer queue status flag*/

#define DEM_SATELLITEINFO_PTOTIMERQUEUE_STATUS                  DEM_NBIT(DEM_SATELLITEINFO_PTOTIMERQUEUE_STATUS_SIZE, DEM_SATELLITEINFO_PTOTIMERQUEUE_STATUS_POS)  /*!< Bit mask for queue status bit(s) */

#define DEM_SATELLITEINFO_CUSTOMTRIGGERQUEUE_STATUS_POS         4u              /*!< Bit offset of the custom trigger queue status */
#define DEM_SATELLITEINFO_CUSTOMTRIGGERQUEUE_STATUS_SIZE        1u              /*!< Size of custom trigger queue status flag*/

#define DEM_SATELLITEINFO_CUSTOMTRIGGERQUEUE_STATUS             DEM_NBIT(DEM_SATELLITEINFO_CUSTOMTRIGGERQUEUE_STATUS_SIZE, DEM_SATELLITEINFO_CUSTOMTRIGGERQUEUE_STATUS_POS)  /*!< Bit mask for queue status bit(s) */
...
/* ****************************************************************************
 % Dem_SatelliteInfo_ResetPtoTimerQueueUpdated
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL_INLINE FUNC(Dem_SatelliteInfo_Type, DEM_CODE)
Dem_SatelliteInfo_ResetPtoTimerQueueUpdated(                                                                                     /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_SatelliteInfo_Type  SatelliteInfo
  )
{
  Dem_SatelliteInfo_Type lReturnValue;                                                                                           /* PRQA S 0759 */ /* MD_MSR_Union */
  ...
  lReturnValue = SatelliteInfo;
  lReturnValue.Data.SatelliteStatus = (uint8)(lReturnValue.Data.SatelliteStatus & ~DEM_SATELLITEINFO_PTOTIMERQUEUE_STATUS);

  return lReturnValue;
}

/* ****************************************************************************
 % Dem_SatelliteInfo_GetPtoTimerQueueUpdated
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_SatelliteInfo_GetPtoTimerQueueUpdated(                                                                                       /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_SatelliteInfo_Type SatelliteInfo
  )
{
  return (boolean)((SatelliteInfo.Data.SatelliteStatus & DEM_SATELLITEINFO_PTOTIMERQUEUE_STATUS) != 0u);
}


/* ****************************************************************************
 % Dem_SatelliteInfo_SetPtoTimerQueueUpdated
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL_INLINE FUNC(Dem_SatelliteInfo_Type, DEM_CODE)
Dem_SatelliteInfo_SetPtoTimerQueueUpdated(                                                                                       /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_SatelliteInfo_Type SatelliteInfo
  )
{
  Dem_SatelliteInfo_Type lReturnValue;                                                                                           /* PRQA S 0759 */ /* MD_MSR_Union */
...
/* ****************************************************************************
 % Dem_SatelliteInfo_SetCustomTriggerQueueUpdated
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL_INLINE FUNC(Dem_SatelliteInfo_Type, DEM_CODE)
Dem_SatelliteInfo_SetCustomTriggerQueueUpdated(                                                                                  /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_SatelliteInfo_Type SatelliteInfo
  )
{
  Dem_SatelliteInfo_Type lReturnValue;                                                                                           /* PRQA S 0759 */ /* MD_MSR_Union */
  ...
  lReturnValue = SatelliteInfo;
  lReturnValue.Data.SatelliteStatus = (uint8)(lReturnValue.Data.SatelliteStatus | DEM_SATELLITEINFO_CUSTOMTRIGGERQUEUE_STATUS);

  return lReturnValue;
}

/* ****************************************************************************
 % Dem_SatelliteInfo_ResetCustomTriggerQueueUpdated
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL_INLINE FUNC(Dem_SatelliteInfo_Type, DEM_CODE)
Dem_SatelliteInfo_ResetCustomTriggerQueueUpdated(                                                                                /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_SatelliteInfo_Type SatelliteInfo
  )
{
  Dem_SatelliteInfo_Type lReturnValue;                                                                                           /* PRQA S 0759 */ /* MD_MSR_Union */
...
/* ****************************************************************************
 % Dem_SatelliteInfo_GetCustomTriggerQueueUpdated
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_SatelliteInfo_GetCustomTriggerQueueUpdated(                                                                                  /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_SatelliteInfo_Type SatelliteInfo
  )
{
  return (boolean)((SatelliteInfo.Data.SatelliteStatus & DEM_SATELLITEINFO_CUSTOMTRIGGERQUEUE_STATUS) != 0u);
}
