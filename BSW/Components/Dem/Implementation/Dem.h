 ...
 *            2018-08-16  visavi       STORYC-5364   Extract subcomponent StorageManager Functional
 ...
 *            2018-10-01  visanh       ESCAN00100905 Compiler warning: last line of Dem_FaultMemory_Memories_Implementation.h ends without a newline
 ...
 *            2020-10-08  visern       ESCAN00109688 MISRA deviation: MISRA-C:2012 Rule 9.1 in file Dem_Satellite_Implementation.h 
 ...
 *  20.04.00  2020-12-15  visejz       DEM-5307      Renamed APIs to match naming pattern of working guidelines
 *            2020-12-11  visern       DEM-5310      Renamed compiler switches to match naming pattern of working guidelines
 ...
 *  21.00.00  2021-03-17  visejz       DEM-5391      Implementation: Resplit units to match CAD.
 *            2021-03-19  visera       DEM-5277      Provide IUMPR data per DTC as extended data record
 *            2021-03-31  visern       ESCAN00108875 Supported status of PID $41 is calculated incorrectly while using API Dem_SetEventDisabled()
 *  21.01.00  2021-04-09  visxli       ESCAN00108650 Update of Freeze Frame with trigger condition FDC is not performed
 *            2021-04-14  visavi       ESCAN00109000 Incorrect type definition of parameter in CallbackDTCStatusChange
 *            2021-04-21  visrk        DEM-4738      Provide DTR data per DTC as extended data record
 *            2021-04-23  haelvero     CARC-1277     Circular buffer behavior of snapshot records
 *            2021-04-26  visern       DEM-5471      OBDonUDS FF: Configuration and Storage
 *            2021-04-26  visern       DEM-5480      OBDonUDS FF: Readout through 0x19-04
 *  21.02.00  2021-05-17  visxli       ESCAN00109135 Service 19 04 reports inconsistent size of OBD Freeze Frame
 *            2021-05-18  visera       DEM-5610      Support OBD Relevant events without OBD DTC Number
 *            2021-05-20  visxli       DEM-5553      Support OBDonUDS Freeze Frame Prestorage
 *            2021-05-25  visern       DEM-5547      Support OBDonUDS Freeze Frame Readout through 0x19-03
 *            2021-05-26  visern       DEM-5774      Support 0xFFFF33 in ClearDTC request for OBDonUDS
 *            2021-05-26  haelvero     CARC-1406     OBDonUDS FF: Readout through SWC API and Data Recovery
 *  21.03.00  2021-06-10  visrk        DEM-5724      Improve Service 0x1916 in order to support ERec 0x92
 *            2021-06-24  visxli       DEM-5495      Enabled OBDonUDS Legislation in validation rule
 *            2021-06-24  visern       DEM-5712      Fixed QAC Findings
 *  21.04.00  2021-07-09  visejz       ESCAN00109612 In service 19 03 Dem omits one  DTC or reports Det error and becomes unoperative
 *            2021-07-13  visern       DEM-5901      Support DID 0xF501 API
 *            2021-07-04  visera       DEM-5645      Incompatible feature in variants of a PBS configurations
 *  21.05.00  2021-08-03  visrk        DEM-5885      Enable Mode $06 APIs with OBD on UDS
 *            2021-08-04  vireno       DEM-5764      Support OBD Monitor Activity Ratio
 *            2021-08-05  visxli       DEM-6009      Extend OBDOnUDS APIs by Dem_DTCFormatType
 *            2021-08-18  visrk        ESCAN00109996 Memory read from wrong address in function Dem_DcmGetDTCOfOBDFreezeFrame
 *            2021-08-18  visera       ESCAN00109710 DTC and Freeze Frame Data reported in mode $02 although no DTC stores a Freeze Frame 
 *            2021-08-19  visern       DEM-6114      Service 19 16 performs out of bounds read access 
 *            2021-08-20  visavi       ESCAN00109995 OBD FreezeFrame invisible over Mode $02 after ECU Reset
 *            2021-08-25  visera       ESCAN00110048 Runtime check fails following which diagnostic functionality could be unavailable
 *  22.00.00  2021-09-03  visern       DEM-5871      EnableConditions are refactored in Global Diagnostics.
 *            2021-09-03  visern       ESCAN00110208 DEM does not reset or freeze FDC values of Events, after modification of EnableCondition
 *            2021-09-07  visera       DEM-6071      Make extended data records post build loadable (PBL)
 *            2021-09-10  abjoerkqvist CARC-1755     Support data element size of 4096 bytes for external data elements
 *            2021-09-23  visavi       ESCAN00110284 Linker Error: Variable "Dem_Mar_NumOfPendingEvents" cannot be located
 *  22.01.00  2021-10-07  visern       DEM-5880      StorageConditions are refactored in Global Diagnostics.
 *  22.02.00  2021-10-19  vsarcmiem    CARC-1982     Support integer typed C/S interfaces for Dem
 *            2021-10-20  abjoerkqvist CARC-1857     Support float typed C/S interfaces for Dem
 *            2021-11-15  visabn       ESCAN00110700 Compiler warning: Dem_Memory_TimeSeries_RingBuffer_GetNormalSlot declared static but never defined
 *  22.03.00  2021-11-26  visfrs       DEM-6214      Indicators is refactored in Global Diagnostics
 *            2021-11-26  visfrs       ESCAN00111145 Selected Indicators associated with a confirmed event are not enabled
 *            2021-11-30  visavi       DEM-4811      Support user defined fault memories according to ISO 14229-1
 *            2021-12-05  visavi       DEM-6522      Improve Dem_ExtDataElement_CollectUserData_XY() functions in ExtDataElement Unit
 *            2021-12-09  visera       DEM-6454      Support IDSM relevant aspects of API Dem_GetFreezeFramePrestored()
 *            2021-12-13  visxli       DEM-6325      Support clearing internal events
 *  22.04.00  2022-01-11  visxli       ESCAN00111015 Compiler warning: Possible loss of data due to incorrect conversion from Dem_GlobalState_Indicator_IndicatorCounterTableIndexType to uint16
 *            2022-01-11  visxli       ESCAN00111031 Compiler warning: Possible loss of data due to incorrect conversion from uint16_least to uint16
 *            2022-01-11  visxli       DEM-6613      Restructure function Dem_ClearTask_ProcessClearDtc()
 *  22.05.00  2022-01-20  abjoerkqvist CARC-2243     Support an individual freeze frame record numeration type for each event memory
 *            2022-01-28  visxli       ESCAN00110984 Indicator status not reset OR incorrectly set after Clear DTC Operation
 *            2022-01-28  visxli       ESCAN00111148 Indicator status not reset OR incorrectly set after OBD FF becomes visible and Clear DTC Operation afterwards
 *            2022-01-28  visxli       ESCAN00111140 EventStatusChanged notifications are not invoked for all relevant events belonging to a CombinedDTC
 *            2022-02-03  visavi       DEM-6639      Reevaluate QAC Justification for Rule 0883
 *            2022-02-09  eacar        ESCAN00111229 Provided synchronous or reentrant information is wrong for multiple APIs
 *  22.06.00  2022-02-15  visern       ESCAN00110167 Wrong IUMPR Ratio reported for a combined DTC in OBD on UDS Extended Data Record 0x91
 *            2022-02-16  visern       ESCAN00110985 Indicator status incorrect after healing and/or after Clear DTC Operation
 *            2022-02-18  visavi       DEM-6705      Improve SafeBSW Justifications
 *            2022-02-21  visern       DEM-5572      Improve DestinationBuffer
 *            2022-02-22  visxli       ESCAN00110725 Completed Status of Comprehensive Component Monitors in PID 0xF501 is not calculated as defined by SAE J1979-DA
 *            2022-02-25  visxli       ESCAN00110661 Update of Monitor Activity Ratio is not delayed to the end of the driving cycle
 *            2022-03-01  visera       ESCAN00111350 Compiler warning: Possible loss of data due to incorrect conversion from Dem_Cfg_FreezeFrameNumTableStart- and -EndIdxOfEventTableType to uint8
 *            2022-03-03  visera       DEM-6581      Post-Build: Check CSL Hashcode during initialization
 *  23.00.00  2022-03-21  visfrs       DEM-5999      WWHOBD Activation Mode refactored
 *            2022-03-24  visabn       DEM-5090      Support an individual storage trigger for each event memory
 *            2022-04-01  visern       Dem-6842      Support DID data length in Service 19 04
 *  23.01.00  2022-04-22  visern       ESCAN00111651 B1 Counter is reset after three driving cycles although a B1 DTC is currently failed
 *            2022-05-03  visera       DEM-6442      OBD for J1939: Read Emission Related (DM6, DM12, DM23), Permanent DTCs (DM28) and DTC Counts (DM29)
 *  23.02.00  2022-05-20  visanh       ESCAN00111832 After a DM11 request general diagnostic information is not reset
 *            2022-05-24  visera       DEM-6483      OBD for J1939: Monitor Performance Ratio (DM20)
 *            2022-05-30  viswsi       DEM-7093      Fix typos
 *  23.03.00  2022-06-07  visxli       DEM-6754      Support configuration of Time Series Snapshot Record Numbers
 *            2022-06-23  visanh       ESCAN00111690 Continuous MI Counter is reset after a clear request for a single DTC
 *            2022-06-24  visanh       ESCAN00111672 Dem_GetSizeOfFreezeFrameSelection returns wrong size of snapshot record selection for a combined DTC
 *            2022-06-28  visabn       DEM-6559      OBD for J1939: Diagnostic Readiness 1 (DM5)
 *  23.04.00  2022-07-14  eacar        ESCAN00112273 OBDII Freeze Frames of unconfirmed events are not deleted during initialization when pending bit is set
 *            2022-07-19  viswsi       DIAGAP-6803   OBD for J1939: Diagnostic Readiness 2 (DM21)
 *            2022-07-20  viswsi       DEM-7241      Update and improve spelling
 *  23.05.00  2022-07-30  visanh       DEM-6031      PID $01 and PID $41 refactored
 *            2022-08-01  visxli       DEM-6989      Support PTO for IUMPR (DM20)
 *            2022-08-09  visera       ESCAN00112223 Dem-Dcm API to read size of a Freeze Frame returns incorrect Return Value
 *            2022-08-12  visabn       ESCAN00112402 During Data recovery for DTC stored in Permanent memory, WIR bit is set but MIL status is off
 *            2022-08-11  visavi       ESCAN00112003 Service 0x19-06 reports Extended Data Records of an event with an Aging Only memory entry
 *            2022-08-22  visavi       ESCAN00112451 OBD events do not age after 40/41 aging cycles
 *            2022-08-23  visavi       ESCAN00112615 Compiler error: identifier "Dem_EventOBDReadinessGroupType" is undefined
 *  24.00.00  2022-09-01  visabn       DEM-7419      Improvement for Service 0x19 03 with J1939 DTC Format
 *            2022-09-03  visxli       DEM-4742      Usage of <Ma>_MemMap.h in Dem
 *            2022-09-06  visabn       ESCAN00112634 Non-Continuously Monitored Systems Status (Byte 7, 8) is incorrect in Diagnostic Readiness 1 for J1939
 *            2022-09-01  visavi       DEM-7349      Remove Compatibility Switch
 *            2022-09-15  visavi       ESCAN00105750 Snapshot Record cannot be stored as defined by the OEM requirement
 *            2022-09-19  visavi       ESCAN00112750 Compiler warning: Alignment cannot be decreased from 4 bytes to 2 byte
 *  24.01.00  2022-09-23  visabn       DEM-7073      Support OBD for J1939: SPNs in Expanded Freeze Frame (DM24)
 *            2022-09-29  visera       DEM-6592      OBD for J1939: Diagnostic Readiness 3 (DM26) - Read PID $30 and Engine Runtime (Part 1)
 *            2022-10-05  vsghbk       DEM-7482      Supported unique identifier for Sequential DID identifier
 *            2022-10-10  abjoerkqvist CARC-3155     Support trigger Test Failed for Time Series Snapshot Records
 *            2022-10-13  visabn       DEM-7529      OBD for J1939: Expanded Freeze Frame (DM25)
 *  24.02.00  2022-11-04  visabn       ESCAN00112903 Undefined behavior while collecting Odometer from application inside the DEM Main Function
 *  24.03.00  2022-11-18  visera       DEM-6961      OBD for J1939: Diagnostic Readiness 3 (DM26) - Readiness this Driving Cycle
 *            2022-12-08  visabn       ESCAN00113229 Compile Error by a Combination Type 2 Configuration with no DCM support
 *  24.04.00  2022-12-13  visxli       DEM-6914      OBD for J1939: Support PTO Activation Timer (DM05)
 *            2022-12-21  visabn       DEM-7045      OBD for J1939: Support PTO Recalculation of Readiness Since Last Clear (DM05)
 *            2023-01-03  visavi       ESCAN00112876 Availability of OBD MIDs incorrectly considered or reported in Mode $06      
 *            2023-01-09  visavi       ESCAN00112985 Dem_J1939DcmGetNextFreezeFrame() returns invalid J1939 (expanded) Freeze frame
 *            2023-01-10  visavi       ESCAN00113141 DEM could write at a wrong memory location based on the compiler abstraction
 *            2023-01-11  visera       ESCAN00112915 J1939Dcm_DemTriggerOnDTCStatus invoked for J1939 DTCs not stored in Primary Memory
 *  24.05.00  2023-01-30  abjoerkqvist CARC-3329     Support a separated OBD DTC list for OBDonUDS services
 *            2023-02-07  visabn       DEM-7556      Improve Dem_Cfg_UnsupportedReadinessGroups Table
 *  24.06.00  2023-02-14  visavi       ESCAN00112730 The Extended FiM API FiM_DemTriggerOnUnconfirmed() is invoked earlier than expected
 *            2023-02-15  visavi       ESCAN00113847 While reading out Global Freeze Frames using API Dem_GetFreezeFrameDataEx(), the number of bytes written is not returned correctly
 *            2023-02-15  tfarahani    ESCAN00113598 Response to request of Availability OBD MIDs (0x00, 0x20, ..., 0xE0) wrongly indicates that subsequent ranges have supported OBD MIDs
 *            2023-02-15  visabn       ESCAN00113450 Monitor Activity Numerator(MAN) is incorrectly incremented even if event commanding MIL is Pending
 *            2023-02-21  visabn       ESCAN00113668 Confirmation of event is delayed during Dem Restart
 *            2023-02-21  visabn       ESCAN00113473 Monitor Activity Denominator(MAD) is incorrectly NOT incremented
 *            2023-02-21  visavi       ESCAN00113936 Incorrect value of PID21/J1939Readiness2 returned by DEM, if unable to retrieve current Odometer from the Application
 *            2023-02-24  visxli       DEM-7259      Implement Functionality of TSSR in UDM
 *            2023-03-06  visavi       ESCAN00113829 Compiler warning: conversion from 'const Dem_ExtCom_FiMFunctionIdType' to 'FiM_FunctionIdType', possible loss of data
 *  25.00.00  2023-05-12  tfarahani    DEM-5955      Refactor Odometer, PID21, PID31, PermanentActivationDistance in GlobalDiagnostics
 *            2023-05-30  tfarahani    DEM-8649      Removed LU GlobalState
 *  25.01.00  2023-06-06  visanh       ESCAN00114451 B1 Counter is reset too early when ECU is restarted
 *            2023-06-06  visanh       ESCAN00114290 B1 Counter is reset either too late or not at all when ECU is restarted
 *            2023-06-06  visanh       ESCAN00114480 B1 Counter resets too early after clear request
 *            2023-06-06  visanh       ESCAN00114294 Reset of PID21 and PID4D works incorrectly during reinitialization of the DEM
 *            2023-06-06  visanh       ESCAN00114372 Write-Access out of bounds during DEM restart
 *            2023-06-13  tfarahani    DEM-5975      PID$30 & PID-Aging & PID$1C & PID$91 refactored
 *  25.02.00  2023-07-04  visabn       DEM-8433      Support for Time Series Snapshot FIFO Storage
 *            2023-07-04  visabn       ESCAN00115030 Compiler warning: Possible loss of data due to incorrect conversion from uint16_least to uint16
 *            2023-07-14  tfarahani    DEM-8722      Move RingBuffer and Sampler to GlobalDiagnostics
 *            2023-07-20  tfarahani    ESCAN00114382 Out of bound read access when invoking API Dem_GetSizeOfFreezeFrameSelection
 *            2023-07-21  visfrs       ESCAN00115075 During Service 0x19-04/0x19-18 to read out all records, DEM may cause DCM to respond incorrectly
 *            2023-07-26  visanh       ESCAN00114323 During Service 0x19-04/0x19-18 to read out all records, DEM does not retry reading the same record if DEM_BUFFER_TOO_SMALL is returned
 *  25.03.00  2023-07-31  visanh       ESCAN00114862 DEM doesn't reset or freeze FDC of Events, when disabling of multiple EnableConditions is prcoessed in single MainFunction
 *            2023-08-02  visanh       ESCAN00114543 During Service 0x19-06, DEM does not retry reading the same record if DEM_BUFFER_TOO_SMALL is returned
 *            2023-08-11  tfarahani    ESCAN00115249 Fixed IUMPR data cannot be incremented for ratio linked to previously unavailable event
 *            2023-08-18  visera       ESCAN00115010 Untested driving cycle can lead to resetting B1 counter too early
 *  26.00.00  2023-09-09  vsarcsiiv    ESCAN00115535 DCM call to retrieve time series samples directly after an update has been stored leads to reading out old future time series samples
 *            2023-09-15  akarlsson    CARC-3687     Support trigger TFTOC for Time Series Snapshot Records
 *            2023-09-22  visabn       DEM-8520      Re-Design of DEM Time Series Data Structure (Snapshot Data)
 *            2023-09-25  tfarahani    DEM-9129      Improve Readiness Runtime
 *  26.01.00  2023-10-12  visabn       ESCAN00115827 Compiler warning: White space between backslash and newline in line splice ignored
 *            2023-10-18  visfrs       ESCAN00115688 Compiler warning for enable conditions: cast truncates constant value
 *  26.02.00  2023-10-24  tfarahani    DEM-9084      Refactor Status Units in Core
 *            2023-10-25  tfarahani    DEM-9177      Refactor Stored Status
 *  26.03.00  2023-11-29  visanh       ESCAN00116080 CDTC status bit is set incorrectly during DEM initialization
 *            2023-11-30  visxli       DEM-9264      SAE Event Combination Healing
 *            2023-12-05  tfarahani    ESCAN00116206 OBD MIDs incorrectly considered as being supported after initialization of Dem
 *            2023-12-08  visanh       ESCAN00116143 Event is not confirmed once similar conditions are fulfilled
 *            2023-12-08  emalekzadeh  CARC-3879     SAE Event Combination Pending bit
 *  26.04.00  2023-12-13  visabn       DEM-9315      Custom Snapshot Storage Trigger API 
 *  26.04.00  2024-01-04  vsgeei       CARC-3774     Support new legislation and Functional Group Identifier (FGID) 0x33 for ZEVonUDS
 *  26.04.00  2024-01-09  akarlsson    CARC-3833     Support a configurable number of time series sampling profiles
 *  26.05.00  2024-01-19  emalekzadeh  CARC-3799     ZEVonUDS: Support Service 0x19 0x42
 *            2024-01-19  tfarahani    DEM-9567      Refactor DTC Aging
 *            2024-01-25  vsgeei       CARC-3792     ZEVonUDS: Support Service 0x14
 *            2024-01-25  visxli       DEM-9243      Storage of Custom Triggered Snapshot Records
 *  26.06.00  2024-02-07  tfarahani    ESCAN00116368 Ford Spec Deviation - MaxFdcSLC not always valid / available during readout
 *            2024-02-09  tfarahani    ESCAN00116447 After hard reset/ battery disconnect only WIR but not CDTC status bit is set
 *            2024-02-14  visera       DEM-9703      Improve Size of EventTable
 *            2024-02-15  visabn       DEM-9300      Support for Custom Triggered Time Series Snapshot Records
 *            2024-02-19  emalekzadeh  CARC-3793     ZEVonUDS: Support PID $21
 *            2024-02-21  visxli       DEM-9317      Custom Triggered Snapshot Records: Displacement and Immediate Storage
 *            2024-02-21  akarlsson    CARC-3862     Support TSSR multi trigger
 *            2024-02-22  tfarahani    ESCAN00116678 Misfire monitoring incorrectly indicated as complete in DID 0xF501 
 *            2024-03-05  cta          CARC-3913     Support the additional ReadDataElement function signatures 
 *            2024-03-05  vsgeei       CARC-3794     ZEVonUDS: Support PID $4D
 *            2024-03-08  vsgeei       CARC-3795     ZEVonUDS: Support PID $1C, PID $31, PID $4E
 *  27.00.00  2024-03-13  visabn       DEM-9045      Adapt Dem_SetEventAvailable to AUTOSAR 19-11
 *            2024-03-19  tfarahani    DEM-7953      Support DM22
 *            2024-03-19  tfarahani    DEM-9931      Support internal DataElement ObdOnUDS 3 Byte DTC
 *            2024-03-19  visanh       DEM-9257      Allow Reporting of BSW errors before OS is initialized
 *            2024-03-26  tfarahani    ESCAN00116981 Composite Lamp Status calculated incorrectly in J1939 DMs
 *            2024-03-26  tfarahani    DEM-9640      Fix Event Combination Type2 - Confirmed DTC is removed from permanent chronology
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
/* PRQA S 3449 EOF */ /* MD_DEM_8.5_multipleDeclarations */
/* PRQA S 3451 EOF */ /* MD_DEM_8.5_declarationInMultipleFiles */
...
#define DEM_SW_MAJOR_VERSION                     (27U)
...
#define DEM_DISABLEEVENTMONITORINGINCURRENTDCY_APIID      (0x56U)              /*< Service ID: Dem_DisableEventMonitoringInCurrentDcy() */
...
#define DEM_DCMREADDATAOFPIDF501_APIID                    (0x6bU)              /*< Service ID: Dem_DcmReadDataOfPIDF501() */
...
#define DEM_GETSIZEOFFILTEREDEXTENDEDDATARECORDS_APIID    (0xe1U)              /*< Service ID: Dem_GetSizeOfFilteredExtendedDataRecords() */   
...
#define DEM_GETFREEZEFRAMEPRESTORED_APIID                 (0xe5U)              /*< Service ID: Dem_GetFreezeFramePrestored() */
#define DEM_STORECUSTOMTRIGGEREDFREEZEFRAME_APIID         (0xe6U)              /*< Service ID: Dem_StoreCustomTriggeredFreezeFrame() */
#define DEM_J1939DCMCLEARSINGLEDTC_APIID                  (0xe7U)              /*< Service ID: Dem_J1939DcmClearSingleDTC() */
...
#define DEM_DCMGETINFOTYPEVALUE79_APID                    (0xfeU)              /*< Service ID: Dem_DcmGetInfoTypeValue79() */
...
#define DEM_DTC_GROUP_EMISSION_REL_DTCS          ((Dem_DTCGroupType)(0x00000000UL))  /*< predefined DTC group encoding 'Emission related DTCs' for OBD-II */
#define DEM_DTC_GROUP_WWHOBD_DTCS                ((Dem_DTCGroupType)(0x00ffff33UL))  /*< predefined DTC group encoding 'Emission related DTCs' for WWH-OBD (legacy, must have the same value as DEM_DTC_GROUP_OBD_DTCS) */
#define DEM_DTC_GROUP_OBD_DTCS                   ((Dem_DTCGroupType)(0x00ffff33UL))  /*< predefined DTC group encoding 'Emission related DTCs' for WWH-OBD and OBD on UDS */
...
extern P2CONST(Dem_ConfigType, DEM_VAR_NO_INIT, DEM_INIT_DATA)  Dem_GlobalConfigPtr;
#endif
 ...
 *                Master runs in an untrusted partition (QM) and satellite 
 *                runs in a trusted partition (ASIL).
 *
 * \context       TASK
 * \synchronous   TRUE
 * \reentrant     FALSE
 ...
 *                OR the selected DTC format is not supported.
 *
 ...
 * \context       TASK|ISR2, from the master partition only
 * \synchronous   FALSE
 * \reentrant     TRUE for different enable conditions
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_SetEnableCondition(
 ...
 * \context       TASK|ISR2, from the master partition only
 * \synchronous   TRUE
 * \reentrant     TRUE for different storage conditions
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_SetStorageCondition(
 ...
 *
 * \return        E_OK
 *                The test result was processed successfully (return value does
 *                not take results for DemMultiEventTriggering slave events into
 *                account).
 *
 * \return        E_NOT_OK
 ...
 *
 * \return        E_OK
 *                The request was processed successfully (whether or not slave events were processed successfully)
 *
 * \return        E_NOT_OK
 ...
 *
 *                The prestored data is managed in a separate buffer. The data sets
 ...
 *                (whether or not slave event handling was successful)
 *
 * \return        E_NOT_OK
 ...
 *****************************************************************************/
/*!
 * \brief         API to read if snapshot data is pre-stored for an event.
 *
 * \details       This API returns if snapshot data is currently pre-stored 
 *                for an event. Snapshot data can be pre-stored by calling API
 *                Dem_PrestoreFreezeFrame().
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *
 * \param[out]    FreezeFramePrestored
 *                TRUE
 *                Snapshot data is pre-stored for the event.
 *                FALSE
 *                No snapshot data is pre-stored for the event.
 *
 * \return        E_OK
 *                The request was processed successfully
 *
 * \return        E_NOT_OK
 *                The request was rejected due to invalid arguments or state.
 *                In this case, FreezeFramePrestored will not be initialized.
 *
 * \pre           -
 *
 * \context       TASK|ISR2, from the master partition only
 ...
 *
 *                Note that overriding the WIR status does neither affect the
 *                internal event status nor any indicators related to the Event.
 ...
 * \return        E_OK
 *                Request processed successfully.
 *                Use API Dem_GetDTCSelectionResult for the result of
 *                this selection.
 * \return        E_NOT_OK
 *                The request was rejected due to invalid arguments.
 * \return        DEM_BUSY
 *                Another Dem_SelectDTC() based operation is active.
 *
 * \pre           -
 *
 * \context       TASK|ISR2, from the master partition only
 ...
 *                or
 *                readout of the selected record number through this API is not supported.
 * \return        E_NOT_OK
 *                The request was rejected, e.g. due to variant coding (see
 *                Dem_SetEventAvailable() )
 *                or
 ...
 *                DEM_DTC_ORIGIN_USERDEFINED_MEMORY_<ShortName>
 ...
 * \context       TASK|ISR2, from the master partition only
 * \synchronous   FALSE
 * \reentrant     TRUE for different Client IDs
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_ClearDTC(
  uint8  ClientId
 ...
 *
 * \return        E_OK
 *                Report of DTR result was successful
 * \return        E_NOT_OK
 ...
 *
 * \details       Normally the compiler start-up code initializes statically
...
/* ****************************************************************************
 * Dem_DisableEventMonitoringInCurrentDcy
 *****************************************************************************/
/*!
 * \brief         Set event monitor to disabled in the current driving cycle
 *
 * \details       Set event monitor to disabled in the current driving cycle.
 *                This function will make the event be considered as tested completed 
 *                during the readiness calculation of the following readiness data:
 *                PID $01, PID $F501 and DM05.
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *
 ...
 *                E_NOT_OK
 *                Event monitoring disabling failed OR
 *                'Major Monitor' disabled AND 'Comprehensive Component always complete' enabled
 *
 *
 * \pre           RTE is started (if RTE is used)
 * \config        Feature OBD II, WWHO_OBD or OBDonUDS is enabled
 *
 * \context       TASK|ISR2, from the master partition only
 * \synchronous   TRUE
 * \reentrant     TRUE for different EventIds.
 ...
 * \return        E_NOT_OK
 *                The request was rejected, e.g. due to invalid arguments,
 *                variant coding (see Dem_SetEventAvailable() ) or because
 *                PTO is active and the event is affected by PTO handling.
 *
 ...
 *****************************************************************************/
/*!
 * \brief         SWC API to lock all numerators for the current DCY
 *
 ...
 *                The request was rejected due to invalid arguments,
 *                variant coding (see Dem_SetEventAvailable() ) or because
 *                PTO is active and the related event is affected by PTO
 *                handling
 *
 * \pre           RTE is active (if RTE is used). Feature IUMPR is supported.
 *
 ...
 *
 * \context       TASK|ISR2, from the master partition only
 * \synchronous   FALSE for processing of ratio specific denominators, 
 *                TRUE for processing of Denominator status and General Denominator 
...
#endif /* (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_ON) && (DEM_CFG_SUPPORT_PERMANENT == STD_ON) */
 ...
 *
 * \details       Pointer to PID01value buffer. The buffer is returned as such:
 *                supported - 0 == FALSE; 1 == TRUE
 *                completed - 0 == TRUE;  1 == FALSE
 *                depending on the motor type (spark/compression) bits are used
 *                separately.
 *                Byte A
 ...
 *                  bit 6 - Comprehensive component Monitoring completed
 *                  bit 7 - reserved
 *                Byte C
 *                  bit 0 - Catalyst Monitoring / NMHC catalyst Monitoring supported
 *                  bit 1 - Heated catalyst Monitoring / NOx aftertreatment Monitoring supported
 *                  bit 2 - Evaporative System Monitoring / reserved supported
 *                  bit 3 - Secondary air System Monitoring / Boost pressure System Monitoring supported
 *                  bit 4 - reserved
 *                  bit 5 - Oxygen sensor Monitoring / Exhaust gas sensor Monitoring supported
 *                  bit 6 - Oxygen sensor heater / PM Filter Monitoring Monitoring supported
 *                  bit 7 - EGR System Monitoring supported
 *                Byte D
 *                  bit 0 - Catalyst Monitoring / NMHC catalyst Monitoring completed
 *                  bit 1 - Heated catalyst Monitoring / NOx aftertreatment Monitoring completed
 *                  bit 2 - Evaporative System Monitoring / reserved completed
 *                  bit 3 - Secondary air System Monitoring / Boost pressure System Monitoring completed
 *                  bit 4 - reserved
 *                  bit 5 - Oxygen sensor Monitoring / Exhaust gas sensor Monitoring completed
 *                  bit 6 - Oxygen sensor heater / PM Filter Monitoring Monitoring completed
 ...
 *****************************************************************************/
/*!
 * \brief         Notify Dem if PTO is active or inactive
 *
 * \details       -
 *
 * \param[out]    PtoStatus
 ...
 *****************************************************************************/
/*!
 * \brief         SWC API to trigger the storage of snapshots and time series
 *                snapshots with custom storage trigger
 *
 * \details       This API is intended to be called via RTE_CALL interface,
 *                as Operation of port interface 'DiagnosticMonitor'.
 *
 *                Dem_StoreCustomTriggeredFreezeFrame() triggers the storage and
 *                optionally also the update of custom triggered snapshot data
 *                and time series snapshot data for an event, even if the API is
 *                called at a point in time where the event is not stored. 
 *                The data is stored in a dedicated memory for custom trigger and
 *                persisted into NVRAM. Once the custom triggered data is stored,
 *                it can be read out via Dem services.
 *
 *                This API is a MICROSAR extension to the AUTOSAR standard.
 *
 * \attention     The operation Dem_StoreCustomTriggeredFreezeFrame() is not reentrant
 *                for the same EventId.
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *
 * \return        E_OK
 *                Custom triggered freeze frame storage request accepted
 *
 * \return        E_NOT_OK
 ...
 * Dem_Cfg_AdminData.ReadinessThisDcyDisabledMask
 ...
 * Dem_Cfg_TimeSeriesEntryCompanionType.ReadoutStatus
 * Dem_Cfg_TimeSeriesEntryCompanionType.ClientCounter
 *
 * \usedin
 * Dem_ClearDTC
 * Dem_EnableDTCRecordUpdate
 ...
 * Dem_Cfg_AdminData.OdometerAtMalfunctionActive
 *
 * \usedin
