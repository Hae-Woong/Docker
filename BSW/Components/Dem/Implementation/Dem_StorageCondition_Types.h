...
typedef struct Dem_Cfg_ComplexIterType_s Dem_StorageCondition_Group_IterType;

typedef uint16 Dem_StorageCondition_Group_IdentifierType;    /*! Storage Condition Group Identifier Type */
