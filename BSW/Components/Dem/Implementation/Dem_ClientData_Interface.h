 ...
 *****************************************************************************/
/*!
 * \brief         Get the FreezeFrameIterator handle of a client.
 *
 * \details       Get the FreezeFrameIterator handle of a client.
 *
 * \param[in]     ClientId
 *                Unique client id, assigned to the instance of the calling
 *                module.
 *
 * \return        FreezeFrameIteratorId
 *                Freeze frame iterator handle reserved for the ClientId
 *
 * \pre           -
 *
 * \context       TASK|ISR2
 ...
 *
 * \details       Get the extended data iterator of a client.
 *
 * \param[in]     ClientId
 *                Unique client id, assigned to the instance of the calling
 *                module.
