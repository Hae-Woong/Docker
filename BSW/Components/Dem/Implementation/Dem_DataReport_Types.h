...
/* Size of time series sequential did header (without the sequential id itself) */
#define DEM_DATAREPORT_TIMESERIES_SEQUENTIALDID_HEADERSIZE             (5u)
...
struct Dem_DataReport_DidCopyInfoType_s
{
  ...
  Dem_Cfg_EntryIndexType                  EventEntryIndex;   /*!< Id of event entry holding the DTC data */
  Dem_DTCReadoutBuffer_HandleType         ReadoutBufferId;   /*!< Id of the ReadoutBuffer holding DTC data */
};
