...
#define DEM_CFG_DTC_OBD_3BYTE_INVALID            (0x00000000UL)                                            /*!< No OBD 3Byte DTC */
#define DEM_CFG_COMBINED_GROUP_INVALID           (DEM_CFG_NO_COMBINEDGROUPSIDXOFEVENTPRECOMPILEDATATABLE)  /*!< No event combination */
...
/*!
 * \defgroup  Dem_Cfg_DataElementKinds Data element kind
 * Enumeration labels defining the kind of a data element
 * \{
 */
...
#define DEM_CFG_DATA_FROM_CS_PORT                                              (33U)  /*!< Data element maps to a Client Server callback (configured size) */
#define DEM_CFG_DATA_FROM_SR_PORT                                              (34U)  /*!< Data element maps to a Sender Receiver callback (configured size) */
#define DEM_CFG_DATA_FROM_CS_PORT_WITH_EVENTID                                 (35U)  /*!< Data element maps to a Client Server callback with EventId argument (configured size) */
#define DEM_CFG_DATA_FROM_FCT_WITH_EVENTID_BUFFERLENGTH                        (36U)  /*!< Data element maps to a functional call with EventId and BufferLength arguments */
#define DEM_CFG_DATA_FROM_FCT_WITH_PROXY                                       (37U)  /*!< Data element maps to a functional call with BufferLength and ErrorCode arguments */
#define DEM_CFG_DATA_FROM_WUC_SINCE_LAST_FAILED                                (38U)  /*!< Data element maps to the number of WUC since last failed (1 byte) */
#define DEM_CFG_DATA_FROM_SI30_STATUS                                          (39U)  /*!< Data element maps to the Status Indicator byte */
#define DEM_CFG_DATA_FROM_IUMPR                                                (40U)  /*!< Data element maps to worst ratio (Numerator and Denominator) of a DTC */
#define DEM_CFG_DATA_FROM_DTR                                                  (41U)  /*!< Data element maps to all DTRs of an event (group) */
#define DEM_CFG_DATA_FROM_MONITOR_ACTIVITY_DATA                                (42U)  /*!< Data element maps to the worst MAN and SMAR of a DTC */
#define DEM_CFG_DATAELEMENT_INVALID                                            (43U)  /*!< Data element does not map to data */


 /*!
  * \defgroup  Dem_Cfg_DataElementTypes  Data element type
  * Enumeration labels defining the data type of a data element
  * \{
  */
/* DataElement data type, returned by Dem_Cfg_DataElementDataType() */
#define DEM_CFG_DATA_TYPE_BOOLEAN                                              (0U)  /*!< Data element data is retrieved using boolean data type */
#define DEM_CFG_DATA_TYPE_SINT8                                                (1U)  /*!< Data element data is retrieved using sint8 data type */
#define DEM_CFG_DATA_TYPE_SINT8_N                                              (2U)  /*!< Data element data is retrieved using sint8 array data type */
#define DEM_CFG_DATA_TYPE_SINT16                                               (3U)  /*!< Data element data is retrieved using sint16 data type */
#define DEM_CFG_DATA_TYPE_SINT16_INTEL                                         (4U)  /*!< Data element data is retrieved using sint16 data type(Little-Endian) */
#define DEM_CFG_DATA_TYPE_SINT16_N                                             (5U)  /*!< Data element data is retrieved using sint16 array data type */
#define DEM_CFG_DATA_TYPE_SINT16_N_INTEL                                       (6U)  /*!< Data element data is retrieved using sint16 array data type(Little-Endian) */
#define DEM_CFG_DATA_TYPE_SINT32                                               (7U)  /*!< Data element data is retrieved using sint32 data type */
#define DEM_CFG_DATA_TYPE_SINT32_INTEL                                         (8U)  /*!< Data element data is retrieved using sint32 data type */
#define DEM_CFG_DATA_TYPE_SINT32_N                                             (9U)  /*!< Data element data is retrieved using sint32 array data type */
#define DEM_CFG_DATA_TYPE_SINT32_N_INTEL                                       (10U) /*!< Data element data is retrieved using sint32 array data type */
#define DEM_CFG_DATA_TYPE_UINT8                                                (11U) /*!< Data element data is retrieved using uint8 data type */
#define DEM_CFG_DATA_TYPE_UINT8_N                                              (12U) /*!< Data element data is retrieved using uint8 array data type */
#define DEM_CFG_DATA_TYPE_UINT16                                               (13U) /*!< Data element data is retrieved using uint16 data type */
#define DEM_CFG_DATA_TYPE_UINT16_INTEL                                         (14U) /*!< Data element data is retrieved using uint16 data type(Little-Endian) */
#define DEM_CFG_DATA_TYPE_UINT16_N                                             (15U) /*!< Data element data is retrieved using uint16 array data type */
#define DEM_CFG_DATA_TYPE_UINT16_N_INTEL                                       (16U) /*!< Data element data is retrieved using uint16 array data type(Little-Endian) */
#define DEM_CFG_DATA_TYPE_UINT32                                               (17U) /*!< Data element data is retrieved using uint32 data type */ 
#define DEM_CFG_DATA_TYPE_UINT32_INTEL                                         (18U) /*!< Data element data is retrieved using uint32 data type(Little-Endian) */
#define DEM_CFG_DATA_TYPE_UINT32_N                                             (19U) /*!< Data element data is retrieved using uint32 array data type */
#define DEM_CFG_DATA_TYPE_UINT32_N_INTEL                                       (20U) /*!< Data element data is retrieved using uint32 array data type(Little-Endian) */
#define DEM_CFG_DATA_TYPE_FLOAT                                                (21U) /*!< Data element data is retrieved using float data type */
#define DEM_CFG_DATA_TYPE_FLOAT_INTEL                                          (22U) /*!< Data element data is retrieved using float data type(Little-Endian) */
#define DEM_CFG_DATA_TYPE_FLOAT_N                                              (23U) /*!< Data element data is retrieved using float array data type */
#define DEM_CFG_DATA_TYPE_FLOAT_N_INTEL                                        (24U) /*!< Data element data is retrieved using float array data type(Little-Endian) */
...
#define DEM_CFG_EREC_TYPE_INTERNAL               (1U)  /*!< Data record requires an event entry */
#define DEM_CFG_EREC_TYPE_USER                   (2U)  /*!< Data record requires room in the user record buffer within an event entry */
/*!
 * \}
 */
...
#define DEM_CFG_TRIGGER_CUSTOM                     (512U)  /*!< Custom API trigger */
/*!
 * \}
 */
...
/*!
* \defgroup  Dem_Cfg_EventMemoryStorageTriggerType
* Enumeration labels defining storage triggers
* \{
*/

/*! Trigger mask for creation of an event entry */
# define DEM_MEMORY_STORAGE_TRIGGER_CONFIRMED           DEM_CFG_TRIGGER_CONFIRMED
# define DEM_MEMORY_STORAGE_TRIGGER_FAILED              (DEM_CFG_TRIGGER_TESTFAILED|DEM_CFG_TRIGGER_TESTFAILEDTHISCYCLE)
# define DEM_MEMORY_STORAGE_TRIGGER_PENDING             (DEM_CFG_TRIGGER_TESTFAILED|DEM_CFG_TRIGGER_TESTFAILEDTHISCYCLE)
# define DEM_MEMORY_STORAGE_TRIGGER_FDC                 (DEM_CFG_TRIGGER_FDC|DEM_CFG_TRIGGER_TESTFAILED)
# define DEM_MEMORY_STORAGE_TRIGGER_NONE                DEM_CFG_TRIGGER_NONE
...
#define DEM_IUMPR_DEN_INDEPENDENT                (7U)  /*!< independent denominator that may be incremented without general individual conditions */
 /*!
 * \}
 */
...
#define DEM_CFG_READINESS_EGSENS                 (7U)  /*!< OBD readiness group DEM_OBD_RDY_EGSENS */
#define DEM_CFG_READINESS_EGR                    (8U)  /*!< OBD readiness group DEM_OBD_RDY_EGR */
#define DEM_CFG_READINESS_PCV                    (9U)  /*!< OBD readiness group DEM_OBD_RDY_PCV */
#define DEM_CFG_READINESS_ECS                   (10U)  /*!< OBD readiness group DEM_OBD_RDY_ECS */
#define DEM_CFG_READINESS_CSER                  (11U)  /*!< OBD readiness group DEM_OBD_RDY_CSER */
#define DEM_CFG_READINESS_VVT                   (12U)  /*!< OBD readiness group DEM_OBD_RDY_VVT */
#define DEM_CFG_READINESS_DOR                   (13U)  /*!< OBD readiness group DEM_OBD_RDY_DOR */
#define DEM_CFG_READINESS_CMPRCMPT              (14U)  /*!< OBD readiness group DEM_OBD_RDY_CMPRCMPT */
#define DEM_CFG_READINESS_OTHER                 (15U)  /*!< OBD readiness group DEM_OBD_RDY_OTHER */
...
#define DEM_CFG_READINESS_NOXADSORB             (19U)  /*!< OBD readiness group DEM_OBD_RDY_NOXADSORB */
#define DEM_CFG_READINESS_PMFLT                 (20U)  /*!< OBD readiness group DEM_OBD_RDY_PMFLT */
#define DEM_CFG_READINESS_O2SENS                (21U)  /*!< OBD readiness group DEM_OBD_RDY_O2SENS */
/* Reserved Space */
...
#define DEM_CFG_READINESS_AC                    (25U)  /*!< OBD readiness group DEM_OBD_RDY_AC */
#define DEM_CFG_READINESS_EGHSENS               (26U)  /*!< OBD readiness group DEM_OBD_RDY_EGHSENS */
#define DEM_CFG_READINESS_CSAS                  (27U)  /*!< OBD readiness group DEM_OBD_RDY_CSAS */
#define DEM_CFG_READINESS_GROUP_INVALID         (28U)  /*!< first invalid OBD readiness group */
#define DEM_CFG_READINESS_GROUP_SIZE            (28U)  /*!< first invalid OBD readiness group */
...
/*!
* \defgroup  Dem_Cfg_FunctionalGroupIdentifierTypes  Functional Group Identifier type
* Enumeration labels defining the functional group identifier
* \{
*/
# define DEM_FGID_EMISSION_SYSTEM_GROUP          (0x33U)  /*!< Functional group identifier emission system group */
/*!
* \}
*/
...
/*! Index type for accessing 32 bit data element configuration tables */
typedef uint32 Dem_Cfg_DataIndexType32Bit;
...
/*! Index type for accessing J1939 SPNs in expanded freeze frame configuration tables */
typedef uint16 Dem_Cfg_J1939SpnsInExpandedFreezeFrameIndexType;
/*! Index enumerating the time series belonging to a specific event. */
typedef uint8 Dem_TimeSeriesIdType;
...
/*! Base type for 32 bit iterations */
typedef struct Dem_Cfg_ComplexIterType32Bit_s Dem_Cfg_ComplexIterType32Bit;
/*! Iterator type for iteration over *Entry tables */
typedef struct Dem_Cfg_ComplexIterType32Bit_s Dem_Cfg_EntryIterType;
...
/*! Iterator type for iteration over J1939 DTC status change notifications */
...
/*! Iterator type for iteration over translated memory Ids corresponding to time series snapshot records*/
typedef struct Dem_Cfg_ComplexIterType_s Dem_Cfg_TSSRTranslatedMemoryIdIterType;

/*! Iterator type for iteration over UDS DTC status change notifications */
...
/*! Iterator type for iteration over J1939 SPNS */
typedef Dem_Cfg_SimpleIterType Dem_Cfg_J1939SpnsIterType;
/*! Iterator type for iterating over the time series of an event. */
typedef Dem_Cfg_SimpleIterType Dem_Cfg_TimeSeriesIterType;
/*! Iterator type for iterating over the configured time series sampling profiles. */
typedef Dem_Cfg_SimpleIterType Dem_Cfg_SamplingProfileIterType;
