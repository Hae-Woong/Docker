...
/* ****************************************************************************
 % Dem_Infrastructure_ExtCom_GetMasterApplicationId()
 *****************************************************************************/
/*!
 ...
 *
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(Dem_ExtCom_ApplicationType, DEM_CODE)
Dem_Infrastructure_ExtCom_GetMasterApplicationId(
  void
)
{
  return DEM_CFG_MASTER_APPLICATION_ID;
}
  ...
  )
{
  ...
  if (GetCurrentApplicationID() != Dem_Infrastructure_ExtCom_GetMasterApplicationId())
  {
    lRetVal = FALSE;
  }
#endif  
...
#else
  /* For performance reasons call GetCurrentApplicationID() only if required */
  Dem_Internal_AssertAlways(DEM_E_INCONSISTENT_STATE)
  lReturn = DEM_CFG_MASTER_APPLICATION_ID;
#endif
  return lReturn;
}
