...
#if !defined (DEM_TYPES_H)                                                                                                       /* COV_MSR_HEADERGUARD TX */
#define DEM_TYPES_H
...
/*!
 * \defgroup  DemServiceInterfaceErrorCode Dem specific error codes for Service Interfaces (APIs) not defined by AUTOSAR
 * \{
 */
#define DEM_WRONG_DTCTYPEFILTER                   ((Std_ReturnType)(49U))        /*!< Selected DTC does not match the given DTCTypeFilter */
/*!
 * \}
 */
...
#define DEM_DTC_FORMAT_INVALID                   ((Dem_DTCFormatType)(0x04U))  /*!< First out of range value of Dem_DTCFormatType */
...
typedef struct Dem_J1939DcmDiagnosticReadiness1Type_s
{
  ...
  uint8 NonContinuouslyMonitoredSystemsStatus7;      /*!< Identifies the non-continuously monitored systems status */
  uint8 NonContinuouslyMonitoredSystemsStatus8;      /*!< Identifies the non-continuously monitored systems status */
...
typedef struct Dem_J1939DcmDiagnosticReadiness3Type_s
{
  ...
  uint8 NonContinuouslyMonitoredSystemsEnableStatus5;      /*!< Enable status of non-continuous monitors this monitoring cycle (byte5) */
  uint8 NonContinuouslyMonitoredSystemsEnableStatus6;      /*!< Enable status of non-continuous monitors this monitoring cycle (byte6) */
  uint8 NonContinuouslyMonitoredSystems7;                  /*!< Completion status of non-continuous monitors this monitoring cycle (byte7) */
  uint8 NonContinuouslyMonitoredSystems8;                  /*!< Completion status of non-continuous monitors this monitoring cycle (byte8) */
...
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE,    Dem_DtcStatusChangedFPtrType)(
                                                   uint32 DTC /* [in] DTC */,
                                                   Dem_UdsStatusByteType DtcStatusOld /* [in] oldStatus */,
                                                   Dem_UdsStatusByteType DtcStatusNew /* [in] newStatus */
                                                 );
...
/*! Function pointer type for C/S and S/R read data callbacks */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE,    Dem_ReadDataUint8FPtrType)(
                                                   P2VAR(uint8, AUTOMATIC, DEM_SHARED_DATA) DestinationBuffer /* [out] data */
                                                 );

/*! Function pointer type for C/S with EventId read data callbacks with additional event argument */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE,    Dem_ReadDataExtendedUint8FPtrType)(
                                                   Dem_EventIdType EventId /* [in] EventId*/,
                                                   P2VAR(uint8, AUTOMATIC, DEM_SHARED_DATA) DestinationBuffer /* [out] data */
                                                   );

/*! Function pointer type for C/S with EventId and BufferLength read data with additional event argument */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataEventIdBufferLengthExtendedUint8FPtrType)(
                                                Dem_EventIdType EventId /* [in] EventId*/,
                                                P2VAR(uint8, AUTOMATIC, DEM_SHARED_DATA) DestinationBuffer /* [out] data */,
                                                uint16 BufferLength /* [in] size of data */
                                                );

#if (DEM_CFG_SUPPORT_DCM == STD_ON)
/*! Function pointer type for C/S with BufferLength and ErrorCode read data with additional event argument */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataBufferLengthErrorCodeExtendedUint8FPtrType)(
                                                P2VAR(uint8, AUTOMATIC, DEM_SHARED_DATA) DestinationBuffer /* [out] data */,
                                                uint16 BufferLength /* [in] size of data */,
                                                Dcm_NegativeResponseCodeType* ErrorCode /* [out] ErrorCode */
                                                );
#endif

/*! Function pointer type for C/S and S/R read data callbacks for data type boolean */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataBooleanFPtrType)(
                                                P2VAR(boolean, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */
                                                );

/*! Function pointer type for C/S with EventId read data callbacks for data type boolean */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataExtendedBooleanFPtrType)(
                                                Dem_EventIdType EventId /* [in] EventId*/,
                                                P2VAR(boolean, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */
                                                );

/*! Function pointer type for C/S with EventId and BufferLength read data callbacks for data type boolean */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataEventIdBufferLengthExtendedBooleanFPtrType)(
                                                Dem_EventIdType EventId /* [in] EventId*/,
                                                P2VAR(boolean, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */,
                                                uint16 BufferLength /* [in] size of data */
                                                );
...
#if (DEM_CFG_SUPPORT_DCM == STD_ON)
/*! Function pointer type for C/S with BufferLength and ErrorCode read data callbacks for data type boolean */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataBufferLengthErrorCodeExtendedBooleanFPtrType)(
                                                P2VAR(boolean, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */,
                                                uint16 BufferLength /* [in] size of data */,
                                                Dcm_NegativeResponseCodeType* ErrorCode /* [out] ErrorCode */
                                                );
...
/*! Function pointer type for C/S and S/R read data callbacks for data type sint8 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataSint8FPtrType)(
                                                P2VAR(sint8, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */
                                                );

/*! Function pointer type for C/S with EventId read data callbacks for data type sint8 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataExtendedSint8FPtrType)(
                                                Dem_EventIdType EventId /* [in] EventId*/,
                                                P2VAR(sint8, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */
                                                );


/*! Function pointer type for C/S with EventId and BufferLength read data callbacks for data type sint8 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataEventIdBufferLengthExtendedSint8FPtrType)(
                                                Dem_EventIdType EventId /* [in] EventId*/,
                                                P2VAR(sint8, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */,
                                                uint16 BufferLength /* [in] size of data */
                                                );
...
#if (DEM_CFG_SUPPORT_DCM == STD_ON)
/*! Function pointer type for C/S with BufferLength and ErrorCode read data callbacks for data type sint8 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataBufferLengthErrorCodeExtendedSint8FPtrType)(
                                                P2VAR(sint8, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */,
                                                uint16 BufferLength /* [in] size of data */,
                                                Dcm_NegativeResponseCodeType* ErrorCode /* [out] ErrorCode */
                                                );
...
/*! Function pointer type for C/S and S/R read data callbacks for data type sint16 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataSint16FPtrType)(
                                                P2VAR(sint16, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] datFa */
                                                );

/*! Function pointer type for C/S with EventId read data callbacks for data type sint16 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataExtendedSint16FPtrType)(
                                                Dem_EventIdType EventId /* [in] EventId*/,
                                                P2VAR(sint16, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */
                                                );

/*! Function pointer type for C/S with EventId and BufferLength read data callbacks for data type sint16 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataEventIdBufferLengthExtendedSint16FPtrType)(
                                                Dem_EventIdType EventId /* [in] EventId*/,
                                                P2VAR(sint16, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */,
                                                uint16 BufferLength /* [in] size of data */
                                                );
...
#if (DEM_CFG_SUPPORT_DCM == STD_ON)
/*! Function pointer type for C/S with BufferLength and ErrorCode read data callbacks for data type sint16 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataBufferLengthErrorCodeExtendedSint16FPtrType)(
                                                P2VAR(sint16, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */,
                                                uint16 BufferLength /* [in] size of data */,
                                                Dcm_NegativeResponseCodeType* ErrorCode /* [out] ErrorCode */
                                                );
...
/*! Function pointer type for C/S and S/R read data callbacks for data type uint16 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataUint16FPtrType)(
                                                P2VAR(uint16, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */
                                                );

/*! Function pointer type for C/S with EventId read data callbacks for data type uint16 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataExtendedUint16FPtrType)(
                                                Dem_EventIdType EventId /* [in] EventId*/,
                                                P2VAR(uint16, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */
                                                );

/*! Function pointer type for C/S with EventId and BufferLength read data callbacks for data type uint16 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataEventIdBufferLengthExtendedUint16FPtrType)(
                                                Dem_EventIdType EventId /* [in] EventId*/,
                                                P2VAR(uint16, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */,
                                                uint16 BufferLength /* [in] size of data */
                                                );
...
#if (DEM_CFG_SUPPORT_DCM == STD_ON)
/*! Function pointer type for C/S with BufferLength and ErrorCode read data callbacks for data type uint16 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataBufferLengthErrorCodeExtendedUint16FPtrType)(
                                                P2VAR(uint16, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */,
                                                uint16 BufferLength /* [in] size of data */,
                                                Dcm_NegativeResponseCodeType* ErrorCode /* [out] ErrorCode */
                                                );
...
/*! Function pointer type for C/S and S/R read data callbacks for data type sint32 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataSint32FPtrType)(
                                                P2VAR(sint32, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */
                                                );

/*! Function pointer type for C/S with EventId read data callbacks for data type uint32 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataExtendedSint32FPtrType)(
                                                Dem_EventIdType EventId /* [in] EventId*/,
                                                P2VAR(sint32, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */
                                                );

/*! Function pointer type for C/S with EventId and BufferLength read data callbacks for data type sint32 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataEventIdBufferLengthExtendedSint32FPtrType)(
                                                Dem_EventIdType EventId /* [in] EventId*/,
                                                P2VAR(sint32, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */,
                                                uint16 BufferLength /* [in] size of data */
                                                );
...
#if (DEM_CFG_SUPPORT_DCM == STD_ON)
/*! Function pointer type for C/S with BufferLength and ErrorCode read data callbacks for data type sint32 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataBufferLengthErrorCodeExtendedSint32FPtrType)(
                                                P2VAR(sint32, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */,
                                                uint16 BufferLength /* [in] size of data */,
                                                Dcm_NegativeResponseCodeType* ErrorCode /* [out] ErrorCode */
                                                );
...
/*! Function pointer type for C/S and S/R read data callbacks for data type uint32 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataUint32FPtrType)(
                                                P2VAR(uint32, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */
                                                );

/*! Function pointer type for C/S with EventId read data callbacks for data type uint32 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataExtendedUint32FPtrType)(
                                                Dem_EventIdType EventId /* [in] EventId*/,
                                                P2VAR(uint32, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */
                                                );

/*! Function pointer type for C/S with EventId and BufferLength read data callbacks for data type uint32 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataEventIdBufferLengthExtendedUint32FPtrType)(
                                                Dem_EventIdType EventId /* [in] EventId*/,
                                                P2VAR(uint32, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */,
                                                uint16 BufferLength /* [in] size of data */
                                                );
...
#if (DEM_CFG_SUPPORT_DCM == STD_ON)
/*! Function pointer type for C/S with BufferLength and ErrorCode read data callbacks for data type uint32 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataBufferLengthErrorCodeExtendedUint32FPtrType)(
                                                P2VAR(uint32, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */,
                                                uint16 BufferLength /* [in] size of data */,
                                                Dcm_NegativeResponseCodeType* ErrorCode /* [out] ErrorCode */
                                                );
...
/*! Function pointer type for C/S and S/R read data callbacks for data type float32 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataFloat32FPtrType)(
                                                P2VAR(float32, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */
                                                );

/*! Function pointer type for C/S with EventId read data callbacks for data type float32 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataExtendedFloat32FPtrType)(
                                                Dem_EventIdType EventId /* [in] EventId*/,
                                                P2VAR(float32, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */
                                                );

/*! Function pointer type for C/S with EventId and BufferLength read data callbacks for data type float32 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataEventIdBufferLengthExtendedFloat32FPtrType)(
                                                Dem_EventIdType EventId /* [in] EventId*/,
                                                P2VAR(float32, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */,
                                                uint16 BufferLength /* [in] size of data */
                                                );
...
#if (DEM_CFG_SUPPORT_DCM == STD_ON)
/*! Function pointer type for C/S with BufferLength and ErrorCode read data callbacks for data type float32 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_ReadDataBufferLengthErrorCodeExtendedFloat32FPtrType)(
                                                P2VAR(float32, AUTOMATIC, DEM_SHARED_DATA) DataBuffer /* [out] data */,
                                                uint16 BufferLength /* [in] size of data */,
                                                Dcm_NegativeResponseCodeType* ErrorCode /* [out] ErrorCode */
                                                );
...
typedef P2VAR(uint8, TYPEDEF, DEM_VAR_NO_INIT)    Dem_DataPtrType;
