...
# define DEM_CFG_NO_COMBINEDGROUPSIDXOFEVENTPRECOMPILEDATATABLE       (0U)          /*!< Invalid combined group index */
#endif
...
#if ((DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_ON) || (DEM_CFG_SUPPORT_WWHOBD == STD_ON))
/*! Define whether common EmissionOBD features are supported */
# define DEM_FEATURE_NEED_EMISSIONOBD                    STD_ON
#else
/*! Define whether common EmissionOBD features are supported */
# define DEM_FEATURE_NEED_EMISSIONOBD                    STD_OFF
#endif

#if ((DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_ON) || (DEM_CFG_SUPPORT_WWHOBD == STD_ON) || (DEM_CFG_SUPPORT_ZEVONUDS == STD_ON))
/*! Define whether common OBD (Emission and Zero-Emission) features are supported */
...
#if ( (DEM_FEATURE_NEED_EMISSIONOBD) \
    && ( (DEM_CFG_SUPPORT_PID21  == STD_ON) \
    || (DEM_CFG_SUPPORT_J1939_READINESS2 == STD_ON) ) )
/*! Define whether MIL related odometer data calculation is required */
# define DEM_FEATURE_NEED_ODOMETER_MIL_ON  STD_ON
#else
/*! Define whether MIL related odometer data calculation is required */
# define DEM_FEATURE_NEED_ODOMETER_MIL_ON  STD_OFF
#endif

#if (  (DEM_CFG_SUPPORT_PID31  == STD_ON) \
    || (DEM_CFG_SUPPORT_J1939_READINESS2 == STD_ON) )
/*! Define whether clear related odometer data calculation is required */
# define DEM_FEATURE_NEED_ODOMETER_AT_CLEAR   STD_ON
#else
/*! Define whether clear related odometer data calculation is required */
# define DEM_FEATURE_NEED_ODOMETER_AT_CLEAR  STD_OFF
#endif

#if (  (DEM_CFG_SUPPORT_PID21  == STD_ON) \
    && (DEM_CFG_SUPPORT_ZEVONUDS == STD_ON) )
/*! Define whether ConfirmedDTC related odometer data calculation is required */
# define DEM_FEATURE_NEED_ODOMETER_CONFIRMEDDTC  STD_ON
#else
/*! Define whether ConfirmedDTC related odometer data calculation is required */
# define DEM_FEATURE_NEED_ODOMETER_CONFIRMEDDTC  STD_OFF
#endif

#if ( (DEM_FEATURE_NEED_EMISSIONOBD) \
    && ( (DEM_CFG_SUPPORT_PID4D  == STD_ON) \
    || (DEM_CFG_SUPPORT_J1939_READINESS2 == STD_ON) ) )
/*! Define whether engine runtime calculation with MIL is on is required */
# define DEM_FEATURE_NEED_ENGINERUNTIME_MIL_ON   STD_ON
#else
/*! Define whether engine runtime calculation with MIL is on is required */
# define DEM_FEATURE_NEED_ENGINERUNTIME_MIL_ON  STD_OFF
#endif

#if (  (DEM_CFG_SUPPORT_PID4D  == STD_ON) \
    && (DEM_CFG_SUPPORT_ZEVONUDS == STD_ON) )
/*! Define whether ConfirmedDTC related engine runtime calculation is required */
# define DEM_FEATURE_NEED_ENGINERUNTIME_CONFIRMEDDTC  STD_ON
#else
/*! Define whether ConfirmedDTC related engine runtime calculation is required */
# define DEM_FEATURE_NEED_ENGINERUNTIME_CONFIRMEDDTC  STD_OFF
#endif

#if (  (DEM_CFG_SUPPORT_PID4E  == STD_ON) \
    || (DEM_CFG_SUPPORT_J1939_READINESS2 == STD_ON) )
/*! Define whether engine runtime calculation since last clear is required */
# define DEM_FEATURE_NEED_ENGINERUNTIME_SINCE_CLEAR   STD_ON
#else
/*! Define whether engine runtime calculation since last clear is required */
# define DEM_FEATURE_NEED_ENGINERUNTIME_SINCE_CLEAR  STD_OFF
#endif

#if (  (DEM_CFG_SUPPORT_PID30  == STD_ON) \
    || (DEM_CFG_SUPPORT_J1939_READINESS3 == STD_ON) )
/*! Define whether warumup cycle counter since clear calculation is required*/
# define DEM_FEATURE_NEED_WARMUP_CYCLES_SINCE_CLEAR   STD_ON
#else
/*! Define whether warumup cycle counter since clear calculation is required */
# define DEM_FEATURE_NEED_WARMUP_CYCLES_SINCE_CLEAR   STD_OFF
#endif

#if (DEM_FEATURE_NEED_EMISSIONOBD == STD_ON) && (DEM_CFG_SUPPORT_MIL_GROUP == STD_ON)
...
# define DEM_FEATURE_NEED_MIL_GROUPS             STD_OFF
   ...
   && ( (DEM_FEATURE_NEED_ODOMETER_MIL_ON == STD_ON) \
     || (DEM_FEATURE_NEED_ODOMETER_AT_CLEAR == STD_ON) \
     || (DEM_CFG_SUPPORT_PERMANENTDTC_ACTIVATION_DISTANCE == STD_ON) \
     || (DEM_FEATURE_NEED_ODOMETER_CONFIRMEDDTC) ) )
...
# define DEM_FEATURE_NEED_OBD_ODOMETER           STD_OFF
   ...
   && ( (DEM_FEATURE_NEED_ODOMETER_MIL_ON == STD_ON) \
     || (DEM_FEATURE_NEED_ENGINERUNTIME_MIL_ON == STD_ON) ) )
...
#if ( (DEM_CFG_SUPPORT_TIME_SERIES_FUTURE == STD_ON) || (DEM_CFG_SUPPORT_TIME_SERIES_PAST == STD_ON) )
...
/*! Define whether a separate buffer for memory independent counter
...
# define DEM_FEATURE_NEED_PID41_MMONLY_CALCULATION  STD_OFF
    ...
    && (DEM_CFG_SUPPORT_DCM == STD_ON) \
    && (DEM_CFG_SUPPORT_PID41 == STD_ON) \
    && ((DEM_CFG_SUPPORT_MAJOR_MONITORS == STD_OFF) && (DEM_CFG_PROCESS_RDY_THIS_DCY_COMPREHENSIVE_COMPLETE == STD_OFF)) )
...
# define DEM_FEATURE_NEED_PID41_CALCULATION      STD_OFF
    ...
    && (DEM_CFG_SUPPORT_J1939_READINESS3 == STD_ON) \
    && (DEM_CFG_SUPPORT_MAJOR_MONITORS == STD_ON) )
/*! Define whether DM26 readiness calculation is required due to MajorMonitor support */
# define DEM_FEATURE_NEED_DM26_MMONLY_CALCULATION  STD_ON
#else
/*! Define whether DM26 readiness calculation is required due to MajorMonitor support */
# define DEM_FEATURE_NEED_DM26_MMONLY_CALCULATION  STD_OFF
#endif
    ...
    && (DEM_CFG_SUPPORT_J1939_READINESS3 == STD_ON) \
    && ((DEM_CFG_SUPPORT_MAJOR_MONITORS == STD_OFF) && (DEM_CFG_PROCESS_RDY_THIS_DCY_COMPREHENSIVE_COMPLETE == STD_OFF)) )
/*! Define whether DM26 readiness calculation is required due to ComprehensiveComponentsAlwaysComplete value */
# define DEM_FEATURE_NEED_DM26_CCONLY_CALCULATION  STD_ON
#else
/*! Define whether DM26 readiness calculation is required due to ComprehensiveComponentsAlwaysComplete value */
# define DEM_FEATURE_NEED_DM26_CCONLY_CALCULATION  STD_OFF
#endif

#if (  (DEM_FEATURE_NEED_DM26_MMONLY_CALCULATION == STD_ON) \
    || (DEM_FEATURE_NEED_DM26_CCONLY_CALCULATION == STD_ON) )
/*! Define whether DM26 readiness calculation is required */
# define DEM_FEATURE_NEED_DM26_CALCULATION      STD_ON
#else
/*! Define whether DM26 readiness calculation is required */
# define DEM_FEATURE_NEED_DM26_CALCULATION      STD_OFF
#endif

#if ( (DEM_CFG_SUPPORT_MAJOR_MONITORS == STD_ON) \
    && ((DEM_FEATURE_NEED_EMISSIONOBD == STD_ON) && (DEM_CFG_SUPPORT_PID01 == STD_ON)))
# define DEM_FEATURE_NEED_PID01_CALCULATION      STD_ON
#else
# define DEM_FEATURE_NEED_PID01_CALCULATION      STD_OFF
#endif

#if ((DEM_CFG_SUPPORT_OBDONUDS == STD_ON) && ((DEM_CFG_SUPPORT_MAJOR_MONITORS == STD_ON) || (DEM_CFG_PROCESS_PIDF501_COMPREHENSIVE_COMPLETE == STD_OFF))) 
# define DEM_FEATURE_NEED_PIDF501_CALCULATION      STD_ON
#else
# define DEM_FEATURE_NEED_PIDF501_CALCULATION      STD_OFF
#endif


#if ((DEM_CFG_SUPPORT_J1939 == STD_ON) && (DEM_CFG_SUPPORT_OBDII == STD_ON) \
    && (DEM_CFG_SUPPORT_MAJOR_MONITORS == STD_ON) && (DEM_CFG_SUPPORT_J1939_READINESS1 == STD_ON))
# define DEM_FEATURE_NEED_DM05_CALCULATION      STD_ON
#else
# define DEM_FEATURE_NEED_DM05_CALCULATION      STD_OFF
#endif

#if (  (DEM_FEATURE_NEED_PID01_CALCULATION == STD_ON) \
    || (DEM_FEATURE_NEED_DM05_CALCULATION == STD_ON) \
    || (DEM_FEATURE_NEED_PIDF501_CALCULATION == STD_ON) )
# define DEM_FEATURE_NEED_READINESS_CALCULATION      STD_ON
#else
# define DEM_FEATURE_NEED_READINESS_CALCULATION      STD_OFF
#endif

#if ((DEM_FEATURE_NEED_READINESS_CALCULATION == STD_ON) \
    && (DEM_CFG_PTO_STATUS_SUPPORT == STD_ON) )
# define DEM_FEATURE_NEED_PTO_TIMER                  STD_ON
#else
# define DEM_FEATURE_NEED_PTO_TIMER                  STD_OFF
#endif


#if ((DEM_FEATURE_NEED_READINESS_CALCULATION == STD_ON) \
    && (DEM_CFG_SUPPORT_DISABLE_EVENT_MONITORING == STD_ON) )
# define DEM_FEATURE_NEED_DISABLE_EVENT_MONITOR      STD_ON
#else
# define DEM_FEATURE_NEED_DISABLE_EVENT_MONITOR      STD_OFF
#endif

#if (DEM_FEATURE_NEED_OBD == STD_ON)
# if (DEM_FEATURE_NEED_ENGINERUNTIME_MIL_ON == STD_ON) || (DEM_FEATURE_NEED_ENGINERUNTIME_SINCE_CLEAR == STD_ON) || (DEM_CFG_SUPPORT_WWHOBD == STD_ON) || (DEM_FEATURE_NEED_PTO_TIMER == STD_ON) || (DEM_FEATURE_NEED_ENGINERUNTIME_CONFIRMEDDTC == STD_ON)
/*! Define whether the engine run time in minutes must be tracked */
#  define DEM_FEATURE_NEED_ENGINE_RUN_TIME_MINUTES       STD_ON
# else
/*! Define whether the engine run time in minutes must be tracked */
#  define DEM_FEATURE_NEED_ENGINE_RUN_TIME_MINUTES       STD_OFF
# endif
#else
/*! Define whether the engine run time in minutes must be tracked */
# define DEM_FEATURE_NEED_ENGINE_RUN_TIME_MINUTES        STD_OFF
...
/*! Define whether the engine run time in seconds must be tracked */
#  define DEM_FEATURE_NEED_ENGINE_RUN_TIME_SECONDS       STD_ON
# else
/*! Define whether the engine run time in seconds must be tracked */
#  define DEM_FEATURE_NEED_ENGINE_RUN_TIME_SECONDS       STD_OFF
# endif
#else
/*! Define whether the engine run time in seconds must be tracked */
# define DEM_FEATURE_NEED_ENGINE_RUN_TIME_SECONDS       STD_OFF
...
#if((DEM_FEATURE_NEED_ENGINE_RUN_TIME_MINUTES == STD_ON) || (DEM_FEATURE_NEED_ENGINE_RUN_TIME_SECONDS == STD_ON))
...
# if ((DEM_CFG_SUPPORT_CUSTOMTRIGGER_SREC == STD_ON) || (DEM_CFG_SUPPORT_CUSTOMTRIGGER_TSSR == STD_ON))
/* Define whether custom trigger shall be supported */
#  define DEM_FEATURE_NEED_CUSTOMTRIGGERSTORAGE      STD_ON
# else
/* Define whether custom trigger shall be supported */
#  define DEM_FEATURE_NEED_CUSTOMTRIGGERSTORAGE      STD_OFF
# endif
