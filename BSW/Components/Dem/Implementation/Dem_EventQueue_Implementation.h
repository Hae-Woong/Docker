  ...
  )
{
  ...
  Dem_Memories_PrestorageMemory_EventPrestorageLock(EventId);
#endif
  ...
  )
{
  ...
  {
    Dem_ExtendedStatus_StatusType lOldExtendedStatus;
    boolean lOldSimilarConditionStatus;
    boolean lNewSimilarConditionStatus;

    Dem_Internal_AssertContinue(Dem_Core_DTC_IsObdRelated(EventId), DEM_E_INCONSISTENT_STATE)
    lOldExtendedStatus = Dem_Event_ExtendedStatus_GetEventStatus(EventId);
    lOldSimilarConditionStatus = Dem_Event_ExtendedStatus_TestBit(lOldExtendedStatus, Dem_ExtendedStatus_SimilarConditions);
    ...
    {
      Dem_ExtendedStatus_StatusType lNewExtendedStatus;
      if (lNewSimilarConditionStatus == TRUE)
      {
        lNewExtendedStatus = Dem_Event_ExtendedStatus_SetBit(lOldExtendedStatus, Dem_ExtendedStatus_SimilarConditions);
      }
      else
      {
        lNewExtendedStatus = Dem_Event_ExtendedStatus_ResetBit(lOldExtendedStatus, Dem_ExtendedStatus_SimilarConditions);
      }
      Dem_Event_ExtendedStatus_SetEventStatus(EventId, lNewExtendedStatus);
