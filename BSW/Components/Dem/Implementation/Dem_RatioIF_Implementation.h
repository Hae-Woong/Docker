...
DEM_LOCAL VAR(boolean, DEM_VAR_NO_INIT)  Dem_Iumpr_Ratio_AnyUpdatePending;
 ...
 *                Do not mistake it with Fim Fid pending. Both are completely
...
/* ****************************************************************************
 % Dem_Iumpr_Ratio_GetRelatedEvent
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
{
  DEM_IGNORE_UNUSED_ARGUMENT(RatioIndex)                                                                                         /* PRQA S 1338, 3112 */ /* MD_MSR_DummyStmt, MD_DEM_14.2 */
#if (DEM_CFG_SUPPORT_IUMPR == STD_ON)
    return ((Dem_EventIdType)(Dem_Cfg_GetEventTableIdxOfRatioIdTable(RatioIndex)));
#else
 ...
 *****************************************************************************/
/*!
 * \brief         Initialize numerator status and counter value
 *
 * \details       Initialize numerator status and counter value
  *
 * \param[in]     RatioIndex
 *                Unique handle of the Ratio
 *
...
{
  Dem_RatioIdIndexType lUpdatePendingSize;
#if (DEM_CFG_SUPPORT_IUMPR == STD_ON)
