...
#if !defined (DEM_RECORDREADERIF_SVCIMPLEMENTATION_H)
#define DEM_RECORDREADERIF_SVCIMPLEMENTATION_H
...
#define DEM_RECORDREADERIF_SVCIMPLEMENTATION_FILENAME "Dem_RecordReaderIF_SvcImplementation.h"
  ...
  )
{
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    lReturnValue = Dem_EnvDataSwcApi_GetEventFreezeFrameDataEx(EventId, RecordNumber, DataId, DestBuffer, BufSize);              /* SBSW_DEM_POINTER_FORWARD_API_ARGUMENT_BUFFER_AND_SIZE */
  }
  ...
  )
{
  ...
  if (Dem_APIChecks_TestExtendedDataRecordNumberReadableInSwcApi(RecordNumber) == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_DATA)
  }
  else
  {
    /* ----- Implementation ------------------------------------------------ */
    lReturnValue = Dem_EnvDataSwcApi_GetEventExtendedDataRecordEx(EventId, RecordNumber, DestBuffer, BufSize);                   /* SBSW_DEM_POINTER_FORWARD_API_ARGUMENT_BUFFER_AND_SIZE */
  }
...
# endif
  if (Dem_APIChecks_IsSnapshotRecordNumberAllowedInDTCSelection(ClientId, RecordNumber) == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_DATA)
  }
  else
...
#endif
    {
      Dem_RecordReader_0x1904_SelectFirstSource(ClientId, RecordNumber);
      lReturnValue = E_OK;
    }
  }
...
# endif
  {
    ...
    {
      lReturnValue = Dem_RecordReader_0x1904_ReadNextRecord(ClientId, DestBuffer, BufSize);                                      /* SBSW_DEM_POINTER_FORWARD_API_ARGUMENT_BUFFER_AND_SIZE */
    }
  }
  /* ----- Development Error Report ---------------------------------------- */
  if (Dem_Det_ErrorRegisterGet() != DEM_E_NO_ERROR)
...
# endif
  {
    ...
    {
      lReturnValue = Dem_RecordReader_0x1904_GetSize(ClientId, SizeOfFreezeFrame);                                               /* SBSW_DEM_POINTER_FORWARD_API */
    }
  }
...
# endif
  if (Dem_APIChecks_IsExtendedDataRecordNumberAllowedInDTCSelection(ClientId, ExtendedDataNumber) == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_DATA)
  }
  else  
...
# endif
  {
    ...
    {
      lReturnValue = Dem_Dcm_ERec_ReadNextRecord(ClientId, DestBuffer, BufSize);                                                 /* SBSW_DEM_POINTER_FORWARD_API_ARGUMENT_BUFFER_AND_SIZE */
    }
  }
        ...
        do
        {
            ...
            )
          {
            ...
            if (Dem_Event_TestDataUpdateInProgress(lUpdateState) == FALSE)
            {
              ...
              else if ((Dem_Cfg_EventUdsDtc(Dem_MemoryEntry_ObdFreezeFrameEntry_GetEventId(lSelectedIndex)) == lUdsDtc)
                && (Dem_MemoryEntry_ObdFreezeFrameEntry_GetEventId(lSelectedIndex) != DEM_EVENT_INVALID))                        /* PRQA S 3415 */ /* MD_DEM_13.5_volatile */
              {
...
# if (DEM_CFG_SUPPORT_OBDII == STD_ON)
    if (Dem_Cfg_IsObdIIExclusivelySupportedInVariant() == TRUE)
    {
      ...
      do
      {
        ...
        if ((Dem_Memories_ObdFreezeFrameMemory_GetSize() != lSelectedIndex)
          && (Dem_DTC_TestDtcSuppression(Dem_MemoryEntry_ObdFreezeFrameEntry_GetEventId(lSelectedIndex)) == FALSE)               /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
          )
        {
          uint8 lUpdateState;
          lFreezeFrameEventId = Dem_MemoryEntry_ObdFreezeFrameEntry_GetEventId(lSelectedIndex);
          ...
          {
            {
              ...
              lReturnValue = Dem_DataReport_ObdIIFreezeFrameCopyPidData(lSelectedIndex, PID, DataElementIndexOfPID, DestBuffer, &lTempBufSize); /* SBSW_DEM_POINTER_FORWARD_API_ARGUMENT_BUFFER_AND_SIZE */ /* SBSW_DEM_POINTER_FORWARD_STACK */
              *BufSize = lTempBufSize;                                                                                           /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
              ...
              else if ((Dem_MemoryEntry_ObdFreezeFrameEntry_GetEventId(lSelectedIndex) != lFreezeFrameEventId)
                && (Dem_MemoryEntry_ObdFreezeFrameEntry_GetEventId(lSelectedIndex) != DEM_EVENT_INVALID))                        /* PRQA S 3415 */ /* MD_DEM_13.5_volatile */
              {
...
# else
    DEM_IGNORE_UNUSED_ARGUMENT(PID)                                                                                              /* PRQA S 1338, 3112 */ /* MD_MSR_DummyStmt, MD_DEM_14.2 */
    DEM_IGNORE_UNUSED_ARGUMENT(DataElementIndexOfPID)                                                                            /* PRQA S 1338, 3112 */ /* MD_MSR_DummyStmt, MD_DEM_14.2 */
# endif
  }
...
)
{
  ...
  if (Dem_APIChecks_IsDTCFormatValid(DTCFormat, Dem_DTCFormat_Context_SetERecFilter) == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_DATA)
  }
  else
...
)
{
  ...
  if (Dem_APIChecks_NullPointer(SizeOfRecords) == FALSE)                                                                         /* SBSW_DEM_POINTER_NULLPTR_CHECKING */ /* PRQA S 0315 */ /* MD_DEM_Dir1.1 */
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_POINTER)
  }
  else
  ...
  {
    /* ----- Implementation ------------------------------------------------ */                                                  
    lReturnValue = Dem_Client_ClientAccess_GetSizeOfFilteredExtendedDataRecords(                                                 /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
      ClientId, NumberOfFilteredRecords, SizeOfRecords);
  }

  /* ----- Development Error Report ---------------------------------------- */
  if (Dem_Det_ErrorRegisterGet() != DEM_E_NO_ERROR)
  {
    Dem_Error_ReportError(DEM_GETSIZEOFFILTEREDEXTENDEDDATARECORDS_APIID, Dem_Det_ErrorRegisterGet());
  }
...
# endif
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    if ((Dem_Client_ClientAccess_IsJ1939FreezeFrameSupported() == FALSE)
         && (FreezeFrameKind == DEM_J1939DCM_FREEZEFRAME))
    {
      lReturnValue = E_NOT_OK;
    }
    else
    if ((Dem_Client_ClientAccess_IsJ1939ExpandedFreezeFrameSupported() == FALSE)
         && (  (FreezeFrameKind == DEM_J1939DCM_EXPANDED_FREEZEFRAME)
            || (FreezeFrameKind == DEM_J1939DCM_SPNS_IN_EXPANDED_FREEZEFRAME)))
    {
      lReturnValue = E_NOT_OK;
...
# endif
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    lReturnValue = Dem_Client_ClientAccess_GetNextJ1939FreezeFrame(ClientId,                                                     /* SBSW_DEM_POINTER_FORWARD_API_ARGUMENT_BUFFER_AND_SIZE */
                                                                    J1939DTC,
                                                                    OccurrenceCounter,
                                                                    DestBuffer,
                                                                    BufSize);
...
# if (DEM_DEV_ERROR_DETECT == STD_ON)
  ...
  if (Dem_Client_ClientAccess_TestJ1939FreezeFrameFilterFreezeFrameKind(ClientId, DEM_J1939DCM_SPNS_IN_EXPANDED_FREEZEFRAME) == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_WRONG_CONDITION)
  }
  else
# endif
  ...
  else
  {
    ...
    {
      lReturnValue = Dem_Client_ClientAccess_GetNextSPNInFreezeFrame(ClientId, SPNSupported, SPNDataLength);                     /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    }
  }
...
#endif /* DEM_FEATURE_NEED_J1939_FREEZEFRAME == STD_ON || DEM_CFG_SUPPORT_J1939_EXPANDED_FREEZEFRAME_FOR_OBDII == STD_ON */
...
#endif /* DEM_RECORDREADERIF_SVCIMPLEMENTATION_H */

/*!
 * \}
 */
/* ********************************************************************************************************************
 *  END OF FILE: Dem_RecordReaderIF_SvcImplementation.h
 *********************************************************************************************************************/
