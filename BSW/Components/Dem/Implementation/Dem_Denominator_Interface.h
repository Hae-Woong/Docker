 ...
 *****************************************************************************/
/*!
 * \brief         Initialize denominator status bits and counter value
 *
 * \details       Initialize denominator status bits and counter value
 *
 * \param[in]     RatioIndex
 *                Unique handle of the Ratio
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Initialize denominator status bits relevant to OpCycle Start
 *
 * \details       -
 *
 * \param[in]     RatioIndex
