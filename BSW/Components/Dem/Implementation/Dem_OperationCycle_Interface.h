 ...
 *****************************************************************************/
/*!
 * \brief         Returns the current aging cycle count of the event.
 *
 * \details       -
 *
 * \param[in]     EventId
 ...
 *
 * \return        Current counter of the aging cycle
 *
 * \pre           -
 *
 * \context       TASK|ISR2
 ...
 *****************************************************************************/
/*!
 * \brief         Pre-Initializes operation cycle states.
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Initializes operation cycle states.
 *
 ...
 *                see DSGN-Dem-OperationCycleInitDependencies
 *
 * \context       TASK
 * \synchronous   TRUE
 * \reentrant     FALSE
