...
/* Usually, including interfaces of sub-units of the top LU GlobalDiagnostics is not allowed however,
*  the scheduler is an exception to this rule, so that it can call the main functions of each sub-component
*  directly
*/
...
DEM_LOCAL volatile VAR(uint32, DEM_VAR_NO_INIT) Dem_Scheduler_ScheduledMultipleInvocationTasks;
DEM_LOCAL volatile VAR(uint32, DEM_VAR_NO_INIT) Dem_Scheduler_ScheduledSingleInvocationTasks;
  ...
  )
{
  ...
  case Dem_Scheduler_Task_Event:
    ...
    break;
  case Dem_Scheduler_Task_SamplerCollectData:
    Dem_GlobalDiagnostics_Sampler_CollectData();
    break;
  case Dem_Scheduler_Task_CustomTrigger:
  ...
  case Dem_Scheduler_Task_EngineRuntime:
    ...
    break;
  case Dem_Scheduler_Task_Pto:
    Dem_GlobalDiagnostics_Pto_MainFunction();
    break;
  case Dem_Scheduler_Task_ReadinessCompletion:
     Dem_Readiness_Completion_ProcessUpdateFlag();
    break;
  case Dem_Scheduler_Task_SamplerReset:
