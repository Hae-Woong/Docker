 ...
 *****************************************************************************/
/*!
 * \brief         Test global denominator conditions reached while PTO inactive
 *                state
 *
 * \details       Test whether the global denominator condition were reached
 *                while PTO was inactive
 *
 * \param[in]     ConditionId
 *                The denominator condition id.
 * \return        TRUE
 *                Denominator conditions were reached while PTO was inactive
 * \return        FALSE
 *                Denominator conditions were not reached while PTO was
 *                inactive
 *
 * \pre           -
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Get General Denominator
 *
 * \details       Get General Denominator
 *
 * \param[out]    GeneralDenominator
 *
 *
 ...
 *                worst ratio of all events associated with a Dtc.
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Compare two IUMPR ratios and return the worse ratio.
 *
 * \details       Compare two IUMPR ratios and return the worse ratio.
 *
 * \param[in]     RatioIndex1
 *                Unique handle of the first Ratio to compare.
 * \param[out]    RatioIndex2
 *                Unique handle of the second Ratio to compare.
 * \return        Unique handle of the worse ratio
 *                DEM_CFG_RATIOINDEX_INVALID if feature IUMPR is not
 *                supported.
 *
 * \pre           Feature IUMPR is supported
 *
