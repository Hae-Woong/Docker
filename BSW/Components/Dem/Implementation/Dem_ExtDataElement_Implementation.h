...
# endif
  {
    ...
    else if (Dem_Cfg_DataCallbackType(DataIndex) == DEM_CFG_DATA_FROM_FCT_WITH_EVENTID_BUFFERLENGTH)
    {
      lRetValue = (*((Dem_ReadDataEventIdBufferLengthExtendedBooleanFPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(EventId, &lDataAppl, Dem_Cfg_DataSize(DataIndex)); /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALVARIABLE */
    }
#if (DEM_CFG_SUPPORT_DCM == STD_ON)
    else if (Dem_Cfg_DataCallbackType(DataIndex) == DEM_CFG_DATA_FROM_FCT_WITH_PROXY)
    {
      Dcm_NegativeResponseCodeType lErrorCode;
      lRetValue = (*((Dem_ReadDataBufferLengthErrorCodeExtendedBooleanFPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(&lDataAppl, Dem_Cfg_DataSize(DataIndex), &lErrorCode); /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALVARIABLE */
    }
#endif
    else
    {
...
# endif
  {
    ...
    {
      lRetValue = (*((Dem_ReadDataEventIdBufferLengthExtendedSint8FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(EventId, &lData, Dem_Cfg_DataSize(DataIndex)); /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALVARIABLE */
    }
#if (DEM_CFG_SUPPORT_DCM == STD_ON)
    else if (Dem_Cfg_DataCallbackType(DataIndex) == DEM_CFG_DATA_FROM_FCT_WITH_PROXY)
    {
      Dcm_NegativeResponseCodeType lErrorCode;
      lRetValue = (*((Dem_ReadDataBufferLengthErrorCodeExtendedSint8FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(&lData, Dem_Cfg_DataSize(DataIndex), &lErrorCode); /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALVARIABLE */
    }
#endif
    else
    {
...
# endif
  {
    ...
    {
      lRetValue = (*((Dem_ReadDataEventIdBufferLengthExtendedUint8FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(EventId, &lData, Dem_Cfg_DataSize(DataIndex)); /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALVARIABLE */
    }
#if (DEM_CFG_SUPPORT_DCM == STD_ON)
    else if (Dem_Cfg_DataCallbackType(DataIndex) == DEM_CFG_DATA_FROM_FCT_WITH_PROXY)
    {
      Dcm_NegativeResponseCodeType lErrorCode;
      lRetValue = (*((Dem_ReadDataBufferLengthErrorCodeExtendedUint8FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(&lData, Dem_Cfg_DataSize(DataIndex), &lErrorCode); /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALVARIABLE */
    }
#endif
    else
    {
...
# endif
  {
    ...
    {
      lRetValue = (*((Dem_ReadDataEventIdBufferLengthExtendedSint16FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(EventId, &lData, Dem_Cfg_DataSize(DataIndex)); /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALVARIABLE */
    }
#if (DEM_CFG_SUPPORT_DCM == STD_ON)
    else if (Dem_Cfg_DataCallbackType(DataIndex) == DEM_CFG_DATA_FROM_FCT_WITH_PROXY)
    {
      Dcm_NegativeResponseCodeType lErrorCode;
      lRetValue = (*((Dem_ReadDataBufferLengthErrorCodeExtendedSint16FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(&lData, Dem_Cfg_DataSize(DataIndex), &lErrorCode); /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALVARIABLE */
    }
#endif
    else
    {
...
# endif
  {
    ...
    {
      lRetValue = (*((Dem_ReadDataEventIdBufferLengthExtendedUint16FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(EventId, &lData, Dem_Cfg_DataSize(DataIndex)); /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALVARIABLE */
    }
#if (DEM_CFG_SUPPORT_DCM == STD_ON)
    else if (Dem_Cfg_DataCallbackType(DataIndex) == DEM_CFG_DATA_FROM_FCT_WITH_PROXY)
    {
      Dcm_NegativeResponseCodeType lErrorCode;
      lRetValue = (*((Dem_ReadDataBufferLengthErrorCodeExtendedUint16FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(&lData, Dem_Cfg_DataSize(DataIndex), &lErrorCode); /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALVARIABLE */
    }
#endif
    else
    {
...
# endif
  {
    ...
    {
      lRetValue = (*((Dem_ReadDataEventIdBufferLengthExtendedSint32FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(EventId, &lData, Dem_Cfg_DataSize(DataIndex)); /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALVARIABLE */
    }
#if (DEM_CFG_SUPPORT_DCM == STD_ON)
    else if (Dem_Cfg_DataCallbackType(DataIndex) == DEM_CFG_DATA_FROM_FCT_WITH_PROXY)
    {
      Dcm_NegativeResponseCodeType lErrorCode;
      lRetValue = (*((Dem_ReadDataBufferLengthErrorCodeExtendedSint32FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(&lData, Dem_Cfg_DataSize(DataIndex), &lErrorCode); /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALVARIABLE */
    }
#endif
    else
    {
...
# endif
  {
    ...
    {
      lRetValue = (*((Dem_ReadDataEventIdBufferLengthExtendedUint32FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(EventId, &lData, Dem_Cfg_DataSize(DataIndex)); /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALVARIABLE */
    }
#if (DEM_CFG_SUPPORT_DCM == STD_ON)
    else if (Dem_Cfg_DataCallbackType(DataIndex) == DEM_CFG_DATA_FROM_FCT_WITH_PROXY)
    {
      Dcm_NegativeResponseCodeType lErrorCode;
      lRetValue = (*((Dem_ReadDataBufferLengthErrorCodeExtendedUint32FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(&lData, Dem_Cfg_DataSize(DataIndex), &lErrorCode); /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALVARIABLE */
    }
#endif
    else
    {
...
# endif
  {
    ...
    {
      lRetValue = (*((Dem_ReadDataEventIdBufferLengthExtendedFloat32FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(EventId, &lData.AsFloat32, Dem_Cfg_DataSize(DataIndex)); /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALVARIABLE */
    }
#if (DEM_CFG_SUPPORT_DCM == STD_ON)
    else if (Dem_Cfg_DataCallbackType(DataIndex) == DEM_CFG_DATA_FROM_FCT_WITH_PROXY)
    {
      Dcm_NegativeResponseCodeType lErrorCode;
      lRetValue = (*((Dem_ReadDataBufferLengthErrorCodeExtendedFloat32FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(&lData.AsFloat32, Dem_Cfg_DataSize(DataIndex), &lErrorCode); /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALVARIABLE */
    }
#endif
    else
    {
...
# endif
  {
    ...
    if (Dem_Data_CheckAvailableSizeDestinationBuffer(DestinationBuffer, lDataSize) == E_OK)                                      /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    {
      ...
      {
        lRetValue = (*((Dem_ReadDataEventIdBufferLengthExtendedUint8FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(                   /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_DESTINATIONBUFFER */
          EventId,
          lDestinationBufferWritePtr,
          lDataSize);
      }
      ...
      {
        Dcm_NegativeResponseCodeType lErrorCode;
        lRetValue = (*((Dem_ReadDataBufferLengthErrorCodeExtendedUint8FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(                 /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_DESTINATIONBUFFER */
          lDestinationBufferWritePtr,
          lDataSize,
          &lErrorCode);
      }
...
# endif
  {
    ...
    if (Dem_Data_CheckAvailableSizeDestinationBuffer(DestinationBuffer, lDataSize) == E_OK)                                      /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    {
      ...
      {
        lRetValue = (*((Dem_ReadDataEventIdBufferLengthExtendedSint8FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(                   /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_DESTINATIONBUFFER */
          EventId,
          (Dem_SignedNvDataPtrType)lDestinationBufferWritePtr,
          lDataSize);                                                                                                            /* PRQA S 0310 */ /* MD_DEM_11.4_sr */
      }
#if (DEM_CFG_SUPPORT_DCM == STD_ON)
      else if (Dem_Cfg_DataCallbackType(DataIndex) == DEM_CFG_DATA_FROM_FCT_WITH_PROXY)
      {
        Dcm_NegativeResponseCodeType lErrorCode;
        lRetValue = (*((Dem_ReadDataBufferLengthErrorCodeExtendedSint8FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(                 /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_DESTINATIONBUFFER */
          (Dem_SignedNvDataPtrType)lDestinationBufferWritePtr,
          lDataSize,
          &lErrorCode);                                                                                                          /* PRQA S 0310 */ /* MD_DEM_11.4_sr */
      }
#endif
      else
      {
...
# endif
  {
    ...
    {
      lRetValue = (*((Dem_ReadDataEventIdBufferLengthExtendedUint16FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(                    /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALBUFFER */
        EventId,
        &lReadData[0],
        lDataSize);
    }
    ...
    {
      Dcm_NegativeResponseCodeType lErrorCode;
      lRetValue = (*((Dem_ReadDataBufferLengthErrorCodeExtendedUint16FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(                  /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALBUFFER */
        &lReadData[0],
        lDataSize,
        &lErrorCode);
    }
...
# endif
  {
    ...
    {
      lRetValue = (*((Dem_ReadDataEventIdBufferLengthExtendedSint16FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(                    /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALBUFFER */
        EventId,
        &lReadData[0],
        lDataSize);
    }
    ...
    {
      Dcm_NegativeResponseCodeType lErrorCode;
      lRetValue = (*((Dem_ReadDataBufferLengthErrorCodeExtendedSint16FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(                  /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALBUFFER */
        &lReadData[0],
        lDataSize,
        &lErrorCode);
    }
...
# endif
  {
    ...
    {
      lRetValue = (*((Dem_ReadDataEventIdBufferLengthExtendedUint32FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(                    /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALBUFFER */
        EventId,
        &lReadData[0],
        lDataSize);
    }
    ...
    {
      Dcm_NegativeResponseCodeType lErrorCode;
      lRetValue = (*((Dem_ReadDataBufferLengthErrorCodeExtendedUint32FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(                  /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALBUFFER */
        &lReadData[0],
        lDataSize,
        &lErrorCode);
    }
...
# endif
  {
    ...
    {
      lRetValue = (*((Dem_ReadDataEventIdBufferLengthExtendedSint32FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(                    /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALBUFFER */
        EventId,
        &lReadData[0u],
        lDataSize);
    }
    ...
    {
      Dcm_NegativeResponseCodeType lErrorCode;
      lRetValue = (*((Dem_ReadDataBufferLengthErrorCodeExtendedSint32FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(                  /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALBUFFER */
        &lReadData[0u],
        lDataSize,
        &lErrorCode);
    }
...
# endif
  {
    ...
    {
      lRetValue = (*((Dem_ReadDataEventIdBufferLengthExtendedFloat32FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(                   /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALBUFFER */
        EventId,
        &lReadData[0].AsFloat32,
        lDataSize
        );
    ...
    {
      Dcm_NegativeResponseCodeType lErrorCode;
      lRetValue = (*((Dem_ReadDataBufferLengthErrorCodeExtendedFloat32FPtrType)Dem_Cfg_DataCbkRead(DataIndex)))(                 /* PRQA S 0313 */ /* MD_DEM_11.1 */ /* SBSW_DEM_CALL_APPLCALLBACK_WRITE_LOCALBUFFER */
        &lReadData[0].AsFloat32,
        lDataSize,
        &lErrorCode);
    }
  ...
  )
{
  ...
  if ((Dem_Cfg_DataCallbackType(DataIndex) == DEM_CFG_DATA_FROM_CS_PORT)
    ...
    || (Dem_Cfg_DataCallbackType(DataIndex) == DEM_CFG_DATA_FROM_FCT_WITH_EVENTID_BUFFERLENGTH)
    || (Dem_Cfg_DataCallbackType(DataIndex) == DEM_CFG_DATA_FROM_FCT_WITH_PROXY)
  ...
  )
{
  ...
  {
    /* signal invalid */
    Dem_MemoryEntry_EventEntry_SetStdEnvData(EventEntryIndex, DEM_EVENTENTRY_STDENVDATA_CURRENTODOMETER, 0xFFU);
    Dem_MemoryEntry_EventEntry_SetStdEnvData(EventEntryIndex, DEM_EVENTENTRY_STDENVDATA_CURRENTODOMETER + 1u, 0xFFU);
  }
  else
  if (lPreciseOdometer == 0x00FFFFFEuL)
  {
    /* signal unavailable */
    Dem_MemoryEntry_EventEntry_SetStdEnvData(EventEntryIndex, DEM_EVENTENTRY_STDENVDATA_CURRENTODOMETER, 0xFFU);
    Dem_MemoryEntry_EventEntry_SetStdEnvData(EventEntryIndex, DEM_EVENTENTRY_STDENVDATA_CURRENTODOMETER + 1u, 0xFEU);
  }
  else
  {
    ...
    Dem_MemoryEntry_EventEntry_SetStdEnvData(EventEntryIndex,
      DEM_EVENTENTRY_STDENVDATA_CURRENTODOMETER, Dem_GetHiByte(lScaledOdometer));
    Dem_MemoryEntry_EventEntry_SetStdEnvData(EventEntryIndex,
      DEM_EVENTENTRY_STDENVDATA_CURRENTODOMETER + 1u, Dem_GetLoByte(lScaledOdometer));
  }
}
#endif
...
# endif
  ...
  Dem_MemoryEntry_EventEntry_SetStdEnvData(EventEntryIndex, DEM_EVENTENTRY_STDENVDATA_TIME, Dem_GetHiHiByte(lOperatingTime));
  Dem_MemoryEntry_EventEntry_SetStdEnvData(EventEntryIndex, DEM_EVENTENTRY_STDENVDATA_TIME + 1u, Dem_GetHiLoByte(lOperatingTime));
  Dem_MemoryEntry_EventEntry_SetStdEnvData(EventEntryIndex, DEM_EVENTENTRY_STDENVDATA_TIME + 2u, Dem_GetLoHiByte(lOperatingTime));
  Dem_MemoryEntry_EventEntry_SetStdEnvData(EventEntryIndex, DEM_EVENTENTRY_STDENVDATA_TIME + 3u, Dem_GetLoLoByte(lOperatingTime));
  Dem_MemoryEntry_EventEntry_SetStdEnvData(EventEntryIndex, DEM_EVENTENTRY_STDENVDATA_TIMESTATUS, lOperatingTimeStatus);
...
)
{
...
#if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ( (DataIndex >= Dem_Cfg_GlobalDataElementCount())
    || (Dem_Cfg_DataCallbackType(DataIndex) != DEM_CFG_DATA_FROM_CS_PORT)
    || (Dem_Cfg_DataElementDataType(DataIndex) != DEM_CFG_DATA_TYPE_UINT8_N)
    || (Dem_Cfg_DataCbkRead(DataIndex) == NULL_PTR)
    || (Dem_Cfg_DataSize(DataIndex) != 4u) )
  {
    Dem_Error_RunTimeCheckFailed(DEM_EXTDATAELEMENT_IMPLEMENTATION_FILENAME, __LINE__);                                          /* SBSW_DEM_POINTER_RUNTIME_CHECK */
...
#endif
  {
    ...
    if (Dem_Data_CheckAvailableSizeDestinationBuffer(DestinationBuffer, lDataSize) == E_OK)                                      /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    {
      Dem_SharedDataPtrType lDestinationBufferWritePtr =
        Dem_Data_GetPtrToWriteIndexOfDestinationBuffer(DestinationBuffer);                                                       /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
