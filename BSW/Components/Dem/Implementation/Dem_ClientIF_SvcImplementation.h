 ...
 *  \{
 *  \file       Dem_ClientIF_SvcImplementation.h
...
#if !defined (DEM_CLIENTIF_SVCIMPLEMENTATION_H)
#define DEM_CLIENTIF_SVCIMPLEMENTATION_H
...
#define DEM_CLIENTIF_SVCIMPLEMENTATION_FILENAME "Dem_ClientIF_SvcImplementation.h"
...
# if (DEM_DEV_ERROR_DETECT == STD_ON)
  if ( ( (Dem_Cfg_IsObdIIExclusivelySupportedInVariant() == FALSE) && (Dem_Cfg_IsWwhObdSupportedInVariant() == FALSE) )
...
# endif /*DEM_DEV_ERROR_DETECT*/
  if (Dem_APIChecks_IsDTCFormatValid(DTCFormat, Dem_DTCFormat_Context_SetDTCFilter) == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_DATA);
  }
  else
  ...
  if (Dem_APIChecks_IsDTCFormatAllowedWithFilter(DTCFormat, DTCOrigin, FilterWithSeverity, FilterForFaultDetectionCounter) == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_DATA);
  }
  else
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    /* Returns E_NOT_OK if function arguments do not match configuration. */
...
# endif
  if (Dem_APIChecks_IsDTCFormatValid(DTCFormat, Dem_DTCFormat_Context_SetFFRecFilter) == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_DATA)
  }
  else
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    if ((Dem_Cfg_IsGlobalSRecSupportEnabled() == TRUE)
      || (Dem_Cfg_IsSRecSupportEnabled() == TRUE)
  ...
  )
{
  ...
  else
  {
    ...
    case DEM_DTCSELECTOR_SELECTION_DTC:
      lReturnValue = Dem_Client_GetStatusOfSelectedDTC(ClientId, DTCStatus);                                                     /* SBSW_DEM_POINTER_FORWARD_API */
      break;
  ...
  )
{
  ...
  else
  {
    ...
    {
    case DEM_DTCSELECTOR_SELECTION_DTC:
      lReturnValue = Dem_Client_GetSeverityOfSelectedDTC(ClientId, DTCSeverity);                                                 /* SBSW_DEM_POINTER_FORWARD_API */
      break;
  ...
  )
{
  ...
  else
  {
    ...
    {
    case DEM_DTCSELECTOR_SELECTION_DTC:
      lReturnValue = Dem_Client_GetFunctionalUnitOfSelectedDTC(ClientId, DTCFunctionalUnit);                                     /* SBSW_DEM_POINTER_FORWARD_API */
      break;
...
#endif
  if (Dem_APIChecks_IsDTCFormatValid(DTCFormat, Dem_DTCFormat_Context_SelectDTC) == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_DATA)
  }
  else
  if (Dem_APIChecks_IsDTCFormatValidWithOrigin(DTCFormat, DTCOrigin, Dem_DTCFormat_Context_SelectDTC) == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_DATA)
  }
  else
  ...
  )
{
  ...
  else
  {
    ...
    {
    case DEM_DTCSELECTOR_SELECTION_DTC:
      lReturnValue = Dem_Client_GetEventIdOfSelectedDTC(ClientId, EventId);                                                      /* SBSW_DEM_POINTER_FORWARD_API */
      break;
...
FUNC(Std_ReturnType, DEM_CODE)
Dem_SetHideObdOccurrences(
  boolean DoHide                                                                                                                 /* PRQA S 1330 */ /* MD_DEM_8.3_rte */
  )
{
  Std_ReturnType lReturnValue;
  Dem_Det_ErrorRegisterDefine()
...
FUNC(Std_ReturnType, DEM_CODE)
Dem_GetHideObdOccurrences(
  P2VAR(boolean, AUTOMATIC, DEM_APPL_DATA)  IsHidden                                                                             /* PRQA S 1330 */ /* MD_DEM_8.3_rte */
  )
{
  Std_ReturnType lReturnValue;
  Dem_Det_ErrorRegisterDefine()
...
)
{
  ...
  if (Dem_APIChecks_IsDTCFormatValid(DTCFormat, Dem_DTCFormat_Context_SetFilterByReadinessGroup) == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_DATA)
  }
  else
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    lReturnValue = Dem_Client_ClientAccess_SetDtcFilterByReadinessGroup(ClientId, DTCFormat, ReadinessGroupNumber);
  }
...
)
{
  ...
  if (Dem_APIChecks_IsDTCFormatValid(DTCFormat, Dem_DTCFormat_Context_SetFilterByERecNumber) == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_DATA)
  }
  else
  if (Dem_APIChecks_IsExtendedDataRecordNumberAllowedInDTCFilter(DTCFormat, ExtendedDataRecordNumber) == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_DATA)
  }
  else
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    lReturnValue = Dem_Client_ClientAccess_SetDTCFilterByExtendedDataRecordNumber(ClientId, DTCFormat, ExtendedDataRecordNumber);
  }
...
# if (DEM_DEV_ERROR_DETECT == STD_ON)
  ...
  if (DTCTypeFilter >= DEM_J1939DTC_CLEAR_ACTIVE_AND_PREVIOUSLY_ACTIVE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_DATA)
  }
  else
  ...
  if ((Dem_Cfg_IsObdIIExclusivelySupportedInVariant() == FALSE) && (Dem_Cfg_IsEmissionObdSupportedInVariant() == TRUE))
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_CONFIG);
  }
  else
# endif
  ...
  {
    /* ----- Implementation ------------------------------------------------ */    
    lReturnValue = Dem_Client_ClientAccess_J1939ClearSingleDTC(ClientId, J1939DTC, DTCOrigin, DTCTypeFilter);
  }

  /* ----- Development Error Report ---------------------------------------- */
  if (Dem_Det_ErrorRegisterGet() != DEM_E_NO_ERROR)
  {
    Dem_Error_ReportError(DEM_J1939DCMCLEARSINGLEDTC_APIID, Dem_Det_ErrorRegisterGet());
  }
...
)
{
  ...
  if (Dem_APIChecks_NullPointer(IgnitionCycleCounter) == FALSE)                                                                  /* SBSW_DEM_POINTER_NULLPTR_CHECKING */  /* PRQA S 0315 */ /* MD_DEM_Dir1.1 */
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_POINTER)
  }
  else
  if (Dem_APIChecks_NullPointer(OBDMonitoringConditionsEncountered) == FALSE)                                                    /* SBSW_DEM_POINTER_NULLPTR_CHECKING */  /* PRQA S 0315 */ /* MD_DEM_Dir1.1 */
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_POINTER)
  }
  else
  ...
  if (Dem_APIChecks_TestJ1939NodeValid(ClientId) == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_DATA)
  }
  else
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    lReturnValue = Dem_Client_ClientAccess_SetJ1939RatioFilter(                                                                  /* SBSW_DEM_POINTER_FORWARD_API */
...
)
{
  ...
  if (Dem_APIChecks_NullPointer(SPN) == FALSE)                                                                                   /* SBSW_DEM_POINTER_NULLPTR_CHECKING */  /* PRQA S 0315 */ /* MD_DEM_Dir1.1 */
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_POINTER)
  }
  else
  ...
  if (Dem_APIChecks_TestJ1939RatioFilterSet(ClientId) == FALSE)
  {
    Dem_Det_ErrorRegisterSet(DEM_E_WRONG_CONDITION)
  }
  else
  ...
  {
    lReturnValue = Dem_Client_ClientAccess_GetNextFilteredJ1939Ratio(                                                            /* SBSW_DEM_POINTER_FORWARD_API */
      SPN,
      Numerator,
      Denominator,
      ClientId);
...
# endif
  ...
  {
    /* ----- Implementation ------------------------------------------------ */
    if ((Dem_Cfg_IsObdIIExclusivelySupportedInVariant() == TRUE) || (Dem_Cfg_IsEmissionObdSupportedInVariant() == FALSE))
    {
      lReturnValue = Dem_Client_ClientAccess_ReadDiagnosticReadiness1(ClientId, DataValue);                                      /* SBSW_DEM_POINTER_FORWARD_API */
    }
  }
...
FUNC(Std_ReturnType, DEM_CODE)
Dem_J1939DcmReadDiagnosticReadiness2(
  P2VAR(Dem_J1939DcmDiagnosticReadiness2Type, AUTOMATIC, DEM_J1939DCM_DATA)  DataValue,                                          /* PRQA S 3206, 3673 */ /* MD_DEM_3206, MD_DEM_8.13 */
  uint8  ClientId
)
{
  Std_ReturnType lReturnValue;
  ...
  else if (Dem_APIChecks_NullPointer(DataValue) == FALSE)                                                                        /* SBSW_DEM_POINTER_NULLPTR_CHECKING */ /* PRQA S 0315 */ /* MD_DEM_Dir1.1 */
  {
    Dem_Det_ErrorRegisterSet(DEM_E_PARAM_POINTER)
  }
  else
  ...
  else
  {
    ...
    { 
      lReturnValue = Dem_Client_ClientAccess_ReadDiagnosticReadiness2(ClientId, DataValue);                                      /* SBSW_DEM_POINTER_FORWARD_API */
    }
  }
...
)
{
  ...
  else
  {
    ...
    if (Dem_Cfg_IsObdIIExclusivelySupportedInVariant() == TRUE)
    {
      lReturnValue = Dem_Client_ClientAccess_ReadDiagnosticReadiness3(                                                           /* SBSW_DEM_POINTER_FORWARD_API */
        ClientId,
        DataValue);
    }
  }
...
#endif /* DEM_CLIENTIF_SVCIMPLEMENTATION_H */

/*!
 * \}
 */
/* ********************************************************************************************************************
 *  END OF FILE: Dem_ClientIF_SvcImplementation.h
 *********************************************************************************************************************/
