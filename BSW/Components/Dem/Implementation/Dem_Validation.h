...
#if !defined PRQA_SIZE_T && !defined _lint && !defined _REVIEW_HELPER && !defined _TSC_DEM_VALIDATIONS && !defined TESTCONFIG_UNSUPPORTED_FEATURECOMBINATION /* COV_DEM_UNSUPPORTED_TESTED_FEATURE TF xf xf xf xf xf tf */ /* SBSW_DEM_ORGANI_TESTCODE_COMMENT_UNDEFINED */

# if (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_ON) && (DEM_CFG_STORE_PRIMARYMEMORY_AT_FAILED != STD_ON)
# error "OBDII / OBDonUDS requires Storage Trigger of Primary Memory as Failed"
# endif

# if (DEM_CFG_SUPPORT_WWHOBD == STD_ON) && (DEM_CFG_STORE_PRIMARYMEMORY_AT_FAILED != STD_ON)
# error "WWH-OBD requires Storage Trigger of Primary Memory as Failed"
# endif
...
#if ((DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_ON) && (DEM_CFG_SUPPORT_MULTITRIP != STD_ON))
#error "For OBD-II / OBDonUDS ECUs, Multitrip must be enabled"
#endif

#if ((DEM_CFG_SUPPORT_OBDONUDS == STD_ON) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS != STD_ON))
#error "For OBD on UDS ECUs, both switches must be enabled"
#endif

#if ((DEM_CFG_SUPPORT_OBDII == STD_ON) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS != STD_ON))
#error "For OBD-II configurations, both switches must be enabled"
#endif
...
#  error "Event combination Type 2 is currently not supported together with Feature 'Aging without Event Entry'"
# endif
...
# error "Event combination Type 2 is not supported together with OBD on UDS"
#endif

#if (DEM_CFG_SUPPORT_SRECS_CALCULATED_FIFO == STD_ON)
# error "Event combination Type 2 is not supported together with snapshot record calculated fifo"
#endif
...
#  error "Event combination Type 2 is currently not supported together with custom trigger"
# endif
...
# error " DEM_CFG_CLEAR_NV_START_RESPONSE == STD_ON is not supported"
    ...
    && (DEM_CFG_SUPPORT_INDICATORS != STD_ON) )
...
#if ((DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS != STD_ON) && (DEM_CFG_SUPPORT_OBD_HIDE_OCCURRENCES == STD_ON))
# error "(DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS != STD_ON) && (DEM_CFG_SUPPORT_OBD_HIDE_OCCURRENCES == STD_ON) is not\
  a valid combination"
#endif

#if ((DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS != STD_ON) && (DEM_CFG_SUPPORT_PERMANENT_CONDITION_DCY == STD_ON))
# error "(DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS != STD_ON) && (DEM_CFG_SUPPORT_PERMANENT_CONDITION_DCY == STD_ON) is not\
  a valid combination"
#endif

#if ((DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS != STD_ON) && (DEM_CFG_SUPPORT_PERMANENT_MANDATORY_PFC == STD_ON))
# error "(DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS != STD_ON) && (DEM_CFG_SUPPORT_PERMANENT_MANDATORY_PFC == STD_ON) is not\
  a valid combination"
#endif

#if (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS != DEM_CFG_SUPPORT_FREEZEFRAME)
# error " DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS and DEM_CFG_SUPPORT_FREEZEFRAME cannot be independently present"
#endif

#if ((DEM_CFG_SUPPORT_OBDII != STD_ON) && (DEM_CFG_SUPPORT_CONFIRMED_STORAGE_FREEZE_FRAME == STD_ON))
# error "DEM_CFG_SUPPORT_CONFIRMED_STORAGE_FREEZE_FRAME == STD_ON is not valid for non-OBDII ECUs"
#endif
...
#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_IUMPR == STD_ON))
# error "DEM_CFG_SUPPORT_IUMPR == STD_ON is not valid for non-EmissionOBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_MIL == STD_ON))
# error "DEM_CFG_SUPPORT_MIL == STD_ON is not valid for non-EmissionOBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_SIMILAR_CONDITIONS == STD_ON))
# error "DEM_CFG_SUPPORT_SIMILAR_CONDITIONS == STD_ON is not valid for non-EmissionOBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_DTR == STD_ON))
# error "DEM_CFG_SUPPORT_DTR == STD_ON is not valid for non-EmissionOBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII == STD_OFF)) && (DEM_CFG_SUPPORT_PENDING_STORAGE_FREEZE_FRAME == STD_ON))
# error "DEM_CFG_SUPPORT_PENDING_STORAGE_FREEZE_FRAME == STD_ON is not valid for non-OBDII and non-WWHOBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII == STD_OFF)) && (DEM_CFG_SUPPORT_PENDING_UPDATE_FREEZE_FRAME == STD_ON))
# error "DEM_CFG_SUPPORT_PENDING_UPDATE_FREEZE_FRAME == STD_ON is not valid for non-OBDII and non-WWHOBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_MAJOR_MONITORS == STD_ON))
# error "DEM_CFG_SUPPORT_MAJOR_MONITORS == STD_ON is not valid for non-EmissionOBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_CLEAR_PDTC_NO_PFC == STD_ON))
# error "DEM_CFG_SUPPORT_CLEAR_PDTC_NO_PFC == STD_ON is not valid for non-OBDII and non-OBDonUDS ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_RESTART_DCY_ON_CLEAR_DTC == STD_ON))
# error "DEM_CFG_SUPPORT_RESTART_DCY_ON_CLEAR_DTC == STD_ON is not valid for non-EmissionOBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_DELAY_WUC_TO_DCY == STD_ON))
# error "DEM_CFG_SUPPORT_DELAY_WUC_TO_DCY == STD_ON is not valid for non-EmissionOBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_PID01 == STD_ON))
# error "DEM_CFG_SUPPORT_PID01 == STD_ON is not valid for non-EmissionOBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF) && (DEM_CFG_SUPPORT_ZEVONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_PID1C == STD_ON))
# error "DEM_CFG_SUPPORT_PID1C == STD_ON is not valid for non-OBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF) && (DEM_CFG_SUPPORT_ZEVONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_PID21 == STD_ON))
# error "DEM_CFG_SUPPORT_PID21 == STD_ON is not valid for non-OBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_PID30 == STD_ON))
# error "DEM_CFG_SUPPORT_PID30 == STD_ON is not valid for non-EmissionOBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)  && (DEM_CFG_SUPPORT_ZEVONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_PID31 == STD_ON))
# error "DEM_CFG_SUPPORT_PID31 == STD_ON is not valid for non-OBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_PID41 == STD_ON))
# error "DEM_CFG_SUPPORT_PID41 == STD_ON is not valid for non-EmissionOBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF) && (DEM_CFG_SUPPORT_ZEVONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_PID4D == STD_ON))
# error "DEM_CFG_SUPPORT_PID4D == STD_ON is not valid for non-OBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF) && (DEM_CFG_SUPPORT_ZEVONUDS == STD_OFF)) && (DEM_CFG_SUPPORT_PID4E == STD_ON))
# error "DEM_CFG_SUPPORT_PID4E == STD_ON is not valid for non-OBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_PROCESS_RDY_THIS_DCY_COMPREHENSIVE_COMPLETE == STD_ON))
# error "DEM_CFG_PROCESS_RDY_THIS_DCY_COMPREHENSIVE_COMPLETE == STD_ON is not valid for non-EmissionOBD ECUs"
#endif

#if ((DEM_CFG_SUPPORT_OBDONUDS == STD_OFF) && (DEM_CFG_PROCESS_PIDF501_COMPREHENSIVE_COMPLETE == STD_ON))
# error "DEM_CFG_PROCESS_PIDF501_COMPREHENSIVE_COMPLETE == STD_ON is not valid for non-OBDonUDS ECUs"
#endif

#if ((DEM_CFG_SUPPORT_OBDONUDS == STD_OFF) && (DEM_CFG_SUPPORT_SHAREDCOUNTER_COMBINATION == STD_ON))
# error "DEM_CFG_SUPPORT_SHAREDCOUNTER_COMBINATION == STD_ON is not valid for non-OBDonUDS ECUs"
#endif

#if (((DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF)) && (DEM_CFG_REPORT_BLINKING_MIL_AS_ACTIVE == STD_OFF))
# error "DEM_CFG_REPORT_BLINKING_MIL_AS_ACTIVE == STD_OFF is not valid for non-EmissionOBD ECUs"
#endif
...
#if ((DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_ON) && (DEM_CFG_SUPPORT_NVM_IMMEDIATE != STD_ON))
# error "(DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_ON) && (DEM_CFG_SUPPORT_NVM_IMMEDIATE != STD_ON) is not\
  a valid combination"
#endif
...
#if ((DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_ON) && (DEM_CFG_SUPPORT_MIL != STD_ON))
# error "(DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_ON) && (DEM_CFG_SUPPORT_MIL != STD_ON) is not\
  a valid combination"
#endif
...
#if (((DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_ON) || (DEM_CFG_SUPPORT_WWHOBD == STD_ON)) && (DEM_CFG_SUPPORT_INDICATORS != STD_ON))
# error "((DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_ON) || (DEM_CFG_SUPPORT_WWHOBD == STD_ON)) && (DEM_CFG_SUPPORT_INDICATORS != STD_ON) is not\
  a valid combination"
#endif
...
# error "(DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_ON) && (DEM_CFG_SUPPORT_PERMANENT != STD_ON) is not\
  a valid combination"
#endif

#if ((DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_PERMANENT == STD_ON))
# error "DEM_CFG_SUPPORT_PERMANENT == STD_ON is not supported for non-EmissionOBD use cases"
#endif

#if ((DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS != STD_ON) && (DEM_CFG_SUPPORT_PERMANENTDTC_ACTIVATION_DISTANCE == STD_ON))
# error "(DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS != STD_ON) && (DEM_CFG_SUPPORT_PERMANENTDTC_ACTIVATION_DISTANCE == STD_ON) is not\
  a valid combination"
#endif
...
# error "DEM_CFG_SUPPORT_PENDING_STORAGE_FREEZE_FRAME != STD_ON && DEM_CFG_SUPPORT_CONFIRMED_STORAGE_FREEZE_FRAME != STD_ON is not valid for OBDII or WWHOBD ECUs"
#endif

#if (((DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_ON) || (DEM_CFG_SUPPORT_WWHOBD == STD_ON)) && (DEM_FEATURE_NEED_MULTIHEAL != STD_ON))
# error "OBD relevant events need healing cycle counter threshold 3"
#endif

#if (((DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF)) && (DEM_CFG_SUPPORT_MIL_GROUP == STD_ON))
# error "MIL Groups cannot be configured for non OBD ECUs"
#endif

#if ((DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF) && (DEM_CFG_SUPPORT_DISABLE_EVENT_MONITORING  == STD_ON))
# error "(DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_OFF) && (DEM_CFG_SUPPORT_DISABLE_EVENT_MONITORING == STD_ON) is not\
  a valid combination"
#endif
...
#if (((DEM_CFG_SUPPORT_TIME_SERIES_FUTURE == STD_ON) || (DEM_CFG_SUPPORT_TIME_SERIES_PAST == STD_ON)) && (DEM_CFG_SUPPORT_SRECS != STD_ON))
# error "DEM_CFG_SUPPORT_SRECS != STD_ON and time series snapshots is not a valid combination"
#endif

#if (((DEM_CFG_SUPPORT_TIME_SERIES_FUTURE == STD_ON) || (DEM_CFG_SUPPORT_TIME_SERIES_PAST == STD_ON)) && (DEM_CFG_SUPPORT_GLOBAL_SRECS == STD_ON))
# error "DEM_CFG_SUPPORT_GLOBAL_SRECS == STD_ON and time series snapshots supported is not a valid combination"
#endif

#if (((DEM_CFG_SUPPORT_TIME_SERIES_FUTURE == STD_ON) || (DEM_CFG_SUPPORT_TIME_SERIES_PAST == STD_ON)) && (DEM_CFG_SUPPORT_TYPE2_COMBINATION == STD_ON))
...
#if ((DEM_CFG_SUPPORT_MEM_INDEPENDENT_MAX_FDC_SLC == STD_ON) && (DEM_CFG_SUPPORT_TYPE2_COMBINATION == STD_ON))
# error "Event Combination Type 2 and memory independent 'MaxFDCSinceLastClear' is not a valid feature combination"
#endif
...
# error "Only one of the settings DEM_CFG_SUPPORT_OBDII or DEM_CFG_SUPPORT_WWHOBD can be enabled in a configuration without PBS variants."
#endif

#if (DEM_CFG_SUPPORT_OBDONUDS == STD_ON) && (DEM_CFG_SUPPORT_WWHOBD == STD_ON) && (DEM_CFG_SUPPORT_PBS_DIFFERENT_OBD_VARIANTS == STD_OFF)
# error "Only one of the settings DEM_CFG_SUPPORT_OBDONUDS or DEM_CFG_SUPPORT_WWHOBD can be enabled in a configuration without PBS variants."
#endif

#if (DEM_CFG_SUPPORT_ZEVONUDS == STD_ON) && (DEM_CFG_SUPPORT_WWHOBD == STD_ON) && (DEM_CFG_SUPPORT_PBS_DIFFERENT_OBD_VARIANTS == STD_OFF)
# error "Only one of the settings DEM_CFG_SUPPORT_ZEVONUDS or DEM_CFG_SUPPORT_WWHOBD can be enabled in a configuration without PBS variants."
#endif

#if (DEM_CFG_SUPPORT_OBDII == STD_ON) && (DEM_CFG_SUPPORT_OBDONUDS == STD_ON) && (DEM_CFG_SUPPORT_PBS_DIFFERENT_OBD_VARIANTS == STD_OFF)
# error "Only one of the settings DEM_CFG_SUPPORT_OBDII or DEM_CFG_SUPPORT_OBDONUDS can be enabled in a configuration without PBS variants."
#endif

#if (DEM_CFG_SUPPORT_ZEVONUDS == STD_ON) && (DEM_CFG_SUPPORT_OBDONUDS == STD_ON) && (DEM_CFG_SUPPORT_PBS_DIFFERENT_OBD_VARIANTS == STD_OFF)
# error "Only one of the settings DEM_CFG_SUPPORT_ZEVONUDS or DEM_CFG_SUPPORT_OBDONUDS can be enabled in a configuration without PBS variants."
#endif

#if (DEM_CFG_SUPPORT_OBDII == STD_ON) && (DEM_CFG_SUPPORT_ZEVONUDS == STD_ON) && (DEM_CFG_SUPPORT_PBS_DIFFERENT_OBD_VARIANTS == STD_OFF)
# error "Only one of the settings DEM_CFG_SUPPORT_OBDII or DEM_CFG_SUPPORT_ZEVONUDS can be enabled in a configuration without PBS variants."
#endif
...
#if (DEM_CFG_SUPPORT_J1939  == STD_ON) && (DEM_CFG_SUPPORT_ZEVONUDS == STD_ON)
# error "Only one of the settings DEM_CFG_SUPPORT_J1939 or DEM_CFG_SUPPORT_ZEVONUDS must be enabled."
#endif
...
#  error "DEM_CFG_SUPPORT_SHAREDCOUNTER_COMBINATION == STD_ON && DEM_CFG_SUPPORT_TYPE1_COMBINATION == STD_OFF is not a valid combination"
# endif
#endif
...
# if ( (DEM_CFG_CLEAR_SINGLE_DTCS != STD_ON) && (DEM_CFG_CLEAR_GROUP_DTCS != STD_ON) && (DEM_CFG_CLEAR_OBDII_GROUP_DTCS != STD_ON) \
       && (DEM_CFG_CLEAR_ALL_DTCS != STD_ON) && (DEM_CFG_CLEAR_EMISSIONS_SYSTEM_GROUP_DTCS != STD_ON) )
# error "The scope of Dem_ClearDTC API must be configured"
# endif

# if (((DEM_CFG_CLEAR_SINGLE_DTCS == STD_ON) || (DEM_CFG_CLEAR_GROUP_DTCS == STD_ON) || (DEM_CFG_CLEAR_OBDII_GROUP_DTCS == STD_ON) \
      || (DEM_CFG_CLEAR_EMISSIONS_SYSTEM_GROUP_DTCS == STD_ON)) && (DEM_CFG_CLEAR_ALL_DTCS != STD_ON))
...
# error "Multi sample snapshot records and Time series Fifo is not a supported feature combination."
# endif
#endif

#if (DEM_FEATURE_NEED_CUSTOMTRIGGERSTORAGE == STD_ON)
# if (DEM_CFG_SUPPORT_GLOBAL_SRECS == STD_ON)
# error "Custom trigger and Global snapshot records is a not supported feature combination."
# endif
# if (DEM_CFG_SUPPORT_SRECS_CONFIGURED != STD_ON)
# error "Configured Snapshot Records must be supported for Custom Trigger"
# endif
# if ((DEM_CFG_SUPPORT_CUSTOMTRIGGER_TSSR == STD_ON) && (DEM_CFG_SUPPORT_TIME_SERIES_FUTURE == STD_OFF) && (DEM_CFG_SUPPORT_TIME_SERIES_PAST == STD_OFF))
# error "Future and/or Past time series sampling must be supported for Custom Trigger Time Series"
# endif
#endif
