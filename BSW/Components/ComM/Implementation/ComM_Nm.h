 ...
 *********************************************************************************************************************/
# define COMM_NM_MAJOR_VERSION    (0x17u)
# define COMM_NM_MINOR_VERSION    (0x00u)
# define COMM_NM_PATCH_VERSION    (0x01u)

/* Nm service identifiers used by the ComM_Nm_ServiceHandler */
#define NM_NETWORKREQUEST                         (uint8)(0x01u)
#define NM_NETWORKRELEASE                         (uint8)(0x02u)
#define NM_PASSIVESTARTUP                         (uint8)(0x03u)
#define NM_REQUESTSYNCHRONIZEDPNCSHUTDOWN         (uint8)(0x04u)
/* Symbol used for Nm servies not using the PncID */
#define COMM_PNC_ID_NOT_USED                      (PNCHandleType)(0x200u)
...
/**********************************************************************************************************************
 *  CALLBACK FUNCTION PROTOTYPES (called by Nm)
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
/*! \brief       Indication that a Nm-message has been received in the Bus Sleep Mode, which indicates that some nodes
 ...
 *********************************************************************************************************************/
/*! \brief       Indication that a synchronized PNC shutdown was requested and needs to be forwarded for the affected PNCs.
 *  \details      -
 *  \param[in]   Channel               Valid channel identifier (network handle)
