...
-----------------------------------------------------------------------------------------------------------------------
  ...
  14.00.00 2020-10-14   vislsi     NMM-1237 :     R22_ESCAN00106344_Ccl_Asr4ComMCfg5_Vector
                        vispps     NMM-1136:      Multi-Partition Support
  14.01.00 2021-04-27   vispps     NMM-1412:      Finalize Multi-Partition Support
                        vispps     ESCAN00109748: Communication request via PNC is limited on a channel unexpectedly
                        vispps     ESCAN00108491: Channel does not wake up when expected by a passive wakeup
                        smarcelin  NMM-1455:      Support for ComM_GetCurrentPNCComMode
  14.01.01 2021-10-08   smarcelin  ESCAN00105892: Configuration tool throws validation errors if any PNC references a managed channel
  14.02.00 2021-11-24   smarcelin  ESCAN00110796: Error codes of Interface Operation ComM_GetCurrentPNCComMode are not according to AUTOSAR
           2021-11-29   vispps     NMM-1528:      Added support for ASR MemMap include structure
  15.00.00 2022-01-17   smarcelin  NMM-1841:      Support for Synchronized PNC Shutdown
  15.00.01 2022-03-28   vispps     ESCAN00111302: [Multi-Partition] PNC state changes unexpectedly
  16.00.00 2022-05-13   vispps     NMM-2078:      Finite Execution Time Analysis
           2022-05-20   vispps     ESCAN00111917: [Multi-Partition] ComM MainFunction takes too long
           2022-05-24   vispps     ESCAN00111975: [Multi-Partition] State of PNC To Channel Routing Limitation changes unexpectedly
  16.00.01 2022-10-26   smarcelin  ESCAN00112732: [Multi-Partition] Critical Section is never left
  16.01.00 2023-01-02   smarcelin  NMM-2533:      [Multi-Partition] Support Satellite Partitions on SWCs
  17.00.00 2023-06-06   smarcelin  NMM-3141:      Units refactoring and transition to Test2020 framework
           2023-10-27   smarcelin  ESCAN00115739: Potential Undefined behavior due to out of bounds parameters
           2024-01-11   smarcelin  ESCAN00116362: Potential undefined behavior due to initialized variable
  17.00.01 2024-03-12   smarcelin  ESCAN00116838: Compiler error: 'Nm_RequestSynchronizedPncShutdown' undefined
                                   ESCAN00116833: Compiler error: conversion from <someDataType> to <someOtherType>, possible loss of data
                                   ESCAN00116959: No ECU shutdown on reception of Eira signal in case of Multi-Partition
                                   NMM-3553:      Include Comments and adapt implementation forComM_CurrentChannelRequest
************************************************************************************************************************************************/
...
# define CCL_ASR4COMMCFG5_VERSION                       (0x1700u)
...
# define COMM_SID_MAINFUNCTION_SATELLITE                (0x61u) /*!< Service ID: ComM_MainFunction_Satellite() */
# define COMM_SID_PREINIT                               (0x62u) /*!< Service ID: ComM_PreInit() */
# define COMM_SID_POSTINIT                              (0x63u) /*!< Service ID: ComM_PostInit() */
# define COMM_SID_GETCURRENTPNCCOMMODE                  (0x6Au) /*!< Service ID: ComM_GetCurrentPNCComMode() */
...
# define COMM_SID_CBK_COMCBK                            (0x40u) /*!< Service ID: ComM_COMCbk_<signal_name>() */
# define COMM_SID_CBK_NM_FORWARDSYNCHRONIZEDPNCSHUTDOWN (0x6Bu) /*!< Service ID: ComM_Nm_ForwardSynchronizedPncShutdown() */
 ...
 *  \trace       CREQ-102775
 *********************************************************************************************************************/
extern FUNC(void, COMM_CODE) ComM_PreInit(P2CONST(ComM_ConfigType, AUTOMATIC, COMM_INIT_DATA) ConfigPtr);

/**********************************************************************************************************************
 * ComM_PostInit()
 *********************************************************************************************************************/
/*! \brief       Post-Initialization function of the ComM
 *  \details     -
 *  \param[in]   -
 ...
 *  \trace       CREQ-102775
 *********************************************************************************************************************/
extern FUNC(void, COMM_CODE) ComM_PostInit( void );
 ...
 *  \trace       SPEC-5108
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, COMM_CODE) ComM_RequestComMode(ComM_UserHandleType User, ComM_ModeType ComMode); /* PRQA S 3451, 3449 */ /* MD_ComM_3451_3449 */
 ...
 *  \trace       CREQ-1267
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, COMM_CODE) ComM_GetMaxComMode(ComM_UserHandleType User, P2VAR(ComM_ModeType, AUTOMATIC, COMM_APPL_VAR) ComMode); /* PRQA S 3451, 3449 */ /* MD_ComM_3451_3449 */
 ...
 *  \trace       CREQ-1267
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, COMM_CODE) ComM_GetRequestedComMode(ComM_UserHandleType User, P2VAR(ComM_ModeType, AUTOMATIC, COMM_APPL_VAR) ComMode); /* PRQA S 3451, 3449 */ /* MD_ComM_3451_3449 */
 ...
 *  \trace       SPEC-5091
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, COMM_CODE) ComM_GetCurrentComMode(ComM_UserHandleType User, P2VAR(ComM_ModeType, AUTOMATIC, COMM_APPL_VAR) ComMode); /* PRQA S 3451, 3449 */ /* MD_ComM_3451_3449 */
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, COMM_CODE) ComM_GetInhibitionStatus( NetworkHandleType Channel, P2VAR(ComM_InhibitionStatusType, AUTOMATIC, COMM_APPL_VAR) Status); /* PRQA S 3451, 3449 */ /* MD_ComM_3451_3449 */
 ...
 *  \synchronous FALSE
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, COMM_CODE) ComM_PreventWakeUp( NetworkHandleType Channel, boolean Status); /* PRQA S 3451, 3449 */ /* MD_ComM_3451_3449 */
 ...
 *  \synchronous FALSE
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, COMM_CODE) ComM_LimitChannelToNoComMode( NetworkHandleType Channel, boolean Status); /* PRQA S 3451, 3449 */ /* MD_ComM_3451_3449 */
 ...
 *                                      - The service is called on another partition than the master partition
 ...
 *  \synchronous FALSE
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, COMM_CODE) ComM_LimitECUToNoComMode(boolean Status); /* PRQA S 3451, 3449 */ /* MD_ComM_3451_3449 */
 ...
 *  \trace       CREQ-1301
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, COMM_CODE) ComM_ReadInhibitCounter(P2VAR(uint16, AUTOMATIC, COMM_APPL_VAR) CounterValue); /* PRQA S 3451, 3449 */ /* MD_ComM_3451_3449 */
 ...
 *  \details     -
 *  \return      E_OK                   Request is accepted
 *               E_NOT_OK               The service is called on another partition than the master partition
 *               COMM_E_UNINIT          ComM is not initialized
 *  \pre         -
 *  \context     ANY
 *  \reentrant   TRUE
 ...
 *  \trace       CREQ-1301
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, COMM_CODE) ComM_ResetInhibitCounter(void); /* PRQA S 3451, 3449 */ /* MD_ComM_3451_3449 */
 ...
 *  \trace       CREQ-1302
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, COMM_CODE) ComM_SetECUGroupClassification(ComM_InhibitionStatusType Status); /* PRQA S 3451, 3449 */ /* MD_ComM_3451_3449 */
 ...
 *  \synchronous FALSE
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, COMM_CODE) ComM_LimitPncToChannelRouting( PNCHandleType Pnc, NetworkHandleType Channel, boolean Status ); /* PRQA S 3451, 3449 */ /* MD_ComM_3451_3449 */

/**********************************************************************************************************************
 * ComM_GetCurrentPNCComMode()
 *********************************************************************************************************************/
 /*! \brief       Function to query the current communication mode of the corresponding PNC the user is assigned to.
 *  \details     -
 ...
 *  \trace       CREQ-292564
 *********************************************************************************************************************/
extern FUNC( Std_ReturnType, COMM_CODE ) ComM_GetCurrentPNCComMode( ComM_UserHandleType User, P2VAR( ComM_ModeType, AUTOMATIC, COMM_APPL_VAR ) ComMode ); /* PRQA S 3451, 3449 */ /* MD_ComM_3451_3449 */
# endif
 ...
 * Protects the channel state and user request status.
 ...
 *           ComM_SyncUserFullComRequests, ComM_PncProcessRxSignalEra
 * \exclude -
...
/*!
 * \exclusivearea COMM_EXCLUSIVE_AREA_2
 * Protects the synchronization of the ComM channel state variables from becoming inconsistent while being accessed on multiple partitions.
 * \protects ComM_ActiveComMode, ComM_ActiveComModeSyncCounter, ComM_BusComModeReq, ComM_BusComModeReqSyncCounter,
 *           ComM_BusComModeReqFrShutdown, ComM_BusComModeReqFrShutdownSyncCounter, ComM_EcuMWakeUpIndicationSyncCounter,
 *           ComM_NmStartUpIndicationSyncCounter
 * \usedin   ComM_MainFunction, ComM_EcuM_WakeUpIndication, ComM_BusSM_ModeIndication, ComM_Nm_PrepareBusSleepMode,
 *           ComM_BusSM_BusSleepMode, ComM_Nm_NetworkMode, ComM_Nm_BusSleepMode, ComM_Nm_NetworkStartIndication, ComM_Nm_RestartIndication,
 *           ComM_TF_NoCom_NetReq, ComM_TF_NoCom_FullReadySleep, ComM_TF_SiCom_NoCom, ComM_ProcessPassiveWakeUp, ComM_SyncBusComModeRequests
 *           ComM_SyncBusComModeRequests, ComM_UpdateDataFromSatellites, 
 * \exclude -
 * \length LONG This exclusive area covers calls to several sub-functions.
 * \endexclusivearea
 */
...
/*!
 * \exclusivearea COMM_EXCLUSIVE_AREA_3
 * Protects the synchronization of DCM requests and state changes due to BusSM indications from becoming inconsistent while being
 * accessed on multiple partitions.
 * \protects ComM_StateChange, ComM_StateChangeSyncCounter, ComM_DcmRequestActive, ComM_DcmRequestActiveSyncCounter, 
 * \usedin ComM_UpdateDataFromSatellites, ComM_DCM_ActiveDiagnostic, ComM_DCM_InactiveDiagnostic, ComM_BusSM_ModeIndication
 * \exclude -
 * \length LONG This exclusive area covers calls to several sub-functions.
 * \endexclusivearea
 */
...
/*!
 * \exclusivearea COMM_EXCLUSIVE_AREA_4
 * Protects the synchronization of PNC signal values and PNC to Channel Routing states from becoming inconsistent while being
 * accessed on multiple partitions.
 * \protects ComM_PncSignalValues, ComM_PncSignalValuesSyncCounter, ComM_PncToChannelRoutingState, ComM_PncToChannelRoutingStateSyncCounter
  *          ComM_BusPncComModeReq, ComM_BusPncComModeReqSyncCounter
 * \usedin   ComM_PncProcessRxSignalEra, ComM_PncProcessRxSignalEira,
             ComM_PncRoutingLimitationHandleChannels, ComM_PncClearBitInSignal, ComM_PncSetBitInSignal
 * \exclude -
 * \length LONG This exclusive area covers calls to several sub-functions.
 * \endexclusivearea
 */
...
/*!
 * \exclusivearea COMM_EXCLUSIVE_AREA_5
 * Protects the synchronization of forwarding the BusSM requests and COM Signal updates to the respective partition from
   becoming inconsistent while being accessed on multiple partitions.
 * \protects ComM_ForwardComSendSignalSyncCounter, ComM_ForwardingComSendSignalIndex, ComM_ForwardRequestBusSmModeSyncCounter,
             ComM_ForwardingBusSmMode
 * \usedin  ComM_MainFunction_Satellite, ComM_ForwardBusSMModeRequest, ComM_PncModeArbitration, ComM_PncModeSendSignal
 * \exclude -
 * \length MEDIUM no calls inside, updating several EIRA RX signal values (depending on the configuration).
 * \endexclusivearea
 */
