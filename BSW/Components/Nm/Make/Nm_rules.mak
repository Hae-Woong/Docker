...
#------------------------------------------------------------------------------
# 1.00.00   2011-02-23  vismdr  creation
# 2.00.00   2012-07-20  visrpp  update for ASR 4.0.3
# 2.01.00   2019-02-06  vircbl  Added support of component-based SIP structure
# 3.00.00   2021-04-26  vispps  Adapted generated source files
#------------------------------------------------------------------------------
...
LIBRARIES_TO_BUILD      += Nm
Nm_FILES                = Nm$(BSW_SRC_DIR)\Nm.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Nm$(BSW_SRC_DIR)\Nm.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
include $(GENDATA_DIR)\Make\Nm_rules_generated.mak
