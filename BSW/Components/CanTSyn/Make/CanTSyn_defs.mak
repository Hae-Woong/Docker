...
CANTSYN_CORE_PATH       = CanTSyn\
# e.g.: CAN_OUTPUT_PATH = $(GENDATA_DIR)
CANTSYN_OUTPUT_PATH     = $(GENDATA_DIR)
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     += CanTSyn$(BSW_SRC_DIR) $(GENDATA_DIR)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
