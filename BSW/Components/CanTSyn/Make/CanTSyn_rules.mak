...
#               C O P Y R I G H T                                             #
#-----------------------------------------------------------------------------#
# Copyright (c) 2014-2019 by Vector Informatik GmbH.  All rights reserved.    #
#                                                                             #
#-----------------------------------------------------------------------------#
...
# --------     ---------------------     -------------------------------------#
# ssf          Stephanie Schaaf          Vector Informatik GmbH               #
#-----------------------------------------------------------------------------#
#               R E V I S I O N   H I S T O R Y                               #
#-----------------------------------------------------------------------------#
# Date         Version  Sign Description                                      #
# ----------   -------  ---- -------------------------------------------------#
# 2014-09-18   1.00.00  ssf  Initial Version                                  #
# 2019-01-15   1.01.00  si   Support of new SIP structure                     #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 1.00.00                                                   #
###############################################################################
...
LIBRARIES_TO_BUILD      += CanTSyn
CanTSyn_FILES            = CanTSyn$(BSW_SRC_DIR)\CanTSyn.c

# e.g.: CC_FILES_TO_BUILD       += <MSN>\<MSN>.c <MSN>\<MSN>_Irq.c
CC_FILES_TO_BUILD       += CanTSyn$(BSW_SRC_DIR)\CanTSyn.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
# e.g.: LIBRARIES_LINK_ONLY       += <MSN>\<MSN>.lib
LIBRARIES_LINK_ONLY     += 
OBJECTS_LINK_ONLY       += 
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\CanTSyn_Cfg.c
