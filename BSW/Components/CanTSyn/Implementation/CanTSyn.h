 ...
 *  06.01.00  2022-11-08  vissi    TSYNC-3911    Refactoring of conditional return statements
 *            2022-12-09  vissi    TSYNC-4033    CanTSyn: QAC 2022.2 support
 *  06.02.00  2023-02-09  visssf   MSR4-33965    Support Postbuild Selectable in CanTsyn
 *  06.03.00  2023-06-13  visjwe   TSYNC-4279    Migrate CanTSyn to Test2020
 *            2023-07-24  fmommer  ESCAN00115129 CanTSynMasterConfirmationTimeout smaller than main function period leads to maximum timeout value being used
 *            2023-08-03  visjwe   TSYNC-4410    Analyze changed PreCompileRelations occured through Testplan migration
 *            2023-08-04  fmommer  ESCAN00115233 Cyclic transmission is not started in the earliest possible CanTSyn_MainFunction after CanTSynGlobalTimeTxPeriod is reached
 *            2023-08-23  visjwe   TSYNC-4484    Add unit annotations for header files and remove NO_UNIT switches for prototypes
 *  06.04.00  2023-08-31  fmommer  MSR4-35756    [CanTSyn] Unit Test Migration Test2020
 *            2023-09-14  fmommer  TSYNC-4531    Harmonize design of FrTSyn and CanTSyn
 *            2023-10-27  fmommer  TSYNC-4566    CanTSyn: Improve variable scopes
 ...
 *            2024-02-14  fmommer  ESCAN00116665 TxConfirmationTimeout is not taken into account after sending an immediate SYNC message
 *********************************************************************************************************************/
...
# define CANTSYN_SW_MINOR_VERSION                (4u)
...
extern P2CONST(CanTSyn_ConfigType, CANTSYN_VAR_CLEARED, CANTSYN_INIT_DATA) CanTSyn_ConfigDataPtr;
# endif
 ...
 * \usedin  CanTSyn_Tx_UpdateWaitingForTxConfirmation, CanTSyn_Tx_UpdateWaitingForSyncSend, CanTSyn_Tx_TransmitFup,
 *          CanTSyn_TxConfirmation, CanTSyn_Rx_UpdateSlaves, CanTSyn_RxIndication
