...
#if (CANTSYN_USE_INIT_POINTER == STD_ON)
# define CANTSYN_START_SEC_VAR_INIT_CONFIGPTR
# include "CanTSyn_MemMap.h"    /* PRQA S 5087 */        /*  MD_MSR_MemMap */

P2CONST(CanTSyn_ConfigType, AUTOMATIC, CANTSYN_INIT_DATA) CanTSyn_ConfigDataPtr = NULL_PTR;

# define CANTSYN_STOP_SEC_VAR_INIT_CONFIGPTR
# include "CanTSyn_MemMap.h"    /* PRQA S 5087 */        /*  MD_MSR_MemMap */
#endif
 ...
 *  Unit: Common
 *********************************************************************************************************************/
/*! \brief      This unit contains the public APIs of the CanTSyn and mapping functions.
 *  \details    -
 *  \pre        -
 *  \trace      COMMON_UNIT
 *********************************************************************************************************************/
 ...
 *  \unit       Utility
 *********************************************************************************************************************/
CANTSYN_LOCAL FUNC(uint32, CANTSYN_CODE) CanTSyn_GetCrcLength(
 ...
 *  Unit: Transmit
 *********************************************************************************************************************/
/*! \brief      This unit provides the master transmit functionality of the CanTSyn.
 *  \details    -
 *  \pre        -
 *  \trace      TRANSMIT_UNIT
 *********************************************************************************************************************/
 ...
 *  \visibility Private
 *********************************************************************************************************************/
CANTSYN_LOCAL FUNC(void, CANTSYN_CODE) CanTSyn_Tx_OnFailedTransmit(
    CanTSyn_MasterConfigIterType masterIdx,
    CanTSyn_PartitionIdentifiersIterType partitionIndex);

/**********************************************************************************************************************
 *  CanTSyn_Tx_ResetStateToSyncSend
 *********************************************************************************************************************/
 ...
 *  \unit       ProtocolTx
 *********************************************************************************************************************/
CANTSYN_LOCAL FUNC(void, CANTSYN_CODE) CanTSyn_Tx_ResetStateToSyncSend(
    CanTSyn_MasterConfigIterType masterIdx,
    CanTSyn_PartitionIdentifiersIterType partitionIndex);
#endif /* CANTSYN_MASTERCONFIG == STD_ON */
 ...
 *  \unit       SyncTx
 *********************************************************************************************************************/
CANTSYN_LOCAL FUNC(void, CANTSYN_CODE) CanTSyn_Tx_TransmitSync(
    CanTSyn_MasterConfigIterType masterIdx,
    CanTSyn_PartitionIdentifiersIterType partitionIndex);
 ...
 *  Unit: FupTx
 *********************************************************************************************************************/
/*! \brief      This unit handles the FUP message mechanism on the transmitting side.
 *  \details    -
 *  \pre        -
 *  \trace      FUPTX_UNIT
 *********************************************************************************************************************/
 ...
 *  \visibility Private
 *********************************************************************************************************************/
CANTSYN_LOCAL FUNC(Std_ReturnType, CANTSYN_CODE) CanTSyn_Tx_OnGetTimeSync(
    CanTSyn_MasterConfigIterType masterIdx,
    CanTSyn_PartitionIdentifiersIterType partitionIndex);
 ...
 *  Unit: AssembleMsg
 *********************************************************************************************************************/
/*! \brief      This unit handles the assembly of the SYNC/FUP, OFS/OFNS messages.
 *  \details    -
 *  \pre        -
 ...
 *  Unit: Validation
 *********************************************************************************************************************/
/*! \brief      This unit handles the validation of the SYNC/OFS, FUP/OFNS messages.
 *  \details    -
 *  \pre        -
 ...
 *  \unit       Validation
 *********************************************************************************************************************/
CANTSYN_LOCAL FUNC(boolean, CANTSYN_CODE) CanTSyn_Tx_ValidateSendSyncConditions(
    CanTSyn_MasterConfigIterType masterIdx,
    CanTSyn_PartitionIdentifiersIterType partitionIndex);
...
#if (CANTSYN_MASTERCONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: TxConfirmationTimeout
 *********************************************************************************************************************/
/*! \brief      This unit handles the Tx confirmation timeout counter.
 *  \details    -
 *  \pre        -
 *  \trace      TXCONFIRMATIONTIMEOUT_UNIT
 *********************************************************************************************************************/
/**********************************************************************************************************************
 ...
 *  Unit: CanController
 *********************************************************************************************************************/
/*! \brief      This unit handles the CAN controller communication.
 *  \details    -
 *  \pre        -
 *  \trace      CANCONTROLLER_UNIT
 *********************************************************************************************************************/
/**********************************************************************************************************************
 ...
 *  Unit: Receive
 *********************************************************************************************************************/
/*! \brief      This unit provides the slave receive functionality of the CanTSyn.
 *  \details    -
 *  \pre        -
 *  \trace      RECEIVE_UNIT
 *********************************************************************************************************************/
 ...
 *  Unit: FupRx
 *********************************************************************************************************************/
/*! \brief      This unit handles the FUP message mechanism on the receiving side.
 *  \details    -
 *  \pre        -
 *  \trace      FUPRX_UNIT
 *********************************************************************************************************************/
 ...
 *  Unit: DisassembleMsg
 *********************************************************************************************************************/
/*! \brief      This unit handles the disassembly of the SYNC/FUP, OFS/OFNS messages.
 *  \details    -
 *  \pre        -
...
#if (CANTSYN_SLAVECONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: FollowUpTimeout
 *********************************************************************************************************************/
/*! \brief      This unit handles the FollowUp timeout counter.
 *  \details    -
 *  \pre        -
 *  \trace      FOLLOWUPTIMEOUT_UNIT
 *********************************************************************************************************************/
/**********************************************************************************************************************
 ...
 *  Unit: Utility
 *********************************************************************************************************************/
#ifndef CANTSYN_NOUNIT_UTILITY /* COV_CANTSYN_NOUNIT_SWITCH */
/**********************************************************************************************************************
 *  CanTSyn_TimestampPlusTimestamp
 *********************************************************************************************************************/
/*!
    ...
    P2VAR(StbM_VirtualLocalTimeType, AUTOMATIC, CANTSYN_APPL_VAR) timediffPtr)
{
  ...
  if ((lhs->nanosecondsHi > rhs->nanosecondsHi) || ((lhs->nanosecondsHi == rhs->nanosecondsHi) && (lhs->nanosecondsLo >= rhs->nanosecondsLo)))
  {
    ...
    timediffPtr->nanosecondsHi = lhs->nanosecondsHi - rhs->nanosecondsHi; /* SBSW_CANTSYN_WRITE_OUTPARAM_POINTER */
    timediffPtr->nanosecondsLo = lhs->nanosecondsLo - rhs->nanosecondsLo; /* SBSW_CANTSYN_WRITE_OUTPARAM_POINTER */

    /* #30 Check for underflow of nanoseconds low */
    if (lhs->nanosecondsLo < rhs->nanosecondsLo)
    {
      timediffPtr->nanosecondsHi--; /* SBSW_CANTSYN_WRITE_OUTPARAM_POINTER */
    }
...
#ifndef CANTSYN_NOUNIT_TRANSMIT /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_MASTERCONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: Transmit
 *********************************************************************************************************************/
...
#  endif /* CANTSYN_EXISTS_SUPPORTED_IMMEDIATETIMESYNCOFMASTERCONFIG == STD_ON */
# endif /* CANTSYN_SLAVECONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_TRANSMIT */

#ifndef CANTSYN_NOUNIT_PROTOCOLTX /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_MASTERCONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: ProtocolTx
 *********************************************************************************************************************/
...
# if (CANTSYN_EXISTS_SUPPORTED_IMMEDIATETIMESYNCOFMASTERCONFIG == STD_ON)
  ...
  {
    /* #40 If Tx confirmation timeout or cyclic msg resume time expired: */
    if ((CanTSyn_Tx_IsTxConfirmationTimeoutExpired(masterIdx, partitionIndex) == TRUE) || (CanTSyn_Tx_IsCyclicMsgResumeTimeExpired(masterIdx, partitionIndex) == TRUE))
    {
      /* #50 Perform actions for unsuccessful transmit */
...
# endif
  {
    /* #60 If Tx confirmation timeout or Tx period expired: */
    if ((CanTSyn_Tx_IsTxConfirmationTimeoutExpired(masterIdx, partitionIndex) == TRUE) || (CanTSyn_Tx_IsTxPeriodTimeExpired(masterIdx, partitionIndex) == TRUE))
    {
      /* #70 Perform actions for unsuccessful transmit */
      CanTSyn_Tx_OnFailedTransmit(masterIdx, partitionIndex);
    }
  }
    ...
    CanTSyn_PartitionIdentifiersIterType partitionIndex)
{
  ...
  CanTSyn_Tx_ResetStateToSyncSend(masterIdx, partitionIndex);

  /* #20 If send conditions for SYNC message are met: */
  if (CanTSyn_Tx_ValidateSendSyncConditions(masterIdx, partitionIndex) == TRUE)
  {
    /* #30 Resend SYNC message in the current CanTSyn_MainFunction() */
...
#  endif
  ...
  /* #10 Reset master state to 'wait to send SYNC' */
  CanTSyn_SetStateOfMasterState(masterIdx, CANTSYN_STATE_SEND_WAITING_FOR_SYNC_SEND, partitionIndex); /* SBSW_CANTSYN_ACCESS_MASTERSTATE_VAR */
...
# endif /* CANTSYN_MASTERCONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_PROTOCOLTX */

#ifndef CANTSYN_NOUNIT_SYNCTX /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_MASTERCONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: SyncTx
 *********************************************************************************************************************/
    ...
    CanTSyn_PartitionIdentifiersIterType partitionIndex)
{
  ...
  if (CanTSyn_Tx_ValidateSendSyncConditions(masterIdx, partitionIndex) == TRUE)
  {
    /* #20 Enter critical area: Accuracy of transmitted time, state transition and PduId lock consistent to actual transmission */
    SchM_Enter_CanTSyn_CANTSYN_EXCLUSIVE_AREA_0();

    /* #30 Transmit SYNC/OFS message */
    CanTSyn_Tx_TransmitSync(masterIdx, partitionIndex);
...
#  endif
  ...
  if (retVal == E_OK)
  {
    /* #30 Set the master to state: 'wait for FUP send' */
  ...
  {
    /* #40 Reset master to 'wait for SYNC send' */
    CanTSyn_Tx_ResetStateToSyncSend(masterIdx, partitionIndex);
  }
...
#  endif
  ...
  if (CanTSyn_Tx_GetTimeSync(masterIdx, partitionIndex) == E_OK)
  {
    ...
    /* #50 Transmit SYNC/OFS message, if transmission succeeded: */
    ...
    {
      /* #60 Run actions for succeeded transmission */
...
# endif /* CANTSYN_MASTERCONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_SYNCTX */

#ifndef CANTSYN_NOUNIT_FUPTX /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_MASTERCONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: FupTx
 *********************************************************************************************************************/
    ...
    CanTSyn_PartitionIdentifiersIterType partitionIndex)
{
  ...
  /* #20 If debouncing configured, reset the Tx debounce counter back to the configured value */
#  if (CANTSYN_TXDEBOUNCECOUNTERIDXOFMASTERCONFIG == STD_ON)
  CanTSyn_Tx_ResetDebounceCounter(masterIdx, partitionIndex);
#  endif
} /* CanTSyn_Tx_OnFupTxConfirmation */
...
# endif /* CANTSYN_MASTERCONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_FUPTX */

#ifndef CANTSYN_NOUNIT_CURRENTTIME /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_MASTERCONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: CurrentTime
 *********************************************************************************************************************/
...
#  endif /* CANTSYN_EXISTS_OFFSET_OFFSETDOMAINOFDOMAINCONFIG == STD_ON */
# endif /* CANTSYN_MASTERCONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_CURRENTTIME */

#ifndef CANTSYN_NOUNIT_ASSEMBLEMSG /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_MASTERCONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: AssembleMsg
 *********************************************************************************************************************/
...
#  endif /* (CANTSYN_EXISTS_SYNC_CRC_TXCRCSECUREDOFMASTERCONFIG == STD_ON) || (CANTSYN_EXISTS_OFS_CRC_TXCRCSECUREDOFMASTERCONFIG == STD_ON) */
# endif /* CANTSYN_MASTERCONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_ASSEMBLEMSG */

#ifndef CANTSYN_NOUNIT_VALIDATION /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_MASTERCONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: Validation
 *********************************************************************************************************************/
...
#   endif
  {
    ...
    uint8 currentUpdateCounter = StbM_GetTimeBaseUpdateCounter(CanTSyn_GetTimeBaseIdOfDomainConfig(CanTSyn_GetDomainConfigIdxOfMasterConfig(masterIdx, partitionIndex), partitionIndex));
...
# endif /* CANTSYN_MASTERCONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_VALIDATION */

#ifndef CANTSYN_NOUNIT_TXPERIODTIME /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_MASTERCONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: TxPeriodTime
 *********************************************************************************************************************/
...
# endif /* CANTSYN_MASTERCONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_TXPERIODTIME */

#ifndef CANTSYN_NOUNIT_TXSEQUENCECOUNTER /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_MASTERCONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: TxSequenceCounter
 *********************************************************************************************************************/
...
# endif /* CANTSYN_MASTERCONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_TXSEQUENCECOUNTER */

#ifndef CANTSYN_NOUNIT_CYCLICMSGRESUMETIME /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_MASTERCONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: CyclicMsgResumeTime
 *********************************************************************************************************************/
...
#  endif /* CANTSYN_EXISTS_SUPPORTED_IMMEDIATETIMESYNCOFMASTERCONFIG == STD_ON */
# endif /* CANTSYN_MASTERCONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_CYCLICMSGRESUMETIME */

#ifndef CANTSYN_NOUNIT_TXCONFIRMATIONTIMEOUT /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_MASTERCONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: TxConfirmationTimeout
 *********************************************************************************************************************/
...
#  endif
  ...
  /* #10 Check if Tx confirmation timeout can be decremented */
  if (CanTSyn_GetTxConfirmationTimeoutCounterOfMasterState(masterIdx, partitionIndex) > 0u)
  {
    /* #20 Decrement Tx confirmation timeout */
...
# endif /* CANTSYN_MASTERCONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_TXCONFIRMATIONTIMEOUT */

#ifndef CANTSYN_NOUNIT_DEBOUNCETIME /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_MASTERCONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: DebounceTime
 *********************************************************************************************************************/
...
#    endif
  ...
  return (boolean) (CanTSyn_GetTxDebounceCounterIdxOfMasterConfig(masterIdx, partitionIndex) < CanTSyn_GetSizeOfTxDebounceCounter(partitionIndex)); /* PRQA S 1881, 4304 */ /* MD_MSR_AutosarBoolean */
} /* CanTSyn_Tx_HasDebouncing */
#   endif /* CANTSYN_TX_CONF_MIXED_DEBOUNCE_COUNTER == STD_ON */
#  endif /* CANTSYN_TXDEBOUNCECOUNTERIDXOFMASTERCONFIG == STD_ON */
# endif /* CANTSYN_MASTERCONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_DEBOUNCETIME */

#ifndef CANTSYN_NOUNIT_PDUIDLOCK /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_MASTERCONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: PduIdLock
 *********************************************************************************************************************/
...
#  endif /* CANTSYN_EXISTS_SHARED_PDUS == STD_ON */
# endif /* CANTSYN_MASTERCONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_PDUIDLOCK */

#ifndef CANTSYN_NOUNIT_CANCONTROLLER /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_MASTERCONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: CanController
 *********************************************************************************************************************/
...
# endif /* CANTSYN_NOUNIT_CANCONTROLLER */
#endif /* CANTSYN_MASTERCONFIG == STD_ON */
 ...
 *
 *********************************************************************************************************************/
#ifndef CANTSYN_NOUNIT_RECEIVE /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_SLAVECONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: Receive
 *********************************************************************************************************************/
...
# endif /* CANTSYN_SLAVECONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_RECEIVE */

#ifndef CANTSYN_NOUNIT_PROTOCOLRX /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_SLAVECONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: ProtocolRx
 *********************************************************************************************************************/
...
# endif /* CANTSYN_SLAVECONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_PROTOCOLRX */

#ifndef CANTSYN_NOUNIT_SYNCRX /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_SLAVECONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: SyncRx
 *********************************************************************************************************************/
...
# endif /* CANTSYN_SLAVECONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_SYNCRX */

#ifndef CANTSYN_NOUNIT_FUPRX /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_SLAVECONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: FupRx
 *********************************************************************************************************************/
...
# endif /* CANTSYN_SLAVECONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_FUPRX */

#ifndef CANTSYN_NOUNIT_DISASSEMBLEMSG /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_SLAVECONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: DisassembleMsg
 *********************************************************************************************************************/
...
#  endif /* ((CANTSYN_EXISTS_NOT_VALIDATED_RXCRCVALIDATEDOFSLAVECONFIG == STD_ON) || (CANTSYN_EXISTS_IGNORED_RXCRCVALIDATEDOFSLAVECONFIG == STD_ON)) */
# endif /* CANTSYN_SLAVECONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_DISASSEMBLEMSG */

#ifndef CANTSYN_NOUNIT_FOLLOWUPTIMEOUT /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_SLAVECONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: FollowUpTimeout
 *********************************************************************************************************************/
...
# endif /* CANTSYN_SLAVECONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_FOLLOWUPTIMEOUT */

#ifndef CANTSYN_NOUNIT_VALIDATIONMSG /* COV_CANTSYN_NOUNIT_SWITCH */
# if (CANTSYN_SLAVECONFIG == STD_ON)
/**********************************************************************************************************************
 *  Unit: ValidationMsg
 *********************************************************************************************************************/
...
#  endif
  ...
  if (CanTSyn_GetRxSequenceCounterOfSlaveState(slaveIdx, partitionIndex) <= CANTSYN_MAX_SEQUENCE_COUNTER)
  {
    ...
    uint8 jumpWidth = CanTSyn_Rx_CalculateSequenceCounterJumpWidth(slaveIdx, sequenceCounter, partitionIndex);
...
#   endif
  ...
  {
#   if (CANTSYN_EXISTS_IGNORED_RXCRCVALIDATEDOFSLAVECONFIG == STD_ON)
    /* #20 CRC validation in FUP message for CRC-IGNORED configured slave (always valid) */
    case CANTSYN_IGNORED_RXCRCVALIDATEDOFSLAVECONFIG:
      isValid = TRUE;
      break;
#   endif
...
#   if (CANTSYN_EXISTS_NOT_VALIDATED_RXCRCVALIDATEDOFSLAVECONFIG == STD_ON)
      /* #30 CRC validation in FUP message for CRC-NOT_VALIDATED configured slave */
    case CANTSYN_NOT_VALIDATED_RXCRCVALIDATEDOFSLAVECONFIG:
...
#   if (CANTSYN_EXISTS_VALIDATED_RXCRCVALIDATEDOFSLAVECONFIG == STD_ON)
      /* #40 CRC validation in FUP message for CRC-VALIDATED configured slave */
    case CANTSYN_VALIDATED_RXCRCVALIDATEDOFSLAVECONFIG:
...
#  endif /* CANTSYN_EXISTS_VALIDATED_RXCRCVALIDATEDOFSLAVECONFIG == STD_ON */
# endif /* CANTSYN_SLAVECONFIG == STD_ON */
#endif /* CANTSYN_NOUNIT_VALIDATIONMSG */
...
#ifndef CANTSYN_NOUNIT_COMMON /* COV_CANTSYN_NOUNIT_SWITCH */
/**********************************************************************************************************************
 *  Unit: Common
 *********************************************************************************************************************/
# if (CANTSYN_MULTIPARTITION_USED == STD_ON)
...
CANTSYN_LOCAL FUNC(CanTSyn_PartitionIdentifiersIterType, CANTSYN_CODE) CanTSyn_GetCurrentPartitionIndexByMasterPdu(PduIdType txPduId)
{
  ...
  /* ----- Implementation ----------------------------------------------- */
  /* #20 Find partition index by master pdu in master pdu to partition mapping table */
...
# if (CANTSYN_USE_INIT_POINTER == STD_ON)
  /* #20 Set the local configuration pointer to NULL_PTR */
  CanTSyn_ConfigDataPtr = NULL_PTR;
# endif
} /* CanTSyn_InitMemory */
...
#  endif
  ...
  CanTSyn_ConfigDataPtr = ConfigPtr;

#  if (CANTSYN_DEV_ERROR_DETECT == STD_ON)
  /* #20 If configuration pointer is NULL: */
  if (CanTSyn_ConfigDataPtr == NULL_PTR)
  {
    /* #30 Set Dev error id to CANTSYN_E_INIT_FAILED */
...
# endif /* CANTSYN_USE_INIT_POINTER == STD_ON */
  {
    /* #40 Initialize all partition specific initialized flags to FALSE */
    ...
    /* #50 Set pre initialized state of component to TRUE */
...
#  if (CANTSYN_DEV_ERROR_REPORT == STD_ON)
  ...
  {
    (void)Det_ReportError(CANTSYN_MODULE_ID, CANTSYN_INSTANCE_ID_DET, CANTSYN_SID_PREINIT, errorId);
  }
#  else
...
#  if ((CANTSYN_DEV_ERROR_DETECT == STD_ON) && (CANTSYN_MULTIPARTITION_USED == STD_OFF)) /* COV_CANTSYN_DEV_ERROR_DETECT_TF_tx_tf */
    if (CanTSyn_Tx_ProcessTxConfirmation(TxPduId, partitionIdx) != E_OK)
    {
