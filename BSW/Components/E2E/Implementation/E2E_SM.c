 ...
 *
 */
E2ESM_LOCAL FUNC (Std_ReturnType, E2E_CODE) E2E_SMCheckParams /* PRQA S 6010, 6030, 6080 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STMIF */
                 (E2E_SMProfileStatusType ProfileStatus,
                  E2E_SMConfigPtrType ConfigPtr,
                  E2E_SMConstStatePtrType StatePtr)
{
    Std_ReturnType ret;
                                                ...
                                                E2E_SMStatePtrType StatePtr)
{
    ...
    for (windowCnt = 0u; windowCnt < currentWindowSize; windowCnt++) /* FETA_E2E_SM_ADD_STATUS */
    {
        ...
        windowIdx = (uint8) (E2E_SM_DEC_WRAPAROUND(windowIdx, ConfigPtr->WindowSizeValid - 1u)); 
    }
