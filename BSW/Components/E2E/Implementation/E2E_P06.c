...
#if !defined (E2EP06_LOCAL) /* COV_E2E_COMPATIBILITY */
# define E2EP06_LOCAL static
#endif

#if !defined (E2EP06_LOCAL_INLINE) /* COV_E2E_COMPATIBILITY */
# define E2EP06_LOCAL_INLINE LOCAL_INLINE
#endif
 ...
 * \synchronous TRUE
 */
E2EP06_LOCAL FUNC (Std_ReturnType, E2E_CODE) E2E_P06ProtectVerifyInputs(P2CONST (E2E_P06ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
 ...
 * \synchronous TRUE
 */
E2EP06_LOCAL FUNC (Std_ReturnType, E2E_CODE) E2E_P06CheckVerifyInputs(P2CONST (E2E_P06ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
 ...
 * \synchronous TRUE
 */
E2EP06_LOCAL FUNC (void, E2E_CODE) E2E_CheckDeltaCounter(P2CONST (E2E_P06ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
 ...
 * \synchronous TRUE
 */
E2EP06_LOCAL FUNC (uint16, E2E_CODE) E2E_P06ComputeCRC(P2CONST (uint8, AUTOMATIC, E2E_APPL_DATA) DataPtr,
                                                    VAR (uint16, AUTOMATIC ) Length,
                                                    ...
                                                    VAR (uint16, AUTOMATIC ) DataID)
{
    ...
    if (Offset > 0u)
    {
        ...
        crc = Crc_CalculateCRC16 ( &DataPtr[Offset + 2u], /* SBSW_E2E_03 */
                                   (uint32)Length - (uint32)Offset - 2u,
                                   crc,
                                   FALSE
                                 );
    }
                                                ...
                                                VAR (uint16, AUTOMATIC) Length)
{
    ...
    if (ret == E2E_E_OK)
    {
        ...
        DataPtr[ByteOffset] = (uint8) (ComputedCRC >> 8u); /* SBSW_E2E_03 */
                                              ...
                                              VAR (uint16, AUTOMATIC) Length)
{
    ...
    if (ret == E2E_E_OK)
    {
        ...
        if (NewDataAvailable == TRUE) 
        {
            ...
            uint16 ReceivedLength = (uint16) ((((uint16) DataPtr[ByteOffset + 2u]) <<  8u)
            ...
            uint16 ReceivedCRC = (uint16) (((uint16) (DataPtr[ByteOffset]) << 8u)
                                                            ...
                                                            VAR (E2E_P06CheckStatusType, AUTOMATIC) Status)
{
    ...
    if (CheckReturn == E2E_E_OK)
    {
        ...
        switch (Status)
        {
            ...
            case E2E_P06STATUS_NONEWDATA    : ret = E2E_P_NONEWDATA; break;
