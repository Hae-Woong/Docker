...
#define E2E_P11_ASR21_11_FINAL_XOR  (0xFFu)
 ...
 *
 */
E2E_P11_LOCAL FUNC(void, E2E_CODE) E2E_P11CheckValidateReceivedData( /* PRQA S 6080 */ /* MD_MSR_STMIF */
    P2CONST(E2E_P11ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
    P2VAR(E2E_P11CheckStateType, AUTOMATIC, E2E_APPL_DATA) StatePtr,
    P2CONST(E2E_P11CheckedData, AUTOMATIC, E2E_DATA) CheckedDataPtr)
{
    ...
    CONST(uint16, AUTOMATIC) Length)
{
  ...
  /* #40 Invert CRC8 in case of ASR21-11 */
#ifdef E2E_ASR21_11_COMPATIBILITY /* COV_E2E_ASR21_11_COMPATIBILITY */
  computedCrc = computedCrc ^ E2E_P11_ASR21_11_FINAL_XOR;
#endif
...
/* START_COVERAGE_JUSTIFICATION
  \ID COV_E2E_ASR21_11_COMPATIBILITY
    \ACCEPT XF
    \REASON Verified manually to be correct implementation. Switch can only be tested through build system and not
            through configuration variant. Therefore no second configuration variant is necessary or feasible.
