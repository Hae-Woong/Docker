...
#if !defined (E2EP02_LOCAL) /* COV_E2E_COMPATIBILITY */
# define E2EP02_LOCAL static
#endif

#if !defined (E2EP02_LOCAL_INLINE) /* COV_E2E_COMPATIBILITY */
# define E2EP02_LOCAL_INLINE LOCAL_INLINE
#endif
 ...
 * \synchronous TRUE
 */
E2EP02_LOCAL FUNC (Std_ReturnType, E2E_CODE) E2E_P02ProtectVerifyInputs(P2CONST (E2E_P02ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
 ...
 * \synchronous TRUE
 */
E2EP02_LOCAL FUNC (Std_ReturnType, E2E_CODE) E2E_P02CheckVerifyInputs(P2CONST (E2E_P02ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
 ...
 * \synchronous TRUE
 */
E2EP02_LOCAL FUNC (uint8, E2E_CODE) E2E_P02ComputeCRC(P2CONST (uint8, AUTOMATIC, E2E_APPL_DATA) DataPtr,
 ...
 * \synchronous TRUE
 */
E2EP02_LOCAL FUNC (void, E2E_CODE) E2E_CheckDeltaCounter(P2CONST (E2E_P02ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
 ...
 * \synchronous    TRUE
 */
E2EP02_LOCAL FUNC (void, E2E_CODE) E2E_CheckSync(P2CONST (E2E_P02ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
                                              P2VAR (E2E_P02CheckStateType, AUTOMATIC, E2E_APPL_DATA) StatePtr);
                                                   ...
                                                   VAR (uint8, AUTOMATIC ) LocalDataID)
{
    ...
    if (Offset > 0u)
    {
        ...
        crc = Crc_CalculateCRC8H2F ( &DataPtr[Offset + 1u],      /* SBSW_E2E_03 */
                                     (uint32)Length - (uint32)Offset - 1u,
                                     crc,
                                     FALSE
                                   );
    }
    ...
    crc = Crc_CalculateCRC8H2F (&LocalDataID, 1u, crc, FALSE); /* PRQA S 1340 */ /* MD_EtoE_17.8 */ /* SBSW_E2E_02 */
                                                ...
                                                P2VAR (uint8, AUTOMATIC, E2E_APPL_DATA) DataPtr)
{
    ...
    if (ret == E2E_E_OK)
    {
        ...
        DataPtr[CounterOffset] = (uint8) ((DataPtr[CounterOffset] & 0xF0u)   /* SBSW_E2E_03 */
                               | StatePtr->Counter);
    ...
    if (CheckReturn == E2E_E_OK)
    {
      /* #20 SYNC and INITIAL status are set according to profileBehavior. Either the legacy behavior (before R4.2) or new behavior is chosen */
        ...
        switch (Status)
        {
            ...
            case E2E_P02STATUS_NONEWDATA    : ret = E2E_P_NONEWDATA;     break;
