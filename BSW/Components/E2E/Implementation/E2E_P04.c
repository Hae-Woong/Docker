...
#if !defined (E2EP04_LOCAL) /* COV_E2E_COMPATIBILITY */
# define E2EP04_LOCAL static
#endif

#if !defined (E2EP04_LOCAL_INLINE) /* COV_E2E_COMPATIBILITY */
# define E2EP04_LOCAL_INLINE LOCAL_INLINE
#endif
 ...
 * \synchronous TRUE
 */
E2EP04_LOCAL FUNC (Std_ReturnType, E2E_CODE) E2E_P04ProtectVerifyInputs(P2CONST (E2E_P04ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
 ...
 * \synchronous   TRUE
 */
E2EP04_LOCAL FUNC (Std_ReturnType, E2E_CODE) E2E_P04CheckVerifyInputs(P2CONST (E2E_P04ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
 ...
 * \synchronous TRUE
 */
E2EP04_LOCAL FUNC (void, E2E_CODE) E2E_P04ProtectWriteLength(P2VAR (uint8, AUTOMATIC, E2E_APPL_DATA ) DataPtr,
                                                          VAR (uint16, AUTOMATIC ) Length,
 ...
 * \synchronous TRUE
 */
E2EP04_LOCAL FUNC (uint16, E2E_CODE) E2E_P04CheckReadLength(P2CONST (uint8, AUTOMATIC, E2E_APPL_DATA) DataPtr,
                                                         VAR (uint16, AUTOMATIC ) Offset);
 ...
 * \synchronous TRUE
 */
E2EP04_LOCAL FUNC (void, E2E_CODE) E2E_P04ProtectWriteCounter(P2CONST (E2E_P04ProtectStateType, AUTOMATIC, E2E_APPL_DATA) StatePtr,
 ...
 * \synchronous TRUE
 */
E2EP04_LOCAL FUNC (uint16, E2E_CODE) E2E_P04CheckReadCounter(P2CONST (uint8, AUTOMATIC, E2E_APPL_DATA) DataPtr,
                                                          VAR (uint16, AUTOMATIC ) Offset);
 ...
 * \synchronous TRUE
 */
E2EP04_LOCAL FUNC (void, E2E_CODE) E2E_P04ProtectWriteDataID(P2CONST (E2E_P04ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
                                                          P2VAR (uint8, AUTOMATIC, E2E_APPL_DATA ) DataPtr,
                                                          VAR (uint16, AUTOMATIC ) Offset);
 ...
 * \synchronous TRUE
 */
E2EP04_LOCAL FUNC (uint32, E2E_CODE) E2E_P04CheckReadDataID(P2CONST (uint8, AUTOMATIC, E2E_APPL_DATA) DataPtr,
                                                         VAR (uint16, AUTOMATIC ) Offset);
 ...
 * \synchronous TRUE
 */
E2EP04_LOCAL FUNC (uint32, E2E_CODE) E2E_P04ComputeCRC(P2CONST (uint8, AUTOMATIC, E2E_APPL_DATA) DataPtr,
                                                    VAR (uint16, AUTOMATIC ) Length,
                                                    VAR (uint16, AUTOMATIC ) Offset);
 ...
 * \synchronous TRUE
 */
E2EP04_LOCAL FUNC (void, E2E_CODE) E2E_P04ProtectWriteCRC(P2VAR (uint8, AUTOMATIC, E2E_APPL_DATA) DataPtr,
                                                       VAR (uint16, AUTOMATIC ) Offset,
 ...
 * \synchronous TRUE
 */
E2EP04_LOCAL FUNC (uint32, E2E_CODE) E2E_P04CheckReadCRC(P2CONST (uint8, AUTOMATIC, E2E_APPL_DATA) DataPtr,
                                                      VAR (uint16, AUTOMATIC ) Offset);
 ...
 * \synchronous TRUE
 */
E2EP04_LOCAL FUNC (void, E2E_CODE) E2E_P04ProtectIncrementCounter(P2VAR (E2E_P04ProtectStateType, AUTOMATIC, E2E_APPL_DATA) StatePtr);
 ...
 * \synchronous TRUE
 */
E2EP04_LOCAL FUNC (void, E2E_CODE) E2E_P04CheckDoChecks(P2CONST (E2E_P04ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
 ...
 * \synchronous TRUE
 */
E2EP04_LOCAL FUNC (void, E2E_CODE) E2E_P04CheckDoChecksCounter(P2CONST (E2E_P04ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
                                                            P2VAR (E2E_P04CheckStateType, AUTOMATIC, E2E_APPL_DATA ) StatePtr,
                                                            VAR (uint16, AUTOMATIC ) ReceivedCounter);
                                                         ...
                                                         VAR (uint16, AUTOMATIC ) Offset)
{
    ...
    return (uint16)((((uint16) DataPtr[Offset]) << 8u)
                   | (DataPtr[Offset + 1u]));
}
                                                          ...
                                                          VAR (uint16, AUTOMATIC ) Offset)
{
    ...
    return (uint16)((((uint16) DataPtr[Offset + 2u]) << 8u)
                    | (DataPtr[Offset + 3u]));
}
                                                    ...
                                                    VAR (uint16, AUTOMATIC ) Offset)
{
    ...
    uint32 ComputedCRC = Crc_CalculateCRC32P4 (DataPtr, (uint32)Offset + 8u, 0xFFFFFFFFu, TRUE); /* SBSW_E2E_03 */

    /* #20 Compute CRC over bytes that are after CRC (if any) */
    if ((Offset + 12u) < Length)
    {
        ComputedCRC = Crc_CalculateCRC32P4 (
            &(DataPtr[Offset + 12u]), /* SBSW_E2E_03 */
            (uint32)Length - (uint32)Offset - 12u,
            ComputedCRC,
            FALSE);
    }
    return ComputedCRC;
                                                            ...
                                                            VAR(E2E_P04CheckStatusType, AUTOMATIC) Status)
{
    ...
    if (CheckReturn == E2E_E_OK)
    {
        ...
        switch (Status)
        {
            ...
            case E2E_P04STATUS_NONEWDATA    : ret = E2E_P_NONEWDATA; break;
            case E2E_P04STATUS_WRONGSEQUENCE: ret = E2E_P_WRONGSEQUENCE; break;

            /* Intentional fallthrough - same behavior */
