...
#if !defined (E2EP05_LOCAL) /* COV_E2E_COMPATIBILITY */
# define E2EP05_LOCAL static
#endif

#if !defined (E2EP05_LOCAL_INLINE) /* COV_E2E_COMPATIBILITY */
# define E2EP05_LOCAL_INLINE LOCAL_INLINE
#endif
 ...
 * \synchronous TRUE
 */
E2EP05_LOCAL FUNC (Std_ReturnType, E2E_CODE) E2E_P05ProtectVerifyInputs(P2CONST (E2E_P05ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
 ...
 * \synchronous TRUE
 */
E2EP05_LOCAL FUNC (Std_ReturnType, E2E_CODE) E2E_P05CheckVerifyInputs(P2CONST (E2E_P05ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
 ...
 * \synchronous    TRUE
 */
E2EP05_LOCAL FUNC (void, E2E_CODE) E2E_CheckDeltaCounter(P2CONST (E2E_P05ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
 ...
 * \synchronous TRUE
 */
E2EP05_LOCAL FUNC (uint16, E2E_CODE) E2E_P05ComputeCRC(P2CONST (uint8, AUTOMATIC, E2E_APPL_DATA) DataPtr,
                                                    VAR (uint16, AUTOMATIC ) Length,
                                              ...
                                              VAR (uint16, AUTOMATIC) Length)
{
    ...
    if (ret == E2E_E_OK)
    {
        ...
        if (NewDataAvailable == TRUE) 
        {
            ...
            /* #50 Read CRC */
            uint16 ReceivedCRC = (uint16) ((uint16) DataPtr[ByteOffset]
                                                            ...
                                                            VAR (E2E_P05CheckStatusType, AUTOMATIC) Status)
{
    ...
    if (CheckReturn == E2E_E_OK)
    {
        ...
        switch (Status)
        {
            ...
            case E2E_P05STATUS_NONEWDATA    : ret = E2E_P_NONEWDATA; break;
