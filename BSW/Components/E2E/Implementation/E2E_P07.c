...
#if !defined (E2EP07_LOCAL) /* COV_E2E_COMPATIBILITY */
# define E2EP07_LOCAL static
#endif

#if !defined (E2EP07_LOCAL_INLINE) /* COV_E2E_COMPATIBILITY */
# define E2EP07_LOCAL_INLINE LOCAL_INLINE
#endif
 ...
 * \synchronous TRUE
 */
E2EP07_LOCAL FUNC (Std_ReturnType, E2E_CODE) E2E_P07ProtectVerifyInputs(P2CONST (E2E_P07ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
 ...
 * \synchronous   TRUE
 */
E2EP07_LOCAL FUNC (Std_ReturnType, E2E_CODE) E2E_P07CheckVerifyInputs(P2CONST (E2E_P07ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
 ...
 * \synchronous TRUE
 */
E2EP07_LOCAL FUNC (void, E2E_CODE) E2E_P07ProtectWriteLength(P2VAR (uint8, AUTOMATIC, E2E_APPL_DATA ) DataPtr,
                                                          VAR (uint32, AUTOMATIC ) Length,
 ...
 * \synchronous TRUE
 */
E2EP07_LOCAL FUNC (uint32, E2E_CODE) E2E_P07CheckReadLength(P2CONST (uint8, AUTOMATIC, E2E_APPL_DATA) DataPtr,
                                                         VAR (uint32, AUTOMATIC ) Offset);
 ...
 * \synchronous TRUE
 */
E2EP07_LOCAL FUNC (void, E2E_CODE) E2E_P07ProtectWriteCounter(P2CONST (E2E_P07ProtectStateType, AUTOMATIC, E2E_APPL_DATA) StatePtr,
 ...
 * \synchronous TRUE
 */
E2EP07_LOCAL FUNC (uint32, E2E_CODE) E2E_P07CheckReadCounter(P2CONST (uint8, AUTOMATIC, E2E_APPL_DATA) DataPtr,
                                                          VAR (uint32, AUTOMATIC ) Offset);
 ...
 * \synchronous TRUE
 */
E2EP07_LOCAL FUNC (void, E2E_CODE) E2E_P07ProtectWriteDataID(P2CONST (E2E_P07ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
                                                          P2VAR (uint8, AUTOMATIC, E2E_APPL_DATA ) DataPtr,
                                                          VAR (uint32, AUTOMATIC ) Offset);
 ...
 * \synchronous TRUE
 */
E2EP07_LOCAL FUNC (uint32, E2E_CODE) E2E_P07CheckReadDataID(P2CONST (uint8, AUTOMATIC, E2E_APPL_DATA) DataPtr,
                                                         VAR (uint32, AUTOMATIC ) Offset);
 ...
 * \synchronous TRUE
 */
E2EP07_LOCAL FUNC (uint64, E2E_CODE) E2E_P07ComputeCRC(P2CONST (uint8, AUTOMATIC, E2E_APPL_DATA) DataPtr,
                                                    VAR (uint32, AUTOMATIC ) Length,
                                                    VAR (uint32, AUTOMATIC ) Offset);
 ...
 * \synchronous TRUE
 */
E2EP07_LOCAL FUNC (void, E2E_CODE) E2E_P07ProtectWriteCRC(P2VAR (uint8, AUTOMATIC, E2E_APPL_DATA) DataPtr,
                                                       VAR (uint32, AUTOMATIC ) Offset,
 ...
 * \synchronous TRUE
 */
E2EP07_LOCAL FUNC (uint64, E2E_CODE) E2E_P07CheckReadCRC(P2CONST (uint8, AUTOMATIC, E2E_APPL_DATA) DataPtr,
                                                      VAR (uint32, AUTOMATIC ) Offset);
 ...
 * \synchronous TRUE
 */
E2EP07_LOCAL FUNC (void, E2E_CODE) E2E_P07ProtectIncrementCounter(P2VAR (E2E_P07ProtectStateType, AUTOMATIC, E2E_APPL_DATA) StatePtr);
 ...
 * \synchronous TRUE
 */
E2EP07_LOCAL FUNC (void, E2E_CODE) E2E_P07CheckDoChecks(P2CONST (E2E_P07ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
 ...
 * \synchronous TRUE
 */
E2EP07_LOCAL FUNC (void, E2E_CODE) E2E_P07CheckDoChecksCounter(P2CONST (E2E_P07ConfigType, AUTOMATIC, E2E_APPL_CONST) ConfigPtr,
                                                            P2VAR (E2E_P07CheckStateType, AUTOMATIC, E2E_APPL_DATA ) StatePtr,
                                                            VAR (uint32, AUTOMATIC ) ReceivedCounter);
                                                            ...
                                                            VAR(E2E_P07CheckStatusType, AUTOMATIC) Status)
{
    ...
    if (CheckReturn == E2E_E_OK)
    {
        ...
        switch (Status)
        {
            ...
            case E2E_P07STATUS_NONEWDATA    : ret = E2E_P_NONEWDATA; break;
