...
# 2.00.00   2020-10-27  virljs  Added support for profile 44.
# 3.00.00   2021-07-20  virljs  Added support for profile 8.
# 4.00.00   2021-10-12  virljs  Added support for profile 22.
#------------------------------------------------------------------------------
...
ifeq ($(E2E_USE_PROFILE_08),1)
E2E_FILES                               += E2E$(BSW_SRC_DIR)\E2E_P08.c
CC_FILES_TO_BUILD                       += E2E$(BSW_SRC_DIR)\E2E_P08.c
endif
ifeq ($(E2E_USE_PROFILE_11),1)
E2E_FILES                               += E2E$(BSW_SRC_DIR)\E2E_P11.c
CC_FILES_TO_BUILD                       += E2E$(BSW_SRC_DIR)\E2E_P11.c
endif
ifeq ($(E2E_USE_PROFILE_22),1)
E2E_FILES                               += E2E$(BSW_SRC_DIR)\E2E_P22.c
CC_FILES_TO_BUILD                       += E2E$(BSW_SRC_DIR)\E2E_P22.c
endif
ifeq ($(E2E_USE_PROFILE_44),1)
E2E_FILES                               += E2E$(BSW_SRC_DIR)\E2E_P44.c
CC_FILES_TO_BUILD                       += E2E$(BSW_SRC_DIR)\E2E_P44.c
endif
