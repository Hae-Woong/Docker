############################################################################### 
# File Name  : Crypto_30_LibCv_defs.mak 
...
# REVISION HISTORY
#------------------------------------------------------------------------------
# Refer to the Crypto_30_LibCv_rules.mak file.
############################################################################### 
...
CRYPTO_30_LIBCV_CORE_PATH       =
# e.g.: CAN_OUTPUT_PATH = $(GENDATA_DIR)
CRYPTO_30_LIBCV_OUTPUT_PATH     = $(GENDATA_DIR)
...
CRYPTO_30_LIBCV_DEPENDENT_PLUGINS = 
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     += Crypto_30_LibCv$(BSW_SRC_DIR)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
