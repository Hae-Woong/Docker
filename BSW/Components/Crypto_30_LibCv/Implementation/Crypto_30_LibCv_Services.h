...
#if !defined (CRYPTO_30_LIBCV_SERVICES_H)
# define CRYPTO_30_LIBCV_SERVICES_H
...
# if !defined (CRYPTO_30_LIBCV_ALWAYS_LOCAL_INLINE) /* COV_CRYPTO_30_LIBCV_LOCAL_DEFINE */
#  define CRYPTO_30_LIBCV_ALWAYS_LOCAL_INLINE                         static INLINE /* "static" cannot be removed in this definition */
# endif
...
# define CRYPTO_30_LIBCV_SIZEOF_ECC_521_SIGNATURE                     (CRYPTO_30_LIBCV_SIZEOF_ECC_521_N)

# define CRYPTO_30_LIBCV_SIZEOF_ECC_160_KEY_PRIVATE_MIN               (CRYPTO_30_LIBCV_SIZEOF_ECC_160_N - 1u) /* Size of private key can have 20 (160 bits) or 21 bytes (161 bit) */
...
# define CRYPTO_30_LIBCV_SIZEOF_ECC_521_KEY_PRIVATE                   (CRYPTO_30_LIBCV_SIZEOF_ECC_521_N)
...
# define CRYPTO_30_LIBCV_SIZEOF_ECC_521_KEY_PUBLIC                    (CRYPTO_30_LIBCV_SIZEOF_ECC_521_P)
...
# define CRYPTO_30_LIBCV_SIZEOF_ECC_521_KEY_PUBLIC_XY                 (2u * (CRYPTO_30_LIBCV_SIZEOF_ECC_521_P))

# if(CRYPTO_30_LIBCV_ECP521GENERATE == STD_ON)
#  define CRYPTO_30_LIBCV_MAX_SIZEOF_SIGNATURE_GENERATE_ECC_KEY       (CRYPTO_30_LIBCV_SIZEOF_ECC_521_SIGNATURE)
# elif(CRYPTO_30_LIBCV_ECP384GENERATE == STD_ON)
...
/* SM2 length defines */
# define CRYPTO_30_LIBCV_SM2_SIZEOF_PRIVATE_KEY                       (32u)
# define CRYPTO_30_LIBCV_SM2_SIZEOF_PUBLIC_KEY                        (64u)   /* Size of the whole public key (X|Y) */
# define CRYPTO_30_LIBCV_SM2_SIZEOF_PUBLIC_KEY_HALF                   (CRYPTO_30_LIBCV_SM2_SIZEOF_PUBLIC_KEY / 2u)
# define CRYPTO_30_LIBCV_SM2_SIZEOF_SIGNATURE                         (64u)   /* Size of the whole signature (R|S) */
# define CRYPTO_30_LIBCV_SM2_SIZEOF_SIGNATURE_HALF                    (CRYPTO_30_LIBCV_SM2_SIZEOF_SIGNATURE / 2u)
# define CRYPTO_30_LIBCV_SM2_MIN_SIZEOF_ID                            (1u)    /* If an user ID KE is available it must not be empty*/
# define CRYPTO_30_LIBCV_SM2_MAX_SIZEOF_ID                            (8191u) /* The ID length is given to ESLib as 2byte parameter in bits */
                                                                              /* MAX_SIZEOF_ID = 2^16 / 8 - 1 */
...
/* EcP Curves */
# if ((CRYPTO_30_LIBCV_ECP256GENERATE == STD_ON) || (CRYPTO_30_LIBCV_ECP384GENERATE == STD_ON) || (CRYPTO_30_LIBCV_ECP160GENERATE == STD_ON) || (CRYPTO_30_LIBCV_ECP521GENERATE == STD_ON))
#  define CRYPTO_30_LIBCV_ECPGENERATE                                 STD_ON
# else
#  define CRYPTO_30_LIBCV_ECPGENERATE                                 STD_OFF
# endif

# if ((CRYPTO_30_LIBCV_ECP256VERIFY == STD_ON) || (CRYPTO_30_LIBCV_ECP384VERIFY == STD_ON) || (CRYPTO_30_LIBCV_ECP160VERIFY == STD_ON) || (CRYPTO_30_LIBCV_ECP521VERIFY == STD_ON))
...
# if ((CRYPTO_30_LIBCV_KEY_EXCHANGE_ALGORITHM_SECP521R1_ENABLED == STD_ON) || (CRYPTO_30_LIBCV_KEY_GENERATE_ALGORITHM_NIST_SEC_P521R1_ENABLED == STD_ON))
/* max size of ECC key -> corresponding to curve -> p521r1 = 66Byte */
#  define CRYPTO_30_LIBCV_ECC_KEY_MAXSIZE                             (CRYPTO_30_LIBCV_SIZEOF_ECC_521_KEY_PRIVATE)
# elif ((CRYPTO_30_LIBCV_KEY_EXCHANGE_ALGORITHM_SECP384R1_ENABLED == STD_ON) || (CRYPTO_30_LIBCV_KEY_GENERATE_ALGORITHM_NIST_SEC_P384R1_ENABLED == STD_ON))
...
# define Crypto_30_LibCv_IsModulePartitionInitialized(partitionIdx)   ((Crypto_30_LibCv_GetPartitionInitialized(partitionIdx) & CRYPTO_30_LIBCV_INITIALIZED) == CRYPTO_30_LIBCV_INITIALIZED)
# define Crypto_30_LibCv_IsModulePartitionNotInitialized(partitionIdx) ((Crypto_30_LibCv_GetPartitionInitialized(partitionIdx) & CRYPTO_30_LIBCV_INITIALIZED) != CRYPTO_30_LIBCV_INITIALIZED)
# define Crypto_30_LibCv_IsModuleSharedInitialized()                  ((Crypto_30_LibCv_ModuleInitialized & CRYPTO_30_LIBCV_INITIALIZED) == CRYPTO_30_LIBCV_INITIALIZED)
# define Crypto_30_LibCv_IsModuleSharedNotInitialized()               ((Crypto_30_LibCv_ModuleInitialized & CRYPTO_30_LIBCV_INITIALIZED) != CRYPTO_30_LIBCV_INITIALIZED)
...
#  define Crypto_30_LibCv_CurrentPartitionIdx()                       Crypto_30_LibCv_GetPartitionIdx()
#  define Crypto_30_LibCv_CurrentPartitionIdxViaObject(objectId)      Crypto_30_LibCv_GetPartitionIdxOfObjectInfo(objectId)
# else
#  define Crypto_30_LibCv_CurrentPartitionIdx()                       Crypto_30_LibCv_MainPartitionIdx
#  define Crypto_30_LibCv_CurrentPartitionIdxViaObject(objectId)      Crypto_30_LibCv_MainPartitionIdx
# endif
 ...
 *  \param[in]     targetData     target value array in bigEndian format
 *  \param[in]     referenceData  reference value array in bigEndian format
 *  \param[in]     dataLength     compare length
 *  \return        E_OK           Target data is smaller.
 *                 E_NOT_OK       Target data is not smaller.
 ...
 *  \synchronous   TRUE
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_ALWAYS_LOCAL_INLINE FUNC(void, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_Uint32ToUint8ArrayBigEndian(
  P2VAR(uint8, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) targetData,
  uint32 sourceData);
 ...
 *  \synchronous   TRUE
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_ALWAYS_LOCAL_INLINE FUNC(void, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_Uint8ArrayToUint32BigEndian(
 ...
 *  \return        E_OK                    Request successful.
 *                 E_NOT_OK                Request failed, keyElement was written, but connected key not found.
 *  \pre           elementIndex has to be a valid identifier to a keyElement in the keyStorage.
 *                 keyLength has to be smaller or equal in length to available key storage space.
 *  \context       TASK
 *  \reentrant     TRUE, for different crypto keys
 *  \synchronous   TRUE
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
/*! \brief          Check if the driver object workspace type is unchanged.
 *  \details        -
 ...
 *********************************************************************************************************************/
/*! \brief          Clear the last driver object workspace type for all driver objects which the given key was used.
 *  \details        -
 *  \param[in]      cryptoKeyId        Id of the crypto key.
 *  \return         E_OK               Dispatching was successful.
 *                  E_NOT_OK           Dispatching failed.
 ...
 *  \details       -
 *  \return        Current partition idx if called by configured application,
 *                 Size of known partitions if called by unknown application
 *  \pre           -
 *  \context       TASK
 *  \reentrant     TRUE
 *  \synchronous   TRUE
 ...
 *********************************************************************************************************************/
/*!
 * \brief       Handles the MainFunctions for the different partitions.
 * \details     Is called cyclically and handles asynchronous jobs from the queue.
 * \param[in]   partitionIdx            Valid partitionIdx
 * \pre         -
 * \context     TASK
 * \reentrant   TRUE for different partitionIdx
 * \synchronous TRUE
 *********************************************************************************************************************/
 ...
 *               It should be called once from each partition where the module is used.
 *  \param[in]   partitionIdx            Valid partitionIdx
 ...
 *
 */
CRYPTO_30_LIBCV_ALWAYS_LOCAL_INLINE FUNC(void, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_Uint32ToUint8ArrayBigEndian( /* PRQA S 3219 */ /* MD_CRYPTO_30_LIBCV_3219 */
  P2VAR(uint8, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) targetData,
  uint32 sourceData)
{
 ...
 *
 */
CRYPTO_30_LIBCV_ALWAYS_LOCAL_INLINE FUNC(void, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_Uint8ArrayToUint32BigEndian( /* PRQA S 3219 */ /* MD_CRYPTO_30_LIBCV_3219 */
  P2VAR(uint32, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) targetData,
  P2CONST(uint8, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) sourceData)
{
...
#endif /* CRYPTO_30_LIBCV_SERVICES_H */
/**********************************************************************************************************************
