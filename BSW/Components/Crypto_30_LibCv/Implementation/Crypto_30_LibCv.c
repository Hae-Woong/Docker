...
#if ((CRYPTO_30_LIBCV_MAJOR_VERSION != (14u)) \
    || (CRYPTO_30_LIBCV_MINOR_VERSION != (0u)) \
...
#if (  (CRYPTO_30_LIBCV_MAJOR_VERSION != CRYPTO_30_LIBCV_CFG_MAJOR_VERSION) \
    || (CRYPTO_30_LIBCV_MINOR_VERSION != CRYPTO_30_LIBCV_CFG_MINOR_VERSION) \
    || (CRYPTO_30_LIBCV_PATCH_VERSION != CRYPTO_30_LIBCV_CFG_PATCH_VERSION))
# error "Version numbers of Crypto_30_LibCv.c and Crypto_30_LibCv_Cfg.h are inconsistent"
#endif

#if (  (CRYPTO_30_LIBCV_GENERATOR_MAJOR_VERSION != (13u)) \
    || (CRYPTO_30_LIBCV_GENERATOR_MINOR_VERSION != (6u)))
# error "Module version numbers of Crypto_30_LibCv.c and generator are inconsistent"
#endif
 ...
 *
 */
CRYPTO_30_LIBCV_LOCAL CONST(uint8, CRYPTO_30_LIBCV_CONST) Crypto_30_LibCv_IOServiceMaskUpdateOptionalKeepFromFinish[CRYPTO_KEYSETVALID + 1u] = {  /* PRQA S 3218 */ /* MD_CRYPTO_30_LIBCV_8.7 */
  /* CRYPTO_HASH                  */   CRYPTO_30_LIBCV_IOMASK_EMPTY,
  /* CRYPTO_MACGENERATE           */   CRYPTO_30_LIBCV_IOMASK_EMPTY,
  /* CRYPTO_MACVERIFY             */   CRYPTO_30_LIBCV_IOMASK_EMPTY,
  /* CRYPTO_ENCRYPT               */   CRYPTO_30_LIBCV_IOMASK_EMPTY,
 ...
 *
 */
CRYPTO_30_LIBCV_LOCAL CONST(uint8, CRYPTO_30_LIBCV_CONST) Crypto_30_LibCv_IOServiceMaskUpdateZeroLength[CRYPTO_KEYSETVALID + 1u] = {  /* PRQA S 3218 */ /* MD_CRYPTO_30_LIBCV_8.7 */
  /* CRYPTO_HASH                  */   CRYPTO_30_LIBCV_IOMASK_PRIMARY_INPUT,
  /* CRYPTO_MACGENERATE           */   CRYPTO_30_LIBCV_IOMASK_PRIMARY_INPUT,
  /* CRYPTO_MACVERIFY             */   CRYPTO_30_LIBCV_IOMASK_PRIMARY_INPUT,
  /* CRYPTO_ENCRYPT               */   CRYPTO_30_LIBCV_IOMASK_EMPTY,
  /* CRYPTO_DECRYPT               */   CRYPTO_30_LIBCV_IOMASK_EMPTY,
  /* CRYPTO_AEADENCRYPT           */   CRYPTO_30_LIBCV_IOMASK_PRIMARY_INPUT,
  /* CRYPTO_AEADDECRYPT           */   CRYPTO_30_LIBCV_IOMASK_PRIMARY_INPUT,
  /* CRYPTO_SIGNATUREGENERATE     */   CRYPTO_30_LIBCV_IOMASK_EMPTY,
  /* CRYPTO_SIGNATUREVERIFY       */   CRYPTO_30_LIBCV_IOMASK_EMPTY,
  /* CRYPTO_SECCOUNTERINCREMENT   */   CRYPTO_30_LIBCV_IOMASK_EMPTY,
  /* CRYPTO_SECCOUNTERREAD        */   CRYPTO_30_LIBCV_IOMASK_EMPTY,
 ...
 *  \details        This function checks if the long term workspace is locked and provides the workspace idx.
 ...
 **********************************************************************************************************************/
/*! \brief          Checks provided key list for validity of key Ids.
 *  \details        -
 *  \param[in]      keyList           Holds the keylist which should be checked. Must not be NULL_PTR.
 *  \return         TRUE              Keys in keyList have valid Ids.
 *                  FALSE             At least one key in keyList has an invalid Id.
 *  \pre            -
 *  \context        TASK
 *  \reentrant      TRUE
 *  \synchronous    TRUE
 *********************************************************************************************************************/
FUNC(boolean, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_IsKeyListValid(
  P2CONST(Crypto_30_LibCv_KeyLockListType, AUTOMATIC, AUTOMATIC) keyList);
#endif

/**********************************************************************************************************************
 *  Crypto_30_LibCv_TryObtainingLockAndSetProcessing()
 *********************************************************************************************************************/
/*! \brief          Try to obtain the workspace lock and set object state to processing.
 *  \details        This function tries to lock the workspace with the job.
 *                  If that succeeds, it sets the object state to processing.
 *                  This access is not protected by a exclusive area.
 *  \param[in]      objectId          Holds the identifier of the object to lock.
 *  \param[in]      job               Pointer to the job. Must not be NULL_PTR.
 *  \param[out]     keyListNeedsLock  Pointer to a boolean where the information should be stored if the keys
 *                                    belonging to job must be locked. Must not be NULL_PTR.
 *  \return         E_OK              Lock is obtained or was already obtained.
 *                  E_NOT_OK          Request Failed
 *                  CRYPTO_E_BUSY     Lock is occupied by other job.
 *  \pre            objectId has to be a valid object id.
 *                  job has to be a valid job object.
 *                  The caller must ensure that this call is protected by a exclusive area.
 *  \context        TASK
 *  \reentrant      TRUE
 *  \synchronous    TRUE
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_LOCAL FUNC(Std_ReturnType, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_TryObtainingLockAndSetProcessing(
  uint32 objectId,
  P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) job,
  P2VAR(boolean, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) keyListNeedsLock);

/**********************************************************************************************************************
 *  Crypto_30_LibCv_TryObtainingLockAndLockKeys()
 *********************************************************************************************************************/
/*! \brief          Try to obtain lock workspace and set object state to processing.
 *  \details        This function tries to lock the workspace and keys with the job.
 *                  If that succeeds, it sets the object state to processing.
 *  \param[in]      objectId          Holds the identifier of the object to lock.
 *  \param[in]      job               Pointer to the job. Must not be NULL_PTR.
 *  \param[in]      keyList           Pointer to the key lock list. Must not be NULL_PTR.
 *  \return         E_OK              Lock is obtained or was already obtained.
 *                  E_NOT_OK          Request Failed
 *                  CRYPTO_E_BUSY     Lock is occupied by other job.
 *  \pre            objectId has to be a valid object id.
 ...
 *  \synchronous    TRUE
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_LOCAL FUNC(Std_ReturnType, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_TryObtainingLockAndLockKeys(
  uint32 objectId,
  P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) job,
  P2CONST(Crypto_30_LibCv_KeyLockListType, AUTOMATIC, AUTOMATIC) keyList);

/**********************************************************************************************************************
 *  Crypto_30_LibCv_CheckQueueAndLockAndProcess()
 *********************************************************************************************************************/
/*! \brief          If a job is in queue, try to obtain lock workspace and process the job.
 *  \details        This function tries to lock the workspace and keys with the job next in the queue.
 *                  If that succeeds, it sets the object state to processing and processes the job.
 *  \param[in]      objectId          Holds the identifier of the object queue to check.
 *  \pre            objectId has to be a valid object id.
 *  \context        TASK
 *  \reentrant      TRUE
 *  \synchronous    TRUE
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_LOCAL FUNC(void, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_CheckQueueAndLockAndProcess(
  uint32 objectId);
...
/**********************************************************************************************************************
 *  Crypto_30_LibCv_Local_DetChecksServiceValues_InputZeroLength()
 **********************************************************************************************************************/
/*! \brief         Det Checks for the input parameters.
 ...
 *  \synchronous   TRUE
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_LOCAL_INLINE FUNC(void, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_DetChecksServiceValues_InputZeroLength(
  P2VAR(uint8, AUTOMATIC, AUTOMATIC) errorId,
  P2CONST(uint8, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) dataPtr,
  uint32 dataLength);
 ...
 **********************************************************************************************************************/
/*! \brief         Dispatches Det checks for primary input.
 *  \details       -
 *  \param[out]    errorId        Output pointer to the detected Error-Type-Id
 *  \param[in]     job            Pointer to the job which shall be dispatched.
 *  \param[in]     optionalMask   Mask which optional parameter shall be checked.
 *  \param[in]     zeroLengthMask Mask which zero-length-enabled parameter shall be checked.
 *  \pre           job has to be a valid job object. errorId pointer has to be a valid pointer.
 *  \context       TASK
 *  \reentrant     TRUE
 *  \synchronous   TRUE
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_LOCAL_INLINE FUNC(void, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_DetChecksServiceValues_PrimaryInput(
  P2VAR(uint8, AUTOMATIC, AUTOMATIC) errorId,
  P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) job,
  uint8 optionalMask,
  uint8 zeroLengthMask);

/**********************************************************************************************************************
 *  Crypto_30_LibCv_Local_DetChecksServiceValues_SecondaryInput()
 **********************************************************************************************************************/
/*! \brief         Dispatches Det checks for secondary input.
 *  \details       -
 *  \param[out]    errorId        Output pointer to the detected Error-Type-Id
 *  \param[in]     job            Pointer to the job which shall be dispatched.
 *  \param[in]     optionalMask   Mask which optional parameter shall be checked.
 ...
 *  \synchronous   TRUE
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_LOCAL_INLINE FUNC(void, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_DetChecksServiceValues_SecondaryInput(
  P2VAR(uint8, AUTOMATIC, AUTOMATIC) errorId,
  P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) job,
  uint8 optionalMask);

/**********************************************************************************************************************
 *  Crypto_30_LibCv_Local_DetChecksServiceValues_PrimaryOutput()
 **********************************************************************************************************************/
/*! \brief         Dispatches Det checks for primary output.
 *  \details       -
 *  \param[out]    errorId        Output pointer to the detected Error-Type-Id
 *  \param[in]     job            Pointer to the job which shall be dispatched.
 *  \param[in]     optionalMask   Mask which optional parameter shall be checked.
 ...
 *  \synchronous   TRUE
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_LOCAL_INLINE FUNC(void, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_DetChecksServiceValues_PrimaryOutput(
  P2VAR(uint8, AUTOMATIC, AUTOMATIC) errorId,
  P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) job,
  uint8 optionalMask);
 ...
 *********************************************************************************************************************/
/*! \brief          Save the last driver object workspace type.
 *  \details        -
 *  \param[in]      objectId           Holds the identifier of the Crypto Driver Object.
 *  \param[in]      job                Pointer to the job which shall be dispatched.
 ...
 *                  Has to be called inside an exclusive area which protects the consistency of the last job data.
 *  \context        TASK
 *  \reentrant      TRUE
 *  \synchronous    TRUE
 *********************************************************************************************************************/
 ...
 **********************************************************************************************************************/
/*! \brief         Check access rights for given key element.
 ...
 *  \param[in,out] writtenLengthPtr Holds the a pointer to the already written length. (last update length)
...
CRYPTO_30_LIBCV_LOCAL FUNC(void, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_RedirectPostSaveKeyResult(
  ...
  uint32 keyElementId,
  uint32 resultLength,
  P2VAR(uint32, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) writtenLengthPtr,
...
CRYPTO_30_LIBCV_LOCAL FUNC(Std_ReturnType, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_RestoreContextJob(
  ...
  P2VAR(Crypto_JobType, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) job, /* PRQA S 3673 */ /* MD_CRYPTO_30_LIBCV_3673_1 */
  Crypto_30_LibCv_SizeOfPrimitiveInfoType primitiveInfoIdx);
#endif /* (CRYPTO_30_LIBCV_SAVEANDRESTOREWORKSPACE == STD_ON) */
...
/**********************************************************************************************************************
 *  Crypto_30_LibCv_TryToSetJobInQueue()
 **********************************************************************************************************************/
/*! \brief         Handles an asynchronous job request and tries to push it into the queue for deferred processing.
 *  \details       -
 *  \param[in]     objectId             Holds the identifier of the Crypto Driver Object.
 *  \param[in,out] job                  Pointer to the configuration of the job.
 *  \param[in]     primitiveInfoIdx     Holds the identifier of the primitive.
 *  \return        E_OK                 Request successful.
 *                 E_NOT_OK             Request failed.
 *                 CRYPTO_E_QUEUE_FULL  The queue for the async job is full.
 *  \pre           objectId has to be a valid driver object handle.
 *                 job has to be a job object handle.
 *                 primitiveInfoIdx has to be a valid Id.
 *  \context       TASK
 ...
 *  \synchronous   TRUE
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_LOCAL_INLINE FUNC(Std_ReturnType, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_TryToSetJobInQueue(
  uint32 objectId,
  P2VAR(Crypto_JobType, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) job,
  Crypto_30_LibCv_SizeOfPrimitiveInfoType primitiveInfoIdx);

/**********************************************************************************************************************
 *  Crypto_30_LibCv_InitMainPartition()
 *********************************************************************************************************************/
/*! \brief       Initializes the shared data of the Crypto Driver
 *  \details     This function initializes all shared variables relevant for all
 *               partitions and sets the module state for this data to initialized. It has to be called once from
 *               the main partition.
 *  \param[out]  errorIdPtr              Pointer to where the errorId should be written.
 *                                       Must not be NULL_PTR and have enough space for a uint8.
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_LOCAL_INLINE FUNC(void, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_InitMainPartition(
  P2VAR(uint8, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) errorIdPtr);

/**********************************************************************************************************************
 *  Crypto_30_LibCv_InitPartitionSpecificData()
 *********************************************************************************************************************/
/*! \brief       Initializes the partition specific data of the Crypto Driver
 *  \details     This function initializes all partition specific variables relevant for the provided
 *               partitionIdx and sets the module state for the partition to initialized. It has to be called once from
 *               each partition where the module is used.
 *  \param[in]   partitionIdx            Holds the index of the partition which should be initialized.
 *  \param[out]  errorIdPtr              Pointer to where the errorId should be written.
 *                                       Must not be NULL_PTR and have enough space for a uint8.
 *  \pre         Interrupts are disabled.
 *               Module is uninitialized.
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_LOCAL_INLINE FUNC(void, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_InitPartitionSpecificData(uint32 partitionIdx,
  P2VAR(uint8, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) errorIdPtr);
  ...
  P2VAR(boolean, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) keyListNeedsLock)
{
  ...
  *keyListNeedsLock = FALSE; /* SBSW_CRYPTO_30_LIBCV_PTR_ACCESS */

  /* #5 Lock driver object for the given job if it is not already locked. */
  if (Crypto_30_LibCv_IsLockOccupiedByJob(objectId, job->CRYPTO_30_LIBCV_JOB_ID_MEMBER))
  {
...
#endif
  {
    ...
    {
      Crypto_30_LibCv_SetLock(objectId, job->CRYPTO_30_LIBCV_JOB_ID_MEMBER); /* SBSW_CRYPTO_30_LIBCV_CSL01_OBJECTID */

      /* #10 Set object state to processing */
      Crypto_30_LibCv_SetDriverObjectState(objectId, CRYPTO_30_LIBCV_DRIVEROBJECTSTATE_PROCESSING); /* SBSW_CRYPTO_30_LIBCV_CSL01_OBJECTID */

#if (CRYPTO_30_LIBCV_ENABLE_KEY_LOCKING == STD_ON)
      *keyListNeedsLock = TRUE; /* SBSW_CRYPTO_30_LIBCV_PTR_ACCESS */
#endif
      retVal = E_OK;
    }
    else
...
{
  Std_ReturnType retVal = E_NOT_OK;
  boolean keysNeedToBeLocked = FALSE;

  SchM_Enter_Crypto_30_LibCv_CRYPTO_30_LIBCV_EXCLUSIVE_AREA_0();
  /* #10 Try to lock driver object for the given job */
  retVal = Crypto_30_LibCv_TryObtainingLockAndSetProcessing(objectId, job, &keysNeedToBeLocked); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_BUFFER */
  SchM_Exit_Crypto_30_LibCv_CRYPTO_30_LIBCV_EXCLUSIVE_AREA_0();

#if (CRYPTO_30_LIBCV_ENABLE_KEY_LOCKING == STD_ON)
  if ((retVal == E_OK) && (keysNeedToBeLocked == TRUE))
  {
    /* #20 Lock key if operation mode is start or restore */
    retVal = Crypto_30_LibCv_Local_KeyListPreLockKeysProtected(keyList);  /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */

    if (retVal != E_OK)
    {
      /* #30 If any lock fails, revert all locks and processing states */
      SchM_Enter_Crypto_30_LibCv_CRYPTO_30_LIBCV_EXCLUSIVE_AREA_0();
...
#else
  CRYPTO_30_LIBCV_DUMMY_STATEMENT(keyList); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
#endif
...
{
  P2VAR(Crypto_JobType, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) job;
  Crypto_30_LibCv_KeyLockListType keyList = {0};
  ...
  /* #1 Check if there is a job in the queue */
  ...
  if (job != NULL_PTR)
  {
    ...
    primitiveInfoIdx = Crypto_30_LibCv_GetDispatch_QueuePrimitiveInfoIdx(objectId);

#if (CRYPTO_30_LIBCV_DEFAULT_RANDOM_SOURCE == STD_ON)
    if (Crypto_30_LibCv_IsDefaultRandomSourceOfPrimitiveInfo(primitiveInfoIdx))
    {
      uint32 defaultRandomKey = Crypto_30_LibCv_GetDefaultRandomKeyOfPartitionInfo(Crypto_30_LibCv_CurrentPartitionIdxViaObject(objectId));
      Crypto_30_LibCv_Local_KeyListAddKey(&keyList, defaultRandomKey, CRYPTO_30_LIBCV_KEY_ACCESS_READ); /* SBSW_CRYPTO_30_LIBCV_STACK_VARIABLE_AS_PTR */
    }
#endif

    /* #10 Try to lock driver object for the given job */
    localRetVal = Crypto_30_LibCv_TryObtainingLockAndSetProcessing(objectId, job, &keysNeedToBeLocked); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_BUFFER */

#if (CRYPTO_30_LIBCV_ENABLE_KEY_LOCKING == STD_ON)
    if (localRetVal == E_OK)
    {
      if (keysNeedToBeLocked == TRUE)
      {
        /* #20 Lock key if operation mode is start or restore */
        SchM_Exit_Crypto_30_LibCv_CRYPTO_30_LIBCV_EXCLUSIVE_AREA_0();
        localRetVal = Crypto_30_LibCv_Local_KeyListPreLockKeysProtected(&keyList);  /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
        SchM_Enter_Crypto_30_LibCv_CRYPTO_30_LIBCV_EXCLUSIVE_AREA_0();

        if (localRetVal != E_OK)
        {
          /* #30 If any lock fails, revert all locks */
          Crypto_30_LibCv_FreeLock(objectId); /* SBSW_CRYPTO_30_LIBCV_CSL01_OBJECTID */
          Crypto_30_LibCv_SetDriverObjectState(objectId, CRYPTO_30_LIBCV_DRIVEROBJECTSTATE_IDLE); /* SBSW_CRYPTO_30_LIBCV_CSL01_OBJECTID */
        }
      }
    ...
    if (localRetVal == E_OK)
    {
      ...
      localRetVal = Crypto_30_LibCv_Process((uint32)objectId, job, &keyList, primitiveInfoIdx); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_OF_JOB_PTR */ /* PRQA S 2973 */ /* MD_CRYPTO_30_LIBCV_2973 */
      ...
      /* #50 Notify CryIf about the result of the job */
      CryIf_CallbackNotification(job, localRetVal); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_OF_JOB_PTR */
...
# if(CRYPTO_30_LIBCV_VSEC_PRIM_ESLT_LENGTH_32 == STD_ON)
  CRYPTO_30_LIBCV_DUMMY_STATEMENT(dataLength); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
# endif
} /* Crypto_30_LibCv_Local_DetChecksServiceValues_InputZeroLength() */
  ...
  uint8 zeroLengthMask)
{
  ...
  else if (Crypto_30_LibCv_IsIOMask(zeroLengthMask, CRYPTO_30_LIBCV_IOMASK_PRIMARY_INPUT))
  {
    Crypto_30_LibCv_Local_DetChecksServiceValues_InputZeroLength(errorId, job->CRYPTO_30_LIBCV_JOB_PRIMITIVE_INPUT_OUTPUT_MEMBER.inputPtr, job->CRYPTO_30_LIBCV_JOB_PRIMITIVE_INPUT_OUTPUT_MEMBER.inputLength); /* SBSW_CRYPTO_30_LIBCV_STACK_VARIABLE_AS_PTR_AND_MEMBER_OF_JOB_PTR */
  }
  else
  {
...
# if(CRYPTO_30_LIBCV_SAVEANDRESTOREWORKSPACE == STD_OFF)
  CRYPTO_30_LIBCV_DUMMY_STATEMENT(optionalMask); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
# endif
} /* Crypto_30_LibCv_Local_DetChecksServiceValues_PrimaryOutput() */
  ...
  )
{
  ...
  {
    Crypto_30_LibCv_Local_DetChecksServiceValues_PrimaryInput(&errorId, job, optionalMask, zeroLengthMask); /* SBSW_CRYPTO_30_LIBCV_STACK_VARIABLE_AS_PTR_AND_MEMBER_OF_JOB_PTR */
  }

  if (Crypto_30_LibCv_IsIOMask(mask, CRYPTO_30_LIBCV_IOMASK_SECONDARY_INPUT))
  {
    Crypto_30_LibCv_Local_DetChecksServiceValues_SecondaryInput(&errorId, job, optionalMask); /* SBSW_CRYPTO_30_LIBCV_STACK_VARIABLE_AS_PTR_AND_MEMBER_OF_JOB_PTR */
  }
  ...
  {
    Crypto_30_LibCv_Local_DetChecksServiceValues_PrimaryOutput(&errorId, job, optionalMask); /* SBSW_CRYPTO_30_LIBCV_STACK_VARIABLE_AS_PTR_AND_MEMBER_OF_JOB_PTR */
  }
  ...
  P2VAR(uint8, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) errorId)
{
  ...
  uint8 zeroLength = CRYPTO_30_LIBCV_IOMASK_EMPTY;
  ...
  {
    /* Check first FINISH then UPDATE this is required for optional special handling. */
    ...
    if (Crypto_30_LibCv_IsJobMode(job, CRYPTO_OPERATIONMODE_UPDATE))
    {
      ...
      optional &= Crypto_30_LibCv_IOServiceMaskUpdateOptionalKeepFromFinish[cryptoService];
      optional |= Crypto_30_LibCv_IOServiceMaskUpdateOptional[cryptoService];
      zeroLength = Crypto_30_LibCv_IOServiceMaskUpdateZeroLength[cryptoService];
    }
...
# endif
    ...
    {
      *errorId = Crypto_30_LibCv_Local_DetChecksServiceValues_All(job, mask, optional, zeroLength); /* SBSW_CRYPTO_30_LIBCV_ACCESS_TO_ERRORID_PTR */ /* SBSW_CRYPTO_30_LIBCV_FORWARDING_OF_JOB_PTR */
    }
  }
  ...
  uint8 keyAccess)
{
  ...
  for (i = 0; i < keyList->numKeys; i++) /* FETA_CRYPTO_30_LIBCV_MONOTONIC_LOOP_UP_WITH_PARAMETER_DEPENDENT_UPPER_BOUND_PTR */
  {
  ...
  P2VAR(Crypto_30_LibCv_KeyLockListType, AUTOMATIC, AUTOMATIC) keyList)
{
  ...
  for (i = 0; i < keyList->numKeys; i++) /* FETA_CRYPTO_30_LIBCV_MONOTONIC_LOOP_UP_WITH_PARAMETER_DEPENDENT_UPPER_BOUND_PTR */
  {
    ...
    {
      /* Check key list for other restrictions */
#if ((CRYPTO_30_LIBCV_SERVICE_RANDOM == STD_ON) && (CRYPTO_30_LIBCV_DEFAULT_RANDOM_SOURCE == STD_ON))
# if (CRYPTO_30_LIBCV_ENABLE_KEY_LOCKING == STD_OFF)
      if (job->jobPrimitiveInfo->primitiveInfo->service == CRYPTO_RANDOMGENERATE)
      {
        Crypto_30_LibCv_PartitionInfoIterType partitionInfoIdx = 0u;
        /* Check if default random key is used */
        for (partitionInfoIdx = 0u; partitionInfoIdx < Crypto_30_LibCv_GetSizeOfPartitionInfo(); partitionInfoIdx++)
        {
          if(Crypto_30_LibCv_GetDefaultRandomKeyOfPartitionInfo(partitionInfoIdx) == keyList->keyLockList[i].keyId)
          {
            retVal = E_NOT_OK;
            break;
          }
  ...
  P2CONST(Crypto_30_LibCv_KeyLockListType, AUTOMATIC, AUTOMATIC) keyList)
{
  ...
  if (retVal != E_OK)
  {
    for (j = 0; j < i; j++) /* FETA_CRYPTO_30_LIBCV_MONOTONIC_LOOP_UP_WITH_PARAMETER_DEPENDENT_UPPER_BOUND_PTR */
    {
...
/**********************************************************************************************************************
 *  Crypto_30_LibCv_Local_KeyListPreLockKeysProtected()
 **********************************************************************************************************************/
/*!
 *
 * Internal comment removed.
 ...
 *
 */
FUNC(Std_ReturnType, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_KeyListPreLockKeysProtected(
  P2CONST(Crypto_30_LibCv_KeyLockListType, AUTOMATIC, AUTOMATIC) keyList)
{
  Std_ReturnType retVal = E_OK; /* PRQA S 2981 */ /* MD_MSR_RetVal */

  SchM_Enter_Crypto_30_LibCv_CRYPTO_30_LIBCV_EXCLUSIVE_AREA_1();
  retVal = Crypto_30_LibCv_Local_KeyListPreLockKeys(keyList); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
...
/**********************************************************************************************************************
 *  Crypto_30_LibCv_Local_KeyListPostFreeKeysProtected()
 **********************************************************************************************************************/
/*!
 *
 * Internal comment removed.
 ...
 *
 */
FUNC(void, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_KeyListPostFreeKeysProtected(
  P2CONST(Crypto_30_LibCv_KeyLockListType, AUTOMATIC, AUTOMATIC) keyList)
{
  SchM_Enter_Crypto_30_LibCv_CRYPTO_30_LIBCV_EXCLUSIVE_AREA_1();
  ...
  P2CONST(Crypto_30_LibCv_KeyLockListType, AUTOMATIC, AUTOMATIC) keyList)
{
  ...
  uint8 currentKeyIdx = 0;

  /* Check if the keyList keys have valid keyIds. */
  for (currentKeyIdx = 0; currentKeyIdx < keyList->numKeys; currentKeyIdx++) /* FETA_CRYPTO_30_LIBCV_MONOTONIC_LOOP_UP_WITH_PARAMETER_DEPENDENT_UPPER_BOUND_PTR */
  {
...
#endif /* (CRYPTO_30_LIBCV_ENABLE_KEY_LOCKING == STD_ON) */
...
# if(CRYPTO_30_LIBCV_SAVEANDRESTOREWORKSPACE == STD_ON)
  /* Check if save or restore mode is used and ignore redirection for these modes */
  if(Crypto_30_LibCv_IsJobMode(job, CRYPTO_OPERATIONMODE_SAVE_CONTEXT) || Crypto_30_LibCv_IsJobMode(job, CRYPTO_OPERATIONMODE_RESTORE_CONTEXT))
  {
    retVal = FALSE;
  }
  else
  ...
  P2VAR(Crypto_JobType, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) job)
{
  ...
  {
    redirectBuffer->firstOutputLengthWritten = 0u;  /* SBSW_CRYPTO_30_LIBCV_PTR_ACCESS */
    redirectBuffer->secondaryOutputLengthWritten = 0u;  /* SBSW_CRYPTO_30_LIBCV_PTR_ACCESS */
  }
  ...
  if (Crypto_30_LibCv_Local_IsRedirectUsed(job) == TRUE)  /* SBSW_CRYPTO_30_LIBCV_FORWARDING_OF_JOB_PTR */
  {
    ...
    redirectBuffer->jobPrimitiveInputOutput_Restore = job->CRYPTO_30_LIBCV_JOB_PRIMITIVE_INPUT_OUTPUT_MEMBER;  /* SBSW_CRYPTO_30_LIBCV_PTR_ACCESS */

    /* # Set redirection for primary input. */
    if (Crypto_30_LibCv_IsIOMask(redir, CRYPTO_REDIRECT_CONFIG_PRIMARY_INPUT))
    {
      retVal = Crypto_30_LibCv_Local_RedirectPreSetBufferForKey(redirInfoRef->inputKeyId, /* SBSW_CRYPTO_30_LIBCV_STACK_VARIABLE_AS_PTR */
        redirInfoRef->inputKeyElementId,
        &elementStorageIndex,
        &redirKeyLength,
    ...
    {
      retVal = Crypto_30_LibCv_Local_RedirectPreSetBufferForKey(redirInfoRef->secondaryInputKeyId, /* SBSW_CRYPTO_30_LIBCV_STACK_VARIABLE_AS_PTR */
        redirInfoRef->secondaryInputKeyElementId,
        &elementStorageIndex,
        &redirKeyLength,
        CRYPTO_30_LIBCV_KEY_ACCESS_READ,
        cryptoService);
    ...
    {
      retVal = Crypto_30_LibCv_Local_RedirectPreSetBufferForKey(redirInfoRef->tertiaryInputKeyId, /* SBSW_CRYPTO_30_LIBCV_STACK_VARIABLE_AS_PTR */
        redirInfoRef->tertiaryInputKeyElementId,
        &elementStorageIndex,
        &redirKeyLength,
        CRYPTO_30_LIBCV_KEY_ACCESS_READ,
        cryptoService);
    ...
    {
      retVal = Crypto_30_LibCv_Local_RedirectPreSetBufferForKey(redirInfoRef->outputKeyId, /* SBSW_CRYPTO_30_LIBCV_STACK_VARIABLE_AS_PTR */
        redirInfoRef->outputKeyElementId,
        &elementStorageIndex,
        &redirKeyLength,
        CRYPTO_30_LIBCV_KEY_ACCESS_WRITE,
        cryptoService);
      inOutRef->outputPtr = &Crypto_30_LibCv_GetAddrKeyStorage(elementStorageIndex)[redirectBuffer->firstOutputLengthWritten]; /* SBSW_CRYPTO_30_LIBCV_WRITE_ACCESS_TO_JOBPRIMITIVE_INPUTOUTPUT_PTR */
      redirectBuffer->firstOutputLength = redirKeyLength - redirectBuffer->firstOutputLengthWritten;  /* SBSW_CRYPTO_30_LIBCV_PTR_ACCESS */
      inOutRef->outputLengthPtr = &redirectBuffer->firstOutputLength;  /* SBSW_CRYPTO_30_LIBCV_WRITE_ACCESS_TO_JOBPRIMITIVE_INPUTOUTPUT_PTR */
    }
    ...
    {
      retVal = Crypto_30_LibCv_Local_RedirectPreSetBufferForKey(redirInfoRef->secondaryOutputKeyId, /* SBSW_CRYPTO_30_LIBCV_STACK_VARIABLE_AS_PTR */
        redirInfoRef->secondaryOutputKeyElementId,
        &elementStorageIndex,
        &redirKeyLength,
        CRYPTO_30_LIBCV_KEY_ACCESS_WRITE,
        cryptoService);
      inOutRef->secondaryOutputPtr = &Crypto_30_LibCv_GetAddrKeyStorage(elementStorageIndex)[redirectBuffer->secondaryOutputLengthWritten]; /* SBSW_CRYPTO_30_LIBCV_WRITE_ACCESS_TO_JOBPRIMITIVE_INPUTOUTPUT_PTR */
      ...
      inOutRef->secondaryOutputLengthPtr = &redirectBuffer->secondaryOutputLength;  /* SBSW_CRYPTO_30_LIBCV_WRITE_ACCESS_TO_JOBPRIMITIVE_INPUTOUTPUT_PTR */
    }

    /* # Restore buffer if there was a failure.  */
    if (retVal != E_OK)
    {
      job->CRYPTO_30_LIBCV_JOB_PRIMITIVE_INPUT_OUTPUT_MEMBER = redirectBuffer->jobPrimitiveInputOutput_Restore;  /* SBSW_CRYPTO_30_LIBCV_WRITE_ACCESS_TO_JOBPRIMITIVE_INPUTOUTPUT_PTR */
    }
  }
  ...
  Std_ReturnType result)
{
  ...
  if (result == E_OK)
  {
    *writtenLengthPtr += resultLength; /* SBSW_CRYPTO_30_LIBCV_PTR_ACCESS */
  }

  Crypto_30_LibCv_SetKeyElementWrittenLengthWithCryptoKeyId(cryptoKeyId, elementIndex, *writtenLengthPtr);
} /* Crypto_30_LibCv_Local_RedirectPostSaveKeyResult() */
...
{
  Crypto_InputOutputRedirectionConfigType redir;
  Crypto_InputOutputRedirectionConfigType redirMask = 0;
  P2CONST(Crypto_JobRedirectionInfoType, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) redirInfoRef = job->jobRedirectionInfoRef;
  ...
  if (Crypto_30_LibCv_Local_IsRedirectUsed(job) == TRUE)   /* SBSW_CRYPTO_30_LIBCV_FORWARDING_OF_JOB_PTR */
  {
    ...
    if(Crypto_30_LibCv_IsJobMode(job, CRYPTO_OPERATIONMODE_UPDATE))
    {
      redirMask = Crypto_30_LibCv_IOServiceMaskUpdate[job->jobPrimitiveInfo->primitiveInfo->service];
    }
    if(Crypto_30_LibCv_IsJobMode(job, CRYPTO_OPERATIONMODE_FINISH))
    {
      redirMask |= Crypto_30_LibCv_IOServiceMaskFinish[job->jobPrimitiveInfo->primitiveInfo->service];
    }
    ...
    {
      Crypto_30_LibCv_Local_RedirectPostSaveKeyResult(redirInfoRef->outputKeyId, redirInfoRef->outputKeyElementId,
        redirectBuffer->firstOutputLength, &(redirectBuffer->firstOutputLengthWritten), result); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
    }

    if (Crypto_30_LibCv_IsIOMask(redir, CRYPTO_REDIRECT_CONFIG_SECONDARY_OUTPUT))
    {
      Crypto_30_LibCv_Local_RedirectPostSaveKeyResult(redirInfoRef->secondaryOutputKeyId, redirInfoRef->secondaryOutputKeyElementId,
        redirectBuffer->secondaryOutputLength, &(redirectBuffer->secondaryOutputLengthWritten), result); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
    }
  ...
  Crypto_30_LibCv_SizeOfPrimitiveInfoType primitiveInfoIdx)
{
  ...
  Crypto_30_LibCv_SetProcessJob_Trigger_Write(objectId, FALSE); /* SBSW_CRYPTO_30_LIBCV_CSL01_OBJECTID */

#if (CRYPTO_30_LIBCV_REDIRECTION == STD_ON)
  retVal = Crypto_30_LibCv_Local_RedirectPreRedirKeys(&Crypto_30_LibCv_GetRedirect_Buffer(objectId), job); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_OF_JOB_AND_GLOBAL_ARRAY_PTR */
  if (retVal == E_OK)
#endif
  {
...
#if (CRYPTO_30_LIBCV_REDIRECTION == STD_ON)
    Crypto_30_LibCv_Local_RedirectPostRestoreBuffer(&Crypto_30_LibCv_GetRedirect_Buffer(objectId), job, retVal); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_OF_JOB_AND_GLOBAL_ARRAY_PTR */
#endif
  }

  /* #14 Free keys in case of an error or if FINISH mode completed. */
#if(CRYPTO_30_LIBCV_SAVEANDRESTOREWORKSPACE == STD_ON)
  ...
  {
#if (CRYPTO_30_LIBCV_ENABLE_KEY_LOCKING == STD_ON)
    Crypto_30_LibCv_Local_KeyListPostFreeKeysProtected(keyList); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
#endif
#if (CRYPTO_30_LIBCV_NVBLOCK == STD_ON)
    if (Crypto_30_LibCv_IsProcessJob_Trigger_Write(objectId)) /* COV_CRYPTO_30_LIBCV_SERVICE_CONFIGURATION_2 */
    {
  ...
  P2VAR(Crypto_30_LibCv_SizeOfPrimitiveInfoType, AUTOMATIC, AUTOMATIC)  primitiveInfoIdx)
{
  ...
  if (Crypto_30_LibCv_IsPrimitiveInfoUsedOfPrimitiveServiceInfo(primitive->service) == TRUE) /* COV_CRYPTO_30_LIBCV_SERVICE_CONFIGURATION */
  {
    ...
    for (primitiveInfoIteratorIdx = primitiveInfoStartIdx; primitiveInfoIteratorIdx < primitiveInfoEndIdx; primitiveInfoIteratorIdx++) /* FETA_CRYPTO_30_LIBCV_MONOTONIC_LOOP_UP_WITH_UNCHANGED_BOUNDS_STATIC_GENDATA */
    {
      ...
      if (Crypto_30_LibCv_GetCombinedOfPrimitiveInfo(primitiveInfoIteratorIdx) == combi)
      {
        ...
        for (objectInfoIndIdx = objectInfoIndStartIdx; objectInfoIndIdx < objectInfoIndEndIdx; objectInfoIndIdx++) /* FETA_CRYPTO_30_LIBCV_MONOTONIC_LOOP_UP_WITH_UNCHANGED_BOUNDS_STATIC_GENDATA */
        {
  ...
  Crypto_30_LibCv_SizeOfPrimitiveInfoType primitiveInfoIdx)
{
  ...
  {
# if (CRYPTO_30_LIBCV_REDIRECTION == STD_ON)
    /* Check if output redirection was used in the previous calls of the current job */
    if(Crypto_30_LibCv_GetRedirect_Buffer(objectId).firstOutputLengthWritten != 0u)
    {
      /* No saving of output redirected job allowed. retVal already set to E_NOT_OK */
    }
    else
# endif
    ...
    else if (*job->CRYPTO_30_LIBCV_JOB_PRIMITIVE_INPUT_OUTPUT_MEMBER.outputLengthPtr >= outputLength)
    {
      ...
      retVal = Appl_Crypto_30_LibCv_SaveContextCallout(objectId,
                                                       job->CRYPTO_30_LIBCV_JOB_ID_MEMBER,
  ...
  Crypto_30_LibCv_SizeOfPrimitiveInfoType primitiveInfoIdx) /* PRQA S 3673 */ /* MD_CRYPTO_30_LIBCV_3673_1 */
{
  ...
  if ((job->jobPrimitiveInfo->primitiveInfo->service <= CRYPTO_SIGNATUREVERIFY) && (Crypto_30_LibCv_IsContextOfPrimitiveInfo(primitiveInfoIdx)))
  {
    ...
    (void) Crypto_30_LibCv_GetDispatchOfPrimitiveFct(Crypto_30_LibCv_GetPrimitiveFctIdxOfPrimitiveInfo(primitiveInfoIdx))(objectId, job, CRYPTO_OPERATIONMODE_RESTORE_CONTEXT); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_OF_JOB_PTR */
  ...
  Crypto_30_LibCv_SizeOfPrimitiveInfoType primitiveInfoIdx)
{
  ...
  boolean queueJob = FALSE;

  SchM_Enter_Crypto_30_LibCv_CRYPTO_30_LIBCV_EXCLUSIVE_AREA_0();

  /* #10 Check if queue is full */
  if (Crypto_30_LibCv_GetQueue(queueIdx) != NULL_PTR)
  {
    retVal = CRYPTO_E_QUEUE_FULL;
  }
  /* #20 Queue job if driver object lock is already set by the same job */
  else if ((Crypto_30_LibCv_IsLockOccupiedByJob(objectId, job->CRYPTO_30_LIBCV_JOB_ID_MEMBER)) == TRUE)
  {
    /* Previously already a start or restore job was processed, therefore the lock is set */
    queueJob = TRUE;
  }
  /* #30 Check if job is a start or restore job */
#if (CRYPTO_30_LIBCV_SAVEANDRESTOREWORKSPACE == STD_ON)
  else if (Crypto_30_LibCv_IsJobMode(job, CRYPTO_OPERATIONMODE_START) || Crypto_30_LibCv_IsJobMode(job, CRYPTO_OPERATIONMODE_RESTORE_CONTEXT))
#else
  else if (Crypto_30_LibCv_IsJobMode(job, CRYPTO_OPERATIONMODE_START))
#endif
  {
    /* #35 Queue job if the driver object lock is not set */
    if (Crypto_30_LibCv_IsLockFree(objectId))
    {
      /* Job is start or restore job */
      queueJob = TRUE;
    }
    else
    {
      /* Another job is currently processing */
      retVal = CRYPTO_E_QUEUE_FULL;
    }
  }
  else
  ...
  if (queueJob)
  {
    ...
    Crypto_30_LibCv_SetDispatch_QueuePrimitiveInfoIdx(objectId, primitiveInfoIdx); /* SBSW_CRYPTO_30_LIBCV_CSL01_OBJECTID */
    retVal = E_OK;
  }
...
#if (CRYPTO_30_LIBCV_NUMBER_OF_PARTITIONS > 1u)
/**********************************************************************************************************************
 *  Crypto_30_LibCv_GetPartitionIdx()
 **********************************************************************************************************************/
/*!
 *
 * Internal comment removed.
 ...
 *
 */
FUNC(uint32, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_GetPartitionIdx(void)
{
  uint32 partitionIdx = Crypto_30_LibCv_GetSizeOfPartitionIdentifiers();

  Crypto_30_LibCv_PartitionIdentifiersIterType partitionIdentifierIdx = 0u;
  ApplicationType applicationId = GetApplicationID();

  for(partitionIdentifierIdx = 0u; partitionIdentifierIdx < Crypto_30_LibCv_GetSizeOfPartitionIdentifiers(); partitionIdentifierIdx++)
  {
    if(applicationId == Crypto_30_LibCv_GetPartitionSNVOfPartitionIdentifiers(partitionIdentifierIdx))
    {
      partitionIdx = Crypto_30_LibCv_GetPCPartitionConfigIdxOfPartitionIdentifiers(partitionIdentifierIdx);
      break;
    }
  }
  return (uint32)partitionIdx;
} /* Crypto_30_LibCv_GetPartitionIdx() */
#endif
...
CRYPTO_30_LIBCV_LOCAL_INLINE FUNC(void, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_InitMainPartition(
  P2VAR(uint8, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) errorIdPtr) /* PRQA S 3673 */ /* MD_CRYPTO_30_LIBCV_3673_2 */
{

  /* ----- Development Error Checks ------------------------------------- */
#if (CRYPTO_30_LIBCV_DEV_ERROR_DETECT == STD_ON)
  /* #5 Check initialization state of the component. */
  if (Crypto_30_LibCv_IsModuleSharedInitialized())
  {
    *errorIdPtr = CRYPTO_E_INIT_FAILED; /* SBSW_CRYPTO_30_LIBCV_PTR_ACCESS */
  }
  else
#endif
  {
...
# endif
    ...
    /* Set module partition state to initialized */
#if (CRYPTO_30_LIBCV_DEV_ERROR_DETECT == STD_ON)
    /* Set shared data and general module state to initialized */
    Crypto_30_LibCv_ModuleInitialized = CRYPTO_30_LIBCV_INITIALIZED;
#endif
  }

  /* ----- Development Error Report --------------------------------------- */
#if (CRYPTO_30_LIBCV_DEV_ERROR_REPORT == STD_OFF)
  CRYPTO_30_LIBCV_DUMMY_STATEMENT(errorIdPtr); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /*lint !e438 */
#endif
} /* Crypto_30_LibCv_InitMainPartition() */
  ...
  P2VAR(uint8, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) errorIdPtr) /* PRQA S 3673 */ /* MD_CRYPTO_30_LIBCV_3673_2 */
{
  /* ----- Development Error Checks ------------------------------------- */
#if (CRYPTO_30_LIBCV_DEV_ERROR_DETECT == STD_ON)
  /* #5 Check initialization state of the partition. */
  if (Crypto_30_LibCv_IsModulePartitionInitialized(partitionIdx))
  {
    *errorIdPtr = CRYPTO_E_INIT_FAILED; /* SBSW_CRYPTO_30_LIBCV_PTR_ACCESS */
  }
  else
#endif
  {
...
#if (CRYPTO_30_LIBCV_DEFAULT_RANDOM_SOURCE == STD_ON)
    Crypto_30_LibCv_SetRandomSourceGenerateCount(0u, partitionIdx); /* SBSW_CRYPTO_30_LIBCV_WRITE_PARTITION_DATA */
#endif
    ...
    {
#if (CRYPTO_30_LIBCV_NUMBER_OF_PARTITIONS > 1u)
      if (partitionIdx == Crypto_30_LibCv_CurrentPartitionIdxViaObject(objectId))
#endif
      {
        Crypto_30_LibCv_SetDriverObjectState(objectId, CRYPTO_30_LIBCV_DRIVEROBJECTSTATE_IDLE); /* SBSW_CRYPTO_30_LIBCV_CSL01_OBJECTID */
#if (CRYPTO_30_LIBCV_CMAC_AES_ROUNDKEY_REUSE == STD_ON)
    ...
    /* Set module partition state to initialized */
#if (CRYPTO_30_LIBCV_DEV_ERROR_DETECT == STD_ON)
    Crypto_30_LibCv_SetPartitionInitialized(CRYPTO_30_LIBCV_INITIALIZED, partitionIdx); /* SBSW_CRYPTO_30_LIBCV_WRITE_PARTITION_DATA */
#endif
  }
...
#if (CRYPTO_30_LIBCV_NUMBER_OF_PARTITIONS < 2u)
  CRYPTO_30_LIBCV_DUMMY_STATEMENT(partitionIdx); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /*lint !e438 */
#endif
} /* Crypto_30_LibCv_InitPartitionSpecificData() */
...
/**********************************************************************************************************************
 *  Crypto_30_LibCv_InitMemoryHandler()
 *********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
 *
 */
FUNC(void, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_InitMemoryHandler(uint32 partitionIdx)
{
#if (CRYPTO_30_LIBCV_DEV_ERROR_DETECT == STD_ON)
  /* #5 Uninitialize module. */
# if (CRYPTO_30_LIBCV_NUMBER_OF_PARTITIONS > 1u)
  if (partitionIdx == Crypto_30_LibCv_MainPartitionIdx)
# endif
  {
    Crypto_30_LibCv_ModuleInitialized = (uint8)CRYPTO_30_LIBCV_UNINIT;
  }

  Crypto_30_LibCv_SetPartitionInitialized(CRYPTO_30_LIBCV_UNINIT, partitionIdx); /* SBSW_CRYPTO_30_LIBCV_WRITE_PARTITION_DATA */
#endif
  ...
  boolean initAllBytes)
{
  ...
  if (Crypto_30_LibCv_HasKeyElementInitValue(elementIndex))
  {
    ...
    if (initAllBytes)
    {
      /* Initialize remaining bytes with zeros. */
...
#endif
    {
      /* #10 Initialize shared data */
      Crypto_30_LibCv_InitMainPartition(&errorId); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_BUFFER */
    }
...
#endif
    {
      /* #20 Initialize partition specific data */
      Crypto_30_LibCv_InitPartitionSpecificData(partitionIdx, &errorId); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_BUFFER */
    }
  }
#if (CRYPTO_30_LIBCV_MULTI_PARTITION_RUNTIME_CHECKS == STD_ON)
  else
...
/**********************************************************************************************************************
 *  Crypto_30_LibCv_MainFunctionHandler()
 *********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 *
 */
FUNC(void, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_MainFunctionHandler(uint32 partitionIdx)
{
  /* ----- Local Variables ---------------------------------------------- */
  Crypto_30_LibCv_ObjectInfoIterType objectId;
  ...
  if (Crypto_30_LibCv_IsModulePartitionInitialized(partitionIdx) && Crypto_30_LibCv_IsModuleSharedInitialized()) /* PRQA S 3415 */ /* MD_CRYPTO_30_LIBCV_3415_LOGICAL_OPERATOR */
#endif
  {
...
#endif
      {
        Crypto_30_LibCv_CheckQueueAndLockAndProcess((uint32)objectId);
      }
    }
  }
  ...
  P2VAR(Crypto_JobType, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) job)
{
  ...
  /* [SWS_Crypto_00057] */
  /* #5 Check initialization state of the component. */
  if (Crypto_30_LibCv_IsModuleSharedNotInitialized())
  {
  ...
  else if (Crypto_30_LibCv_Local_DetChecksServiceValues(job, &errorId) != E_OK) /* SBSW_CRYPTO_30_LIBCV_STACK_VARIABLE_AS_PTR_AND_MEMBER_OF_JOB_PTR */
  {
    /* Error Id is set by sub-function */
  }
  else
#endif
  if (objectId >= Crypto_30_LibCv_GetSizeOfObjectInfo())
  {
  ...
  /* [SWS_Crypto_00057] */
  /* #5 Check initialization state of the component. */
  else if (Crypto_30_LibCv_IsModulePartitionNotInitialized(Crypto_30_LibCv_CurrentPartitionIdxViaObject(objectId)))
  {
    errorId = CRYPTO_E_UNINIT;
  }
#endif
  else if (Crypto_30_LibCv_Local_GetKeyListAndDet(job, &keyList) != E_OK) /* SBSW_CRYPTO_30_LIBCV_STACK_VARIABLE_AS_PTR_AND_MEMBER_OF_JOB_PTR */
  {
    errorId = CRYPTO_E_PARAM_HANDLE;
  }
  else if (Crypto_30_LibCv_SearchService(objectId, job, &primitiveInfoIdx) != E_OK) /* SBSW_CRYPTO_30_LIBCV_STACK_VARIABLE_AS_PTR_AND_MEMBER_OF_JOB_PTR */
  {
    errorId = CRYPTO_E_PARAM_HANDLE;
  }
#if (CRYPTO_30_LIBCV_MULTI_PARTITION_RUNTIME_CHECKS == STD_ON)
  else if (Crypto_30_LibCv_CurrentPartitionIdx() != Crypto_30_LibCv_CurrentPartitionIdxViaObject(objectId))
  {
    errorId = CRYPTO_E_PARAM_HANDLE;
  }
#endif
  else
  {
    ...
    {
      retVal = Crypto_30_LibCv_TryObtainingLockAndLockKeys(objectId, job, &keyList); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_OF_JOB_PTR */
      if (retVal == E_OK)
      {
    ...
    {
      /* #20 Otherwise handle job asynchronously. */
      retVal = Crypto_30_LibCv_TryToSetJobInQueue(objectId, job, primitiveInfoIdx); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_OF_JOB_PTR */
    }
  }
...
#if (CRYPTO_30_LIBCV_DEV_ERROR_DETECT == STD_ON)
  if (Crypto_30_LibCv_IsModulePartitionNotInitialized(Crypto_30_LibCv_CurrentPartitionIdxViaObject(objectId)))
  {
    errorId = CRYPTO_E_UNINIT;
  }
  else
#endif
  {
    ...
    if (Crypto_30_LibCv_GetDriverObjectState(objectId) == CRYPTO_30_LIBCV_DRIVEROBJECTSTATE_IDLE)
    {
      ...
      if ((queuedJob != NULL_PTR) &&
          (queuedJob->CRYPTO_30_LIBCV_JOB_ID_MEMBER == job->CRYPTO_30_LIBCV_JOB_ID_MEMBER))
      {
...
#if (CRYPTO_30_LIBCV_ENABLE_KEY_LOCKING == STD_ON)
        SchM_Exit_Crypto_30_LibCv_CRYPTO_30_LIBCV_EXCLUSIVE_AREA_0();
        Crypto_30_LibCv_Local_KeyListPostFreeKeysProtected(&keyList);  /* SBSW_CRYPTO_30_LIBCV_STACK_VARIABLE_AS_PTR */
        SchM_Enter_Crypto_30_LibCv_CRYPTO_30_LIBCV_EXCLUSIVE_AREA_0();
#endif
        retVal = E_OK;
      }
...
FUNC(void, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Api_GetKeyListRedirection(
  ...
  P2VAR(Crypto_30_LibCv_KeyLockListType, AUTOMATIC, AUTOMATIC) keyList)
{
  Crypto_30_LibCv_Local_GetKeyListRedirection(job, keyList); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
} /* Crypto_30_LibCv_Api_GetKeyListRedirection() */
  ...
  P2VAR(Crypto_JobType, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) job)
{
  ...
  if (Crypto_30_LibCv_Local_GetKeyListAndDet(job, &keyList) != E_OK) /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
  {
    retVal = E_NOT_OK;
  }
  else
  {
    retVal = Crypto_30_LibCv_Local_RedirectPreRedirKeys(redirectBuffer, job); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
  }
  ...
  Std_ReturnType result)
{
  ...
  {
    Crypto_30_LibCv_Local_RedirectPostRestoreBuffer(redirectBuffer, job, result); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
    retVal = E_OK;
  }
  ...
  uint8 keyAccess)
{
  ...
  {
    Crypto_30_LibCv_Local_KeyListAddKey(keyList, cryptoKeyId, keyAccess); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR_AND_MEMBER_OF_JOB_PTR */
    retVal = E_OK;
  }
  ...
  P2CONST(Crypto_30_LibCv_KeyLockListType, AUTOMATIC, AUTOMATIC) keyList)
{
  ...
  /* Check if the keyList keys have valid keyIds. */
  keysValid = Crypto_30_LibCv_Local_IsKeyListValid(keyList); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
...
/**********************************************************************************************************************
 *  Crypto_30_LibCv_Api_KeyListPreLockKeysProtected()
 **********************************************************************************************************************/
/*!
 *
 * Internal comment removed.
 ...
 *
 */
FUNC(Std_ReturnType, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Api_KeyListPreLockKeysProtected(
  P2CONST(Crypto_30_LibCv_KeyLockListType, AUTOMATIC, AUTOMATIC) keyList)
{
  Std_ReturnType retVal = E_NOT_OK;
...
/**********************************************************************************************************************
 *  Crypto_30_LibCv_Api_KeyListPostFreeKeysProtected()
 **********************************************************************************************************************/
/*!
 *
 * Internal comment removed.
 ...
 *
 */
FUNC(Std_ReturnType, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Api_KeyListPostFreeKeysProtected(
  P2CONST(Crypto_30_LibCv_KeyLockListType, AUTOMATIC, AUTOMATIC) keyList)
{
  Std_ReturnType retVal = E_NOT_OK;
...
MD_CRYPTO_30_LIBCV_3415_LOGICAL_OPERATOR:
Reason:     Volatile reads could have side-effects. Ihe right side of the logical operator may not get evaluated and therefore doesn't produce the side-effect.
Risk:       None, as no registers with side-effects are read.
Prevention: Covered by code review.
...
\DESCRIPTION    The caller provides the length of the workspace and the respective objectId as a parameter.
\COUNTERMEASURE \N The objectId is provided as a function parameter to the caller. The caller requires it to be within the array boundaries.
...
\ID SBSW_CRYPTO_30_LIBCV_CALL_WITH_STACK_WORKSPACE
\DESCRIPTION The function is called with a pointer pointing to a workspace located on the stack within the caller function.
...
\COUNTERMEASURE \N Either the sizes of the buffers are given in the call or the sizes are according to the callee requirements.
                   The caller requires the workspace to be valid, therefore it can be safely assumed that the workspace and its members is valid.

\ID SBSW_CRYPTO_30_LIBCV_FORWARDING_WORKSPACE_MEMBER
\DESCRIPTION The function is called with pointers pointing to workspace members. The workspace itself is given as parameter to the caller.
\COUNTERMEASURE \N Either the sizes of the workspace members are given in the call or the sizes are according to the callee requirements. It is assumed that the workspace given as parameter to the caller are valid.
...
\DESCRIPTION The esl library is called with a pointer to a workspace and one (or multiple) pointer to a key buffer is provided with a size which is equal or smaller than the provided buffer.
\COUNTERMEASURE \N The caller requires the workspace to be valid, therefore it can be safely assumed that the workspace is valid.
The pointers to the key buffers are ensured to be valid by the caller.
...
\ID SBSW_CRYPTO_30_LIBCV_ESL_PARAMETER_WORKSPACE
\DESCRIPTION The esl library is called with a pointer to the workspace, which is provided to the caller as parameter.
\COUNTERMEASURE \N The caller requires the workspace to be valid, therefore it can be safely assumed that the workspace and the workspace header are valid.
...
\ID SBSW_CRYPTO_30_LIBCV_DOMAIN_PTR_AS_PARAM
\DESCRIPTION The function is called and one (or more) domain pointer to a const buffer provided as parameters is forwarded.
The const buffer provides domain parameters of a specific elliptic curve.
The domain parameters are provided in a known structure (ASN1 structure for EC domain parameters) where the size of the buffer
can be determined from a known field in the structure itself.
\COUNTERMEASURE \N The caller requires the provided domain pointer and the domain parameters to be valid.
Therefore it can be safely assumed that the domain pointer and the domain parameters are valid.
Thus, the length of the const buffer can be determined by the callee from a known field from the structure itself.

\ID SBSW_CRYPTO_30_LIBCV_DOMAIN_PTR
\DESCRIPTION The function is called and one (or more) domain pointer to a const buffer is forwarded.
The const buffer provides domain parameters of a specific elliptic curve.
The domain parameters are provided in a known structure (ASN1 structure for EC domain parameters) where the size of the buffer
can be determined from a known field in the structure itself.
\COUNTERMEASURE \N The function implementation itself guarantees that the domain pointer and the domain parameters are valid.
Thus, the length of the const buffer can be determined by the callee from a known field from the structure itself.
...
\ID SBSW_CRYPTO_30_LIBCV_CALL_WORKSPACE_STACK_WITH_STACK_BUFFERS_AND_PTR_AS_PARAMETER
\DESCRIPTION  A function is called and a pointer to a workspace is forwarded which is located on the stack.
Other parameters are located on the stack and have the same size as expected from the called API.
In addition, there is one pointer which is already given as parameter to the calling function.
\COUNTERMEASURE \N  [CM_CRYPTO_30_LIBCV_WORKSPACE_STACK]
[CM_CRYPTO_30_LIBCV_STACK_ARRAY_WITHOUT_SIZE]
...
\ID SBSW_CRYPTO_30_LIBCV_CALL_WITH_KEYPTR_AND_LENGTH
\DESCRIPTION A pointer to a key buffer is given to the callee with its actual length.
\COUNTERMEASURE \R The key pointer points to a valid key buffer and the length was determined and
checked by Crypto_30_LibCv_Local_KeyElementGetStorageIndexJob.
...
\DESCRIPTION Access of WrittenLength, BufferLength, DriverObjectState, QueuePrimitiveInfoIdx, ProcessJob_Trigger_Write, Redirect_Buffer and Lock using ComStackLib. The GetSizeOf-check is performed in one of the global APIs Crypto_30_LibCv_CancelJob, Crypto_30_LibCv_ProcessJob or Crypto_30_LibCv_MainFunction.
\COUNTERMEASURE \N Qualified use case CSL01 of ComStackLib.
...
\ID SBSW_CRYPTO_30_LIBCV_VOLATILE_KEY_STORAGE_VIA_KEY_ELEMENT
\DESCRIPTION Access of KeyStorage via volatile pointer. Pointer is set using ComStackLib (via indirection over keyElement).
\COUNTERMEASURE \N Setting of pointer is done via indirection using ComStackLib. Access of data is done through unmodified pointer.
...
\ID SBSW_CRYPTO_30_LIBCV_INIT_ESL_WORKSPACE_PARAMETER
\DESCRIPTION The function esl_initWorkSpaceHeader is called with a pointer to the workspace header, a size and a function pointer. The workspace is provided to the caller as parameter.
\COUNTERMEASURE \N The caller requires the workspace to be valid, therefore it can be safely assumed that the workspace and the workspace header are valid.
                   The function pointer is a static generated value and therefore it can be assumed that it is valid.
...
\ID SBSW_CRYPTO_30_LIBCV_ESL_CALL_WITH_WORKSPACE_AND_PARAMETER_BUFFER
\DESCRIPTION The esl library is called with a pointer to a workspace,
a pointer to a buffer provided to the caller via parameter and a length denoting the length of the buffer.
\COUNTERMEASURE \N  The caller requires the workspace to be valid, therefore it can be safely assumed that the workspace is valid.
                    The caller requires the buffer to be valid, therefore it can be safely assumed that the buffer is valid during the call.

\ID SBSW_CRYPTO_30_LIBCV_ESL_CALL_WITH_WORKSPACE_AND_CONST_BUFFER
\DESCRIPTION The esl library is called with a pointer to a workspace,
a pointer to one or multiple const buffers and a length denoting the length of the buffers.
\COUNTERMEASURE \N  The caller requires the workspace to be valid, therefore it can be safely assumed that the workspace is valid.
                    As the const buffers are constant, they cannot be written to, making them irrelevant for this analysis.

\ID SBSW_CRYPTO_30_LIBCV_ESL_CALL_WITH_WORKSPACE_AND_CONST_BUFFER_AND_PARAMETER_BUFFER
\DESCRIPTION The esl library is called with a pointer to a workspace,
a pointer to one or multiple const buffer, a length denoting the length of the const buffers,
a pointer to one or multiple buffers provided to the caller via parameter and a length denoting the length of the buffers.
\COUNTERMEASURE \N  The caller requires the workspace to be valid, therefore it can be safely assumed that the workspace is valid.
                    As the const buffers are constant, they cannot be written to, making them irrelevant for this analysis.
                    The caller requires the parameter buffers to be valid, therefore it can be safely assumed that they are valid during the call.
                    The caller also provides the length of the parameter buffers as required by the API of the callee.

\ID SBSW_CRYPTO_30_LIBCV_ESL_CALL_WITH_WORKSPACE_AND_CONST_BUFFER_AND_STACK_BUFFER
\DESCRIPTION The esl library is called with a pointer to a workspace,
a pointer to one or multiple const buffer, a length denoting the length of the const buffers,
a pointer to one or multiple stack buffers provided located on the stack and a length denoting the length of the buffers.
\COUNTERMEASURE \N  The caller requires the workspace to be valid, therefore it can be safely assumed that the workspace is valid.
                    As the const buffers are constant, they cannot be written to, making them irrelevant for this analysis.
                    The caller creates the stack buffers before and ensures their validity.
                    The caller also provides the length of the stack buffers as required by the API of the callee.
...
\DESCRIPTION The pointers of workspace and job are forwarded.
The workspace pointer points to a workspace provided by ComStackLibrary via Indirection over ObjectId.
A pointer to a const buffer is passed to the called function.
\COUNTERMEASURE \N [CM_CRYPTO_30_LIBCV_WORKSPACE_VIA_COMSTACKLIB_RUNTIME]
The job pointer is forwarded and assumed to be valid.
As the const buffer is constant, it cannot be written to, making them irrelevant for this analysis.
...
\ID SBSW_CRYPTO_30_LIBCV_FORWARDING_OF_JOB_AND_GLOBAL_ARRAY_PTR
\DESCRIPTION The call is only forwarded and has as parameter a pointer to a job and a pointer to a global
array located in data segment.
\COUNTERMEASURE \N The job pointer is forwarded and assumed to be valid. For the pointer to a global array
the static size of the array is used as upper bound and therefore no illegal access is done.

\ID SBSW_CRYPTO_30_LIBCV_CALL_WITH_GLOBAL_WORKSPACE_AND_CONST_BUFFER
\DESCRIPTION A function is called with a pointer to a workspace, which is provided by ComStackLibrary via Indirection over ObjectId,
and a pointer to one or multiple const buffers.
\COUNTERMEASURE \N  [CM_CRYPTO_30_LIBCV_WORKSPACE_VIA_COMSTACKLIB_RUNTIME]
As the const buffers are constant, they cannot be written to, making them irrelevant for this analysis.

\ID SBSW_CRYPTO_30_LIBCV_CALL_WITH_GLOBAL_WORKSPACE_AND_JOB_BUFFER
\DESCRIPTION A function is called with a pointer to a workspace, which is provided by ComStackLibrary via Indirection over ObjectId,
and pointers pointing to workspace members.
\COUNTERMEASURE \N [CM_CRYPTO_30_LIBCV_WORKSPACE_VIA_COMSTACKLIB_RUNTIME]
[CM_CRYPTO_30_LIBCV_JOB_INPUT_OUTPUT_BUFFERS_RUNTIME]

\ID SBSW_CRYPTO_30_LIBCV_VARIABLE_ACCESS_PTR_FROM_STACK
...
\COUNTERMEASURE \S SMI-863486 ensures, that the NvM block length is as expected from the component. Therefore read and write access is within correct boundaries.

\ID SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_AND_ACCESS_TO_NVBUFFER
\DESCRIPTION A pointer to a stack variable is forwarded and a NvBuffer is forwarded and accessed without a length given to the service.
\COUNTERMEASURE \S  SMI-863486 ensures, that the NvM block length is as expected from the component. Therefore read and write access is within correct boundaries.
                    Stack pointer assumed to be valid, pointer to NvM block is forwarded by the caller and assumed to be valid.

\ID SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_AND_KEYSTORE_BUFFER
\DESCRIPTION The function is called with pointers pointing to stack and keystorage buffers.
\COUNTERMEASURE \N Either the sizes of the buffers are given in the call or the the caller ensures that the sizes are according to the callee requirements.

\ID SBSW_CRYPTO_30_LIBCV_WRITE_PARTITION_DATA
\DESCRIPTION Write of Partition specific data using ComStackLib.
\COUNTERMEASURE \N The index for the Partition specific data is either fixed (for single partition usecase) or provided by searching the current application id
...
/* COV_JUSTIFICATION_BEGIN
 ...
 \ID COV_CRYPTO_30_LIBCV_ECDSA_PREHASHING_ENABLED
 \ACCEPT TF
 \ACCEPT TX
 \ACCEPT XF
 \REASON The result of the check depends of the ECDSA configuration. In a configuration where only curve SECp521r1 is supported, the ECDSA is always used together with SHA512 prehashing and thus,
         the algorithm secondary family is always set.
 ...
 \ID COV_CRYPTO_30_LIBCV_BINARYSEARCH
 \ACCEPT TX
 \REASON This check can never be false, as the searched list is generated as an ordered list without gaps.
         Consequently, the used binary search algorithm will always find the searched entry if the list was generated correctly,
         and the check will never be false.

\ID COV_CRYPTO_30_LIBCV_USER_DEFINES
 \ACCEPT TX
 \ACCEPT XF
 \REASON Ifndef is present for redefinition prevention. This allows the user or CSM to override this value
         while also ensuring that the constant is present if the user or CSM does not override it.
 ...
 *********************************************************************************************************************/
 ...
 \ID FETA_CRYPTO_30_LIBCV_MONOTONIC_LOOP_UP_WITH_UNCHANGED_BOUNDS_STATIC_GENDATA
 \DESCRIPTION Loop bounds are determined by static GenData which is accessed via ComStackLib.
 \COUNTERMEASURE \N The here applied loop uses variables as lower and upper bound which are set via a ComStackLib macro
                    and remain unchanged during loop execution. The lower bound variable is guaranteed to be less
                    than or equal to the upper bound variable. The loop's type of the counter variable is appropriate
                    for the loop's type of lower and upper bound determining variables as it is an iteration type suitable for the
                    used CSL indirection. The counter variable is increased once within each single loop iteration (strictly monotonically increasing)
 ...
 \ID FETA_CRYPTO_30_LIBCV_MONOTONIC_LOOP_UP_WITH_UNCHANGED_UPPER_BOUND_STATIC_GENDATA
 \DESCRIPTION Loop upper bound is determined by static GenData which is accessed via ComStackLib.
 \COUNTERMEASURE \N The here applied loop uses a variables as upper bound which is set via a ComStackLib macro
                    and remains unchanged during loop execution. The loop's type of the counter variable is appropriate
                    for the loop's type of lower and upper bound determining variables as it is an iteration type suitable for the
                    used CSL indirection. The counter variable is increased once within each single loop iteration (strictly monotonically increasing)
                    until it reaches a value that makes the loop stop without any occurrences of overflows. This
                    is done by a comparison used as loop termination condition that considers the amount of the
 ...
 \ID FETA_CRYPTO_30_LIBCV_MONOTONIC_LOOP_UP_WITH_PARAMETER_DEPENDENT_UPPER_BOUND_WITH_CHECK
 \DESCRIPTION Loop upper bound is determined by a constant parameter which is passed to the function.
 \COUNTERMEASURE \R The caller ensures correctness of the parameter by checking it for boundary conditions
                    described in the function doxygen comment.
                    [CM_CRYPTO_LIBCV_FOR_LOOP_WITH_NON_CHANGING_UPPER_BOUND]

 \ID FETA_CRYPTO_30_LIBCV_MONOTONIC_LOOP_UP_WITH_PARAMETER_DEPENDENT_UPPER_BOUND_PTR
 \DESCRIPTION Loop upper bound is determined by a pointer parameter which is passed to the function.
 \COUNTERMEASURE \N [CM_CRYPTO_LIBCV_FOR_LOOP_WITH_NON_CHANGING_UPPER_BOUND]

 \ID FETA_CRYPTO_30_LIBCV_MONOTONIC_LOOP_UP_WITH_PARAMETER_DEPENDENT_UPPER_BOUND
 \DESCRIPTION Loop upper bound is determined by a constant parameter which is passed to the function.
 \COUNTERMEASURE \N [CM_CRYPTO_LIBCV_FOR_LOOP_WITH_NON_CHANGING_UPPER_BOUND]

 \ID FETA_CRYPTO_30_LIBCV_BINARY_SEARCH
 \DESCRIPTION While loop which is used for a binary search of a cryptoKeyId via its elementIndex.
 \COUNTERMEASURE \N The here applied while loop is controlled by a comparison of the variables minKey and maxKey,
                    which are of the same type.
                    Within each single loop execution:
                       - the value of variable middleKey, which is of an appropriate type, is calculated and then it is: minKey <= middleKey < maxKey,
                       - Then
                         - either maxKey becomes middleKey, so right decreases
                         - or minKey becomes (middleKey + 1), so left increases
                         - or keyFound becomes TRUE which makes the loop stop by a call of break
                         So with each single loop the difference (maxKey - minKey) becomes smaller (strictly monotonically decreasing) and
                         the loop will finally stop after a maximum of (maxKey - minKey) loop executions.

 \CM CM_CRYPTO_LIBCV_FOR_LOOP_WITH_NON_CHANGING_UPPER_BOUND
    The loop's type of the counter variable is appropriate for the loop's type of upper bound
    variable as it is the same type as the bound determining variables. The upper bound remains unchanged during loop execution.
    The counter variable is increased once within each single loop iteration (strictly monotonically increasing)
    until it reaches a value that makes the loop stop without any occurrences of overflows. This
    is done by a comparison used as loop termination condition that considers the amount of the
    increment that is applied within each single loop.
