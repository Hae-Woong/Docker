 ...
 *  12.00.00  2022-05-16  visenc     SEC-4482      Support of ECDSA secp521r1 with SHA2-512
 *            2022-09-01  viseag     SEC-4863      Support of AES-192
 *            2022-10-24  viskju     ESCAN00111536 Missing validation can lead to undefined behavior
 *                                   ESCAN00111597 Missing Partial Access Limitation
 *                                   ESCAN00111639 Algorithm message length limitation too strict
 *  12.01.00  2022-11-11  viskju     HSM-3249      Support of ECDHE secp521r1
 *                                   HSM-3317      Provide APIs for redirection for Hwa Use-Case
 *                                   HSM-3096      Support SHA-3 and SHAKE according to FIPS 202
 *                                   ESCAN00113238 Redirection will provide wrong data in output key element for Encrypt, Decrypt, Aead Encrypt and Aead Decrypt
 *                                   ESCAN00113241 Undefined behavior after restoring context of job with configured redirection
 *                                   ESCAN00113214 RSA PKCS1 decryption fails after restore
 *                                   ESCAN00113213 RSA PSS signature verification fails after restore
 *  12.02.00  2023-01-24  viskju     HSM-3086      Support of HKDF HMAC SHA384
 *                                   HSM-3703      FETA Analysis
 *  12.03.00  2023-03-15  viskju     HSM-3819      Support HKDF HASH Option 1 Sha-512
 *                                   ESCAN00114135 RSA signature verification job with invalid input data returns unexpectedly with E_NOT_OK
 *  12.04.00  2023-04-03  viskju     HSM-3826      Support ISO-15118-20 Key Derivation for P521
 *                                   ESCAN00114495 CMAC generation or verification produces the wrong output
 *                                   ESCAN00114531 CMAC generation or verification fails unexpectedly
 *  13.00.00  2023-04-13  viskju     HSM-3728      Support multicore with shared memory
 *                                   ESCAN00114693 Invalid sequence of asynchronous jobs leads to blockage of queue
 *  13.01.00  2023-06-06  viskju     HSM-4098      Support X448/ECDH based on curve Edwards448
 *                                   HSM-3956      Harmonize Crypto_JobType usage to ASR 21-11
 *                                   HSM-4090      Support ISO-15118-20 Key Derivation for ED448
 *                                   HSM-4390      Rework InitMemory for LibCv
 *                        coechsler  SEC-6446      Support Ed448 Signature generation and verification, support Ed25519 context mode
 *                                   SEC-6572      Use NvM defines for service identification
 *  13.02.00  2023-07-31  coechsler  SEC-6310      Support HMAC with SHA2-512 generation and verification
 *                                   SEC-6306      Support HKDF Expand SHA2-256 and SHA2-384
 *                                   SEC-6683      Support IsKeyOnCurve for P160R1, P256R1, P384R1, P521R1
 *  13.03.00  2023-08-21  coechsler  SEC-6734      Support IsKeyOnCurve for Ed25519 and Ed448
 *                                   SEC-6768      Support ECBD KeyExchange based on P256R1
 *                                   ESCAN00115701 Missing length check for AES GCM Decrypt Authentication Tag
 *  13.04.00  2023-10-04  viskju     HSM-4583      Support for secp521r1 Key Generation
 *  13.04.01  2023-10-16  viskju     ESCAN00115928 For ChaCha20-Poly1305-Crypto jobs in finish mode the outputLength is not updated
 *  13.05.00  2023-10-27  coechsler  CRY-418       Support ECDHE with x-coordinate shared secret only
 *  13.05.01  2024-01-05  coechsler  ESCAN00116209 Added length check of CRYPTO_KE_RANDOM_SEED_STATE in DRBG
 *                                   ESCAN00116431 Support ECBD with x-coordinate shared secret only
 *  13.06.00  2024-01-16  coechsler  CRY-58        Support SLH-DSA SHA2-128s Verify
 *                                   CRY-391       Support SM4 Cipher Encrypt/Decrypt
 *                                   CRY-389       Support SM3 Hash
 *                                   CRY-395       Support SM2 Signature Generate/Verify
 *  14.00.00  2024-03-15  coechsler  CRY-759       Support AES GCM variable tag length
 *                                   ESCAN00117009 Declaration after statement in C90 dialect
 *********************************************************************************************************************/
...
# define CRYPTO_30_LIBCV_MAJOR_VERSION                                (14u)
# define CRYPTO_30_LIBCV_MINOR_VERSION                                (0u)
...
# ifndef CRYPTO_30_LIBCV_JOB_ID_MEMBER /* COV_CRYPTO_30_LIBCV_ASR_COMPATIBILITY */
#  define CRYPTO_30_LIBCV_JOB_ID_MEMBER                               jobId
# endif
 ...
 *  \details     This function initializes the module Crypto_30_LibCv. It initializes all variables relevant for the
 *               partition and sets the module state for the partition to initialized. It has to be called once from
 *               the main partition and also from each other partition where the module is used.
 ...
 *                                         If multi-partition support is enabled, only the objectId which belongs to
 *                                         the calling partition is allowed to be used.
 ...
 *  \pre           -
 *  \context       TASK
 *  \reentrant     TRUE, for jobs with different job ids
...
/**********************************************************************************************************************
 *  Crypto_30_LibCv_MainFunction<_OS_APPLICATION>()
 *********************************************************************************************************************/
 ...
 *                 <_OS_APPLICATION> is only used if module is used by multiple partitions.
 *  \pre           -
 *  \context       TASK
 *  \reentrant     FALSE
 *  \synchronous   TRUE
 ...
 * Ensures consistency of common global RAM variables.
 * \protects Crypto_30_LibCv_Lock, Crypto_30_LibCv_LastJob, Crypto_30_LibCv_Queue, Crypto_30_LibCv_NvBlock_State, Crypto_30_LibCv_RandomSourceGenerateCount
 * \usedin Crypto_30_LibCv_MainFunction, Crypto_30_LibCv_ProcessJob, Crypto_30_LibCv_CancelJob, Crypto_30_LibCv_KeyValidSet, Crypto_30_LibCv_KeyDerive, Crypto_30_LibCv_RandomSeed, esl_getBytesRNG, Crypto_30_LibCv_NvBlock_Callback and Crypto_30_LibCv_NvBlock_WriteToBlock.
 * \exclude All functions in which this exclusive area is used in.
 * \length LONG in esl_getBytesRNG, SHORT in rest.
 * \endexclusivearea

 * \exclusivearea CRYPTO_30_LIBCV_EXCLUSIVE_AREA_1
 * Ensures consistency of global RAM variables used for key locking.
 * \protects Crypto_30_LibCv_KeyLock
 * \usedin Crypto_30_LibCv_MainFunction, Crypto_30_LibCv_ProcessJob, Crypto_30_LibCv_CancelJob, Crypto_30_LibCv_KeyExchangeCalcPubVal, Crypto_30_LibCv_KeyExchangeCalcSecret, Crypto_30_LibCv_KeyGenerate, Crypto_30_LibCv_KeyElementSet, Crypto_30_LibCv_KeyValidSet, Crypto_30_LibCv_KeyElementGet, Crypto_30_LibCv_KeyCopy, Crypto_30_LibCv_KeyElementCopy, Crypto_30_LibCv_KeyElementCopyPartial, Crypto_30_LibCv_KeyDerive, Crypto_30_LibCv_RandomSeed
 * \exclude All functions in which this exclusive area is used in.
 * \length MEDIUM as runtime depends on number of to be locked keys.
 * \endexclusivearea

 * \exclusivearea CRYPTO_30_LIBCV_EXCLUSIVE_AREA_2
 * Ensures consistency of global RAM variables used for the primitives Spake2+ and ECBD.
 * \protects Crypto_30_LibCv_LongTermWsLock
 * \usedin Crypto_30_LibCv_MainFunction, Crypto_30_LibCv_ProcessJob, Crypto_30_LibCv_KeyExchangeCalcPubVal, Crypto_30_LibCv_KeyExchangeCalcSecret
 * \exclude All functions in which this exclusive area is used in.
