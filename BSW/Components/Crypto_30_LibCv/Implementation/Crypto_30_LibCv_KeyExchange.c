 ...
 **********************************************************************************************************************/
/*! \brief         Calculation of the secret for Spake2+
 *  \details       Depending on the state either secret is calculation or key confirmation is executed.
 *  \param[in]     cryptoKeyId              Holds the identifier of the key which shall be used for the key exchange
 *                                          protocol.
 *  \param[in]     partnerPublicValuePtr    Holds the pointer to the memory location which contains the partners
...
/**********************************************************************************************************************
 *  Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_X448()
 *********************************************************************************************************************/
/*! \brief         Calculation of the public value for x448
 *  \details       Calculates the public value for the key exchange and stores the public key in the
 *                 memory location pointed to by the public value pointer. The write access right for the destination
 *                 key element must be less than or equal to WA_INTERNAL_COPY.
 *  \param[in]     cryptoKeyId             Holds the identifier of the key which shall be used for the key exchange
 ...
 *  \synchronous   TRUE
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_LOCAL_INLINE FUNC(Std_ReturnType, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_X448(
  uint32 cryptoKeyId,
  P2VAR(uint8, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) publicValuePtr,
  P2VAR(uint32, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) publicValueLengthPtr);
...
# if (CRYPTO_30_LIBCV_KEY_EXCHANGE_ECBD_ENABLED == STD_ON)
/**********************************************************************************************************************
 *  Crypto_30_LibCv_Local_KeyExchange_CheckDomainKeyLengths()
 *********************************************************************************************************************/
/*! \brief         Check of the domain key lengths
 *  \details       Checks if the private and public key lengths provided by the domain parameters are equal to the given expected values.
 ...
 *  \return        E_OK                           Request successful.
 *                 E_NOT_OK                       Request failed.
 *  \pre           EcDomainPtr has to be a valid pointer pointing to valid domain parameters.
 *  \context       TASK
 *  \reentrant     TRUE, for different crypto keys
 *  \synchronous   TRUE
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_LOCAL_INLINE FUNC(Std_ReturnType, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_KeyExchange_CheckDomainKeyLengths(
  P2CONST(eslt_EccDomain, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) EcDomainPtr,
  const uint32 expectedPrivateKeyLength,
  const uint32 expectedPublicKeyLength);

/**********************************************************************************************************************
 *  Crypto_30_LibCv_Local_KeyExchangeCalcSecret_BD_CheckDomainKeyLengthsAndProcessCalc()
 *********************************************************************************************************************/
/*! \brief         Calculation of the secret
 *  \details       Checks the key length length provided by the domain. If lengths are ok, the given parameters are
 *                 forwarded to the KeyExchangeCalcSecret_BD_Prime function calculating the secret.
 *  \param[in]     cryptoKeyId                    Holds the identifier of the key which shall be used for the key exchange
 *                                                protocol.
 ...
 *                 E_NOT_OK                       Request failed.
 *  \pre           cryptoKeyId has to be a valid crypto key.
 *                 partnerIntermediateValuePtr has to be a valid pointer with size (1 + CRYPTO_30_LIBCV_SIZEOF_ECC_..._KEY_PUBLIC_XY).
 *                 EcDomainPtr has to be a valid pointer pointing to valid domain parameters.
 *  \context       TASK
 *  \reentrant     TRUE, for different crypto keys
 *  \synchronous   TRUE
 *  \trace         DSGN-DrvCrypto_Libcv_ECBD
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_LOCAL_INLINE FUNC(Std_ReturnType, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_KeyExchangeCalcSecret_BD_CheckDomainKeyLengthsAndProcessCalc(
  uint32 cryptoKeyId,
 ...
 *  \return        E_OK                           Request successful.
 *                 E_NOT_OK                       Request failed.
 *  \pre           wsPtr has to be a valid pointer.
 *                 partnerIntermediateValuePtr has to be a valid pointer with size (1 + CRYPTO_30_LIBCV_SIZEOF_ECC_..._KEY_PUBLIC_XY).
 *                 EcDomainPtr has to be a valid pointer pointing to valid domain parameters.
 *  \context       TASK
 *  \reentrant     TRUE, for different workspaces
 ...
 *                 E_NOT_OK         Request failed.
 *  \pre           wsPtr has to be a valid pointer.
 *                 cryptoKeyId has to be a valid crypto key.
 *                 EcDomainPtr has to be a valid pointer pointing to valid domain parameters.
 *  \context       TASK
 *  \reentrant     TRUE, for different workspaces
 *  \synchronous   TRUE
...
CRYPTO_30_LIBCV_LOCAL_INLINE FUNC(Std_ReturnType, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_KeyExchangeCalcSecret_BD_Prime_Finish(
  ...
  uint32 cryptoKeyId,
  P2CONST(eslt_EccDomain, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) EcDomainPtr);
# endif /* (CRYPTO_30_LIBCV_KEY_EXCHANGE_ECBD_ENABLED == STD_ON) */
 ...
 *  \synchronous   TRUE
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_LOCAL FUNC(Std_ReturnType, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_KeyExchangeCalcSecret_X25519_Calculate(
  uint32 cryptoKeyId,
  P2CONST(uint8, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) partnerPublicValuePtr,
  P2VAR(eslt_WorkSpaceX25519, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) wsX25519);
 ...
 *********************************************************************************************************************/
/*! \brief         Calculation of the secret
 *  \details       After initializing the workspace, the private key is loaded and the secret is calculated.
 *  \param[in]     cryptoKeyId             Holds the identifier of the key which shall be used for the key exchange
 *                                         protocol.
 *  \param[in]     partnerPublicValuePtr   Holds the pointer to the memory location which contains the partners
 *                                         public value.
...
# if (CRYPTO_30_LIBCV_KEY_EXCHANGE_ALGORITHM_X448_ENABLED == STD_ON)
/**********************************************************************************************************************
 *  Crypto_30_LibCv_Local_KeyExchangeCalcSecret_X448()
 *********************************************************************************************************************/
/*! \brief         Calculation of the secret
 *  \details       Calculates the shared secret key for the key exchange with the key material of the key identified
 *                 by the cryptoKeyId and the partner public key. The shared secret key is stored
 ...
 *                 CRYPTO_E_BUSY           Request failed, Crypto Driver Object is busy.
 *  \pre           cryptoKeyId has to be a valid crypto key.
 *                 partnerPublicValuePtr has to be a valid pointer with size ESL_SIZEOF_X448_PUBLIC_KEY.
 *  \context       TASK
 *  \reentrant     TRUE, for different crypto keys
 *  \synchronous   TRUE
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_LOCAL_INLINE FUNC(Std_ReturnType, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_KeyExchangeCalcSecret_X448(
  uint32 cryptoKeyId,
  P2CONST(uint8, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) partnerPublicValuePtr);

/**********************************************************************************************************************
 *  Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_X448_With_Ws()
 *********************************************************************************************************************/
/*! \brief         Calculation of the public value for x448
 *  \details       Calculates the public value for the key exchange and stores the public key in the
 *                 memory location pointed to by the public value pointer. The write access right for the destination
 ...
 *                                         contain the size of the buffer provided by publicValuePtr. When the request
 *                                         has finished, the actual length of the returned value shall be stored.
 *  \param[in,out] wsX448                  Contains the workspace.
 *  \return        E_OK                    Request successful.
 *                 E_NOT_OK                Request failed.
 *                 CRYPTO_E_BUSY           Request failed, Crypto Driver Object is busy.
 *                 CRYPTO_E_SMALL_BUFFER   Request failed, the provided buffer is too small to store the result.
 ...
 *  \synchronous   TRUE
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_LOCAL FUNC(Std_ReturnType, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_X448_With_Ws(
  uint32 cryptoKeyId,
  P2VAR(uint8, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) publicValuePtr,
  P2VAR(uint32, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) publicValueLengthPtr,
  P2VAR(eslt_WorkSpaceEdDH, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) wsX448);
 ...
 *  \synchronous   TRUE
 *********************************************************************************************************************/
CRYPTO_30_LIBCV_LOCAL FUNC(Std_ReturnType, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_KeyExchangeCalcSecret_X448_With_Ws(
  uint32 cryptoKeyId,
  P2CONST(uint8, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) partnerPublicValuePtr,
  P2VAR(eslt_WorkSpaceEdDH, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) wsX448);
# endif /* (CRYPTO_30_LIBCV_KEY_EXCHANGE_ALGORITHM_X448_ENABLED == STD_ON) */
...
# if (CRYPTO_30_LIBCV_KEY_EXCHANGE_ECBD_ENABLED == STD_ON)
/**********************************************************************************************************************
 *  Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_BD_CheckDomainKeyLengthsAndProcessCalc()
 *********************************************************************************************************************/
/*! \brief         Calculation of the public key
 *  \details       Checks the key length length provided by the domain. If lengths are ok, the given parameters are
 *                 forwarded to the KeyExchangeCalcPubVal_BD_Prime function calculating the public key.
 *  \param[in]     cryptoKeyId               Holds the identifier of the key which shall be used for the key exchange
 *                                           protocol.
 *  \param[out]    publicValuePtr            Contains the pointer to the data where the public value shall be stored.
 *  \param[in,out] publicValueLengthPtr      Holds a pointer to the memory location in which the public value length
 ...
 *                 E_NOT_OK                  Request failed.
 *  \pre           cryptoKeyId has to be a valid crypto key.
 *                 publicValuePtr need to be valid and have at least the length of publicValueLengthPtr.
 *                 all domain pointers have to be valid pointing to valid domain parameters.
 *  \context       TASK
 *  \reentrant     TRUE
 *  \synchronous   TRUE
 *  \trace         DSGN-DrvCrypto_Libcv_ECBD
  *********************************************************************************************************************/
CRYPTO_30_LIBCV_LOCAL_INLINE FUNC(Std_ReturnType, CRYPTO_30_LIBCV_CODE) Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_BD_CheckDomainKeyLengthsAndProcessCalc(
  uint32 cryptoKeyId,
  P2VAR(uint8, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) publicValuePtr,
  P2VAR(uint32, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) publicValueLengthPtr,
  P2CONST(eslt_EccDomain, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) EcDomainPtr,
 ...
 *  \return        E_OK                    Request successful.
 *                 E_NOT_OK                Request failed.
 *  \pre           wsPtr and StorageIndexPtr have to be valid pointers.
 *                 cryptoKeyId has to be a valid crypto key.
 *                 all domain pointers need to be valid pointing to valid domain parameters.
 *  \context       TASK
 ...
 *  \pre           wsPtr has to be a valid pointer.
 *                 cryptoKeyId has to be a valid crypto key.
 *                 publicValuePtr need to need to be valid and have at least the length of publicValueLengthPtr.
 *                 EcDomainPtr need to be valid pointing to valid domain parameters.
 *  \context       TASK
 *  \reentrant     TRUE, true for different workspaces.
 *  \synchronous   TRUE
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
/*! \brief         Dispatch public value generation.
 ...
 *                 CRYPTO_E_SMALL_BUFFER   Request failed, the provided buffer is too small to store the result.
 *  \pre           cryptoKeyId has to be a valid crypto key.
 *                 publicValuePtr need to have at least the length of publicValueLengthPtr.
 *                 all domain pointers need to be valid pointing to valid domain parameters.
 *  \context       TASK
 *  \reentrant     TRUE
 *  \synchronous   TRUE
 ...
 *  \return         E_OK                    Request successful.
 *                  E_NOT_OK                Request failed.
 *  \pre            privateKeyPtr has to be a valid pointer with a valid length.
 *                  partnerPubKeyPtr has to be a valid pointer with a valid length.
  ...
  Std_ReturnType infoElementRetVal)
{
  ...
  if (infoElementRetVal == E_OK)
  {
    ...
    if (aLength != 0u)
    {
      aPtr = (P2CONST(eslt_Byte, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR))&infoPtr[dataPos];
    }
    ...
    if (bLength != 0u)
    {
      bPtr = (P2CONST(eslt_Byte, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR))&infoPtr[dataPos];
    }
    ...
    if (aadLength != 0u)
    {
      aadPtr = (P2CONST(eslt_Byte, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR))&infoPtr[dataPos];
    }
  ...
  uint32 partnerPublicValueLength)
{
  ...
  /* Calc Secret */
  if (((Crypto_30_LibCv_Math_Mul2((uint32)CRYPTO_30_LIBCV_SIZEOF_ECC_256_KEY_PUBLIC)) == partnerPublicValueLength) && (localRetVal == E_OK))
  {
...
{
  /* #10 Init Workspace */
  eslt_WorkSpaceEdDH localWsX448;

  /* #20 Call Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_X448_With_Ws */
  return Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_X448_With_Ws(cryptoKeyId, publicValuePtr, publicValueLengthPtr, &localWsX448); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
} /* Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_X448() */
  ...
  P2VAR(eslt_WorkSpaceEdDH, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) wsX448)
{
  /* ----- Local Variables ------------------------------------------------ */
  Std_ReturnType retVal = E_NOT_OK;
  uint8 publicKeyBuf[ESL_SIZEOF_X448_PUBLIC_KEY];
  eslt_Length publicKeyLength = ESL_SIZEOF_X448_PUBLIC_KEY;
  uint8 privateKeyBuf[ESL_SIZEOF_X448_PRIVATE_KEY];
  eslt_Length privateKeyLength = ESL_SIZEOF_X448_PRIVATE_KEY;
  eslt_ErrorCode eslRet;
  Std_ReturnType retValKeyElementSetPrivateKey = E_NOT_OK;  /* PRQA S 2981 */ /* MD_MSR_RetVal */
  Std_ReturnType retValKeyElementSetPublicKey = E_NOT_OK;  /* PRQA S 2981 */ /* MD_MSR_RetVal */
  ...
  /* #20 Init Workspace */
  eslRet = esl_initWorkSpaceHeader((P2VAR(eslt_WorkSpaceHeader, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR))&wsX448->header, ESL_SIZEOF_WS_EDDH, CRYPTO_30_LIBCV_WATCHDOG_PTR); /* SBSW_CRYPTO_30_LIBCV_INIT_ESL_WORKSPACE_PARAMETER */

  if (eslRet == ESL_ERC_NO_ERROR)
  {
    eslRet = esl_initEdDH(wsX448, ESL_CURVE448); /* SBSW_CRYPTO_30_LIBCV_ESL_PARAMETER_WORKSPACE */
  }

  if (eslRet == ESL_ERC_NO_ERROR)
  {
    /* #25 Calculate Keys */
    if (esl_generateEphemeralKeyPairEdDH(wsX448, publicKeyBuf, &publicKeyLength, privateKeyBuf, &privateKeyLength) == ESL_ERC_NO_ERROR) /* SBSW_CRYPTO_30_LIBCV_ESL_CALL_WITH_WORKSPACE_AND_PARAMETER_BUFFER */
    {
      /* #30 Store public and private key to key elements if calculation was successful */
      retValKeyElementSetPrivateKey = Crypto_30_LibCv_Local_KeyElementSet(cryptoKeyId, CRYPTO_KE_KEYEXCHANGE_PRIVKEY, (P2VAR(uint8, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR))privateKeyBuf, privateKeyLength); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_WORKSPACE_MEMBER */
      retValKeyElementSetPublicKey = Crypto_30_LibCv_Local_KeyElementSet(cryptoKeyId, CRYPTO_KE_KEYEXCHANGE_OWNPUBKEY, (P2VAR(uint8, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR))publicKeyBuf, publicKeyLength); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_BUFFER */
    }
      ...
      (retValKeyElementSetPublicKey == E_OK))
    {
      /* #35 Copy public key to output buffer and overwrite local copy if store key was successfully */
      /* [SWS_Crypto_00109] return public key */
      if (*publicValueLengthPtr >= ESL_SIZEOF_X448_PUBLIC_KEY)
      {

        Crypto_30_LibCv_CopyData(publicValuePtr, publicKeyBuf, ESL_SIZEOF_X448_PUBLIC_KEY); /* SBSW_CRYPTO_30_LIBCV_ARRAY_ACCESS_WITH_SIZE_CHECK */
        Crypto_30_LibCv_ClearData(publicKeyBuf, ESL_SIZEOF_X448_PUBLIC_KEY); /* SBSW_CRYPTO_30_LIBCV_ARRAY_ACCESS_WITH_SIZE_CHECK */
        Crypto_30_LibCv_ClearData(privateKeyBuf, ESL_SIZEOF_X448_PRIVATE_KEY); /* SBSW_CRYPTO_30_LIBCV_ARRAY_ACCESS_WITH_SIZE_CHECK */
        *publicValueLengthPtr = publicKeyLength; /* SBSW_CRYPTO_30_LIBCV_PTR_ACCESS_WITH_DET_CHECK */
        retVal = E_OK;
      }
      else
        /* #40 If buffer is too small return with error */
  ...
  P2CONST(eslt_EccDomain, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) EcDomainPtr)
{
  ...
  const uint32 publicKeyLength = esl_getLengthOfEcPpublicKey_comp(EcDomainPtr); /* SBSW_CRYPTO_30_LIBCV_DOMAIN_PTR_AS_PARAM */

  /*  predecessor = left neighbor / successor = right neighbor */
  uint32 keyLengthLeft = publicKeyLength * 2u;
  uint32 keyLengthRight = publicKeyLength * 2u;
  ...
  P2CONST(eslt_EccSpeedUpExt, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) EcSpeedUpExtPtr)
{
  ...
  uint8 privKey[CRYPTO_30_LIBCV_MAX_SIZEOF_PRIVATE_ECBD_KEY];
  uint8 publicKey[CRYPTO_30_LIBCV_MAX_SIZEOF_PUBLIC_ECBD_KEY_XY];

  const uint32 privateKeyLength = esl_getLengthOfEcPprivateKey(EcDomainPtr); /* SBSW_CRYPTO_30_LIBCV_DOMAIN_PTR_AS_PARAM */
  const uint32 publicKeyLength = esl_getLengthOfEcPpublicKey_comp(EcDomainPtr); /* SBSW_CRYPTO_30_LIBCV_DOMAIN_PTR_AS_PARAM */
  const uint32 publicKeyLengthXY = publicKeyLength * 2u;

  /* ----- Implementation ------------------------------------------------- */
  /* Init workspace */
  if (Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_BD_Prime_GenKeyPair_Init(wsPtr, cryptoKeyId, EcDomainPtr, EcDomainExtPtr, EcSpeedUpExtPtr) == E_OK) /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR_OF_WORKSPACE */
  {
    if (esl_generateEphemeralKeyPairECBD( /* SBSW_CRYPTO_30_LIBCV_ESL_CALL_WITH_WORKSPACE_AND_STACK_BUFFER */
      ...
      (P2VAR(eslt_Byte, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR))&(publicKey[publicKeyLength]))
      == ESL_ERC_NO_ERROR)
    {
    ...
    if (localRet == E_OK)
    {
      ...
      /* [SWS_Crypto_00109] return public key */
      if (*publicValueLengthPtr >= publicKeyLengthXY)
      {
        Crypto_30_LibCv_CopyData(publicValuePtr, publicKey, publicKeyLengthXY); /* PRQA S 0315 */ /* MD_MSR_VStdLibCopy */ /* SBSW_CRYPTO_30_LIBCV_PTR_ACCESS */
        *publicValueLengthPtr = publicKeyLengthXY; /* SBSW_CRYPTO_30_LIBCV_PTR_ACCESS */
      ...
      /* delete buffer content from RAM */
      Crypto_30_LibCv_ClearData(privKey, privateKeyLength); /* PRQA S 0315 */ /* MD_MSR_VStdLibCopy */ /* SBSW_CRYPTO_30_LIBCV_STACK_ARRAY_ACCESS_WITH_SIZE */
      Crypto_30_LibCv_ClearData(publicKey, publicKeyLengthXY); /* PRQA S 0315 */ /* MD_MSR_VStdLibCopy */ /* SBSW_CRYPTO_30_LIBCV_STACK_ARRAY_ACCESS_WITH_SIZE */
    }
  }
  return retVal;
} /* Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_BD_Prime_GenKeyPair() */
  ...
  P2CONST(eslt_EccDomain, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) EcDomainPtr)
{
  ...
  uint8 intermediateKey[CRYPTO_30_LIBCV_MAX_SIZEOF_PUBLIC_ECBD_KEY_XY];
  ...
  if (Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_BD_Prime_GetPartnerPub(cryptoKeyId, &leftPublicStorageIndex, &rightPublicStorageIndex, EcDomainPtr) == E_OK) /* SBSW_CRYPTO_30_LIBCV_STACK_VARIABLE_AS_PTR */
  {
    if (esl_calculateIntermediateECBD(wsPtr, /* SBSW_CRYPTO_30_LIBCV_ESL_CALL_WITH_WORKSPACE_AND_BUFFER_AND_STACK_BUFFER */
      ...
      (P2VAR(eslt_Byte, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR))&((Crypto_30_LibCv_GetAddrKeyStorage(leftPublicStorageIndex))[publicKeyLength]),
      (P2VAR(eslt_Byte, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR))Crypto_30_LibCv_GetAddrKeyStorage(rightPublicStorageIndex),
      (P2VAR(eslt_Byte, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR))&((Crypto_30_LibCv_GetAddrKeyStorage(rightPublicStorageIndex))[publicKeyLength]),
      (P2VAR(eslt_Byte, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR))intermediateKey,
      (P2VAR(eslt_Byte, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR))&(intermediateKey[publicKeyLength])) == ESL_ERC_NO_ERROR)
    {
      if (Crypto_30_LibCv_Local_KeyElementSet(cryptoKeyId, CRYPTO_KE_CUSTOM_KEYEXCHANGE_INTERMEDIATE, intermediateKey, publicKeyLengthXY) == E_OK) /* SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_BUFFER */
      {
        /* Copy intermediate key to output buffer and overwrite local copy if store key was successfully */
        /* [SWS_Crypto_00109] return public key */
        if (*publicValueLengthPtr >= publicKeyLengthXY)
        {
          Crypto_30_LibCv_CopyData(publicValuePtr, intermediateKey, publicKeyLengthXY); /* PRQA S 0315 */ /* MD_MSR_VStdLibCopy */ /* SBSW_CRYPTO_30_LIBCV_PTR_ACCESS */
          *publicValueLengthPtr = publicKeyLengthXY; /* SBSW_CRYPTO_30_LIBCV_PTR_ACCESS */

          /* delete buffer content from RAM */
          Crypto_30_LibCv_ClearData(intermediateKey, publicKeyLengthXY); /* PRQA S 0315 */ /* MD_MSR_VStdLibCopy */ /* SBSW_CRYPTO_30_LIBCV_STACK_ARRAY_ACCESS_WITH_SIZE */
          retVal = E_OK;
        }
        else
        {
  ...
  if (localWsEcBPPtr != NULL_PTR)
  {
    switch (localWsEcBPPtr->state)
    {
      ...
      default: /* CRYPTO_30_LIBCV_ECBD_STATE_CALC_PUBVAL */
      {
        ...
        retVal = Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_BD_Prime_GenKeyPair(localWsEcBPPtr,
          cryptoKeyId, publicValuePtr, publicValueLengthPtr,
          EcDomainPtr, EcDomainExtPtr, EcSpeedUpExtPtr); /* SBSW_CRYPTO_30_LIBCV_ESL_CALL_WITH_WORKSPACE_AND_BUFFERS */
      ...
      case CRYPTO_30_LIBCV_ECBD_STATE_CALC_INTERMEDIATE:
      {
        ...
        retVal = Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_BD_Prime_CalcIntermediate(&localWsEcBPPtr->wsBD, cryptoKeyId, publicValuePtr, publicValueLengthPtr, EcDomainPtr); /* SBSW_CRYPTO_30_LIBCV_ESL_CALL_WITH_WORKSPACE_AND_BUFFERS */
    ...
    /* delete working products if there was a failure */
    if (retVal != E_OK)
    {
  ...
  const uint32 expectedPublicKeyLength)
{
  ...
  /* # Check domain key lengths */
  if (expectedPrivateKeyLength == esl_getLengthOfEcPprivateKey(EcDomainPtr)) /* SBSW_CRYPTO_30_LIBCV_DOMAIN_PTR_AS_PARAM */
  {
    if (expectedPublicKeyLength == esl_getLengthOfEcPpublicKey_comp(EcDomainPtr)) /* SBSW_CRYPTO_30_LIBCV_DOMAIN_PTR_AS_PARAM */
    {
      retVal = E_OK;
    }
  }
  ...
  const uint32 expectedPublicKeyLength)
{
  ...
  /* # Check domain key lengths */
  if (Crypto_30_LibCv_Local_KeyExchange_CheckDomainKeyLengths(EcDomainPtr, expectedPrivateKeyLength, expectedPublicKeyLength) == E_OK) /* SBSW_CRYPTO_30_LIBCV_DOMAIN_PTR_AS_PARAM */
  {
    /* # Calculate shared secret according to ECBD */
    retVal = Crypto_30_LibCv_Local_KeyExchangeCalcSecret_BD_Prime(cryptoKeyId,
      partnerIntermediateValuePtr, partnerIntermediateValueLength,
      EcDomainPtr); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
  }
  ...
  const uint32 expectedPublicKeyLength)
{
  ...
  if (Crypto_30_LibCv_Local_KeyExchange_CheckDomainKeyLengths(EcDomainPtr, expectedPrivateKeyLength, expectedPublicKeyLength) == E_OK) /* SBSW_CRYPTO_30_LIBCV_DOMAIN_PTR_AS_PARAM */
  {
    /* # Calculate public value (Key pair of private and public) according to ECBD curve p224r1 */
    retVal = Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_BD_Prime(cryptoKeyId, publicValuePtr, publicValueLengthPtr,
      EcDomainPtr, EcDomainExtPtr, EcSpeedUpExtPtr); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
  }
...
# endif
# if (CRYPTO_30_LIBCV_KEY_EXCHANGE_ALGORITHM_X448_ENABLED == STD_ON)
              case CRYPTO_30_LIBCV_KEY_EXCHANGE_X448:
                /* #30 execute KEA x25519 / RFC 7748 */
                retVal = Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_X448(cryptoKeyId, publicValuePtr, publicValueLengthPtr); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
                break;
# endif
...
# if (CRYPTO_30_LIBCV_KEY_EXCHANGE_ALGORITHM_SECP384R1_ENABLED == STD_ON)
              case CRYPTO_30_LIBCV_KEY_EXCHANGE_SECP384R1:
                ...
                break;
# endif
# if (CRYPTO_30_LIBCV_KEY_EXCHANGE_ALGORITHM_SECP521R1_ENABLED == STD_ON)
              case CRYPTO_30_LIBCV_KEY_EXCHANGE_SECP521R1:
                /* #70 execute KEA SECp521r1 */
...
# if (CRYPTO_30_LIBCV_KEY_EXCHANGE_ALGORITHM_NISTP224R1_BD_ENABLED == STD_ON)
                case CRYPTO_30_LIBCV_KEY_EXCHANGE_NISTP224R1_BD:
                  /* #90 execute KEA NISTp224r1 BD */
                  retVal = Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_BD_CheckDomainKeyLengthsAndProcessCalc(
                    ...
                    CRYPTO_30_LIBCV_SIZEOF_ECC_224_KEY_PUBLIC);
                break;
# endif
# if (CRYPTO_30_LIBCV_KEY_EXCHANGE_ALGORITHM_P256R1_BD_ENABLED == STD_ON)
                case CRYPTO_30_LIBCV_KEY_EXCHANGE_P256R1_BD:
                  /* #100 execute KEA p256r1 BD */
                  retVal = Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_BD_CheckDomainKeyLengthsAndProcessCalc(
                    cryptoKeyId, publicValuePtr, publicValueLengthPtr, /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
                    ...
                    CRYPTO_30_LIBCV_SIZEOF_ECC_256_KEY_PUBLIC);
                  break;
# endif
                default:
                    /* invalid algorithm */
  ...
  P2VAR(eslt_WorkSpaceX25519, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) wsX25519)
{
  ...
  Crypto_30_LibCv_ClearData(sharedSecret, ESL_SIZEOF_X25519_SHARED_SECRET); /* PRQA S 0315 */ /* MD_MSR_VStdLibCopy */ /* SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_BUFFER */
  ...
  P2VAR(eslt_WorkSpaceX25519, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) wsX25519)
{
  ...
  if (eslRet == ESL_ERC_NO_ERROR)
  {
    ...
    if (localRetVal == E_OK)
    {
      ...
      {
        /* #30 generate secret */
        retVal = Crypto_30_LibCv_Local_KeyExchangeCalcSecret_X25519_Calculate(cryptoKeyId, partnerPublicValuePtr, wsX25519); /* SBSW_CRYPTO_30_LIBCV_ESL_CALL_WITH_WORKSPACE_AND_KEY_PTR */
      }
    }
  }
  return retVal;
  ...
  P2CONST(uint8, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR) partnerPublicValuePtr)
{
  ...
  /* #20 Call Crypto_30_LibCv_Local_KeyExchangeCalcSecret_X448_With_Ws */
  return Crypto_30_LibCv_Local_KeyExchangeCalcSecret_X448_With_Ws(cryptoKeyId, partnerPublicValuePtr, &localWsX448); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
} /* Crypto_30_LibCv_Local_KeyExchangeCalcSecret_X448() */
  ...
  P2VAR(eslt_WorkSpaceEdDH, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) wsX448)
{
  ...
  Std_ReturnType retVal = E_NOT_OK;
  Crypto_30_LibCv_SizeOfKeyStorageType keyExchangePrivateKeyIndex;
  uint32 keyExchangePrivateKeyLength = ESL_SIZEOF_X448_PRIVATE_KEY;
  uint32 sharedSecretLength = ESL_SIZEOF_X448_SHARED_SECRET;
  uint8 sharedSecret[ESL_SIZEOF_X448_SHARED_SECRET];
  ...
  if (localRetVal == E_OK)
  {
    /* #20 generate secret by using public key from key element */
    localRetVal = Crypto_30_LibCv_Local_Dispatch_EdDH_CalculateSharedSecret_With_Ws( /* SBSW_CRYPTO_30_LIBCV_ESL_CALL_WITH_WORKSPACE_AND_CONST_BUFFER_AND_STACK_BUFFER */
      Crypto_30_LibCv_GetAddrKeyStorage(keyExchangePrivateKeyIndex),
      keyExchangePrivateKeyLength,
      partnerPublicValuePtr,
      ESL_SIZEOF_X448_PUBLIC_KEY,
      sharedSecret,
      &sharedSecretLength,
      wsX448
    );
    ...
    if (localRetVal == E_OK)
    {
      /* #30 Store calculated sharedSecret */
      if (Crypto_30_LibCv_Local_KeyElementSet(cryptoKeyId, CRYPTO_KE_KEYEXCHANGE_SHAREDVALUE, sharedSecret, sharedSecretLength) == E_OK) /* SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_BUFFER */
      {
        retVal = E_OK;
      }
    }
    ...
    /* #40 Delete buffer content from RAM */
    Crypto_30_LibCv_ClearData(sharedSecret, ESL_SIZEOF_X448_KEY); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_BUFFER */
  }
  ...
  P2VAR(eslt_WorkSpaceEcP, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) workspace)
{
  ...
  else
  {
    ...
    {
      /* #35 Try to store calculated sharedSecret as X|Y coordinate */
      Std_ReturnType localRetVal = Crypto_30_LibCv_Local_KeyElementSet(cryptoKeyId, CRYPTO_KE_KEYEXCHANGE_SHAREDVALUE, sharedSecret, Crypto_30_LibCv_Math_Mul2(keySize)); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_BUFFER */

      if (localRetVal == E_OK)
      {
        retVal = E_OK;
      }
      else if (localRetVal == CRYPTO_E_KEY_SIZE_MISMATCH)
      {
        /* #36 If not enough space in key element, store shared secret as x-coordinate only */
        if (Crypto_30_LibCv_Local_KeyElementSet(cryptoKeyId, CRYPTO_KE_KEYEXCHANGE_SHAREDVALUE, sharedSecret, keySize) == E_OK) /* SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_BUFFER */
        {
          retVal = E_OK;
        }
        else
  ...
  P2CONST(eslt_EccDomain, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) EcDomainPtr)
{
  ...
  /* EcuId (1Byte) | Partner intermediate value X | Partner intermediate value Y */
  if (partnerIntermediateValueLength == (CRYPTO_30_LIBCV_SIZEOF_ECDHE_BD_ECU_ID_LENGTH + publicKeyLengthXY))
  {
    if (esl_updateSharedSecretECBD(wsPtr, /* SBSW_CRYPTO_30_LIBCV_CALL_WITH_WORKSPACE */
      ...
      (P2CONST(eslt_Byte, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR))&partnerIntermediateValuePtr[CRYPTO_30_LIBCV_SIZEOF_ECDHE_BD_ECU_ID_LENGTH + publicKeyLength])
      == ESL_ERC_NO_ERROR)
    {
      retVal = E_OK;
    }
...
{
  /* ----- Local Variables ------------------------------------------------ */
  uint8 sharedSecret[CRYPTO_30_LIBCV_MAX_SIZEOF_PUBLIC_ECBD_KEY_XY];
  Std_ReturnType retVal = E_NOT_OK;
  const uint32 publicKeyLength = esl_getLengthOfEcPpublicKey_comp(EcDomainPtr); /* SBSW_CRYPTO_30_LIBCV_DOMAIN_PTR_AS_PARAM */
  const uint32 publicKeyLengthXY = publicKeyLength * 2u;

  /* ----- Implementation ------------------------------------------------- */
  /* #10 Retrieve shared secret */
  if (esl_retrieveSharedSecretECBD(wsPtr, /* SBSW_CRYPTO_30_LIBCV_ESL_CALL_WITH_WORKSPACE_AND_STACK_BUFFER_NOLENGTHGIVEN */
    ...
    (P2VAR(eslt_Byte, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR))&sharedSecret[publicKeyLength])
    == ESL_ERC_NO_ERROR)
  {
    /* #20 Try to store calculated sharedSecret as X|Y coordinate */
    Std_ReturnType localRetVal = Crypto_30_LibCv_Local_KeyElementSet(cryptoKeyId, CRYPTO_KE_KEYEXCHANGE_SHAREDVALUE, /* SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_BUFFER */
      sharedSecret, publicKeyLengthXY);
    if (localRetVal == E_OK)
    {
      retVal = E_OK;
    }
    ...
    {
      /* #30 If not enough space in key element, store sharedSecret as x-coordinate only */
      if (Crypto_30_LibCv_Local_KeyElementSet(cryptoKeyId, CRYPTO_KE_KEYEXCHANGE_SHAREDVALUE, sharedSecret, publicKeyLength) == E_OK) /* SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_BUFFER */
      {
        retVal = E_OK;
      }
  ...
  /* #40 Delete sharedSecret buffer content from RAM */
  Crypto_30_LibCv_ClearData(sharedSecret, publicKeyLengthXY); /* PRQA S 0315 */ /* MD_MSR_VStdLibCopy */ /* SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_BUFFER */
  ...
  if (Crypto_30_LibCv_Local_LongWsIsLock(cryptoKeyId, &longWsIdx) == E_OK) /* SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_BUFFER */
  {
    ...
    if (localWsEcBPPtr->state == CRYPTO_30_LIBCV_ECBD_STATE_REC_INTERMEDIATE)
    {
      ...
      if (retVal == E_OK)
      {
        ...
        retVal = Crypto_30_LibCv_Local_KeyExchangeCalcSecret_BD_Prime_Update(&localWsEcBPPtr->wsBD, partnerIntermediateValuePtr, partnerIntermediateValueLength, EcDomainPtr); /* SBSW_CRYPTO_30_LIBCV_CALL_WITH_WORKSPACE */
      }
      ...
      if ((retVal == E_OK) && (localWsEcBPPtr->ecuCount == (localWsEcBPPtr->ecuNum - 1u))) /* own value not required */
      {
        ...
        retVal = Crypto_30_LibCv_Local_KeyExchangeCalcSecret_BD_Prime_Finish(&localWsEcBPPtr->wsBD, cryptoKeyId, EcDomainPtr); /* SBSW_CRYPTO_30_LIBCV_CALL_WITH_WORKSPACE */
        Crypto_30_LibCv_Local_KeyExchange_BD_Prime_DeleteWorkspace(longWsIdx);
        release = TRUE;
      }
    }
...
# if (CRYPTO_30_LIBCV_KEY_EXCHANGE_ALGORITHM_X448_ENABLED == STD_ON)
        case CRYPTO_30_LIBCV_KEY_EXCHANGE_X448:
          /* #30 execute KEA x25519 / RFC 7748 */
          if (partnerPublicValueLength == ESL_SIZEOF_X448_PUBLIC_KEY)
          {
            retVal = Crypto_30_LibCv_Local_KeyExchangeCalcSecret_X448(cryptoKeyId, partnerPublicValuePtr); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
          }
          break;
# endif
# if (CRYPTO_30_LIBCV_KEY_EXCHANGE_ALGORITHM_ANSIP256R1_ENABLED == STD_ON)
...
# if (CRYPTO_30_LIBCV_KEY_EXCHANGE_ALGORITHM_SECP521R1_ENABLED == STD_ON)
        case CRYPTO_30_LIBCV_KEY_EXCHANGE_SECP521R1:
          /* #70 execute KEA SECp521r1 */
          retVal = Crypto_30_LibCv_Local_KeyExchangeCalcSecret_Generic(cryptoKeyId, partnerPublicValuePtr, partnerPublicValueLength, CRYPTO_30_LIBCV_SIZEOF_ECC_521_KEY_PRIVATE, CRYPTO_30_LIBCV_ECDHE_521_ID); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
          break;
# endif
# if (CRYPTO_30_LIBCV_KEY_EXCHANGE_ALGORITHM_SPAKE2_PLUS_CIPHERSUITE_8_ENABLED == STD_ON)
          /* #80 execute KEA Spake2+ */
...
# if (CRYPTO_30_LIBCV_KEY_EXCHANGE_ALGORITHM_NISTP224R1_BD_ENABLED == STD_ON)
        case CRYPTO_30_LIBCV_KEY_EXCHANGE_NISTP224R1_BD:
          /* #90 execute KEA NISTp224r1 BD */
          retVal = Crypto_30_LibCv_Local_KeyExchangeCalcSecret_BD_CheckDomainKeyLengthsAndProcessCalc(
            cryptoKeyId, partnerPublicValuePtr, partnerPublicValueLength, /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
            Crypto_30_LibCv_EccCurveNistSecP224R1Domain,/* SBSW_CRYPTO_30_LIBCV_DOMAIN_PTR */
            CRYPTO_30_LIBCV_SIZEOF_ECC_224_KEY_PRIVATE,
            CRYPTO_30_LIBCV_SIZEOF_ECC_224_KEY_PUBLIC);
          break;
  ...
  P2VAR(eslt_WorkSpaceEdDH, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) workspace)
{
  ...
  Std_ReturnType retVal = E_NOT_OK;
  eslt_ErrorCode eslRet = ESL_ERC_ERROR;
  eslt_Length localSharedSecretLength = (eslt_Length)*sharedSecretLengthPtr;

  /* ----- Implementation ------------------------------------------------- */
  /* #10 Initialize workspace */
  eslRet = esl_initWorkSpaceHeader((P2VAR(eslt_WorkSpaceHeader, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR))&workspace->header, ESL_SIZEOF_WS_EDDH, CRYPTO_30_LIBCV_WATCHDOG_PTR); /* SBSW_CRYPTO_30_LIBCV_INIT_ESL_WORKSPACE_PARAMETER */

  if (eslRet == ESL_ERC_NO_ERROR)
  {
    eslRet = esl_initEdDH(workspace, ESL_CURVE448); /* SBSW_CRYPTO_30_LIBCV_ESL_PARAMETER_WORKSPACE */
  }

  if (eslRet == ESL_ERC_NO_ERROR)
  {
    /* #20 Load private key */
    if (esl_importStaticPrivateKeyEdDH(workspace, /* SBSW_CRYPTO_30_LIBCV_ESL_CALL_WITH_WORKSPACE_AND_CONST_BUFFER */
      privateKeyPtr,
      (eslt_Length)privateKeyLength) == ESL_ERC_NO_ERROR)
    {
      /* #30 generate secret by using public key */
      eslRet = esl_generateSharedSecretEdDH( /* SBSW_CRYPTO_30_LIBCV_ESL_CALL_WITH_WORKSPACE_AND_CONST_BUFFER_AND_PARAMETER_BUFFER */
        workspace,
        (P2CONST(eslt_Byte, AUTOMATIC, CRYPTO_30_LIBCV_APPL_VAR))partnerPubKeyPtr,
        (eslt_Length)partnerPubKeyLength,
        sharedSecretPtr,
        &localSharedSecretLength);

      if (eslRet == ESL_ERC_NO_ERROR)
      {
        *sharedSecretLengthPtr = localSharedSecretLength; /* SBSW_CRYPTO_30_LIBCV_PTR_ACCESS */
        retVal = E_OK;
      }
    }
  }
  ...
  P2VAR(eslt_WorkSpaceEcP, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) workspace)
{
  /* ----- Local Variables ---------------------------------------------- */
  Std_ReturnType retVal = E_NOT_OK;
  Std_ReturnType retValDispatching = E_NOT_OK;
...
# if (CRYPTO_30_LIBCV_KEY_EXCHANGE_P256R1_DOMAIN == STD_ON)
  case CRYPTO_30_LIBCV_ECDHE_256_ID:
    ...
    break;
# endif /* (CRYPTO_30_LIBCV_KEY_EXCHANGE_P256R1_DOMAIN == STD_ON) */

# if (CRYPTO_30_LIBCV_KEY_EXCHANGE_ALGORITHM_SECP384R1_ENABLED == STD_ON)
  case CRYPTO_30_LIBCV_ECDHE_384_ID:
    /* NISTp384r1 = SECp384r1 */
    EcDomainPtr = Crypto_30_LibCv_EccCurveNistSecP384R1Domain;
    EcDomainExtPtr = Crypto_30_LibCv_EccCurveNistSecP384R1DomainExt;
    retValDispatching = E_OK;
    break;
# endif /* (CRYPTO_30_LIBCV_KEY_EXCHANGE_ALGORITHM_SECP384R1_ENABLED == STD_ON) */

# if ((CRYPTO_30_LIBCV_KEY_EXCHANGE_ALGORITHM_SECP521R1_ENABLED == STD_ON) || (CRYPTO_30_LIBCV_KDF_ALGO_ISO_15118_20_CERTIFICATE_HANDLING_ENABLED == STD_ON))
  case CRYPTO_30_LIBCV_ECDHE_521_ID:
    /* NISTp521r1 = SECp521r1 */
    EcDomainPtr = Crypto_30_LibCv_EccCurveNistSecP521R1Domain;
    EcDomainExtPtr = Crypto_30_LibCv_EccCurveNistSecP521R1DomainExt;
    retValDispatching = E_OK;
    break;
# endif /* ((CRYPTO_30_LIBCV_KEY_EXCHANGE_ALGORITHM_SECP521R1_ENABLED == STD_ON) || (CRYPTO_30_LIBCV_KDF_ALGO_ISO_15118_20_CERTIFICATE_HANDLING_ENABLED == STD_ON)) */
  ...
  {
    /* Check key sizes */
    if (privateKeyLength != esl_getLengthOfEcPprivateKey(EcDomainPtr)) /* SBSW_CRYPTO_30_LIBCV_DOMAIN_PTR_AS_PARAM */
    {
      /* invalid private key length */
    }
    else if (partnerPubKeyLength != (uint32)Crypto_30_LibCv_Math_Mul2((uint32)esl_getLengthOfEcPpublicKey_comp(EcDomainPtr))) /* SBSW_CRYPTO_30_LIBCV_DOMAIN_PTR_AS_PARAM */
    {
      /* invalid partner public key length */
    }
    else
    {
      retVal = Crypto_30_LibCv_Local_EcP_CalculateSharedSecret_With_Ws(privateKeyPtr,
        partnerPubKeyPtr,
        sharedSecretPtr,
        workspace,
        EcDomainPtr,
        EcDomainExtPtr); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_BUFFER_AND_PARAMETER_BUFFER */
    }
  }
  ...
  P2CONST(eslt_EccDomainExt, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) EcDomainExtPtr)
{
  ...
  if (eslRet == ESL_ERC_NO_ERROR)
  {
    ...
    eslRet = esl_generateSharedSecretDHEcP_prim((P2VAR(eslt_WorkSpaceEcP, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR))workspace, /* PRQA S 0310, 0311 */ /* MD_CRYPTO_30_LIBCV_0310, MD_CRYPTO_30_LIBCV_0311 */ /* SBSW_CRYPTO_30_LIBCV_FORWARDING_STACK_BUFFER */
      ...
      (P2CONST(eslt_Byte, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR))&partnerPubKeyPtr[0], (P2CONST(eslt_Byte, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR))&partnerPubKeyPtr[esl_getLengthOfEcPprivateKey(EcDomainPtr)], /* SBSW_CRYPTO_30_LIBCV_DOMAIN_PTR_AS_PARAM */
      (P2VAR(eslt_Byte, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR))&sharedSecretPtr[0], (P2VAR(eslt_Byte, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR))&sharedSecretPtr[esl_getLengthOfEcPsecret_comp(EcDomainPtr)]); /* SBSW_CRYPTO_30_LIBCV_DOMAIN_PTR_AS_PARAM */
    if (eslRet == ESL_ERC_NO_ERROR)
    {
      retVal = E_OK;
    }
...
#endif /* Crypto_30_LibCv_Dispatch_KeyX448Secret() */
  ...
  Crypto_OperationModeType mode)
{
  /* ----- Local Variables ------------------------------------------------ */
  Std_ReturnType retVal = E_OK;
  P2VAR(eslt_WorkSpaceEdDH, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) workspace = Crypto_30_LibCv_GetWorkspaceOfKeyX448Secret(Crypto_30_LibCv_GetKeyX448SecretIdxOfObjectInfo(objectId));
  ...
  if (mode == CRYPTO_OPERATIONMODE_FINISH)
  {
    ...
    {
      /* #10 Calculate shared secret according to X448 */
      retVal = Crypto_30_LibCv_Local_KeyExchangeCalcSecret_X448_With_Ws(job->cryptoKeyId, job->CRYPTO_30_LIBCV_JOB_PRIMITIVE_INPUT_OUTPUT_MEMBER.inputPtr, workspace); /* SBSW_CRYPTO_30_LIBCV_CALL_WITH_GLOBAL_WORKSPACE_AND_CONST_BUFFER */
    }
    else
    {
      retVal = E_NOT_OK;
  ...
  Crypto_OperationModeType mode)
{
  ...
  if (mode == CRYPTO_OPERATIONMODE_FINISH)
  {
    ...
    retVal = Crypto_30_LibCv_Local_KeyExchangeCalcSecret_Generic_With_Ws(job->cryptoKeyId,
      ...
      CRYPTO_30_LIBCV_SIZEOF_ECC_256_KEY_PRIVATE, CRYPTO_30_LIBCV_ECDHE_256_ID, workspace); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
  }
  return retVal;
} /* Crypto_30_LibCv_Dispatch_KeyP256R1Secret() */
  ...
  Crypto_OperationModeType mode)
{
  ...
  if (mode == CRYPTO_OPERATIONMODE_FINISH)
  {
    ...
    retVal = Crypto_30_LibCv_Local_KeyExchangeCalcSecret_Generic_With_Ws(job->cryptoKeyId,
      job->CRYPTO_30_LIBCV_JOB_PRIMITIVE_INPUT_OUTPUT_MEMBER.inputPtr,
      job->CRYPTO_30_LIBCV_JOB_PRIMITIVE_INPUT_OUTPUT_MEMBER.inputLength,
      CRYPTO_30_LIBCV_SIZEOF_ECC_384_KEY_PRIVATE, CRYPTO_30_LIBCV_ECDHE_384_ID, workspace); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
  }
  return retVal;
} /* Crypto_30_LibCv_Dispatch_KeyP384R1Secret() */
  ...
  Crypto_OperationModeType mode)
{
  /* ----- Local Variables ------------------------------------------------ */
  Std_ReturnType retVal = E_OK;
  P2VAR(eslt_WorkSpaceEcP, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) workspace = Crypto_30_LibCv_GetWorkspaceOfKeyP521R1Secret(Crypto_30_LibCv_GetKeyP521R1SecretIdxOfObjectInfo(objectId));

  /* ----- Implementation ------------------------------------------------- */
  if (mode == CRYPTO_OPERATIONMODE_FINISH)
  {
    /* #10 Calculate shared secret according to ECC curve p521r1 */
    retVal = Crypto_30_LibCv_Local_KeyExchangeCalcSecret_Generic_With_Ws(job->cryptoKeyId,
      job->CRYPTO_30_LIBCV_JOB_PRIMITIVE_INPUT_OUTPUT_MEMBER.inputPtr,
      job->CRYPTO_30_LIBCV_JOB_PRIMITIVE_INPUT_OUTPUT_MEMBER.inputLength,
      CRYPTO_30_LIBCV_SIZEOF_ECC_521_KEY_PRIVATE, CRYPTO_30_LIBCV_ECDHE_521_ID, workspace); /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
  }
  return retVal;
} /* Crypto_30_LibCv_Dispatch_KeyP521R1Secret() */
#endif /* Crypto_30_LibCv_Dispatch_KeyP521R1Secret() */
...
#endif /* Crypto_30_LibCv_Dispatch_KeySpake2PSecret() */
  ...
  Crypto_OperationModeType mode)
{
  /* ----- Local Variables ------------------------------------------------ */
  Std_ReturnType retVal = E_OK;
  P2VAR(eslt_WorkSpaceEdDH, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) workspace = Crypto_30_LibCv_GetWorkspaceOfKeyX448PubVal(Crypto_30_LibCv_GetKeyX448PubValIdxOfObjectInfo(objectId));

  /* ----- Implementation ------------------------------------------------- */
  if (mode == CRYPTO_OPERATIONMODE_FINISH)
  {
    /* #10 Calculate public value (Key pair of private and public) according to X448 */
    retVal = Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_X448_With_Ws(job->cryptoKeyId, /* SBSW_CRYPTO_30_LIBCV_CALL_WITH_GLOBAL_WORKSPACE_AND_JOB_BUFFER */
      job->CRYPTO_30_LIBCV_JOB_PRIMITIVE_INPUT_OUTPUT_MEMBER.outputPtr,
      job->CRYPTO_30_LIBCV_JOB_PRIMITIVE_INPUT_OUTPUT_MEMBER.outputLengthPtr,
      workspace);
  }
...
#endif /* Crypto_30_LibCv_Dispatch_KeyX448PubVal() */
  ...
  Crypto_OperationModeType mode)
{
  ...
  switch (mode)
  {
    ...
    case CRYPTO_OPERATIONMODE_FINISH:
      /* #10 Calculate public value (Key pair of private and public) according to ECBD curve p256r1 */
      retVal = Crypto_30_LibCv_Local_KeyExchangeCalcPubVal_BD_CheckDomainKeyLengthsAndProcessCalc(
        job->cryptoKeyId, /* SBSW_CRYPTO_30_LIBCV_FORWARDING_PTR */
        job->CRYPTO_30_LIBCV_JOB_PRIMITIVE_INPUT_OUTPUT_MEMBER.outputPtr,
        job->CRYPTO_30_LIBCV_JOB_PRIMITIVE_INPUT_OUTPUT_MEMBER.outputLengthPtr,
  ...
  Crypto_OperationModeType mode)
{
  /* ----- Local Variables ------------------------------------------------ */
  Std_ReturnType retVal = E_OK;
  P2VAR(eslt_WorkSpaceEcP, AUTOMATIC, CRYPTO_30_LIBCV_CRYPTOCV_APPL_VAR) workspace = Crypto_30_LibCv_GetWorkspaceOfKeyP521R1PubVal(Crypto_30_LibCv_GetKeyP521R1PubValIdxOfObjectInfo(objectId));
...
#endif /* Crypto_30_LibCv_Dispatch_KeyP521R1PubVal() */
