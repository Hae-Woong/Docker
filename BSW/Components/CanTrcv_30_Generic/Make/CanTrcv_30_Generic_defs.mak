############################################################################### 
# File Name  : CanTrcv_30_Generic_defs.mak 
...
# REVISION HISTORY
#------------------------------------------------------------------------------
# Refer to the CanTrcv_30_Generic_rules.mak file.
############################################################################### 
...
CANTRCV_CORE_PATH        =
CANTRCV_OUTPUT_PATH      = $(GENDATA_DIR)
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     += CanTrcv_30_Generic$(BSW_SRC_DIR)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
