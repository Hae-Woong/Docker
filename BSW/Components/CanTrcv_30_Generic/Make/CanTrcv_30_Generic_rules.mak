############################################################################### 
# File Name  : CanTrcv_30_Generic_rules.mak 
...
# 1.01.00   2008-06-11  Ces     Adapted to AUTOSAR CanTrcv
# 1.02.00   2008-08-21  Ou      Correct the case sensitivity for "Dio" and "dio"
# 1.03.00   2008-12-12  Ou      Rename the file name
# 1.04.00   2009-04-17  Tvi     Changed Paths / Renamed files
# 1.05.00   2009-11-12  Tvi     Renamed files
# 1.06.00   2010-02-05  Tvi     Renamed make files
# 1.08.00   2017-03-14  Seu     ESCAN00094363
# 1.09.00   2017-03-15  Seu     Renamed make files
# 1.09.01   2017-03-21  Seu     ESCAN00094443
# 1.10.00   2019-02-06  vircbl  Added support of component-based SIP structure
#------------------------------------------------------------------------------
...
CanTrcv_30_Generic_FILES = CanTrcv_30_Generic$(BSW_SRC_DIR)\CanTrcv_30_GenericCan.c

# e.g.: CC_FILES_TO_BUILD += drv\CanTrcv_30_Xdio.c
CC_FILES_TO_BUILD       += CanTrcv_30_Generic$(BSW_SRC_DIR)\CanTrcv_30_GenericCan.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
