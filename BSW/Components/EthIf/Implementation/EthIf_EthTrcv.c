 ...
 *
 */
FUNC(Std_ReturnType, ETHIF_CODE) EthIf_VSetTransceiverWakeupMode( /* PRQA S 6080 */ /* MD_MSR_STMIF */
  uint8                   CtrlIdx,
  EthTrcv_WakeupModeType  WakeupMode)
{
  /* ----- Local Variables ---------------------------------------------- */
 ...
 *
 */
FUNC(Std_ReturnType, ETHIF_CODE) EthIf_VGetTransceiverWakeupMode( /* PRQA S 6080 */ /* MD_MSR_STMIF */
        uint8                                               CtrlIdx,
  P2VAR(EthTrcv_WakeupModeType, AUTOMATIC, ETHIF_APPL_VAR)  WakeupModePtr)
{
  /* ----- Local Variables ---------------------------------------------- */
...
FUNC(void, ETHIF_CODE) EthIf_PollTrcvSignalQualities( void )
{
       ...
       ethTrcvIdx++ )
  {
    ...
    if (EthIf_Internal_GetTrcvSignalQuality(ethTrcvIdx) != E_OK)
    {
