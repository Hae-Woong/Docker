 ...
 *                Provides access to the public API of EthIf by including the respective public API header
 *                EthIf_<Sub>.h of each EthIf sub-module.
 *
 *********************************************************************************************************************/
 ...
 *  02.01.08  2011-09-07  visalr      ESCAN00053407 Additional preprocessor argument for macro without DEM has to be removed
 ...
 *                                    ESCAN00060125 Optimization of Transceiver Link State Change Callback
 ...
 *  16.03.01  2022-06-17  visdep      ETHCIF-1239   Upgraded zero copy, firewall support and header access API from QM to
 *                                                  ASIL quality level
 *  16.04.00  2022-09-30  peisinger   ETHCIF-1915   EthIf - Introduce interface APIs for MACsec related Trcv APIs
 *  16.04.01  2022-12.29  visdep      ETHCIF-1963   Update the EthIf_GetTxMgmtObject function header
 *  16.04.02  2023-01-16  visdep      ETHCIF-2649   Updated Service IDs of MACsec APIs as per Autosar Release 22-11
 *  16.04.03  2023-01-25  baubeck     ETHCIF-2159   Small fix in EthIf_GetMaxTxBufIdxForEthIfCtrl
 *  16.05.00  2023-04-04  peisinger   ESCAN00114017 EthIf_GetSnvOfEthTrcv is called with controller index instead of
 *                                                  TrcvIdx (possible out of bounds access)
 *  16.06.00  2023-06-22  peisinger   ETHCIF-2913   Support MACsec State Management *
 *  17.00.00  2023-08-07  peisinger   MSR4-34710    MACsec Switch Support
 *                        visdep      ETHCIF-4272   Migrate EthIf External Specs to text-based format
 *                                    ETHCIF-5403   Development Error Codes literals(Macros) aligned to AUTOSAR R22-11
 *  17.00.01  2023-12-29  visdep      ESCAN00116389 MacSec secured Physical Element stops communication after non
 *                                                  operational call by MacSecKeyAgreement
 *                                    ETHCIF-5309   Fix the Function Metrics MIF violations
 *  17.01.00  2023-12-04  vistoc      ETHCIF-4766   Extend AUTOSAR Forward Compatibility for all callbacks used by Eth
 *  17.02.00  2024-03-26  visdep      ETHCIF-6350   Updated Autosar version to R23-11 (4.9.0)
 *********************************************************************************************************************/
...
# define ETHIF_AR_RELEASE_MAJOR_VERSION                               (4u) /* 23 */
# define ETHIF_AR_RELEASE_MINOR_VERSION                               (9u) /* 11 */
# define ETHIF_AR_RELEASE_REVISION_VERSION                            (0u) /* 00 */

/* ----- Component version information (decimal version of ALM implementation package) ----- */
# define ETHIF_SW_MAJOR_VERSION                                       (17u)
# define ETHIF_SW_MINOR_VERSION                                       (2u)
# define ETHIF_SW_PATCH_VERSION                                       (0u)

# define ETHIF_INSTANCE_ID_DET                                        (0x00u)

/* ----- API service IDs of AUTOSAR APIs (AUTOSAR CP R21-11 + MACsec APIs introduced in R22-11)----- */
...
# define ETHIF_SID_MACSEC_DELETE_TX_SA                                (0x16u)
...
# define ETHIF_SID_MACSEC_OPERATIONAL                                 (0x1Cu)
...
# define ETHIF_SID_SWITCH_MACSEC_UPDATE_SECY_NOTIFICATION             (0x6bu)
# define ETHIF_SID_MACSEC_UPDATE_SECY_NOTIFICATION                    (0x6cu)
# define ETHIF_SID_SWITCH_MACSEC_UPDATE_SECY                          (0x6du)
# define ETHIF_SID_SWITCH_MACSEC_INIT_RX_SC                           (0x6eu)
# define ETHIF_SID_SWITCH_MACSEC_RESET_RX_SC                          (0x6fu)
# define ETHIF_SID_SWITCH_MACSEC_ADD_TX_SA                            (0x70u)
# define ETHIF_SID_SWITCH_MACSEC_ADD_TX_SA_NOTIFICATION               (0x71u)
# define ETHIF_SID_MACSEC_ADD_TX_SA_NOTIFICATION                      (0x72u)
# define ETHIF_SID_SWITCH_MACSEC_UPDATE_TX_SA                         (0x73u)
# define ETHIF_SID_SWITCH_MACSEC_DELETE_TX_SA                         (0x74u)
# define ETHIF_SID_SWITCH_MACSEC_ADD_RX_SA                            (0x75u)
# define ETHIF_SID_SWITCH_MACSEC_ADD_RX_SA_NOTIFICATION               (0x76u)
# define ETHIF_SID_MACSEC_ADD_RX_SA_NOTIFICATION                      (0x77u)
# define ETHIF_SID_SWITCH_MACSEC_UPDATE_RX_SA                         (0x78u)
# define ETHIF_SID_SWITCH_MACSEC_DELETE_RX_SA                         (0x79u)
# define ETHIF_SID_SWITCH_MACSEC_GET_TX_SA_NEXT_PN                    (0x7au)
# define ETHIF_SID_SWITCH_MACSEC_GET_MAC_SEC_STATS                    (0x7bu)
# define ETHIF_SID_SWITCH_MACSEC_GET_MAC_SEC_STATS_NOTIFICATION       (0x7cu)
# define ETHIF_SID_MACSEC_GET_MAC_SEC_STATS_NOTIFICATION              (0x7du)
# define ETHIF_SID_SWITCH_MACSEC_OPERATIONAL                          (0x7eu)
# define ETHIF_SID_SWITCH_MACSEC_SET_CONTROLLED_PORT_ENABLED          (0x7fu)
# define ETHIF_SID_MACSEC_SET_CONTROLLED_PORT_ENABLED                 (0x80u)
# define ETHIF_SID_MACSEC_DELETE_RX_SA                                (0x81u)
# define ETHIF_SID_MACSEC_UPDATE_RX_SA                                (0x82u)
# define ETHIF_SID_MACSEC_ADD_RX_SA                                   (0x83u)
# define ETHIF_SID_MACSEC_UPDATE_TX_SA                                (0x84u)
# define ETHIF_SID_MACSEC_ADD_TX_SA                                   (0x85u)
# define ETHIF_SID_MACSEC_RESET_RX_SC                                 (0x86u)
# define ETHIF_SID_MACSEC_INIT_RX_SC                                  (0x87u)
# define ETHIF_SID_MACSEC_UPDATE_SECY                                 (0x88u)
# define ETHIF_SID_MACSEC_GET_MAC_SEC_STATS                           (0x89u)
# define ETHIF_SID_MACSEC_GET_TX_SA_NEXT_PN                           (0x90u)
...
# define ETHIF_SID_GATEWAY_MANIPULATE_PROMISCUOUS_MODE                (0xABu)
...
/* ----- Autosar Development Error codes ----- */
# define ETHIF_E_NO_ERROR                                             (0x00u) /*!< no error occurred */
# define ETHIF_E_INV_CTRL_IDX                                         (0x01u) /*!< Error code: API service called with invalid controller index */
# define ETHIF_E_INV_TRCV_IDX                                         (0x02u) /*!< Error code: API service called with invalid transceiver index */
# define ETHIF_E_INV_PORT_GROUP_IDX                                   (0x03u) /*!< Error code: API service called with invalid port group index */
# define ETHIF_E_UNINIT                                               (0x04u) /*!< Error code: API service called when EthIf module was not initialized */
# define ETHIF_E_PARAM_POINTER                                        (0x05u) /*!< Error code: API service called with invalid pointer in parameter list (NULL_PTR) */
# define ETHIF_E_INV_PARAM                                            (0x06u) /*!< Error code: API service called with invalid parameter */
# define ETHIF_E_INIT_FAILED                                          (0x07u) /*!< Error code: EthIf_Init called with an invalid configuration pointer */
# define ETHIF_E_INV_SWT_IDX                                          (0x08u) /*!< Error code: API service called with invalid switch index */

/* ----- Vector Specific Development Error codes ----- */
...
# define ETHIF_TRAFFIC_GATEWAY_E_MANIPULATE_PROMISCUOUS_MODE          (0x10u) /*!< Error code: Promiscuous mode couldn't be enabled on respective Ethernet controller */
