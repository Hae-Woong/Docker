 ...
 *
 */
FUNC(Std_ReturnType, ETHIF_CODE) EthIf_GetTxStats( /* PRQA S 6080 */ /* MD_MSR_STMIF */
        uint8                                         CtrlIdx,
 ...
 *
 */
FUNC(Std_ReturnType, ETHIF_CODE) EthIf_GetRxStats( /* PRQA S 6080 */ /* MD_MSR_STMIF */
        uint8                                         CtrlIdx,
 ...
 *
 */
FUNC(Std_ReturnType, ETHIF_CODE) EthIf_GetAndResetMeasurementData( /* PRQA S 6080 */ /* MD_MSR_STMIF */
...
# endif /* ETHIF_DEV_ERROR_DETECT */
  {
    ...
    if (MeasurementIdx == ETHIF_MEAS_ALL)
    {
      ...
      {
        /* #2020 MeasurementIdx ETHIF_MEAS_ALL only supported / specified for reset of all statistics */
        retVal = E_NOT_OK;
      }
    }
