 ...
 *  ETHIF_MEAS_DROP_CTRLIDX  0x01      Measurement index of dropped datagrams caused by invalid CtrlIdx/VLAN
...
typedef struct
{
  uint32  NumTxPkts;   /*!< Packets transmitted on the EthIf-controller */
