###############################################################################
# File Name  : XcpOnFrAsr_rules.mak                                           #
...
# --------     ---------------------     -------------------------------------#
# Alr          Alex Lunkenheimer         Vector Informatik GmbH               #
#-----------------------------------------------------------------------------#
#               R E V I S I O N   H I S T O R Y                               #
#-----------------------------------------------------------------------------#
# Date         Version  Sign Description                                      #
# ----------   -------  ---- -------------------------------------------------#
# 2008/07/10   1.00.00  alr  Created                                          #
# 2019/02/06   1.00.01  Cbl  Added support of component-based SIP structure
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
FrXcp_FILES                = FrXcp$(BSW_SRC_DIR)\FrXcp.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += FrXcp$(BSW_SRC_DIR)\FrXcp.c
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\FrXcp_Lcfg.c
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\FrXcp_PBcfg.c
