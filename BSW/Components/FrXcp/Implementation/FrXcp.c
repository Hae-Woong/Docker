...
/* Check consistency of source and header file. */
  ...
  #if ( CP_XCPONFRASR_VERSION != 0x0500u )
    #error "Source and Header file are inconsistent!"
  #endif
  #if ( CP_XCPONFRASR_RELEASE_VERSION != 0x00u )
    #error "Source and Header file are inconsistent!"
  #endif
#endif
...
#define FRXCP_NAX_FRAME_OFFSET 0u
...
CONST(uint16, FRXCP_CONST) FRXCP_VENDOR_ID = (uint16)FRXCP_VENDOR_ID_DEFINITION; /* Vector = 30 */ /* PRQA S 1514 */ /* MD_FRXCP_1514 */
...
CONST(uint8, FRXCP_CONST) FRXCP_MAJOR_VERSION = (uint8)(CP_XCPONFRASR_VERSION >> 8u); /* Major version number */ /* PRQA S 1514 */ /* MD_FRXCP_1514 */
CONST(uint8, FRXCP_CONST) FRXCP_MINOR_VERSION = (uint8)(CP_XCPONFRASR_VERSION & 0xFFu); /* Minor version number */ /* PRQA S 1514 */ /* MD_FRXCP_1514 */
CONST(uint8, FRXCP_CONST) FRXCP_PATCH_VERSION = (uint8)CP_XCPONFRASR_RELEASE_VERSION; /* Patch level version number */ /* PRQA S 1514 */ /* MD_FRXCP_1514 */
...
/* PRQA S 3453 73 */ /* MD_MSR_FctLikeMacro */
...
#define FRXCP_TRANSMIT(FrXcpTxPduId, PduInfoPtr) FrIf_Transmit(FrXcpTxPduId, PduInfoPtr) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#if !defined ( FRXCP_COPY )
  #if defined ( XCP_ENABLE_ALIGNED_DTO )
    #define FRXCP_COPY(dest, src, length) FrXcp_FastCopy( (DAQBYTEPTR)(dest), (ROMDAQBYTEPTR)(src), (uint16)(length) ) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
  #else
    #define FRXCP_COPY(dest, src, length) (void)Xcp_MemCpy( (DAQBYTEPTR)(dest), (ROMDAQBYTEPTR)(src), (uint8)(length) ) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
  #endif
#endif
#if !defined ( FRXCP_MEMSET )
  #define FRXCP_MEMSET(dest, length, value) Xcp_MemSet( (BYTEPTR)(dest), (uint16)(length), (uint8)(value) ) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#endif

/* Adjust according to alignment requirements */
#if ((XCP_ALIGNMENT_MASK) > 0u)
  #define XCP_ALIGN(idx) ((idx) | (uint8)XCP_ALIGNMENT_MASK) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#else
  #define XCP_ALIGN(idx) (idx) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#endif

/* Macro for platform independent 16Bit access */
#if ( CPU_BYTE_ORDER == HIGH_BYTE_FIRST ) /* Avoid WORD access */
  #define GET_ARCHITECTURE_DEPENDANT_UI16(pt, idx) (((uint16)((pt)[(idx)+0u]) << 8u) | (uint16)((pt)[(idx)+1u])) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#else
  #define GET_ARCHITECTURE_DEPENDANT_UI16(pt, idx) (((uint16)((pt)[(idx)+1u]) << 8u) | (uint16)((pt)[(idx)+0u])) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#endif

/* Macro for determining xcp frame type */
#define XCP_GET_XCP_FRAME_TYPE(frame) (((frame)[FRXCP_PID_OFFSET] > (uint8)FRXCP_PID_TYPE_DAQ) ? LPDU_LOOKUP[(uint8)(~msg[FRXCP_PID_OFFSET])] : (uint8)FRXCP_LPDU_TYPE_DAQ) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

/* Sequence counter handling */
#if ( CTR_FRAME_OFFSET > 0 )
  #define EMBOSS_TFC_SEQUENCE_COUNTER(PduHandle) ((FrXcp_GetTransmitFC()[FRXCP_TFC_IDX(PduHandle)]).fc[CTR_FRAME_OFFSET] = FrXcp_GlobalSequenceCounter) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
...
#if ( FRXCP_FRAME_CONCATENATION == STD_ON )
#define INSERT_TFC_XCP_FRAME(PduHandle, msg, len) { FrXcp_GetTransmitFC()[FRXCP_TFC_IDX(PduHandle)].fc[FrXcp_GetAggregatedLength()[FRXCP_TFC_IDX(PduHandle)]] = (uint8)(len); \
                                                    FRXCP_COPY(&(FrXcp_GetTransmitFC()[FRXCP_TFC_IDX(PduHandle)].fc[FrXcp_GetAggregatedLength()[FRXCP_TFC_IDX(PduHandle)]+1u]), msg, len); \
                                                    XCP_TRANSFER_OVERRUN(PduHandle, FrXcp_GetAggregatedLength()[FRXCP_TFC_IDX(PduHandle)] + 1u); \
                                                    FrXcp_GetAggregatedLength()[FRXCP_TFC_IDX(PduHandle)] += ((len) + 1u); \
                                                    FrXcp_GetAggregatedLength()[FRXCP_TFC_IDX(PduHandle)] = XCP_ALIGN(FrXcp_GetAggregatedLength()[FRXCP_TFC_IDX(PduHandle)]); \
                                                  }
#define FINALIZE_TFC(PduHandle)                   { FrXcp_GetAggregatedLength()[FRXCP_TFC_IDX(PduHandle)] += (uint8)1u; \
...
#else
#define INSERT_TFC_XCP_FRAME(PduHandle, msg, len) { FRXCP_COPY(&(FrXcp_GetTransmitFC()[FRXCP_TFC_IDX(PduHandle)].fc[XCP_FRAME_START]), msg, len); \
...
#define CREATE_TFC_HEADER(PduHandle) { EMBOSS_TFC_SEQUENCE_COUNTER(PduHandle); \
                                       FrXcp_GetAggregatedLength()[FRXCP_TFC_IDX(PduHandle)] = (uint8)HEADER_SIZE; }
#define GET_TFC_PTR(PduHandle) ((P2VAR(uint8, AUTOMATIC, FRXCP_VAR_NOINIT))&(FrXcp_GetTransmitFC()[FRXCP_TFC_IDX(PduHandle)].fc[0])) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define GET_TFC_LENGTH(PduHandle) FrXcp_GetAggregatedLength()[FRXCP_TFC_IDX(PduHandle)] /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#define SET_TFC_LENGTH(PduHandle, Length) FrXcp_GetAggregatedLength()[FRXCP_TFC_IDX(PduHandle)] = (Length) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#if ( FRXCP_USE_DECOUPLED_MODE == STD_ON )
  #define XCP_RESERVE_PDU(PduHandle) FrXcp_GetRtConfig()[PduHandle].FrXcpPduAttributes |= (FrXcp_XcpPacketType)FRXCP_LPDU_TYPE_BUSY /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
  #define XCP_FREE_PDU(PduHandle)  { FrXcp_GetAggregatedLength()[FRXCP_TFC_IDX(PduHandle)] = (uint8)0u; \
                                     FrXcp_GetRtConfig()[PduHandle].FrXcpPduAttributes &= (FrXcp_XcpPacketType)((~FRXCP_LPDU_TYPE_BUSY) & 0xFFu); } 
#else
  #define XCP_RESERVE_PDU(PduHandle) { FrXcp_GetRtConfig()[PduHandle].FrXcpPduAttributes |= (FrXcp_XcpPacketType)FRXCP_LPDU_TYPE_BUSY; \
                                       FrXcp_GetAggregatedLength()[FRXCP_TFC_IDX(PduHandle)] = (uint8)0u; \
                                     }
  #define XCP_FREE_PDU(PduHandle) FrXcp_GetRtConfig()[PduHandle].FrXcpPduAttributes &= (FrXcp_XcpPacketType)((~FRXCP_LPDU_TYPE_BUSY) & 0xFFu)
#endif

#define XCP_GET_CURRENT_MAX_FLX_LEN_BUF(PduHandle) FrXcp_GetRtConfig()[PduHandle].FrXcpPduLength /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

#if ( FRXCP_USE_DECOUPLED_MODE == STD_ON )
  #define FRXCP_TFC_IDX(Index) (Index) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#else
  #define FRXCP_TFC_IDX(Index) LPDU_TO_BUFFER[(FrXcp_GetRtConfig()[Index].FrXcpPduAttributes >> 2u) & 0x07u] /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#endif
...
/***************************************************************************************************/
/* PRQA S 3453 12 */ /* MD_MSR_FctLikeMacro */
...
/* Macros for SBSW check abstraction */
  ...
  # define FrXcp_SilentBswCheckErrorReturnVoid(cond, api, err)       FrXcp_CheckErrorReturnVoid( (cond), (api), (err)) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
  # define FrXcp_SilentBswCheckErrorReturnValue(cond, api, err, ret) FrXcp_CheckErrorReturnValue( (cond), (api), (err), (ret)) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#else
  # define FrXcp_SilentBswCheckErrorReturnVoid(cond, api, err) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */ \
  FrXcp_CheckDetErrorReturnVoid( (cond), (api), (err) )
  # define FrXcp_SilentBswCheckErrorReturnValue(cond, api, err, ret) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */ \
  FrXcp_CheckDetErrorReturnValue( (cond), (api), (err), (ret) )
#endif
...
#if ( FRXCP_ENABLE_CONTROL == STD_ON )
VAR(uint8, FRXCP_VAR_INIT) FrXcp_ControlDeniedCount = 0u; /* PRQA S 3408 */ /* MD_FRXCP_3408 */
#endif
...
STATIC VAR(uint16, FRXCP_VAR_NOINIT) sq_len;
...
STATIC FUNC(uint8, FRXCP_CODE) FrXcp_SendHandling( uint16 len, P2CONST(uint8, AUTOMATIC, FRXCP_APPL_DATA) msg );
...
STATIC FUNC(void, FRXCP_CODE) FrXcp_FastCopy( P2VAR(uint8, AUTOMATIC, FRXCP_VAR_NOINIT) dest, P2CONST(uint8, AUTOMATIC, FRXCP_VAR_NOINIT) src, uint16 len )
{
  while( len >= 4u )
  {
    *(P2VAR(uint32, AUTOMATIC, FRXCP_VAR_NOINIT))dest = *(P2CONST(uint32, AUTOMATIC, FRXCP_VAR_NOINIT))src; /* PRQA S 0310, 3305 */ /* MD_FRXCP_0310, MD_FRXCP_3305 */
    dest = &dest[4]; /* PRQA S 1338 */ /* MD_FRXCP_1338 */
    src = &src[4]; /* PRQA S 1338 */ /* MD_FRXCP_1338 */
    len -= 4u; /* PRQA S 1338 */ /* MD_FRXCP_1338 */
  }
  while( len > 0u )
  {
    *(P2VAR(uint8, AUTOMATIC, FRXCP_VAR_NOINIT))dest = *(P2CONST(uint8, AUTOMATIC, FRXCP_VAR_NOINIT))src;
    dest = &dest[1]; /* PRQA S 1338 */ /* MD_FRXCP_1338 */
    src = &src[1]; /* PRQA S 1338 */ /* MD_FRXCP_1338 */
    len -= 1u; /* PRQA S 1338 */ /* MD_FRXCP_1338 */
  }
}
#endif
...
/**************************************************************************************************
   ...
   Misc             : -
**************************************************************************************************/
STATIC FUNC(uint8, FRXCP_CODE) FrXcp_GetFreePdu( FrXcp_XcpPacketType pduFilter, P2VAR(uint8, AUTOMATIC, FRXCP_VAR_NOINIT) pduIndex ) /* PRQA S 2889 */ /* MD_FRXCP_2889 */
{
  uint8_least i;
  for( i=0u; i<FrXcp_CfgGetNumberTxLpduIds(); i++ )
  {
...
/**************************************************************************************************
   ...
   Misc             : -
**************************************************************************************************/
FUNC(void, FRXCP_CODE) Xcp_FrIfTxConfirmation( PduIdType XcpTxPduId ) /* PRQA S 2889 */ /* MD_FRXCP_2889 */
{
...
/**************************************************************************************************
   ...
   Misc             : -
**************************************************************************************************/
FUNC(void, FRXCP_CODE) Xcp_FrIfRxIndication /* PRQA S 2889 */ /* MD_FRXCP_2889 */
(
...
/**************************************************************************************************
   ...
   Misc             : -
**************************************************************************************************/
extern FUNC(Std_ReturnType, FRXCP_CODE) Xcp_FrIfTriggerTransmit /* PRQA S 2889 */ /* MD_FRXCP_2889 */
(
...
/**************************************************************************************************
   ...
   Misc             : -
**************************************************************************************************/
FUNC(void, FRXCP_CODE) FrXcp_DaqResumeStore( void ) /* PRQA S 2889 */ /* MD_FRXCP_2889 */
{
  /* Activation control */
#if ( FRXCP_ENABLE_CONTROL == STD_ON )
  if ( FrXcp_ControlState == kXcponFr_Control_Disable )
...
/**************************************************************************************************
   ...
   Misc             : -
**************************************************************************************************/
FUNC(void, FRXCP_CODE) FrXcp_DaqResumeClear( void ) /* PRQA S 2889 */ /* MD_FRXCP_2889 */
{
  /* Activation control */
#if ( FRXCP_ENABLE_CONTROL == STD_ON )
  if ( FrXcp_ControlState == kXcponFr_Control_Disable )
...
FUNC(void, FRXCP_CODE) FrXcp_InitMemory( void )
{
  ...
  FrXcp_ControlDeniedCount = 0u; /* PRQA S 3408 */ /* MD_FRXCP_3408 */
#endif
...
/**************************************************************************************************
   ...
   Misc             : -
**************************************************************************************************/
FUNC(void, FRXCP_CODE) FrXcp_Init( P2CONST(FrXcp_ConfigType, AUTOMATIC, FRXCP_PBCFG) CfgPtr ) /* PRQA S 2889 */ /* MD_FRXCP_2889 */
{
  uint8_least i;
...
#else
  XCP_DUMMY_STATEMENT (CfgPtr); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */ /*lint -e{438} */
#endif
...
/**************************************************************************************************
   ...
   Misc             : -
**************************************************************************************************/
FUNC(uint8, FRXCP_CODE) FrXcp_TLService( uint8 Xcp_Channel, P2CONST(uint8, AUTOMATIC, FRXCP_APPL_DATA) pCmd ) /* PRQA S 2889 */ /* MD_FRXCP_2889 */
{
  /* Activation control */
#if ( FRXCP_ENABLE_CONTROL == STD_ON )
  if ( FrXcp_ControlState == kXcponFr_Control_Disable )
  ...
  switch( pCmd[FRXCP_IDX_TL_CMD] )
  {
    ...
    case (uint8)FRXCP_CMD_FLX_ASSIGN : 
    {
      ...
      /*---------------------------------------------------------------------------*/
      /* Reconfigure Buffer */
      if( 1u == FrXcp_CfgGetIsReconfigurable(pCmd[FRXCP_IDX_FLX_BUF]) )
      {
    ...
    case (uint8)FRXCP_CMD_FLX_ACTIVATE :
    {
      ...
      {
        FrXcp_GetRtConfig()[pCmd[FRXCP_IDX_FLX_BUF]].FrXcpPduAttributes &= (FrXcp_XcpPacketType)((~FRXCP_LPDU_TYPE_EVTBLOCKED) & 0xFFu);
        FrXcp_InterruptEnableRx();
        return((uint8)XCP_CMD_OK);
      }
      FrXcp_InterruptEnableRx();
...
/**************************************************************************************************
   ...
   Misc             : -
**************************************************************************************************/
FUNC(void, FRXCP_CODE) FrXcp_Send( uint8 Xcp_Channel, uint16 len, P2CONST(uint8, AUTOMATIC, FRXCP_APPL_DATA) msg ) /* PRQA S 2889 */ /* MD_FRXCP_2889 */
{
  /* Activation control */
#if ( FRXCP_ENABLE_CONTROL == STD_ON )
  if ( FrXcp_ControlState == kXcponFr_Control_Disable )
...
STATIC FUNC(uint8, FRXCP_CODE) FrXcp_SendHandling( uint16 len, P2CONST(uint8, AUTOMATIC, FRXCP_APPL_DATA) msg )
{
  ...
  if( (uint8)FRXCP_E_OK == FrXcp_GetFreePdu( PacketFilter, &TxPduHandle ) )
  {
    ...
    {
      len = XCP_GET_CURRENT_MAX_FLX_LEN_BUF(TxPduHandle); /* ESCAN00078873 */ /* PRQA S 1338 */ /* MD_FRXCP_1338 */
    }
  ...
  if( (uint8)FRXCP_E_OK == FrXcp_GetFreePdu( PacketFilter, &TxPduHandle ) )
  {
    if( 0u == GET_TFC_LENGTH(TxPduHandle) )
    {
      CREATE_TFC_HEADER(TxPduHandle);
    ...
    if((GET_TFC_LENGTH(TxPduHandle) + len + 1u) <= XCP_GET_CURRENT_MAX_FLX_LEN_BUF(TxPduHandle))
    {
      INSERT_TFC_XCP_FRAME(TxPduHandle, msg, len);
    }
    else
...
/**************************************************************************************************
   ...
   Misc             : -
**************************************************************************************************/
FUNC(void, FRXCP_CODE) FrXcp_SendFlush( uint8 Xcp_Channel, uint8 XcpFlushTypeSel ) /* PRQA S 2889 */ /* MD_FRXCP_2889 */
{
#if ( FRXCP_FRAME_CONCATENATION == STD_ON )
  PduInfoType PduInfoStruct;
  uint8       TxPduHandle;
...
/**************************************************************************************************
   ...
   Misc             : -
**************************************************************************************************/
FUNC(void, FRXCP_CODE) FrXcp_GetVersionInfo /* PRQA S 2889 */ /* MD_FRXCP_2889 */
(
...
/**************************************************************************************************
   ...
   Misc             : -
**************************************************************************************************/
FUNC(void, FRXCP_CODE) FrXcp_MainFunctionRx( void ) /* PRQA S 2889 */ /* MD_FRXCP_2889 */
{
  /* Activation control */
#if ( FRXCP_ENABLE_CONTROL == STD_ON )
  if ( FrXcp_ControlState == kXcponFr_Control_Disable )
  ...
  FrXcp_Rtm_Start(FrXcp_MainFunctionRx);
  {
    ...
    if( (uint8)FRXCP_INIT == FrXcp_InitializationState )
    {
      for( pduIdx = (uint8_least)0u; pduIdx < (uint8_least)FrXcp_CfgGetNumberRxLpduIds(); pduIdx++ )
      {
        if( FrXcp_GetReceiveFrameSignal()[pduIdx] > (uint8)0u )
        {
          #if ( FRXCP_FRAME_CONCATENATION == STD_OFF )
            /* Process command */
            if(0xffu == FrXcp_GetReceiveFrameCache()[pduIdx].fc[XCP_FRAME_START])
          ...
          #else
            {
              ...
              while((FrXcp_GetReceiveFrameCache()[pduIdx].fc[frame_idx] > (uint8)0u) && /* Is the length > 0? */
                    ((frame_idx + (uint16)FrXcp_GetReceiveFrameCache()[pduIdx].fc[frame_idx] + 1u)
                    <= (uint16)XCP_GET_CURRENT_MAX_FLX_LEN_BUF(pduIdx + FrXcp_CfgGetNumberTxLpduIds())) ) /* Is it within PDU size? */
              {
                /* Process command */
                if(0xffu == FrXcp_GetReceiveFrameCache()[pduIdx].fc[frame_idx + 1u])
                { /* In case of connect we set this as active TL */
                  Xcp_SetActiveTl(XCP_TRANSPORT_LAYER_FR, kFrXcpMaxCTO, kFrXcpMaxDTO, XCP_TRANSPORT_LAYER_FR);
                }
                if( XCP_TRANSPORT_LAYER_FR == Xcp_GetActiveTl(XCP_TRANSPORT_LAYER_FR) )
    ...
    Xcp_TlMainFunction((uint8)(XCP_TRANSPORT_LAYER_FR));
  }
...
/**************************************************************************************************
   ...
   Misc             : -
**************************************************************************************************/
FUNC(void, FRXCP_CODE) FrXcp_MainFunctionTx( void ) /* PRQA S 2889 */ /* MD_FRXCP_2889 */
{
  uint8_least i;
  ...
  if( (uint8)FRXCP_INIT == FrXcp_InitializationState )
  {
    ...
    while( (sq_len > 0u) && ((uint8)FRXCP_TP_OK == FrXcp_SendHandling(sq_len, sq_msg)) ) /* PRQA S 3415 */ /* MD_FRXCP_3415 */
    {
  ...
  for( i = 0u; i < (uint8_least)FrXcp_CfgGetNumberOfTransmitFC(); i++ )
  {
    FrXcp_InterruptDisableTx();
...
FUNC(void, FRXCP_CODE) FrXcp_SetPduMode( NetworkHandleType XcpNwH, FrXcp_PduSetModeType PduMode )
{
  ...
  XCP_DUMMY_STATEMENT (XcpNwH); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */ /*lint -e{438} */
...
/* module specific MISRA deviations:
  ...
  MD_FRXCP_1338:  Rule 17.8
      Reason:     Parameter is modified to keep function simple and readable.
      Risk:       None.
      Prevention: Not required.

  MD_FRXCP_1514:  Rule 8.9:
      Reason:     Constants defined global but are used only once. The constants shall be global to be accessible via debugging tool.
      Risk:       None.
      Prevention: Not required.

  MD_FRXCP_1753:  Rule 8.6:
      Reason:     External application functions are declared within the component as the API is standardized.
      Risk:       None.
      Prevention: Not required.

  MD_FRXCP_2889: Rule 15.5
      Reason:     API pattern not applied in this component yet.
      Risk:       Code understandability and maintainability reduced.
      Prevention: Covered by code review.

  MD_FRXCP_3218:  Rule 8.9
