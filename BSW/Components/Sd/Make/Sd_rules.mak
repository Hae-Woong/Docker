...
#------------------------------------------------------------------------------
# 1.00.00   2014-01-13  vispcn  Created                                       # 
# 2.00.00   2015-11-16  vispcn  Added Sd_PBcfg.c                              # 
# 2.01.00   2019-02-06  vircbl  Added support of component-based SIP structure
# 3.00.00   2023-05-04  visfaz  Included generated Makefile of ComStackLib
#------------------------------------------------------------------------------
# TemplateVersion = 1.02
###############################################################################
LIBRARIES_TO_BUILD      += Sd
Sd_FILES                = Sd$(BSW_SRC_DIR)\Sd.c

ifeq ($(GET_IMPLEMENTION_FROM), LIB)
CC_FILES_TO_BUILD       += 
else
CC_FILES_TO_BUILD       += Sd$(BSW_SRC_DIR)\Sd.c
endif
CPP_FILES_TO_BUILD      += 
ASM_FILES_TO_BUILD      += 
...
include $(GENDATA_DIR)\Make\Sd_rules_generated.mak
