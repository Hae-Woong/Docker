...
/**********************************************************************************************************************
 *  CanTp_ApplRxIndication()
 *********************************************************************************************************************/
/*! \brief         Indicates finalized reception of an N-SDU
 *  \details       Function is called if a CANTP N-SDU has successfully been received or to report an error that 
 *                 occurred during the reception.
 *  \param[in]     PduRRxSduId            PduId of the received CANTP SDU; 
 *                                        The same Id used for calls to PduR_CanTpRxIndication().
 *  \param[in]     result                 Result of the TP reception
 *  \context       TASK|ISR2
 *  \reentrant     TRUE for different handles
 *  \synchronous   TRUE
 *  \config        This call-out is only available if CANTP_APPL_RX_SDU_INDICATION is set to STD_ON by user config.
 *  \pre           -
 *********************************************************************************************************************/
FUNC(void, CANTP_CODE) Appl_CanTpSduRxIndication(PduIdType PduRRxSduId, NotifResultType Result);
#endif


#if (CANTP_APPL_TX_SDU_CONFIRMATION == STD_ON)
/**********************************************************************************************************************
 *  CanTp_ApplTxConfirmation()
 *********************************************************************************************************************/
/*! \brief         Indicates finalized transmission of an N-SDU
 *  \details       Function is called if a CANTP N-SDU has successfully been transmitted or to report an error that 
 *                 occurred during the transmission.
 *   
 *  \param[in]     PduRTxSduId            PduId of the transmitted CANTP SDU; 
 *                                        The same Id used for calls to PduR_CanTpTxConfirmation().
 *  \param[in]     result                 Result of the TP transmission
 *  \context       TASK|ISR2
 *  \reentrant     TRUE for different handles
 *  \synchronous   TRUE
 *  \config        This call-out is only available if CANTP_APPL_TX_SDU_CONFIRMATION is set to STD_ON by user config.
 *  \pre           -
 *********************************************************************************************************************/
FUNC(void, CANTP_CODE) Appl_CanTpSduTxConfirmation(PduIdType PduRTxSduId, NotifResultType Result);
#endif
