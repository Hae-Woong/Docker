...
#------------------------------------------------------------------------------
# 1.00.00   2012-07-13  Dth     Initial Version of Template (1.0)
# 2.00.00   2014-09-01  Dth     CanTp_Cfg.c removed from file list
...
LIBRARIES_TO_BUILD      += CanTp
CanTp_FILES             = CanTp$(BSW_SRC_DIR)\CanTp.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += CanTp$(BSW_SRC_DIR)\CanTp.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
include $(GENDATA_DIR)\Make\CanTp_rules_generated.mak
