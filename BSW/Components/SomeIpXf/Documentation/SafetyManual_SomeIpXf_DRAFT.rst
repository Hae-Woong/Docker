...
.. smi:: SMI-105510
    ...
    .. list-table::
       ...
       * - CREQ-106190
         - SomeIpXf shall provide a service to initialize itself.
         - TSR-1
         - ASIL D

       * - CREQ-106187
         - SomeIpXf shall provide a service to transform a Sender/Receiver/Trigger communication.
         - TSR-111108,TSR-10
         - ASIL D

       * - CREQ-106188
         - SomeIpXf shall provide a service to retransform a Sender/Receiver/Trigger communication.
         - TSR-111108,TSR-10
         - ASIL D
...
.. smi:: SMI-116840
    ...
    **The user of MICROSAR Safe shall ensure that unions are not used for safety-related signals.**
    
    The RTE Analyzer lists the transformers with unsupported union transformations to assist in this integration step.


.. smi:: SMI-311078

    **The user of MICROSAR Safe shall ensure that TLV is not used for safety-related signals.**
    
    The RTE Analyzer lists the transformers with unsupported TLV transformations to assist in this integration step.
...
.. smi:: SMI-105507
    ...
    **The user of MICROSAR Safe shall execute the RTE Analyzer.**
    ...
    The RTE Analyzer performs checks to identify faults in SomeIpXf. Especially out-of-bounds accesses within SomeIpXf are detected. If RTE Analyzer reports a fault, the generated SomeIpXf cannot be used. Moreover it provides the user of MICROSAR Safe with feedback what was generated. This feedback shall be reviewed during integration testing against the intended software design and its configuration.
...
.. smi:: SMI-105508
    ...
    **The user of MICROSAR Safe shall ensure that the RTE Analyzer does not report unsupported templates.**
    ...
    The generated SomeIpXf code is based on templates. The templates are instantiated by the SomeIpXf Generator in different variants. The RTE Analyzer verifies that the analyzed template variants have been tested during the development of the SomeIpXf Generator according to ISO 26262.
...
.. smi:: SMI-105509
    ...
    **The user of MICROSAR Safe shall ensure that SomeIpXf serializes and deserializes the data in the format that is expected by the network.**
    
    Inconsistencies in the communication extract, the configuration of the communication stack, the SomeIpXf configuration and the RTE configuration can lead to missinterpretation of signal group data.
    ...
    The RTE Analyzer lists the APIs of SWCs that use SomeIpXf to assist in this integration step.
    The SomeIpXf API names contain the signal group names.
...
.. smi:: SMI-857106
    ...
    SOMEIPXF requires the following functionality as safety requirements from the RTE:
