 ...
 *********************************************************************************************************************/
#define FEE_DEFAULT_BLOCK_TAG      0xFFFFu
#define FEE_DEFAULT_DATA_INDEX     0xFFu
 ...
 * \reentrant  FALSE
 */
FEE_INLINE_FUNC(Fee_LengthType) Fee_ChunkInfo_GetLinkAddress(Fee_ChunkInfoConstRefType chunk, Fee_BlockIdConstRefType blockId);
 ...
 * \reentrant  FALSE
 */
FEE_INLINE_FUNC(void) Fee_ChunkInfo_NewChunkInfo(Fee_ChunkInfoRefType info_pt , enum Fee_ChunkType chType,
                                                 uint16 payload, uint8 instanceExponent);
 ...
 * \param[in]  chunk_pt
 * \return     content length of given chunk
 * \pre        self is not null
 * \context    TASK
 * \reentrant  FALSE
 */
 ...
 * \reentrant  FALSE
 */
FEE_INLINE_FUNC(enum Fee_MngmtStatus) Fee_ChunkInfo_CreateFromRawData(Fee_ChunkInfoRefType self,
                                                                      Fee_IntBuffer_u32ConstPtrType intBuf, Fee_Bool readOk);
...
FEE_INLINE_FUNC(void) Fee_ChunkInfo_NewChunkInfo(Fee_ChunkInfoRefType info_pt, enum Fee_ChunkType chType, uint16 payload, uint8 instanceExponent)
{
    ...
    temp.isDataChunk_bl = (chType == FEE_CHUNK_DATA); /* PRQA S 4404 */ /* MD_FEE_10.3_essentially_boolean_type */
...
FEE_LOCAL_FUNC(Fee_LengthType) Fee_ChunkInfo_GetChunkSize(Fee_ChunkInfoConstRefType chunk)
{
    ...
    /* PRQA S 3344 1 */ /* MD_FEE_13.2_boolean */
    return (chunk->isPseudoChunk_bl) ? /* PRQA S 4559 */ /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
...
{
    /* PRQA S 3344 1 */ /* MD_FEE_13.2_boolean */
    return ((self->isDataChunk_bl) ? (((uint16)1u << self->InstanceExponent_b8) - 1u) : 1u); /* PRQA S 4559 */ /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
}
                                                                     ...
                                                                     Fee_BlockIdConstRefType blockId)
{
    ...
    if((!chunk->isDataChunk_bl) && (blockId != NULL_PTR)) /* PRQA S 4558, 4116 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
    {
        const Fee_BitFieldType index = (Fee_BitFieldType)((!!chunk->isPseudoChunk_bl) ? blockId->Tag : blockId->DataIndex); /* PRQA S 4558, 4116 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
                                            ...
                                            Fee_Bool readOk)
{
    ...
    if(readOk)
    {
        /* ESCAN00107873: Check the full page to detect already started chunk header/link, even for backwards writing controllers with
           pageSize > 8*/
        if(Fee_Sector_isWholePageErased(sector, intBuf) == FEE_TRUE) /* PRQA S 1881 */  /* MD_FEE_10.4_compare_FeeBool_to_enum */  /* SBSW_FEE_ConstPointer_refParam */
        {
...
#      else
            ...
            const uint16 payload      = (uint16)((intBuf[1] >> 16));
...
#       endif
            ...
            self->isDataChunk_bl = (linkChunkFlag == 0uL); /* PRQA S 4404 */ /* MD_FEE_10.3_essentially_boolean_type */ /* SBSW_FEE_PointerWrite_refParam */
            ...
            instExpOk = (((self->isDataChunk_bl) && (instExp > 0u)) || /* PRQA S 4403, 4558, 4115 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
                         ((!self->isDataChunk_bl) && (instExp == 0u))); /* PRQA S 4403, 4558, 4116 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
            ...
            /* PRQA S 3344 1 */ /* MD_FEE_13.2_boolean */
            if((reservedBits == 0uL) && (self->PayloadSize_b16 > 0u) && (instExpOk) && /* PRQA S 4538, 4115 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
...
FEE_INTERN_FUNC(Fee_Bool) Fee_ChunkInfo_AssignSector(Fee_ChunkInfoRefType self, Fee_SectorRefType sector_pt)
{
    ...
    if(!self->isDataChunk_bl) /* PRQA S 4558, 4116 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
    {
    ...
    return (self->ChunkBaseOffset_t != 0uL); /* PRQA S 4403 */ /* MD_FEE_10.3_essentially_boolean_type */
}
...
#   endif
    ...
    if(linkStatus == FEE_MNGMT_CONSISTENT)
    {
        ...
        if((!Fee_Sector_containsAbsAddr(sector, linkAddress - 1u))     /* PRQA S 4558, 4116 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */     /* SBSW_FEE_ConstPointer_refParam */
           || (Fee_Sector_alignAddress(sector, linkAddress) != linkAddress) /* SBSW_FEE_ConstPointer_refParam */
           || (base > self->ChunkBaseOffset_t)
           || (self->ChunkBaseOffset_t >= Fee_Sector_AbsAddr2Offset(sector, linkAddress))) /* PRQA S 3415 */ /* MD_FEE_13.5_queries*/ /* SBSW_FEE_ConstPointer_refParam */
        {
                                                                        ...
                                                                        Fee_Bool ReadOk)
{
    ...
    /* QAC rule 9.1: assure that blockId struct is initialized in any case.*/
    blockId_pt->DataIndex = FEE_DEFAULT_DATA_INDEX; /* SBSW_FEE_PointerWrite_refParam */
    blockId_pt->Tag = FEE_DEFAULT_BLOCK_TAG; /* SBSW_FEE_PointerWrite_refParam */

    if(!self->isPseudoChunk_bl) /* PRQA S 4558,4116 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
    {
        ...
        if(headerStatus == FEE_MNGMT_CONSISTENT)
        {
            ...
            if((intBuf_au32[1] & headerMask) != 0uL)
            {
                                                          ...
                                                          Fee_IntBuffer_u32PtrType buffer_au32)
{
    ...
    const uint32 dataIndexField = (uint32)((!!self->isDataChunk_bl) ? blockId_pt->DataIndex : self->InstanceExponent_b8); /* PRQA S 4558, 4116 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
    uint32 temp;
                            ...
                            Fee_ChunkInfoConstRefType self, uint16 instanceIndex, Fee_IntBuffer_u32PtrType buffer)
{
    ...
    return Fee_Sector_readMngmtData(sector, addr, buffer, readLen); /* SBSW_FEE_ConstPointer_refParam */
}
                                                                                    ...
                                                                                    Fee_UserDataPtrType buffer_au8, uint16 offset, uint16 length)
{
    ...
    if(self->isDataChunk_bl)
    {
        ...
        result = Fee_Sector_readDataWithoutBlankCheck(sector, addr, buffer_au8, length); /* SBSW_FEE_ConstPointer_refParam */
    }
...
FEE_INTERN_FUNC(void) Fee_ChunkInfo_Construct(Fee_ChunkInfoRefType self, Fee_SectorRefType sector_pt)
{
    ...
    temp.isPseudoChunk_bl = FEE_TRUE; /* PRQA S 4424 */ /* MD_FEE_10.3_essentially_enum_type */
                                                                                       ...
                                                                                       Fee_IntBuffer_u32PtrType buffer_au32)
{
    ...
    {
        /* ESCAN00107873: Read the full page to detect already started chunk header, even for backwards writing controllers with
           pageSize > 8*/
        const Fee_LengthType readLen = Fee_Sector_alignWrite(Fee_ChunkInfo_GetSector(self), FEE_CHUNK_HEADER_SIZE_READ); /* SBSW_FEE_ConstPointer_refParam */ /* SBSW_FEE_ConstPointer_refParam */
                                                                                     ...
                                                                                     Fee_IntBuffer_u32PtrType buffer_au32)
{
    ...
    if(linkAddress != 0uL)
    {
        /* ESCAN00107873: Read the full page to detect already started chunk links, even for backwards writing controllers with
           pageSize > 8*/
        const Fee_LengthType readLen = Fee_Sector_alignWrite(Fee_ChunkInfo_GetSector(self), FEE_CHUNK_HEADER_SIZE_READ); /* SBSW_FEE_ConstPointer_refParam */ /* SBSW_FEE_ConstPointer_refParam */
        retVal = Fee_Sector_readMngmtData(Fee_ChunkInfo_GetSector(self), /* SBSW_FEE_ConstPointer_refParam */
                                    linkAddress,
...
FEE_INTERN_FUNC(void ) Fee_ChunkInfo_SwitchToSuccessor(Fee_ChunkInfoRefType self)
{
    ...
    temp.isPseudoChunk_bl = FEE_FALSE; /* PRQA S 4424 */ /* MD_FEE_10.3_essentially_enum_type */

    /* MWDG-5426: In case Fee forwards to the next chunk, it is wrong to assume that this chunk "inherits" the link errors from the predecessor chunk
       The successor is its own chunk with its own properties. At this point we assume that it is valid. This will lead the Fee to write chunk links
       even when a chunk link before was broken*/
    temp.isLinkDefective_bl = FEE_FALSE; /* PRQA S 4424 */ /* MD_FEE_10.3_essentially_enum_type */
    temp.wasLinkWritten_bl = FEE_FALSE; /* PRQA S 4424 */ /* MD_FEE_10.3_essentially_enum_type */
                                                                                     ...
                                                                                     Fee_IntBuffer_u32ConstPtrType buffer_au32)
{
    ...
    /* PRQA S 3415 1 */ /* MD_FEE_13.5_queries */
    if((address > 0uL) && (Fee_ChunkInfo_isLinkAllowed(self) == FEE_TRUE)) /* PRQA S 1881 */  /* MD_FEE_10.4_compare_FeeBool_to_enum */ /* SBSW_FEE_ConstPointer_refParam */
    {
        const Fee_SectorConstRefType sector = Fee_ChunkInfo_GetSector(self); /* SBSW_FEE_ConstPointer_refParam */
...
{
    *target = *source; /* PRQA S 2916 */ /* MD_FEE_18.6_CopyingToPointerWithGreaterLifetime */ /* SBSW_FEE_PointerWrite_refParam */
}
...
{
    return !!self->isDataChunk_bl; /* PRQA S 4403, 4558, 4116 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */ /* !! makes a a boolean expression -> no casts, etc */
}
...
FEE_INLINE_FUNC(Fee_Bool) Fee_ChunkInfo_isLinkTable(Fee_ChunkInfoConstRefType self)
{
    /* PRQA S 4403, 4558, 4116 1 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
    return !Fee_ChunkInfo_isDataChunk(self); /* SBSW_FEE_Func_passParamByReference */
}
...
{
    /* PRQA S 3344 1 */ /* MD_FEE_13.2_boolean */
    return (Fee_ChunkInfo_isLinkTable(self)) && (self->isPseudoChunk_bl); /* PRQA S 4403, 4558, 4115 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */ /* SBSW_FEE_ConstPointer_refParam */
}
...
{
    return !self->wasLinkWritten_bl; /* PRQA S 4403, 4558, 4116 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
}
...
{
    return !self->isLinkDefective_bl; /* PRQA S 4403, 4558, 4116 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
}
...
{
    Fee_ChunkInfo_setLinkStatus(self, FEE_FALSE, FEE_FALSE); /* PRQA S 4423 */ /* MD_FEE_10.3_essentially_enum_type */ /* SBSW_FEE_PointerWrite_refParam */
}
...
FEE_INTERN_FUNC(void) Fee_ChunkInfo_unconfirmLink(Fee_ChunkInfoRefType self)
{
    ...
    Fee_ChunkInfo_setLinkStatus(self, FEE_TRUE, FEE_TRUE); /* PRQA S 4423 */ /* MD_FEE_10.3_essentially_enum_type */ /* SBSW_FEE_PointerWrite_refParam */
}
...
FEE_INTERN_FUNC(Fee_LengthType) Fee_ChunkInfo_GetInstanceSize(Fee_ChunkInfoConstRefType self)
{
    ...
    const Fee_LengthType managementLength = (Fee_LengthType)((self->isDataChunk_bl)
            ? (FEE_INSTANCE_HEADER_SIZE + FEE_INSTANCE_TRAILER_SIZE) : 0u); /* PRQA S 4559 */ /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
...
FEE_INLINE_FUNC(void) Fee_ChunkInfo_setLinkStatus(Fee_ChunkInfoRefType self, Fee_Bool defective, Fee_Bool written)
{
        self->wasLinkWritten_bl = (written == FEE_TRUE); /* PRQA S 4404, 1881 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.4_compare_FeeBool_to_enum */   /* SBSW_FEE_PointerWrite_refParam */
        self->isLinkDefective_bl = (defective == FEE_TRUE); /* PRQA S 4404, 1881 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.4_compare_FeeBool_to_enum */ /* SBSW_FEE_PointerWrite_refParam */
}
                                                                  ...
                                                                  struct Fee_BlockIdStruct searchBlock, Fee_Bool flsReadOk)
{
    ...
    if((Fee_ChunkInfo_EvaluateHeaderData(&chunk, &blockId_tloc, headerBuffer_au32, flsReadOk) == FEE_MNGMT_CONSISTENT)
                    ...
                    && (((searchBlock.DataIndex) == (blockId_tloc.DataIndex)) || (Fee_ChunkInfo_isLinkTable(&chunk))) /* PRQA S 4558, 4115 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */ /* SBSW_FEE_ConstPointer_refParam */
                    && (Fee_ChunkInfo_Equals(&chunk, mostRecentChunk_pt))) /* PRQA S 4558, 4115 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions */ /* SBSW_FEE_ConstPointer_refParam */ /* SBSW_FEE_ConstPointer_refParam */
    {
