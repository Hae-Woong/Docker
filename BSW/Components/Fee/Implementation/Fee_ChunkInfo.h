 ...
 * \synchronous FALSE
 */
FEE_INTERN_FUNC(enum Fee_FlsRequestStatus) Fee_ChunkInfo_ReadInstanceHeader(Fee_ChunkInfoConstRefType self, uint16 instanceIndex,
                Fee_IntBuffer_u32PtrType buffer);
 ...
 * \synchronous FALSE
 */
FEE_INTERN_FUNC(enum Fee_FlsRequestStatus) Fee_ChunkInfo_ReadInstanceTrailer(Fee_ChunkInfoConstRefType self, uint16 instanceIndex,
                Fee_IntBuffer_u32PtrType buffer_au32);
 ...
 * \synchronous FALSE
 */
FEE_INTERN_FUNC(enum Fee_FlsRequestStatus) Fee_ChunkInfo_ReadInstancePayload(Fee_ChunkInfoConstRefType self, uint16 instanceIndex,
