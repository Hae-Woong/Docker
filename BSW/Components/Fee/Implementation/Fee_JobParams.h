...
struct Fee_tagBlockSpecificJob /* <! Gathers Block specfic job parameters */
{
    ...
    union /* PRQA S 0750 1 */ /* MD_MSR_Union */ /*<! only one of the jobs is valid at any time */
    {
...
union Fee_tagJobSpecificParams /* PRQA S 0750 1 */ /* MD_MSR_Union */ /*<! Gathers all possible asynchronous job params */
{
