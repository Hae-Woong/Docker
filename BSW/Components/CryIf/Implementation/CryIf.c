                                                    ...
                                                    P2VAR(Crypto_KeyStatusType, AUTOMATIC, CRYIF_APPL_VAR) keyStatusPtr)
{
  ...
  {
    /* ----- Implementation ----------------------------------------------- */
    retVal = CryIf_GetKeyGetStatusOfCryptoFunctions(CryIf_GetCryptoFunctionsIdxOfKey(cryIfKeyId))(CryIf_GetRefOfKey(cryIfKeyId), keyStatusPtr); /* SBSW_CRYIF_API_CALL_FORWARDING_ID_AND_PTR */
  }
...
FUNC(Std_ReturnType, CRYIF_CODE) CryIf_KeySetInvalid(uint32 cryIfKeyId)
{
  ...
  {
    /* ----- Implementation ----------------------------------------------- */
    retVal = CryIf_GetKeySetInvalidOfCryptoFunctions(CryIf_GetCryptoFunctionsIdxOfKey(cryIfKeyId))(CryIf_GetRefOfKey(cryIfKeyId)); /* SBSW_CRYIF_API_CALL_FORWARDING_ID_ONLY */
  }
