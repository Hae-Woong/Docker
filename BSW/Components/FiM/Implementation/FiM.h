 ...
 *                        vistne  DEM-6637      Optimize FiM_UFidHdl_Init
 *                        vistne  DEM-6935      ESCAN00111496: Endless loop during initialization of FiM
 *                        vistne  DEM-6933      ESCAN00109734: Missing MemMap guard for definition of FiM_ConfigDataPtr
 *                        vistne  DEM-7769      ESCAN00112991: Undefined behavior if APIs FiM_DemTriggerOnMonitorStatus
 *                                              or FiM_DemInitSatellite are invoked
 *                        vistne  DEM-7787      ESCAN00112480: Compiler warning: enumerated type mixed with another type
 *                                              (ApplicationType)
 *                        vistne  DEM-7346      FiM: Rename compiler abstractions
 *                        vistne  DEM-7154      Usage of <Ma>_MemMap.h in FiM
 **********************************************************************************************************************/
#if !defined(FIM_H)
#define FIM_H
...
#if (  (FIM_CFG_GEN_MAJOR_VERSION != (10u)) \
    || (FIM_CFG_GEN_MINOR_VERSION !=  (0u)) )
...
#if (  (FIM_CFG_SW_MAJOR_VERSION != (10u)) \
    || (FIM_CFG_SW_MINOR_VERSION !=  (0u)) )
...
#define FIM_SW_MAJOR_VERSION                        (10u) /* decimal coded version number         */
#define FIM_SW_MINOR_VERSION                        (0u)
#define FIM_SW_PATCH_VERSION                        (0u)  /* decimal coded release version number */
