...
#------------------------------------------------------------------------------
# 1.00.00   2012-06-29  mhe     initial CFG5 version derived from
#                               Gw_AsrPduR_Cfg5
# 1.00.00   2012-07-19  get     Lower   case module abbreviation
# 1.00.00   2012-07-23  ade     Adapt   to AR4
# 1.00.00   2012-11-05  tne     corrected comments
# 2.00.00   2014-02-21  tne     added FiM_PBcfg.c
# 2.01.00   2019-02-06  vircbl  Added support of component-based SIP structure
# 10.00.00  2023-06-30  vistne  DEM-6536  Splitting files according Unit Design
#------------------------------------------------------------------------------
...
LIBRARIES_TO_BUILD      += FiM
FiM_FILES                = FiM$(BSW_SRC_DIR)\FiM.c
FiM_FILES               += FiM$(BSW_SRC_DIR)\FiM_LHelper.c
FiM_FILES               += FiM$(BSW_SRC_DIR)\FiM_UEvHdl.c
FiM_FILES               += FiM$(BSW_SRC_DIR)\FiM_UFidHdl.c
FiM_FILES               += FiM$(BSW_SRC_DIR)\FiM_UGeneral.c
FiM_FILES               += FiM$(BSW_SRC_DIR)\FiM_UInhStatHdl.c
FiM_FILES               += FiM$(BSW_SRC_DIR)\FiM_UPendCntHdl.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += FiM$(BSW_SRC_DIR)\FiM.c
CC_FILES_TO_BUILD       += FiM$(BSW_SRC_DIR)\FiM_LHelper.c
CC_FILES_TO_BUILD       += FiM$(BSW_SRC_DIR)\FiM_UEvHdl.c
CC_FILES_TO_BUILD       += FiM$(BSW_SRC_DIR)\FiM_UFidHdl.c
CC_FILES_TO_BUILD       += FiM$(BSW_SRC_DIR)\FiM_UGeneral.c
CC_FILES_TO_BUILD       += FiM$(BSW_SRC_DIR)\FiM_UInhStatHdl.c
CC_FILES_TO_BUILD       += FiM$(BSW_SRC_DIR)\FiM_UPendCntHdl.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\FiM_Lcfg.c
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\FiM_PBcfg.c
