 ...
 *         \file  PduR.h
 *         \unit  PduR_General
 *        \brief  Pdu Router General header file
 ...
 *           2018-02-23  visfrm  ESCAN00098624   Compiler error: 'PduR_IsIfCancelTransmitSupportedOfMmRom'/'PduR_MultipleSourceHandler_IfCancelTransmit' undefined
 ...
 * 17.00.00  2021-03-31  visfrm  COM-2332        PduR: Test FETA Analysis from VCA
 * 17.00.01  2021-07-12  visfrm  ESCAN00109450   Undefined ECU behavior due to incorrect cast for queued transport protocol Tx API forwarding routing paths
 * 17.01.00  2021-08-02  visfrm  COM-2355        Use CSL05 instead of getPartitionIndexOfCslArray() API
 *           2021-08-06  visfrm  COM-2614        Support Helix QAC 2021.1
 * 17.02.00  2021-08-20  visssg  COM-2706        Usage of <Ma>_MemMap.h in PduR
 * 18.00.00  2021-10-26  visfrm  COM-2999        Improve Units for Test2020
 *           2022-01-20  visfrm  COM-3122        Rework PduR preprocessor variants and use CompileTimeChecking where useful
 *           2022-04-25  visfrm  ESCAN00111759   PduR returns incorrect buffer size via CopyRxData API
 *           2022-04-29  visfrm  ESCAN00111799   Queued Transport Protocol routing path does not work
 *           2022-06-10  visfrm  ESCAN00112084   Processing of PduR Multicore Queue (McQ) can result in endless loop inside the PduR Mainfunction
 *           2022-07-18  visaol  COM-3947        Design and Implementation of PduR_Mm
 *           2022-07-26  visfrm  COM-3858        Remove PduR switching functionality
 * 18.01.00  2022-12-07  visaol  ESCAN00113218   Unqueued Communication Interface N:1 API Forwarding Routing Paths are not reset when its routing path group is disabled
 *           2022-12-07  visfrm  COM-4047        Simplify Bm Unit
 * 18.02.00  2023-01-02  visfrm  COM-4200        Replace VStdMemCpyRamToRam and VStdMemCpyRomToRam with VStdLib_MemCpy_s
 *           2023-01-10  visaol  COM-4207        PduR resolve compiler warnings
 *           2023-01-16  visfrm  ESCAN00113524   Meta data is sent inside the payload of Transport Protocol routing path
 * 18.03.00  2023-01-24  visfrm  COM-4266        Add additional handle ID runtime checks
 *           2023-01-25  visfrm  COM-4273        Simplify PartitionLookup
 *           2023-01-27  visfrm  COM-4263        Cleanup coverage justifications and unnecessary if conditions
 *           2023-01-30  visfrm  COM-1184        Replace RH by VCA
 *           2023-02-08  visfrm  ESCAN00113567   Out-of-bounds memory access during queued transport protocol Tx forwarding routing path
 *           2023-02-14  visfrm  COM-4333        Improve RoutingPathGroup memory mapping
 * 18.03.01  2023-10-09  vismvi  ESCAN00115868   MISRA deviation: MISRA-C:2012
 *           2023-10-11  visfrm  ESCAN00115813   VCA plugin is missing 'PduR_LoTpCopyRxData' API as entry function
 ...
 *           2023-10-13  visfrm  ESCAN00115822   Compiler error in PduR_Fm.c: parse error near 'PduR_FmFifoRomIterType'
 *           2023-10-13  visfrm  ESCAN00114972   VCA reports errors for APIs of neighbouring modules
 * 18.03.02  2023-11-22  visfrm  ESCAN00114427   PduR calls <DestModule>_Transmit/StartOfReception/CopyRxData/TpRxIndication APIs in incorrect partition/core context
 *           2023-11-22  visfrm  ESCAN00114315   Deferred processing of routing paths may suddenly not work anymore
 *********************************************************************************************************************/
#ifndef PDUR_H
# define PDUR_H
...
# define PDUR_SW_MAJOR_VERSION  18u  /**< Major version */
# define PDUR_SW_MINOR_VERSION   3u  /**< Minor version */
# define PDUR_SW_PATCH_VERSION   2u  /**< Patch level version */
...
/*! An API was called in the wrong partition context. */
# define PDUR_E_INVALID_PARTITION_CONTEXT      ((uint8)0xB5u)
/*! A QAL API is not supported for this destination Pdu. */
# define PDUR_E_QAL_UNSUPPORTEDAPI             ((uint8)0xC0u)
/*! Fatal error */
...
/*! Service ID internal function */
# define PDUR_FCT_RMIF_FQ              ((uint8)0x84u)
/*! Service ID internal function */
...
/*! Service ID internal function */
# define PDUR_LOCK_UNLOCK ((uint8)0xD6u)

/*! Service ID internal function */
# define PDUR_IFQ_PUT ((uint8)0xD7u)
...
/*! Service ID internal function */
# define PDUR_FCT_QAL_PUT          ((uint8)0xE0u)
/*! Service ID internal function */
# define PDUR_FCT_QAL_GET          ((uint8)0xE1u)
/*! Service ID internal function */
# define PDUR_FCT_QAL_REMOVE       ((uint8)0xE2u)
/*! Service ID internal function */
# define PDUR_FCT_QAL_GETFILLLEVEL ((uint8)0xE3u)
/*! Service ID internal function */
# define PDUR_FCT_QAL_FLUSH        ((uint8)0xE4u)

/*! Service ID internal function */
# define PDUR_MM_CALLIFTXCONFIRMATION ((uint8)0xE5u)
/*! Service ID internal function */
# define PDUR_MM_CALLIFTRANSMIT ((uint8)0xE6u)
/*! Service ID internal function */
# define PDUR_MM_CALLIFCANCELTRANSMIT ((uint8)0xE7u)
/*! Service ID internal function */
# define PDUR_MM_CALLIFTRIGGERTRANSMIT ((uint8)0xE8u)
/*! Service ID internal function */
# define PDUR_MM_CALLIFRXINDICATION ((uint8)0xE9u)
/*! Service ID internal function */
# define PDUR_MM_CALLTPTRANSMIT ((uint8)0xEAu)
/*! Service ID internal function */
# define PDUR_MM_CALLTPCANCELTRANSMIT ((uint8)0xEBu)
/*! Service ID internal function */
# define PDUR_MM_CALLTPCOPYTXDATA ((uint8)0xECu)
/*! Service ID internal function */
# define PDUR_MM_CALLTPTXCONFIRMATION ((uint8)0xEDu)
/*! Service ID internal function */
# define PDUR_MM_CALLTPSTARTOFRECEPTION ((uint8)0xEEu)
/*! Service ID internal function */
# define PDUR_MM_CALLTPRXINDICATION ((uint8)0xEFu)
/*! Service ID internal function */
# define PDUR_MM_CALLTPCOPYRXDATA ((uint8)0xF0u)
/*! Service ID internal function */
# define PDUR_MM_CALLTPCANCELRECEIVE ((uint8)0xF3u)
/*! Service ID internal function */
# define PDUR_MM_CALLTPCHANGEPARAMETER ((uint8)0xF4u)
 ...
 *               In Multi partition UseCase: This function has to be called once in every partition context.
 ...
 *********************************************************************************************************************/
/*!
 * \brief        This function transmits the corresponding upper layer I-PDU to the configured destinations.
 ...
 * \synchronous TRUE
 * \note        The function is called by an upper layer module.
 ...
 *********************************************************************************************************************/
/*!
 * \brief        This function receives a lower layer I-PDU and routes it to the configured destinations.
 *               The I-PDU is routed to the destination module using the appropriate I-PDU handle of the destination module.
 *  \details     -
 ...
 * \note         The function is called by the lower layer communication interface modules.
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
/*!
 * \brief          This function is called by the lower layer to request the lower layer TX I-PDU before transmission.
 *                 The call will either be forwarded to the upper layer module or
 *                 the I-PDU data will be read from a PduR queue in case of a queued routing path.
 *  \details       -
 ...
 *********************************************************************************************************************/
/*!
 * \brief       This function is called by the lower layer to confirm the complete transmission of a lower layer I-PDU.
 *              The call will either be forwarded to the upper layer module or
 *              is used to confirm the latest transmitted Pdu from a PduR queue. In this context the next Pdu from the queue will be transmitted to the destination.
 * \details      -
 ...
 * \note         The function is called by the lower layer transport protocol modules.
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
/*!
 * \brief       This function is called by the lower layer Tp if data has to be copied to the receiving module.
 *              Each call to this function copies the next part of the received data. Several calls may be made during reception of an TP-PDU.
 ...
 *                        A Pdu size of 0 can be used to poll the available buffer size.
 ...
 *                                The Pdu data will be copied to this buffer either by the upper layer module
 *                                or by the PduR in case of a queue routing path.
 *                                A Pdu size of 0 can be used to poll the available Tx data via availableDataPtr.
 ...
 *********************************************************************************************************************/
/*!
 * \brief       The function is called by the lower layer Tp to finish and confirm the complete transmission of a lower layer Tp I-PDU.
 ...
 *********************************************************************************************************************/
/*!
 * \brief       This function requests cancellation of an ongoing reception of a PDU in a lower layer transport protocol module.
 *              The call is routed to a lower TP module using the appropriate I-PDU handle of the destination module.
 * \details     -
 ...
 * \note        The function is called by the upper layer modules.
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
/*!
 * \brief       The function requests cancellation of an ongoing transmission of a PDU in a lower layer module.
 *              The call is routed to a lower IF/TP module using the appropriate I-PDU handle of the destination module.
 * \details     -
 * \param[in]   id                ID of the upper layer I-PDU to be cancelled
 * \return      Std_ReturnType
 *              E_OK              Cancellation was executed successfully by the destination module.
 ...
 *********************************************************************************************************************/
/*! \brief       Processes all destinations on this destination application
 *  \details     -
 ...
 *  \param[in]   id    ID of the routing path group.
 *  \pre         -
 *  \context     TASK|ISR1|ISR2
 *  \reentrant   TRUE for different handle IDs
 *  \synchronous TRUE
 ...
 *               PduRRoutingPathGroups is enabled if one related PduRRoutingPathGroups is enabled.
 **********************************************************************************************************************/
 ...
 *  \note        The function is called by the BSW Mode Manager.
 *               The routing of a destination PDU of a PduRRoutingPath which is contained in multiple
 *               PduRRoutingPathGroups is disabled if all related PduRRoutingPathGroups are disabled.
 *********************************************************************************************************************/
 ...
 * \length SHORT to LONG depending on the usage of a queue, the PduRDestPduDataProcessing and the runtime in the destination module.
 * \endexclusivearea
 */
