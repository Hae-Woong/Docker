 ...
 *         \file  PduR_McQ.c
 *         \unit  McQ
 *        \brief  Pdu Router Multicore Queue source file
 ...
 *********************************************************************************************************************/
/*! \brief      Get the current read idx for the McQ buffer.
 *  \details    -
 ...
 *********************************************************************************************************************/
/*! \brief      Get the current write idx for the McQ buffer.
 *  \details    -
 *  \param[in]  mcqBufferRomIdx    id of the McQ Buffer
 *  \param[in]  memIdx             memory section index
 ...
 *********************************************************************************************************************/
/*! \brief      Get the current pending Read idx for the McQ buffer.
 *  \details    -
 *  \param[in]  mcqBufferRomIdx    id of the McQ Buffer
 *  \param[in]  memIdx             memory section index
 *  \return     the pending read index
 *  \pre        -
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
/*! \brief      Get the current pending Write idx for the McQ buffer.
 *  \details    -
 *  \param[in]  mcqBufferRomIdx    id of the McQ Buffer
 *  \param[in]  memIdx             memory section index
 *  \return     the pending write index
 *  \pre        -
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
/*! \brief      This function writes an unused value to the write position.
 *  \details    -
 ...
 *  \pre        -
 *********************************************************************************************************************/
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_McQ_SerializeTxConfirmation(PduR_McQBufferArrayRamWriteIdxOfMcQBufferRamType writeIdx, PduR_RmDestRomEndIdxOfRmSrcRomType rmDestRomIdx, PduR_MemIdxType memIdx);
#endif
 ...
 *  \pre         -
 *********************************************************************************************************************/
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_McQ_DeserializeData(PduR_McQBufferArrayRamReadIdxOfMcQBufferRamType readIdx,
 ...
 *  \pre         -
 *********************************************************************************************************************/
PDUR_LOCAL_INLINE FUNC(PduR_RmDestRomEndIdxOfRmSrcRomType, PDUR_CODE) PduR_McQ_ReadTxConfirmation(PduR_McQBufferRomIdxOfSrcApplicationRomType mcQBufferRomIdx,
 ...
 * PduR_McQ_ReadFlush
 *********************************************************************************************************************/
/*! \brief       Reads all contents of the mcq by setting the readIdx to the writeIdx.
 *  \details     This function will not process anything from the queue.
 *  \param[in]   mcQBufferRomIdx        Id of the queue to be used
 *  \param[in]   memIdx                 memory section index
 *  \pre         -
 *  \context     TASK|ISR1|ISR2
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_McQ_ReadFlush(PduR_McQBufferRomIdxOfSrcApplicationRomType mcQBufferRomIdx, PduR_MemIdxType memIdx);
#endif
 ...
 *********************************************************************************************************************/
/*! \brief       Set the provided readIdx as pending readIdx.
 *  \details -
 *  \param[in]   mcQBufferRomIdx         Id of the queue to be used
...
FUNC(void, PDUR_CODE) PduR_McQ_Init(PduR_MemIdxType memIdx)
{
  ...
  for(mcqBufferRomIdx = 0u; mcqBufferRomIdx < PduR_GetSizeOfMcQBufferRom(memIdx); mcqBufferRomIdx++)  /* FETA_PDUR_01 */
  {
    ...
    PduR_SetMcQBufferArrayRamPendingWriteIdxOfMcQBufferRam(mcqBufferRomIdx, startIdxOfBuffer, memIdx);
    PduR_SetMcQBufferArrayRamPendingReadIdx(mcqBufferRomIdx, startIdxOfBuffer, memIdx);
    PduR_SetMcQBufferArrayRamReadIdxOfMcQBufferRam(mcqBufferRomIdx, startIdxOfBuffer, memIdx);
    PduR_SetMcQBufferArrayRamWriteIdxOfMcQBufferRam(mcqBufferRomIdx, startIdxOfBuffer, memIdx);
  }
}
#endif
...
FUNC(Std_ReturnType, PDUR_CODE) PduR_McQ_WriteTxConfirmation(PduR_McQBufferRomIdxOfSrcApplicationRomType mcQBufferRomIdx, PduR_RmDestRomEndIdxOfRmSrcRomType rmDestRomIdx , PduR_MemIdxType memIdx)
{
  ...
  if(PduR_McQ_GetWriteIdx(mcQBufferRomIdx, &writeIdx, PduR_McQ_GetTxConfirmationSize(), memIdx) == E_OK)
  {
    /* #20 Serialize tx Confirmation handle into the queue starting at the writeIdx position */
    PduR_McQ_SerializeTxConfirmation(writeIdx, rmDestRomIdx, memIdx);
...
# endif
  {
    ...
    if(PduR_McQ_GetWriteIdx(mcQBufferRomIdx, &writeIdx, data->SduLength + PduR_McQ_GetDataHeaderSize(), memIdx) == E_OK)
    {
      PduR_McQ_SerializeData(writeIdx, rmDestRomIdx, data, memIdx);
      PduR_McQ_UpdateWriteIdx(mcQBufferRomIdx, memIdx);
      retVal = E_OK;
    }
    /* #40 Otherwise return E_NOT_OK */
...
/* ----- Development Error Report --------------------------------------- */
  ...
  {
    PduR_Reporting_ReportError(PDUR_MCQ_WRITE_DATA, errorId);  /* PRQA S 2880 */ /* MD_PduR_2880 */
  }
                                                                  ...
                                                                  PduR_MemIdxType memIdx)
{
  ...
  else if(localWriteIdx < readIdx)      /* write is possible until read Idx is reached. Could be too small though */
  {
    ...
    if(linearBufferSize >= pduLengthWithHeader)
    {
      *writeIdx = localWriteIdx;
      ...
      PduR_SetMcQBufferArrayRamPendingWriteIdxOfMcQBufferRam(mcqBufferRomIdx, localWriteIdx + (PduR_McQBufferArrayRamWriteIdxOfMcQBufferRamType) pduLengthWithHeader, memIdx);
      retVal = E_OK;
    }
  ...
  {     /* readIdx < localWriteIdx OR readIdx == localWriteIdx */
    ...
    linearBufferSizeAtEnd = (localWriteIdx == endIdxOfBuffer) ? 0u : (PduR_McQBufferArrayRamWriteIdxOfMcQBufferRamType) (endIdxOfBuffer - localWriteIdx);
    linearBufferSizeAtFront = (readIdx == startIdxOfBuffer) ? 0u : (PduR_McQBufferArrayRamWriteIdxOfMcQBufferRamType) (readIdx - startIdxOfBuffer - 1u);
    ...
    else if(linearBufferSizeAtFront >= pduLengthWithHeader)
    {
      ...
      *writeIdx = startIdxOfBuffer;
      ...
      /* Update write Idx */
      PduR_SetMcQBufferArrayRamPendingWriteIdxOfMcQBufferRam(mcqBufferRomIdx, startIdxOfBuffer + (PduR_McQBufferArrayRamStartIdxOfMcQBufferRomType) pduLengthWithHeader, memIdx);
  ...
  /*@ assert retVal != E_OK || (*writeIdx < PduR_GetSizeOfMcQBufferArrayRam(memIdx)); */
  return retVal;
}
#endif
...
PDUR_LOCAL_INLINE FUNC(uint8, PDUR_CODE) PduR_McQ_GetTxConfirmationSize(void)
{
  return PDUR_MCQ_SIZE_OF_HEADER + sizeof(PduR_RmDestRomEndIdxOfRmSrcRomType);
}
#endif
                                                          ...
                                                          CONSTP2CONST(PduInfoType, AUTOMATIC, PDUR_APPL_DATA) data, PduR_MemIdxType memIdx)
{
  ...
  /* #20 Serialize rmDestRomIdx */
  {
    ...
    for(; rmDestRomIterator < sizeof(PduR_RmDestRomEndIdxOfRmSrcRomType); rmDestRomIterator++)  /* FETA_PDUR_04 */
    {
      tempRmDestRomIdx = tempRmDestRomIdx >> shiftOperand;      /* PRQA S 2985 */ /* MD_PduR_2985_2986 */
      PduR_McQBufferArrayRamWrite(writeIdxIntern, (uint8) tempRmDestRomIdx, memIdx);
      shiftOperand = 8u;        /* PRQA S 2983 */ /* MD_PduR_2982_2983 */
      writeIdxIntern++;
    }
  }
  /* #30 Serialize PduLengthType */
  {
    ...
    for(; pduLengthTypeIterator < sizeof(PduLengthType); pduLengthTypeIterator++)  /* FETA_PDUR_04 */
    {
      PduR_McQBufferArrayRamWrite(writeIdxIntern, (uint8) tempPduLength, memIdx);
      tempPduLength = tempPduLength >> 8u;      /* PRQA S 2983 */ /* MD_PduR_2982_2983 */
      writeIdxIntern++;
    }
  }
  /* #40 Serialize Payload */
  VStdLib_MemCpy_s(PduR_GetAddrMcQBufferArrayRam(writeIdxIntern, memIdx), ((VStdLib_CntType) PduR_GetSizeOfMcQBufferArrayRam(memIdx) - writeIdxIntern) , data->SduDataPtr, data->SduLength); /* PRQA S 0315 */ /* MD_MSR_VStdLibCopy */
}
#endif
...
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_McQ_SerializeTxConfirmation(PduR_McQBufferArrayRamWriteIdxOfMcQBufferRamType writeIdx, PduR_RmDestRomEndIdxOfRmSrcRomType rmDestRomIdx, PduR_MemIdxType memIdx)
{
  ...
  /* #20 Serialize rmDestRomIdx */
  {
    ...
    for(; rmDestRomIterator < sizeof(PduR_RmDestRomEndIdxOfRmSrcRomType); rmDestRomIterator++)  /* FETA_PDUR_04 */
    {
      ...
      PduR_McQBufferArrayRamWrite(writeIdxIntern, (uint8) tempRmDestRomIdx, memIdx);
      shiftOperand = 8u;        /* PRQA S 2983 */ /* MD_PduR_2982_2983 */
      writeIdxIntern++; /* PRQA S 2983 */ /* MD_PduR_2982_2983 */
    }
  }
}
#endif
...
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_McQ_DeserializeData(PduR_McQBufferArrayRamReadIdxOfMcQBufferRamType readIdx,
                                                            ...
                                                            PduR_MemIdxType memIdx)
{
  PduR_McQBufferArrayRamReadIdxOfMcQBufferRamType readIdxIntern = readIdx;
  /* skip Header */
  ...
  /* #10 Deserialize rmDestRomIdx */
  {
    ...
    for(; rmDestRomIterator < sizeof(PduR_RmDestRomEndIdxOfRmSrcRomType); rmDestRomIterator++)  /* FETA_PDUR_04 */
    {
      tempRmDestRomIdx = tempRmDestRomIdx | (((PduR_RmDestRomEndIdxOfRmSrcRomType) PduR_GetMcQBufferArrayRam(readIdxIntern, memIdx)) << offset);        /* PRQA S 2985 */ /* MD_PduR_2985_2986 */
      offset += 8u;     /* PRQA S 2983 */ /* MD_PduR_2982_2983 */
      readIdxIntern++;
    }
  ...
  data->SduDataPtr = PduR_GetAddrMcQBufferArrayRam(readIdxIntern, memIdx);
}
#endif
...
{
  /* #10 Deserialize Data */
  PduR_McQ_DeserializeData(readIdx, rmDestRomIdx, data, memIdx);
  /* #20 Set the returned ReadIdx as pending ReadIdx: the readIdx will be set to this value if the read is finished */
  PduR_SetMcQBufferArrayRamPendingReadIdx(mcQBufferRomIdx, readIdx + (PduR_McQBufferArrayRamReadIdxOfMcQBufferRamType) PduR_McQ_GetDataHeaderSize() + (PduR_McQBufferArrayRamReadIdxOfMcQBufferRamType) data->SduLength, memIdx);
}
#endif
                                                                 ...
                                                                 PduR_MemIdxType memIdx)
{
  ...
  /*@ assert retVal != E_OK || *readIdx < PduR_GetSizeOfMcQBufferArrayRam(memIdx); */
  return retVal;
}
#endif
...
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_McQ_UpdateReadIdx(PduR_McQBufferRomIdxOfSrcApplicationRomType mcQBufferRomIdx, PduR_MemIdxType memIdx)
{
  PduR_SetMcQBufferArrayRamReadIdxOfMcQBufferRam(mcQBufferRomIdx, PduR_McQ_GetMcQBufferArrayRamPendingReadIdxSafe(mcQBufferRomIdx, memIdx), memIdx);
}
#endif
...
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_McQ_ReadFlush(PduR_McQBufferRomIdxOfSrcApplicationRomType mcQBufferRomIdx, PduR_MemIdxType memIdx)
{
  ...
  PduR_SetMcQBufferArrayRamReadIdxOfMcQBufferRam(mcQBufferRomIdx, writeIdx, memIdx);
  PduR_SetMcQBufferArrayRamPendingReadIdx(mcQBufferRomIdx, writeIdx, memIdx);
}
#endif
...
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_McQBufferArrayRamWrite(PduR_McQBufferArrayRamWriteIdxOfMcQBufferRamType writeIdx, uint8 byteToBeWritten, PduR_MemIdxType memIdx)
{
  if(writeIdx < PduR_GetSizeOfMcQBufferArrayRam(memIdx))
  {
    PduR_SetMcQBufferArrayRam(writeIdx, byteToBeWritten, memIdx);
  }
  else
  {
    PduR_Reporting_ReportError(PDUR_MCQ_WRITE_DATA, PDUR_E_FATAL);
  }
}
#endif
...
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_McQ_UpdateWriteIdx(PduR_McQBufferRomIdxOfSrcApplicationRomType mcQBufferRomIdx, PduR_MemIdxType memIdx)
{
  PduR_SetMcQBufferArrayRamWriteIdxOfMcQBufferRam(mcQBufferRomIdx, PduR_McQ_GetMcQBufferArrayRamPendingWriteIdxSafe(mcQBufferRomIdx, memIdx), memIdx);
}
#endif
...
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_SetMcQBufferArrayRamPendingReadIdx(PduR_McQBufferRomIterType mcQBufferRomIdx, PduR_McQBufferArrayRamPendingReadIdxOfMcQBufferRamType readIdx, PduR_MemIdxType memIdx)
{
  if(readIdx < PduR_GetMcQBufferArrayRamEndIdxOfMcQBufferRom(mcQBufferRomIdx, memIdx))
  {
    PduR_SetMcQBufferArrayRamPendingReadIdxOfMcQBufferRam(mcQBufferRomIdx, readIdx, memIdx);
  }
  else
  {
    PduR_Reporting_ReportError(PDUR_MCQ_PENDING_READ_IDX, PDUR_E_FATAL);
  }
}
#endif
...
FUNC(void, PDUR_CODE) PduR_McQ_MainFunction(PduR_DestApplicationManagerRomIterType destApplicationManagerRomIdx)
{
  ...
  for(srcApplicationRomIdx = PduR_GetSrcApplicationRomStartIdxOfDestApplicationManagerRom(destApplicationManagerRomIdx); srcApplicationRomIdx < PduR_GetSrcApplicationRomEndIdxOfDestApplicationManagerRom(destApplicationManagerRomIdx); srcApplicationRomIdx++)  /* FETA_PDUR_01 */
  {
    if(PduR_IsMcQBufferRomUsedOfSrcApplicationRom(srcApplicationRomIdx))
    {
      ...
      PduR_McQBufferRomPartitionIdxOfSrcApplicationRomType memIdx = PduR_GetMcQBufferRomPartitionIdxOfSrcApplicationRom(srcApplicationRomIdx);
      ...
      while(PduR_McQ_GetReadIdx(mcQBufferRomIdx, &readIdx, memIdx) == E_OK)     /* FETA_PDUR_02 */
      {
        switch (PduR_GetMcQBufferArrayRam(readIdx, memIdx))
        {
          ...
          {
            PduR_RmDestRomEndIdxOfRmSrcRomType rmDestRomIdx = 0u;
            PduInfoType info;

            PduR_McQ_ReadData(mcQBufferRomIdx, readIdx, &rmDestRomIdx, &info, memIdx);

            if(PduR_RmIf_IsRmDestRomIdxUnqueuedIFCrossPartition(rmDestRomIdx, PduR_GetDestApplicationManagerRomSourceIdxOfSrcApplicationRom(srcApplicationRomIdx), destApplicationManagerRomIdx))
            {
              (void) PduR_RmIf_ProcessDestPdu(rmDestRomIdx, &info);
            }
          ...
          {
            PduR_RmDestRomEndIdxOfRmSrcRomType rmDestRomIdx = PduR_McQ_ReadTxConfirmation(mcQBufferRomIdx, readIdx, memIdx);
            PduR_McQ_UpdateReadIdx(mcQBufferRomIdx, memIdx);
            if(PduR_RmIf_IsRmDestRomIdxUnqueuedIFCrossPartitionTxConfirmation(rmDestRomIdx, PduR_GetDestApplicationManagerRomSourceIdxOfSrcApplicationRom(srcApplicationRomIdx), destApplicationManagerRomIdx))
            {
          ...
          default:     /* COV_PDUR_MISRA */
            PduR_Reporting_ReportError(PDUR_MCQ_MAINFUNCTION, PDUR_E_FATAL);
            /* Reset the queue by reading all its content. */
            PduR_McQ_ReadFlush(mcQBufferRomIdx, memIdx);
            break;
        }
...
# if (PDUR_EXTENDED_ERROR_CHECKS == STD_ON)  /* COV_PDUR_VAR_EXTENDED_ERROR_CHECKS */
  ...
  if(readIdx >= endIdxOfQueue)
  {
    ...
    PduR_Reporting_ReportRuntimeError(PDUR_FCT_GETMCQREADIDX, PDUR_E_IDXOUTOFBOUNDS);
  }
...
# endif
  /*@ assert (readIdx  < PduR_GetSizeOfMcQBufferArrayRam(memIdx)); */
  return readIdx;
}
#endif
...
# if (PDUR_EXTENDED_ERROR_CHECKS == STD_ON)  /* COV_PDUR_VAR_EXTENDED_ERROR_CHECKS */
  ...
  if(writeIdx >= endIdxOfQueue)
  {
    ...
    PduR_Reporting_ReportRuntimeError(PDUR_FCT_GETMCQWRITEIDX, PDUR_E_IDXOUTOFBOUNDS);
  }
...
# endif
  /*@ assert (writeIdx  < PduR_GetSizeOfMcQBufferArrayRam(memIdx)); */
  return writeIdx;
}
#endif
...
# if (PDUR_EXTENDED_ERROR_CHECKS == STD_ON)  /* COV_PDUR_VAR_EXTENDED_ERROR_CHECKS */
  ...
  if(readIdx >= endIdxOfQueue)
  {
    ...
    PduR_Reporting_ReportRuntimeError(PDUR_FCT_GETMCQPENDINGREADIDX, PDUR_E_IDXOUTOFBOUNDS);
  }
  if(readIdx < startIdxOfQueue)
  {
    readIdx = startIdxOfQueue;
...
# if (PDUR_EXTENDED_ERROR_CHECKS == STD_ON)  /* COV_PDUR_VAR_EXTENDED_ERROR_CHECKS */
  ...
  if(writeIdx >= endIdxOfQueue)
  {
    ...
    PduR_Reporting_ReportRuntimeError(PDUR_FCT_GETMCQPENDINGWRITEIDX, PDUR_E_IDXOUTOFBOUNDS);
  }
  if(writeIdx < startIdxOfQueue)
  {
    writeIdx = startIdxOfQueue;
