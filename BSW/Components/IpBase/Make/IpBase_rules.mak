...
#------------------------------------------------------------------------------
# 1.00.00   2010-10-01  visalr  Created
# 1.00.01   2011-12-02  visalr  IpBase_Sock added
# 1.01.00   2017-11-09  visalr  IpBase_Ber added, IpBase_Copy removed
...
LIBRARIES_TO_BUILD      += IpBase
IpBase_FILES             = IpBase$(BSW_SRC_DIR)\IpBase.c IpBase$(BSW_SRC_DIR)\IpBase_Ber.c IpBase$(BSW_SRC_DIR)\IpBase_Code.c IpBase$(BSW_SRC_DIR)\IpBase_Sock.c IpBase$(BSW_SRC_DIR)\IpBase_String.c IpBase$(BSW_SRC_DIR)\IpBase_PBuf.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
ifeq ($(GET_IMPLEMENTION_FROM), LIB)
CC_FILES_TO_BUILD       += 
else
CC_FILES_TO_BUILD       += IpBase$(BSW_SRC_DIR)\IpBase.c IpBase$(BSW_SRC_DIR)\IpBase_Ber.c IpBase$(BSW_SRC_DIR)\IpBase_Code.c IpBase$(BSW_SRC_DIR)\IpBase_Sock.c IpBase$(BSW_SRC_DIR)\IpBase_String.c IpBase$(BSW_SRC_DIR)\IpBase_PBuf.c
endif
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
