 ...
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  _Appl_Rand.c
 *        \brief  Demo random generator source file
 *      \details  Demo random generator (integration support example providing functions required by MICROSAR IP).
 *********************************************************************************************************************/
...
{
# if !defined (APPLRAND_DEACTIVATE_ERROR_DIRECTIVE)
#  error "Appl_Rand.c: Replace the code below with true random number"
# endif
