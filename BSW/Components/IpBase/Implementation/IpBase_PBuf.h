...
/*!        \file  IpBase_PBuf.h
 *         \unit  PBuf
 *        \brief  IpBase buffer handling header file
 *      \details  IpBase buffer handling routines declaration.
 *********************************************************************************************************************/
/**********************************************************************************************************************
 *  REVISION HISTORY
 *  -------------------------------------------------------------------------------------------------------------------
 ...
 *  \param[in,out] SrcPbufPtr            in: pointer to Pbuf string start, out: pointer to PBuf string end
 *  \param[in]     PatternPtr            pointer to string pattern
 *  \param[in,out] CurByteIdxPtr         in: pointer to local start index, out: pointer to local end index [byte]
 *  \param[in,out] TotByteIdxPtr         in: pointer to total start index, out: pointer to total end index [byte]
 *  \param[in,out] RestLenBytePtr        in: pointer to PBuf string start rest length, out: pointer to PBuf string end 
 *                                       rest length
 ...
 *  \param[in,out] PbufPtr               in: pointer to PBuf struct, out: pointer to incremented PBuf struct
 *  \param[in,out] CurByteIdxPtr         in: pointer to current byte idx within PBuf struct, out: pointer to 
 *                                       incremented idx 
 *  \param[in,out] TotByteIdxPtr         in: pointer to total byte idx within PBuf struct, out: pointer to incremented
 *                                       idx 
 *  \pre           -
 *  \context       TASK|ISR2
 *  \reentrant     TRUE
 ...
 *                                       \spec requires $lengthOf(StrPtr) >= StrLen; \endspec
 ...
 *  \details       Find a string in a PBuf starting at a given position within PBuf.
 ...
 *  \param[out]    StrPosPtr             start index of string in PBuf
 ...
 *  \details       Read a byte from PBuf structure.
 *  \param[in]     PbufPtr               pointer to Pbuf struct
