...
/*!        \file  IpBase_Ber.h
 *         \unit  Ber
 *        \brief  IpBase basic encoding rules header file
 *      \details  IpBase basic encoding rules routines declaration.
 *********************************************************************************************************************/
/**********************************************************************************************************************
 *  REVISION HISTORY
 *  -------------------------------------------------------------------------------------------------------------------
 ...
 *                                \spec requires $lengthOf(StackPtr) >= Depth; \endspec
 ...
 *                                \spec requires $lengthOf(WorkspacePtr->Stack) >= WorkspacePtr->MaxDepth; \endspec
 *                                \spec requires WorkspacePtr->MaxDepth >= WorkspacePtr->CurrentDepth; \endspec
