 ...
 *         \unit  String
 *        \brief  IpBase string handling header file
 *      \details  IpBase string handling routines declaration.
 *********************************************************************************************************************/
/**********************************************************************************************************************
 *  REVISION HISTORY
 *  -------------------------------------------------------------------------------------------------------------------
 ...
 *                                   \spec requires $lengthOf(TgtPtr) >= $lengthOf(SrcPtr); \endspec
 ...
 *  \param[out]    TgtPtr            pointer for target string
 *                                   \spec requires $lengthOf(TgtPtr) >= $lengthOf(SrcPtr); \endspec
 *                                   \spec requires $lengthOf(TgtPtr) >= MaxLen; \endspec
 *  \param[in]     SrcPtr            pointer to source string
 ...
 *                                   \spec requires $lengthOf(*StrPtr) >= *StrLenPtr; \endspec
 ...
 *                                   \spec requires $lengthOf(ArrayPtr) >= ArrayLen; \endspec
 *  \param[in]     ArrayLen          array length [byte]
 *  \param[in]     StrPtr            pointer to string
 *  \return        E_OK              array converted
 *  \return        E_NOT_OK          array conversion failed
