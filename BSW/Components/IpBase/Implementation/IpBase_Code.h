...
/*!        \file  IpBase_Code.h
 *         \unit  Code
 *        \brief  IpBase coding header file
 *      \details  IpBase encoding and decoding routines declaration.
 *********************************************************************************************************************/
/**********************************************************************************************************************
 *  REVISION HISTORY
 *  -------------------------------------------------------------------------------------------------------------------
 ...
 *                                \spec requires $lengthOf(TgtDataPtr) >= *TgtLenBytePtr; \endspec
 *  \param[in]     SrcDataPtr     pointer to the raw data
 *                                \spec requires $lengthOf(SrcDataPtr) >= SrcLenByte; \endspec
