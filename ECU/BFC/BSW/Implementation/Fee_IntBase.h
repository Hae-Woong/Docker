...
#define FEE_DUMMY_STATEMENT(v)  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#endif
...
struct Fee_BlockConfigStruct /*< Block Configuration -> filled by FEE generator */
{
    ...
    Fee_BitFieldType LookUpTableBlock_bl : 1; /*!< Determines whether block is a lut block or a "normal user block" */
    uint16 LookUpTableIndex; /*!< LUT base index of the block */
};
