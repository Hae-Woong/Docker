...
#define Fee_Sector_ClearBuffer(self, buf, length) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
 ...
 *********************************************************************************************************************/
/*!
 * \brief      Requests Flash to read (with blank check) the given data at given offset within given sector into the given buffer
 * \details    Requests Flash to read (with blank check) the given data at given offset within given sector into the given buffer
 * \param[in]  self
 * \param[in]  offset
 * \param[in,out]  data
 * \param[in]  byteCount
 * \return     FEE_REQ_ACCEPTED: Flash accepted readBlank request
 * \return     FEE_REQ_REJECTED: Flash rejected readBlank request
 * \pre        self is not null, data is not null
 * \context    TASK
 * \reentrant  FALSE
 * \synchronous FALSE
 ...
 *********************************************************************************************************************/
/*!
 * \brief      Requests Flash to read (without blank check) the given data at given offset within given sector into the given buffer
 * \details    Requests Flash to read (without blank check) the given data at given offset within given sector into the given buffer
 * \param[in]  self
 * \param[in]  offset
 * \param[in,out]  data
 * \param[in]  byteCount
 ...
 *********************************************************************************************************************/
/*!
 * \brief      Checks if given address might be a valid lut address within given sector
 * \details    Checks if given address is between sectors link table end address and its absolute end address
 *             Any lut address may not point into sector header or link table
 * \param[in]  self
 * \param[in]  addr
 * \return     FALSE: address is not a valid lut address within given sector
 * \return     TRUE: address might be a valid lut address within given sector
 ...
 *********************************************************************************************************************/
/*!
 * \brief      Checks if the given pageToCheck is completely erased
 * \details    Completely here means that the number of bytes according to write alignment are erased.
 * \param[in]  self: sector which holds the alignemnts and the erase value.
 * \param[in]  pageToCheck: buffer that contains the page that shall be checked
 * \return     FALSE: The page is not erased completely.
 * \return     TRUE: The page is erased completely.
 * \pre        self is not null, pageToCheck is not null.
 * \context    TASK
 * \reentrant  FALSE
 * \synchronous TRUE
 */
 ...
 *********************************************************************************************************************/
/*!
 * \brief      Requests Flash to write the erase start marker to the given sector
 * \details    -
 * \config    FEE_USE_RELIABLE_ERASE_PROCEDURE is enabled
 * \param[in,out]  self: target sector
 * \param[in,out]  bufferForRequest: The buffer that can be used for the request
 * \return     FEE_REQ_ACCEPTED: Flash accepted write request
 * \return     FEE_REQ_REJECTED: Flash rejected write request
 * \pre        self is not null, bufferForRequest is not null
 * \context    TASK
 * \reentrant  FALSE
 * \synchronous FALSE
 */
 ...
 *********************************************************************************************************************/
/*!
 * \brief      Requests Flash to read the erase start marker from the given sector
 * \details    -
 * \config    FEE_USE_RELIABLE_ERASE_PROCEDURE is enabled
 ...
 *********************************************************************************************************************/
/*!
 * \brief      Parses the just read erase start marker and checks whether it reveals an aborted erase operation.
 * \details    If a aborted erase operation is detected, the sector will be marked as not usable.
 * \config    FEE_USE_RELIABLE_ERASE_PROCEDURE is enabled
 * \param[in,out]  self: sector that contains this erase start marker.
 * \param[in]  buffer: The buffer to which the erase start marker was loaded.
 * \param[in]  readOk: Reveals whether the fls read job was successful.
 * \pre        self is not null, buffer is not null
 * \context    TASK
 * \reentrant  FALSE
 * \synchronous FALSE
 */
