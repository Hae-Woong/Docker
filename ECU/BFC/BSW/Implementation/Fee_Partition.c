 ...
 *
 */
FEE_INTERN_FUNC(void) Fee_Partition_init(Fee_ConfigRefTypeInternal cfg, uint8 idx)
{
...
#if(FEE_LOOKUPTABLE_MODE == STD_ON)
    Fee_Lut_InitRam(prd.partition_t.cfg_pt); /* SBSW_FEE_PartitionConfig */
#endif
                                                                ...
                                                                uint8 sectorId)
{
    ...
    else if(Fee_Sector_isUsable(sector_pt)) /* PRQA S 3344 */ /* MD_FEE_13.2_boolean */ /* SBSW_FEE_ConstPointer_refParam */
    {
        ...
        sint16_least idDiff = ((sint16_least)sectorId - (sint16_least)pi.sectorId_u8);
        if((Fee_Sector_isUsable(pi.currentSector_pt) == FEE_FALSE) /* PRQA S 1881 */  /* MD_FEE_10.4_compare_FeeBool_to_enum */ /* SBSW_FEE_ConstPointer_refParam */
    ...
    else if(Fee_Sector_isUsable(pi.currentSector_pt) == FEE_FALSE) /* PRQA S 1881 */  /* MD_FEE_10.4_compare_FeeBool_to_enum */ /* SBSW_FEE_ConstPointer_refParam */
    { 
        ...
        if((Fee_Sector_isDefective(sector_pt))                     /* SBSW_FEE_ConstPointer_refParam */
                || (Fee_Sector_isDefective(pi.currentSector_pt))) /* PRQA S 4558, 3415, 4115 */  /* MD_FEE_10.1_Essentially_boolean_in_logical_expressions, MD_FEE_13.5_queries, MD_FEE_10.1_Essentially_boolean_in_logical_expressions */ /* SBSW_FEE_ConstPointer_refParam */
        { 
            Fee_Partition_handleError(&pi, FEE_SECTORS_CORRUPTED); /* SBSW_FEE_Func_passParamByReference */
        }
    }
    else /* PRQA S 2013 */ /* MD_MSR_EmptyClause */
    {
    }
...
{
    return (uint8)((self->sectorId_u8 < 254u) ? (self->sectorId_u8 + 1u) : 1u);
}
...
{
    switch(Fee_ErrorCallbackNotification(self->cfg_pt->ownIndex_u8, errorCode))
    {
...
#endif
            {
                self->currentSector_pt = Fee_Partition_getOldestSector(self); /* SBSW_FEE_PointerWrite_refParam */ /* SBSW_FEE_Func_passParamByReference */
            }
            Fee_Sector_free(Fee_Partition_getOldestSector(self)); /* SBSW_FEE_PointerWrite_refParam */ /* SBSW_FEE_Func_passParamByReference */

            break;
        case FEE_ERRCBK_REJECT_WRITE:
            self->readOnlyMode_bl = TRUE; /* SBSW_FEE_PointerWrite_refParam */
            break;
        default: /* PRQA S 2016 */ /* MD_MSR_EmptyClause */ /* COV_FEE_DEFAULT_CASE */ /* FEE_ERRCBK_REJECT_ALL or any other return value */
...
#        if(FEE_USE_APPL_ERROR_CALLBACK == STD_ON)
            self->rejectAllMode_bl = TRUE; /* SBSW_FEE_PointerWrite_refParam */
            self->readOnlyMode_bl = TRUE; /* SBSW_FEE_PointerWrite_refParam */
#        endif
            break;
...
FEE_INLINE_FUNC(enum Fee_Partition_FillLevelEnum) Fee_Partition_determineRealFillLevel(Fee_PartitionConstRefType self)
{
    ...
    /* PRQA S 3344,3415 1 */ /* MD_FEE_13.2_boolean, MD_FEE_13.5_queries */
    if((Fee_Sector_isUsable(oldSector) == FEE_TRUE) /* PRQA S 1881 */  /* MD_FEE_10.4_compare_FeeBool_to_enum */              /* SBSW_FEE_ConstPointer_refParam */
            && (Fee_Sector_isUsable(newSector) == FEE_TRUE)) /* PRQA S 1881, 3415 */  /* MD_FEE_10.4_compare_FeeBool_to_enum, MD_FEE_13.5_queries */    /* SBSW_FEE_ConstPointer_refParam */
    { 
...
{
    return !self->readOnlyMode_bl; /* PRQA S 4403, 4558, 4116 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions,MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
}
...
{
    return !self->rejectAllMode_bl; /* PRQA S 4403, 4558, 4116 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions,MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
}
#endif
 ...
 *
 */
FEE_INTERN_FUNC(Fee_PartitionRefType) Fee_Partition_getFromConfigById(Fee_ConfigRefTypeInternal cfg, uint8 idx)
{
...
{
    return (!!self->requiresBlockCopy); /* PRQA S 4403, 4558, 4116 */ /* MD_FEE_10.3_essentially_boolean_type, MD_FEE_10.1_Essentially_boolean_in_logical_expressions,MD_FEE_10.1_Essentially_boolean_in_logical_expressions */
}
